...
int cortex_a9_r5_enter_critical( void )
{
    ...
    else if( pxTraceRecorderData->uiTraceSystemState ==
             TRC_STATE_IN_TASKSWITCH )
    {
...
void cortex_a9_r5_exit_critical( int cs_type )
{
    switch( cs_type )
    {
        ...
        case CS_TYPE_ISR_MASK_CHANGED:
            vPortClearInterruptMask( pdFALSE ); // pdFALSE means it will reset
                                                // the IRQ mask.
            break;
    ...
    #endif /* ((TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_ARM_CORTEX_A9) || \
              (TRC_CFG_HARDWARE_PORT ==                                      \
              TRC_HARDWARE_PORT_XILINX_ZyncUltraScaleR5)) */
