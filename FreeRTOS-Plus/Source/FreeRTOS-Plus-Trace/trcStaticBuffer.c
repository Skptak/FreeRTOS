...
{
    TRC_ASSERT_EQUAL_SIZE( TraceStaticBufferBuffer_t,
...
traceResult xTraceStaticBufferGet( void ** ppvBuffer )
{
    ...
    /* This should never fail */
    TRC_ASSERT(
        xTraceIsComponentInitialized( TRC_RECORDER_COMPONENT_STATIC_BUFFER ) );
    ...
    *ppvBuffer = ( void * ) &pxTraceStaticBufferTable
                     ->coreDummyEvents[ TRC_CFG_GET_CURRENT_CORE() ]
                     .dummyEvents[ ISR_nesting + 1 ];
