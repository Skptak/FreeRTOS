 ...
 *
 * @brief Defines the size of the "up" RTT buffer (target -> host) to use for
 * writing the trace data, for RTT buffer 1 or higher.
 *
 ...
 *
 * @brief Defines the size of the "down" RTT buffer (host -> target) to use for
 * reading commands from Tracealyzer, for RTT buffer 1 or higher.
 *
 ...
 *
 * @brief Defines the RTT buffer to use for writing the trace data. Make sure
 * that the PC application has the same setting (File->Settings).
 *
 * Default: 1
 *
 ...
 *
 * @brief Defines the RTT buffer to use for reading the trace data. Make sure
 * that the PC application has the same setting (File->Settings).
 *
 * Default: 1
 *
 ...
 *
 * @brief This stream port for J-Link streaming relies on SEGGER RTT, that
 * contains an internal RAM buffer read by the J-Link probes during execution.
 *
 * Possible values:
