...
extern "C" {
        ...
        #if( !defined( TRC_CFG_STREAM_PORT_ITM_PORT ) || \
             ( TRC_CFG_STREAM_PORT_ITM_PORT ) < 0 ) ||   \
            ( ( TRC_CFG_STREAM_PORT_ITM_PORT ) > 31 )
            #error "Invalid ITM port defined in trcStreamPortConfig.h."
        #endif

        /* Important for the ITM port - no RAM buffer, direct writes. In most
         * other ports this can be skipped (default is 1) */
...
traceResult xTraceStreamPortInitialize( TraceStreamPortBuffer_t * pxBuffer );
        ...
        #define xTraceStreamPortCommit( pvData, uiSize, piBytesCommitted ) \
        ...
        #define xTraceStreamPortReadData( pvData, uiSize, piBytesRead ) \
            prvTraceItmRead( pvData, uiSize, piBytesRead )
        ...
        #define xTraceStreamPortOnTraceBegin() \
            TRC_COMMA_EXPR_TO_STATEMENT_EXPR_1( TRC_SUCCESS )
