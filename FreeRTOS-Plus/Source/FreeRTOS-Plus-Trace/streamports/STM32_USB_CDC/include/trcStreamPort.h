...
#define TRC_STREAM_PORT_USB_BUFFER_SIZE             \
    ( ( ( ( TRC_CFG_STREAM_PORT_USB_BUFFER_SIZE ) + \
...
{
    uint8_t buffer[ ( TRC_STREAM_PORT_USB_BUFFER_SIZE ) +
                    ( TRC_STREAM_PORT_INTERNAL_BUFFER_SIZE ) +
                    sizeof( TraceUnsignedBaseType_t ) ];
...
#define xTraceStreamPortOnEnable( uiStartOption ) \
    ( ( void ) ( uiStartOption ), TRC_SUCCESS )
