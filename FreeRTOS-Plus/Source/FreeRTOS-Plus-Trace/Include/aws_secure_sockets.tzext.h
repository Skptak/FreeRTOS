                                              ...
                                              Socklen_t xAddressLength )
{
    ...
    // timeout/error.
    prvTraceStoreEvent3( EVENTCODE_SOCKETS_Connect,
                         ( uint32_t ) xSocket,
                         ( uint32_t ) pxAddress->ulAddress,
                         ( uint32_t ) ret );
                                           ...
                                           uint32_t ulFlags )
{
    ...
    // Note: The host-side xml file assumes that ret == 0 means OK, otherwise
    // timeout/error.
    prvTraceStoreEvent2( EVENTCODE_SOCKETS_Send,
                         ( uint32_t ) xSocket,
                         ( uint32_t ) ret );
                                           ...
                                           uint32_t ulFlags )
{
    ...
    // Note: The host-side xml file assumes that ret == 0 means OK, otherwise
    // timeout/error.
    prvTraceStoreEvent2( EVENTCODE_SOCKETS_Recv,
                         ( uint32_t ) xSocket,
                         ( uint32_t ) ret );
