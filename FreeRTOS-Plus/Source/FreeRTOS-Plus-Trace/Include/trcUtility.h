...
#define TRC_STRCAT( dst, dst_size, pDstLength, src )            \
...
#if( defined( TRC_CFG_USE_GCC_STATEMENT_EXPR ) && \
     TRC_CFG_USE_GCC_STATEMENT_EXPR == 1 ) ||     \
    __GNUC__
    #define TRC_COMMA_EXPR_TO_STATEMENT_EXPR_1( e1 ) ( { e1; } )
    #define TRC_COMMA_EXPR_TO_STATEMENT_EXPR_2( e1, e2 ) \
        ( {                                              \
            e1;                                          \
            e2;                                          \
        } )
    #define TRC_COMMA_EXPR_TO_STATEMENT_EXPR_3( e1, e2, e3 ) \
        ( {                                                  \
            e1;                                              \
            e2;                                              \
            e3;                                              \
        } )
    #define TRC_COMMA_EXPR_TO_STATEMENT_EXPR_4( e1, e2, e3, e4 ) \
        ( {                                                      \
            e1;                                                  \
            e2;                                                  \
            e3;                                                  \
    ...
    #define TRC_COMMA_EXPR_TO_STATEMENT_EXPR_5( e1, e2, e3, e4, e5 ) \
        ( {                                                          \
            e1;                                                      \
            e2;                                                      \
            e3;                                                      \
