...
/** Transact after a successful red_ftruncate(), RedFseTruncate(), or red_open()
 * with RED_O_TRUNC that actually truncates. */
...
#define RED_TRANSACT_VOLFULL  0x00000400U
    ...
    #define RED_TRANSACT_MASK                                                \
        ( RED_TRANSACT_UMOUNT | RED_TRANSACT_CREAT |                         \
          ...
          ( ( REDCONF_API_POSIX_FTRUNCATE == 1 ) ? RED_TRANSACT_TRUNCATE     \
                                                 : 0U ) |                    \
     ...
     */
    #define RED_TRANSACT_MASK                                                  \
        ( RED_TRANSACT_UMOUNT | RED_TRANSACT_WRITE |                           \
