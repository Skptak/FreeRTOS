...
#define RED_PRODUCT_NAME                               \
    "Datalight " RED_PRODUCT_BASE_NAME " " RED_VERSION \
    " Build " RED_BUILD_NUMBER ALPHABETA

/** @brief Product copyright.
 */
#define RED_PRODUCT_LEGAL \
    "Copyright (c) 2014-2017 Datalight, Inc.  All Rights Reserved Worldwide."
 ...
 */
    ...
    #define RED_PRODUCT_EDITION \
        "Open-Source GPLv2 Edition -- Compiled " __DATE__ " at " __TIME__
#elif RED_KIT == RED_KIT_COMMERCIAL
    #define RED_PRODUCT_EDITION \
        "Commercial Edition -- Compiled " __DATE__ " at " __TIME__
#else
    #define RED_PRODUCT_EDITION \
        "Developer Sandbox -- Compiled " __DATE__ " at " __TIME__
#endif
