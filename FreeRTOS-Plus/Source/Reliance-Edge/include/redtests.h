...
#define FSSTRESS_SUPPORTED                                                     \
    ( ( ( RED_KIT == RED_KIT_GPL ) || ( RED_KIT == RED_KIT_SANDBOX ) ) &&      \
      ...
      ( REDCONF_PATH_SEPARATOR == '/' ) && ( REDCONF_API_POSIX == 1 ) &&       \
      ( REDCONF_API_POSIX_UNLINK == 1 ) && ( REDCONF_API_POSIX_MKDIR == 1 ) && \
      ( REDCONF_API_POSIX_RMDIR == 1 ) && ( REDCONF_API_POSIX_RENAME == 1 ) && \
      ( REDCONF_API_POSIX_LINK == 1 ) &&                                       \
      ( REDCONF_API_POSIX_FTRUNCATE == 1 ) &&                                  \
      ( REDCONF_API_POSIX_READDIR == 1 ) )

#define FSE_STRESS_TEST_SUPPORTED                                    \
    ( ( ( RED_KIT == RED_KIT_COMMERCIAL ) ||                         \
        ( RED_KIT == RED_KIT_SANDBOX ) ) &&                          \
      ( REDCONF_OUTPUT == 1 ) && ( REDCONF_READ_ONLY == 0 ) &&       \
      ( REDCONF_API_FSE == 1 ) && ( REDCONF_API_FSE_FORMAT == 1 ) && \
      ( REDCONF_API_FSE_TRANSMASKSET == 1 ) &&                       \
      ( REDCONF_API_FSE_TRANSMASKGET == 1 ) &&                       \
...
#define STOCH_POSIX_TEST_SUPPORTED                                            \
    ( ( ( RED_KIT == RED_KIT_COMMERCIAL ) ||                                  \
      ...
      ( REDCONF_API_POSIX == 1 ) && ( REDCONF_API_POSIX_FORMAT == 1 ) &&      \
      ( REDCONF_API_POSIX_READDIR == 1 ) &&                                   \
      ( REDCONF_API_POSIX_MKDIR == 1 ) && ( REDCONF_API_POSIX_RMDIR == 1 ) && \
      ( REDCONF_API_POSIX_UNLINK == 1 ) && ( REDCONF_API_POSIX_RENAME == 1 ) )
