 ...
 * @brief A group of macros which should be defined as integer values, zero or
 * larger.
 *
 ...
 * @brief Macros that specify the maximum lengths (number of characters) for
 * names of kernel objects, such as tasks and queues. If longer names are used,
 * they will be truncated when stored in the recorder.
 */
