 ...
 */
     ...
     *
     * \param TypeExtField      Type extension field, allows you to configure
     * memory access type, for example strongly ordered, peripheral. \param
     * IsShareable       Region is shareable between multiple bus masters.
     * \param IsCacheable       Region is cacheable, i.e. its value may be kept
     * in cache. \param IsBufferable      Region is bufferable, i.e. using
     * write-back caching. Cacheable but non-bufferable regions use
     ...
     * instruction fetches. \param AccessPermission  Data access permissions,
     * allows you to configure read/write access for User and Privileged mode.
     * \param AccessAttributes  Memory access attribution, see \ref
     * ARM_MPU_ACCESS_. \param SubRegionDisable  Sub-region disable field.
     ...
     * in cache. \param IsBufferable      Region is bufferable, i.e. using
     * write-back caching. Cacheable but non-bufferable regions use
     * write-through policy. \param SubRegionDisable  Sub-region disable field.
     * \param Size              Region size of the region to be configured, for
     * example 4K, 8K.
     */
