...
#define MBEDTLS_PLATFORM_CALLOC_MACRO                                   \
    mbedtls_platform_calloc /**< Default allocator macro to use, can be \
                               undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO \
    mbedtls_platform_free /**< Default free macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_EXIT_MACRO            exit /**< Default exit macro
// to use, can be undefined */ #define MBEDTLS_PLATFORM_SETBUF_MACRO      setbuf
