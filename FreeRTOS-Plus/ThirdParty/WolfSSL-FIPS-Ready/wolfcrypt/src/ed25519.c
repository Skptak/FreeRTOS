...
static const byte ed25519Ctx[ ED25519CTX_SIZE + 1 ] = "SigEd25519 no Ed25519 "
                                                      "collisions";
    #endif
                            ...
                            word32 pubKeySz )
{
    ...
    if( ret == 0 )
    {
        ...
        LTC_PKHA_Ed25519_PointMul( LTC_PKHA_Ed25519_BasePoint(),
                                   az,
                                   ED25519_KEY_SIZE,
                                   &publicKey,
                           ...
                           byte contextLen )
{
    ...
    return wc_ed25519ph_sign_hash( hash,
                                   sizeof( hash ),
                                   out,
                                   outLen,
                                   key,
                               ...
                               byte contextLen )
{
    ...
    *res = 0;
    ...
    LTC_PKHA_SignatureForVerify( rcheck,
                                 h,
                                 sig + ( ED25519_SIG_SIZE / 2 ),
                                 key );
        #else
    sc_reduce( h );
    ...
    */
    ret = ge_double_scalarmult_vartime( &R,
                                        h,
                                        &A,
                                        sig + ( ED25519_SIG_SIZE / 2 ) );
    if( ret != 0 )
                             ...
                             byte contextLen )
{
    ...
    return wc_ed25519ph_verify_hash( sig,
                                     sigLen,
                                     hash,
                                     sizeof( hash ),
                                     res,
