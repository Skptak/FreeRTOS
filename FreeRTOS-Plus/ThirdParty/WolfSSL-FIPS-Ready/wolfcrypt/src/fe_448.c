...
{
    r[ 0 ] = ( ( int64_t ) ( b[ 0 ] ) << 0 ) | ( ( int64_t ) ( b[ 1 ] ) << 8 ) |
             ( ( int64_t ) ( b[ 2 ] ) << 16 ) |
             ( ( int64_t ) ( b[ 3 ] ) << 24 ) |
             ( ( int64_t ) ( b[ 4 ] ) << 32 ) |
             ( ( int64_t ) ( b[ 5 ] ) << 40 ) |
             ( ( int64_t ) ( b[ 6 ] ) << 48 );
    r[ 1 ] = ( ( int64_t ) ( b[ 7 ] ) << 0 ) | ( ( int64_t ) ( b[ 8 ] ) << 8 ) |
             ( ( int64_t ) ( b[ 9 ] ) << 16 ) |
             ( ( int64_t ) ( b[ 10 ] ) << 24 ) |
             ( ( int64_t ) ( b[ 11 ] ) << 32 ) |
             ( ( int64_t ) ( b[ 12 ] ) << 40 ) |
...
void fe448_invert( int64_t * r, const int64_t * a )
{
    ...
    for( i = 1; i < 224; ++i )
        fe448_sqr( t1, t1 );
    /* t1 =
     * fffffffffffffffffffffffffffffffffffffffffffffffffffffffe00000000000000000000000000000000000000000000000000000000
     */
    fe448_mul( r, t3, t1 );
    /* r =
...
void fe448_pow_2_446_222_1( int64_t * r, const int64_t * a )
{
    ...
    for( i = 1; i < 192; ++i )
        fe448_sqr( t1, t1 );
    /* t1 =
     * fffffffffffffffffffffffffffffffffffffffffffffffffffffffe000000000000000000000000000000000000000000000000
     */
    fe448_mul( t1, t1, t4 );
    /* t1 =
     * fffffffffffffffffffffffffffffffffffffffffffffffffffffffeffffffffffffffffffffffffffffffffffffffffffffffff
     */
    fe448_sqr( t1, t1 );
    for( i = 1; i < 30; ++i )
        fe448_sqr( t1, t1 );
    /* t1 =
     * 3fffffffffffffffffffffffffffffffffffffffffffffffffffffffbfffffffffffffffffffffffffffffffffffffffffffffffc0000000
     */
    fe448_mul( r, t5, t1 );
    /* r =
