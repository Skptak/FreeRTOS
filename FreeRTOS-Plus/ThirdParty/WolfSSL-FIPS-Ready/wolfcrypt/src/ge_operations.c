...
static void ge_sub( ge_p1p1 *, const ge_p3 *, const ge_cached * );
    ...
    Here the group is the set of pairs (x,y) of field elements (see
    ge_operations.h) satisfying -x^2 + y^2 = 1 + d x^2y^2 where d =
    -121665/121666.
...
{
    uint64_t n;
    n = ( ( uint64_t ) a[ 0 ] << 0 ) | ( ( uint64_t ) a[ 1 ] << 8 ) |
...
void sc_muladd( byte * s, const byte * a, const byte * b, const byte * c )
{
    ...
    t[ 1 ] = cd[ 1 ] + ( __int128_t ) ad[ 0 ] * bd[ 1 ] +
             ( __int128_t ) ad[ 1 ] * bd[ 0 ];
    t[ 2 ] = cd[ 2 ] + ( __int128_t ) ad[ 0 ] * bd[ 2 ] +
             ( __int128_t ) ad[ 1 ] * bd[ 1 ] +
             ( __int128_t ) ad[ 2 ] * bd[ 0 ];
    t[ 3 ] = cd[ 3 ] + ( __int128_t ) ad[ 0 ] * bd[ 3 ] +
             ( __int128_t ) ad[ 1 ] * bd[ 2 ] +
             ( __int128_t ) ad[ 2 ] * bd[ 1 ] +
             ( __int128_t ) ad[ 3 ] * bd[ 0 ];
    t[ 4 ] = cd[ 4 ] + ( __int128_t ) ad[ 0 ] * bd[ 4 ] +
             ( __int128_t ) ad[ 1 ] * bd[ 3 ] +
             ( __int128_t ) ad[ 2 ] * bd[ 2 ] +
             ( __int128_t ) ad[ 3 ] * bd[ 1 ] +
             ( __int128_t ) ad[ 4 ] * bd[ 0 ];
    t[ 5 ] = cd[ 5 ] + ( __int128_t ) ad[ 0 ] * bd[ 5 ] +
             ( __int128_t ) ad[ 1 ] * bd[ 4 ] +
             ( __int128_t ) ad[ 2 ] * bd[ 3 ] +
             ( __int128_t ) ad[ 3 ] * bd[ 2 ] +
             ( __int128_t ) ad[ 4 ] * bd[ 1 ] +
             ( __int128_t ) ad[ 5 ] * bd[ 0 ];
    t[ 6 ] = ( __int128_t ) ad[ 1 ] * bd[ 5 ] +
             ( __int128_t ) ad[ 2 ] * bd[ 4 ] +
             ( __int128_t ) ad[ 3 ] * bd[ 3 ] +
             ( __int128_t ) ad[ 4 ] * bd[ 2 ] +
             ( __int128_t ) ad[ 5 ] * bd[ 1 ];
    t[ 7 ] = ( __int128_t ) ad[ 2 ] * bd[ 5 ] +
             ( __int128_t ) ad[ 3 ] * bd[ 4 ] +
             ( __int128_t ) ad[ 4 ] * bd[ 3 ] +
             ( __int128_t ) ad[ 5 ] * bd[ 2 ];
    t[ 8 ] = ( __int128_t ) ad[ 3 ] * bd[ 5 ] +
             ( __int128_t ) ad[ 4 ] * bd[ 4 ] +
             ( __int128_t ) ad[ 5 ] * bd[ 3 ];
    t[ 9 ] = ( __int128_t ) ad[ 4 ] * bd[ 5 ] +
             ( __int128_t ) ad[ 5 ] * bd[ 4 ];
...
static const ge d = {
    ...
    0x7779e898, -0x7338bf87, 0x2b6ffe73, 0x52036cee,
};
        #elif defined( CURVED25519_128BIT )
static const ge d = { 0x34dca135978a3,
                      0x1a8283b156ebd,
                      0x5e7a26001c029,
                      0x739c663a03cbb,
                      0x52036cee2b6ff };
        #else
static const ge d = { -10913610, 13857413, -15372611, 6949391,   114729,
...
static const ge sqrtm1 = {
    ...
    0x3dfbd7a7, 0x2b4d0099,  0x4fc1df0b,  0x2b832480,
        ...
        #elif defined( CURVED25519_128BIT )
static const ge sqrtm1 = { 0x61b274a0ea0b0,
                           0x0d5a5fc8f189d,
                           0x7ef5e9cbd0c60,
                           0x78595a6804c9e,
                           0x2b8324804fc1d };
        #else
static const ge sqrtm1 = { -32595792, -7943725,  9377950,  3500415, 12389472,
...
static const ge d2 = {
    ...
    0x2406d9dc56dffce7,
        ...
        #elif defined( CURVED25519_ASM_32BIT )
static const ge d2 = {
    0x26b2f159,  -0x1429646c, -0x7d7c4eaa, 0x00e0149a,
    -0x110c2ed0, 0x198e80f2,  0x56dffce7,  0x2406d9dc,
};
        #elif defined( CURVED25519_128BIT )
static const ge d2 = { 0x69b9426b2f159,
                       0x35050762add7a,
                       0x3cf44c0038052,
                       0x6738cc7407977,
                       0x2406d9dc56dff };
        #else
static const ge d2 = { -21827239, -5839606,  -30745221, 13898782, 229458,
