...
/* PKCS#5 v1.5 with non standard extension to optionally derive the extra data
 * (IV) */
                  ...
                  int devId )
{
    ...
    if( hLen < 0 )
        ...
        #ifdef WOLFSSL_SMALL_STACK
    buffer = ( byte * ) XMALLOC( WC_MAX_DIGEST_SIZE,
                                 heap,
...
int wc_PKCS12_PBKDF( byte * output,
                     ...
                     int id )
{
    return wc_PKCS12_PBKDF_ex( output,
                               passwd,
                               passLen,
                               salt,
                               saltLen,
                        ...
                        void * heap )
{
    ...
    v = ret;
        ...
        #ifdef WOLFSSL_SMALL_STACK
    Ai = ( byte * ) XMALLOC( WC_MAX_DIGEST_SIZE,
                             heap,
                             DYNAMIC_TYPE_TMP_BUFFER );
    if( Ai == NULL )
        return MEMORY_E;
