...
int wc_Sha224Hash( const byte * data, word32 len, byte * hash )
{
    ...
    wc_Sha224 sha224[ 1 ];
            ...
            #ifdef WOLFSSL_SMALL_STACK
    sha224 = ( wc_Sha224 * ) XMALLOC( sizeof( wc_Sha224 ),
                                      NULL,
                                      DYNAMIC_TYPE_TMP_BUFFER );
    if( sha224 == NULL )
        return MEMORY_E;
...
int wc_Sha256Hash( const byte * data, word32 len, byte * hash )
{
    ...
    wc_Sha256 sha256[ 1 ];
            ...
            #ifdef WOLFSSL_SMALL_STACK
    sha256 = ( wc_Sha256 * ) XMALLOC( sizeof( wc_Sha256 ),
                                      NULL,
                                      DYNAMIC_TYPE_TMP_BUFFER );
    if( sha256 == NULL )
        return MEMORY_E;
...
int wc_Sha512Hash( const byte * data, word32 len, byte * hash )
{
    ...
    wc_Sha512 sha512[ 1 ];
        ...
        #ifdef WOLFSSL_SMALL_STACK
    sha512 = ( wc_Sha512 * ) XMALLOC( sizeof( wc_Sha512 ),
                                      NULL,
                                      DYNAMIC_TYPE_TMP_BUFFER );
    if( sha512 == NULL )
        return MEMORY_E;
...
int wc_Sha384Hash( const byte * data, word32 len, byte * hash )
{
    ...
    wc_Sha384 sha384[ 1 ];
        ...
        #ifdef WOLFSSL_SMALL_STACK
    sha384 = ( wc_Sha384 * ) XMALLOC( sizeof( wc_Sha384 ),
                                      NULL,
                                      DYNAMIC_TYPE_TMP_BUFFER );
    if( sha384 == NULL )
        return MEMORY_E;
...
int wc_Sha3_224Hash( const byte * data, word32 len, byte * hash )
{
    ...
    wc_Sha3 sha3[ 1 ];
            ...
            #ifdef WOLFSSL_SMALL_STACK
    sha3 = ( wc_Sha3 * ) XMALLOC( sizeof( wc_Sha3 ),
                                  NULL,
                                  DYNAMIC_TYPE_TMP_BUFFER );
    if( sha3 == NULL )
        return MEMORY_E;
...
int wc_Shake256Hash( const byte * data, word32 len, byte * hash, word32 hashLen )
{
    int ret = 0;
            #ifdef WOLFSSL_SMALL_STACK
    wc_Shake * shake;
    ...
    wc_Shake shake[ 1 ];
            ...
            #ifdef WOLFSSL_SMALL_STACK
    shake = ( wc_Shake * ) XMALLOC( sizeof( wc_Shake ),
                                    NULL,
                                    DYNAMIC_TYPE_TMP_BUFFER );
    if( shake == NULL )
        return MEMORY_E;
                  ...
                  int devId )
{
    ...
    if( half > MAX_PRF_HALF || labLen + seedLen > MAX_PRF_LABSEED ||
        digLen > MAX_PRF_DIG )
    {
    #if defined( WOLFSSL_ASYNC_CRYPT ) && !defined( WC_ASYNC_NO_HASH )
