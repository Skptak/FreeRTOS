...
typedef struct word128
{
    ...
    word64 hi;
            ...
            #define SHR( in, shift ) \
                ( __shiftright128( in.lo, in.hi, ( shift ) ) )
            #define LO( in ) ( in.lo )
                             ...
                             size_t bytes )
{
    ...
    poly1305_blocks_avx( ctx, m, bytes );
        #elif defined( POLY130564 )
    const word64 hibit = ( ctx->finished )
                             ? 0
                             : ( ( word64 ) 1 << 40 ); /* 1 << 128 */
    word64 r0, r1, r2;
    word64 s1, s2;
    ...
    ctx->h[ 2 ] = h2;
        ...
        #else /* if not 64 bit then use 32 bit */
    const word32 hibit = ( ctx->finished )
                             ? 0
                             : ( ( word32 ) 1 << 24 ); /* 1 << 128 */
    ...
    while( bytes >= POLY1305_BLOCK_SIZE )
    {
        ...
        /* h *= r */
        d0 = ( ( word64 ) h0 * r0 ) + ( ( word64 ) h1 * s4 ) +
             ( ( word64 ) h2 * s3 ) + ( ( word64 ) h3 * s2 ) +
             ( ( word64 ) h4 * s1 );
        d1 = ( ( word64 ) h0 * r1 ) + ( ( word64 ) h1 * r0 ) +
             ( ( word64 ) h2 * s4 ) + ( ( word64 ) h3 * s3 ) +
             ( ( word64 ) h4 * s2 );
        d2 = ( ( word64 ) h0 * r2 ) + ( ( word64 ) h1 * r1 ) +
             ( ( word64 ) h2 * r0 ) + ( ( word64 ) h3 * s4 ) +
             ( ( word64 ) h4 * s3 );
        d3 = ( ( word64 ) h0 * r3 ) + ( ( word64 ) h1 * r2 ) +
             ( ( word64 ) h2 * r1 ) + ( ( word64 ) h3 * r0 ) +
             ( ( word64 ) h4 * s4 );
        d4 = ( ( word64 ) h0 * r4 ) + ( ( word64 ) h1 * r3 ) +
             ( ( word64 ) h2 * r2 ) + ( ( word64 ) h3 * r1 ) +
             ( ( word64 ) h4 * r0 );
