                                 ...
                                 const char * cbc )
{
    ...
    #if !defined( NO_SHA ) || defined( WOLFSSL_SHA512 ) || \
                                 ...
                                 const char * digest )
{
    ...
    int ret = ConvertHexToBin( digest,
                               binDigest,
                               &digestSz,
                               key,
                               binKey,
                                 ...
                                 const char * output )
{
    ...
    int ret = ConvertHexToBin( entropyA,
                               binEntropyA,
                               &binEntropyASz,
                               entropyB,
                               binEntropyB,
    ...
    /* Test Body */
    ret = RNG_HealthTest_fips( reseed,
                               binEntropyA,
                               binEntropyASz,
                               binEntropyB,
                               binEntropyBSz,
                                    ...
                                    const char * z )
{
    ...
    if( ret == 0 )
    {
        ret = Base16_Decode( ( const byte * ) z,
                             ( word32 ) XSTRLEN( z ),
                             sharedB,
                             &bSz );
    }
                                            ...
                                            const char * sig )
{
    ...
    ret = wc_RsaPrivateKeyDecode( client_key_der_2048,
                                  &idx,
                                  &rsa,
                                          ...
                                          const char * zVerify )
{
    ...
    if( ret == 0 )
        ...
        #endif
    if( ret == 0 )
        ret = wc_ecc_import_raw_ex( &serverKey,
                                    qexServer,
                                    qeyServer,
                                    NULL,
                                    ECC_SECP256R1 );
    ...
    if( ret == 0 )
        ret = wc_ecc_import_raw_ex( &clientKey,
                                    qexClient,
                                    qeyClient,
                                    deClient,
                                    ECC_SECP256R1 );
...
static int ECDSA_PairwiseAgreeTest( int type, const char * msg )
{
    ...
    ret = wc_EccPrivateKeyDecode( ecc_clikey_der_256,
                                  &idx,
                                  &ecc,
    ...
    ret = wc_ecc_sign_hash( msgDigest,
                            msgDigestSz,
                            msgSigned,
                            &msgSignedSz,
                            &rng,
    ...
    ret = wc_ecc_verify_hash( msgSigned,
                              msgSignedSz,
                              msgDigest,
                              msgDigestSz,
                              &verify,
...
static const char verifyCore[] = "542F30458624B1C57D6FDDE94A7E28C7A688097F6FB8A"
                                 "7FF647BF418C2D6867A";
...
static int DoInCoreCheck( char * base16_hash, int base16_hashSz )
{
    ...
    static const char coreKey[] = "EAD92D38850B03D7160EA4F5C90EDD49C0B6933FAA48"
                                  "33213ED6F0F1596E356B";
    ...
    ret = ConvertHexToBin( verifyCore,
                           binVerify,
                           &verifySz,
                           NULL,
                           NULL,
...
int DoKnownAnswerTests( char * base16_hash, int base16_hashSz )
{
    ...
    if( AesKnownAnswerTest(
            ...
            "95163ff1caa1681fac09120eca307586e1a7" ) != 0 )
    {
    ...
    if( AesGcm_KnownAnswerTest( 0,
                                ...
                                "cc38bccd6bc536ad919b1395f5d63801f99f8068d65ca5"
                                "ac" /* plain */
                                "63872daf16b93901",
                                "021fafd238463973ffe80256e5b1c6b1", /* auth */
                                "dfce4e9cd291103d7fe4e63351d9e79d3dfd391e326710"
                                "46" /* cipher */
                                "58212da96521b7db",
    ...
    if( AesGcm_KnownAnswerTest( 1,
                                ...
                                "f3ee01423f192c36033542221c5545dd939de52ada18b9"
                                "e8" /* plain */
                                "b72ba17d02c5dddd",
                                "cdf5496a50214683304aec0a80337f9a", /* auth */
                                "36a4029c9e7d0307d31c29cea885bb6c8022452016a297"
                                "54" /* cipher */
                                "ba8a344c5bbfc3e1",
    ...
    if( HMAC_KnownAnswerTest( WC_SHA512, /* type */
                              "303132333435363738393a3b3c3d3e3f40414243", /* key
                                                                           */
                              "Sample #2", /* msg */
                              "809d44057c5b954105bd041316db0fac44d5a4d5d0892bd0"
                              "4e866412c0907768"
                              "f187b77c4fae2c2f21a5b5659a4f4ba74702a3de9b51f145"
                              "bd4f252742989905"
                              /* digest */
                              ) != 0 )
    {
    ...
    #ifndef NO_RSA
    if( RsaSignPKCS1v15_KnownAnswerTest(
            WC_SHA256,                   /* type */
    ...
    if( DRBG_KnownAnswerTest( 0,
                              ...
                              "8581f9317517276e06e9607ddbcbcc2e", /* entropy +
                                                                     nonce input
                                                                   */
                              NULL, /* no reseed */
                              ...
                              "8b2295910281b02dd431f4c9f70427df" /* pseudorandom
                                                                    output */
                              ) != 0 )
    {
    ...
    if( DRBG_KnownAnswerTest( 1,
                              ...
                              "808aa38f2a72a62359915a9f8a04ca68", /* entropy +
                                                                     nonce input
                                                                   */
                              "e62b8a8ee8f141b6980566e3bfe3c049"
                              "03dad4ac2cdf9f2280010a6739bc83d3", /* reseed
                                                                     entropy
                                                                     input */
                              ...
                              "1969e069fa8ce007a180183a07dfae17" /* pseudorandom
                                                                    output */
                              ) != 0 )
    {
        return DRBG_KAT_FIPS_E;
    ...
    if( ECC_CDH_KnownAnswerTest(
            ...
            /* z */
            "46fc62106420ff012e54a434fbdd2d25ccc5852060561e68040dd7778997bd7"
            "b" ) != 0 )
    {
    ...
    if( EccPrimitiveZ_KnownAnswerTest(
            ...
            /* zVerify */
            "322f2e5a51d78300e5ec692e7c592a25e65c960f76de8729ee0b678dc9d0e99"
            "e" ) != 0 )
    {
    ...
    if( DhPrimitiveZ_KnownAnswerTest(
            ...
            /* zVerify */
            "288cc3c9b62c6af7ae8ceaa61c1ebe3de7fe8040928b7154428fa3a08e148b2"
            "7" ) != 0 )
    {
