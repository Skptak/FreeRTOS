 ...
 */
    ...
    #define MONT_START __asm__( "movd %0,%%mm2" ::"g"( mp ) )

    #define MONT_FINI  __asm__( "emms" )
...
/* TAO switched tmpm from "g" to "r" after gcc tried to index the indexed stack
   pointer */
    ...
    #define LOOP_END __asm__( "movd %%mm3,%0  \n" : "=r"( cy ) )
...
/* x86-64 optimized */
    ...
    #define COMBA_FINI __asm__( "emms" );
...
/* ISO C portable code */
    ...
    #define SQRADDDB                                                        \
        ...
        {                                                                   \
            ...
            c0 = ( fp_digit ) t;                                            \
            t = ( ( fp_word ) sc1 ) + ( ( fp_word ) sc1 ) + c1 +            \
                ( t >> DIGIT_BIT );                                         \
            c1 = ( fp_digit ) t;                                            \
            c2 = c2 +                                                       \
                 ( fp_digit ) ( ( ( fp_word ) sc2 ) + ( ( fp_word ) sc2 ) + \
                                ( t >> DIGIT_BIT ) );                       \
        } while( 0 );
