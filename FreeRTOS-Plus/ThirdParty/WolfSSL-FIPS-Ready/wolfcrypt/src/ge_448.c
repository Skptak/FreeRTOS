...
static const uint8_t ed448_order_mul[ 56 ] = {
    0x0d, 0xbb, 0xa7, 0x54, 0x6d, 0x3d, 0x87, 0xdc, 0xaa, 0x70,
...
void sc448_reduce( uint8_t * b )
{
    ...
    /* Load from bytes */
    t[ 0 ] = ( ( int64_t ) ( b[ 0 ] ) << 0 ) | ( ( int64_t ) ( b[ 1 ] ) << 8 ) |
             ( ( int64_t ) ( b[ 2 ] ) << 16 ) |
             ( ( int64_t ) ( b[ 3 ] ) << 24 ) |
             ( ( int64_t ) ( b[ 4 ] ) << 32 ) |
             ( ( int64_t ) ( b[ 5 ] ) << 40 ) |
             ( ( int64_t ) ( b[ 6 ] ) << 48 );
    t[ 1 ] = ( ( int64_t ) ( b[ 7 ] ) << 0 ) | ( ( int64_t ) ( b[ 8 ] ) << 8 ) |
             ( ( int64_t ) ( b[ 9 ] ) << 16 ) |
             ( ( int64_t ) ( b[ 10 ] ) << 24 ) |
             ( ( int64_t ) ( b[ 11 ] ) << 32 ) |
             ( ( int64_t ) ( b[ 12 ] ) << 40 ) |
                   ...
                   const uint8_t * d )
{
    ...
    t[ 2 ] = dd[ 2 ] + ( int128_t ) ad[ 0 ] * bd[ 2 ] +
             ( int128_t ) ad[ 1 ] * bd[ 1 ] + ( int128_t ) ad[ 2 ] * bd[ 0 ];
    t[ 3 ] = dd[ 3 ] + ( int128_t ) ad[ 0 ] * bd[ 3 ] +
             ( int128_t ) ad[ 1 ] * bd[ 2 ] + ( int128_t ) ad[ 2 ] * bd[ 1 ] +
             ( int128_t ) ad[ 3 ] * bd[ 0 ];
    t[ 4 ] = dd[ 4 ] + ( int128_t ) ad[ 0 ] * bd[ 4 ] +
             ( int128_t ) ad[ 1 ] * bd[ 3 ] + ( int128_t ) ad[ 2 ] * bd[ 2 ] +
             ( int128_t ) ad[ 3 ] * bd[ 1 ] + ( int128_t ) ad[ 4 ] * bd[ 0 ];
    t[ 5 ] = dd[ 5 ] + ( int128_t ) ad[ 0 ] * bd[ 5 ] +
             ( int128_t ) ad[ 1 ] * bd[ 4 ] + ( int128_t ) ad[ 2 ] * bd[ 3 ] +
             ( int128_t ) ad[ 3 ] * bd[ 2 ] + ( int128_t ) ad[ 4 ] * bd[ 1 ] +
             ( int128_t ) ad[ 5 ] * bd[ 0 ];
    t[ 6 ] = dd[ 6 ] + ( int128_t ) ad[ 0 ] * bd[ 6 ] +
             ( int128_t ) ad[ 1 ] * bd[ 5 ] + ( int128_t ) ad[ 2 ] * bd[ 4 ] +
             ( int128_t ) ad[ 3 ] * bd[ 3 ] + ( int128_t ) ad[ 4 ] * bd[ 2 ] +
             ( int128_t ) ad[ 5 ] * bd[ 1 ] + ( int128_t ) ad[ 6 ] * bd[ 0 ];
    t[ 7 ] = dd[ 7 ] + ( int128_t ) ad[ 0 ] * bd[ 7 ] +
             ( int128_t ) ad[ 1 ] * bd[ 6 ] + ( int128_t ) ad[ 2 ] * bd[ 5 ] +
             ( int128_t ) ad[ 3 ] * bd[ 4 ] + ( int128_t ) ad[ 4 ] * bd[ 3 ] +
             ( int128_t ) ad[ 5 ] * bd[ 2 ] + ( int128_t ) ad[ 6 ] * bd[ 1 ] +
             ( int128_t ) ad[ 7 ] * bd[ 0 ];
    t[ 8 ] = ( int128_t ) ad[ 1 ] * bd[ 7 ] + ( int128_t ) ad[ 2 ] * bd[ 6 ] +
             ( int128_t ) ad[ 3 ] * bd[ 5 ] + ( int128_t ) ad[ 4 ] * bd[ 4 ] +
             ( int128_t ) ad[ 5 ] * bd[ 3 ] + ( int128_t ) ad[ 6 ] * bd[ 2 ] +
             ( int128_t ) ad[ 7 ] * bd[ 1 ];
    t[ 9 ] = ( int128_t ) ad[ 2 ] * bd[ 7 ] + ( int128_t ) ad[ 3 ] * bd[ 6 ] +
             ( int128_t ) ad[ 4 ] * bd[ 5 ] + ( int128_t ) ad[ 5 ] * bd[ 4 ] +
             ( int128_t ) ad[ 6 ] * bd[ 3 ] + ( int128_t ) ad[ 7 ] * bd[ 2 ];
    t[ 10 ] = ( int128_t ) ad[ 3 ] * bd[ 7 ] + ( int128_t ) ad[ 4 ] * bd[ 6 ] +
              ( int128_t ) ad[ 5 ] * bd[ 5 ] + ( int128_t ) ad[ 6 ] * bd[ 4 ] +
              ( int128_t ) ad[ 7 ] * bd[ 3 ];
    t[ 11 ] = ( int128_t ) ad[ 4 ] * bd[ 7 ] + ( int128_t ) ad[ 5 ] * bd[ 6 ] +
              ( int128_t ) ad[ 6 ] * bd[ 5 ] + ( int128_t ) ad[ 7 ] * bd[ 4 ];
    t[ 12 ] = ( int128_t ) ad[ 5 ] * bd[ 7 ] + ( int128_t ) ad[ 6 ] * bd[ 6 ] +
              ( int128_t ) ad[ 7 ] * bd[ 5 ];
    t[ 13 ] = ( int128_t ) ad[ 6 ] * bd[ 7 ] + ( int128_t ) ad[ 7 ] * bd[ 6 ];
                   ...
                   const uint8_t * d )
{
    ...
    t[ 2 ] = dd[ 2 ] + ( int64_t ) ad[ 0 ] * bd[ 2 ] +
             ( int64_t ) ad[ 1 ] * bd[ 1 ] + ( int64_t ) ad[ 2 ] * bd[ 0 ];
    t[ 3 ] = dd[ 3 ] + ( int64_t ) ad[ 0 ] * bd[ 3 ] +
             ( int64_t ) ad[ 1 ] * bd[ 2 ] + ( int64_t ) ad[ 2 ] * bd[ 1 ] +
             ( int64_t ) ad[ 3 ] * bd[ 0 ];
    t[ 4 ] = dd[ 4 ] + ( int64_t ) ad[ 0 ] * bd[ 4 ] +
             ( int64_t ) ad[ 1 ] * bd[ 3 ] + ( int64_t ) ad[ 2 ] * bd[ 2 ] +
             ( int64_t ) ad[ 3 ] * bd[ 1 ] + ( int64_t ) ad[ 4 ] * bd[ 0 ];
    t[ 5 ] = dd[ 5 ] + ( int64_t ) ad[ 0 ] * bd[ 5 ] +
             ( int64_t ) ad[ 1 ] * bd[ 4 ] + ( int64_t ) ad[ 2 ] * bd[ 3 ] +
             ( int64_t ) ad[ 3 ] * bd[ 2 ] + ( int64_t ) ad[ 4 ] * bd[ 1 ] +
             ( int64_t ) ad[ 5 ] * bd[ 0 ];
    t[ 6 ] = dd[ 6 ] + ( int64_t ) ad[ 0 ] * bd[ 6 ] +
             ( int64_t ) ad[ 1 ] * bd[ 5 ] + ( int64_t ) ad[ 2 ] * bd[ 4 ] +
             ( int64_t ) ad[ 3 ] * bd[ 3 ] + ( int64_t ) ad[ 4 ] * bd[ 2 ] +
             ( int64_t ) ad[ 5 ] * bd[ 1 ] + ( int64_t ) ad[ 6 ] * bd[ 0 ];
    t[ 7 ] = dd[ 7 ] + ( int64_t ) ad[ 0 ] * bd[ 7 ] +
             ( int64_t ) ad[ 1 ] * bd[ 6 ] + ( int64_t ) ad[ 2 ] * bd[ 5 ] +
             ( int64_t ) ad[ 3 ] * bd[ 4 ] + ( int64_t ) ad[ 4 ] * bd[ 3 ] +
             ( int64_t ) ad[ 5 ] * bd[ 2 ] + ( int64_t ) ad[ 6 ] * bd[ 1 ] +
             ( int64_t ) ad[ 7 ] * bd[ 0 ];
    t[ 8 ] = dd[ 8 ] + ( int64_t ) ad[ 0 ] * bd[ 8 ] +
             ( int64_t ) ad[ 1 ] * bd[ 7 ] + ( int64_t ) ad[ 2 ] * bd[ 6 ] +
             ( int64_t ) ad[ 3 ] * bd[ 5 ] + ( int64_t ) ad[ 4 ] * bd[ 4 ] +
             ( int64_t ) ad[ 5 ] * bd[ 3 ] + ( int64_t ) ad[ 6 ] * bd[ 2 ] +
             ( int64_t ) ad[ 7 ] * bd[ 1 ] + ( int64_t ) ad[ 8 ] * bd[ 0 ];
    t[ 9 ] = dd[ 9 ] + ( int64_t ) ad[ 0 ] * bd[ 9 ] +
             ( int64_t ) ad[ 1 ] * bd[ 8 ] + ( int64_t ) ad[ 2 ] * bd[ 7 ] +
             ( int64_t ) ad[ 3 ] * bd[ 6 ] + ( int64_t ) ad[ 4 ] * bd[ 5 ] +
             ( int64_t ) ad[ 5 ] * bd[ 4 ] + ( int64_t ) ad[ 6 ] * bd[ 3 ] +
             ( int64_t ) ad[ 7 ] * bd[ 2 ] + ( int64_t ) ad[ 8 ] * bd[ 1 ] +
             ( int64_t ) ad[ 9 ] * bd[ 0 ];
    t[ 10 ] = dd[ 10 ] + ( int64_t ) ad[ 0 ] * bd[ 10 ] +
              ( int64_t ) ad[ 1 ] * bd[ 9 ] + ( int64_t ) ad[ 2 ] * bd[ 8 ] +
              ( int64_t ) ad[ 3 ] * bd[ 7 ] + ( int64_t ) ad[ 4 ] * bd[ 6 ] +
              ( int64_t ) ad[ 5 ] * bd[ 5 ] + ( int64_t ) ad[ 6 ] * bd[ 4 ] +
              ( int64_t ) ad[ 7 ] * bd[ 3 ] + ( int64_t ) ad[ 8 ] * bd[ 2 ] +
              ( int64_t ) ad[ 9 ] * bd[ 1 ] + ( int64_t ) ad[ 10 ] * bd[ 0 ];
    t[ 11 ] = dd[ 11 ] + ( int64_t ) ad[ 0 ] * bd[ 11 ] +
              ( int64_t ) ad[ 1 ] * bd[ 10 ] + ( int64_t ) ad[ 2 ] * bd[ 9 ] +
              ( int64_t ) ad[ 3 ] * bd[ 8 ] + ( int64_t ) ad[ 4 ] * bd[ 7 ] +
              ( int64_t ) ad[ 5 ] * bd[ 6 ] + ( int64_t ) ad[ 6 ] * bd[ 5 ] +
              ( int64_t ) ad[ 7 ] * bd[ 4 ] + ( int64_t ) ad[ 8 ] * bd[ 3 ] +
              ( int64_t ) ad[ 9 ] * bd[ 2 ] + ( int64_t ) ad[ 10 ] * bd[ 1 ] +
              ( int64_t ) ad[ 11 ] * bd[ 0 ];
    t[ 12 ] = dd[ 12 ] + ( int64_t ) ad[ 0 ] * bd[ 12 ] +
              ( int64_t ) ad[ 1 ] * bd[ 11 ] + ( int64_t ) ad[ 2 ] * bd[ 10 ] +
              ...
              ( int64_t ) ad[ 11 ] * bd[ 1 ] + ( int64_t ) ad[ 12 ] * bd[ 0 ];
    t[ 13 ] = dd[ 13 ] + ( int64_t ) ad[ 0 ] * bd[ 13 ] +
              ( int64_t ) ad[ 1 ] * bd[ 12 ] + ( int64_t ) ad[ 2 ] * bd[ 11 ] +
              ( int64_t ) ad[ 3 ] * bd[ 10 ] + ( int64_t ) ad[ 4 ] * bd[ 9 ] +
              ( int64_t ) ad[ 5 ] * bd[ 8 ] + ( int64_t ) ad[ 6 ] * bd[ 7 ] +
              ( int64_t ) ad[ 7 ] * bd[ 6 ] + ( int64_t ) ad[ 8 ] * bd[ 5 ] +
              ( int64_t ) ad[ 9 ] * bd[ 4 ] + ( int64_t ) ad[ 10 ] * bd[ 3 ] +
              ( int64_t ) ad[ 11 ] * bd[ 2 ] + ( int64_t ) ad[ 12 ] * bd[ 1 ] +
              ( int64_t ) ad[ 13 ] * bd[ 0 ];
    t[ 14 ] = dd[ 14 ] + ( int64_t ) ad[ 0 ] * bd[ 14 ] +
              ( int64_t ) ad[ 1 ] * bd[ 13 ] + ( int64_t ) ad[ 2 ] * bd[ 12 ] +
              ( int64_t ) ad[ 3 ] * bd[ 11 ] + ( int64_t ) ad[ 4 ] * bd[ 10 ] +
              ( int64_t ) ad[ 5 ] * bd[ 9 ] + ( int64_t ) ad[ 6 ] * bd[ 8 ] +
              ( int64_t ) ad[ 7 ] * bd[ 7 ] + ( int64_t ) ad[ 8 ] * bd[ 6 ] +
              ( int64_t ) ad[ 9 ] * bd[ 5 ] + ( int64_t ) ad[ 10 ] * bd[ 4 ] +
              ( int64_t ) ad[ 11 ] * bd[ 3 ] + ( int64_t ) ad[ 12 ] * bd[ 2 ] +
              ( int64_t ) ad[ 13 ] * bd[ 1 ] + ( int64_t ) ad[ 14 ] * bd[ 0 ];
    t[ 15 ] = dd[ 15 ] + ( int64_t ) ad[ 0 ] * bd[ 15 ] +
              ( int64_t ) ad[ 1 ] * bd[ 14 ] + ( int64_t ) ad[ 2 ] * bd[ 13 ] +
              ( int64_t ) ad[ 3 ] * bd[ 12 ] + ( int64_t ) ad[ 4 ] * bd[ 11 ] +
              ( int64_t ) ad[ 5 ] * bd[ 10 ] + ( int64_t ) ad[ 6 ] * bd[ 9 ] +
              ( int64_t ) ad[ 7 ] * bd[ 8 ] + ( int64_t ) ad[ 8 ] * bd[ 7 ] +
              ( int64_t ) ad[ 9 ] * bd[ 6 ] + ( int64_t ) ad[ 10 ] * bd[ 5 ] +
              ( int64_t ) ad[ 11 ] * bd[ 4 ] + ( int64_t ) ad[ 12 ] * bd[ 3 ] +
              ( int64_t ) ad[ 13 ] * bd[ 2 ] + ( int64_t ) ad[ 14 ] * bd[ 1 ] +
              ( int64_t ) ad[ 15 ] * bd[ 0 ];
    t[ 16 ] = ( int64_t ) ad[ 1 ] * bd[ 15 ] + ( int64_t ) ad[ 2 ] * bd[ 14 ] +
              ( int64_t ) ad[ 3 ] * bd[ 13 ] + ( int64_t ) ad[ 4 ] * bd[ 12 ] +
              ( int64_t ) ad[ 5 ] * bd[ 11 ] + ( int64_t ) ad[ 6 ] * bd[ 10 ] +
              ( int64_t ) ad[ 7 ] * bd[ 9 ] + ( int64_t ) ad[ 8 ] * bd[ 8 ] +
              ( int64_t ) ad[ 9 ] * bd[ 7 ] + ( int64_t ) ad[ 10 ] * bd[ 6 ] +
              ( int64_t ) ad[ 11 ] * bd[ 5 ] + ( int64_t ) ad[ 12 ] * bd[ 4 ] +
              ( int64_t ) ad[ 13 ] * bd[ 3 ] + ( int64_t ) ad[ 14 ] * bd[ 2 ] +
              ( int64_t ) ad[ 15 ] * bd[ 1 ];
    t[ 17 ] = ( int64_t ) ad[ 2 ] * bd[ 15 ] + ( int64_t ) ad[ 3 ] * bd[ 14 ] +
              ( int64_t ) ad[ 4 ] * bd[ 13 ] + ( int64_t ) ad[ 5 ] * bd[ 12 ] +
              ( int64_t ) ad[ 6 ] * bd[ 11 ] + ( int64_t ) ad[ 7 ] * bd[ 10 ] +
              ( int64_t ) ad[ 8 ] * bd[ 9 ] + ( int64_t ) ad[ 9 ] * bd[ 8 ] +
              ( int64_t ) ad[ 10 ] * bd[ 7 ] + ( int64_t ) ad[ 11 ] * bd[ 6 ] +
              ( int64_t ) ad[ 12 ] * bd[ 5 ] + ( int64_t ) ad[ 13 ] * bd[ 4 ] +
              ( int64_t ) ad[ 14 ] * bd[ 3 ] + ( int64_t ) ad[ 15 ] * bd[ 2 ];
    t[ 18 ] = ( int64_t ) ad[ 3 ] * bd[ 15 ] + ( int64_t ) ad[ 4 ] * bd[ 14 ] +
              ( int64_t ) ad[ 5 ] * bd[ 13 ] + ( int64_t ) ad[ 6 ] * bd[ 12 ] +
              ( int64_t ) ad[ 7 ] * bd[ 11 ] + ( int64_t ) ad[ 8 ] * bd[ 10 ] +
              ( int64_t ) ad[ 9 ] * bd[ 9 ] + ( int64_t ) ad[ 10 ] * bd[ 8 ] +
              ( int64_t ) ad[ 11 ] * bd[ 7 ] + ( int64_t ) ad[ 12 ] * bd[ 6 ] +
              ( int64_t ) ad[ 13 ] * bd[ 5 ] + ( int64_t ) ad[ 14 ] * bd[ 4 ] +
              ( int64_t ) ad[ 15 ] * bd[ 3 ];
    t[ 19 ] = ( int64_t ) ad[ 4 ] * bd[ 15 ] + ( int64_t ) ad[ 5 ] * bd[ 14 ] +
              ( int64_t ) ad[ 6 ] * bd[ 13 ] + ( int64_t ) ad[ 7 ] * bd[ 12 ] +
              ( int64_t ) ad[ 8 ] * bd[ 11 ] + ( int64_t ) ad[ 9 ] * bd[ 10 ] +
              ( int64_t ) ad[ 10 ] * bd[ 9 ] + ( int64_t ) ad[ 11 ] * bd[ 8 ] +
              ( int64_t ) ad[ 12 ] * bd[ 7 ] + ( int64_t ) ad[ 13 ] * bd[ 6 ] +
              ( int64_t ) ad[ 14 ] * bd[ 5 ] + ( int64_t ) ad[ 15 ] * bd[ 4 ];
    t[ 20 ] = ( int64_t ) ad[ 5 ] * bd[ 15 ] + ( int64_t ) ad[ 6 ] * bd[ 14 ] +
              ( int64_t ) ad[ 7 ] * bd[ 13 ] + ( int64_t ) ad[ 8 ] * bd[ 12 ] +
              ( int64_t ) ad[ 9 ] * bd[ 11 ] + ( int64_t ) ad[ 10 ] * bd[ 10 ] +
              ( int64_t ) ad[ 11 ] * bd[ 9 ] + ( int64_t ) ad[ 12 ] * bd[ 8 ] +
              ( int64_t ) ad[ 13 ] * bd[ 7 ] + ( int64_t ) ad[ 14 ] * bd[ 6 ] +
              ( int64_t ) ad[ 15 ] * bd[ 5 ];
    t[ 21 ] = ( int64_t ) ad[ 6 ] * bd[ 15 ] + ( int64_t ) ad[ 7 ] * bd[ 14 ] +
              ( int64_t ) ad[ 8 ] * bd[ 13 ] + ( int64_t ) ad[ 9 ] * bd[ 12 ] +
              ( int64_t ) ad[ 10 ] * bd[ 11 ] +
              ( int64_t ) ad[ 11 ] * bd[ 10 ] + ( int64_t ) ad[ 12 ] * bd[ 9 ] +
              ( int64_t ) ad[ 13 ] * bd[ 8 ] + ( int64_t ) ad[ 14 ] * bd[ 7 ] +
              ( int64_t ) ad[ 15 ] * bd[ 6 ];
    t[ 22 ] = ( int64_t ) ad[ 7 ] * bd[ 15 ] + ( int64_t ) ad[ 8 ] * bd[ 14 ] +
              ( int64_t ) ad[ 9 ] * bd[ 13 ] + ( int64_t ) ad[ 10 ] * bd[ 12 ] +
              ( int64_t ) ad[ 11 ] * bd[ 11 ] +
              ( int64_t ) ad[ 12 ] * bd[ 10 ] + ( int64_t ) ad[ 13 ] * bd[ 9 ] +
              ( int64_t ) ad[ 14 ] * bd[ 8 ] + ( int64_t ) ad[ 15 ] * bd[ 7 ];
    t[ 23 ] = ( int64_t ) ad[ 8 ] * bd[ 15 ] + ( int64_t ) ad[ 9 ] * bd[ 14 ] +
              ( int64_t ) ad[ 10 ] * bd[ 13 ] +
              ( int64_t ) ad[ 11 ] * bd[ 12 ] +
              ( int64_t ) ad[ 12 ] * bd[ 11 ] +
              ( int64_t ) ad[ 13 ] * bd[ 10 ] + ( int64_t ) ad[ 14 ] * bd[ 9 ] +
              ( int64_t ) ad[ 15 ] * bd[ 8 ];
    t[ 24 ] = ( int64_t ) ad[ 9 ] * bd[ 15 ] + ( int64_t ) ad[ 10 ] * bd[ 14 ] +
              ( int64_t ) ad[ 11 ] * bd[ 13 ] +
              ( int64_t ) ad[ 12 ] * bd[ 12 ] +
              ( int64_t ) ad[ 13 ] * bd[ 11 ] +
              ( int64_t ) ad[ 14 ] * bd[ 10 ] + ( int64_t ) ad[ 15 ] * bd[ 9 ];
    t[ 25 ] = ( int64_t ) ad[ 10 ] * bd[ 15 ] +
              ( int64_t ) ad[ 11 ] * bd[ 14 ] +
              ( int64_t ) ad[ 12 ] * bd[ 13 ] +
              ( int64_t ) ad[ 13 ] * bd[ 12 ] +
              ( int64_t ) ad[ 14 ] * bd[ 11 ] + ( int64_t ) ad[ 15 ] * bd[ 10 ];
    t[ 26 ] = ( int64_t ) ad[ 11 ] * bd[ 15 ] +
              ( int64_t ) ad[ 12 ] * bd[ 14 ] +
              ( int64_t ) ad[ 13 ] * bd[ 13 ] +
              ( int64_t ) ad[ 14 ] * bd[ 12 ] + ( int64_t ) ad[ 15 ] * bd[ 11 ];
    t[ 27 ] = ( int64_t ) ad[ 12 ] * bd[ 15 ] +
              ( int64_t ) ad[ 13 ] * bd[ 14 ] +
              ( int64_t ) ad[ 14 ] * bd[ 13 ] + ( int64_t ) ad[ 15 ] * bd[ 12 ];
    t[ 28 ] = ( int64_t ) ad[ 13 ] * bd[ 15 ] +
              ( int64_t ) ad[ 14 ] * bd[ 14 ] + ( int64_t ) ad[ 15 ] * bd[ 13 ];
    t[ 29 ] = ( int64_t ) ad[ 14 ] * bd[ 15 ] + ( int64_t ) ad[ 15 ] * bd[ 14 ];
