                     ...
                     word32 hsize )
{
    ...
    #ifdef WOLFSSL_SMALL_STACK
    hash_desc = ( wolfssl_TI_Hash * ) XMALLOC( sizeof( wolfssl_TI_Hash ),
                                               NULL,
                                               DYNAMIC_TYPE_TMP_BUFFER );
    if( hash_desc == NULL )
        return MEMORY_E;
...
{
    return hashFinal( ( wolfssl_TI_Hash * ) md5,
                      hash,
                      SHAMD5_ALGO_MD5,
                      MD5_DIGEST_SIZE );
}
...
{
    return hashGetHash( ( wolfssl_TI_Hash * ) md5,
                        hash,
                        SHAMD5_ALGO_MD5,
                        MD5_DIGEST_SIZE );
}
...
{
    return hashFinal( ( wolfssl_TI_Hash * ) sha,
                      hash,
                      SHAMD5_ALGO_SHA1,
                      SHA_DIGEST_SIZE );
}
...
{
    return hashFinal( ( wolfssl_TI_Hash * ) sha224,
                      hash,
                      SHAMD5_ALGO_SHA224,
                      SHA224_DIGEST_SIZE );
}
...
{
    return hashFinal( ( wolfssl_TI_Hash * ) sha256,
                      hash,
                      SHAMD5_ALGO_SHA256,
                      SHA256_DIGEST_SIZE );
}
