...
#include <wolfssl/wolfcrypt/settings.h>
    ...
    /* set FIPS_NO_WRAPPERS before headers, use direct internal f()s not
     * wrappers */
...
static char base16_hash[ WC_SHA256_DIGEST_SIZE * 2 + 1 ]; /* caclulated hash */
     ...
     * the wolfcrypt module before execution of the power on self test has
     * finished. Note GetThisThreadInPos() MUST return correct value therefore
     * no ops would not work.
     */
                        ...
                        word32 authInSz )
{
    ...
    return wc_AesGcmEncrypt_ex( aes,
                                out,
                                in,
                                sz,
                                ivOut,
                     ...
                     word32 authTagSz )
{
    ...
    #if defined( HAVE_AESCCM ) && defined( HAVE_FIPS_VERSION ) && \
        ( HAVE_FIPS_VERSION >= 2 )
/* ccm set key wrapper */
                        ...
                        word32 authInSz )
{
    ...
    return wc_AesCcmEncrypt_ex( aes,
                                out,
                                in,
                                sz,
                                ivOut,
                             ...
                             word32 labelSz )
{
    ...
    return wc_RsaPublicEncrypt_ex( in,
                                   inLen,
                                   out,
                                   outLen,
                                   key,
                                    ...
                                    word32 labelSz )
{
    ...
    return wc_RsaPrivateDecryptInline_ex( in,
                                          inLen,
                                          out,
                                          key,
                                          type,
                              ...
                              word32 labelSz )
{
    ...
    return wc_RsaPrivateDecrypt_ex( in,
                                    inLen,
                                    out,
                                    outLen,
                                    key,
                          ...
                          RsaKey * key )
{
    ...
    return wc_RsaPSS_Verify_ex( in, inLen, out, outLen, hash, mgf, saltLen, key );
}
                                ...
                                int bits )
{
    ...
    return wc_RsaPSS_CheckPadding_ex( in,
                                      inSz,
                                      sig,
                                      sigSz,
                                      hashType,
