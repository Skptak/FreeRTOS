...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        defined( ED25519_SMALL ) /* use slower code that takes less memory */
...
static void xc_double( byte * x3, byte * z3, const byte * x1, const byte * z1 )
{
...
void fprime_mul( byte * r, const byte * a, const byte * b, const byte * modulus )
{
    word16 c = 0;
    int i, j;
