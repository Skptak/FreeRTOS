...
struct WOLFSSL_ASN1_STRING
{
    ...
    char * data;
    long flags;
    unsigned int isDynamic : 1; /* flag for if data pointer dynamic (1 is yes 0
                                   is no) */
};
...
struct WOLFSSL_ASN1_OBJECT
{
    ...
    WOLFSSL_ASN1_INTEGER * pathlen;
#endif
    unsigned char dynamic; /* Use WOLFSSL_ASN1_DYNAMIC and
                            * WOLFSSL_ASN1_DYNAMIC_DATA to determine what needs
                            * to be freed. */
...
WOLFSSL_API int wolfSSL_RSA_padding_add_PKCS1_PSS(
    WOLFSSL_RSA * rsa,
    unsigned char * EM,
...
WOLFSSL_API WOLFSSL_X509 * wolfSSL_SESSION_get0_peer(
    WOLFSSL_SESSION * session );
...
WOLFSSL_API void wolfSSL_DTLSv1_set_initial_timeout_duration(
    WOLFSSL * ssl,
    word32 duration_ms );
...
WOLFSSL_API void wolfSSL_sk_X509_free( WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
                                       sk );
...
WOLFSSL_API void wolfSSL_sk_GENERAL_NAME_pop_free(
    WOLFSSL_STACK * sk,
...
WOLFSSL_API void wolfSSL_sk_ACCESS_DESCRIPTION_pop_free(
    WOLFSSL_STACK * sk,
    void ( *f )( WOLFSSL_ACCESS_DESCRIPTION * ) );
WOLFSSL_API void wolfSSL_ACCESS_DESCRIPTION_free(
    WOLFSSL_ACCESS_DESCRIPTION * access );
...
WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_ASN1_OBJECT_dup(
...
WOLFSSL_API int wolfSSL_sk_X509_EXTENSION_num(
    WOLF_STACK_OF( WOLFSSL_X509_EXTENSION ) * sk );
...
WOLFSSL_API const char * wolfSSL_CIPHER_get_version(
    const WOLFSSL_CIPHER * cipher );
...
WOLFSSL_API const char * wolfSSL_SESSION_CIPHER_get_name(
    WOLFSSL_SESSION * session );
...
WOLFSSL_API void wolfSSL_set_locking_callback(
    void ( *f )( int, int, const char *, int ) );
WOLFSSL_API void wolfSSL_set_dynlock_create_callback(
    WOLFSSL_dynlock_value * ( *f )( const char *, int ) );
WOLFSSL_API void wolfSSL_set_dynlock_lock_callback(
    void ( *f )( int, WOLFSSL_dynlock_value *, const char *, int ) );
WOLFSSL_API void wolfSSL_set_dynlock_destroy_callback(
...
WOLFSSL_API int wolfSSL_X509_STORE_CTX_get_error_depth(
    WOLFSSL_X509_STORE_CTX * );

WOLFSSL_API void wolfSSL_X509_STORE_CTX_set_verify_cb(
    WOLFSSL_X509_STORE_CTX * ctx,
    WOLFSSL_X509_STORE_CTX_verify_cb verify_cb );
WOLFSSL_API void wolfSSL_X509_STORE_set_verify_cb(
...
WOLFSSL_ABI WOLFSSL_API WOLFSSL_X509_NAME * wolfSSL_X509_get_subject_name(
    WOLFSSL_X509 * );
WOLFSSL_API unsigned long wolfSSL_X509_subject_name_hash(
    const WOLFSSL_X509 * x509 );
...
WOLFSSL_API int wolfSSL_X509_NAME_get_index_by_NID( WOLFSSL_X509_NAME *,
                                                    int,
                                                    int );
WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_X509_NAME_ENTRY_get_data(
    WOLFSSL_X509_NAME_ENTRY * );

WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_ASN1_STRING_new( void );
WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_ASN1_STRING_dup(
...
WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_d2i_DISPLAYTEXT(
    WOLFSSL_ASN1_STRING ** asn,
...
WOLFSSL_API WOLFSSL_X509_LOOKUP * wolfSSL_X509_STORE_add_lookup(
    WOLFSSL_X509_STORE *,
...
WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_X509_CRL_get_lastUpdate(
    WOLFSSL_X509_CRL * );
WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_X509_CRL_get_nextUpdate(
    WOLFSSL_X509_CRL * );
...
WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PrivateKey( int type,
                                                       ...
                                                       const unsigned char ** in,
                                                       long inSz );
WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PrivateKey_EVP(
...
WOLFSSL_API int wolfSSL_X509_cmp_time( const WOLFSSL_ASN1_TIME * asnTime,
                                       time_t * cmpTime );
WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_X509_time_adj_ex(
    WOLFSSL_ASN1_TIME * asnTime,
    int offset_day,
    long offset_sec,
    time_t * in_tm );
WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_X509_time_adj(
    WOLFSSL_ASN1_TIME * asnTime,
    long offset_sec,
    time_t * in_tm );
...
WOLFSSL_API void wolfSSL_X509_VERIFY_PARAM_set_hostflags(
    ...
    unsigned int flags );
WOLFSSL_API int wolfSSL_X509_VERIFY_PARAM_set1_host(
...
WOLFSSL_API WOLFSSL_X509_REVOKED * wolfSSL_sk_X509_REVOKED_value(
    WOLFSSL_X509_REVOKED *,
    int );
WOLFSSL_API WOLFSSL_ASN1_INTEGER * wolfSSL_X509_get_serialNumber(
    WOLFSSL_X509 * );
...
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
    wolfSSL_load_client_CA_file( const char * );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
    wolfSSL_CTX_get_client_CA_list( const WOLFSSL_CTX * s );
/* deprecated function name */
#define wolfSSL_SSL_CTX_get_client_CA_list wolfSSL_CTX_get_client_CA_list

WOLFSSL_API void wolfSSL_CTX_set_client_CA_list(
    WOLFSSL_CTX *,
    WOLF_STACK_OF( WOLFSSL_X509_NAME ) * );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
    wolfSSL_get_client_CA_list( const WOLFSSL * ssl );
...
WOLFSSL_API int wolfSSL_i2d_RSAPrivateKey( WOLFSSL_RSA * r,
                                           unsigned char ** pp );
WOLFSSL_API void wolfSSL_CTX_set_tmp_rsa_callback(
    WOLFSSL_CTX *,
...
enum
{
    ...
    SSL_OP_ALL = ( SSL_OP_MICROSOFT_SESS_ID_BUG |
                   SSL_OP_NETSCAPE_CHALLENGE_BUG |
                   SSL_OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG |
                   SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG |
                   SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER |
                   SSL_OP_MSIE_SSLV2_RSA_PADDING |
                   SSL_OP_SSLEAY_080_CLIENT_DH_BUG | SSL_OP_TLS_D5_BUG |
    ...
    #define SSL_OP_NO_TLSv1_2 WOLFSSL_OP_NO_TLSv1_2
           ...
           defined( WOLFSSL_APACHE_HTTPD ) ) /* apache uses this to determine \
                                                if TLS 1.3 is enabled */
...
WOLFSSL_API void wolfSSL_ERR_print_errors( WOLFSSL_BIO * bio );
    ...
    #define SSL_R_SSLV3_ALERT_BAD_CERTIFICATE \
        WOLFSSL_R_SSLV3_ALERT_BAD_CERTIFICATE
...
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509 ) *
    wolfSSL_get_peer_cert_chain( const WOLFSSL * );
#if defined( WOLFSSL_QT ) || defined( OPENSSL_ALL )
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509 ) *
...
WOLFSSL_API int wolfSSL_ASN1_GENERALIZEDTIME_print(
    WOLFSSL_BIO *,
    const WOLFSSL_ASN1_GENERALIZEDTIME * );
WOLFSSL_API void wolfSSL_ASN1_GENERALIZEDTIME_free(
...
WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_set_timeout( WOLFSSL_CTX *,
                                                     unsigned int );
WOLFSSL_API void wolfSSL_CTX_set_current_time_cb(
    WOLFSSL_CTX * ctx,
...
WOLFSSL_API WOLFSSL_X509_CRL * wolfSSL_d2i_X509_CRL( WOLFSSL_X509_CRL ** crl,
                                                     ...
                                                     int len );
#ifndef NO_FILESYSTEM
WOLFSSL_API WOLFSSL_X509_CRL * wolfSSL_d2i_X509_CRL_fp(
    XFILE file,
    WOLFSSL_X509_CRL ** crl );
#endif
...
WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_d2i_fp( WOLFSSL_X509 ** x509,
                                                XFILE file );
    #endif
WOLFSSL_ABI WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_load_certificate_file(
    const char * fname,
    int format );
#endif
...
#ifndef NO_FILESYSTEM
WOLFSSL_API WOLFSSL_X509_PKCS12 * wolfSSL_d2i_PKCS12_fp(
    XFILE fp,
...
WOLFSSL_API int wolfSSL_CTX_use_PrivateKey_id( WOLFSSL_CTX *,
                                               ...
                                               int,
                                               long );
WOLFSSL_API int wolfSSL_CTX_use_certificate_chain_buffer_format(
    WOLFSSL_CTX *,
    const unsigned char *,
    long,
    int );
...
WOLFSSL_API int wolfSSL_use_PrivateKey_id( WOLFSSL *,
                                           ...
                                           int,
                                           long );
WOLFSSL_API int wolfSSL_use_certificate_chain_buffer_format(
    WOLFSSL *,
    const unsigned char *,
    long,
    int );
...
WOLFSSL_API void wolfSSL_CTX_SetX25519SharedSecretCb(
    WOLFSSL_CTX *,
...
typedef int ( *SessionTicketEncCb )(
    WOLFSSL *,
...
WOLFSSL_API void wolfSSL_cert_service( void );
    ...
    /* Smaller subset of X509 compatibility functions. Avoid increasing the size
     * of this subset and its memory usage */
...
WOLFSSL_API int wolfSSL_X509_NAME_get_index_by_OBJ(
...
WOLFSSL_LOCAL WOLFSSL_ASN1_OBJECT * wolfSSL_OBJ_nid2obj_ex(
    int n,
...
WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509_get_ext(
    const WOLFSSL_X509 * x,
    int loc );
WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509_set_ext( WOLFSSL_X509 * x,
                                                           int loc );
WOLFSSL_API int wolfSSL_X509_EXTENSION_get_critical(
    const WOLFSSL_X509_EXTENSION * ex );
...
WOLFSSL_API void wolfSSL_X509_EXTENSION_free(
    WOLFSSL_X509_EXTENSION * ext_to_free );
WOLFSSL_API WOLFSSL_STACK * wolfSSL_sk_new_x509_ext( void );
        #endif

WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_X509_EXTENSION_get_object(
    WOLFSSL_X509_EXTENSION * ext );
WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_X509_EXTENSION_get_data(
    WOLFSSL_X509_EXTENSION * ext );
    #endif /* !NO_CERTS */
...
WOLFSSL_API WOLFSSL_X509 * wolfSSL_d2i_X509_fp( XFILE fp,
                                                WOLFSSL_X509 ** x509 );
WOLFSSL_API WOLFSSL_STACK * wolfSSL_X509_STORE_GetCerts(
    WOLFSSL_X509_STORE_CTX * s );
    #endif
...
WOLFSSL_API WOLFSSL_X509 * wolfSSL_PEM_read_bio_X509( WOLFSSL_BIO * bp,
                                                      ...
                                                      pem_password_cb * cb,
                                                      void * u );
WOLFSSL_API WOLFSSL_X509_CRL * wolfSSL_PEM_read_bio_X509_CRL(
    WOLFSSL_BIO * bp,
    WOLFSSL_X509_CRL ** x,
    pem_password_cb * cb,
    void * u );
WOLFSSL_API WOLFSSL_X509 * wolfSSL_PEM_read_bio_X509_AUX( WOLFSSL_BIO * bp,
                                                          ...
                                                          pem_password_cb * cb,
                                                          void * u );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_INFO ) *
    wolfSSL_PEM_X509_INFO_read_bio( WOLFSSL_BIO * bio,
...
WOLFSSL_API WOLFSSL_X509_NAME_ENTRY * wolfSSL_X509_NAME_get_entry(
    ...
    defined( OPENSSL_EXTRA_X509_SMALL )
        ...
        defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA_X509_SMALL )
...
WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_X509_NAME_ENTRY_get_object(
...
WOLFSSL_API int wolfSSL_X509_check_private_key( WOLFSSL_X509 *,
                                                WOLFSSL_EVP_PKEY * );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
    wolfSSL_dup_CA_list( WOLF_STACK_OF( WOLFSSL_X509_NAME ) * sk );
...
WOLFSSL_API int wolfSSL_X509_REQ_sign( WOLFSSL_X509 * req,
                                       WOLFSSL_EVP_PKEY * pkey,
                                       const WOLFSSL_EVP_MD * md );
WOLFSSL_API int wolfSSL_X509_REQ_add_extensions(
    WOLFSSL_X509 * req,
...
WOLFSSL_API WOLFSSL_DH * wolfSSL_DH_generate_parameters(
    int prime_len,
    int generator,
    void ( *callback )( int, int, void * ),
    void * cb_arg );

WOLFSSL_API int wolfSSL_DH_generate_parameters_ex(
    WOLFSSL_DH *,
    int,
    int,
    void ( *callback )( int, int, void * ) );
...
WOLFSSL_API int wolfSSL_sk_X509_INFO_num(
    const WOLF_STACK_OF( WOLFSSL_X509_INFO ) * );
...
WOLFSSL_API int wolfSSL_sk_X509_INFO_push( WOLF_STACK_OF( WOLFSSL_X509_INFO ) *,
                                           WOLFSSL_X509_INFO * );
WOLFSSL_API WOLFSSL_X509_INFO * wolfSSL_sk_X509_INFO_pop(
    WOLF_STACK_OF( WOLFSSL_X509_INFO ) * );
...
typedef int ( *wolf_sk_compare_cb )( const void * const * a,
                                     const void * const * b );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_X509_NAME ) *
    wolfSSL_sk_X509_NAME_new( wolf_sk_compare_cb );
WOLFSSL_API int wolfSSL_sk_X509_NAME_push( WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
                                           WOLFSSL_X509_NAME * );
WOLFSSL_API int wolfSSL_sk_X509_NAME_find(
    const WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
    WOLFSSL_X509_NAME * );
WOLFSSL_API int wolfSSL_sk_X509_NAME_set_cmp_func(
    WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
    wolf_sk_compare_cb );
WOLFSSL_API WOLFSSL_X509_NAME * wolfSSL_sk_X509_NAME_value(
    const WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
    int );
WOLFSSL_API int wolfSSL_sk_X509_NAME_num(
    const WOLF_STACK_OF( WOLFSSL_X509_NAME ) * );
WOLFSSL_API WOLFSSL_X509_NAME * wolfSSL_sk_X509_NAME_pop(
    WOLF_STACK_OF( WOLFSSL_X509_NAME ) * );
WOLFSSL_API void wolfSSL_sk_X509_NAME_pop_free(
    WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
    void ( *f )( WOLFSSL_X509_NAME * ) );
WOLFSSL_API void wolfSSL_sk_X509_NAME_free(
    WOLF_STACK_OF( WOLFSSL_X509_NAME ) * );

WOLFSSL_API int wolfSSL_sk_X509_OBJECT_num(
    const WOLF_STACK_OF( WOLFSSL_X509_OBJECT ) * s );
...
WOLFSSL_API WOLFSSL_X509 * wolfSSL_sk_X509_value(
    WOLF_STACK_OF( WOLFSSL_X509 ) *,
    int );

WOLFSSL_API WOLFSSL_X509 * wolfSSL_sk_X509_shift(
    WOLF_STACK_OF( WOLFSSL_X509 ) * );

WOLFSSL_API void * wolfSSL_sk_X509_OBJECT_value(
    WOLF_STACK_OF( WOLFSSL_X509_OBJECT ) *,
    int );
#endif /* OPENSSL_ALL || HAVE_STUNNEL || WOLFSSL_NGINX || WOLFSSL_HAPROXY || \
          OPENSSL_EXTRA || HAVE_LIGHTY */
...
WOLFSSL_API int wolfSSL_X509_set_ex_data( WOLFSSL_X509 * x509,
    ...
    defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA ) || \
    defined( HAVE_LIGHTY )
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_CIPHER ) *
    wolfSSL_get_ciphers_compat( const WOLFSSL * ssl );
...
WOLFSSL_API int wolfSSL_i2a_ASN1_INTEGER( WOLFSSL_BIO * bp,
    ...
    #ifdef HAVE_SESSION_TICKET
WOLFSSL_API int wolfSSL_CTX_set_tlsext_ticket_key_cb(
    WOLFSSL_CTX *,
    int ( * )( WOLFSSL * ssl,
               unsigned char * name,
               unsigned char * iv,
...
WOLFSSL_API void wolfSSL_X509_email_free( WOLF_STACK_OF( WOLFSSL_STRING ) *
                                          sk );
WOLFSSL_API WOLF_STACK_OF( WOLFSSL_STRING ) *
    wolfSSL_X509_get1_ocsp( WOLFSSL_X509 * x );
...
WOLFSSL_API char * wolfSSL_sk_WOLFSSL_STRING_value(
    ...
    int idx );
    #endif /* HAVE_OCSP || OPENSSL_EXTRA || OPENSSL_ALL || WOLFSSL_NGINX || \
              WOLFSSL_HAPROXY */
...
WOLFSSL_API void wolfSSL_CTX_set_alpn_select_cb(
    WOLFSSL_CTX * ctx,
    int ( *cb )( WOLFSSL * ssl,
                 const unsigned char ** out,
                 unsigned char * outlen,
                 ...
                 void * arg ),
    void * arg );
WOLFSSL_API void wolfSSL_CTX_set_next_protos_advertised_cb(
    WOLFSSL_CTX * s,
    int ( *cb )( WOLFSSL * ssl,
                 const unsigned char ** out,
                 unsigned int * outlen,
                 void * arg ),
    void * arg );
WOLFSSL_API void wolfSSL_CTX_set_next_proto_select_cb(
    WOLFSSL_CTX * s,
    int ( *cb )( WOLFSSL * ssl,
                 unsigned char ** out,
                 unsigned char * outlen,
...
WOLFSSL_API const WOLFSSL_X509_ALGOR * wolfSSL_X509_get0_tbs_sigalg(
    const WOLFSSL_X509 * x );
...
WOLFSSL_API WOLFSSL_X509_PUBKEY * wolfSSL_X509_get_X509_PUBKEY(
    const WOLFSSL_X509 * x509 );
...
WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_X509_PUBKEY_get(
...
WOLFSSL_API int wolfSSL_i2d_ASN1_OBJECT( WOLFSSL_ASN1_OBJECT * a,
                                         unsigned char ** pp );
WOLFSSL_API void SSL_CTX_set_tmp_dh_callback(
    WOLFSSL_CTX * ctx,
    WOLFSSL_DH * ( *dh )( WOLFSSL * ssl, int is_export, int keylength ) );
WOLFSSL_API WOLF_STACK_OF( SSL_COMP ) *
...
WOLFSSL_API int wolfSSL_sk_SSL_CIPHER_find( WOLF_STACK_OF( WOLFSSL_CIPHER ) *
                                                sk,
                                            const WOLFSSL_CIPHER * toFind );
WOLFSSL_API void wolfSSL_sk_SSL_CIPHER_free( WOLF_STACK_OF( WOLFSSL_CIPHER ) *
                                             sk );
...
WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_ASN1_TIME_to_generalizedtime(
    WOLFSSL_ASN1_TIME * t,
...
WOLFSSL_API int wolfSSL_PEM_write_bio_PKCS8PrivateKey(
    WOLFSSL_BIO * bio,
    WOLFSSL_EVP_PKEY * pkey,
    ...
    pem_password_cb * cb,
    void * ctx );
WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PKCS8PrivateKey_bio(
    WOLFSSL_BIO * bio,
    WOLFSSL_EVP_PKEY ** pkey,
    pem_password_cb * cb,
    void * u );
