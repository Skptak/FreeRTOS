...
WOLFSSL_API WOLFSSL_OCSP_CERTID * wolfSSL_OCSP_cert_to_id(
    const WOLFSSL_EVP_MD * dgst,
    const WOLFSSL_X509 * subject,
    const WOLFSSL_X509 * issuer );

WOLFSSL_API void wolfSSL_OCSP_BASICRESP_free(
    WOLFSSL_OCSP_BASICRESP * basicResponse );
...
WOLFSSL_API OcspResponse * wolfSSL_d2i_OCSP_RESPONSE_bio(
    WOLFSSL_BIO * bio,
    OcspResponse ** response );
WOLFSSL_API OcspResponse * wolfSSL_d2i_OCSP_RESPONSE(
    OcspResponse ** response,
...
WOLFSSL_API int wolfSSL_i2d_OCSP_REQUEST( OcspRequest * request,
                                          unsigned char ** data );
WOLFSSL_API WOLFSSL_OCSP_ONEREQ * wolfSSL_OCSP_request_add0_id(
    OcspRequest * req,
...
WOLFSSL_API int wolfSSL_OCSP_REQUEST_add_ext( OcspRequest * req,
                                              ...
                                              int idx );
WOLFSSL_API OcspResponse * wolfSSL_OCSP_response_create(
    int status,
