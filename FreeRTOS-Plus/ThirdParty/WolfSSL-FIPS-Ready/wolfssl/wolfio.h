...
/* Micrium uses NetSock I/O callbacks in wolfio.c */
    ...
    /* Micrium uses NetSock I/O callbacks in wolfio.c */
        ...
        #include "zlib.h"
            ...
            defined( WOLFSSL_RENESAS_RA6M3 ) /* Uses FREERTOS_TCP */
            #include <errno.h>
        #endif
...
int net_recv( int, void *, int, unsigned int );
    ...
    #elif defined( FREERTOS_TCP )
        #define RECV_FUNCTION( a, b, c, d )    \
            FreeRTOS_recv( ( Socket_t ) ( a ), \
                           ( void * ) ( b ),   \
                           ( size_t ) ( c ),   \
                           ( BaseType_t ) ( d ) )
        #define SEND_FUNCTION( a, b, c, d )    \
            FreeRTOS_send( ( Socket_t ) ( a ), \
                           ( void * ) ( b ),   \
                           ( size_t ) ( c ),   \
                           ( BaseType_t ) ( d ) )
    #elif defined( WOLFSSL_VXWORKS )
