...
#define SSL_get_cipher_list( ctx, i ) \
    wolfSSL_get_cipher_list_ex( ( ctx ), ( i ) )
...
#define X509_F_X509_CHECK_PRIVATE_KEY 128
    ...
    #define SSL_CTX_use_PrivateKey_file  wolfSSL_CTX_use_PrivateKey_file
        ...
        #define SSL_CTX_load_verify_locations( ctx, file, path ) \
            wolfSSL_CTX_load_verify_locations_ex( ctx,           \
                                                  file,          \
                                                  path,          \
...
#define X509_STORE_set_verify_cb( s, c ) \
    wolfSSL_X509_STORE_set_verify_cb(    \
        ( WOLFSSL_X509_STORE * ) ( s ),  \
        ( WOLFSSL_X509_STORE_CTX_verify_cb ) ( c ) )
...
#define ASN1_STRING_print( x, y )                       \
    wolfSSL_ASN1_STRING_print( ( WOLFSSL_BIO * ) ( x ), \
...
#define SSL_CTX_get_cert_store( x ) \
    wolfSSL_CTX_get_cert_store( ( WOLFSSL_CTX * ) ( x ) )
...
#else
    #define PEMerr( func, reason ) \
        WOLFSSL_ERROR_LINE( ( reason ), NULL, __LINE__, __FILE__, NULL )
#endif
...
#define DTLSv1_get_timeout( ssl, timeleft ) \
    wolfSSL_DTLSv1_get_timeout( ( ssl ), ( WOLFSSL_TIMEVAL * ) ( timeleft ) )
#define DTLSv1_handle_timeout wolfSSL_DTLSv1_handle_timeout
#define DTLSv1_set_initial_timeout_duration \
    wolfSSL_DTLSv1_set_initial_timeout_duration

#ifndef NO_WOLFSSL_STUB
    #define SSL_CTX_set_current_time_cb( ssl, cb ) \
        ( {                                        \
            ( void ) ssl;                          \
            ( void ) cb;                           \
        } )
...
#define sk_SSL_CIPHER_find wolfSSL_sk_SSL_CIPHER_find
    ...
    #define SSL_set_mode( ssl, op ) \
        wolfSSL_ctrl( ( ssl ), SSL_CTRL_MODE, ( op ), NULL )
    ...
    #define SSL_CTX_set_app_data( ctx, arg ) \
        wolfSSL_CTX_set_ex_data( ctx, 0, ( char * ) ( arg ) )
...
#define DTLS1_2_VERSION                          0xFEFD
    ...
    #define sk_ACCESS_DESCRIPTION_pop_free \
...
#define SSL_CTX_get_default_passwd_cb_userdata \
 ...
 */
#define ERR_GET_FUNC( l ) \
    ( int ) ( ( ( ( unsigned long ) l ) >> 12L ) & 0xfffL )
...
#define ERR_LIB_ASN1                    12
    ...
    #define SSL_CTX_set_next_proto_select_cb \
        wolfSSL_CTX_set_next_proto_select_cb
