...
typedef STACK_OF( CONF_VALUE ) *
    ( *X509V3_EXT_I2V )( struct WOLFSSL_v3_ext_method * method,
                         void * ext,
...
typedef WOLF_STACK_OF( WOLFSSL_ACCESS_DESCRIPTION )
    WOLFSSL_AUTHORITY_INFO_ACCESS;

WOLFSSL_API WOLFSSL_BASIC_CONSTRAINTS * wolfSSL_BASIC_CONSTRAINTS_new( void );
WOLFSSL_API void wolfSSL_BASIC_CONSTRAINTS_free(
