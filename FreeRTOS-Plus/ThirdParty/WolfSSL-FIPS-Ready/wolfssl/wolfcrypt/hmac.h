...
enum
{
    ...
    HMAC_MAX_ID_LEN = 32,
            ...
            #define WC_HMAC_BLOCK_SIZE WC_MAX_BLOCK_SIZE
                ...
                defined( WOLFSSL_SHA224 ) && defined( NO_SHA ) &&         \
                defined( NO_MD5 )
                #error \
                    "You have to have some kind of hash if you want to use HMAC."
            #endif
...
{
    wc_Hmac_Hash hash;
    word32 ipad[ WC_HMAC_BLOCK_SIZE / sizeof( word32 ) ]; /* same block size
                                                             all*/
