...
enum Pkcs7_Misc
{
    ...
    #endif
    MAX_RECIP_SZ = MAX_VERSION_SZ + MAX_SEQ_SZ + ASN_NAME_MAX + MAX_SN_SZ +
...
struct PKCS7
{
    ...
    byte publicKey[ MAX_RSA_INT_SZ + MAX_RSA_E_SZ ]; /* MAX RSA key size (m +
                                                        e)*/
...
WOLFSSL_API int wc_PKCS7_EncodeSignedEncryptedCompressedFPD(
    PKCS7 * pkcs7,
    byte * encryptKey,
    word32 encryptKeySz,
    byte * privateKey,
...
WOLFSSL_API int wc_PKCS7_DecodeEncryptedData( PKCS7 * pkcs7,
                                              ...
                                              byte * output,
                                              word32 outputSz );
WOLFSSL_API int wc_PKCS7_SetDecodeEncryptedCb(
    PKCS7 * pkcs7,
    CallbackDecryptContent decryptionCb );
