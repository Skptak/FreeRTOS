...
/* Have QSH : Quantum-safe Handshake */
    ...
    #define BUILD_TLS_QSH
            ...
            #undef HAVE_AES_CBC
                    ...
                    !defined( NO_SHA ) && defined( WOLFSSL_STATIC_RSA )
            ...
            !defined( NO_TLS )
                    ...
                    #if defined( WOLFSSL_STATIC_DH ) && \
                        defined( WOLFSSL_AES_128 ) && defined( HAVE_ECC )
...
#if defined( WOLFSSL_MAX_STRENGTH ) || defined( HAVE_ECC ) || !defined( NO_DH )
...
enum Misc
{
    ...
    MAX_HKDF_LABEL_SZ = OPAQUE16_LEN + OPAQUE8_LEN + PROTOCOL_LABEL_SZ +
                        MAX_LABEL_SZ + OPAQUE8_LEN + WC_MAX_DIGEST_SIZE,
    ...
    MAX_WOLFSSL_FILE_SIZE = 1024ul * 1024ul *
                            4, /* 4 mb file size alloc limit */
#endif
...
/* assumes MAX_CHAIN_DEPTH number of certificates at 2kb per certificate */
    ...
    #define MAX_CERTIFICATE_SZ \
        CERT_HEADER_SZ + ( MAX_X509_SIZE + CERT_HEADER_SZ ) * MAX_CHAIN_DEPTH
#endif
...
*/
    ...
    #define STATIC_BUFFER_LEN \
        RECORD_HEADER_SZ + RECORD_SIZE + COMP_EXTRA + MTU_EXTRA + MAX_MSG_EXTRA
#else
...
struct WOLFSSL_CIPHER
{
    ...
    unsigned int in_stack; /* TRUE if added to stack in
...
#ifndef NO_CERTS
    #if !defined NOCERTS && ( !defined( NO_WOLFSSL_CLIENT ) || \
...
#elif defined( HAVE_SNI ) || defined( HAVE_MAX_FRAGMENT ) ||        \
    defined( HAVE_TRUSTED_CA ) || defined( HAVE_TRUNCATED_HMAC ) || \
    defined( HAVE_CERTIFICATE_STATUS_REQUEST ) ||                   \
    defined( HAVE_CERTIFICATE_STATUS_REQUEST_V2 ) ||                \
    defined( HAVE_SUPPORTED_CURVES ) || defined( HAVE_ALPN ) ||     \
    defined( HAVE_QSH ) || defined( HAVE_SESSION_TICKET ) ||        \
...
struct WOLFSSL_CTX
{
    ...
    byte useSecureReneg : 1; /* when set will set WOLFSSL objects generated to
                                enable */
#endif
    ...
    CallbackEccSharedSecret EccSharedSecretCb; /* User EccVerify Callback
                                                  handler */
        #ifdef HAVE_ED25519
    ...
    CallbackRsaVerify RsaVerifyCb; /* User RsaVerify Callback handler (pub key)
                                    */
    CallbackRsaVerify RsaSignCheckCb; /* User VerifyRsaSign Callback handler
                                         (priv key) */
        #ifdef WC_RSA_PSS
...
#define PSS_RSAE_TO_PSS_PSS( macAlgo ) ( macAlgo + ( pss_sha256 - sha256_mac ) )

#define PSS_PSS_HASH_TO_MAC( macAlgo ) ( macAlgo - ( pss_sha256 - sha256_mac ) )
...
typedef int (
    *hmacfp )( WOLFSSL *, byte *, const byte *, word32, int, int, int, int );
...
struct WOLFSSL_X509
{
    ...
    byte certPolicySet;
    byte certPolicyCrit;
#endif /* (WOLFSSL_SEP || WOLFSSL_QT) && (OPENSSL_EXTRA || \
          OPENSSL_EXTRA_X509_SMALL) */
#if defined( WOLFSSL_QT ) || defined( OPENSSL_ALL )
    WOLFSSL_STACK * ext_sk;  /* Store X509_EXTENSIONS from wolfSSL_X509_get_ext
                              */
    WOLFSSL_STACK * ext_d2i; /* Store d2i extensions from
                                wolfSSL_X509_get_ext_d2i */
#endif                       /* WOLFSSL_QT || OPENSSL_ALL */
#ifdef OPENSSL_EXTRA
    WOLFSSL_ASN1_INTEGER * serialNumber; /* Stores SN from
...
static const byte client[ SIZEOF_SENDER + 1 ] = { 0x43,
                                                  0x4C,
                                                  0x4E,
                                                  0x54,
                                                  0x00 }; /* CLNT */
static const byte server[ SIZEOF_SENDER + 1 ] = { 0x53,
                                                  0x52,
                                                  0x56,
                                                  0x52,
                                                  0x00 }; /* SRVR */
