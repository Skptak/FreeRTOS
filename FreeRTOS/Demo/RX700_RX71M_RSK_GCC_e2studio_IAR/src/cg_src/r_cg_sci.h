...
#define _00_SCI_MULTI_PROCESSOR_DISABLE \
    ( 0x00U ) /* Disable multiprocessor mode */
#define _04_SCI_MULTI_PROCESSOR_ENABLE \
    ( 0x04U ) /* Enable multiprocessor mode */
...
*/
/* Clock enable (CKE) */
#define _00_SCI_INTERNAL_SCK_UNUSED \
    ( 0x00U ) /* Internal clock selected, SCK pin unused */
#define _01_SCI_INTERNAL_SCK_OUTPUT \
    ( 0x01U ) /* Internal clock selected, SCK pin as clock output */
...
#define _00_SCI_TEI_INTERRUPT_DISABLE \
    ( 0x00U ) /* TEI interrupt request disable */
#define _04_SCI_TEI_INTERRUPT_ENABLE \
    ( 0x04U ) /* TEI interrupt request enable */
/* Multi-processor interrupt enable (MPIE) */
#define _00_SCI_MP_INTERRUPT_NORMAL ( 0x00U ) /* Normal reception */
#define _08_SCI_MP_INTERRUPT_SPECIAL \
    ( 0x08U ) /* Multi-processor ID reception */
/* Receive enable (RE) */
...
#define _00_SCI_RXI_ERI_DISABLE \
    ( 0x00U ) /* Disable RXI and ERI interrupt requests */
#define _40_SCI_RXI_ERI_ENABLE \
    ( 0x40U ) /* Enable RXI and ERI interrupt requests */
...
#define _04_SCI_TRANSMIT_COMPLETE \
    ( 0x04U ) /* Character transfer has been completed */
...
#define _10_SCI_LOW_ERROR_DETECTED            \
    ( 0x10U ) /* A low error signal responded \
               */
/* Overrun error flag (ORER) */
#define _20_SCI_OVERRUN_ERROR ( 0x20U ) /* An overrun error has occurred */
/* Receive Data Full Flag (RDRF) */
#define _40_SCI_RECEIVE_DATAFULL                                       \
    ( 0x40U ) /* Data has been received normally, and transferred from \
                 RSR to RDR */
/* Transmit Data Empty Flag (TDRE) */
#define _80_SCI_TRANSMIT_DATAEMPTY \
    ( 0x80U ) /* Data is transferred from TDR to TSR */

/*
    Smart card mode register (SCMR)
*/
/* Smart card interface mode select (SMIF) */
#define _00_SCI_SERIAL_MODE                           \
    ( 0x00U ) /* Serial communications interface mode \
               */
...
/* Character length 1 */
#define _00_SCI_DATA_LENGTH_9 \
    ( 0x00U ) /* Transmit/receive in 9-bit data length */
#define _10_SCI_DATA_LENGTH_8_OR_7 \
    ( 0x10U ) /* Transmit/receive in 8-bit or 7-bit data length */
/* Base clock pulse 2 (BCP2) */
#define _00_SCI_93_128_186_512_CLK \
    ( 0x00U ) /* 93, 128, 186, or 512 clock cycles */
#define _80_SCI_32_64_256_372_CLK \
    ( 0x80U ) /* 32, 64, 256, or 372 clock cycles */
...
#define _01_SCI_ASYNC_SOURCE_TMR \
    ( 0x01U ) /* Logical AND of two clock cycles output from TMR */
/* Bit Modulation Enable (BRME) */
#define _00_SCI_BIT_MODULATION_DISABLE \
    ( 0x00U ) /* Bit rate modulation function is disabled */
#define _04_SCI_BIT_MODULATION_ENABLE \
    ( 0x04U ) /* Bit rate modulation function is enabled */
/* Asynchronous mode base clock select (ABCS) */
#define _00_SCI_16_BASE_CLOCK \
    ( 0x00U ) /* Selects 16 base clock cycles for 1 bit period */
#define _10_SCI_8_BASE_CLOCK \
    ( 0x10U ) /* Selects 8 base clock cycles for 1 bit period */
...
#define _00_SCI_BAUDRATE_SINGLE \
    ( 0x00U ) /* Baud rate generator outputs normal frequency */
#define _40_SCI_BAUDRATE_DOUBLE \
    ( 0x40U ) /* Baud rate generator doubles output frequency */
/* Asynchronous start bit edge detections select (RXDESEL) */
#define _00_SCI_LOW_LEVEL_START_BIT \
    ( 0x00U ) /* Low level on RXDn pin selected as start bit */
#define _80_SCI_FALLING_EDGE_START_BIT \
    ( 0x80U ) /* Falling edge on RXDn pin selected as start bit */

/*
    Noise filter setting register (SNFR)
*/
/* Noise filter clock select (NFCS) */
#define _00_SCI_ASYNC_DIV_1 \
    ( 0x00U ) /* Clock signal divided by 1 is used with the noise filter */
#define _01_SCI_IIC_DIV_1 \
    ( 0x01U ) /* Clock signal divided by 1 is used with the noise filter */
#define _02_SCI_IIC_DIV_2 \
    ( 0x02U ) /* Clock signal divided by 2 is used with the noise filter */
#define _03_SCI_IIC_DIV_4 \
    ( 0x03U ) /* Clock signal divided by 4 is used with the noise filter */
#define _04_SCI_IIC_DIV_8 \
    ( 0x04U ) /* Clock signal divided by 8 is used with the noise filter */

/*
    I2C mode register 1 (SIMR1)
*/
/* Simple IIC mode select (IICM) */
#define _00_SCI_SERIAL_SMART_CARD_MODE                                     \
    ( 0x00U )                                 /* Serial or smart card mode \
                                               */
...
#define _01_SCI_RX_TX_INTERRUPTS \
    ( 0x01U ) /* Use reception/transmission interrupts */
/* Clock synchronization (IICCSC) */
#define _00_SCI_NO_SYNCHRONIZATION \
    ( 0x00U ) /* No synchronization with the clock signal */
#define _02_SCI_SYNCHRONIZATION \
    ( 0x02U ) /* Synchronization with the clock signal */
/* ACK transmission data (IICACKT) */
#define _00_SCI_ACK_TRANSMISSION ( 0x00U ) /* ACK transmission */
#define _20_SCI_NACK_TRANSMISSION \
    ( 0x20U ) /* NACK transmission and reception of ACK/NACK */

/*
    I2C mode register 3 (SIMR3)
*/
/* Start condition generation (IICSTAREQ) */
#define _00_SCI_START_CONDITION_OFF \
    ( 0x00U ) /* Start condition is not generated */
#define _01_SCI_START_CONDITION_ON            \
    ( 0x01U ) /* Start condition is generated \
               */
/* Restart condition generation (IICRSTAREQ) */
#define _00_SCI_RESTART_CONDITION_OFF \
    ( 0x00U ) /* Restart condition is not generated */
#define _02_SCI_RESTART_CONDITION_ON \
    ( 0x02U ) /* Restart condition is generated */
/* Stop condition generation (IICSTPREQ) */
#define _00_SCI_STOP_CONDITION_OFF \
    ( 0x00U ) /* Stop condition is not generated */
...
#define _00_SCI_CONDITION_GENERATED \
    ( 0x00U ) /* No requests to generate conditions/conditions generated */
#define _08_SCI_GENERATION_COMPLETED \
    ( 0x08U ) /* All request generation has been completed */
/* SSDA output select (IICSDAS) */
#define _00_SCI_SSDA_DATA_OUTPUT \
    ( 0x00U ) /* SSDA output is serial data output */
#define _10_SCI_SSDA_START_RESTART_STOP_CONDITION \
    ( 0x10U ) /* SSDA output generates start, restart or stop condition */
...
#define _00_SCI_SSCL_CLOCK_OUTPUT \
    ( 0x00U ) /* SSCL output is serial clock output */
#define _40_SCI_SSCL_START_RESTART_STOP_CONDITION \
    ( 0x40U ) /* SSCL output generates start, restart or stop condition */
...
#define _00_SCI_CLOCK_NOT_INVERTED \
    ( 0x00U ) /* Clock polarity is not inverted */
