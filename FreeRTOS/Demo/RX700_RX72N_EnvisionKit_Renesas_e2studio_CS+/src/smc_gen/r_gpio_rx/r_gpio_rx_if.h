 ...
 * Description  : General Purpose I/O driver for RX MCUs. This interface file
 *has everything the user needs to use this module.
 ***********************************************************************************************************************/
/***********************************************************************************************************************
 ...
 *         : 02.09.2015 1.50    Add support for RX71M, increased the minor
 *version number to 50. :                    Added GPIO_CMD_DSCR_DISABLE and
 *GPIO_CMD_DSCR_ENABLE commands in gpio_cmd_t : 06.04.2015 1.60    Add support
 *for RX231 : 30.09.2015 1.70    Add support for RX23T : 01.10.2015 1.80    Add
 *support for RX130 : 01.12.2015 1.90    Add support for RX24T : 01.02.2016 2.00
 *Add support for RX230 : 15.06.2016 2.01    Added the demo of the RX64M group.
...
/* Include specifics for chosen MCU. Go to the header file for your MCU to see
...
Typedef definitions
***********************************************************************************************************************/
/* The gpio_port_t and gpio_port_pin_t enums are located in the 'targets' folder
 * for each MCU. For example, to see these enums for a RX111 look at the
 * following file: r_gpio_rx/src/targets/rx111/r_gpio_rx111.h
 */
