 ...
 * Description  : This is a file for integrating the definitions of built-in
 *functions that differ for each compilers. Replace different functions for each
 *compiler.
 ***********************************************************************************************************************/
/**********************************************************************************************************************
 ...
 *         : 31.07.2019 1.11     Modified the compile condition of the below
 *functions.
 *                               - R_BSP_InitTFU
 *                               - R_BSP_CalcSine_Cosine
 *                               - R_BSP_CalcAtan_SquareRoot
 *         : 08.10.2019 1.12     Modified the followind definition of intrinsic
 *function of TFU for ICCRX.
 *                               - R_BSP_INIT_TFU
 *                               - R_BSP_SINCOSF
 *                               - R_BSP_ATAN2HYPOTF
...
/* Multiple inclusion prevention macro */
    ...
    /* ---------- Maximum value and minimum value ---------- */
        ...
        #define R_BSP_MAX( x, y ) \
            max( ( signed long ) ( x ), ( signed long ) ( y ) )
        /* signed long min(signed long data1, signed long data2) */
        #define R_BSP_MIN( x, y ) \
            min( ( signed long ) ( x ), ( signed long ) ( y ) )

    #elif defined( __GNUC__ )

        /* signed long R_BSP_Max(signed long data1, signed long data2) (This
         * macro uses API function of BSP.) */
        #define R_BSP_MAX( x, y ) \
            R_BSP_Max( ( signed long ) ( x ), ( signed long ) ( y ) )
        /* signed long R_BSP_Min(signed long data1, signed long data2) (This
         * macro uses API function of BSP.) */
        #define R_BSP_MIN( x, y ) \
            R_BSP_Min( ( signed long ) ( x ), ( signed long ) ( y ) )

    #elif defined( __ICCRX__ )

        /* signed long   __MAX(signed long, signed long) */
        #define R_BSP_MAX( x, y ) \
            __MAX( ( signed long ) ( x ), ( signed long ) ( y ) )
        /* signed long   __MIN(signed long, signed long) */
        #define R_BSP_MIN( x, y ) \
            __MIN( ( signed long ) ( x ), ( signed long ) ( y ) )
    ...
    /* ---------- Byte switch ---------- */
        ...
        #define R_BSP_REVW( x ) \
            ( unsigned long ) __builtin_rx_revw( ( int ) ( x ) )
    ...
    /* ---------- Data Exchange ---------- */
        ...
        #define R_BSP_EXCHANGE( x, y ) \
            xchg( ( signed long * ) ( x ), ( signed long * ) ( y ) )

    #elif defined( __GNUC__ )

        /* void __builtin_rx_xchg (int *, int *) */
        #define R_BSP_EXCHANGE( x, y ) \
            __builtin_rx_xchg( ( int * ) ( x ), ( int * ) ( y ) )

    #elif defined( __ICCRX__ )

        /* void _builtin_xchg(signed long *, signed long *) */
        #define R_BSP_EXCHANGE( x, y ) \
            _builtin_xchg( ( signed long * ) ( x ), ( signed long * ) ( y ) )
    ...
    /* ---------- Multiply-and-accumulate operation ---------- */
        ...
        /* long long rmpab(long long init, unsigned long count, signed char
         * *addr1, signed char *addr2) */
        #define R_BSP_RMPAB( w, x, y, z )   \
            rmpab( ( long long ) ( w ),     \
                   ( unsigned long ) ( x ), \
                   ( signed char * ) ( y ), \
                   ( signed char * ) ( z ) )
        /* long long rmpaw(long long init, unsigned long count, short *addr1,
         * short *addr2) */
        #define R_BSP_RMPAW( w, x, y, z )   \
            rmpaw( ( long long ) ( w ),     \
                   ...
                   ( short * ) ( y ),       \
                   ( short * ) ( z ) )
        /* long long rmpal(long long init, unsigned long count, long *addr1,
         * long *addr2) */
        ...
        /* long long R_BSP_MulAndAccOperation_B(long long init, unsigned long
           count, signed char *addr1, signed char *addr2) (This macro uses API
           function of BSP.) */
        #define R_BSP_RMPAB( w, x, y, z )                        \
            R_BSP_MulAndAccOperation_B( ( long long ) ( w ),     \
                                        ...
                                        ( signed char * ) ( y ), \
                                        ( signed char * ) ( z ) )
        /* long long R_BSP_MulAndAccOperation_W(long long init, unsigned long
           count, short *addr1, short *addr2) (This macro uses API function of
           BSP.) */
        #define R_BSP_RMPAW( w, x, y, z )                        \
            R_BSP_MulAndAccOperation_W( ( long long ) ( w ),     \
                                        ...
                                        ( short * ) ( y ),       \
                                        ( short * ) ( z ) )
        /* long long R_BSP_MulAndAccOperation_L(long long init, unsigned long
           count, long *addr1, long *addr2) (This macro uses API function of
           BSP.) */
        #define R_BSP_RMPAL( w, x, y, z )                        \
            R_BSP_MulAndAccOperation_L( ( long long ) ( w ),     \
                                        ( unsigned long ) ( x ), \
                                        ( long * ) ( y ),        \
                                        ( long * ) ( z ) )
    ...
    /* ---------- Rotation ---------- */
        ...
        #define R_BSP_ROTL( x, y ) \
            rotl( ( unsigned long ) ( x ), ( unsigned long ) ( y ) )
        /* unsigned long rotr (unsigned long data, unsigned long num) */
        #define R_BSP_ROTR( x, y ) \
            rotr( ( unsigned long ) ( x ), ( unsigned long ) ( y ) )

    #elif defined( __GNUC__ )

        /* unsigned long R_BSP_RotateLeftWithCarry(unsigned long data) (This
         * macro uses API function of BSP.) */
        #define R_BSP_ROLC( x ) \
            R_BSP_RotateLeftWithCarry( ( unsigned long ) ( x ) )
        /* unsigned long R_BSP_RotateRightWithCarry(unsigned long data) (This
         * macro uses API function of BSP.) */
        #define R_BSP_RORC( x ) \
            R_BSP_RotateRightWithCarry( ( unsigned long ) ( x ) )
        /* unsigned long R_BSP_RotateLeft(unsigned long data, unsigned long num)
         * (This macro uses API function of BSP.) */
        #define R_BSP_ROTL( x, y ) \
            R_BSP_RotateLeft( ( unsigned long ) ( x ), ( unsigned long ) ( y ) )
        /* unsigned long R_BSP_RotateRight (unsigned long data, unsigned long
         * num) (This macro uses API function of BSP.) */
        #define R_BSP_ROTR( x, y )                      \
            R_BSP_RotateRight( ( unsigned long ) ( x ), \
                               ( unsigned long ) ( y ) )
        ...
        #define R_BSP_ROTL( x, y ) \
            __ROTL( ( unsigned long ) ( y ), ( unsigned long ) ( x ) )
        /* unsigned long __ROTR(unsigned long, unsigned long) */
        #define R_BSP_ROTR( x, y ) \
            __ROTR( ( unsigned long ) ( y ), ( unsigned long ) ( x ) )
    ...
    /* ---------- Processor interrupt priority level (IPL) ---------- */
        ...
        /* uint32_t R_BSP_CpuInterruptLevelRead (void) (This macro uses API
         * function of BSP.) */
    ...
    /* ---------- Floating-point status word (FPSW) ---------- */
            ...
            #define R_BSP_SET_FPSW( x ) \
                __set_FPSW_register( ( unsigned long ) ( x ) )
    ...
    /* ---------- Interrupt Table Register (INTB) ---------- */
        ...
        #define R_BSP_SET_INTB( x ) \
            __set_interrupt_table( ( unsigned long ) ( x ) )
    ...
    /* ---------- Backup PSW (BPSW) ---------- */
        ...
        /* void R_BSP_SetBPSW(uint32_t data) (This macro uses API function of
         * BSP.) */
    ...
    /* ---------- Fast Interrupt Vector Register (FINTV) ---------- */
        ...
        #define R_BSP_SET_FINTV( x ) \
            __set_FINTV_register( ( __fast_int_f ) ( x ) )
    ...
    /* ---------- Significant 64-bit multiplication ---------- */
        ...
        #define R_BSP_EMUL( x, y ) \
            emul( ( signed long ) ( x ), ( signed long ) ( y ) )
        /* unsigned long long emulu(unsigned long data1, unsigned long data2) */
        #define R_BSP_EMULU( x, y ) \
            emulu( ( unsigned long ) ( x ), ( unsigned long ) ( y ) )

    #elif defined( __GNUC__ )

        /* signed long long R_BSP_SignedMultiplication(signed long data1, signed
           long data2) (This macro uses API function of BSP.) */
        #define R_BSP_EMUL( x, y )                             \
            R_BSP_SignedMultiplication( ( signed long ) ( x ), \
                                        ( signed long ) ( y ) )
        /* unsigned long long R_BSP_UnsignedMultiplication(unsigned long data1,
           unsigned long data2) (This macro uses API function of BSP.) */
        #define R_BSP_EMULU( x, y )                                \
            R_BSP_UnsignedMultiplication( ( unsigned long ) ( x ), \
                                          ( unsigned long ) ( y ) )
    ...
    /* ---------- Processor mode (PM) ---------- */
        ...
        /* void R_BSP_ChangeToUserMode(void) (This macro uses API function of
         * BSP.) */
    ...
    /* ---------- Accumulator (ACC) ---------- */
        ...
        /* void R_BSP_SetACC(signed long long data) (This macro uses API
         * function of BSP.) */
        #define R_BSP_SET_ACC( x ) R_BSP_SetACC( ( signed long long ) ( x ) )
        /* signed long long R_BSP_GetACC(void) (This macro uses API function of
         * BSP.) */
    ...
    /* ---------- Multiply-and-accumulate operation ---------- */
        ...
        /* long R_BSP_MulAndAccOperation_2byte(short *data1, short *data2,
           unsigned long count) (This macro uses API function of BSP.) */
        #define R_BSP_MACL( x, y, z )                          \
            R_BSP_MulAndAccOperation_2byte( ( short * ) ( x ), \
                                            ( short * ) ( y ), \
                                            ( unsigned long ) ( z ) )
        /* short R_BSP_MulAndAccOperation_FixedPoint1(short *data1, short
         *data2, unsigned long count) (This macro uses API function of BSP.)
         */
        #define R_BSP_MACW1( x, y, z )                               \
            R_BSP_MulAndAccOperation_FixedPoint1( ( short * ) ( x ), \
                                                  ( short * ) ( y ), \
                                                  ( unsigned long ) ( z ) )
        /* short R_BSP_MulAndAccOperation_FixedPoint2(short *data1, short
         *data2, unsigned long count) (This macro uses API function of BSP.)
         */
        #define R_BSP_MACW2( x, y, z )                               \
            R_BSP_MulAndAccOperation_FixedPoint2( ( short * ) ( x ), \
                                                  ( short * ) ( y ), \
                                                  ( unsigned long ) ( z ) )
    ...
    /* ---------- Exception Table Register (EXTB) ---------- */
            ...
            /* void R_BSP_SetEXTB(void * data) (This macro uses API function of
             * BSP.) */
    ...
    /* ---------- Bit Manipulation ---------- */
        ...
        #define R_BSP_BIT_CLEAR( x, y ) \
            __bclr( ( unsigned char * ) ( x ), ( unsigned long ) ( y ) )
        /* void __bset(unsigned char *data, unsigned long bit) */
        #define R_BSP_BIT_SET( x, y ) \
            __bset( ( unsigned char * ) ( x ), ( unsigned long ) ( y ) )
        /* void __bnot(unsigned char *data, unsigned long bit) */
        #define R_BSP_BIT_REVERSE( x, y ) \
            __bnot( ( unsigned char * ) ( x ), ( unsigned long ) ( y ) )

    #elif defined( __GNUC__ )

        /* void R_BSP_BitClear(uint8_t *data, uint32_t bit) (This macro uses API
         * function of BSP.) */
        #define R_BSP_BIT_CLEAR( x, y ) \
            R_BSP_BitClear( ( uint8_t * ) ( x ), ( uint32_t ) ( y ) )
        /* void R_BSP_BitSet(uint8_t *data, uint32_t bit) (This macro uses API
         * function of BSP.) */
        #define R_BSP_BIT_SET( x, y ) \
            R_BSP_BitSet( ( uint8_t * ) ( x ), ( uint32_t ) ( y ) )
        /* void R_BSP_BitReverse(uint8_t *data, uint32_t bit) (This macro uses
         * API function of BSP.) */
        #define R_BSP_BIT_REVERSE( x, y ) \
            R_BSP_BitReverse( ( uint8_t * ) ( x ), ( uint32_t ) ( y ) )
        ...
        #define R_BSP_BIT_REVERSE( x, y ) \
             ...
             * ---------- */
                ...
                #define R_BSP_SET_DPSW( x ) \
                    __set_dpsw( ( unsigned long ) ( x ) )
                /* unsigned long get_dpsw(void) */
                #define R_BSP_GET_DPSW() __get_dpsw()

            #elif defined( __GNUC__ )

                /* void R_BSP_SetDPSW(uint32_t data) (This macro uses API
                 * function of BSP.) */
                #define R_BSP_SET_DPSW( x ) R_BSP_SetDPSW( ( uint32_t ) ( x ) )
                /* uint32_t R_BSP_GetDPSW(void) (This macro uses API function of
                 * BSP.) */
            ...
            /* ---------- Double-precision floating-point exception handling
             * operation control register (DECNT) ---------- */
            #if defined( __CCRX__ )

                /* void __set_decnt(unsigned long data) */
                #define R_BSP_SET_DECNT( x ) \
                    __set_decnt( ( unsigned long ) ( x ) )
                /* unsigned long __get_decnt(void) */
                #define R_BSP_GET_DECNT() __get_decnt()

            #elif defined( __GNUC__ )

                /* void R_BSP_SetDECNT(uint32_t data) (This macro uses API
                 * function of BSP.) */
                #define R_BSP_SET_DECNT( x ) \
                    R_BSP_SetDECNT( ( uint32_t ) ( x ) )
                /* uint32_t R_BSP_GetDECNT(void) (This macro uses API function
                 * of BSP.) */
            ...
            /* ---------- Double-precision floating-point exception program
             * counter (DEPC) ---------- */
            #if defined( __CCRX__ )
                ...
                /* void *R_BSP_GetDEPC(void) (This macro uses API function of
                 * BSP.) */
     ...
     * ---------- */
            ...
            /* Invalid for ICCRX.
               Because the initilaze function of TFU is called automatically
               when the TFU function is called. */
            #define R_BSP_INIT_TFU()

        #endif

        /* ---------- Calculating the Sine and Cosine of an angle at the same
         * time(single precision) ---------- */
        #if defined( __CCRX__ )

            /* void __sincosf(float f, float *sin, float *cos) */
            #define R_BSP_SINCOSF( x, y, z )  \
                __sincosf( ( float ) ( x ),   \
                           ( float * ) ( y ), \
                           ( float * ) ( z ) )
            ...
            /* void R_BSP_CalcSine_Cosine(float f, float *sin, float *cos) (This
             * macro uses API function of BSP.) */
            #define R_BSP_SINCOSF( x, y, z )              \
                R_BSP_CalcSine_Cosine( ( float ) ( x ),   \
                                       ( float * ) ( y ), \
                                       ( float * ) ( z ) )
         ...
         * ---------- */
            ...
            /* void R_BSP_CalcAtan_SquareRoot(float y, float x, float *atan2,
               float *hypot) (This macro uses API function of BSP.) */
            #define R_BSP_ATAN2HYPOTF( w, x, y, z )           \
                R_BSP_CalcAtan_SquareRoot( ( float ) ( w ),   \
                                           ( float ) ( x ),   \
                                           ( float * ) ( y ), \
                                           ( float * ) ( z ) )
