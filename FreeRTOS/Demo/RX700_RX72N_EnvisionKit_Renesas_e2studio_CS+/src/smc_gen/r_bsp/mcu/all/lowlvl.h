...
***********************************************************************************************************************/
/* Output one character to standard output (the E1 Virtual Console or a serial
 * port via user own charput function) */
void charput( char output_char );

/* Input one character from standard input (the E1 Virtual Console or a serial
 * port via user own charget function) */
char charget( void );
