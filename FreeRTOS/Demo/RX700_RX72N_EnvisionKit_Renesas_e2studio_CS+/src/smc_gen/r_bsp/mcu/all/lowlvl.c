...
/* When using the user startup program, disable the following code. */
    ...
    ***********************************************************************************************************************/
    #define BSP_PRV_E1_DBG_PORT \
        ( *( volatile st_dbg_t R_BSP_EVENACCESS_SFR * ) 0x84080 )
...
/* If user has indicated they want to provide their own charput function then
 * this is the prototype. */
void BSP_CFG_USER_CHARPUT_FUNCTION( char output_char );
    #endif

    #if BSP_CFG_USER_CHARGET_ENABLED != 0
/* If user has indicated they want to provide their own charget function then
 * this is the prototype. */
