...
bsp_int_err_t bsp_interrupt_enable_disable( bsp_int_src_t vector, bool enable )
{
    ...
    switch( vector )
    {
        case( BSP_INT_SRC_BUS_ERROR ):
            if( true == enable )
            {
                /* Enable the bus error interrupt to catch accesses to
                 * illegal/reserved areas of memory */
                /* Clear any pending interrupts */
                IR( BSC, BUSERR ) = 0;

                /* Make this the highest priority interrupt (adjust as necessary
        ...
        case( BSP_INT_SRC_EXC_FPU ):
            ...
            if( true == enable )
            {
                ...
                R_BSP_SET_FPSW(
                    ( tmp_fpsw | ( uint32_t ) BSP_PRV_FPU_EXCEPTIONS_ENABLE ) );
            }
            else
            {
 ...
 * Description  : Interrupt handler for Group BL0 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
 *peripheral. Arguments    : None Return Value : None
 ***********************************************************************************************************************/
R_BSP_ATTRIB_STATIC_INTERRUPT void group_bl0_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPBL0.BIT.IS1 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI0_ERI0,
    ...
    if( 1 == ICU.GRPBL0.BIT.IS0 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI0_TEI0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS2 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI1_TEI1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS5 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI2_ERI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS4 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI2_TEI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS7 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI3_ERI3,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS6 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI3_TEI3,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS9 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI4_ERI4,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS8 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI4_TEI4,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS11 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI5_ERI5,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS10 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI5_TEI5,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS13 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI6_ERI6,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS12 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI6_TEI6,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS17 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_ERI12,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS16 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_TEI12,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS18 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_SCIX0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS19 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_SCIX1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS20 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_SCIX2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS21 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_SCI12_SCIX3,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS24 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_QSPI_QSPSSLI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS26 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_CAC_FERRI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS27 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_CAC_MENDI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS28 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_CAC_OVFI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS29 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_DOC_DOPCI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL0.BIT.IS31 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL0_PDC_PCERI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
 ...
 * Description  : Interrupt handler for Group BL1 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_bl1_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPBL1.BIT.IS4 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_SDHI_CACI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS6 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_MMCIF_CDETIO,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS7 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_MMCIF_ERRIO,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS8 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_MMCIF_ACCIO,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS9 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_POE3_OEI1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS10 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_POE3_OEI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS11 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_POE3_OEI3,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS12 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_POE3_OEI4,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS14 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC0_EEI0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS13 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC0_TEI0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS16 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC2_EEI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS15 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC2_TEI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS17 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_SSIE0_SSIF0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS18 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_SSIE1_SSIF1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS29 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC1_EEI1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL1.BIT.IS28 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL1_RIIC1_TEI1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_bl2_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPBL2.BIT.IS7 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL2_POEG_POEGGAI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL2.BIT.IS8 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL2_POEG_POEGGBI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL2.BIT.IS9 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL2_POEG_POEGGCI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBL2.BIT.IS10 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BL2_POEG_POEGGDI,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
 ...
 * Description  : Interrupt handler for Group AL0 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al0_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPAL0.BIT.IS1 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI8_ERI8,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS0 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI8_TEI8,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS5 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI9_ERI9,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS4 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI9_TEI9,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS9 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI10_ERI10,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS8 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI10_TEI10,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS13 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI11_ERI11,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS12 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI11_TEI11,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS17 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI0_SPEI0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS16 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI0_SPII0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS19 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI1_SPEI1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS18 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI1_SPII1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS21 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI2_SPEI2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS20 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_RSPI2_SPII2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS23 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI7_ERI7,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL0.BIT.IS22 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL0_SCI7_TEI7,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
 ...
 * Description  : Interrupt handler for Group AL1 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al1_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPAL1.BIT.IS0 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_EPTPC_MINT,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS1 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_PTPEDMAC_PINT,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS5 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_EDMAC1_EINT1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS9 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_GLCDC_GR1UF,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS10 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_GLCDC_GR2UF,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS8 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_GLCDC_VPOS,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPAL1.BIT.IS11 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_AL1_DRW2D_DRW_IRQ,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
 ...
 * Description  : Interrupt handler for Group IE0 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_ie0_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPIE0.BIT.IS0 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_IE0_DPFPU_DPFPUEX,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
 ...
 * Description  : Interrupt handler for Group BE0 interrupts. The way this code
 *works is that for each possible interrupt in this group the following will be
 *performed: 1) Test to see if an interrupt is requested for this source 2) If
 *an interrupt is requested then the registered callback is called (if one is
 *registered) NOTE: The interrupt request flag must be cleared in the
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_be0_handler_isr( void )
{
    ...
    if( 1 == ICU.GRPBE0.BIT.IS0 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BE0_CAN0_ERS0,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBE0.BIT.IS1 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BE0_CAN1_ERS1,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
    ...
    if( 1 == ICU.GRPBE0.BIT.IS2 )
    {
        ...
        R_BSP_InterruptControl( BSP_INT_SRC_BE0_CAN2_ERS2,
                                BSP_INT_CMD_CALL_CALLBACK,
                                FIT_NO_PTR );
    }
