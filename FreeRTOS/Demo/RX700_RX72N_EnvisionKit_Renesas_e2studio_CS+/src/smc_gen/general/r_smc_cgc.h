...
#define _00_CGC_MAINOSC_NOT_CONTROLLED \
    ( 0x00U ) /* Oscillator is not controlled by this bit */
#define _01_CGC_MAINOSC_FORCE_OSCILLATED \
    ( 0x01U ) /* The main clock oscillator is forcedly oscillated */
