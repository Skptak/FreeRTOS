 ...
 * Description  : This function Used to set the fast interrupt or group
 *interrupt Arguments    : None Return Value : None
 ***********************************************************************************************************************/

void R_Interrupt_Create( void )
{
    /* No fast interrupt and group settings have been configured in the
     * Interrupts tab. */
}
