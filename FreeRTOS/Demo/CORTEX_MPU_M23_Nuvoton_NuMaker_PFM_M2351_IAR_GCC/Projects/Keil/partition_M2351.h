...
/*
     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4                                  \
    FMC_NON_SECURE_BASE /* start address of SAU region 4 \
                         */
...
__STATIC_INLINE void TZ_SAU_Setup( void )
{
    ...
    //                 SCB_AIRCR_SYSRESETREQS_Pos) & SCB_AIRCR_SYSRESETREQS_Msk)
    //                 |
    ...
    SCB->ICSR = ( SCB->ICSR & ~( SCB_ICSR_STTNS_Msk ) ) |
                ( ( SCB_ICSR_STTNS_VAL << SCB_ICSR_STTNS_Pos ) &
                  SCB_ICSR_STTNS_Msk );
