...
__PACKED_STRUCT T_UINT16_READ
{
    uint16_t v;
        ...
        #define __UNALIGNED_UINT16_READ( addr )                              \
            ( ( ( const struct T_UINT16_READ * ) ( const void * ) ( addr ) ) \
                  ->v )
    #endif
...
__PACKED_STRUCT T_UINT32_READ
{
    uint32_t v;
        ...
        #define __UNALIGNED_UINT32_READ( addr )                              \
            ( ( ( const struct T_UINT32_READ * ) ( const void * ) ( addr ) ) \
                  ->v )
    #endif
    #ifndef __ALIGNED
        // #warning No compiler specific solution for __ALIGNED. __ALIGNED is
        // ignored.
        #define __ALIGNED( x )
    #endif
    #ifndef __RESTRICT
        // #warning No compiler specific solution for __RESTRICT. __RESTRICT is
        // ignored.
        #define __RESTRICT
    #endif
