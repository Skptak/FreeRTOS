...
__PACKED_STRUCT T_UINT16_WRITE
{
    ...
    #define __UNALIGNED_UINT16_WRITE( addr, val )                        \
        ( void ) ( ( ( ( struct T_UINT16_WRITE * ) ( void * ) ( addr ) ) \
                         ->v ) = ( val ) )
#endif
...
__PACKED_STRUCT T_UINT32_WRITE
{
    ...
    #define __UNALIGNED_UINT32_WRITE( addr, val )                        \
        ( void ) ( ( ( ( struct T_UINT32_WRITE * ) ( void * ) ( addr ) ) \
                         ->v ) = ( val ) )
#endif
 ...
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE void __TZ_set_SP_NS(
    uint32_t topOfStack )
{
...
__attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __get_FPSCR( void )
{
        ...
        #if __has_builtin( __builtin_arm_get_fpscr ) || ( __GNUC__ > 7 ) || \
    ...
    uint32_t fpscr )
{
    #if( ( defined( __FPU_PRESENT ) && ( __FPU_PRESENT == 1U ) ) && \
         ( defined( __FPU_USED ) && ( __FPU_USED == 1U ) ) )
        #if __has_builtin( __builtin_arm_set_fpscr ) || ( __GNUC__ > 7 ) || \
            ( __GNUC__ == 7 && __GNUC_MINOR__ >= 2 )
    /* see https://gcc.gnu.org/ml/gcc-patches/2017-04/msg00443.html */
...
//}
#define __WFI()                                                                \
    __ASM volatile( "wfi" ) /* This implementation generates debug information \
                             */
...
//}
#define __WFE()                                                                \
    __ASM volatile( "wfe" ) /* This implementation generates debug information \
                             */
...
//}
#define __SEV()                                                                \
    __ASM volatile( "sev" ) /* This implementation generates debug information \
                             */
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE void __STLB(
    uint8_t value,
    volatile uint8_t * ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE void __STLH(
    uint16_t value,
    volatile uint16_t * ptr )
{
...
/**
  ...
  \param [in]    ptr  Pointer to location
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE void __STL(
    uint32_t value,
    volatile uint32_t * ptr )
{
...
#if( __ARM_FEATURE_DSP == 1 ) /* ToDo ARMCLANG: This should be ARCH >= ARMv7-M \
                                 + SIMD */
