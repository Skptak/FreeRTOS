...
*/
    ...
    #define SDH_TIMEOUT \
        ( SDH_ERR_ID | 0x01UL ) /*!< Timeout  \hideinitializer */
    #define SDH_NO_MEMORY                                  \
        ( SDH_ERR_ID | 0x02UL ) /*!< OOM  \hideinitializer \
                                 */
    ...
    #define SDH_NO_SD_CARD \
        ( SDH_ERR_ID | 0x10UL ) /*!< Card removed  \hideinitializer */
    #define SDH_ERR_DEVICE \
        ( SDH_ERR_ID | 0x11UL ) /*!< Device error  \hideinitializer */
    #define SDH_INIT_TIMEOUT \
        ( SDH_ERR_ID | 0x12UL ) /*!< Card init timeout  \hideinitializer */
    #define SDH_SELECT_ERROR \
        ( SDH_ERR_ID | 0x13UL ) /*!< Card select error  \hideinitializer */
    #define SDH_WRITE_PROTECT \
        ( SDH_ERR_ID | 0x14UL ) /*!< Card write protect  \hideinitializer */
    #define SDH_INIT_ERROR \
        ( SDH_ERR_ID | 0x15UL ) /*!< Card init error  \hideinitializer */
    #define SDH_CRC7_ERROR \
        ( SDH_ERR_ID | 0x16UL ) /*!< CRC 7 error  \hideinitializer */
    #define SDH_CRC16_ERROR \
        ( SDH_ERR_ID | 0x17UL ) /*!< CRC 16 error  \hideinitializer */
    #define SDH_CRC_ERROR \
        ( SDH_ERR_ID | 0x18UL ) /*!< CRC error  \hideinitializer */
    #define SDH_CMD8_ERROR \
        ( SDH_ERR_ID | 0x19UL ) /*!< Command 8 error  \hideinitializer */
    ...
    #define CardDetect_From_GPIO \
        ( 1UL << 8 ) /*!< Card detection pin is GPIO \hideinitializer */
    #define CardDetect_From_DAT3 \
        ( 1UL << 9 ) /*!< Card detection pin is DAT3 \hideinitializer */
...
extern SDH_INFO_T SD0;
    ...
    */
     ...
     *                           \ref SDH_INTEN_BLKDIEN_Msk / \ref
     * SDH_INTEN_CRCIEN_Msk / \ref SDH_INTEN_CDIEN_Msk / \ref
     * SDH_INTEN_CDSRC_Msk / \ref SDH_INTEN_RTOIEN_Msk / \ref
     * SDH_INTEN_DITOIEN_Msk / \ref SDH_INTEN_WKIEN_Msk
     *
     *  @return   None.
     * \hideinitializer
     */
     ...
     *                           \ref SDH_INTEN_BLKDIEN_Msk / \ref
     * SDH_INTEN_CRCIEN_Msk / \ref SDH_INTEN_CDIEN_Msk / \ref
     * SDH_INTEN_RTOIEN_Msk / \ref SDH_INTEN_DITOIEN_Msk / \ref
     * SDH_INTEN_WKIEN_Msk / \ref SDH_INTEN_CDSRC_Msk /
     *
     *  @return   None.
     * \hideinitializer
     */
     ...
     *  @param[in]    sdh    The pointer of the specified SDH module.
     *  @param[in]    u32IntMask    Interrupt type mask:
     *                           \ref SDH_INTSTS_BLKDIF_Msk / \ref
     * SDH_INTSTS_CRCIF_Msk / \ref SDH_INTSTS_CRC7_Msk / \ref
     * SDH_INTSTS_CRC16_Msk / \ref SDH_INTSTS_CRCSTS_Msk / \ref
     * SDH_INTSTS_DAT0STS_Msk / \ref SDH_INTSTS_CDIF_Msk / \ref
     * SDH_INTSTS_RTOIF_Msk / \ref SDH_INTSTS_DITOIF_Msk / \ref
     * SDH_INTSTS_CDSTS_Msk / \ref SDH_INTSTS_DAT1STS_Msk
     *
     *
     ...
     *  @param[in]    u32IntMask    Interrupt type mask:
     *                           \ref SDH_INTSTS_BLKDIF_Msk / \ref
     * SDH_INTSTS_CRCIF_Msk / \ref SDH_INTSTS_CDIF_Msk / \ref
     * SDH_INTSTS_RTOIF_Msk / \ref SDH_INTSTS_DITOIF_Msk
     *
     *
     *  @return   None.
     * \hideinitializer
    ...
    #define SDH_IS_CARD_PRESENT( sdh )                                         \
        ( ( ( ( sdh ) == SDH0 ) || ( ( sdh ) == SDH0_NS ) ) ? SD0.IsCardInsert \
                                                            : 0 )
    ...
    #define SDH_GET_CARD_CAPACITY( sdh ) \
        ( ( ( ( sdh ) == SDH0 ) || ( ( sdh ) == SDH0_NS ) ) ? SD0.diskSize : 0 )
