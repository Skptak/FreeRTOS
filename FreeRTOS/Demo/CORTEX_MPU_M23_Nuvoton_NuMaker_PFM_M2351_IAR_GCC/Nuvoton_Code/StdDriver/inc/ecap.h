...
*/
    ...
    #define ECAP_NOISE_FILTER_CLKDIV_1                                        \
        ( 0UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 1 \
                                             \hideinitializer */
    #define ECAP_NOISE_FILTER_CLKDIV_2                                        \
        ( 1UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 2 \
                                             \hideinitializer */
    #define ECAP_NOISE_FILTER_CLKDIV_4                                        \
        ( 2UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 4 \
                                             \hideinitializer */
    #define ECAP_NOISE_FILTER_CLKDIV_16                                        \
        ( 3UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 16 \
                                             \hideinitializer */
    #define ECAP_NOISE_FILTER_CLKDIV_32                                        \
        ( 4UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 32 \
                                             \hideinitializer */
    #define ECAP_NOISE_FILTER_CLKDIV_64                                        \
        ( 5UL << ECAP_CTL0_NFCLKSEL_Pos ) /*!< Noise filter clock divide by 64 \
                                             \hideinitializer */

    #define ECAP_CAP_INPUT_SRC_FROM_IC \
        ( 0UL ) /*!< CAP input source from IC             \hideinitializer */
    #define ECAP_CAP_INPUT_SRC_FROM_CH \
        ( 2UL ) /*!< CAP input source from CH of QEI      \hideinitializer */

    #define ECAP_DISABLE_COMPARE                                             \
        ( 0UL << ECAP_CTL0_CMPEN_Pos ) /*!< Input capture compare and reload \
                                          function disable \hideinitializer */
    #define ECAP_COMPARE_FUNCTION                                          \
        ( 1UL << ECAP_CTL0_CMPEN_Pos ) /*!< Input capture compare function \
                                          \hideinitializer */
    /*---------------------------------------------------------------------------------------------------------*/
    /* ECAP CTL1 constant definitions */
    /*---------------------------------------------------------------------------------------------------------*/
    #define ECAP_RISING_EDGE                                            \
        ( 0UL << ECAP_CTL1_EDGESEL0_Pos ) /*!< ECAP capture rising edge \
                                             selection \hideinitializer */
    #define ECAP_FALLING_EDGE                                            \
        ( 1UL << ECAP_CTL1_EDGESEL0_Pos ) /*!< ECAP capture falling edge \
                                             selection \hideinitializer */
    #define ECAP_RISING_FALLING_EDGE                                         \
        ( 2UL << ECAP_CTL1_EDGESEL0_Pos ) /*!< ECAP capture either rising or \
                                             falling edge selection          \
                                             \hideinitializer */

    #define ECAP_CAPTURE_TIMER_CLKDIV_1                                      \
        ( 0UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 1   \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_4                                      \
        ( 1UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 4   \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_16                                     \
        ( 2UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 16  \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_32                                     \
        ( 3UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 32  \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_64                                     \
        ( 4UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 64  \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_96                                     \
        ( 5UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 96  \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_112                                    \
        ( 6UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 112 \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLKDIV_128                                    \
        ( 7UL << ECAP_CTL1_CLKSEL_Pos ) /*!< ECAP capture timer clock divide \
                                           by 128 \hideinitializer */

    #define ECAP_CAPTURE_TIMER_CLK_SRC_CAP_CLK                           \
        ( 0UL << ECAP_CTL1_CNTSRCSEL_Pos ) /*!< ECAP capture timer/clock \
                                              source from CAP_CLK        \
                                              \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLK_SRC_CAP0                              \
        ( 1UL << ECAP_CTL1_CNTSRCSEL_Pos ) /*!< ECAP capture timer/clock \
                                              source from CAP0           \
                                              \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLK_SRC_CAP1                              \
        ( 2UL << ECAP_CTL1_CNTSRCSEL_Pos ) /*!< ECAP capture timer/clock \
                                              source from CAP1           \
                                              \hideinitializer */
    #define ECAP_CAPTURE_TIMER_CLK_SRC_CAP2                              \
        ( 3UL << ECAP_CTL1_CNTSRCSEL_Pos ) /*!< ECAP capture timer/clock \
                                              source from CAP2           \
                                              \hideinitializer */
    ...
    */
     ...
     * @return None
     * @details This macro will set the sampling frequency of the noise filter
     * cock. \hideinitializer
     */
    #define ECAP_SET_NOISE_FILTER_CLKDIV( ecap, u32ClkSel )               \
        ( ( ecap )->CTL0 = ( ( ecap )->CTL0 & ~ECAP_CTL0_NFCLKSEL_Msk ) | \
                           ( u32ClkSel ) )
    ...
    #define ECAP_NOISE_FILTER_DISABLE( ecap ) \
        ( ( ecap )->CTL0 |= ECAP_CTL0_CAPNFDIS_Msk )
     ...
     *                  - \ref ECAP_NOISE_FILTER_CLKDIV_64
     * @return None
     * @details This macro will enable the noise filter of input capture and set
     * noise filter clock divide. \hideinitializer
     */
    #define ECAP_NOISE_FILTER_ENABLE( ecap, u32ClkSel )                       \
        ( ( ecap )->CTL0 = ( ( ecap )->CTL0 & ~( ECAP_CTL0_CAPNFDIS_Msk |     \
     ...
     * @param[in] ecap      Specify ECAP port
     * @return None
     * @details This macro will enable the input channel compare-match
     * interrupt. \hideinitializer
     */
    #define ECAP_ENABLE_CMP_MATCH_INT( ecap ) \
        ( ( ecap )->CTL0 |= ECAP_CTL0_CMPIEN_Msk )

    /**
     * @brief This macro is used to disable input channel compare-match
     * interrupt
     * @param[in] ecap      Specify ECAP port
     * @return None
     * @details This macro will disable the input channel compare-match
     * interrupt. \hideinitializer
     */
    ...
    /**
      ...
      * @return None
      * @details This macro will enable and select compare or capture event that
      can clear capture counter.
      * \hideinitializer
      */
     ...
     * @return None
     * @details This macro will select input capture can detect falling edge,
     * rising edge or either rising or falling edge change. \hideinitializer
     */
    ...
    #define ECAP_SEL_RELOAD_TRIG_SRC( ecap, u32TrigSrc ) \
        ( ( ecap )->CTL1 = ( ( ecap )->CTL1 & ~0xF00 ) | ( u32TrigSrc ) )
     ...
     * @return None
     * @details This macro will select capture timer clock has a pre-divider
     * with eight divided option. \hideinitializer
     */
    #define ECAP_SEL_TIMER_CLK_DIV( ecap, u32Clkdiv )                   \
        ( ( ecap )->CTL1 = ( ( ecap )->CTL1 & ~ECAP_CTL1_CLKSEL_Msk ) | \
                           ( u32Clkdiv ) )
    ...
    #define ECAP_SEL_TIMER_CLK_SRC( ecap, u32ClkSrc )                      \
        ( ( ecap )->CTL1 = ( ( ecap )->CTL1 & ~ECAP_CTL1_CNTSRCSEL_Msk ) | \
                           ( u32ClkSrc ) )
     ...
     * @return None
     * @details This macro will write 1 to get the input channel_n interrupt
     * flag. \hideinitializer
     */
    #define ECAP_GET_CAPTURE_FLAG( ecap, u32Mask ) \
        ( ( ( ecap )->STATUS & ( u32Mask ) ) ? 1 : 0 )
     ...
     *                  - \ref ECAP_STATUS_CAPCMPF_Msk
     * @return None
     * @details This macro will write 1 to clear the input channel_n interrupt
     * flag. \hideinitializer
     */
    ...
    #define ECAP_GET_CNT_HOLD_VALUE( ecap, u32Index ) \
        ( *( __IO uint32_t * ) ( &( ( ecap )->HLD0 ) + ( u32Index ) ) )
