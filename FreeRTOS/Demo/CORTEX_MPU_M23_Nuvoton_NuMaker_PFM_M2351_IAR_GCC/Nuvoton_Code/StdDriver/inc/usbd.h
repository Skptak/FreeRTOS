...
extern const S_USBD_INFO_T gsInfo;
    ...
    */
    #define USBD_BUF_BASE                                                   \
        ( uint32_t )( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )               \
                          ? ( USBD_BASE + NS_OFFSET + 0x100UL )             \
                          : ( USBD_BASE + 0x100UL ) ) /*!< USBD buffer base \
                                                         address */
...
/******************************************************************************/
    ...
    #define USBD_INT_FLDET \
        USBD_INTEN_VBDETIEN_Msk /*!< USB VBUS Detection Interrupt */
    #define USBD_INT_WAKEUP         \
        ( USBD_INTEN_NEVWKIEN_Msk | \
          USBD_INTEN_WKEN_Msk ) /*!< USB No-Event-Wake-Up Interrupt */

    #define USBD_INTSTS_WAKEUP \
        USBD_INTSTS_NEVWKIF_Msk /*!< USB No-Event-Wake-Up Interrupt Status */
    #define USBD_INTSTS_FLDET \
        USBD_INTSTS_VBDETIF_Msk /*!< USB Float Detect Interrupt Status */
    #define USBD_INTSTS_BUS \
        USBD_INTSTS_BUSIF_Msk /*!< USB Bus Event Interrupt Status */
    #define USBD_INTSTS_USB \
        USBD_INTSTS_USBIF_Msk /*!< USB Event Interrupt Status */
    #define USBD_INTSTS_SETUP USBD_INTSTS_SETUP_Msk /*!< USB Setup Event */
    #define USBD_INTSTS_EP0                              \
        USBD_INTSTS_EPEVT0_Msk /*!< USB Endpoint 0 Event \
                                */
    #define USBD_INTSTS_EP1                              \
        USBD_INTSTS_EPEVT1_Msk /*!< USB Endpoint 1 Event \
                                */
    #define USBD_INTSTS_EP2                              \
        USBD_INTSTS_EPEVT2_Msk /*!< USB Endpoint 2 Event \
                                */
    #define USBD_INTSTS_EP3                              \
        USBD_INTSTS_EPEVT3_Msk /*!< USB Endpoint 3 Event \
                                */
    #define USBD_INTSTS_EP4                              \
        USBD_INTSTS_EPEVT4_Msk /*!< USB Endpoint 4 Event \
                                */
    #define USBD_INTSTS_EP5                              \
        USBD_INTSTS_EPEVT5_Msk /*!< USB Endpoint 5 Event \
                                */
    #define USBD_INTSTS_EP6                              \
        USBD_INTSTS_EPEVT6_Msk /*!< USB Endpoint 6 Event \
                                */
    #define USBD_INTSTS_EP7                              \
        USBD_INTSTS_EPEVT7_Msk /*!< USB Endpoint 7 Event \
                                */
    #define USBD_INTSTS_EP8                              \
        USBD_INTSTS_EPEVT8_Msk /*!< USB Endpoint 8 Event \
                                */
    #define USBD_INTSTS_EP9                              \
        USBD_INTSTS_EPEVT9_Msk /*!< USB Endpoint 9 Event \
                                */
    #define USBD_INTSTS_EP10 \
        USBD_INTSTS_EPEVT10_Msk /*!< USB Endpoint 10 Event */
    #define USBD_INTSTS_EP11 \
        USBD_INTSTS_EPEVT11_Msk /*!< USB Endpoint 11 Event */
    ...
    #define USBD_STATE_L1SUSPEND \
        USBD_ATTR_L1SUSPEND_Msk /*!< USB Bus L1SUSPEND  */
    #define USBD_STATE_L1RESUME \
        USBD_ATTR_L1RESUME_Msk /*!< USB Bus L1RESUME   */
    ...
    #define USBD_CFG_EPMODE_DISABLE \
        ( 0UL << USBD_CFG_STATE_Pos ) /*!< Endpoint Disable */
    #define USBD_CFG_EPMODE_OUT \
        ( 1UL << USBD_CFG_STATE_Pos ) /*!< Out Endpoint */
    #define USBD_CFG_EPMODE_IN                         \
        ( 2UL << USBD_CFG_STATE_Pos ) /*!< In Endpoint \
                                       */
    #define USBD_CFG_TYPE_ISO                          \
        ( 1UL << USBD_CFG_ISOCH_Pos ) /*!< Isochronous \
                                       */
    ...
    */
    ...
    #define USBD_ENABLE_USB()                               \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )           \
              ? ( ( uint32_t ) ( USBD_NS->ATTR |= 0x7D0 ) ) \
              : ( ( uint32_t ) ( USBD->ATTR |= 0x7D0 ) ) )
    ...
    #define USBD_DISABLE_USB()                                     \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                  \
              ? ( ( uint32_t ) ( USBD_NS->ATTR &= ~USBD_USB_EN ) ) \
              : ( ( uint32_t ) ( USBD->ATTR &= ~USBD_USB_EN ) ) )
    ...
    #define USBD_ENABLE_PHY()                                     \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                 \
              ? ( ( uint32_t ) ( USBD_NS->ATTR |= USBD_PHY_EN ) ) \
              : ( ( uint32_t ) ( USBD->ATTR |= USBD_PHY_EN ) ) )
     ...
     * @return   None
     *
     * @details  Set DRVSE0 bit of USB_DRVSE0 register to enable
     * software-disconnect function. Force USB PHY transceiver to drive SE0 to
     * bus.
     *
     */
    #define USBD_SET_SE0()                                       \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                \
              ? ( ( uint32_t ) ( USBD_NS->SE0 |= USBD_DRVSE0 ) ) \
              : ( ( uint32_t ) ( USBD->SE0 |= USBD_DRVSE0 ) ) )
     ...
     * @return   None
     *
     * @details  Clear DRVSE0 bit of USB_DRVSE0 register to disable
     ...
     * @return     None
     *
     * @details    Enable USB related interrupt functions specified by intr
     * parameter.
     *
     */
    ...
    #define USBD_GET_INT_FLAG()                      \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )    \
              ? ( ( uint32_t ) ( USBD_NS->INTSTS ) ) \
              : ( ( uint32_t ) ( USBD->INTSTS ) ) )
     ...
     *             (USBD_INTSTS_WAKEUP, USBD_INTSTS_FLDET, USBD_INTSTS_BUS,
     * USBD_INTSTS_USB)
     *
     * @return     None
     *
     * @details    Clear USB related interrupt flags specified by flag
     * parameter.
     *
     */
    ...
    #define USBD_GET_BUS_STATE()                            \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )           \
              ? ( ( uint32_t ) ( USBD_NS->ATTR & 0x300F ) ) \
              : ( ( uint32_t ) ( USBD->ATTR & 0x300F ) ) )
     ...
     *
     * @param[in]  ep The USB endpoint ID. M2351 Series supports 12 hardware
     * endpoint ID. This parameter could be 0 ~ 11.
     *
     * @return     None
     *
     * @details    Write 1 to CLRRDY bit of USB_CFGPx register to stop USB
     * transaction of the specified endpoint ID.
     *
     */
    #define USBD_STOP_TRANSACTION( ep )                                          \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                                \
              ? ( *( ( __IO uint32_t * ) ( ( uint32_t ) &USBD_NS->EP[ 0 ].CFGP + \
                                           ( uint32_t ) ( ( ep ) << 4 ) ) ) |=   \
                  USBD_CFGP_CLRRDY_Msk )                                         \
              : ( *( ( __IO uint32_t * ) ( ( uint32_t ) &USBD->EP[ 0 ].CFGP +    \
                                           ( uint32_t ) ( ( ep ) << 4 ) ) ) |=   \
                  USBD_CFGP_CLRRDY_Msk ) )
     ...
     * @return     None
     *
     * @details    Set DSQ_SYNC bit of USB_CFGx register to specify the DATA1
     * PID for the following IN token transaction. Base on this setting,
     * hardware will toggle PID between DATA0 and DATA1 automatically for IN
     * token transactions.
     *
     */
    #define USBD_SET_DATA1( ep )                                                \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                               \
              ? ( *( ( __IO uint32_t * ) ( ( uint32_t ) &USBD_NS->EP[ 0 ].CFG + \
                                           ( uint32_t ) ( ( ep ) << 4 ) ) ) |=  \
                  USBD_CFG_DSQSYNC_Msk )                                        \
              : ( *( ( __IO uint32_t * ) ( ( uint32_t ) &USBD->EP[ 0 ].CFG +    \
                                           ( uint32_t ) ( ( ep ) << 4 ) ) ) |=  \
                  USBD_CFG_DSQSYNC_Msk ) )
     ...
     * @return     None
     *
     * @details    Clear DSQ_SYNC bit of USB_CFGx register to specify the DATA0
     * PID for the following IN token transaction. Base on this setting,
     * hardware will toggle PID between DATA0 and DATA1 automatically for IN
     * token transactions.
     *
     ...
     * @return     None
     *
     * @details    This macro will write the transfer length to USB_MXPLDx
     * register for IN data transaction.
     *
     */
    #define USBD_SET_PAYLOAD_LEN( ep, size )                                     \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                                \
              ? ( *( (                                                           \
                      __IO uint32_t * ) ( ( uint32_t ) &USBD_NS->EP[ 0 ].MXPLD + \
                                          ( uint32_t ) ( ( ep )                  \
                                                         << 4 ) ) ) = ( size ) ) \
              : ( *( (                                                           \
                      __IO uint32_t * ) ( ( uint32_t ) &USBD->EP[ 0 ].MXPLD +    \
                                          ( uint32_t ) ( ( ep )                  \
                                                         << 4 ) ) ) = ( size ) ) )
     ...
     *
     * @details    Get the data length of OUT data transaction by reading
     * USB_MXPLDx register.
     *
     */
     ...
     * @return     None
     *
     * @details    This macro will write config parameter to USB_CFGx register
     * of specified endpoint ID.
     *
     */
     ...
     * @return     None
     *
     * @details    This macro will set the SRAM offset for the specified
     * endpoint ID.
     *
     */
    #define USBD_SET_EP_BUF_ADDR( ep, offset )                                     \
        ( ( ( __PC() & NS_OFFSET ) == NS_OFFSET )                                  \
              ? ( *( (                                                             \
                      __IO uint32_t * ) ( ( uint32_t ) &USBD_NS->EP[ 0 ]           \
                                              .BUFSEG +                            \
                                          ( uint32_t ) ( ( ep )                    \
                                                         << 4 ) ) ) = ( offset ) ) \
              : ( *( ( __IO uint32_t * ) ( ( uint32_t ) &USBD->EP[ 0 ].BUFSEG +    \
                                           ( uint32_t ) ( ( ep ) << 4 ) ) ) =      \
                      ( offset ) ) )
     ...
     *
     * @details    This macro will return the SRAM offset of the specified
     * endpoint ID.
     *
     */
     ...
     * @return      None
     *
     * @details     Set USB endpoint stall state for the specified endpoint ID.
     * Endpoint will respond STALL token automatically.
     *
     */
     ...
     * @return      None
     *
     * @details     Clear USB endpoint stall state for the specified endpoint
     * ID. Endpoint will respond ACK/NAK token.
     */
 ...
 * @return     None
 *
 * @details    This function will copy the number of data specified by size and
 * src parameters to the address specified by dest parameter.
 *
 */
 ...
 * @return      None
 *
 * @details     Set USB endpoint stall state. Endpoint will respond STALL token
 * automatically.
 *
 */
__STATIC_INLINE void USBD_SetStall( uint8_t epnum )
{
    ...
    {
        u32CfgAddr = ( uint32_t ) ( i << 4 ) +
                     ( uint32_t ) &pUSBD->EP[ 0 ].CFG; /* USBD_CFG0 */
        u32Cfg = *( ( __IO uint32_t * ) ( u32CfgAddr ) );

        if( ( u32Cfg & 0xFUL ) == epnum )
        {
            u32CfgAddr = ( uint32_t ) ( i << 4 ) +
                         ( uint32_t ) &pUSBD->EP[ 0 ].CFGP; /* USBD_CFGP0 */
            u32Cfg = *( ( __IO uint32_t * ) ( u32CfgAddr ) );
 ...
 * @return      None
 *
 * @details     Clear USB endpoint stall state. Endpoint will respond ACK/NAK
 * token.
 */
...
typedef void ( *VENDOR_REQ )( void ); /*!< Functional pointer type definition
                                         for Vendor class */
typedef void ( *CLASS_REQ )( void );  /*!< Functional pointer type declaration
                                         for USB class request callback handler
                                       */
typedef void ( *SET_INTERFACE_REQ )(
    uint32_t u32AltInterface ); /*!< Functional pointer type declaration for USB
                                   set interface request callback handler */
typedef void ( *SET_CONFIG_CB )( void ); /*!< Functional pointer type
                                            declaration for USB set
                                            configuration request callback
                                            handler */
