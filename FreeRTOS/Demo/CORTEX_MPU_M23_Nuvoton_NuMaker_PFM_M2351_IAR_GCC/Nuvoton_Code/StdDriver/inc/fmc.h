...
extern "C" {
    ...
    */
    ...
    #define FMC_APROM_BANK0_END \
        ( FMC_APROM_END / 2UL )         /*!< APROM bank0 end address */
    ...
    #define FMC_SCRLOCK_BASE \
        0x00200804UL /*!< Secure Region Lock base address */
    ...
    #define FMC_MULTI_WORD_PROG_LEN \
        512UL /*!< The maximum length of a multi-word program.  */

    #define FMC_APROM_SIZE FMC_APROM_END /*!< APROM Size                  */
    #define FMC_BANK_SIZE \
        ( FMC_APROM_SIZE / 2UL )       /*!< APROM Bank Size             */
    ...
    #define IS_BOOT_FROM_LDROM \
        0x1UL /*!< ISPCTL setting to select to boot from LDROM */
    #define IS_BOOT_FROM_APROM \
        0x0UL /*!< ISPCTL setting to select to boot from APROM */
    ...
    #define FMC_ISPCMD_READ_UID \
        0x04UL /*!< ISP Command: Read Unique ID           */
    #define FMC_ISPCMD_READ_ALL1 \
        0x08UL /*!< ISP Command: Read all-one result      */
    #define FMC_ISPCMD_READ_CID \
        0x0BUL /*!< ISP Command: Read Company ID          */
    #define FMC_ISPCMD_READ_DID \
        0x0CUL /*!< ISP Command: Read Device ID           */
    #define FMC_ISPCMD_READ_CKS \
        0x0DUL /*!< ISP Command: Read Checksum            */
    #define FMC_ISPCMD_PROGRAM \
        0x21UL /*!< ISP Command: 32-bit Program Flash     */
    #define FMC_ISPCMD_PAGE_ERASE \
        0x22UL /*!< ISP Command: Page Erase Flash         */
    #define FMC_ISPCMD_BANK_ERASE \
        0x23UL /*!< ISP Command: Erase Flash bank 0 or 1 */
    #define FMC_ISPCMD_BLOCK_ERASE                                             \
        0x25UL /*!< ISP Command: Erase 4 pages alignment of APROM in bank 0 or \
                  1  */
    #define FMC_ISPCMD_PROGRAM_MUL \
        0x27UL /*!< ISP Command: Flash Multi-Word Program */
    #define FMC_ISPCMD_RUN_ALL1 \
        0x28UL /*!< ISP Command: Run all-one verification*/
    #define FMC_ISPCMD_RUN_CKS \
        0x2DUL /*!< ISP Command: Run Check Calculation    */
    #define FMC_ISPCMD_VECMAP \
        0x2EUL /*!< ISP Command: Set vector mapping       */
    #define FMC_ISPCMD_READ_64 0x40UL /*!< ISP Command: 64-bit read Flash */
    #define FMC_ISPCMD_PROGRAM_64 \
        0x61UL /*!< ISP Command: 64-bit program Flash     */
    ...
    #define READ_ALLONE_CMD_FAIL \
        0xFFFFFFFFUL /*!< Check-all-one command failed.        */
    ...
    */
     ...
     * @return     None
     *
     * @details    This function will set ISPEN bit of ISPCTL control register
     * to enable ISP function.
     *
     */
    #define FMC_ENABLE_ISP() \
        ( FMC->ISPCTL |= FMC_ISPCTL_ISPEN_Msk ) /*!< Enable ISP Function  */
     ...
     * @return     None
     *
     * @details    This function will clear ISPEN bit of ISPCTL control register
     * to disable ISP function.
     *
     */
    #define FMC_DISABLE_ISP() \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_ISPEN_Msk ) /*!< Disable ISP Function */
     ...
     * @return     None
     *
     * @details    This function will set LDUEN bit of ISPCTL control register
     * to enable LDROM update function. User needs to set LDUEN bit before they
     * can update LDROM.
     *
     */
    #define FMC_ENABLE_LD_UPDATE()                                       \
        ( FMC->ISPCTL |= FMC_ISPCTL_LDUEN_Msk ) /*!< Enable LDROM Update \
                                                   Function   */
    ...
    #define FMC_DISABLE_LD_UPDATE()                                        \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_LDUEN_Msk ) /*!< Disable LDROM Update \
                                                    Function  */
     ...
     * @return     None
     *
     * @details    This function will set CFGUEN bit of ISPCTL control register
     * to enable User Configuration update function. User needs to set CFGUEN
     * bit before they can update User Configuration area.
     *
     */
    #define FMC_ENABLE_CFG_UPDATE()                                        \
        ( FMC->ISPCTL |= FMC_ISPCTL_CFGUEN_Msk ) /*!< Enable CONFIG Update \
                                                    Function  */
     ...
     * @return     None
     *
     * @details    This function will clear CFGUEN bit of ISPCTL control
     * register to disable User Configuration update function.
     *
     */
    #define FMC_DISABLE_CFG_UPDATE()                                         \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_CFGUEN_Msk ) /*!< Disable CONFIG Update \
                                                     Function */
     ...
     * @return     None
     *
     * @details    This function will set APUEN bit of ISPCTL control register
     * to enable APROM update function. User needs to set APUEN bit before they
     * can update APROM in APROM boot mode.
     *
     */
    #define FMC_ENABLE_AP_UPDATE()                                       \
        ( FMC->ISPCTL |= FMC_ISPCTL_APUEN_Msk ) /*!< Enable APROM Update \
                                                   Function   */
     ...
     * @return     None
     *
     * @details    This function will clear APUEN bit of ISPCTL control register
     * to disable APROM update function.
     *
     */
    #define FMC_DISABLE_AP_UPDATE()                                        \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_APUEN_Msk ) /*!< Disable APROM Update \
                                                    Function  */
    ...
    #define FMC_SET_APROM_BOOT()                                             \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_BS_Msk ) /*!< Select booting from APROM \
                                               */
    ...
    #define FMC_SET_LDROM_BOOT() \
        ( FMC->ISPCTL |= FMC_ISPCTL_BS_Msk ) /*!< Select booting from LDROM */
     ...
     * @return     None
     *
     * @details    This function is used to get ISP fail flag when do ISP
     * actoin.
     *
     */
    #define FMC_GET_FAIL_FLAG()                                             \
        ( ( FMC->ISPCTL & FMC_ISPCTL_ISPFF_Msk ) ? 1UL : 0UL ) /*!< Get ISP \
                                                                  fail flag */
     ...
     * @return     None
     *
     * @details    This function is used to clear ISP fail flag when ISP fail
     * flag set.
     *
     */
    #define FMC_CLR_FAIL_FLAG() \
        ( FMC->ISPCTL |= FMC_ISPCTL_ISPFF_Msk ) /*!< Clear ISP fail flag */
     ...
     *
     */
    #define FMC_ENABLE_ISP_INT() \
        ( FMC->ISPCTL |= FMC_ISPCTL_INTEN_Msk ) /*!< Enable ISP interrupt */
     ...
     *
     */
    #define FMC_DISABLE_ISP_INT() \
        ( FMC->ISPCTL &= ~FMC_ISPCTL_INTEN_Msk ) /*!< Disable ISP interrupt */
     ...
     *
     */
    #define FMC_GET_ISP_INT_FLAG()                 \
        ( ( FMC->ISPSTS & FMC_ISPSTS_INTFLAG_Msk ) \
              ? 1UL                                \
              : 0UL ) /*!< Get ISP interrupt flag Status */
     ...
     *
     */
    #define FMC_CLEAR_ISP_INT_FLAG()                                      \
        ( FMC->ISPSTS = FMC_ISPSTS_INTFLAG_Msk ) /*!< Clear ISP interrupt \
                                                    flag*/
 ...
 *
 * @details     To get VECMAP value which is the page address for remapping to
 * vector page (0x0).
 *
 */
__STATIC_INLINE uint32_t FMC_GetVECMAP( void )
 ...
 *
 * @param[in]   u8Index  UID index. 0 = UID[31:0], 1 = UID[63:32], 2 =
 * UID[95:64]
 *
 ...
 * @brief      To read UCID
 *
 * @param[in]  u32Index    Index of the UCID to read. u32Index must be 0, 1, 2,
 * or 3.
 *
...
__STATIC_INLINE uint32_t FMC_ReadUCID( uint32_t u32Index )
{
    ...
    FMC->ISPADDR = ( 0x04u * u32Index ) +
                   0x10u; /* The UCID is at offset 0x10 with word alignment. */
    FMC->ISPTRG = FMC_ISPTRG_ISPGO_Msk; /* Trigger to start ISP procedure */
    #if ISBEN
    __ISB();
    #endif /* To make sure ISP/CPU be Synchronized */
 ...
 *
 * @param[in]   u32PageAddr  The page address to remap to address 0x0. The
 * address must be page alignment.
 *
...
__STATIC_INLINE void FMC_SetVectorPageAddr( uint32_t u32PageAddr )
{
    ...
    FMC->ISPADDR = u32PageAddr; /* The address of specified page which will be
                                   map to address 0x0. It must be page
                                   alignment. */
