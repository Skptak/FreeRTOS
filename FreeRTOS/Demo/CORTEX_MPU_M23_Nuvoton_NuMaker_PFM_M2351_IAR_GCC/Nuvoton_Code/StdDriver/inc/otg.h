...
extern "C" {
    ...
    */
    ...
    #define OTG_VBUS_EN_ACTIVE_HIGH \
        ( 0UL ) /*!< USB VBUS power switch enable signal is active high. */
    #define OTG_VBUS_EN_ACTIVE_LOW \
        ( 1UL ) /*!< USB VBUS power switch enable signal is active low. */
    #define OTG_VBUS_ST_VALID_HIGH \
        ( 0UL ) /*!< USB VBUS power switch valid status is high. */
    #define OTG_VBUS_ST_VALID_LOW \
        ( 1UL ) /*!< USB VBUS power switch valid status is low. */
    ...
    */
     ...
     * @param None
     * @return None
     * @details This macro will set OTGEN bit of OTG_CTL register to enable OTG
     * function.
     */
     ...
     * @param None
     * @return None
     * @details This macro will clear OTGEN bit of OTG_CTL register to disable
     * OTG function.
     */
     ...
     * @param None
     * @return None
     * @details When the USB role is selected as OTG device, use this macro to
     * enable USB PHY. This macro will set OTGPHYEN bit of OTG_PHYCTL register
     * to enable USB PHY.
     */
     ...
     * @param None
     * @return None
     * @details This macro will clear OTGPHYEN bit of OTG_PHYCTL register to
     * disable USB PHY.
     */
     ...
     * @param None
     * @return None
     * @details This macro will set IDDETEN bit of OTG_PHYCTL register to enable
     * ID detection function.
     */
    #define OTG_ENABLE_ID_DETECT() ( OTG->PHYCTL |= OTG_PHYCTL_IDDETEN_Msk )

    /**
     * @brief This macro is used to enable ID detection function Macro for
     * Non-Secure
     */
    #define OTG_ENABLE_ID_DETECT_NS() \
        ( OTG_NS->PHYCTL |= OTG_PHYCTL_IDDETEN_Msk )

    /**
     * @brief This macro is used to disable ID detection function
     * @param None
     * @return None
     * @details This macro will clear IDDETEN bit of OTG_PHYCTL register to
     * disable ID detection function.
     */
    #define OTG_DISABLE_ID_DETECT() ( OTG->PHYCTL &= ~OTG_PHYCTL_IDDETEN_Msk )

    /**
     * @brief This macro is used to disable ID detection function Macro for
     * Non-Secure
     */
    #define OTG_DISABLE_ID_DETECT_NS() \
        ( OTG_NS->PHYCTL &= ~OTG_PHYCTL_IDDETEN_Msk )
     ...
     * @param None
     * @return None
     * @details This macro will set WKEN bit of OTG_CTL register to enable OTG
     * wake-up function.
     */
    #define OTG_ENABLE_WAKEUP()     ( OTG->CTL |= OTG_CTL_WKEN_Msk )

    /**
     * @brief This macro is used to enable OTG wake-up function Macro for
     * Non-Secure
     */
     ...
     * @param None
     * @return None
     * @details This macro will clear WKEN bit of OTG_CTL register to disable
     * OTG wake-up function.
     */
    #define OTG_DISABLE_WAKEUP()    ( OTG->CTL &= ~OTG_CTL_WKEN_Msk )

    /**
     * @brief This macro is used to disable OTG wake-up function Macro for
     * Non-Secure
     */
     ...
     * @return None
     * @details This macro is used to set the polarity of external USB VBUS
     * power switch enable signal.
     */
    #define OTG_SET_VBUS_EN_POL( u32Pol )                               \
        ( OTG->PHYCTL = ( OTG->PHYCTL & ( ~OTG_PHYCTL_VBENPOL_Msk ) ) | \
                        ( ( u32Pol ) << OTG_PHYCTL_VBENPOL_Pos ) )

    /**
     * @brief This macro is used to set the polarity of USB_VBUS_EN pin Macro
     * for Non-Secure
     */
    #define OTG_SET_VBUS_EN_POL_NS( u32Pol )                                  \
        ( OTG_NS->PHYCTL = ( OTG_NS->PHYCTL & ( ~OTG_PHYCTL_VBENPOL_Msk ) ) | \
                           ( ( u32Pol ) << OTG_PHYCTL_VBENPOL_Pos ) )
     ...
     * @return None
     * @details This macro is used to set the polarity of external USB VBUS
     * power switch status signal.
     */
    #define OTG_SET_VBUS_STS_POL( u32Pol )                               \
        ( OTG->PHYCTL = ( OTG->PHYCTL & ( ~OTG_PHYCTL_VBSTSPOL_Msk ) ) | \
                        ( ( u32Pol ) << OTG_PHYCTL_VBSTSPOL_Pos ) )

    /**
     * @brief This macro is used to set the polarity of USB_VBUS_ST pin Macro
     * for Non-Secure
     */
    #define OTG_SET_VBUS_STS_POL_NS( u32Pol )                                  \
        ( OTG_NS->PHYCTL = ( OTG_NS->PHYCTL & ( ~OTG_PHYCTL_VBSTSPOL_Msk ) ) | \
                           ( ( u32Pol ) << OTG_PHYCTL_VBSTSPOL_Pos ) )

    /**
     * @brief This macro is used to enable OTG related interrupts
     * @param[in] u32Mask The combination of interrupt source. Each bit
     * corresponds to a interrupt source. Valid values are listed below.
     ...
     * @return None
     * @details This macro will enable OTG related interrupts specified by
     * u32Mask parameter.
     */
    #define OTG_ENABLE_INT( u32Mask )      ( OTG->INTEN |= ( u32Mask ) )

    /**
     * @brief This macro is used to enable OTG related interrupts Macro for
     * Non-Secure
     */
     ...
     *                    - \ref OTG_INTEN_SRPDETIEN_Msk
     * @return None
     * @details This macro will disable OTG related interrupts specified by
     * u32Mask parameter.
     */
    #define OTG_DISABLE_INT( u32Mask )     ( OTG->INTEN &= ~( u32Mask ) )

    /**
     * @brief This macro is used to disable OTG related interrupts Macro for
     * Non-Secure
     */
     ...
     * @details This macro will return OTG related interrupt flags specified by
     * u32Mask parameter.
     */
    #define OTG_GET_INT_FLAG( u32Mask )    ( OTG->INTSTS & ( u32Mask ) )

    /**
     * @brief This macro is used to get OTG related interrupt flags Macro for
     * Non-Secure
     */
     ...
     *                    - \ref OTG_INTSTS_SRPDETIF_Msk
     * @return None
     * @details This macro will clear OTG related interrupt flags specified by
     * u32Mask parameter.
     */
    #define OTG_CLR_INT_FLAG( u32Mask )    ( OTG->INTSTS = ( u32Mask ) )

    /**
     * @brief This macro is used to clear OTG related interrupt flags Macro for
     * Non-Secure
     */
     ...
     * @param[in] u32Mask The combination of user specified source. Valid values
     * are listed below.
     ...
     * @details This macro will return OTG related status specified by u32Mask
     * parameter.
     */
