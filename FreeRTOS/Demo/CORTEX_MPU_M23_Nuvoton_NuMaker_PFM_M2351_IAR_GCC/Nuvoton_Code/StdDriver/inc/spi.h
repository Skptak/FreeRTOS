...
*/
    ...
    #define SPI_MODE_0                                        \
        ( SPI_CTL_TXNEG_Msk ) /*!< CLKPOL=0; RXNEG=0; TXNEG=1 \
                               */
    #define SPI_MODE_1                                        \
        ( SPI_CTL_RXNEG_Msk ) /*!< CLKPOL=0; RXNEG=1; TXNEG=0 \
                               */
    #define SPI_MODE_2                                                     \
        ( SPI_CTL_CLKPOL_Msk | SPI_CTL_RXNEG_Msk ) /*!< CLKPOL=1; RXNEG=1; \
                                                      TXNEG=0 */
    #define SPI_MODE_3                                                     \
        ( SPI_CTL_CLKPOL_Msk | SPI_CTL_TXNEG_Msk ) /*!< CLKPOL=1; RXNEG=0; \
                                                      TXNEG=1 */
    ...
    #define SPI_SS_ACTIVE_HIGH                              \
        ( SPI_SSCTL_SSACTPOL_Msk )      /*!< SS active high \
                                         */
    ...
    #define SPI_SSACT_INT_MASK \
        ( 0x002UL ) /*!< Slave selection signal active interrupt mask */
    #define SPI_SSINACT_INT_MASK \
        ( 0x004UL ) /*!< Slave selection signal inactive interrupt mask */
    #define SPI_SLVUR_INT_MASK \
        ( 0x008UL ) /*!< Slave under run interrupt mask */
    #define SPI_SLVBE_INT_MASK \
        ( 0x010UL ) /*!< Slave bit count error interrupt mask */
    #define SPI_TXUF_INT_MASK \
        ( 0x040UL ) /*!< Slave TX underflow interrupt mask */
    #define SPI_FIFO_TXTH_INT_MASK \
        ( 0x080UL ) /*!< FIFO TX threshold interrupt mask */
    #define SPI_FIFO_RXTH_INT_MASK \
        ( 0x100UL ) /*!< FIFO RX threshold interrupt mask */
    #define SPI_FIFO_RXOV_INT_MASK \
        ( 0x200UL ) /*!< FIFO RX overrun interrupt mask */
    #define SPI_FIFO_RXTO_INT_MASK \
        ( 0x400UL ) /*!< FIFO RX time-out interrupt mask */
    ...
    #define SPII2S_DATABIT_8 \
        ( 0UL << SPI_I2SCTL_WDWIDTH_Pos ) /*!< I2S data width is 8-bit */
    #define SPII2S_DATABIT_16 \
        ( 1UL << SPI_I2SCTL_WDWIDTH_Pos ) /*!< I2S data width is 16-bit */
    #define SPII2S_DATABIT_24 \
        ( 2UL << SPI_I2SCTL_WDWIDTH_Pos ) /*!< I2S data width is 24-bit */
    #define SPII2S_DATABIT_32 \
        ( 3UL << SPI_I2SCTL_WDWIDTH_Pos ) /*!< I2S data width is 32-bit */
    ...
    #define SPII2S_FORMAT_I2S \
        ( 0UL << SPI_I2SCTL_FORMAT_Pos ) /*!< I2S data format */
    #define SPII2S_FORMAT_MSB \
        ( 1UL << SPI_I2SCTL_FORMAT_Pos ) /*!< MSB justified data format */
    #define SPII2S_FORMAT_PCMA \
        ( 2UL << SPI_I2SCTL_FORMAT_Pos ) /*!< PCM mode A data format */
    #define SPII2S_FORMAT_PCMB \
        ( 3UL << SPI_I2SCTL_FORMAT_Pos ) /*!< PCM mode B data format */
    ...
    #define SPII2S_FIFO_TX_LEVEL_WORD_1 \
        ( 1UL << SPI_FIFOCTL_TXTH_Pos ) /*!< TX threshold is 1 word */
    #define SPII2S_FIFO_TX_LEVEL_WORD_2 \
        ( 2UL << SPI_FIFOCTL_TXTH_Pos ) /*!< TX threshold is 2 words */
    #define SPII2S_FIFO_TX_LEVEL_WORD_3 \
        ( 3UL << SPI_FIFOCTL_TXTH_Pos ) /*!< TX threshold is 3 words */
    /* I2S RX FIFO Threshold */
    #define SPII2S_FIFO_RX_LEVEL_WORD_1 ( 0UL ) /*!< RX threshold is 1 word */
    #define SPII2S_FIFO_RX_LEVEL_WORD_2 \
        ( 1UL << SPI_FIFOCTL_RXTH_Pos ) /*!< RX threshold is 2 words */
    #define SPII2S_FIFO_RX_LEVEL_WORD_3 \
        ( 2UL << SPI_FIFOCTL_RXTH_Pos ) /*!< RX threshold is 3 words */
    #define SPII2S_FIFO_RX_LEVEL_WORD_4 \
        ( 3UL << SPI_FIFOCTL_RXTH_Pos ) /*!< RX threshold is 4 words */

    /* I2S Record Channel */
    #define SPII2S_MONO_RIGHT ( 0UL ) /*!< Record mono right channel */
    #define SPII2S_MONO_LEFT \
        SPI_I2SCTL_RXLCH_Msk /*!< Record mono left channel */
    ...
    #define SPII2S_FIFO_TXTH_INT_MASK \
        ( 0x01UL ) /*!< TX FIFO threshold interrupt mask */
    #define SPII2S_FIFO_RXTH_INT_MASK \
        ( 0x02UL ) /*!< RX FIFO threshold interrupt mask */
    #define SPII2S_FIFO_RXOV_INT_MASK \
        ( 0x04UL ) /*!< RX FIFO overrun interrupt mask */
    #define SPII2S_FIFO_RXTO_INT_MASK \
        ( 0x08UL ) /*!< RX FIFO time-out interrupt mask */
    #define SPII2S_TXUF_INT_MASK \
        ( 0x10UL ) /*!< TX FIFO underflow interrupt mask */
    #define SPII2S_RIGHT_ZC_INT_MASK \
        ( 0x20UL ) /*!< Right channel zero cross interrupt mask */
    #define SPII2S_LEFT_ZC_INT_MASK \
        ( 0x40UL ) /*!< Left channel zero cross interrupt mask */
    ...
    */
     ...
     * @return     None.
     * @details    Write 1 to UNITIF bit of SPI_STATUS register to clear the
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Set RXPDMAEN bit of SPI_PDMACTL register to enable RX PDMA
     * transfer function.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Set TXPDMAEN bit of SPI_PDMACTL register to enable TX PDMA
     * transfer function.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Clear RXPDMAEN bit of SPI_PDMACTL register to disable RX PDMA
     * transfer function.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Clear TXPDMAEN bit of SPI_PDMACTL register to disable TX PDMA
     * transfer function.
     */
     ...
     * @details    Read RXCNT (SPI_STATUS[27:24]) to get the count of available
     * data in RX FIFO.
     */
     ...
     * @details    Read RXEMPTY bit of SPI_STATUS register to get the RX FIFO
     * empty flag.
     */
     ...
     * @details    Read TXEMPTY bit of SPI_STATUS register to get the TX FIFO
     * empty flag.
     */
    #define SPI_GET_TX_FIFO_EMPTY_FLAG( spi )             \
        ( ( ( spi )->STATUS & SPI_STATUS_TXEMPTY_Msk ) >> \
     ...
     * @details    Read TXFULL bit of SPI_STATUS register to get the TX FIFO
     * full flag.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @param[in]  u32TxData The datum which user attempt to transfer through
     * SPI bus.
     * @return     None.
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Disable automatic slave selection function and set SPIx_SS
     * pin to high state.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Enable Byte Reorder function. The suspend interval depends on
     * the setting of SUSPITV (SPI_CTL[7:4]).
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Clear REORDER bit field of SPI_CTL register to disable Byte
     * Reorder function.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @param[in]  u32SuspCycle Decides the length of suspend interval. It could
     * be 0 ~ 15.
     * @return     None.
     * @details    Set the length of suspend interval according to u32SuspCycle.
     *             The length of suspend interval is ((u32SuspCycle + 0.5) * the
     * length of one SPI bus clock cycle).
     */
    #define SPI_SET_SUSPEND_CYCLE( spi, u32SuspCycle )             \
        ( ( spi )->CTL = ( ( spi )->CTL & ~SPI_CTL_SUSPITV_Msk ) | \
                         ( ( u32SuspCycle ) << SPI_CTL_SUSPITV_Pos ) )

    /**
     * @brief      Set the SPI transfer sequence with LSB first.
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Set LSB bit of SPI_CTL register to set the SPI transfer
     * sequence with LSB first.
     */
     ...
     * @param[in]  spi The pointer of the specified SPI module.
     * @return     None.
     * @details    Clear LSB bit of SPI_CTL register to set the SPI transfer
     * sequence with MSB first.
     */
    ...
    #define SPI_IS_BUSY( spi ) \
        ( ( ( spi )->STATUS & SPI_STATUS_BUSY_Msk ) >> SPI_STATUS_BUSY_Pos )
 ...
 *                    - \ref SPII2S_LEFT
 * @return None
 * @details This function will set RZCEN or LZCEN bit of SPI_I2SCTL register to
 ...
 *                    - \ref SPII2S_LEFT
 * @return None
 * @details This function will clear RZCEN or LZCEN bit of SPI_I2SCTL register
 * to disable zero cross detection function.
 */
__STATIC_INLINE void SPII2S_DISABLE_TX_ZCD( SPI_T * i2s, uint32_t u32ChMask )
{
    if( u32ChMask == SPII2S_RIGHT )
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will set TXPDMAEN bit of SPI_PDMACTL register to
     * transmit data with PDMA.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear TXPDMAEN bit of SPI_PDMACTL register to
     * disable TX DMA function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will set RXPDMAEN bit of SPI_PDMACTL register to
     * receive data with PDMA.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear RXPDMAEN bit of SPI_PDMACTL register to
     * disable RX DMA function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will set TXEN bit of SPI_I2SCTL register to enable
     * I2S TX function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear TXEN bit of SPI_I2SCTL register to disable
     * I2S TX function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will set RXEN bit of SPI_I2SCTL register to enable
     * I2S RX function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear RXEN bit of SPI_I2SCTL register to disable
     * I2S RX function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will set MUTE bit of SPI_I2SCTL register to enable
     * I2S TX mute function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear MUTE bit of SPI_I2SCTL register to disable
     * I2S TX mute function.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear TX FIFO. The internal TX FIFO pointer will
     * be reset to FIFO start point.
     */
     ...
     * @param[in] i2s The pointer of the specified I2S module.
     * @return None
     * @details This macro will clear RX FIFO. The internal RX FIFO pointer will
     * be reset to FIFO start point.
     */
...
/**
 * @brief  This function sets the recording source channel when mono mode is
 * used.
 * @param[in] i2s The pointer of the specified I2S module.
...
__STATIC_INLINE void SPII2S_SET_MONO_RX_CHANNEL( SPI_T * i2s, uint32_t u32Ch )
{
    u32Ch == SPII2S_MONO_LEFT ? ( i2s->I2SCTL |= SPI_I2SCTL_RXLCH_Msk )
     ...
     * @details This macro will return the combination interrupt flags of
     * SPI_I2SSTS register. The flags are specified by the u32mask parameter.
     */
     ...
     * @param[in] u32Mask The mask value for all interrupt flags.
     * @return None
     * @details This macro will clear the interrupt flags specified by the
     * u32mask parameter.
     * @note Except TX and RX FIFO threshold interrupt flags, the other
     * interrupt flags can be cleared by writing 1 to itself.
     */
