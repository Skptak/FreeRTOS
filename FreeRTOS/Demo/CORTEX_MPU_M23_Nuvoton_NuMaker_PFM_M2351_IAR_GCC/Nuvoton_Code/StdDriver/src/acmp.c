 ...
 * @return     None
 *
 * @details    Configure hysteresis function, select the source of negative
 * input and enable analog comparator.
 */
                ...
                uint32_t u32HysSel )
{
    acmp->CTL[ u32ChNum ] = ( acmp->CTL[ u32ChNum ] &
                              ( ~( ACMP_CTL_NEGSEL_Msk |
                                   ACMP_CTL_HYSSEL_Msk ) ) ) |
                            ( u32NegSrc | u32HysSel | ACMP_CTL_ACMPEN_Msk );
}
 ...
 * @return     None
 *
 * @details  This function will clear ACMPEN bit of ACMP_CTL register to disable
 * analog comparator.
 */
