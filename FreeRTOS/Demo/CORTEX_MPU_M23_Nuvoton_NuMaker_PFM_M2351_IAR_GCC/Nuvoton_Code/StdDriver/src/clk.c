 ...
 *             enable frequency divider clock function and configure frequency
 * divider.
 ...
 * @return     None
 *
 * @details    Output selected clock to CKO. The output clock frequency is
 * divided by u32ClkDiv. The formula is: CKO frequency = (Clock source
 * frequency) / 2^(u32ClkDiv + 1) This function is just used to set CKO clock.
 ...
 *             The register write-protection function should be disabled before
 * using this function.
 */
 ...
 * @details    This function get external high frequency crystal frequency. The
 ...
 * @details    This function get external low frequency crystal frequency. The
 * frequency unit is Hz.
 */
...
{
    SystemCoreClockUpdate();
    return ( SystemCoreClock >> ( ( CLK->PCLKDIV & CLK_PCLKDIV_APB0DIV_Msk ) >>
...
{
    SystemCoreClockUpdate();
    return ( SystemCoreClock >> ( ( CLK->PCLKDIV & CLK_PCLKDIV_APB1DIV_Msk ) >>
...
uint32_t CLK_GetCPUFreq( void )
{
    ...
    uint32_t au32ClkTbl[] = { __HXT, __LXT,    0UL, __LIRC,
                              0UL,   __HIRC48, 0UL, __HIRC };
    ...
    else /* PLL is in normal mode */
    {
        ...
        else
        {
            ...
            u32NO = au8NoTbl[ ( ( u32PllReg & CLK_PLLCTL_OUTDIV_Msk ) >>
                                CLK_PLLCTL_OUTDIV_Pos ) ];
            u32NF = ( ( u32PllReg & CLK_PLLCTL_FBDIV_Msk ) >>
                      CLK_PLLCTL_FBDIV_Pos ) +
                    2UL;
            u32NR = ( ( u32PllReg & CLK_PLLCTL_INDIV_Msk ) >>
                      CLK_PLLCTL_INDIV_Pos ) +
                    1UL;

            /* u32FIN is shifted 2 bits to avoid overflow */
            PllClock = ( ( ( u32FIN >> 2 ) * ( u32NF << 1 ) ) / ( u32NR * u32NO )
                         << 2 );
        }
    }
    ...
    if( u32HclkSrc == CLK_CLKSEL0_HCLKSEL_LXT )
    {
        if( u32RTCCKEN == 0UL )
        {
            CLK->APBCLK0 |= CLK_APBCLK0_RTCCKEN_Msk; /* Enable RTC clock to get
                                                        LXT clock source */
        }
        ...
        if( u32RTCCKEN == 0UL )
        {
            CLK->APBCLK0 &= ( ~CLK_APBCLK0_RTCCKEN_Msk ); /* Disable RTC clock
                                                             if it is disabled
                                                             before */
        }
    }
 ...
 * @return     HCLK frequency
 * @details    This function is used to set HCLK frequency. The frequency unit
 * is Hz. \n The register write-protection function should be disabled before
 * using this function.
 */
uint32_t CLK_SetCoreClock( uint32_t u32Hclk )
{
    ...
    else if( ( u32PLSTATUS == SYS_PLSTS_PLSTATUS_PL1 ) &&
             ( u32Hclk > FREQ_48MHZ ) )
    {
        u32Hclk = FREQ_48MHZ;
    }
...
void CLK_SetHCLK( uint32_t u32ClkSrc, uint32_t u32ClkDiv )
{
    ...
    /* Disable Flash access cycle auto-tuning function and set Flash access
     * cycle if HCLK switches to HIRC48 */
    if( u32ClkSrc == CLK_CLKSEL0_HCLKSEL_HIRC48 )
    {
        FMC->CYCCTL = ( FMC->CYCCTL & ( ~FMC_CYCCTL_CYCLE_Msk ) ) |
                      FMC_CYCCTL_FADIS_Msk | ( 3UL );
    }
...
/**
 * @brief      This function set selected module clock source and module clock
 * divider
 ...
 * :----------------  | :----------------------------------- |
 * :----------------------- |
 * |\ref SDH0_MODULE    |\ref CLK_CLKSEL0_SDH0SEL_HXT          |\ref
 * CLK_CLKDIV0_SDH0(x)  |
 * |\ref SDH0_MODULE    |\ref CLK_CLKSEL0_SDH0SEL_PLL          |\ref
 * CLK_CLKDIV0_SDH0(x)  |
 * |\ref SDH0_MODULE    |\ref CLK_CLKSEL0_SDH0SEL_HCLK         |\ref
 * CLK_CLKDIV0_SDH0(x)  |
 * |\ref SDH0_MODULE    |\ref CLK_CLKSEL0_SDH0SEL_HIRC         |\ref
 * CLK_CLKDIV0_SDH0(x)  |
 ...
 * |\ref UART0_MODULE   |\ref CLK_CLKSEL1_UART0SEL_HXT         |\ref
 * CLK_CLKDIV0_UART0(x) |
 * |\ref UART0_MODULE   |\ref CLK_CLKSEL1_UART0SEL_PLL         |\ref
 * CLK_CLKDIV0_UART0(x) |
 * |\ref UART0_MODULE   |\ref CLK_CLKSEL1_UART0SEL_LXT         |\ref
 * CLK_CLKDIV0_UART0(x) |
 * |\ref UART0_MODULE   |\ref CLK_CLKSEL1_UART0SEL_HIRC        |\ref
 * CLK_CLKDIV0_UART0(x) |
 * |\ref UART1_MODULE   |\ref CLK_CLKSEL1_UART1SEL_HXT         |\ref
 * CLK_CLKDIV0_UART1(x) |
 * |\ref UART1_MODULE   |\ref CLK_CLKSEL1_UART1SEL_PLL         |\ref
 * CLK_CLKDIV0_UART1(x) |
 * |\ref UART1_MODULE   |\ref CLK_CLKSEL1_UART1SEL_LXT         |\ref
 * CLK_CLKDIV0_UART1(x) |
 * |\ref UART1_MODULE   |\ref CLK_CLKSEL1_UART1SEL_HIRC        |\ref
 * CLK_CLKDIV0_UART1(x) |
 * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_HXT         |\ref
 * CLK_CLKDIV4_UART2(x) |
 * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_PLL         |\ref
 * CLK_CLKDIV4_UART2(x) |
 * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_LXT         |\ref
 * CLK_CLKDIV4_UART2(x) |
 * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_HIRC        |\ref
 * CLK_CLKDIV4_UART2(x) |
 * |\ref UART3_MODULE   |\ref CLK_CLKSEL3_UART3SEL_HXT         |\ref
 * CLK_CLKDIV4_UART3(x) |
 * |\ref UART3_MODULE   |\ref CLK_CLKSEL3_UART3SEL_PLL         |\ref
 * CLK_CLKDIV4_UART3(x) |
 * |\ref UART3_MODULE   |\ref CLK_CLKSEL3_UART3SEL_LXT         |\ref
 * CLK_CLKDIV4_UART3(x) |
 * |\ref UART3_MODULE   |\ref CLK_CLKSEL3_UART3SEL_HIRC        |\ref
 * CLK_CLKDIV4_UART3(x) |
 * |\ref UART4_MODULE   |\ref CLK_CLKSEL3_UART4SEL_HXT         |\ref
 * CLK_CLKDIV4_UART4(x) |
 * |\ref UART4_MODULE   |\ref CLK_CLKSEL3_UART4SEL_PLL         |\ref
 * CLK_CLKDIV4_UART4(x) |
 * |\ref UART4_MODULE   |\ref CLK_CLKSEL3_UART4SEL_LXT         |\ref
 * CLK_CLKDIV4_UART4(x) |
 * |\ref UART4_MODULE   |\ref CLK_CLKSEL3_UART4SEL_HIRC        |\ref
 * CLK_CLKDIV4_UART4(x) |
 * |\ref UART5_MODULE   |\ref CLK_CLKSEL3_UART5SEL_HXT         |\ref
 * CLK_CLKDIV4_UART5(x) |
 * |\ref UART5_MODULE   |\ref CLK_CLKSEL3_UART5SEL_PLL         |\ref
 * CLK_CLKDIV4_UART5(x) |
 * |\ref UART5_MODULE   |\ref CLK_CLKSEL3_UART5SEL_LXT         |\ref
 * CLK_CLKDIV4_UART5(x) |
 * |\ref UART5_MODULE   |\ref CLK_CLKSEL3_UART5SEL_HIRC        |\ref
 * CLK_CLKDIV4_UART5(x) |
 ...
 * |\ref SC0_MODULE     |\ref CLK_CLKSEL3_SC0SEL_HXT           |\ref
 * CLK_CLKDIV1_SC0(x)   |
 * |\ref SC0_MODULE     |\ref CLK_CLKSEL3_SC0SEL_PLL           |\ref
 * CLK_CLKDIV1_SC0(x)   |
 * |\ref SC0_MODULE     |\ref CLK_CLKSEL3_SC0SEL_PCLK0         |\ref
 * CLK_CLKDIV1_SC0(x)   |
 * |\ref SC0_MODULE     |\ref CLK_CLKSEL3_SC0SEL_HIRC          |\ref
 * CLK_CLKDIV1_SC0(x)   |
 * |\ref SC1_MODULE     |\ref CLK_CLKSEL3_SC1SEL_HXT           |\ref
 * CLK_CLKDIV1_SC1(x)   |
 * |\ref SC1_MODULE     |\ref CLK_CLKSEL3_SC1SEL_PLL           |\ref
 * CLK_CLKDIV1_SC1(x)   |
 * |\ref SC1_MODULE     |\ref CLK_CLKSEL3_SC1SEL_PCLK1         |\ref
 * CLK_CLKDIV1_SC1(x)   |
 * |\ref SC1_MODULE     |\ref CLK_CLKSEL3_SC1SEL_HIRC          |\ref
 * CLK_CLKDIV1_SC1(x)   |
 * |\ref SC2_MODULE     |\ref CLK_CLKSEL3_SC2SEL_HXT           |\ref
 * CLK_CLKDIV1_SC2(x)   |
 * |\ref SC2_MODULE     |\ref CLK_CLKSEL3_SC2SEL_PLL           |\ref
 * CLK_CLKDIV1_SC2(x)   |
 * |\ref SC2_MODULE     |\ref CLK_CLKSEL3_SC2SEL_PCLK0         |\ref
 * CLK_CLKDIV1_SC2(x)   |
 * |\ref SC2_MODULE     |\ref CLK_CLKSEL3_SC2SEL_HIRC          |\ref
 * CLK_CLKDIV1_SC2(x)   |
 * |\ref USBH_MODULE    |\ref CLK_CLKSEL0_USBSEL_HIRC48        |\ref
 * CLK_CLKDIV0_USB(x)   |
 * |\ref USBH_MODULE    |\ref CLK_CLKSEL0_USBSEL_PLL           |\ref
 * CLK_CLKDIV0_USB(x)   |
 * |\ref OTG_MODULE     |\ref CLK_CLKSEL0_USBSEL_HIRC48        |\ref
 * CLK_CLKDIV0_USB(x)   |
 * |\ref OTG_MODULE     |\ref CLK_CLKSEL0_USBSEL_PLL           |\ref
 * CLK_CLKDIV0_USB(x)   |
 * |\ref USBD_MODULE    |\ref CLK_CLKSEL0_USBSEL_HIRC48        |\ref
 * CLK_CLKDIV0_USB(x)   |
 * |\ref USBD_MODULE    |\ref CLK_CLKSEL0_USBSEL_PLL           |\ref
 * CLK_CLKDIV0_USB(x)   |
 */
                         ...
                         uint32_t u32ClkDiv )
{
    ...
    if( MODULE_CLKDIV_Msk( u32ModuleIdx ) != MODULE_NoMsk )
    {
        ...
        u32Div = ( uint32_t ) &CLK->CLKDIV0 +
                 ( au32DivTbl[ MODULE_CLKDIV( u32ModuleIdx ) ] );
        /* Apply new divider */
        M32( u32Div ) = ( M32( u32Div ) &
                          ( ~( MODULE_CLKDIV_Msk( u32ModuleIdx )
                               << MODULE_CLKDIV_Pos( u32ModuleIdx ) ) ) ) |
                        u32ClkDiv;
    }
    ...
    if( MODULE_CLKSEL_Msk( u32ModuleIdx ) != MODULE_NoMsk )
    {
        ...
        u32Sel = ( uint32_t ) &CLK->CLKSEL0 +
                 ( au32SelTbl[ MODULE_CLKSEL( u32ModuleIdx ) ] );
        /* Set new clock selection setting */
        M32( u32Sel ) = ( M32( u32Sel ) &
                          ( ~( MODULE_CLKSEL_Msk( u32ModuleIdx )
                               << MODULE_CLKSEL_Pos( u32ModuleIdx ) ) ) ) |
                        u32ClkSrc;
    }
}
 ...
 * @param[in]  u32PllFreq is PLL frequency. The range of u32PllFreq is 24 MHz ~
 * 144 MHz.
 * @return     PLL frequency
 * @details    This function is used to configure PLLCTL register to set
 * specified PLL frequency. \n The register write-protection function should be
...
uint32_t CLK_EnablePLL( uint32_t u32PllClkSrc, uint32_t u32PllFreq )
{
    ...
    if( ( u32PllFreq <= FREQ_144MHZ ) && ( u32PllFreq >= FREQ_24MHZ ) )
    {
        ...
        for( ; u32NR <= 32UL; u32NR++ )
        {
            ...
            if( ( u32Tmp >= FREQ_2MHZ ) && ( u32Tmp <= FREQ_8MHZ ) )
            {
                for( u32NF = 2UL; u32NF <= 513UL; u32NF++ )
                {
                    ...
                    if( ( u32Tmp2 >= FREQ_96MHZ ) &&
                        ( u32Tmp2 <= FREQ_200MHZ ) )
                    {
                        u32Tmp3 = ( u32Tmp2 > u32PllFreq )
                                      ? u32Tmp2 - u32PllFreq
                                      : u32PllFreq - u32Tmp2;
                        if( u32Tmp3 < u32Min )
                        {
        ...
        CLK->PLLCTL = u32PllClkSrc | ( u32NO << 14 ) |
                      ( ( u32MinNR - 1UL ) << 9 ) | ( u32MinNF - 2UL );

        /* Actual PLL output clock frequency */
        u32PllClk = u32PllSrcClk / ( ( u32NO + 1UL ) * u32MinNR ) *
                    ( u32MinNF << 1 );
    }
    else
    {
 ...
 * @details    To wait for clock ready by specified clock source stable flag or
 * timeout (~300ms)
 */
 ...
 * @return     None
 * @details    This function set System Tick clock source, reload value, enable
 * System Tick counter and interrupt. \n The register write-protection function
 * should be disabled before using this function.
 */
...
{
    CLK->PMUCTL = ( CLK->PMUCTL & ( ~CLK_PMUCTL_WKPINEN_Msk ) ) |
                  ( u32TriggerType );
}
 ...
 * @param[in]   u32DebounceEn Standby Power-down mode wake-up pin de-bounce
 * function
 *              - \ref CLK_SPDWKPIN_DEBOUNCEEN
 *              - \ref CLK_SPDWKPIN_DEBOUNCEDIS
 * @return      None
 * @details     This function is used to set specified GPIO as wake up source at
                         ...
                         uint32_t u32DebounceEn )
{
    ...
    u32TmpVal = ( u32TmpVal &
                  ~( CLK_PASWKCTL_WKPSEL_Msk | CLK_PASWKCTL_PRWKEN_Msk |
                     CLK_PASWKCTL_PFWKEN_Msk | CLK_PASWKCTL_DBEN_Msk |
                     CLK_PASWKCTL_WKEN_Msk ) ) |
                ( u32Pin << CLK_PASWKCTL_WKPSEL_Pos ) | u32TriggerType |
                u32DebounceEn | CLK_SPDWKPIN_ENABLE;
...
uint32_t CLK_GetModuleClockDivider( uint32_t u32ModuleIdx )
{
    ...
    {
        /* Get clock divider control register address */
        u32TmpAddr = ( uint32_t ) &CLK->CLKDIV0 +
                     ( au32DivTbl[ MODULE_CLKDIV( u32ModuleIdx ) ] );
