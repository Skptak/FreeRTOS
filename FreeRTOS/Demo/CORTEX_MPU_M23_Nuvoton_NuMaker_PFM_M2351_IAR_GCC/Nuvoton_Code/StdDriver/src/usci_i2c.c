...
/**
 *    @brief        This function makes USCI_I2C module be ready and set the
 * wanted bus clock
 *
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 *    @param[in]    u32BusClock     The target bus speed of USCI_I2C module.
 *
 *    @return       Actual USCI_I2C bus clock frequency.
 *
 *    @details      Enable USCI_I2C module and configure USCI_I2C module(bus
 * clock, data format).
 */
uint32_t UI2C_Open( UI2C_T * ui2c, uint32_t u32BusClock )
{
    ...
    u32ClkDiv = ( uint32_t ) ( ( ( ( ( ( u32Pclk / 2u ) * 10u ) /
                                     ( u32BusClock ) ) +
                                   5u ) /
                                 10u ) -
                               1u ); /* Compute proper divider for USCI_I2C
                                        clock */
 ...
 *    @return       None
 *
 *    @details      The function set USCI_I2C control bit of USCI_I2C bus
 * protocol.
 */
...
{
    uint32_t u32Reg = 0u;
    uint32_t u32Val = ui2c->PROTCTL &
                      ~( UI2C_PROTCTL_STA_Msk | UI2C_PROTCTL_STO_Msk |
                         UI2C_PROTCTL_AA_Msk );
 ...
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 *    @param[in]    u32Mask         The combination of all related interrupt
 * enable bits. Each bit corresponds to an interrupt enable bit. This parameter
 * decides which interrupts will be disabled. It is combination of:
 ...
 *    @return       None
 *
 *    @details      The function is used to disable USCI_I2C bus interrupt
 * events.
 */
 ...
 * module.
 *    @param[in]    u32Mask         The combination of all related interrupt
 * enable bits. Each bit corresponds to a interrupt enable bit. This parameter
 * decides which interrupts will be enabled. It is combination of:
 *                                  - \ref UI2C_TO_INT_MASK
 *                                  - \ref UI2C_STAR_INT_MASK
 *                                  - \ref UI2C_STOR_INT_MASK
 *                                  - \ref UI2C_NACK_INT_MASK
 ...
 *    @return None
 *
 *    @details      The function is used to enable USCI_I2C bus interrupt
 * events.
 */
...
uint32_t UI2C_GetBusClockFreq( UI2C_T * ui2c )
{
    ...
    u32Divider = ( ui2c->BRGEN & UI2C_BRGEN_CLKDIV_Msk ) >>
 ...
 *    @return Actual USCI_I2C bus clock frequency.
 *
 *    @details      Use this function set USCI_I2C bus clock frequency and
 * return actual bus clock.
 */
 ...
 * module.
 *    @param[in]    u32Mask         The combination of all related interrupt
 * sources. Each bit corresponds to a interrupt source. This parameter decides
 * which interrupt flags will be read. It is combination of:
 *                                  - \ref UI2C_TO_INT_MASK
 *                                  - \ref UI2C_STAR_INT_MASK
 *                                  - \ref UI2C_STOR_INT_MASK
 *                                  - \ref UI2C_NACK_INT_MASK
 ...
 *
 *    @details      Use this function to get USCI_I2C interrupt flag when module
 * occurs interrupt event.
 */
 ...
 *    @param[in]    u32Mask         The combination of all related interrupt
 * sources. Each bit corresponds to a interrupt source. This parameter decides
 * which interrupt flags will be cleared. It is combination of:
 *                                  - \ref UI2C_TO_INT_MASK
 *                                  - \ref UI2C_STAR_INT_MASK
 *                                  - \ref UI2C_STOR_INT_MASK
 *                                  - \ref UI2C_NACK_INT_MASK
 ...
 *    @return       None
 *
 *    @details      Use this function to clear USCI_I2C interrupt flag when
 * module occurs interrupt event and set flag.
 */
...
/**
 *    @brief        This function returns the data stored in data register of
 * USCI_I2C module.
 *
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 ...
 *
 *    @details      To read a byte data from USCI_I2C module receive data
 * register.
 */
...
/**
 *    @brief        This function writes a byte data to data register of
 * USCI_I2C module
 *
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 *    @param[in]    u8Data          The data which will be written to data
 * register of USCI_I2C module.
 *
 *    @return       None
 *
 *    @details      To write a byte data to transmit data register to transmit
 * data.
 */
...
/**
 *    @brief        This function enables time-out function and configures
 * timeout counter
 *
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 *    @param[in]    u32TimeoutCnt   Timeout counter. Valid values are between
 * 0~0x3FF.
 *
 *    @return       None
 *
 *    @details      To enable USCI_I2C bus time-out function and set time-out
 * counter.
 */
void UI2C_EnableTimeout( UI2C_T * ui2c, uint32_t u32TimeoutCnt )
{
    ui2c->PROTCTL = ( ui2c->PROTCTL & ~UI2C_PROTCTL_TOCNT_Msk ) |
                    ( u32TimeoutCnt << UI2C_PROTCTL_TOCNT_Pos );
    ui2c->BRGEN = ( ui2c->BRGEN & ~UI2C_BRGEN_TMCNTSRC_Msk ) |
 ...
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 *    @param[in]    u8WakeupMode    The wake-up mode selection. Valid values
 * are:
...
{
    ui2c->WKCTL = ( ui2c->WKCTL & ~UI2C_WKCTL_WKADDREN_Msk ) |
                  ( u8WakeupMode | UI2C_WKCTL_WKEN_Msk );
}

/**
 *    @brief        This function disables the wakeup function of USCI_I2C
 * module
 *
 *    @param[in]    ui2c            The pointer of the specified USCI_I2C
 * module.
 ...
 *
 * @details    The function is used for USCI_I2C Master write a byte data to
 * Slave.
 *
 */
...
uint8_t UI2C_WriteByte( UI2C_T * ui2c, uint8_t u8SlaveAddr, uint8_t data )
{
    ...
    while( u8Xfering )
    {
        while( !( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U ) )
            ; /* Wait UI2C new status occur */

        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            case UI2C_PROTSTS_STARIF_Msk:
                UI2C_CLR_PROT_INT_FLAG( ui2c,
                                        UI2C_PROTSTS_STARIF_Msk ); /* Clear
                                                                      START INT
                                                                      Flag */
                UI2C_SET_DATA( ui2c,
                               ( u8SlaveAddr << 1U ) | 0x00U ); /* Write SLA+W
                                                                   to Register
                                                                   UI2C_TXDAT */
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                UI2C_CLR_PROT_INT_FLAG( ui2c,
                                        UI2C_PROTSTS_ACKIF_Msk ); /* Clear ACK
                                                                     INT Flag */
                ...
                {
                    u8Ctrl = ( UI2C_CTL_PTRG | UI2C_CTL_STO ); /* Clear SI and
                                                                  send STOP */
                }
            ...
            case UI2C_PROTSTS_NACKIF_Msk:
                UI2C_CLR_PROT_INT_FLAG( ui2c,
                                        UI2C_PROTSTS_NACKIF_Msk ); /* Clear NACK
                                                                      INT Flag
                                                                    */
                u8Ctrl = ( UI2C_CTL_PTRG | UI2C_CTL_STO ); /* Clear SI and send
                                                              STOP */
                u8Err = 1U;
                break;
            ...
            case UI2C_PROTSTS_STORIF_Msk:
                UI2C_CLR_PROT_INT_FLAG( ui2c,
                                        UI2C_PROTSTS_STORIF_Msk ); /* Clear STOP
                                                                      INT Flag
                                                                    */
                u8Ctrl = UI2C_CTL_PTRG; /* Clear SI */
                u8Xfering = 0U;
        ...
        UI2C_SET_CONTROL_REG( ui2c, u8Ctrl ); /* Write controlbit to
                                                 UI2C_PROTCTL register */
    }
 ...
 *
 * @details    The function is used for USCI_I2C Master write multi bytes data
 * to Slave.
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                if( u32txLen < u32wLen )
                    UI2C_SET_DATA( ui2c, data[ u32txLen++ ] ); /* Write data to
                                                                  UI2C_TXDAT */
                else
                {
                    u8Ctrl = ( UI2C_CTL_PTRG | UI2C_CTL_STO ); /* Clear SI and
        ...
        UI2C_SET_CONTROL_REG( ui2c, u8Ctrl ); /* Write controlbit to UI2C_CTL
                                                 register */
    }
 ...
 * @retval     1               Write data fail, or bus occurs error events
 *
 * @details    The function is used for USCI_I2C Master specify a address that
 * data write to in Slave.
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                if( u32txLen == 0U )
                {
                    UI2C_SET_DATA( ui2c, u8DataAddr ); /* Write data address to
                                                          UI2C_TXDAT */
                    u32txLen++;
                }
                else if( u32txLen == 1U )
 ...
 * @return     A length of how many bytes have been transmitted.
 *
 * @details    The function is used for USCI_I2C Master specify a byte address
 * that multi data bytes write to in Slave.
 *
 */
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                else
                {
                    if( u32txLen < u32wLen )
                        UI2C_SET_DATA( ui2c,
                                       data[ u32txLen++ ] ); /* Write data to
                                                                UI2C_TXDAT */
                    else
                    {
                        u8Ctrl = ( UI2C_CTL_PTRG |
                                   UI2C_CTL_STO ); /* Clear SI and send STOP */
                    }
                }
 ...
 * @retval     1               Write data fail, or bus occurs error events
 *
 * @details    The function is used for USCI_I2C Master specify two bytes
 * address that data write to in Slave.
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                {
                    UI2C_SET_DATA( ui2c,
                                   ( uint8_t ) ( u16DataAddr & 0xFF00U ) >>
                                       8U ); /* Write Hi byte data address to
                                                UI2C_TXDAT */
                    u32txLen++;
                }
                else if( u32txLen == 1U )
 ...
 *
 * @details    The function is used for USCI_I2C Master specify a byte address
 * that multi data write to in Slave.
 *
 */
 ...
 *
 * @details    The function is used for USCI_I2C Master to read a byte data from
 * Slave.
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            case UI2C_PROTSTS_STARIF_Msk:
                UI2C_CLR_PROT_INT_FLAG( ui2c,
                                        UI2C_PROTSTS_STARIF_Msk ); /* Clear
                                                                      ...
                                                                      Flag */
                UI2C_SET_DATA( ui2c,
                               ( u8SlaveAddr << 1U ) | 0x01U ); /* Write SLA+R
                                                                   to Register
                                                                   UI2C_TXDAT */
            ...
            case UI2C_PROTSTS_NACKIF_Msk:
                ...
                {
                    rdata = ( unsigned char ) UI2C_GET_DATA( ui2c ); /* Receive
                                                                        Data */
                }
 ...
 *
 * @details    The function is used for USCI_I2C Master to read multi data bytes
 * from Slave.
 *
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                {
                    rdata[ u32rxLen++ ] = ( unsigned char ) UI2C_GET_DATA(
                        ui2c ); /* Receive Data */
 ...
 *
 * @details    The function is used for USCI_I2C Master specify a byte address
 * that a data byte read from Slave.
 *
 *
 */
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            case UI2C_PROTSTS_STARIF_Msk:
                ...
                else if( eEvent == MASTER_SEND_REPEAT_START )
                {
                    UI2C_SET_DATA( ui2c,
                                   ( u8SlaveAddr << 1U ) |
                                       0x01U ); /* Write SLA+R to Register TXDAT
                                                 */
                    eEvent = MASTER_SEND_H_RD_ADDRESS;
                }
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                if( eEvent == MASTER_SEND_ADDRESS )
                {
                    UI2C_SET_DATA( ui2c, u8DataAddr ); /* Write data address of
                                                          register */
                    u8Ctrl = UI2C_CTL_PTRG;
                    eEvent = MASTER_SEND_DATA;
                }
                ...
                {
                    u8Ctrl = ( UI2C_CTL_PTRG |
                               UI2C_CTL_STA ); /* Send repeat START signal */
 ...
 *
 * @details    The function is used for USCI_I2C Master specify a byte address
 * that multi data bytes read from Slave.
 *
 *
 */
    ...
    while( u8Xfering )
    {
        ...
        switch( UI2C_GET_PROT_STATUS( ui2c ) & 0x3F00U )
        {
            ...
            case UI2C_PROTSTS_ACKIF_Msk:
                ...
                {
                    rdata[ u32rxLen++ ] = ( uint8_t ) UI2C_GET_DATA(
                        ui2c ); /* Receive Data */
 ...
 *
 * @details    The function is used for USCI_I2C Master specify two bytes
 * address that a data byte read from Slave.
 *
 *
 */
...
/**
 * @brief      Specify two bytes register address and read multi bytes from
 * Slave
 *
 * @param[in]  *ui2c            The pointer of the specified USCI_I2C module.
 * @param[in]  u8SlaveAddr     Access Slave address(7-bit)
 ...
 *
 * @details    The function is used for USCI_I2C Master specify two bytes
 * address that multi data bytes read from Slave.
 *
 *
 */
