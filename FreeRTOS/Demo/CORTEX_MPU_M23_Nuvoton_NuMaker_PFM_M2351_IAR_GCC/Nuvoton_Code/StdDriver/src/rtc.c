...
/*---------------------------------------------------------------------------------------------------------*/
static volatile uint32_t g_u32hiYear, g_u32loYear, g_u32hiMonth, g_u32loMonth,
    g_u32hiDay, g_u32loDay;
static volatile uint32_t g_u32hiHour, g_u32loHour, g_u32hiMin, g_u32loMin,
    g_u32hiSec, g_u32loSec;
 ...
 *
 * @param[in]  sPt     Specify the time property and current date and time. It
 * includes:           \n u32Year: Year value, range between 2000 ~ 2099. \n
 *                     u32Month: Month value, range between 1 ~ 12. \n u32Day:
 * Day value, range between 1 ~ 31.                                    \n
 *                     u32DayOfWeek: Day of the week. [RTC_SUNDAY / RTC_MONDAY /
 * RTC_TUESDAY / RTC_WEDNESDAY / RTC_THURSDAY / RTC_FRIDAY / RTC_SATURDAY] \n
 *                     u32Hour: Hour value, range between 0 ~ 23. \n u32Minute:
 * Minute value, range between 0 ~ 59.                              \n
 ...
 *                 3. User has to make sure that parameters of RTC date/time are
 * reasonable. \n
 ...
 * @return     None
 *
 * @details    This API will disable RTC peripheral clock and stops RTC
 * counting.
 */
void RTC_Close( void )
{
 ...
 *
 *  @param[in]    i32FrequencyX10000    Specify the RTC clock X10000, ex:
 * 327736512 means 32773.6512.
 *
 * @return     None
 *
 * @details    This API is used to compensate the 32 kHz frequency by current
 * LXT frequency for RTC application.
 */
void RTC_32KCalibration( int32_t i32FrequencyX10000 )
{
    ...
    u64Compensate = ( uint64_t ) ( u64Compensate /
                                   ( uint64_t ) i32FrequencyX10000 );
    /*
 ...
 *
 * @param[out] sPt     The returned pointer is specified the current RTC value.
...
void RTC_GetDateAndTime( S_RTC_TIME_DATA_T * sPt )
{
    ...
    sPt->u32DayOfWeek = pRTC->WEEKDAY &
                        RTC_WEEKDAY_WEEKDAY_Msk; /* Day of the week */
 ...
 *
 * @param[out] sPt     The returned pointer is specified the RTC alarm value. It
 * includes: \n u32Year: Year value \n u32Month: Month value \n u32Day: Day
 * value                                                   \n u32DayOfWeek: Day
 * of week                                           \n u32Hour: Hour value \n
...
void RTC_SetDateAndTime( S_RTC_TIME_DATA_T * sPt )
{
    ...
    else
    {
        ...
        /*-----------------------------------------------------------------------------------------------------*/
        u32RegCAL = ( ( sPt->u32Year - ( uint32_t ) RTC_YEAR2000 ) / 10UL )
                    << 20;
        u32RegCAL |= ( ( ( sPt->u32Year - ( uint32_t ) RTC_YEAR2000 ) % 10UL )
                       << 16 );
 ...
 *
 * @param[in]  sPt     Specify the time property and alarm date and time. It
 * includes:             \n u32Year: Year value, range between 2000 ~ 2099. \n
 *                     u32Month: Month value, range between 1 ~ 12. \n u32Day:
 * Day value, range between 1 ~ 31.                                    \n
 *                     u32DayOfWeek: Day of the week. [RTC_SUNDAY / RTC_MONDAY /
...
void RTC_SetAlarmDateAndTime( S_RTC_TIME_DATA_T * sPt )
{
    ...
    else
    {
        ...
        /*-----------------------------------------------------------------------------------------------------*/
        u32RegCALM = ( ( sPt->u32Year - ( uint32_t ) RTC_YEAR2000 ) / 10UL )
                     << 20;
        u32RegCALM |= ( ( ( sPt->u32Year - ( uint32_t ) RTC_YEAR2000 ) % 10UL )
                        << 16 );
 ...
 * @param[in]  u32DayOfWeek    The Day of the week. [RTC_SUNDAY / RTC_MONDAY /
 * RTC_TUESDAY / RTC_WEDNESDAY / RTC_THURSDAY / RTC_FRIDAY / RTC_SATURDAY]
 *
 * @return     None
 *
 ...
 * @param[in]  u32TimeMode     The 24-Hour / 12-Hour Time Scale Selection.
 * [RTC_CLOCK_12 / RTC_CLOCK_24]
 * @param[in]  u32AmPm         12-hour time scale with AM and PM indication.
 * Only Time Scale select 12-hour used. [RTC_AM / RTC_PM]
 *
 * @return     None
 *
 ...
 * @return     None
 *
 * @details    This API is used to enable or disable RTC alarm date mask
 * function.
 */
 ...
 * @return     None
 *
 * @details    This API is used to enable or disable RTC alarm time mask
 * function.
 */
 ...
 *
 * @param[in]  u32TickSelection    It is used to set the RTC tick period time
 * for Periodic Time Tick request. \n It consists of:
 *                                     - \ref RTC_TICK_1_SEC     : Time tick is
 * 1 second
 *                                     - \ref RTC_TICK_1_2_SEC   : Time tick is
 * 1/2 second
 *                                     - \ref RTC_TICK_1_4_SEC   : Time tick is
 * 1/4 second
 *                                     - \ref RTC_TICK_1_8_SEC   : Time tick is
 * 1/8 second
 *                                     - \ref RTC_TICK_1_16_SEC  : Time tick is
 * 1/16 second
 *                                     - \ref RTC_TICK_1_32_SEC  : Time tick is
 * 1/32 second
 *                                     - \ref RTC_TICK_1_64_SEC  : Time tick is
 * 1/64 second
 *                                     - \ref RTC_TICK_1_128_SEC : Time tick is
 * 1/128 second
 *
 * @return     None
 *
 * @details    This API is used to set RTC tick period time for each tick
 * interrupt.
 */
 ...
 *                                     - \ref RTC_INTEN_ALMIEN_Msk   : Alarm
 * interrupt
 *                                     - \ref RTC_INTEN_TICKIEN_Msk  : Tick
 * interrupt
 *                                     - \ref RTC_INTEN_TAMP0IEN_Msk : Tamper 0
 * Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_TAMP1IEN_Msk : Tamper 1
 * or Pair 0 Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_TAMP2IEN_Msk : Tamper 2
 * Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_TAMP3IEN_Msk : Tamper 3
 * or Pair 1 Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_TAMP4IEN_Msk : Tamper 4
 * Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_TAMP5IEN_Msk : Tamper 5
 * or Pair 2 Pin Event Detection interrupt
 *                                     - \ref RTC_INTEN_CLKFIEN_Msk  : LXT Clock
 * Frequency Monitor Fail interrupt
 *                                     - \ref RTC_INTEN_CLKSPIEN_Msk : LXT Clock
 * Frequency Monitor Stop interrupt
 *
 * @return     None
 *
 ...
 * @return     None
 *
 * @details    This API is used to enable the spare registers 0~19 can be
 * accessed.
 */
 ...
 * @return     None
 *
 * @details    This API is used to disable the spare register 0~19 cannot be
 * accessed.
 */
 ...
 *
 * @param[in]  u32DetecLevel       Tamper pin detection level select. Possible
 * options are
 ...
 * @return     None
 *
 * @details    This API is used to enable the tamper pin detect function with
 * specify trigger condition. User need disable dynamic tamper function before
 * use this API.
 */
                             ...
                             uint32_t u32DebounceEn )
{
    ...
    u32TmpReg = ( RTC_TAMPCTL_TAMP0EN_Msk |
                  ( u32DetecLevel << RTC_TAMPCTL_TAMP0LV_Pos ) |
    ...
    for( i = 0UL; i < ( uint32_t ) MAX_TAMPER_PIN_NUM; i++ )
    {
        ...
        {
            u32Reg &= ~( ( RTC_TAMPCTL_TAMP0EN_Msk | RTC_TAMPCTL_TAMP0LV_Msk |
 ...
 *
 * @param[in]  u32PairSel          Tamper pin detection enable. Possible options
 * are
                              ...
                              uint32_t u32Pair2Source )
{
    ...
    RTC_WaitAccessEnable();
    u32Reg = pRTC->TAMPCTL;
    u32Reg &= ~( RTC_TAMPCTL_TAMP0EN_Msk | RTC_TAMPCTL_TAMP1EN_Msk |
                 RTC_TAMPCTL_TAMP2EN_Msk | RTC_TAMPCTL_TAMP3EN_Msk |
                 RTC_TAMPCTL_TAMP4EN_Msk | RTC_TAMPCTL_TAMP5EN_Msk );
    ...
    u32Reg |= ( ( u32Pair1Source & 0x1UL ) << RTC_TAMPCTL_DYN1ISS_Pos ) |
              ( ( u32Pair2Source & 0x1UL ) << RTC_TAMPCTL_DYN2ISS_Pos );

    if( u32DebounceEn )
    {
        u32TmpReg = ( RTC_TAMPCTL_TAMP0EN_Msk | RTC_TAMPCTL_TAMP1EN_Msk |
                      RTC_TAMPCTL_TAMP0DBEN_Msk | RTC_TAMPCTL_TAMP1DBEN_Msk |
...
void RTC_DynamicTamperDisable( uint32_t u32PairSel )
{
    ...
    if( ( u32Reg & ( uint32_t ) RTC_TAMPCTL_DYN1ISS_Msk ) &&
        ( u32PairSel & ( uint32_t ) RTC_PAIR1_SELECT ) )
    {
        u32Tamper2En = u32Reg & RTC_TAMPCTL_TAMP2EN_Msk;
    }

    if( ( u32Reg & ( uint32_t ) RTC_TAMPCTL_DYN2ISS_Msk ) &&
        ( u32PairSel & ( uint32_t ) RTC_PAIR2_SELECT ) )
    {
                              ...
                              uint32_t u32Seed )
{
    ...
    u32Reg &= ~( RTC_TAMPCTL_DYNSRC_Msk | RTC_TAMPCTL_SEEDRLD_Msk |
                 RTC_TAMPCTL_DYNRATE_Msk );

    u32Reg |= ( u32ChangeRate ) |
              ( ( u32SeedReload & 0x1UL ) << RTC_TAMPCTL_SEEDRLD_Pos ) |
