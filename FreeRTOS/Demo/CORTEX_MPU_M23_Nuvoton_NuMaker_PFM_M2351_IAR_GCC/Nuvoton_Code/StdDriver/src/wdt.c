 ...
 *
 * @param[in]  u32TimeoutInterval  Time-out interval period of WDT module. Valid
 * values are:
 ...
 * @param[in]  u32ResetDelay       Configure WDT time-out reset delay period.
 * Valid values are:
 *                                 - \ref WDT_RESET_DELAY_1026CLK
 *                                 - \ref WDT_RESET_DELAY_130CLK
 *                                 - \ref WDT_RESET_DELAY_18CLK
 *                                 - \ref WDT_RESET_DELAY_3CLK
 * @param[in]  u32EnableReset      Enable WDT time-out reset system function.
 * Valid values are TRUE and FALSE.
 * @param[in]  u32EnableWakeup     Enable WDT time-out wake-up system function.
 * Valid values are TRUE and FALSE.
 *
 * @return     None
 *
 * @details    This function makes WDT module start counting with different
 * time-out interval, reset delay period and choose to \n enable or disable WDT
 * time-out reset system or wake-up system.
