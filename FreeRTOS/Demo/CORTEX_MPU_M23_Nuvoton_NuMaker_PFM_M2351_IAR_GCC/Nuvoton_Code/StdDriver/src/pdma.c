 ...
 * @return      None
 *
 * @details     This function set the selected channel data width and transfer
 * count.
 */
 ...
 * @return      None
 *
 * @details     This function set the selected channel source/destination
 * address and attribute.
 */
                           ...
                           uint32_t u32DstCtrl )
{
    ...
    ( pdma )->DSCT[ u32Ch ].CTL &= ~( PDMA_DSCT_CTL_SAINC_Msk |
 ...
 * @return      None
 *
 * @details     This function set the selected channel transfer mode. Include
 * peripheral setting.
 */
                           ...
                           uint32_t u32DescAddr )
{
    ...
    if( u32ScatterEn )
    {
        ( pdma )->DSCT[ u32Ch ].CTL = ( ( pdma )->DSCT[ u32Ch ].CTL &
 ...
 * @return      None
 *
 * @details     This function enable timeout function of the selected
 * channel(s).
 ...
 * @return      None
 *
 * @details     This function disable timeout function of the selected
 * channel(s).
 * @note        This function is only supported in channel 0 and channel 1.
 */
                      ...
                      uint32_t u32TimeOutCnt )
{
    ...
    {
        case 0UL:
            ( pdma )->TOC0_1 = ( ( pdma )->TOC0_1 & ~PDMA_TOC0_1_TOC0_Msk ) |
                               u32TimeOutCnt;
            break;
        case 1UL:
            ( pdma )->TOC0_1 = ( ( pdma )->TOC0_1 & ~PDMA_TOC0_1_TOC1_Msk ) |
                               ( u32TimeOutCnt << PDMA_TOC0_1_TOC1_Pos );
            break;
 ...
 * @note        PDMA_INT_TIMEOUT is only supported in channel 0 and channel 1.
 * @note        The transfer done interrupt is disabled when table empty
 * interrupt is disabled(PDMA_INT_TEMPTY).
 */
