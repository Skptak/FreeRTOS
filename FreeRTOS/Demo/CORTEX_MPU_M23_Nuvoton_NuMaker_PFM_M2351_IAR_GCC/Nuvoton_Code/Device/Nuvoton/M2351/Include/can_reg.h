...
typedef struct
{
     ...
     * |        |          |0x01-0x20: Valid Message Number, the Message Object
     * in the Message |        |          |RAM is selected for data transfer. |
     * |          |0x00: Not a valid Message Number, interpreted as 0x20. | |
     * |0x21-0x3F: Not a valid Message Number, interpreted as 0x01-0x1F.
     * |[15]    |Busy      |Busy Flag
     * |        |          |0 = Read/write action has finished.
     * |        |          |1 = Writing to the IFn Command Request Register is
     * in progress. |        |          |This bit can only be read by the
     * software.
     * @var CAN_IF_T::CMASK
     ...
     * |        |          |Read Operation:
     * |        |          |0 = Data Bytes [7:4] unchanged.
     * |        |          |1 = Transfer Data Bytes [7:4] to IFn Message Buffer
     * Register.
     ...
     * |        |          |Read Operation:
     * |        |          |0 = Data Bytes [3:0] unchanged.
     * |        |          |1 = Transfer Data Bytes [3:0] to IFn Message Buffer
     * Register.
     * |[2]     |TxRqst_NewDat|Access Transmission Request Bit When Write
     * Operation |        |          |0 = TxRqst bit unchanged. |        | |1 =
     * Set TxRqst bit. |        |          |Note: If a transmission is requested
     * by programming bit TxRqst/NewDat in the IFn Command Mask Register, bit
     * TxRqst in the IFn Message Control Register will be ignored. |        |
     * |Access New Data Bit when Read Operation. |        |          |0 = NewDat
     * bit remains unchanged. |        |          |1 = Clear NewDat bit in the
     * Message Object. |        |          |Note: A read access to a Message
     * Object can be combined with the reset of the control bits IntPnd and
     * NewDat. |        |          |The values of these bits transferred to the
     * IFn Message Control Register always reflect the status before resetting
     * these bits.
     * |[3]     |ClrIntPnd |Clear Interrupt Pending Bit
     * |        |          |Write Operation:
     * |        |          |When writing to a Message Object, this bit is
     * ignored. |        |          |Read Operation: |        |          |0 =
     * IntPnd bit (CAN_IFn_MCON[13]) remains unchanged. |        |          |1 =
     ...
     * |        |          |Read Operation:
     * |        |          |0 = Control Bits unchanged.
     * |        |          |1 = Transfer Control Bits to IFn Message Buffer
     * Register.
     * |[5]     |Arb       |Access Arbitration Bits
     * |        |          |Write Operation:
     * |        |          |0 = Arbitration bits unchanged.
     * |        |          |1 = Transfer Identifier + Dir (CAN_IFn_ARB2[13]) +
     * Xtd (CAN_IFn_ARB2[14]) + MsgVal (CAN_IFn_APB2[15]) to Message Object. |
     * |          |Read Operation: |        |          |0 = Arbitration bits
     * unchanged. |        |          |1 = Transfer Identifier + Dir + Xtd +
     * MsgVal to IFn Message Buffer Register.
     * |[6]     |Mask      |Access Mask Bits
     * |        |          |Write Operation:
     * |        |          |0 = Mask bits unchanged.
     * |        |          |1 = Transfer Identifier Mask + MDir + MXtd to
     * Message Object. |        |          |Read Operation: |        | |0 = Mask
     * bits unchanged. |        |          |1 = Transfer Identifier Mask + MDir
     * + MXtd to IFn Message Buffer Register.
     * |[7]     |WR_RD     |Write / Read Mode
     * |        |          |0 = Read: Transfer data from the Message Object
     * addressed by the Command Request Register into the selected Message
     * Buffer Registers. |        |          |1 = Write: Transfer data from the
     * selected Message Buffer Registers to the Message Object addressed by the
     ...
     * message object cannot inhibit the match in the acceptance filtering. | |
     ...
     * |        |          |0 = The message direction bit (Dir
     * (CAN_IFn_ARB2[13])) has no effect on the acceptance filtering. |        |
     * |1 = The message direction bit (Dir) is used for acceptance filtering.
     * |[15]    |MXtd      |Mask Extended Identifier
     * |        |          |0 = The extended identifier bit (IDE) has no effect
     * on the acceptance filtering. |        |          |1 = The extended
     * identifier bit (IDE) is used for acceptance filtering. |        | |Note:
     ...
     * (CAN_IFn_ARB2[12:2]). |        |          |For acceptance filtering, only
     * these bits together with mask bits Msk28 to Msk18 (CAN_IFn_MASK2[12:2])
     * are considered.
     * @var CAN_IF_T::ARB1
     ...
     * |        |          |On TxRqst, a Remote Frame with the identifier of
     * this Message Object is transmitted. |        |          |On reception of
     * a Data Frame with matching identifier, that message is stored in this
     * Message Object. |        |          |1 = Direction is transmit. | | |On
     * TxRqst, the respective Message Object is transmitted as a Data Frame. |
     * |          |On reception of a Remote Frame with matching identifier, the
     * TxRqst bit (CAN_IFn_CMASK[2]) of this Message Object is set (if RmtEn
     * (CAN_IFn_MCON[9]) = one).
     * |[14]    |Xtd       |Extended Identifier
     * |        |          |0 = The 11-bit ("standard") Identifier will be used
     * for this Message Object. |        |          |1 = The 29-bit ("extended")
     * Identifier will be used for this Message Object.
     * |[15]    |MsgVal    |Message Valid
     * |        |          |0 = The Message Object is ignored by the Message
     * Handler. |        |          |1 = The Message Object is configured and
     * should be considered by the Message Handler. |        |          |Note:
     * The application software must reset the MsgVal bit of all unused Messages
     * Objects during the initialization before it resets bit Init (CAN_CON[0]).
     * |        |          |This bit must also be reset before the identifier
     * Id28-0 (CAN_IFn_ARB1/2), the control bits Xtd (CAN_IFn_ARB2[14]), Dir
     * (CAN_IFn_APB2[13]), or the Data Length Code DLC3-0 (CAN_IFn_MCON[3:0])
     ...
     * |        |          |Note: The Data Length Code of a Message Object must
     * be defined the same as in all the corresponding objects with the same
     * identifier at other nodes. |        |          |When the Message Handler
     * stores a data frame, it will write the DLC to the value given by the
     * received message. |        |          |Data 0: 1st data byte of a CAN
     * Data Frame |        |          |Data 1: 2nd data byte of a CAN Data Frame
     ...
     * |        |          |Note: The Data 0 Byte is the first data byte shifted
     * into the shift register of the CAN Core during a reception while the Data
     * 7 byte is the last. |        |          |When the Message Handler stores
     * a Data Frame, it will write all the eight data bytes into a Message
     * Object. |        |          |If the Data Length Code is less than 8, the
     * remaining bytes of the Message Object will be overwritten by unspecified
     * values.
     * |[7]     |EoB       |End Of Buffer
     * |        |          |0 = Message Object belongs to a FIFO Buffer and is
     * not the last Message Object of that FIFO Buffer. |        |          |1 =
     * Single Message Object or last Message Object of a FIFO Buffer. |        |
     * |Note: This bit is used to concatenate two or more Message Objects (up to
     * 32) to build a FIFO Buffer. |        |          |For single Message
     * Objects (not belonging to a FIFO Buffer), this bit must always be set to
     * one.
     * |[8]     |TxRqst    |Transmit Request
     * |        |          |0 = This Message Object is not waiting for
     * transmission. |        |          |1 = The transmission of this Message
     * Object is requested and is not yet done.
     * |[9]     |RmtEn     |Remote Enable Control
     * |        |          |0 = At the reception of a Remote Frame, TxRqst
     * (CAN_IFn_MCON[8]) is left unchanged. |        |          |1 = At the
     * reception of a Remote Frame, TxRqst is set.
     * |[10]    |RxIE      |Receive Interrupt Enable Control
     * |        |          |0 = IntPnd (CAN_IFn_MCON[13]) will be left unchanged
     * after a successful reception of a frame. |        |          |1 = IntPnd
     * will be set after a successful reception of a frame.
     * |[11]    |TxIE      |Transmit Interrupt Enable Control
     * |        |          |0 = IntPnd (CAN_IFn_MCON[13]) will be left unchanged
     * after the successful transmission of a frame. |        |          |1 =
     * IntPnd will be set after a successful transmission of a frame.
     * |[12]    |UMask     |Use Acceptance Mask
     * |        |          |0 = Mask ignored.
     * |        |          |1 = Use Mask (Msk28-0, MXtd, and MDir) for
     * acceptance filtering. |        |          |Note: If the UMask bit is set
     * to one, the Message Object's mask bits have to be programmed during
     * initialization of the Message Object before MsgVal bit (CAN_IFn_APB2[15])
     * is set to one.
     * |[13]    |IntPnd    |Interrupt Pending
     * |        |          |0 = This message object is not the source of an
     * interrupt. |        |          |1 = This message object is the source of
     * an interrupt. |        |          |The Interrupt Identifier in the
     * Interrupt Register will point to this message object if there is no other
     * interrupt source with higher priority.
     * |[14]    |MsgLst    |Message Lost (only valid for Message Objects with
     * direction = receive). |        |          |0 = No message lost since last
     * time this bit was reset by the CPU. |        |          |1 = The Message
     * Handler stored a new message into this object when NewDat was still set,
     * the CPU has lost a message.
     * |[15]    |NewDat    |New Data
     * |        |          |0 = No new data has been written into the data
     * portion of this Message Object by the Message Handler since last time
     * this flag was cleared by the application software. |        |          |1
     * = The Message Handler or the application software has written new data
    ...
    __IO uint32_t CREQ; /* Offset: 0x20, 0x80  IFn (Register Map Note 2) Command
                           Request Registers          */
    ...
    __IO uint32_t DAT_A1; /* Offset: 0x3C, 0x9C  IFn Data A1 Register (Register
                             Map Note 3)                   */
    __IO uint32_t DAT_A2; /* Offset: 0x40, 0xA0  IFn Data A2 Register (Register
                             Map Note 3)                   */
    __IO uint32_t DAT_B1; /* Offset: 0x44, 0xA4  IFn Data B1 Register (Register
                             Map Note 3)                   */
    __IO uint32_t DAT_B2; /* Offset: 0x48, 0xA8  IFn Data B2 Register (Register
                             Map Note 3)                   */
...
typedef struct
{
     ...
     * |        |          |0 = Disabled - No Status Change Interrupt will be
     * generated. |        |          |1 = Enabled - An interrupt will be
     * generated when a message transfer is successfully completed or a CAN bus
     * error is detected.
     * |[3]     |EIE       |Error Interrupt Enable Control
     * |        |          |0 = Disabled - No Error Status Interrupt will be
     * generated. |        |          |1 = Enabled - A change in the bits BOff
     * (CAN_STATUS[7]) or EWarn (CAN_STATUS[6]) in the Status Register will
     * generate an interrupt.
     * |[5]     |DAR       |Automatic Re-Transmission Disable Control
     * |        |          |0 = Automatic Retransmission of disturbed messages
     * enabled. |        |          |1 = Automatic Retransmission disabled.
     * |[6]     |CCE       |Configuration Change Enable Control
     * |        |          |0 = No write access to the Bit Timing Register.
     * |        |          |1 = Write access to the Bit Timing Register
     * (CAN_BTIME) allowed. (while Init bit (CAN_CON[0]) = 1).
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2:0]   |LEC       |Last Error Code (Type Of The Last Error To Occur On
     * The CAN Bus) |        |          |The LEC field holds a code, which
     * indicates the type of the last error to occur on the CAN bus. |        |
     * |This field will be cleared to '0' when a message has been transferred
     * (reception or transmission) without error. |        |          |The
     * unused code '7' may be written by the CPU to check for updates. | | |The
     * following table describes the error code.
     * |[3]     |TxOK      |Transmitted A Message Successfully
     * |        |          |0 = Since this bit was reset by the CPU, no message
     * has been successfully transmitted. |        |          |This bit is never
     * reset by the CAN Core. |        |          |1 = Since this bit was last
     * reset by the CPU, a message has been successfully (error free and
     * acknowledged by at least one other node) transmitted.
     * |[4]     |RxOK      |Received A Message Successfully
     * |        |          |0 = No message has been successfully received since
     * this bit was last reset by the CPU. |        |          |This bit is
     * never reset by the CAN Core. |        |          |1 = A message has been
     * successfully received since this bit was last reset by the CPU
     * (independent of the result of acceptance filtering).
     * |[5]     |EPass     |Error Passive (Read Only)
     * |        |          |0 = The CAN Core is error active.
     * |        |          |1 = The CAN Core is in the error passive state as
     * defined in the CAN Specification.
     * |[6]     |EWarn     |Error Warning Status (Read Only)
     * |        |          |0 = Both error counters are below the error warning
     * limit of 96. |        |          |1 = At least one of the error counters
     ...
     * passive level. |        |          |1 = The Receive Error Counter has
     * reached the error passive level as defined in the CAN Specification.
     * @var CAN_T::BTIME
     ...
     * frequency is divided for generating the bit time quanta. |        | |The
     * bit time is built up from a multiple of this quanta. |        | |Valid
     * values for the Baud Rate Prescaler are [ 0 ... 63 ]. |        | |The
     ...
     * value is such that one more than the value programmed here is used.
     * |[11:8]  |TSeg1     |Time Segment Before The Sample Point Minus Sync_Seg
     * |        |          |0x01-0x0F: valid values for TSeg1 are [1 ... 15].
     * |        |          |The actual interpretation by the hardware of this
     * value is such that one more than the value programmed is used.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |IntId     |Interrupt Identifier (Indicates The Source Of The
     * Interrupt) |        |          |If several interrupts are pending, the
     * CAN Interrupt Register will point to the pending interrupt with the
     * highest priority, disregarding their chronological order. |        | |An
     * interrupt remains pending until the application software has cleared it.
     * |        |          |If IntId is different from 0x0000 and IE
     * (CAN_IFn_MCON[1]) is set, the IRQ interrupt signal to the EIC is active.
     * |        |          |The interrupt remains active until IntId is back to
     * value 0x0000 (the cause of the interrupt is reset) or until IE is reset.
     * |        |          |The Status Interrupt has the highest priority.
     * |        |          |Among the message interrupts, the Message Object' s
     * interrupt priority decreases with increasing message number. |        |
     * |A message interrupt is cleared by clearing the Message Object's IntPnd
     * bit (CAN_IFn_MCON[13]). |        |          |The Status Interrupt is
     ...
     * |        |          |These bits are always read as '0' and must always be
     * written with '0'.
     * |[2]     |Basic     |Basic Mode
     ...
     * |        |          |00 = Reset value, CAN_TX pin is controlled by the
     * CAN Core. |        |          |01 = Sample Point can be monitored at
     * CAN_TX pin. |        |          |10 = CAN_TX pin drives a dominant ('0')
     * value. |        |          |11 = CAN_TX pin drives a recessive ('1')
     * value.
     ...
     * |        |          |0x00-0x0F: By programming BRPE, the Baud Rate
     * Prescaler can be extended to values up to 1023. |        |          |The
     * actual interpretation by the hardware is that one more than the value
     * programmed by BRPE (MSBs) and BTIME (LSBs) is used.
     * @var CAN_T::IF
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |TxRqst[16:1]|Transmission Request Bits 16-1 (Of All Message
     * Objects) |        |          |0 = This Message Object is not waiting for
     * transmission. |        |          |1 = The transmission of this Message
     * Object is requested and is not yet done. |        |          |These bits
     * are read only.
     * @var CAN_T::TXREQ2
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |TxRqst[32:17]|Transmission Request Bits 32-17 (Of All Message
     * Objects) |        |          |0 = This Message Object is not waiting for
     * transmission. |        |          |1 = The transmission of this Message
     * Object is requested and is not yet done. |        |          |These bits
     * are read only.
     ...
     * |        |          |0 = No new data has been written into the data
     * portion of this Message Object by the Message Handler since the last time
     * this flag was cleared by the application software. |        |          |1
     * = The Message Handler or the application software has written new data
     * into the data portion of this Message Object.
     * @var CAN_T::NDAT2
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |IntPnd[16:1]|Interrupt Pending Bits 16-1 (Of All Message
     * Objects) |        |          |0 = This message object is not the source
     * of an interrupt. |        |          |1 = This message object is the
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |IntPnd[32:17]|Interrupt Pending Bits 32-17(Of All Message
     * Objects) |        |          |0 = This message object is not the source
     * of an interrupt. |        |          |1 = This message object is the
     * source of an interrupt.
     * @var CAN_T::MVLD1
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MsgVal[16:1]|Message Valid Bits 16-1 (Of All Message Objects)
     * (Read Only) |        |          |0 = This Message Object is ignored by
     * the Message Handler. |        |          |1 = This Message Object is
     * configured and should be considered by the Message Handler. |        |
     * |Ex. |        |          |CAN_MVLD1[0] means Message object No.1 is valid
     * or not. |        |          |If CAN_MVLD1[0] is set, message object No.1
     * is configured.
     * @var CAN_T::MVLD2
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |MsgVal[32:17]|Message Valid Bits 32-17 (Of All Message Objects)
     * (Read Only) |        |          |0 = This Message Object is ignored by
     * the Message Handler. |        |          |1 = This Message Object is
     * configured and should be considered by the Message Handler. |        |
     ...
     * |        |          |Note: User can wake-up system when there is a
     * falling edge in the CAN_Rx pin.
     * @var CAN_T::WU_STATUS
...
#define CAN_IF_CMASK_WRRD_Msk \
    ( 0x1ul << CAN_IF_CMASK_WRRD_Pos ) /*!< CAN_IF_T::CMASK: WRRD Mask     */

#define CAN_IF_CMASK_MASK_Pos 6 /*!< CAN_IF_T::CMASK: MASK Position */
#define CAN_IF_CMASK_MASK_Msk \
    ( 0x1ul << CAN_IF_CMASK_MASK_Pos ) /*!< CAN_IF_T::CMASK: MASK Mask     */

#define CAN_IF_CMASK_ARB_Pos 5 /*!< CAN_IF_T::CMASK: ARB Position  */
#define CAN_IF_CMASK_ARB_Msk \
    ( 0x1ul << CAN_IF_CMASK_ARB_Pos ) /*!< CAN_IF_T::CMASK: ARB Mask      */

#define CAN_IF_CMASK_CONTROL_Pos 4 /*!< CAN_IF_T::CMASK: CONTROL Position */
#define CAN_IF_CMASK_CONTROL_Msk                                             \
    ( 0x1ul << CAN_IF_CMASK_CONTROL_Pos ) /*!< CAN_IF_T::CMASK: CONTROL Mask \
                                           */

#define CAN_IF_CMASK_CLRINTPND_Pos             \
    3 /*!< CAN_IF_T::CMASK: CLRINTPND Position \
       */
#define CAN_IF_CMASK_CLRINTPND_Msk                                          \
    ( 0x1ul << CAN_IF_CMASK_CLRINTPND_Pos ) /*!< CAN_IF_T::CMASK: CLRINTPND \
                                               Mask */

#define CAN_IF_CMASK_TXRQSTNEWDAT_Pos \
    2 /*!< CAN_IF_T::CMASK: TXRQSTNEWDAT Position */
#define CAN_IF_CMASK_TXRQSTNEWDAT_Msk                                \
    ( 0x1ul << CAN_IF_CMASK_TXRQSTNEWDAT_Pos ) /*!< CAN_IF_T::CMASK: \
                                                  TXRQSTNEWDAT Mask     */

#define CAN_IF_CMASK_DATAA_Pos 1 /*!< CAN_IF_T::CMASK: DATAA Position */
#define CAN_IF_CMASK_DATAA_Msk \
    ( 0x1ul << CAN_IF_CMASK_DATAA_Pos ) /*!< CAN_IF_T::CMASK: DATAA Mask */

#define CAN_IF_CMASK_DATAB_Pos 0 /*!< CAN_IF_T::CMASK: DATAB Position */
#define CAN_IF_CMASK_DATAB_Msk \
    ( 0x1ul << CAN_IF_CMASK_DATAB_Pos ) /*!< CAN_IF_T::CMASK: DATAB Mask */

/* CAN IFn_MASK1 Bit Field Definitions */
#define CAN_IF_MASK1_MSK_Pos 0 /*!< CAN_IF_T::MASK1: MSK Position   */
#define CAN_IF_MASK1_MSK_Msk \
    ( 0xFFul << CAN_IF_MASK1_MSK_Pos ) /*!< CAN_IF_T::MASK1: MSK Mask       */

/* CAN IFn_MASK2 Bit Field Definitions */
#define CAN_IF_MASK2_MXTD_Pos 15 /*!< CAN_IF_T::MASK2: MXTD Position */
#define CAN_IF_MASK2_MXTD_Msk \
    ( 0x1ul << CAN_IF_MASK2_MXTD_Pos ) /*!< CAN_IF_T::MASK2: MXTD Mask     */

#define CAN_IF_MASK2_MDIR_Pos 14 /*!< CAN_IF_T::MASK2: MDIR Position */
#define CAN_IF_MASK2_MDIR_Msk \
    ( 0x1ul << CAN_IF_MASK2_MDIR_Pos ) /*!< CAN_IF_T::MASK2: MDIR Mask     */

#define CAN_IF_MASK2_MSK_Pos 0 /*!< CAN_IF_T::MASK2: MSK Position */
#define CAN_IF_MASK2_MSK_Msk \
    ( 0x1FFul << CAN_IF_MASK2_MSK_Pos ) /*!< CAN_IF_T::MASK2: MSK Mask     */

/* CAN IFn_ARB1 Bit Field Definitions */
#define CAN_IF_ARB1_ID_Pos 0 /*!< CAN_IF_T::ARB1: ID Position   */
#define CAN_IF_ARB1_ID_Msk \
    ( 0xFFFFul << CAN_IF_ARB1_ID_Pos ) /*!< CAN_IF_T::ARB1: ID Mask       */
...
#define CAN_IF_DAT_A1_DATA1_Msk \
    ( 0xFFul << CAN_IF_DAT_A1_DATA1_Pos ) /*!< CAN_IF_T::DATAA1: DATA1 Mask */

#define CAN_IF_DAT_A1_DATA0_Pos 0 /*!< CAN_IF_T::DATAA1: DATA0 Position */
#define CAN_IF_DAT_A1_DATA0_Msk \
    ( 0xFFul << CAN_IF_DAT_A1_DATA0_Pos ) /*!< CAN_IF_T::DATAA1: DATA0 Mask */
...
#define CAN_IF_DAT_A2_DATA3_Msk \
    ( 0xFFul << CAN_IF_DAT_A2_DATA3_Pos ) /*!< CAN_IF_T::DATAA1: DATA3 Mask */

#define CAN_IF_DAT_A2_DATA2_Pos 0 /*!< CAN_IF_T::DATAA1: DATA2 Position */
#define CAN_IF_DAT_A2_DATA2_Msk \
    ( 0xFFul << CAN_IF_DAT_A2_DATA2_Pos ) /*!< CAN_IF_T::DATAA1: DATA2 Mask */
...
#define CAN_IF_DAT_B1_DATA5_Msk \
    ( 0xFFul << CAN_IF_DAT_B1_DATA5_Pos ) /*!< CAN_IF_T::DATAB1: DATA5 Mask */

#define CAN_IF_DAT_B1_DATA4_Pos 0 /*!< CAN_IF_T::DATAB1: DATA4 Position */
#define CAN_IF_DAT_B1_DATA4_Msk \
    ( 0xFFul << CAN_IF_DAT_B1_DATA4_Pos ) /*!< CAN_IF_T::DATAB1: DATA4 Mask */
...
#define CAN_IF_DAT_B2_DATA7_Msk \
    ( 0xFFul << CAN_IF_DAT_B2_DATA7_Pos ) /*!< CAN_IF_T::DATAB2: DATA7 Mask */

#define CAN_IF_DAT_B2_DATA6_Pos 0 /*!< CAN_IF_T::DATAB2: DATA6 Position */
#define CAN_IF_DAT_B2_DATA6_Msk \
    ( 0xFFul << CAN_IF_DAT_B2_DATA6_Pos ) /*!< CAN_IF_T::DATAB2: DATA6 Mask */

/* CAN IFn_TXRQST1 Bit Field Definitions */
#define CAN_TXRQST1_TXRQST_Pos 0 /*!< CAN_T::TXRQST1: TXRQST Position */
#define CAN_TXRQST1_TXRQST_Msk \
    ( 0xFFFFul << CAN_TXRQST1_TXRQST_Pos ) /*!< CAN_T::TXRQST1: TXRQST Mask */

/* CAN IFn_TXRQST2 Bit Field Definitions */
#define CAN_TXRQST2_TXRQST_Pos 0 /*!< CAN_T::TXRQST2: TXRQST Position  */
#define CAN_TXRQST2_TXRQST_Msk \
    ( 0xFFFFul << CAN_TXRQST2_TXRQST_Pos ) /*!< CAN_T::TXRQST2: TXRQST Mask */

/* CAN IFn_NDAT1 Bit Field Definitions */
#define CAN_NDAT1_NEWDATA_Pos 0 /*!< CAN_T::NDAT1: NEWDATA Position */
#define CAN_NDAT1_NEWDATA_Msk \
    ( 0xFFFFul << CAN_NDAT1_NEWDATA_Pos ) /*!< CAN_T::NDAT1: NEWDATA Mask */

/* CAN IFn_NDAT2 Bit Field Definitions */
#define CAN_NDAT2_NEWDATA_Pos 0 /*!< CAN_T::NDAT2: NEWDATA Position */
#define CAN_NDAT2_NEWDATA_Msk \
    ( 0xFFFFul << CAN_NDAT2_NEWDATA_Pos ) /*!< CAN_T::NDAT2: NEWDATA Mask */

/* CAN IFn_IPND1 Bit Field Definitions */
#define CAN_IPND1_INTPND_Pos 0 /*!< CAN_T::IPND1: INTPND Position */
#define CAN_IPND1_INTPND_Msk \
    ( 0xFFFFul << CAN_IPND1_INTPND_Pos ) /*!< CAN_T::IPND1: INTPND Mask     */

/* CAN IFn_IPND2 Bit Field Definitions */
#define CAN_IPND2_INTPND_Pos 0 /*!< CAN_T::IPND2: INTPND Position */
#define CAN_IPND2_INTPND_Msk \
    ( 0xFFFFul << CAN_IPND2_INTPND_Pos ) /*!< CAN_T::IPND2: INTPND Mask     */

/* CAN IFn_MVLD1 Bit Field Definitions */
#define CAN_MVLD1_MSGVAL_Pos 0 /*!< CAN_T::MVLD1: MSGVAL Position */
#define CAN_MVLD1_MSGVAL_Msk \
    ( 0xFFFFul << CAN_MVLD1_MSGVAL_Pos ) /*!< CAN_T::MVLD1: MSGVAL Mask     */

/* CAN IFn_MVLD2 Bit Field Definitions */
#define CAN_MVLD2_MSGVAL_Pos 0 /*!< CAN_T::MVLD2: MSGVAL Position */
#define CAN_MVLD2_MSGVAL_Msk \
    ( 0xFFFFul << CAN_MVLD2_MSGVAL_Pos ) /*!< CAN_T::MVLD2: MSGVAL Mask     */

/* CAN WUEN Bit Field Definitions */
#define CAN_WU_EN_WAKUP_EN_Pos 0 /*!< CAN_T::WU_EN: WAKUP_EN Position */
#define CAN_WU_EN_WAKUP_EN_Msk \
    ( 0x1ul << CAN_WU_EN_WAKUP_EN_Pos ) /*!< CAN_T::WU_EN: WAKUP_EN Mask */

/* CAN WUSTATUS Bit Field Definitions */
#define CAN_WU_STATUS_WAKUP_STS_Pos \
    0 /*!< CAN_T::WU_STATUS: WAKUP_STS Position */
#define CAN_WU_STATUS_WAKUP_STS_Msk                                           \
    ( 0x1ul << CAN_WU_STATUS_WAKUP_STS_Pos ) /*!< CAN_T::WU_STATUS: WAKUP_STS \
                                                Mask     */
