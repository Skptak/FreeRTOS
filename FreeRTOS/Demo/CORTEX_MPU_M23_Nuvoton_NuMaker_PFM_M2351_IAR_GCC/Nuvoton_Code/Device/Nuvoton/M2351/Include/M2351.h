...
/**
  ...
  * <b>Disclaimer</b>
  *
  * The Software is furnished "AS IS", without warranty as to performance or
  results, and
  * the entire risk as to performance or results is assumed by YOU. Nuvoton
  disclaims all
  * warranties, express, implied or otherwise, with regard to the Software, its
  use, or
  * operation, including without limitation any and all warranties of
...
/**
 * @details  Interrupt Number Definition. The maximum of 32 Specific Interrupts
 * are possible.
 */
typedef enum IRQn
{
    ...
    /* --------  Configuration of the Cortex-ARMv8MBL Processor and Core
     * Peripherals  ------- */
...
*/
    ...
    #define PA \
        ( ( GPIO_T * ) GPIOA_BASE ) /*!< GPIO PORTA Pointer                 */
    #define PB \
        ( ( GPIO_T * ) GPIOB_BASE ) /*!< GPIO PORTB Pointer                 */
    #define PC \
        ( ( GPIO_T * ) GPIOC_BASE ) /*!< GPIO PORTC Pointer                 */
    #define PD \
        ( ( GPIO_T * ) GPIOD_BASE ) /*!< GPIO PORTD Pointer                 */
    #define PE \
        ( ( GPIO_T * ) GPIOE_BASE ) /*!< GPIO PORTE Pointer                 */
    #define PF \
        ( ( GPIO_T * ) GPIOF_BASE ) /*!< GPIO PORTF Pointer                 */
    #define PG \
        ( ( GPIO_T * ) GPIOG_BASE ) /*!< GPIO PORTG Pointer                 */
    #define PH \
        ( ( GPIO_T * ) GPIOH_BASE ) /*!< GPIO PORTH Pointer                 */

    #define UART0 \
        ( ( UART_T * ) UART0_BASE ) /*!< UART0 Pointer                      */
    #define UART1 \
        ( ( UART_T * ) UART1_BASE ) /*!< UART1 Pointer                      */
    #define UART2 \
        ( ( UART_T * ) UART2_BASE ) /*!< UART2 Pointer                      */
    #define UART3 \
        ( ( UART_T * ) UART3_BASE ) /*!< UART3 Pointer                      */
    #define UART4 \
        ( ( UART_T * ) UART4_BASE ) /*!< UART4 Pointer                      */
    #define UART5 \
        ( ( UART_T * ) UART5_BASE ) /*!< UART5 Pointer                      */

    #define TIMER0 ( ( TIMER_T * ) TMR01_BASE ) /*!< TIMER0 Pointer */
    #define TIMER1 \
        ( ( TIMER_T * ) ( TMR01_BASE + 0x100UL ) ) /*!< TIMER1 Pointer */
    #define TIMER2 ( ( TIMER_T * ) TMR23_BASE )    /*!< TIMER2 Pointer */
    #define TIMER3 \
        ( ( TIMER_T * ) ( TMR23_BASE + 0x100UL ) ) /*!< TIMER3 Pointer */

    #define WDT \
        ( ( WDT_T * ) WDT_BASE ) /*!< Watch Dog Timer Pointer             */

    #define WWDT \
        ( ( WWDT_T * ) WWDT_BASE ) /*!< Window Watch Dog Timer Pointer      */

    #define QSPI0 ( ( QSPI_T * ) QSPI0_BASE ) /*!< QSPI0 Pointer */
    #define SPI0 \
        ( ( SPI_T * ) SPI0_BASE ) /*!< SPI0 Pointer                        */
    #define SPI1 \
        ( ( SPI_T * ) SPI1_BASE ) /*!< SPI1 Pointer                        */
    #define SPI2 \
        ( ( SPI_T * ) SPI2_BASE ) /*!< SPI2 Pointer                        */
    #define SPI3 \
        ( ( SPI_T * ) SPI3_BASE ) /*!< SPI3 Pointer                        */

    #define I2S0 \
        ( ( I2S_T * ) I2S0_BASE ) /*!< I2S0 Pointer                        */

    #define I2C0 \
        ( ( I2C_T * ) I2C0_BASE ) /*!< I2C0 Pointer                        */
    #define I2C1 \
        ( ( I2C_T * ) I2C1_BASE ) /*!< I2C1 Pointer                        */
    #define I2C2 \
        ( ( I2C_T * ) I2C2_BASE ) /*!< I2C1 Pointer                        */

    #define QEI0 \
        ( ( QEI_T * ) QEI0_BASE ) /*!< QEI0 Pointer                        */
    #define QEI1 \
        ( ( QEI_T * ) QEI1_BASE ) /*!< QEI1 Pointer                        */

    #define RTC \
        ( ( RTC_T * ) RTC_BASE ) /*!< RTC Pointer                         */

    #define ACMP01 ( ( ACMP_T * ) ACMP01_BASE ) /*!< ACMP01 Pointer */

    #define CLK \
        ( ( CLK_T * ) CLK_BASE ) /*!< System Clock Controller Pointer     */

    #define DAC0 \
        ( ( DAC_T * ) DAC0_BASE ) /*!< DAC0 Pointer                        */
    #define DAC1 \
        ( ( DAC_T * ) DAC1_BASE ) /*!< DAC1 Pointer                        */

    #define EADC \
        ( ( EADC_T * ) EADC_BASE ) /*!< EADC Pointer                        */

    #define SYS \
        ( ( SYS_T * ) SYS_BASE ) /*!< System Global Controller Pointer    */

    #define SYSINT                                                            \
        ( ( SYS_INT_T * ) INT_BASE ) /*!< Interrupt Source Controller Pointer \
                                      */
    ...
    #define CRPT \
        ( ( CRPT_T * ) CRPT_BASE ) /*!< Crypto Accelerator Pointer          */
    #define TRNG \
        ( ( TRNG_T * ) TRNG_BASE ) /*!< True Random Number Pointer          */
    ...
    #define SC0 \
        ( ( SC_T * ) SC0_BASE ) /*!< SC0 Pointer                         */
    #define SC1 \
        ( ( SC_T * ) SC1_BASE ) /*!< SC1 Pointer                         */
    #define SC2 \
        ( ( SC_T * ) SC2_BASE ) /*!< SC2 Pointer                         */

    #define EBI \
        ( ( EBI_T * ) EBI_BASE ) /*!< EBI Pointer                         */

    #define CRC \
        ( ( CRC_T * ) CRC_BASE ) /*!< CRC Pointer                         */

    #define USBD \
        ( ( USBD_T * ) USBD_BASE ) /*!< USB Device Pointer                  */
    #define USBH \
        ( ( USBH_T * ) USBH_BASE ) /*!< USBH Pointer                        */
    #define OTG \
        ( ( OTG_T * ) OTG_BASE ) /*!< OTG Pointer                         */
...
*/
    ...
    #define PA_NS \
        ( ( GPIO_T * ) ( GPIOA_BASE + NS_OFFSET ) ) /*!< GPIO PORTA Pointer */
    #define PB_NS \
        ( ( GPIO_T * ) ( GPIOB_BASE + NS_OFFSET ) ) /*!< GPIO PORTB Pointer */
    #define PC_NS \
        ( ( GPIO_T * ) ( GPIOC_BASE + NS_OFFSET ) ) /*!< GPIO PORTC Pointer */
    #define PD_NS \
        ( ( GPIO_T * ) ( GPIOD_BASE + NS_OFFSET ) ) /*!< GPIO PORTD Pointer */
    #define PE_NS \
        ( ( GPIO_T * ) ( GPIOE_BASE + NS_OFFSET ) ) /*!< GPIO PORTE Pointer */
    #define PF_NS \
        ( ( GPIO_T * ) ( GPIOF_BASE + NS_OFFSET ) ) /*!< GPIO PORTF Pointer */
    #define PG_NS \
        ( ( GPIO_T * ) ( GPIOG_BASE + NS_OFFSET ) ) /*!< GPIO PORTG Pointer */
    #define PH_NS \
        ( ( GPIO_T * ) ( GPIOH_BASE + NS_OFFSET ) ) /*!< GPIO PORTH Pointer */
    #define UART0_NS \
        ( ( UART_T * ) ( UART0_BASE + NS_OFFSET ) ) /*!< UART0 Pointer */
    #define UART1_NS \
        ( ( UART_T * ) ( UART1_BASE + NS_OFFSET ) ) /*!< UART1 Pointer */
    #define UART2_NS \
        ( ( UART_T * ) ( UART2_BASE + NS_OFFSET ) ) /*!< UART2 Pointer */
    #define UART3_NS \
        ( ( UART_T * ) ( UART3_BASE + NS_OFFSET ) ) /*!< UART3 Pointer */
    #define UART4_NS \
        ( ( UART_T * ) ( UART4_BASE + NS_OFFSET ) ) /*!< UART4 Pointer */
    #define UART5_NS \
        ( ( UART_T * ) ( UART5_BASE + NS_OFFSET ) ) /*!< UART5 Pointer */
    #define TIMER2_NS \
        ( ( TIMER_T * ) ( TMR23_BASE + NS_OFFSET ) ) /*!< TIMER2 Pointer */
    #define TIMER3_NS                                                      \
        ( ( TIMER_T * ) ( TMR23_BASE + NS_OFFSET + 0x100UL ) ) /*!< TIMER3 \
                                                                  Pointer */
    #define QSPI0_NS \
        ( ( QSPI_T * ) ( QSPI0_BASE + NS_OFFSET ) ) /*!< QSPI0 Pointer */
    #define SPI0_NS \
        ( ( SPI_T * ) ( SPI0_BASE + NS_OFFSET ) ) /*!< SPI0 Pointer */
    #define SPI1_NS \
        ( ( SPI_T * ) ( SPI1_BASE + NS_OFFSET ) ) /*!< SPI1 Pointer */
    #define SPI2_NS \
        ( ( SPI_T * ) ( SPI2_BASE + NS_OFFSET ) ) /*!< SPI2 Pointer */
    #define SPI3_NS \
        ( ( SPI_T * ) ( SPI3_BASE + NS_OFFSET ) ) /*!< SPI3 Pointer */
    #define I2S0_NS \
        ( ( I2S_T * ) ( I2S0_BASE + NS_OFFSET ) ) /*!< I2S0 Pointer */
    #define I2C0_NS \
        ( ( I2C_T * ) ( I2C0_BASE + NS_OFFSET ) ) /*!< I2C0 Pointer */
    #define I2C1_NS \
        ( ( I2C_T * ) ( I2C1_BASE + NS_OFFSET ) ) /*!< I2C1 Pointer */
    #define I2C2_NS \
        ( ( I2C_T * ) ( I2C2_BASE + NS_OFFSET ) ) /*!< I2C1 Pointer */
    #define QEI0_NS \
    ...
    #define DAC0_NS \
        ( ( DAC_T * ) ( DAC0_BASE + NS_OFFSET ) ) /*!< DAC0 Pointer */
    #define DAC1_NS \
        ( ( DAC_T * ) ( DAC1_BASE + NS_OFFSET ) ) /*!< DAC1 Pointer */
    #define EADC_NS \
        ( ( EADC_T * ) ( EADC_BASE + NS_OFFSET ) ) /*!< EADC Pointer */
    #define SDH0_NS ( ( SDH_T * ) ( SDH0_BASE + NS_OFFSET ) )
    #define CRPT_NS ( ( CRPT_T * ) ( CRPT_BASE + NS_OFFSET ) )
    #define TRNG_NS                                                   \
        ( ( TRNG_T * ) ( TRNG_BASE + NS_OFFSET ) ) /*!< Random Number \
                                                      Generator Pointer    */
    #define BPWM0_NS \
        ( ( BPWM_T * ) ( BPWM0_BASE + NS_OFFSET ) ) /*!< BPWM0 Pointer */
    #define BPWM1_NS \
        ( ( BPWM_T * ) ( BPWM1_BASE + NS_OFFSET ) ) /*!< BPWM1 Pointer */
    #define EPWM0_NS \
        ( ( EPWM_T * ) ( EPWM0_BASE + NS_OFFSET ) ) /*!< EPWM0 Pointer */
    #define EPWM1_NS \
        ( ( EPWM_T * ) ( EPWM1_BASE + NS_OFFSET ) )        /*!< EPWM1 Pointer */
    ...
    #define UI2C0_NS \
        ( ( UI2C_T * ) ( USCI0_BASE + NS_OFFSET ) ) /*!< UI2C0 Pointer */
    #define UI2C1_NS \
        ( ( UI2C_T * ) ( USCI1_BASE + NS_OFFSET ) ) /*!< UI2C1 Pointer */
    #define UI2C2_NS \
        ( ( UI2C_T * ) ( USCI2_BASE + NS_OFFSET ) ) /*!< UI2C2 Pointer */
    #define USPI0_NS \
        ( ( USPI_T * ) ( USCI0_BASE + NS_OFFSET ) ) /*!< USPI0 Pointer */
    #define USPI1_NS \
        ( ( USPI_T * ) ( USCI1_BASE + NS_OFFSET ) ) /*!< USPI1 Pointer */
    #define UUART0_NS \
    ...
    #define ECAP1_NS \
        ( ( ECAP_T * ) ( ECAP1_BASE + NS_OFFSET ) ) /*!< ECAP1 Pointer */
    #define CAN0_NS \
        ( ( CAN_T * ) ( CAN0_BASE + NS_OFFSET ) ) /*!< CAN0 Pointer */
...
typedef volatile unsigned short vu16;
    ...
    #define outps( port, value ) \
        ( *( ( volatile unsigned short * ) ( port ) ) = ( value ) )
    #define inps( port ) ( ( *( ( volatile unsigned short * ) ( port ) ) ) )

    #define outp32( port, value ) \
        ( *( ( volatile unsigned int * ) ( port ) ) = ( value ) )
    #define inp32( port ) ( ( *( ( volatile unsigned int * ) ( port ) ) ) )
    #define outp8( port, value ) \
        ( *( ( volatile unsigned char * ) ( port ) ) = ( value ) )
    #define inp8( port ) ( ( *( ( volatile unsigned char * ) ( port ) ) ) )
    #define outp16( port, value ) \
        ( *( ( volatile unsigned short * ) ( port ) ) = ( value ) )
    ...
    #define _GET_BYTE0( u32Param )                                           \
        ( ( ( u32Param ) &BYTE0_Msk ) ) /*!< Extract Byte 0 (Bit  0~ 7) from \
                                           parameter u32Param */
    #define _GET_BYTE1( u32Param )                                             \
        ( ( ( u32Param ) &BYTE1_Msk ) >> 8UL ) /*!< Extract Byte 1 (Bit  8~15) \
                                                  from parameter u32Param */
    #define _GET_BYTE2( u32Param )       \
        ( ( ( u32Param ) &BYTE2_Msk ) >> \
          16UL ) /*!< Extract Byte 2 (Bit 16~23) from parameter u32Param */
    #define _GET_BYTE3( u32Param )       \
        ( ( ( u32Param ) &BYTE3_Msk ) >> \
          24UL ) /*!< Extract Byte 3 (Bit 24~31) from parameter u32Param */
