...
extern unsigned char BallPointerBmp[ POINTER_WIDTH ], *CurrentPointerBmp,
    *CurrentPointerSize;
...
void POINTER_SetRect( s16 x, s16 y, s16 width, s16 height ); // Restrict the
                                                             // move of the
                                                             // pointer to a
                                                             // rectangle
void POINTER_SetRectScreen( void ); // Remove any space restriction for the
                                    // pointer moves.
void POINTER_Save( u8 Line, u8 Column, u8 Width, u8 Height );
void POINTER_Restore( u8 Line, u8 Column, u8 Width, u8 Height );
u16 POINTER_GetPos( void ); // Return the poistion of the cursor (x=lower byte,
                            // y = upperbyte)
