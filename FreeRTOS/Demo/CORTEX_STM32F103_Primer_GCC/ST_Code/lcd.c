...
/*! ASCII Table. Each character is 7 column (7dots large) on two pages (16dots
   high) 7 column character: Two 8 bit data to display one column*/
 ...
 *  @param[in]  PortVal  The value to write. Only the lowest 8 bits are taken
 *into account.
 *
 **/
/******************************************************************************/
 ...
 *
 *  @param[in]  GPIOx       Where x can be 0, 1 or 2 to select the GPIO
 *peripheral.
 ...
 *  @param[in]  bmp         The character (monochrome) bitmap. A pointer of the
 *dot matrix data.
 ...
 *
 *  @param[in]  Cmd   An unsigned char containing the user command to send to
 *the LCD.
 *
 **/
/******************************************************************************/
 ...
 *
 *  @param[in]  Data  An unsigned character containing the data to send to the
 *LCD.
 ...
 *
 *  @return     An unsigned 32 bit word containing the data returned by a LCD
 *command.
 ...
 *
 *  @param[in]  x        The horizontal coordinate of the rectangle low left
 *corner.
 *  @param[in]  y        The vertical coordinate of the rectangle low left
 *corner.
 ...
 *  @return              An unsigned 16 bit word containing the RGB color of the
 *pixel.
 *
 *  @warning    The (0x0) point in on the low left corner.
 *  @see        LCD_RectRead
...
/**
 *
 *  Display at provided coordinates the provided ASCII character with the
 *provided text and background colors and with the provided magnify coefficient.
 *
 ...
 *
 *  @return   A Rotate_H12_V_Match_TypeDef telling the current screen
 *orientation.
 *
 **/
/******************************************************************************/
