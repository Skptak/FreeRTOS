 ...
 *
 *  @param[out] ptr   A pointer to a string where the converted value will be
 *put.
                                        ...
                                        int mode )
{
    ...
    while( ( *ptr != 0 ) && ( i < 18 ) )
    {
        ...
        LCD_DisplayChar( ref_x,
                         y,
                         *ptr,
                         mode ? BGndColor : TextColor,
                         mode ? TextColor : BGndColor,
                         CharMagniCoeff );
...
/**
 *
 *  The provided bitmap is made width * height 2 byte words. Each 2 byte word
 *contains the RGB color of a pixel.
 *
 *  @brief      Draw a color bitmap at the provided coordinates.
 *  @param[in]  imageptr    A pointer to an array of width * height 2 byte
 *words.
 *  @param[in]  x           The horizontal coordinate of the low left corner of
 *the bitmap.
 *  @param[in]  y           The vertical coordinate of the low left corner of
 *the bitmap.
 ...
 *
 *  This function is used to display a 17 character max string of
 *  characters on the LCD display at the provided coordinates with inverted
 *colors.
 *
 *  @param[in] x      The horizontal coordinate of the displayed string.
 *  @param[in] y      The vertical coordinate of the display string.
