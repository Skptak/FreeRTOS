...
struct dhcp
{
    ...
    u16_t request_timeout;     /* #ticks with period DHCP_FINE_TIMER_SECS for
                                  request timeout */
    u16_t t1_timeout; /* #ticks with period DHCP_COARSE_TIMER_SECS for renewal
                         time */
    u16_t t2_timeout; /* #ticks with period DHCP_COARSE_TIMER_SECS for rebind
                         time */
...
struct dhcp_msg
{
    ...
    /** make sure user does not configure this too small */
         ...
         ( DHCP_OPTIONS_LEN < DHCP_MIN_OPTIONS_LEN ) )
...
void dhcp_network_changed( struct netif * netif );
    ...
    /** if enabled, check whether the offered IP address is not in use, using
     * ARP */
...
void dhcp_fine_tmr( void );
    ...
    /* This is a list of options for BOOTP and DHCP, see RFC 2132 for
     * descriptions */
    ...
    #define DHCP_OPTION_REQUESTED_IP             \
        50 /* RFC 2132 9.1, requested IP address \
            */
    ...
    /** possible combinations of overloading the file and sname fields with
     * options */
