...
typedef struct
{
    ...
    #define IS_TIM_IC_MODE( MODE ) \
        ( ( MODE == TIM_ICMode_ICAP ) || ( MODE == TIM_ICMode_PWMI ) )
    ...
    #define IS_TIM_IT( IT ) \
        ( ( ( IT & ( u16 ) 0xFFA0 ) == 0x0000 ) && ( IT != 0x0000 ) )
    ...
    #define IS_TIM_DMA_BASE( BASE )                                         \
        ( ( BASE == TIM_DMABase_CR1 ) || ( BASE == TIM_DMABase_CR2 ) ||     \
          ...
          ( BASE == TIM_DMABase_CCR1 ) || ( BASE == TIM_DMABase_CCR2 ) ||   \
          ( BASE == TIM_DMABase_CCR3 ) || ( BASE == TIM_DMABase_CCR4 ) ||   \
    ...
    #define IS_TIM_EVENT_SOURCE( SOURCE ) \
        ( ( ( SOURCE & ( u16 ) 0xFFA0 ) == 0x0000 ) && ( SOURCE != 0x0000 ) )
    ...
    #define IS_TIM_CLEAR_FLAG( FLAG ) \
        ( ( ( FLAG & ( u16 ) 0xE1A0 ) == 0x0000 ) && ( FLAG != 0x0000 ) )
