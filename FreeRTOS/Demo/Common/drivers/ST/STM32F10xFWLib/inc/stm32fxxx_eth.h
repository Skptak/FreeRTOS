...
{
    /* MAC ----------------------------------*/
    u32 ETH_AutoNegotiation; /* Selects or not the AutoNegotiation with the
                                external PHY */
    ...
    u32 ETH_InterFrameGap;   /* Selects minimum IFG between frames during
                                transmission */
    u32 ETH_CarrierSense;    /* Enable/disable Carrier Sense */
    u32 ETH_Speed;           /* Indicates the Ethernet speed: 10/100 Mbps */
    u32 ETH_ReceiveOwn; /* Enable/disable the reception of frames when the TX_EN
                           signal is asserted in Half-Duplex mode */
    u32 ETH_LoopbackMode; /* Enable/disable internal MAC MII Loopback mode */
    u32 ETH_Mode; /* Selects the MAC duplex mode: Half-Duplex or Full-Duplex
                     mode */
    u32 ETH_ChecksumOffload; /* Enable/disable the calculation of complement sum
                                of all received Ethernet frame payloads */
    u32 ETH_RetryTransmission;    /* Enable/disable the MAC attempt retries
                                     transmission, based on the settings of BL,
                                     when a colision occurs (Half-Duplex mode) */
    u32 ETH_AutomaticPadCRCStrip; /* Enable/disable Automatic MAC Pad/CRC
                                     Stripping */
    u32 ETH_BackOffLimit;         /* Selects the BackOff limit value */
    u32 ETH_DeferralCheck;        /* Enable/disable deferral check function
                                     (Half-Duplex mode) */
    u32 ETH_ReceiveAll; /* Enable/disable all frames reception by the MAC (No
                           fitering)*/
    u32 ETH_SourceAddrFilter;  /* Selects EnableNormal/EnableInverse/disable
                                  Source Address Filter comparison */
    u32 ETH_PassControlFrames; /* Selects None/All/FilterPass of all control
                                  frames (including unicast and multicast PAUSE
                                  frames) */
    u32 ETH_BroadcastFramesReception; /* Enable/disable reception of Broadcast
                                         Frames */
    u32 ETH_DestinationAddrFilter;    /* Selects EnableNormal/EnableInverse
                                         destination filter for both unicast and
                                         multicast frames */
    u32 ETH_PromiscuousMode;          /* Enable/disable Promiscuous Mode */
    u32 ETH_MulticastFramesFilter;    /* Selects the Multicast Frames filter:
                                         None/HashTableFilter/PerfectFilter/PerfectHashTableFilter
                                       */
    u32 ETH_UnicastFramesFilter;      /* Selects the Unicast Frames filter:
                                         HashTableFilter/PerfectFilter/PerfectHashTableFilter
                                       */
    u32 ETH_HashTableHigh; /* This field contains the higher 32 bits of Hash
                              table.  */
    u32 ETH_HashTableLow;  /* This field contains the lower 32 bits of Hash
                              table.  */
    u32 ETH_PauseTime;     /* This field holds the value to be used in the Pause
                              Time field in the transmit control frame */
    u32 ETH_ZeroQuantaPause;   /* Enable/disable the automatic generation of
                                  Zero-Quanta Pause Control frames */
    u32 ETH_PauseLowThreshold; /* This field configures the threshold of the
                                  PAUSE to be checked for automatic
                                  retransmission of PAUSE Frame */
    u32 ETH_UnicastPauseFrameDetect; /* Enable/disable MAC to detect the Pause
                                        frames (with MAC Address0 unicast
                                        address and unique multicast address) */
    u32 ETH_ReceiveFlowControl; /* Enable/disable the MAC to decode the received
                                   Pause frame and disable its transmitter for a
                                   specified (Pause Time) time */
    u32 ETH_TransmitFlowControl; /* Enable/disable the MAC to transmit Pause
                                    frames (Full-Duplex mode) or the MAC
                                    back-pressure operation (Half-Duplex mode)
                                  */
    u32 ETH_VLANTagComparison;   /* Selects the 12-bit VLAN identifier or the
                                    complete 16-bit VLAN tag for comparison and
                                    filtering */
    u32 ETH_VLANTagIdentifier;   /* VLAN tag identifier for receive frames */

    /* DMA --------------------------*/
    u32 ETH_DropTCPIPChecksumErrorFrame; /* Enable/disable Dropping of TCP/IP
    ...
    u32 ETH_TransmitThresholdControl; /* Selects the Transmit Threshold Control
                                       */
    u32 ETH_ForwardErrorFrames; /* Enable/disable forward to DMA of all frames
                                   except runt error frames */
    u32 ETH_ForwardUndersizedGoodFrames; /* Enable/disable Rx FIFO to forward
                                            Undersized frames (frames with no
                                            Error and length less than 64 bytes)
                                            including pad-bytes and CRC) */
    u32 ETH_ReceiveThresholdControl;     /* Selects the threshold level of the
                                            Receive FIFO */
    u32 ETH_SecondFrameOperate;  /* Enable/disable the DMA process of a second
                                    frame of Transmit	data even before status
                                    for  first frame is obtained */
    u32 ETH_AddressAlignedBeats; /* Enable/disable Address Aligned Beats */
    u32 ETH_FixedBurst; /* Enable/disable the AHB Master interface fixed burst
                           transfers */
    u32 ETH_RxDMABurstLength;     /* Indicate the maximum number of beats to be
                                     transferred in one Rx DMA transaction */
    u32 ETH_TxDMABurstLength;     /* Indicate the maximum number of beats to be
                                     transferred in one Tx DMA transaction */
    u32 ETH_DescriptorSkipLength; /* Specifies the number of word to skip
...
typedef struct
{
    ...
    volatile u32 Buffer2NextDescAddr; /* Buffer2 or next descriptor address
                                         pointer */
} ETH_DMADESCTypeDef;
    ...
    #define ETH_DMATxDesc_OWN \
        ( 0x80000000UL ) /* OWN bit: descriptor is owned by DMA engine */
    #define ETH_DMATxDesc_IC \
        ( ( u32 ) 0x40000000 ) /* Interrupt on Completion */
    ...
    #define ETH_DMATxDesc_TTSE \
        ( ( u32 ) 0x02000000 ) /* Transmit Time Stamp Enable */
    #define ETH_DMATxDesc_CIC \
        ( ( u32 ) 0x00C00000 ) /* Checksum Insertion Control: 4 cases */
    #define ETH_DMATxDesc_CIC_ByPass \
        ( ( u32 ) 0x00000000 ) /* Do Nothing: Checksum Engine is bypassed */
    #define ETH_DMATxDesc_CIC_IPV4Header \
        ( ( u32 ) 0x00400000 ) /* IPV4 header Checksum Insertion */
    #define ETH_DMATxDesc_CIC_TCPUDPICMP_Segment                             \
        ( ( u32 ) 0x00800000 ) /* TCP/UDP/ICMP Checksum Insertion calculated \
                                  over segment only */
    #define ETH_DMATxDesc_CIC_TCPUDPICMP_Full                           \
        ( ( u32 ) 0x00C00000 ) /* TCP/UDP/ICMP Checksum Insertion fully \
                                  calculated */
    #define ETH_DMATxDesc_TER                          \
        ( ( u32 ) 0x00200000 ) /* Transmit End of Ring \
                                */
    #define ETH_DMATxDesc_TCH \
        ( ( u32 ) 0x00100000 ) /* Second Address Chained */
    #define ETH_DMATxDesc_TTSS                                               \
        ( ( u32 ) 0x00020000 )                       /* Tx Time Stamp Status \
                                                      */
    #define ETH_DMATxDesc_IHE ( ( u32 ) 0x00010000 ) /* IP Header Error */
    #define ETH_DMATxDesc_ES                                                  \
        ( ( u32 ) 0x00008000 ) /* Error summary: OR of the following bits: UE \
                                  || ED || EC || LCO || NC || LCA || FF || JT \
                                */
    #define ETH_DMATxDesc_JT ( ( u32 ) 0x00004000 ) /* Jabber Timeout */
    #define ETH_DMATxDesc_FF                                                   \
        ( ( u32 ) 0x00002000 ) /* Frame Flushed: DMA/MTL flushed the frame due \
                                  to SW flush */
    #define ETH_DMATxDesc_PCE \
        ( ( u32 ) 0x00001000 ) /* Payload Checksum Error */
    #define ETH_DMATxDesc_LCA                                          \
        ( ( u32 ) 0x00000800 ) /* Loss of Carrier: carrier lost during \
                                  tramsmission */
    #define ETH_DMATxDesc_NC                                             \
        ( ( u32 ) 0x00000400 ) /* No Carrier: no carrier signal from the \
                                  tranceiver */
    #define ETH_DMATxDesc_LCO                                                 \
        ( ( u32 ) 0x00000200 ) /* Late Collision: transmission aborted due to \
                                  collision */
    #define ETH_DMATxDesc_EC                                                \
        ( ( u32 ) 0x00000100 ) /* Excessive Collision: transmission aborted \
                                  after 16 collisions */
    ...
    #define ETH_DMARxDesc_OWN                                                \
        ( ( u32 ) 0x80000000 ) /* OWN bit: descriptor is owned by DMA engine \
                                */
    #define ETH_DMARxDesc_AFM \
        ( ( u32 ) 0x40000000 ) /* DA Filter Fail for the rx frame  */
    #define ETH_DMARxDesc_FL \
        ( ( u32 ) 0x3FFF0000 ) /* Receive descriptor frame length  */
    #define ETH_DMARxDesc_ES                                                  \
        ( ( u32 ) 0x00008000 ) /* Error summary: OR of the following bits: DE \
                                  || OE || IPC || LC || RWT || RE || CE */
    #define ETH_DMARxDesc_DE                                               \
        ( ( u32 ) 0x00004000 ) /* Desciptor error: no more descriptors for \
                                  receive frame  */
    #define ETH_DMARxDesc_SAF \
        ( ( u32 ) 0x00002000 ) /* SA Filter Fail for the received frame */
    #define ETH_DMARxDesc_LE \
        ( ( u32 ) 0x00001000 ) /* Frame size not matching with length field */
    #define ETH_DMARxDesc_OE                                               \
        ( ( u32 ) 0x00000800 ) /* Overflow Error: Frame was damaged due to \
                                  buffer overflow */
    #define ETH_DMARxDesc_VLAN \
        ( ( u32 ) 0x00000400 ) /* VLAN Tag: received frame is a VLAN frame */
    #define ETH_DMARxDesc_FS \
        ( ( u32 ) 0x00000200 ) /* First descriptor of the frame  */
    #define ETH_DMARxDesc_LS \
        ( ( u32 ) 0x00000100 ) /* Last descriptor of the frame  */
    #define ETH_DMARxDesc_IPV4HCE                                         \
        ( ( u32 ) 0x00000080 ) /* IPC Checksum Error/Giant Frame: Rx Ipv4 \
                                  header checksum error   */
    #define ETH_DMARxDesc_RxLongFrame                                    \
        ( ( u32 ) 0x00000080 ) /* (Giant Frame)Rx - frame is longer than \
                                  1518/1522   */
    #define ETH_DMARxDesc_LC \
        ( ( u32 ) 0x00000040 ) /* Late collision occurred during reception */
    #define ETH_DMARxDesc_FT \
        ( ( u32 ) 0x00000020 ) /* Frame type - Ethernet, otherwise 802.3    */
    #define ETH_DMARxDesc_RWT                                              \
        ( ( u32 ) 0x00000010 ) /* Receive Watchdog Timeout: watchdog timer \
                                  expired during reception    */
    #define ETH_DMARxDesc_RE                                           \
        ( ( u32 ) 0x00000008 ) /* Receive error: error reported by MII \
                                  interface  */
    #define ETH_DMARxDesc_DBE                                               \
        ( ( u32 ) 0x00000004 ) /* Dribble bit error: frame contains non int \
                                  multiple of 8 bits  */
    #define ETH_DMARxDesc_CE ( ( u32 ) 0x00000002 ) /* CRC error */
    #define ETH_DMARxDesc_MAMPCE                                            \
        ( ( u32 ) 0x00000001 ) /* Rx MAC Address/Payload Checksum Error: Rx \
                                  MAC address matched/ Rx Payload Checksum  \
                                  Error */

    /* Bit definition of RDES1 register */
    #define ETH_DMARxDesc_DIC \
        ( ( u32 ) 0x80000000 ) /* Disable Interrupt on Completion */
    #define ETH_DMARxDesc_RBS2                                               \
        ( ( u32 ) 0x1FFF0000 )                       /* Receive Buffer2 Size \
                                                      */
    #define ETH_DMARxDesc_RER ( ( u32 ) 0x00008000 ) /* Receive End of Ring */
    #define ETH_DMARxDesc_RCH \
        ( ( u32 ) 0x00004000 ) /* Second Address Chained */
    #define ETH_DMARxDesc_RBS1                         \
        ( ( u32 ) 0x00001FFF ) /* Receive Buffer1 Size \
                                */
    ...
    #define PHY_FULLDUPLEX_100M \
        ( ( u16 ) 0x2100 ) /* Set the full-duplex mode at 100 Mb/s */
    #define PHY_HALFDUPLEX_100M \
        ( ( u16 ) 0x2000 ) /* Set the half-duplex mode at 100 Mb/s */
    #define PHY_FULLDUPLEX_10M \
        ( ( u16 ) 0x0100 ) /* Set the full-duplex mode at 10 Mb/s */
    #define PHY_HALFDUPLEX_10M \
        ( ( u16 ) 0x0000 ) /* Set the half-duplex mode at 10 Mb/s */
    #define PHY_AutoNegotiation \
        ( ( u16 ) 0x1000 ) /* Enable auto-negotiation function */
    #define PHY_Restart_AutoNegotiation \
        ( ( u16 ) 0x0200 ) /* Restart auto-negotiation function */
    ...
    #define PHY_AutoNego_Complete \
        ( ( u16 ) 0x0020 ) /* Auto-Negotioation process completed */
    #define PHY_Linked_Status ( ( u16 ) 0x0004 ) /* Valid link established */
    #define PHY_Jabber_detection \
        ( ( u16 ) 0x0002 ) /* Jabber condition detected */

    /* The PHY status register value change from a PHY to another so the user
       have to update this value depending on the used external PHY */
    /* For LAN8700 */
    // #define PHY_SR                           31         /* Tranceiver Status
    // Register */
    /* For DP83848 */
    ...
    /* The Speed and Duplex mask values change from a PHY to another so the user
       have to update this value depending on the used external PHY */
    /* For LAN8700 */
    // #define PHY_Speed_Status            ((u16)0x0004)       /* Configured
    // information of Speed: 10Mbps */ #define PHY_Duplex_Status ((u16)0x0010)
    // /* Configured information of Duplex: Full-duplex */
    /* For DP83848 */
    #define PHY_Speed_Status \
        ( ( u16 ) 0x0002 ) /* Configured information of Speed: 10Mbps */
    #define PHY_Duplex_Status \
        ( ( u16 ) 0x0004 ) /* Configured information of Duplex: Full-duplex */

    #define IS_ETH_PHY_ADDRESS( ADDRESS ) ( ( ADDRESS ) <= 0x20 )
    #define IS_ETH_PHY_REG( REG )                             \
        ( ( ( REG ) == PHY_BCR ) || ( ( REG ) == PHY_BSR ) || \
          ( ( REG ) == PHY_SR ) )
    ...
    #define ETH_InterFrameGap_96Bit                                 \
        ( ( u32 ) 0x00000000 ) /* minimum IFG between frames during \
                                  transmission is 96Bit */
    #define ETH_InterFrameGap_88Bit                                 \
        ( ( u32 ) 0x00020000 ) /* minimum IFG between frames during \
                                  transmission is 88Bit */
    #define ETH_InterFrameGap_80Bit                                 \
        ( ( u32 ) 0x00040000 ) /* minimum IFG between frames during \
                                  transmission is 80Bit */
    #define ETH_InterFrameGap_72Bit                                 \
        ( ( u32 ) 0x00060000 ) /* minimum IFG between frames during \
                                  transmission is 72Bit */
    #define ETH_InterFrameGap_64Bit                                 \
        ( ( u32 ) 0x00080000 ) /* minimum IFG between frames during \
                                  transmission is 64Bit */
    #define ETH_InterFrameGap_56Bit                                 \
        ( ( u32 ) 0x000A0000 ) /* minimum IFG between frames during \
                                  transmission is 56Bit */
    #define ETH_InterFrameGap_48Bit                                 \
        ( ( u32 ) 0x000C0000 ) /* minimum IFG between frames during \
                                  transmission is 48Bit */
    #define ETH_InterFrameGap_40Bit                                 \
        ( ( u32 ) 0x000E0000 ) /* minimum IFG between frames during \
    ...
    #define ETH_PassControlFrames_BlockAll                                     \
        ( ( u32 ) 0x00000040 ) /* MAC filters all control frames from reaching \
                                  the application */
    #define ETH_PassControlFrames_ForwardAll                                \
        ( ( u32 ) 0x00000080 ) /* MAC forwards all control frames to        \
                                  application even if they fail the Address \
                                  Filter */
    #define ETH_PassControlFrames_ForwardPassedAddrFilter                   \
        ( ( u32 ) 0x000000C0 ) /* MAC forwards control frames that pass the \
                                  Address Filter. */
    ...
    #define ETH_PauseLowThreshold_Minus4 \
        ( ( u32 ) 0x00000000 ) /* Pause time minus 4 slot times */
    #define ETH_PauseLowThreshold_Minus28 \
        ( ( u32 ) 0x00000010 ) /* Pause time minus 28 slot times */
    #define ETH_PauseLowThreshold_Minus144 \
        ( ( u32 ) 0x00000020 ) /* Pause time minus 144 slot times */
    #define ETH_PauseLowThreshold_Minus256 \
        ( ( u32 ) 0x00000030 ) /* Pause time minus 256 slot times */
    ...
    #define ETH_MAC_FLAG_TST \
        ( ( u32 ) 0x00000200 ) /* Time stamp trigger flag (on MAC) */
    ...
    #define IS_ETH_MAC_GET_FLAG( FLAG )        \
        ( ( ( FLAG ) == ETH_MAC_FLAG_TST ) ||  \
          ( ( FLAG ) == ETH_MAC_FLAG_MMCT ) || \
          ( ( FLAG ) == ETH_MAC_FLAG_MMCR ) || \
          ( ( FLAG ) == ETH_MAC_FLAG_MMC ) ||  \
          ( ( FLAG ) == ETH_MAC_FLAG_PMT ) )

    /* ETHERNET MAC Interrupts
     * ---------------------------------------------------*/
    #define ETH_MAC_IT_TST \
        ( ( u32 ) 0x00000200 ) /* Time stamp trigger interrupt (on MAC) */
    #define ETH_MAC_IT_MMCT                                                  \
        ( ( u32 ) 0x00000040 )                     /* MMC transmit interrupt \
                                                    */
    ...
    #define IS_ETH_MAC_IT( IT ) \
        ( ( ( ( IT ) & ( u32 ) 0xFFFFFDF7 ) == 0x00 ) && ( ( IT ) != 0x00 ) )
    ...
    #define ETH_MAC_AddressMask_Byte6 \
        ( ( u32 ) 0x20000000 ) /* Mask MAC Address high reg bits [15:8] */
    #define ETH_MAC_AddressMask_Byte5 \
        ( ( u32 ) 0x10000000 ) /* Mask MAC Address high reg bits [7:0] */
    #define ETH_MAC_AddressMask_Byte4 \
        ( ( u32 ) 0x08000000 ) /* Mask MAC Address low reg bits [31:24] */
    #define ETH_MAC_AddressMask_Byte3 \
        ( ( u32 ) 0x04000000 ) /* Mask MAC Address low reg bits [23:16] */
    #define ETH_MAC_AddressMask_Byte2 \
        ( ( u32 ) 0x02000000 ) /* Mask MAC Address low reg bits [15:8] */
    #define ETH_MAC_AddressMask_Byte1 \
        ( ( u32 ) 0x01000000 ) /* Mask MAC Address low reg bits [70] */
    ...
    #define ETH_DMATxDesc_LastSegment          \
        ( ( u32 ) 0x40000000 ) /* Last Segment \
                                */
    #define ETH_DMATxDesc_FirstSegment \
        ( ( u32 ) 0x20000000 ) /* First Segment */
    ...
    #define ETH_DMARxDesc_Buffer1 \
        ( ( u32 ) 0x00000000 ) /* DMA Rx Desc Buffer1 */
    #define ETH_DMARxDesc_Buffer2 \
        ( ( u32 ) 0x00000001 ) /* DMA Rx Desc Buffer2 */
    ...
    #define ETH_TransmitThresholdControl_64Bytes                              \
        ( ( u32 ) 0x00000000 ) /* threshold level of the MTL Transmit FIFO is \
                                  64 Bytes */
    #define ETH_TransmitThresholdControl_128Bytes                             \
        ( ( u32 ) 0x00004000 ) /* threshold level of the MTL Transmit FIFO is \
                                  128 Bytes */
    #define ETH_TransmitThresholdControl_192Bytes                             \
        ( ( u32 ) 0x00008000 ) /* threshold level of the MTL Transmit FIFO is \
                                  192 Bytes */
    #define ETH_TransmitThresholdControl_256Bytes                             \
        ( ( u32 ) 0x0000C000 ) /* threshold level of the MTL Transmit FIFO is \
                                  256 Bytes */
    #define ETH_TransmitThresholdControl_40Bytes                              \
        ( ( u32 ) 0x00010000 ) /* threshold level of the MTL Transmit FIFO is \
                                  40 Bytes */
    #define ETH_TransmitThresholdControl_32Bytes                              \
        ( ( u32 ) 0x00014000 ) /* threshold level of the MTL Transmit FIFO is \
                                  32 Bytes */
    #define ETH_TransmitThresholdControl_24Bytes                              \
        ( ( u32 ) 0x00018000 ) /* threshold level of the MTL Transmit FIFO is \
                                  24 Bytes */
    #define ETH_TransmitThresholdControl_16Bytes                              \
        ( ( u32 ) 0x0001C000 ) /* threshold level of the MTL Transmit FIFO is \
                                  16 Bytes */
    ...
    #define ETH_ReceiveThresholdControl_64Bytes                              \
        ( ( u32 ) 0x00000000 ) /* threshold level of the MTL Receive FIFO is \
                                  64 Bytes */
    #define ETH_ReceiveThresholdControl_32Bytes                              \
        ( ( u32 ) 0x00000008 ) /* threshold level of the MTL Receive FIFO is \
                                  32 Bytes */
    #define ETH_ReceiveThresholdControl_96Bytes                              \
        ( ( u32 ) 0x00000010 ) /* threshold level of the MTL Receive FIFO is \
                                  96 Bytes */
    #define ETH_ReceiveThresholdControl_128Bytes                             \
        ( ( u32 ) 0x00000018 ) /* threshold level of the MTL Receive FIFO is \
                                  128 Bytes */
    ...
    #define ETH_RxDMABurstLength_1Beat                                         \
        ( ( u32 ) 0x00020000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 1 */
    #define ETH_RxDMABurstLength_2Beat                                         \
        ( ( u32 ) 0x00040000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 2 */
    #define ETH_RxDMABurstLength_4Beat                                         \
        ( ( u32 ) 0x00080000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 4 */
    #define ETH_RxDMABurstLength_8Beat                                         \
        ( ( u32 ) 0x00100000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 8 */
    #define ETH_RxDMABurstLength_16Beat                                        \
        ( ( u32 ) 0x00200000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 16 */
    #define ETH_RxDMABurstLength_32Beat                                        \
        ( ( u32 ) 0x00400000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 32 */

    #define ETH_RxDMABurstLength_4xPBL_4Beat                                   \
        ( ( u32 ) 0x01020000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 4 */
    #define ETH_RxDMABurstLength_4xPBL_8Beat                                   \
        ( ( u32 ) 0x01040000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 8 */
    #define ETH_RxDMABurstLength_4xPBL_16Beat                                  \
        ( ( u32 ) 0x01080000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 16 */
    #define ETH_RxDMABurstLength_4xPBL_32Beat                                  \
        ( ( u32 ) 0x01100000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 32 */
    #define ETH_RxDMABurstLength_4xPBL_64Beat                                  \
        ( ( u32 ) 0x01200000 ) /* maximum number of beats to be transferred in \
                                  one RxDMA transaction is 64 */
    #define ETH_RxDMABurstLength_4xPBL_128Beat                                 \
        ( ( u32 ) 0x01400000 ) /* maximum number of beats to be transferred in \
    ...
    #define ETH_TxDMABurstLength_1Beat                                         \
        ( ( u32 ) 0x00000100 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 1 */
    #define ETH_TxDMABurstLength_2Beat                                         \
        ( ( u32 ) 0x00000200 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 2 */
    #define ETH_TxDMABurstLength_4Beat                                         \
        ( ( u32 ) 0x00000400 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 4 */
    #define ETH_TxDMABurstLength_8Beat                                         \
        ( ( u32 ) 0x00000800 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 8 */
    #define ETH_TxDMABurstLength_16Beat                                        \
        ( ( u32 ) 0x00001000 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 16 */
    #define ETH_TxDMABurstLength_32Beat                                        \
        ( ( u32 ) 0x00002000 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 32 */

    #define ETH_TxDMABurstLength_4xPBL_4Beat                                   \
        ( ( u32 ) 0x01000100 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 4 */
    #define ETH_TxDMABurstLength_4xPBL_8Beat                                   \
        ( ( u32 ) 0x01000200 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 8 */
    #define ETH_TxDMABurstLength_4xPBL_16Beat                                  \
        ( ( u32 ) 0x01000400 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 16 */
    #define ETH_TxDMABurstLength_4xPBL_32Beat                                  \
        ( ( u32 ) 0x01000800 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 32 */
    #define ETH_TxDMABurstLength_4xPBL_64Beat                                  \
        ( ( u32 ) 0x01001000 ) /* maximum number of beats to be transferred in \
                                  one TxDMA (or both) transaction is 64 */
    #define ETH_TxDMABurstLength_4xPBL_128Beat                                 \
        ( ( u32 ) 0x01002000 ) /* maximum number of beats to be transferred in \
    ...
    #define ETH_DMA_FLAG_TST \
        ( ( u32 ) 0x20000000 ) /* Time-stamp trigger interrupt (on DMA) */
    #define ETH_DMA_FLAG_PMT                             \
        ( ( u32 ) 0x10000000 ) /* PMT interrupt (on DMA) \
                                */
    #define ETH_DMA_FLAG_MMC                             \
        ( ( u32 ) 0x08000000 ) /* MMC interrupt (on DMA) \
                                */

    #define ETH_DMA_FLAG_DataTransferError \
        ( ( u32 ) 0x00800000 ) /* Error bits 0-Rx DMA, 1-Tx DMA */
    #define ETH_DMA_FLAG_ReadWriteError \
        ( ( u32 ) 0x01000000 ) /* Error bits 0-write trnsf, 1-read transfr */
    #define ETH_DMA_FLAG_AccessError \
        ( ( u32 ) 0x02000000 ) /* Error bits 0-data buffer, 1-desc. access */
    #define ETH_DMA_FLAG_NIS \
        ( ( u32 ) 0x00010000 ) /* Normal interrupt summary flag */
    #define ETH_DMA_FLAG_AIS \
        ( ( u32 ) 0x00008000 ) /* Abnormal interrupt summary flag */
    ...
    #define ETH_DMA_FLAG_RWT \
        ( ( u32 ) 0x00000200 ) /* Receive watchdog timeout flag */
    #define ETH_DMA_FLAG_RPS \
        ( ( u32 ) 0x00000100 ) /* Receive process stopped flag */
    #define ETH_DMA_FLAG_RBU \
        ( ( u32 ) 0x00000080 ) /* Receive buffer unavailable flag */
    ...
    #define ETH_DMA_FLAG_TJT \
        ( ( u32 ) 0x00000008 ) /* Transmit jabber timeout flag */
    #define ETH_DMA_FLAG_TBU \
        ( ( u32 ) 0x00000004 ) /* Transmit buffer unavailable flag */
    #define ETH_DMA_FLAG_TPS \
        ( ( u32 ) 0x00000002 ) /* Transmit process stopped flag */
    #define ETH_DMA_FLAG_T ( ( u32 ) 0x00000001 ) /* Transmit flag */

    #define IS_ETH_DMA_FLAG( FLAG )                        \
        ( ( ( ( FLAG ) & ( u32 ) 0xFFFE1800 ) == 0x00 ) && \
          ( ( FLAG ) != 0x00 ) )
    #define IS_ETH_DMA_GET_FLAG( FLAG )                                        \
        ( ( ( FLAG ) == ETH_DMA_FLAG_TST ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_PMT ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_MMC ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_DataTransferError ) ||                    \
          ( ( FLAG ) == ETH_DMA_FLAG_ReadWriteError ) ||                       \
          ( ( FLAG ) == ETH_DMA_FLAG_AccessError ) ||                          \
          ( ( FLAG ) == ETH_DMA_FLAG_NIS ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_AIS ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_ER ) ||                                   \
          ( ( FLAG ) == ETH_DMA_FLAG_FBE ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_ET ) ||                                   \
          ( ( FLAG ) == ETH_DMA_FLAG_RWT ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_RPS ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_RBU ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_R ) || ( ( FLAG ) == ETH_DMA_FLAG_TU ) || \
          ( ( FLAG ) == ETH_DMA_FLAG_RO ) ||                                   \
          ( ( FLAG ) == ETH_DMA_FLAG_TJT ) ||                                  \
          ( ( FLAG ) == ETH_DMA_FLAG_TBU ) ||                                  \
    ...
    #define ETH_DMA_IT_NIS                                 \
        ( ( u32 ) 0x00010000 ) /* Normal interrupt summary \
                                */
    #define ETH_DMA_IT_AIS \
        ( ( u32 ) 0x00008000 ) /* Abnormal interrupt summary */
    #define ETH_DMA_IT_ER ( ( u32 ) 0x00004000 ) /* Early receive interrupt */
    #define ETH_DMA_IT_FBE \
        ( ( u32 ) 0x00002000 ) /* Fatal bus error interrupt */
    #define ETH_DMA_IT_ET                                  \
        ( ( u32 ) 0x00000400 ) /* Early transmit interrupt \
                                */
    #define ETH_DMA_IT_RWT \
        ( ( u32 ) 0x00000200 ) /* Receive watchdog timeout interrupt */
    #define ETH_DMA_IT_RPS \
        ( ( u32 ) 0x00000100 ) /* Receive process stopped interrupt */
    #define ETH_DMA_IT_RBU \
        ( ( u32 ) 0x00000080 ) /* Receive buffer unavailable interrupt */
    ...
    #define ETH_DMA_IT_TJT \
        ( ( u32 ) 0x00000008 ) /* Transmit jabber timeout interrupt */
    #define ETH_DMA_IT_TBU \
        ( ( u32 ) 0x00000004 ) /* Transmit buffer unavailable interrupt */
    #define ETH_DMA_IT_TPS \
        ( ( u32 ) 0x00000002 ) /* Transmit process stopped interrupt */
    #define ETH_DMA_IT_T ( ( u32 ) 0x00000001 ) /* Transmit interrupt */

    #define IS_ETH_DMA_IT( IT ) \
        ( ( ( ( IT ) & ( u32 ) 0xFFFE1800 ) == 0x00 ) && ( ( IT ) != 0x00 ) )
    ...
    #define ETH_DMA_TransmitProcess_Stopped \
        ( ( u32 ) 0x00000000 ) /* Stopped - Reset or Stop Tx Command issued */
    #define ETH_DMA_TransmitProcess_Fetching \
        ( ( u32 ) 0x00100000 ) /* Running - fetching the Tx descriptor */
    #define ETH_DMA_TransmitProcess_Waiting \
        ( ( u32 ) 0x00200000 ) /* Running - waiting for status */
    #define ETH_DMA_TransmitProcess_Reading                                   \
        ( ( u32 ) 0x00300000 ) /* Running - reading the data from host memory \
                                */
    #define ETH_DMA_TransmitProcess_Suspended \
        ( ( u32 ) 0x00600000 ) /* Suspended - Tx Desciptor unavailabe */
    #define ETH_DMA_TransmitProcess_Closing \
        ( ( u32 ) 0x00700000 ) /* Running - closing Rx descriptor */

    /* ETHERNET DMA receive process state
     * --------------------------------------------------------*/
    #define ETH_DMA_ReceiveProcess_Stopped \
        ( ( u32 ) 0x00000000 ) /* Stopped - Reset or Stop Rx Command issued */
    #define ETH_DMA_ReceiveProcess_Fetching \
        ( ( u32 ) 0x00020000 ) /* Running - fetching the Rx descriptor */
    #define ETH_DMA_ReceiveProcess_Waiting \
        ( ( u32 ) 0x00060000 ) /* Running - waiting for packet */
    #define ETH_DMA_ReceiveProcess_Suspended \
        ( ( u32 ) 0x00080000 ) /* Suspended - Rx Desciptor unavailable */
    #define ETH_DMA_ReceiveProcess_Closing \
        ( ( u32 ) 0x000A0000 ) /* Running - closing descriptor */
    #define ETH_DMA_ReceiveProcess_Queuing                                 \
        ( ( u32 ) 0x000E0000 ) /* Running - queuing the recieve frame into \
                                  host memory */

    /* ETHERNET DMA overflow
     * --------------------------------------------------------*/
    #define ETH_DMA_Overflow_RxFIFOCounter \
        ( ( u32 ) 0x10000000 ) /* Overflow bit for FIFO overflow counter */
    #define ETH_DMA_Overflow_MissedFrameCounter \
        ( ( u32 ) 0x00010000 ) /* Overflow bit for missed frame counter */
    ...
    #define ETH_PMT_FLAG_WUFFRPR                                              \
        ( ( u32 ) 0x80000000 ) /* Wake-Up Frame Filter Register Poniter Reset \
                                */
    #define ETH_PMT_FLAG_WUFR \
        ( ( u32 ) 0x00000040 ) /* Wake-Up Frame Received */
    #define ETH_PMT_FLAG_MPR                            \
        ( ( u32 ) 0x00000020 ) /* Magic Packet Received \
                                */
    ...
    #define ETH_MMC_IT_TGF                                                    \
        ( ( u32 ) 0x00200000 ) /* When Tx good frame counter reaches half the \
                                  maximum value */
    #define ETH_MMC_IT_TGFMSC                                                 \
        ( ( u32 ) 0x00008000 ) /* When Tx good multi col counter reaches half \
                                  the maximum value */
    #define ETH_MMC_IT_TGFSC                                                   \
        ( ( u32 ) 0x00004000 ) /* When Tx good single col counter reaches half \
                                  the maximum value */

    /* ETHERNET MMC Rx Interrupts */
    #define ETH_MMC_IT_RGUF                                                   \
        ( ( u32 ) 0x10020000 ) /* When Rx good unicast frames counter reaches \
                                  half the maximum value */
    #define ETH_MMC_IT_RFAE                                                    \
        ( ( u32 ) 0x10000040 ) /* When Rx alignment error counter reaches half \
                                  the maximum value */
    #define ETH_MMC_IT_RFCE                                                  \
        ( ( u32 ) 0x10000020 ) /* When Rx crc error counter reaches half the \
                                  maximum value */

    #define IS_ETH_MMC_IT( IT )                              \
        ( ( ( ( ( IT ) & ( u32 ) 0xFFDF3FFF ) == 0x00 ) ||   \
            ( ( ( IT ) & ( u32 ) 0xEFFDFF9F ) == 0x00 ) ) && \
          ( ( IT ) != 0x00 ) )
    ...
    #define ETH_PTP_CoarseUpdate \
        ( ( u32 ) 0x00000000 ) /* Coarse Update method */
    ...
    /* ETHERNET PTP Flags
     * --------------------------------------------------------*/
    #define ETH_PTP_FLAG_TSARU \
        ( ( u32 ) 0x00000020 ) /* Addend Register Update */
    #define ETH_PTP_FLAG_TSITE \
        ( ( u32 ) 0x00000010 ) /* Time Stamp Interrupt Trigger */
    #define ETH_PTP_FLAG_TSSTU ( ( u32 ) 0x00000008 ) /* Time Stamp Update */
    #define ETH_PTP_FLAG_TSSTI \
        ( ( u32 ) 0x00000004 ) /* Time Stamp Initialize */
    ...
    #define IS_ETH_PTP_SUBSECOND_INCREMENT( SUBSECOND ) \
        ( ( SUBSECOND ) <= 0xFF )

    /* ETHERNET PTP time sign
     * ----------------------------------------------------*/
    #define ETH_PTP_PositiveTime \
        ( ( u32 ) 0x00000000 ) /* Positive time value */
    #define ETH_PTP_NegativeTime \
        ( ( u32 ) 0x80000000 ) /* Negative time value */
    ...
    #define IS_ETH_PTP_TIME_STAMP_UPDATE_SUBSECOND( SUBSECOND ) \
        ( ( SUBSECOND ) <= 0x7FFFFFFF )
