...
typedef struct
{
    ...
    #define ETH_MACCR_CSD                                                     \
        ( ( u32 ) 0x00010000 ) /* Carrier sense disable (during transmission) \
                                */
    ...
    #define ETH_MACCR_APCS \
        ( ( u32 ) 0x00000080 ) /* Automatic Pad/CRC stripping */
    #define ETH_MACCR_BL                                                       \
        ( ( u32 ) 0x00000060 ) /* Back-off limit: random integer number (r) of \
    ...
    #define ETH_MACFFR_SAF \
        ( ( u32 ) 0x00000200 ) /* Source address filter enable */
    #define ETH_MACFFR_SAIF ( ( u32 ) 0x00000100 ) /* SA inverse filtering */
    #define ETH_MACFFR_PCF \
        ( ( u32 ) 0x000000C0 ) /* Pass control frames: 3 cases */
    ...
    #define ETH_MACFFR_BFD                                                    \
        ( ( u32 ) 0x00000020 )                     /* Broadcast frame disable \
                                                    */
    ...
    #define ETH_MACMIIAR_PA                              \
        ( ( u32 ) 0x0000F800 ) /* Physical layer address \
                                */
    #define ETH_MACMIIAR_MR \
        ( ( u32 ) 0x000007C0 ) /* MII register in the selected PHY */
    #define ETH_MACMIIAR_CR                               \
        ( ( u32 ) 0x0000001C ) /* CR clock range: 6 cases \
                                */
    #define ETH_MACMIIAR_CR_Div42 \
        ( ( u32 ) 0x00000000 ) /* HCLK:60-72 MHz; MDC clock= HCLK/42 */
    #define ETH_MACMIIAR_CR_Div16 \
        ( ( u32 ) 0x00000008 ) /* HCLK:20-35 MHz; MDC clock= HCLK/16 */
    #define ETH_MACMIIAR_CR_Div26 \
        ( ( u32 ) 0x0000000C ) /* HCLK:35-60 MHz; MDC clock= HCLK/26 */
    ...
    #define ETH_MACMIIDR_MD \
        ( ( u32 ) 0x0000FFFF ) /* MII data: read/write data from/to PHY */

    /* Bit definition for Ethernet MAC Flow Control Register */
    #define ETH_MACFCR_PT ( ( u32 ) 0xFFFF0000 ) /* Pause time */
    #define ETH_MACFCR_ZQPD \
        ( ( u32 ) 0x00000080 ) /* Zero-quanta pause disable */
    #define ETH_MACFCR_PLT \
        ( ( u32 ) 0x00000030 ) /* Pause low threshold: 4 cases */
    ...
    #define ETH_MACFCR_UPFD \
        ( ( u32 ) 0x00000008 ) /* Unicast pause frame detect */
    #define ETH_MACFCR_RFCE \
        ( ( u32 ) 0x00000004 ) /* Receive flow control enable */
    #define ETH_MACFCR_TFCE \
        ( ( u32 ) 0x00000002 ) /* Transmit flow control enable */
    #define ETH_MACFCR_FCBBPA \
        ( ( u32 ) 0x00000001 ) /* Flow control busy/backpressure activate */

    /* Bit definition for Ethernet MAC VLAN Tag Register */
    #define ETH_MACVLANTR_VLANTC \
        ( ( u32 ) 0x00010000 ) /* 12-bit VLAN tag comparison */
    #define ETH_MACVLANTR_VLANTI \
        ( ( u32 ) 0x0000FFFF ) /* VLAN tag identifier (for receive frames) */

    /* Bit definition for Ethernet MAC Remote Wake-UpFrame Filter Register */
    #define ETH_MACRWUFFR_D \
        ( ( u32 ) 0xFFFFFFFF ) /* Wake-up frame filter register data */
    ...
    #define ETH_MACPMTCSR_WFFRPR                                              \
        ( ( u32 ) 0x80000000 ) /* Wake-Up Frame Filter Register Pointer Reset \
                                */
    ...
    #define ETH_MACPMTCSR_WFE                                                \
        ( ( u32 ) 0x00000004 )                       /* Wake-Up Frame Enable \
                                                      */
    ...
    #define ETH_MACSR_TSTS \
        ( ( u32 ) 0x00000200 ) /* Time stamp trigger status */
    ...
    #define ETH_MACIMR_TSTIM \
        ( ( u32 ) 0x00000200 ) /* Time stamp trigger interrupt mask */
    ...
    #define ETH_MACA1HR_MBC                                           \
        ( ( u32 ) 0x3F000000 ) /* Mask byte control: bits to mask for \
    ...
    #define ETH_MACA1HR_MBC_LBits7_0 \
        ( ( u32 ) 0x01000000 ) /* Mask MAC Address low reg bits [7:0] */
    ...
    #define ETH_MMCRIR_RGUFS                                              \
        ( ( u32 ) 0x00020000 ) /* Set when Rx good unicast frames counter \
                                  reaches half the maximum value */
    #define ETH_MMCRIR_RFAES                                                  \
        ( ( u32 ) 0x00000040 ) /* Set when Rx alignment error counter reaches \
                                  half the maximum value */
    #define ETH_MMCRIR_RFCES                                                 \
        ( ( u32 ) 0x00000020 ) /* Set when Rx crc error counter reaches half \
                                  the maximum value */

    /* Bit definition for Ethernet MMC Transmit Interrupt Register */
    #define ETH_MMCTIR_TGFS                                                    \
        ( ( u32 ) 0x00200000 ) /* Set when Tx good frame count counter reaches \
                                  half the maximum value */
    #define ETH_MMCTIR_TGFMSCS                                               \
        ( ( u32 ) 0x00008000 ) /* Set when Tx good multi col counter reaches \
                                  half the maximum value */
    #define ETH_MMCTIR_TGFSCS                                                 \
        ( ( u32 ) 0x00004000 ) /* Set when Tx good single col counter reaches \
                                  half the maximum value */

    /* Bit definition for Ethernet MMC Receive Interrupt Mask Register */
    #define ETH_MMCRIMR_RGUFM                                             \
        ( ( u32 ) 0x00020000 ) /* Mask the interrupt when Rx good unicast \
                                  frames counter reaches half the maximum \
                                  value */
    #define ETH_MMCRIMR_RFAEM                                                  \
        ( ( u32 ) 0x00000040 ) /* Mask the interrupt when when Rx alignment    \
                                  error counter reaches half the maximum value \
                                */
    #define ETH_MMCRIMR_RFCEM                                                  \
        ( ( u32 ) 0x00000020 ) /* Mask the interrupt when Rx crc error counter \
                                  reaches half the maximum value */

    /* Bit definition for Ethernet MMC Transmit Interrupt Mask Register */
    #define ETH_MMCTIMR_TGFM                                                  \
        ( ( u32 ) 0x00200000 ) /* Mask the interrupt when Tx good frame count \
                                  counter reaches half the maximum value */
    #define ETH_MMCTIMR_TGFMSCM                                             \
        ( ( u32 ) 0x00008000 ) /* Mask the interrupt when Tx good multi col \
                                  counter reaches half the maximum value */
    #define ETH_MMCTIMR_TGFSCM                                               \
        ( ( u32 ) 0x00004000 ) /* Mask the interrupt when Tx good single col \
                                  counter reaches half the maximum value */
    ...
    #define ETH_MMCTGFSCCR_TGFSCC                                           \
        ( ( u32 ) 0xFFFFFFFF ) /* Number of successfully transmitted frames \
    ...
    #define ETH_PTPTSCR_TSITE \
        ( ( u32 ) 0x00000010 ) /* Time stamp interrupt trigger enable */
    ...
    #define ETH_PTPTSCR_TSFCU \
        ( ( u32 ) 0x00000002 ) /* Time stamp fine or coarse update */
    #define ETH_PTPTSCR_TSE ( ( u32 ) 0x00000001 ) /* Time stamp enable */

    /* Bit definition for Ethernet PTP Sub-Second Increment Register */
    #define ETH_PTPSSIR_STSSI \
        ( ( u32 ) 0x000000FF ) /* System time Sub-second increment value */
    ...
    #define ETH_PTPTSLR_STPNS \
        ( ( u32 ) 0x80000000 ) /* System Time Positive or negative time */
    #define ETH_PTPTSLR_STSS \
        ( ( u32 ) 0x7FFFFFFF ) /* System Time sub-seconds */

    /* Bit definition for Ethernet PTP Time Stamp High Update Register */
    #define ETH_PTPTSHUR_TSUS \
        ( ( u32 ) 0xFFFFFFFF ) /* Time stamp update seconds */

    /* Bit definition for Ethernet PTP Time Stamp Low Update Register */
    #define ETH_PTPTSLUR_TSUPNS                                               \
        ( ( u32 ) 0x80000000 ) /* Time stamp update Positive or negative time \
                                */
    #define ETH_PTPTSLUR_TSUSS \
        ( ( u32 ) 0x7FFFFFFF ) /* Time stamp update sub-seconds */
    ...
    #define ETH_PTPTTHR_TTSH                             \
        ( ( u32 ) 0xFFFFFFFF ) /* Target time stamp high \
                                */

    /* Bit definition for Ethernet PTP Target Time Low Register */
    #define ETH_PTPTTLR_TTSL                            \
        ( ( u32 ) 0xFFFFFFFF ) /* Target time stamp low \
                                */
    ...
    #define ETH_DMABMR_RTPR_1_1 \
        ( ( u32 ) 0x00000000 ) /* Rx Tx priority ratio */
    #define ETH_DMABMR_RTPR_2_1 \
        ( ( u32 ) 0x00004000 ) /* Rx Tx priority ratio */
    #define ETH_DMABMR_RTPR_3_1 \
        ( ( u32 ) 0x00008000 ) /* Rx Tx priority ratio */
    #define ETH_DMABMR_RTPR_4_1 \
        ( ( u32 ) 0x0000C000 ) /* Rx Tx priority ratio */
    #define ETH_DMABMR_PBL \
        ( ( u32 ) 0x00003F00 ) /* Programmable burst length */
    /* Values to be confirmed: maybe they are inversed */
    ...
    #define ETH_DMARDLAR_SRL                            \
        ( ( u32 ) 0xFFFFFFFF ) /* Start of receive list \
                                */

    /* Bit definition for Ethernet DMA Transmit Descriptor List Address Register
     */
    #define ETH_DMATDLAR_STL                             \
        ( ( u32 ) 0xFFFFFFFF ) /* Start of transmit list \
                                */

    /* Bit definition for Ethernet DMA Status Register */
    #define ETH_DMASR_TSTS \
        ( ( u32 ) 0x20000000 ) /* Time-stamp trigger status */
    ...
    #define ETH_DMASR_TPS_Suspended \
        ( ( u32 ) 0x00600000 ) /* Suspended - Tx Descriptor unavailabe */
    ...
    #define ETH_DMASR_RPS_Suspended \
        ( ( u32 ) 0x00080000 ) /* Suspended - Rx Descriptor unavailable */
    ...
    #define ETH_DMASR_RWTS \
        ( ( u32 ) 0x00000200 ) /* Receive watchdog timeout status */
    #define ETH_DMASR_RPSS \
        ( ( u32 ) 0x00000100 ) /* Receive process stopped status */
    #define ETH_DMASR_RBUS \
        ( ( u32 ) 0x00000080 ) /* Receive buffer unavailable status */
    #define ETH_DMASR_RS ( ( u32 ) 0x00000040 ) /* Receive status */
    #define ETH_DMASR_TUS                                                     \
        ( ( u32 ) 0x00000020 )                   /* Transmit underflow status \
                                                  */
    #define ETH_DMASR_ROS ( ( u32 ) 0x00000010 ) /* Receive overflow status */
    #define ETH_DMASR_TJTS \
        ( ( u32 ) 0x00000008 ) /* Transmit jabber timeout status */
    #define ETH_DMASR_TBUS \
        ( ( u32 ) 0x00000004 ) /* Transmit buffer unavailable status */
    #define ETH_DMASR_TPSS \
        ( ( u32 ) 0x00000002 ) /* Transmit process stopped status */
    #define ETH_DMASR_TS ( ( u32 ) 0x00000001 ) /* Transmit status */

    /* Bit definition for Ethernet DMA Operation Mode Register */
    #define ETH_DMAOMR_DTCEFD                                               \
        ( ( u32 ) 0x04000000 ) /* Disable Dropping of TCP/IP checksum error \
                                  frames */
    #define ETH_DMAOMR_RSF \
        ( ( u32 ) 0x02000000 ) /* Receive store and forward */
    #define ETH_DMAOMR_DFRF \
        ( ( u32 ) 0x01000000 ) /* Disable flushing of received frames */
    #define ETH_DMAOMR_TSF \
        ( ( u32 ) 0x00200000 ) /* Transmit store and forward */
    #define ETH_DMAOMR_FTF ( ( u32 ) 0x00100000 ) /* Flush transmit FIFO */
    #define ETH_DMAOMR_TTC \
        ( ( u32 ) 0x0001C000 ) /* Transmit threshold control */
    ...
    #define ETH_DMAOMR_ST \
        ( ( u32 ) 0x00002000 ) /* Start/stop transmission command */
    #define ETH_DMAOMR_FEF ( ( u32 ) 0x00000080 ) /* Forward error frames */
    #define ETH_DMAOMR_FUGF \
        ( ( u32 ) 0x00000040 ) /* Forward undersized good frames */
    #define ETH_DMAOMR_RTC \
        ( ( u32 ) 0x00000018 ) /* receive threshold control */
    ...
    #define ETH_DMAOMR_OSF                                                  \
        ( ( u32 ) 0x00000004 )                   /* operate on second frame \
                                                  */
    #define ETH_DMAOMR_SR ( ( u32 ) 0x00000002 ) /* Start/stop receive */

    /* Bit definition for Ethernet DMA Interrupt Enable Register */
    #define ETH_DMAIER_NISE \
        ( ( u32 ) 0x00010000 ) /* Normal interrupt summary enable */
    #define ETH_DMAIER_AISE \
        ( ( u32 ) 0x00008000 ) /* Abnormal interrupt summary enable */
    #define ETH_DMAIER_ERIE \
        ( ( u32 ) 0x00004000 ) /* Early receive interrupt enable */
    #define ETH_DMAIER_FBEIE \
        ( ( u32 ) 0x00002000 ) /* Fatal bus error interrupt enable */
    #define ETH_DMAIER_ETIE \
        ( ( u32 ) 0x00000400 ) /* Early transmit interrupt enable */
    #define ETH_DMAIER_RWTIE \
        ( ( u32 ) 0x00000200 ) /* Receive watchdog timeout interrupt enable */
    #define ETH_DMAIER_RPSIE \
        ( ( u32 ) 0x00000100 ) /* Receive process stopped interrupt enable */
    #define ETH_DMAIER_RBUIE                                                  \
        ( ( u32 ) 0x00000080 ) /* Receive buffer unavailable interrupt enable \
                                */
    #define ETH_DMAIER_RIE                                 \
        ( ( u32 ) 0x00000040 ) /* Receive interrupt enable \
                                */
    #define ETH_DMAIER_TUIE \
        ( ( u32 ) 0x00000020 ) /* Transmit Underflow interrupt enable */
    #define ETH_DMAIER_ROIE \
        ( ( u32 ) 0x00000010 ) /* Receive Overflow interrupt enable */
    #define ETH_DMAIER_TJTIE \
        ( ( u32 ) 0x00000008 ) /* Transmit jabber timeout interrupt enable */
    #define ETH_DMAIER_TBUIE                                                   \
        ( ( u32 ) 0x00000004 ) /* Transmit buffer unavailable interrupt enable \
                                */
    #define ETH_DMAIER_TPSIE \
        ( ( u32 ) 0x00000002 ) /* Transmit process stopped interrupt enable */
    #define ETH_DMAIER_TIE \
        ( ( u32 ) 0x00000001 ) /* Transmit interrupt enable */
