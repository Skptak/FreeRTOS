...
typedef struct
{
    ...
    #define DMAChannel1_IRQChannel \
        ( ( u8 ) 0x0B ) /* DMA Channel 1 global Interrupt */
    #define DMAChannel2_IRQChannel \
        ( ( u8 ) 0x0C ) /* DMA Channel 2 global Interrupt */
    #define DMAChannel3_IRQChannel \
        ( ( u8 ) 0x0D ) /* DMA Channel 3 global Interrupt */
    #define DMAChannel4_IRQChannel \
        ( ( u8 ) 0x0E ) /* DMA Channel 4 global Interrupt */
    #define DMAChannel5_IRQChannel \
        ( ( u8 ) 0x0F ) /* DMA Channel 5 global Interrupt */
    #define DMAChannel6_IRQChannel \
        ( ( u8 ) 0x10 ) /* DMA Channel 6 global Interrupt */
    #define DMAChannel7_IRQChannel \
        ( ( u8 ) 0x11 )                    /* DMA Channel 7 global Interrupt */
    ...
    #define IS_NVIC_IRQ_CHANNEL( CHANNEL )                                     \
        ( ( CHANNEL == WWDG_IRQChannel ) || ( CHANNEL == PVD_IRQChannel ) ||   \
          ( CHANNEL == TAMPER_IRQChannel ) || ( CHANNEL == RTC_IRQChannel ) || \
          ( CHANNEL == FLASH_IRQChannel ) || ( CHANNEL == RCC_IRQChannel ) ||  \
          ...
          ( CHANNEL == TIM2_IRQChannel ) || ( CHANNEL == TIM3_IRQChannel ) ||  \
          ...
          ( CHANNEL == SPI1_IRQChannel ) || ( CHANNEL == SPI2_IRQChannel ) ||  \
