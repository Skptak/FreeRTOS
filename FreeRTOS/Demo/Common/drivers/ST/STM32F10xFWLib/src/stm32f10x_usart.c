...
void USART_Init( USART_TypeDef * USARTx, USART_InitTypeDef * USART_InitStruct )
{
    ...
    tmpreg |= ( u32 ) USART_InitStruct->USART_StopBits |
              USART_InitStruct->USART_Clock | USART_InitStruct->USART_CPOL |
              USART_InitStruct->USART_CPHA | USART_InitStruct->USART_LastBit;
...
void USART_Cmd( USART_TypeDef * USARTx, FunctionalState NewState )
{
    ...
    {
        /* Disable the selected USART by clearing the RUN bit in the CR1
         * register */
...
void USART_ReceiverWakeUpCmd( USART_TypeDef * USARTx, FunctionalState NewState )
{
    ...
    {
        /* Disable the mute mode USART by clearing the RWU bit in the CR1
         * register */
 ...
 *peripheral. Input          : - USARTx: where x can be 1, 2 or 3 to select the
 *USART peripheral. Output         : None Return         : The received data.
 *******************************************************************************/
 ...
 *not. Input          : - USARTx: where x can be 1, 2 or 3 to select the USART
 *                    peripheral.
