 ...
 *default reset values. Input          : - GPIOx: where x can be (A..E) to
 *select the GPIO peripheral. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - GPIOx: where x can be (A..E) to select the GPIO
 *peripheral.
 ...
 *be GPIO_Pin_x where x can be (0..15). Output         : None Return         :
 ...
 * Input          : - GPIOx: where x can be (A..E) to select the GPIO
 *peripheral. Output         : None Return         : GPIO input data port value.
 *******************************************************************************/
 ...
 * Input          : - GPIOx: where x can be (A..E) to select the GPIO
 *peripheral. Output         : None Return         : GPIO output data port
 *value.
 *******************************************************************************/
 ...
 *bit. This parameter can be one of the BitAction enum values:
 ...
 * Input          : - GPIOx: where x can be (A..E) to select the GPIO
 *peripheral.
 *                  - PortVal: specifies the value to be written to the port
 *output data register. Output         : None Return         : None
 *******************************************************************************/
 ...
 *source for Event output. This parameter can be GPIO_PortSourceGPIOx where x
 *can be (A..E).
 *                  - GPIO_PinSource: specifies the pin for the Event output.
 *                    This parameter can be GPIO_PinSourcex where x can be
 *(0..15). Output         : None Return         : None
 *******************************************************************************/
...
void GPIO_EXTILineConfig( u8 GPIO_PortSource, u8 GPIO_PinSource )
{
    ...
    AFIO->EXTICR[ GPIO_PinSource >> 0x02 ] |= ( ( ( u32 ) GPIO_PortSource )
                                                << ( 0x04 * ( GPIO_PinSource &
                                                              ( u8 ) 0x03 ) ) );
}
