...
void FSMC_NORSRAMInit( FSMC_NORSRAMInitTypeDef * FSMC_NORSRAMInitStruct )
{
    ...
    /* Bank1 NOR/SRAM timing register for write configuration, if extended mode
     * is used */
...
void FSMC_NANDInit( FSMC_NANDInitTypeDef * FSMC_NANDInitStruct )
{
    ...
    assert_param(
        IS_FSMC_WAIT_FEATURE( FSMC_NANDInitStruct->FSMC_Waitfeature ) );
    assert_param(
        IS_FSMC_DATA_WIDTH( FSMC_NANDInitStruct->FSMC_MemoryDataWidth ) );
    assert_param( IS_FSMC_ECC_STATE( FSMC_NANDInitStruct->FSMC_ECC ) );
    assert_param(
        IS_FSMC_ECCPAGE_SIZE( FSMC_NANDInitStruct->FSMC_ECCPageSize ) );
    assert_param(
        IS_FSMC_TCLR_TIME( FSMC_NANDInitStruct->FSMC_TCLRSetupTime ) );
     ...
     */
    tmppmem = ( uint32_t ) FSMC_NANDInitStruct->FSMC_CommonSpaceTimingStruct
                  ->FSMC_SetupTime |
...
void FSMC_PCCARDInit( FSMC_PCCARDInitTypeDef * FSMC_PCCARDInitStruct )
{
    ...
    assert_param(
        IS_FSMC_TAR_TIME( FSMC_PCCARDInitStruct->FSMC_TARSetupTime ) );
     ...
     * parameters */
    FSMC_Bank4->PMEM4 = ( uint32_t ) FSMC_PCCARDInitStruct
     ...
     * parameters */
    FSMC_Bank4->PIO4 = ( uint32_t ) FSMC_PCCARDInitStruct
