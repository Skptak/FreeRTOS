 ...
 *                  - Ascii: character ascii code, must be between 0x20 and
 *0x7E. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - Line: the starting Line where to display the character
 *shape. This parameter can be one of the following values:
 *                       - Linex: where x can be 0..9
 *                  - *ptr: pointer to string to display on LCD.
 * Output         : None
 * Return         : None
 ...
 *                    This parameter can be one of the following values:
 *Vertical or Horizontal. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - GPIOx: where x can be B or D to select the GPIO
 *peripheral.
