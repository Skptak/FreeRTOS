...
//*****************************************************************************
    ...
    #define ROM_FlashProtectGet    \
        ( ( tFlashProtection( * )( \
            unsigned long ulAddress ) ) ROM_FLASHTABLE[ 4 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
...
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
    #define ROM_FlashProtectSave ( ( long ( * )( void ) ) ROM_FLASHTABLE[ 6 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
...
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
    #define ROM_FlashUserSave ( ( long ( * )( void ) ) ROM_FLASHTABLE[ 9 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
...
//*****************************************************************************
    ...
    #define ROM_SysCtlGPIOAHBEnable \
        ( ( void ( * )(             \
            unsigned long ulGPIOPeripheral ) ) ROM_SYSCTLTABLE[ 29 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
    #define ROM_SysCtlGPIOAHBDisable \
        ( ( void ( * )(              \
            unsigned long ulGPIOPeripheral ) ) ROM_SYSCTLTABLE[ 30 ] )
#endif
...
//*****************************************************************************
    ...
    #define ROM_WatchdogReloadGet \
        ( ( unsigned long ( * )(  \
            unsigned long ulBase ) ) ROM_WATCHDOGTABLE[ 9 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
    #define ROM_WatchdogValueGet \
        ( ( unsigned long ( * )( \
            unsigned long ulBase ) ) ROM_WATCHDOGTABLE[ 10 ] )
#endif
#if defined( TARGET_IS_DUSTDEVIL_RA0 )
