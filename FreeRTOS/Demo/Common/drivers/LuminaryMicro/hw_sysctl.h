...
#define SYSCTL_DID1_VER_1 \
    0x10000000                       // First revision of the DID1
...
#define SYSCTL_RIS_CLRIS \
    0x00000020 // Current Limit Raw Interrupt
               // Status.
#define SYSCTL_RIS_IOFRIS \
    0x00000010 // Internal Oscillator Fault Raw
               // Interrupt Status.
#define SYSCTL_RIS_MOFRIS \
    0x00000008 // Main Oscillator Fault Raw
               // Interrupt Status.
#define SYSCTL_RIS_LDORIS \
    0x00000004 // LDO Power Unregulated Raw
               // Interrupt Status.
...
#define SYSCTL_IMC_IOFIM \
    0x00000010 // Internal Oscillator Fault
               // Interrupt Mask.
#define SYSCTL_IMC_MOFIM \
    0x00000008 // Main Oscillator Fault Interrupt
               // Mask.
#define SYSCTL_IMC_LDOIM \
    0x00000004                       // LDO Power Unregulated Interrupt
                                     // Mask.
...
#define SYSCTL_MISC_PLLLMIS \
    0x00000040 // PLL Lock Masked Interrupt
               // Status.
#define SYSCTL_MISC_CLMIS \
    0x00000020 // Current Limit Masked Interrupt
               // Status.
#define SYSCTL_MISC_IOFMIS \
    0x00000010 // Internal Oscillator Fault Masked
               // Interrupt Status.
#define SYSCTL_MISC_MOFMIS \
    0x00000008 // Main Oscillator Fault Masked
               // Interrupt Status.
#define SYSCTL_MISC_LDOMIS \
    0x00000004                             // LDO Power Unregulated Masked
                                           // Interrupt Status.
...
//
//*****************************************************************************
#define SYSCTL_RCGC1_COMP2 \
    0x04000000 // Analog Comparator 2 Clock
               // Gating.
#define SYSCTL_RCGC1_COMP1 \
    0x02000000 // Analog Comparator 1 Clock
               // Gating.
#define SYSCTL_RCGC1_COMP0 \
    0x01000000                             // Analog Comparator 0 Clock
                                           // Gating.
...
//
//*****************************************************************************
#define SYSCTL_SCGC1_COMP2 \
    0x04000000 // Analog Comparator 2 Clock
               // Gating.
#define SYSCTL_SCGC1_COMP1 \
    0x02000000 // Analog Comparator 1 Clock
               // Gating.
...
//
//*****************************************************************************
#define SYSCTL_DCGC1_COMP2 \
    0x04000000 // Analog Comparator 2 Clock
               // Gating.
#define SYSCTL_DCGC1_COMP1 \
    0x02000000 // Analog Comparator 1 Clock
               // Gating.
#define SYSCTL_DCGC1_COMP0 \
    0x01000000                          // Analog Comparator 0 Clock
                                        // Gating.
...
#define SYSCTL_DC5_PWMEFLT \
    0x00200000 // PWM Extended Fault feature is
               // active.
#define SYSCTL_DC5_PWMESYNC \
    0x00100000                     // PWM Extended SYNC feature is
                                   // active.
...
//
//*****************************************************************************
#define SYSCTL_DC6_USB0_M \
    0x00000003                             // This specifies that USB0 is
...
//*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // SYSCTL_SRCR0, SYSCTL_RCGC0, SYSCTL_SCGC0, and SYSCTL_DCGC0 registers.
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // SYSCTL_SRCR1, SYSCTL_RCGC1, SYSCTL_SCGC1, and SYSCTL_DCGC1 registers.
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // SYSCTL_SRCR2, SYSCTL_RCGC2, SYSCTL_SCGC2, and SYSCTL_DCGC2 registers.
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // SYSCTL_RIS, SYSCTL_IMC, and SYSCTL_IMS registers.
    //
    //*****************************************************************************
    ...
    //
    //*****************************************************************************
    #define SYSCTL_DSLPCLKCFG_D_MSK \
        0x1F800000 // Deep sleep system clock override
