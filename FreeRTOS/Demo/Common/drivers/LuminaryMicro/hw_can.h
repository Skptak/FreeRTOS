...
#define CAN_BIT_TSEG1_M \
    0x00000F00                          // Time Segment Before Sample
                                        // Point.
...
#define CAN_IF1CRQ_MNUM_RSVD \
    0x00000000 // 0 is not a valid message number;
...
//*****************************************************************************
    ...
    // CAN_IF1CMSK and CAN_IF2CMSK registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // CAN_IF1MSK1 and CAN_IF2MSK1 registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // CAN_IF1MSK2 and CAN_IF2MSK2 registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // CAN_IF1ARB1 and CAN_IF2ARB1 registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // CAN_IF1ARB2 and CAN_IF2ARB2 registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
    ...
    //
    // The following are deprecated defines for the bit fields in the
    // CAN_IF1MCTL and CAN_IF2MCTL registers. Note: All bits may not be
    // available in all registers
    //
    //*****************************************************************************
