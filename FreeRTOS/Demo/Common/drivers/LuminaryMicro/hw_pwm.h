...
#define PWM_X_GENA_ACTCMPBD_ZERO 0x00000800 // Set the output signal to 0.
...
#define PWM_X_GENA_ACTCMPBU_ZERO 0x00000200 // Set the output signal to 0.
...
#define PWM_X_GENA_ACTCMPAD_ZERO 0x00000080 // Set the output signal to 0.
...
#define PWM_X_GENA_ACTCMPAU_ZERO 0x00000020 // Set the output signal to 0.
...
#define PWM_X_GENB_ACTCMPBD_ZERO 0x00000800 // Set the output signal to 0.
...
#define PWM_X_GENB_ACTCMPBU_ZERO 0x00000200 // Set the output signal to 0.
...
#define PWM_X_GENB_ACTCMPAD_ZERO 0x00000080 // Set the output signal to 0.
...
#define PWM_X_GENB_ACTCMPAU_ZERO 0x00000020 // Set the output signal to 0.
...
//*****************************************************************************
    ...
    //*****************************************************************************
    //
    // The following are deprecated defines for the PWM_X Interrupt Status
    ...
    #define PWM_RV_X_CTL \
        0x00000000                 // Master control of the PWM
                                   // generator block
    #define PWM_RV_SYNC 0x00000000 // Counter synch for PWM generators
    #define PWM_RV_X_DBFALL \
        0x00000000                    // The dead band falling edge delay
                                      // count
    ...
    #define PWM_RV_FAULT \
        0x00000000                   // Fault handling for the PWM
                                     // output pins
    #define PWM_RV_RIS    0x00000000 // Raw interrupt status
    #define PWM_RV_X_CMPA 0x00000000 // The comparator A value
    #define PWM_RV_INVERT \
        0x00000000 // Inversion control for PWM output
                   // pins
    #define PWM_RV_X_DBRISE \
        0x00000000 // The dead band rising edge delay
                   // count
    #define PWM_RV_ENABLE \
        0x00000000                    // Master enable for the PWM output
                                      // pins
