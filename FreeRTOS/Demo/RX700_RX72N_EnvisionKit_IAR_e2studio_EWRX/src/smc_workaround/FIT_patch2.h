...
#define FIT_PATCH2_H
    ...
    /* Workaround to reduce the following remark messages caused in the
     * r_rx_compiler.h.
     *
    ...
    /* Workaround to reduce the following remark messages. (The following is
     * example.)
     *
     *   #define R_BSP_ASM(...)            _R_BSP_ASM(__VA_ARGS__\n)
     *                                                           ^
     ...
     *       R_BSP_ASM_BEGIN
     *       ^
     * "XXX\r_bsp_common.c",NNN  Remark[Pa174]: inline assembler statement has
     * no declared side-effect. All optimizations around it will be disabled.
     ...
     */
        ...
        /* #define R_BSP_ASM_LAB(n_colon)    R_BSP_ASM(_lab##n_colon) */ /* no
                                                                            change
                                                                          */
