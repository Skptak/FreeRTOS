...
void vApplicationSetupTimerInterrupt( void )
{
    ...
    CMT0.CMCR.WORD = 0x00C0; // CKS=00b,CMIE=1; PCLK/8,Compare match interrupt
                             // (CMIn) enabled @60MHz
    ...
    /* Enable interrupt on compare match.
     * Divide the PCLK by 8. */
    CMT1.CMCR.WORD = 0x00C0; // CKS=00b,CMIE=1; PCLK/8,Compare match interrupt
                             // (CMIn) enabled @60MHz

    /* Set the compare match value. */
    CMT1.CMCOR = ( unsigned short ) ( ( ( configPERIPHERAL_CLOCK_HZ /
                                          configTICK_RATE_HZ ) ) /
                                          8 -
                                      1 );
    ...
    /* Enable interrupt on compare match.
     * Divide the PCLK by 8. */
    CMT2.CMCR.WORD = 0x00C0; // CKS=00b,CMIE=1; PCLK/8,Compare match interrupt
                             // (CMIn) enabled @60MHz

    /* Set the compare match value. */
    CMT2.CMCOR = ( unsigned short ) ( ( ( configPERIPHERAL_CLOCK_HZ /
                                          configTICK_RATE_HZ ) ) /
                                          8 -
                                      1 );
    ...
    /* Enable interrupt on compare match.
     * Divide the PCLK by 8. */
    CMT3.CMCR.WORD = 0x00C0; // CKS=00b,CMIE=1; PCLK/8,Compare match interrupt
                             // (CMIn) enabled @60MHz

    /* Set the compare match value. */
    CMT3.CMCOR = ( unsigned short ) ( ( ( configPERIPHERAL_CLOCK_HZ /
                                          configTICK_RATE_HZ ) ) /
                                          8 -
                                      1 );
...
static void prvSetupHardware( void );
    ...
    /*
     * main_blinky() is used when mainCREATE_SIMPLE_BLINKY_DEMO_ONLY is set
     * to 1. main_full() is used when mainCREATE_SIMPLE_BLINKY_DEMO_ONLY is set
     * to 0.
     */
