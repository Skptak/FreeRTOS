...
const baud_divisor_t async_baud[ NUM_DIVISORS_ASYNC ] = {
    ...
    { 8, 1, 1, 0 },   { 16, 0, 1, 0 },   { 32, 0, 0, 0 },
    { 64, 0, 1, 1 },  { 128, 0, 0, 1 },  { 256, 0, 1, 2 },
    { 512, 0, 0, 2 }, { 1024, 0, 1, 3 }, { 2048, 0, 0, 3 }
};
#endif
...
const sci_ch_rom_t ch0_rom = {
    ...
    ( volatile uint32_t R_BSP_EVENACCESS_SFR * ) &SYSTEM.MSTPCRB.LONG,
    BIT31_MASK,
...
/* channel control block */
sci_ch_ctrl_t ch3_ctrl = { &ch3_rom,
                           SCI_MODE_OFF,
                           0,
                           NULL,
                           NULL,
...
/* channel control block */
sci_ch_ctrl_t ch4_ctrl = { &ch4_rom,
                           SCI_MODE_OFF,
                           0,
                           NULL,
                           NULL,
...
/* channel control block */
sci_ch_ctrl_t ch7_ctrl = { &ch7_rom,
                           SCI_MODE_OFF,
                           0,
                           NULL,
                           NULL,
...
const sci_ch_rom_t ch8_rom = {
    ...
    ( volatile uint32_t R_BSP_EVENACCESS_SFR * ) &SYSTEM.MSTPCRC.LONG,
    BIT27_MASK,
    #if SCI_CFG_TEI_INCLUDED
...
/* channel control block */
sci_ch_ctrl_t ch10_ctrl = { &ch10_rom,
                            SCI_MODE_OFF,
                            0,
                            NULL,
                            NULL,
...
/* channel control block */
sci_ch_ctrl_t ch11_ctrl = { &ch11_rom,
                            SCI_MODE_OFF,
                            0,
                            NULL,
                            NULL,
