 ...
 *         : 29.01.2016 1.60    Updated version to 1.60 for correspondence to RX
 *Family : 01.06.2018 1.70    Updated version to 1.70 : 03.12.2018 1.71 Updated
 *version to 1.71 for update of xml file. : 07.02.2019 1.80    Updated version
 *to 1.80.
 ***********************************************************************************************************************/
...
typedef enum e_byteq_err // BYTEQ API error codes
{
    ...
    BYTEQ_ERR_MALLOC_FAIL, // can't allocate memory for ctrl block; increase
                           // heap
    BYTEQ_ERR_NO_MORE_CTRL_BLKS, // no more control blocks, increase
                                 // BYTEQ_MAX_CTRL_BLKS
