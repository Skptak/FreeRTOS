 ...
 * Description  : This has fixed-width integer and bool support for compilers
 *that are not C99 compliant and do not have the header files stdint.h,
 ...
 *         : 22.11.2013 1.11     Changed size_t to 'unsigned long' from
 *'unsigned int'. : 28.02.2019 1.12     Fixed coding style.
 ***********************************************************************************************************************/
