...
#define PTPEDMAC \
    ( *( volatile struct st_ptpedmac __sfr __evenaccess * ) 0xC0400 )
...
#define FLASHCONST \
    ( *( volatile struct st_flashconst __sfr __evenaccess * ) 0xFE7F7D90 )
#define TEMPSCONST \
    ( *( volatile struct st_tempsconst __sfr __evenaccess * ) 0xFE7F7D7C )
...
typedef enum enum_ier
{
    ...
    IER_SSIE0_SSITXI0 = 0x05,
    IER_SSIE0_SSIRXI0 = 0x05,
...
typedef enum enum_ipr
{
    ...
    IPR_SDHI_SBFAI = 44,
    IPR_MMCIF_MBFAI = 45,
    IPR_SSIE0_SSITXI0 = 46,
    IPR_SSIE0_SSIRXI0 = 47,
