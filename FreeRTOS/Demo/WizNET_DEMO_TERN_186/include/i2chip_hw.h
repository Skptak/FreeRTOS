...
void i2chip_set_window( u_int window_addr );
    ...
    // Note that if you're using other MMC chips within your application, you
    // will need to call this function regularly, if you've changed the MMC
    // chip/page selection via mmc_window().  The driver code otherwise assume
    // that you never change away from chip 7, page 0.
...
#define COMMAND( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, i ) ) )
#define INT_STATUS( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_C0_ISR + i ) ) )
#define INT_REG \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_IR ) ) )
#define INTMASK \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_IMR ) ) )
#define RESETSOCK \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x0A ) ) )

#define RX_PTR_BASE I2CHIP_C0_RW_PR
#define RX_PTR_SIZE ( I2CHIP_C1_RW_PR - I2CHIP_C0_RW_PR )

#define RX_WR_PTR( i )                                   \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       RX_PTR_BASE + RX_PTR_SIZE * i ) ) )
#define RX_RD_PTR( i )                                                 \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG,               \
                                       RX_PTR_BASE + RX_PTR_SIZE * i + \
                                           0x04 ) ) )
...
/* For windowing purposes, these are definitely outside the first 256-byte
Window... therefore, use the MK_FP_WINDOW macros instead. */
#define SHADOW_RXWR_PTR( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x1E0 + 3 * i ) ) )
#define SHADOW_RXRD_PTR( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x1E1 + 3 * i ) ) )
#define SHADOW_TXACK_PTR( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x1E2 + 3 * i ) ) )
#define SHADOW_TXWR_PTR( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x1F0 + 3 * i ) ) )
#define SHADOW_TXRD_PTR( i ) \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, 0x1F1 + 3 * i ) ) )

#define SOCK_BASE I2CHIP_C0_SSR
#define SOCK_SIZE ( I2CHIP_C1_SSR - I2CHIP_C0_SSR )

#define SOCK_STATUS( i )                                 \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i ) ) )
#define OPT_PROTOCOL( i )                                \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x01 ) ) )
#define DST_HA_PTR( i )                                  \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x02 ) ) )
#define DST_IP_PTR( i )                                  \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x08 ) ) )
#define DST_PORT_PTR( i )                                \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x0C ) ) )
#define SRC_PORT_PTR( i )                                \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x0E ) ) )
#define IP_PROTOCOL( i )                                 \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x10 ) ) )
#define TOS( i )                                         \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                       SOCK_BASE + SOCK_SIZE * i + 0x11 ) ) )
#define MSS( i )                                        \
    ( ( u_int far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                      SOCK_BASE + SOCK_SIZE * i + 0x12 ) ) )
#define P_WINDOW( i )                                   \
    ( ( u_int far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                      SOCK_BASE + SOCK_SIZE * i + 0x14 ) ) )
#define WINDOW( i )                                     \
    ( ( u_int far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, \
                                      SOCK_BASE + SOCK_SIZE * i + 0x16 ) ) )

#define GATEWAY_PTR \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_GAR ) ) )
#define SUBNET_MASK_PTR \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_SMR ) ) )

#define SRC_HA_PTR \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_SHAR ) ) )
#define SRC_IP_PTR \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_SIPR ) ) )
#define TIMEOUT_PTR \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_IRTR ) ) )

#define RX_DMEM_SIZE \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_RMSR ) ) )
#define TX_DMEM_SIZE \
    ( ( u_char far * ) ( MK_FP_WINDOW( COMMAND_BASE_SEG, I2CHIP_TMSR ) ) )
