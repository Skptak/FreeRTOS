...
// memory.
//*****************************************************************************
__attribute__( ( section( ".after_vectors" ) ) ) void data_init(
...
__attribute__( ( section( ".after_vectors" ) ) ) void bss_init(
    unsigned int start,
    unsigned int len )
{
    unsigned int * pulDest = ( unsigned int * ) start;
...
__attribute__( ( section( ".after_vectors" ) ) ) void ResetISR( void )
{
    ...
    data_init( ( unsigned int ) LoadAddr,
...
__attribute__( ( section( ".after_vectors" ) ) ) void SVCall_Handler( void )
{
    while( 1 )
    {
    }
