...
#define _00_PORT_PSEL6_PB6 \
    ( 0x00U ) /* PB6 general I/O port function is selected */
#define _40_PORT_PSEL6_PC0 \
    ( 0x40U ) /* PC0 general I/O port function is selected */
/* PB7/PC1 Switching (PSEL7) */
#define _00_PORT_PSEL7_PB7 \
    ( 0x00U ) /* PB7 general I/O port function is selected */
#define _80_PORT_PSEL7_PC1 \
    ( 0x80U ) /* PC1 general I/O port function is selected */
