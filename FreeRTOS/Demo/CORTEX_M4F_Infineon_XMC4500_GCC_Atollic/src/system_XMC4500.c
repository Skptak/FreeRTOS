 ...
 * @brief    Device specific initialization for the XMC4500-Series according to
 CMSIS
 * @version  V2.2
...
void SystemCoreClockUpdate( void )
{
    /*----------------------------------------------------------------------------
      Clock Variable definitions
     *----------------------------------------------------------------------------*/
    SystemCoreClock = SYSTEM_FREQUENCY; /*!< System Clock Frequency (Core
                                           Clock)*/
}
