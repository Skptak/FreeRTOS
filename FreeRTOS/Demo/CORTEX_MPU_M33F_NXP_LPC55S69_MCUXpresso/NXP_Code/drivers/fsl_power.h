...
#define LOWPOWER_HWWAKE_PERIPHERALS                                            \
    ( 1UL << 1 ) /*!< Wake for Flexcomms. Any Flexcomm FIFO reaching the level \
                    specified by its own TXLVL will cause \ peripheral         \
                    clocking to wake up temporarily while the related status   \
                    is asserted */
...
#define LOWPOWER_WAKEUPIO_PIO0_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO0_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up      \
                                                                 I/O 0 use      \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 \              \
...
#define LOWPOWER_WAKEUPIO_PIO1_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO1_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up      \
                                                                 I/O 1 use      \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 \              \
...
#define LOWPOWER_WAKEUPIO_PIO2_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO2_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up      \
                                                                 I/O 2 use      \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 \              \
...
#define LOWPOWER_WAKEUPIO_PIO3_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO3_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up      \
                                                                 I/O 3 use      \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 \              \
