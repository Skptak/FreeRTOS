...
typedef enum _SYSCON_RSTn
{
    ...
    kGPIOSECINT_RST_SHIFT_RSTn = 131072 |
                                 30U, /**< GPIO Secure int reset control */
} SYSCON_RSTn_t;
...
#define CTIMER_RSTS                                           \
    {                                                         \
        kCTIMER0_RST_SHIFT_RSTn, kCTIMER1_RST_SHIFT_RSTn,     \
            kCTIMER2_RST_SHIFT_RSTn, kCTIMER3_RST_SHIFT_RSTn, \
...
#define FLEXCOMM_RSTS                                                        \
    {                                                                        \
        kFC0_RST_SHIFT_RSTn, kFC1_RST_SHIFT_RSTn, kFC2_RST_SHIFT_RSTn,       \
            ...
            kFC6_RST_SHIFT_RSTn, kFC7_RST_SHIFT_RSTn, kHSLSPI_RST_SHIFT_RSTn \
