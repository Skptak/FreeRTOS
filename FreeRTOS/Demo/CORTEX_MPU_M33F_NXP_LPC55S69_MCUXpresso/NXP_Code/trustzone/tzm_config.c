...
void BOARD_InitTrustZone()
{
    ...
    /* Set SAU Control register: Enable SAU and All Secure (applied only if
     * disabled) */
    ...
    */
    ...
    AHB_SECURE_CTRL->SEC_CTRL_FLASH_ROM[ 0 ]
        .SEC_CTRL_FLASH_MEM_RULE[ 0 ] = 0x00000033U;
    ...
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE0_MEM_CTRL0 = 0xFCCCCCFFU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE0_MEM_CTRL1 = 0xFCCCFFCCU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE0_MEM_CTRL2 = 0xFFFFCFFFU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE1_MEM_CTRL0 = 0xFFFFCFFCU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE1_MEM_CTRL1 = 0xFFCCFCCCU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE1_MEM_CTRL2 = 0xFFCCFFFFU;
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[ 0 ]
        .SEC_CTRL_APB_BRIDGE1_MEM_CTRL3 = 0xFFCFCCFCU;
    ...
    AHB_SECURE_CTRL->MASTER_SEC_LEVEL = ( AHB_SECURE_CTRL->MASTER_SEC_LEVEL &
                                        ...
                                        0x080000000U;
    AHB_SECURE_CTRL
        ->MASTER_SEC_ANTI_POL_REG = ( AHB_SECURE_CTRL->MASTER_SEC_ANTI_POL_REG &
                                      0x03FFFFFFFU ) |
                                    0x080000000U;
