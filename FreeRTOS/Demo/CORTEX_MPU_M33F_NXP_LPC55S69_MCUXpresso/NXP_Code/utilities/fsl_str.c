                                        ...
                                        bool use_caps )
{
    ...
    *nstrp++ = '\0';
    ...
    ( void ) neg;
    /*
     * Fix MISRA issue: CID 15972928 (#15 of 15): MISRA C-2012 Control Flow
    ...
    while( true )
    {
        ...
        c = *++p;
        {
            if( 1U == PrintIsdi( c ) )
            {
                ...
                vlen = ConvertRadixNumToString( ( char * ) vstr,
                                                ( void * ) &ival,
                                                1,
                                                10,
                                                use_caps );
                ...
                PrintOutputdifFobpu( flags_used,
                                     field_width,
                                     ( unsigned int ) vlen,
                                     schar,
                                     vstrp,
...
#endif /* PRINTF_ADVANCED_ENABLE */
                {
                    uval = ( STR_FORMAT_PRINTF_UVAL_TYPE )
            ...
            else if( 1U == PrintIsobpu( c ) )
            {
                ...
                {
                    /*
                     * Fix MISRA issue: CID 17205581 (#15 of 15): MISRA C-2012
                     * Pointer Type Conversions (MISRA C-2012
                     * Rule 11.6) 1.misra_c_2012_rule_11_6_violation: The
                     * expression va_arg (ap, void *) of type void * is cast to
                     * type uint32_t.
                     *
                     * Orignal code: uval =
                     * (STR_FORMAT_PRINTF_UVAL_TYPE)(uint32_t)va_arg(ap, void
                     * *);
                     */
                    void * pval;
                                         ...
                                         int32_t val )
{
    ...
    switch( flag & ( uint32_t ) kSCANF_LengthMask )
    {
        ...
        case( uint32_t ) kSCANF_LengthLongInt:
            ...
            {
                *va_arg( *args_ptr,
                         signed long int * ) = ( signed long int ) val;
            }
            else
            {
                *va_arg( *args_ptr,
        ...
        case( uint32_t ) kSCANF_LengthLongLongInt:
            ...
            {
                *va_arg( *args_ptr,
                         signed long long int * ) = ( signed long long int ) val;
            }
            else
            {
                *va_arg( *args_ptr,
                                             ...
                                             uint8_t * base )
{
    ...
    while( ( '\0' != ( *c ) ) &&
           ( 0U == ( *flag & ( uint32_t ) kSCANF_DestMask ) ) )
    {
#if( defined( SCANF_ADVANCED_ENABLE ) && ( SCANF_ADVANCED_ENABLE > 0 ) )
        if( '*' == ( *c ) )
        {
...
int StrFormatScanf( const char * line_ptr, char * format, va_list args_ptr )
{
    ...
    while( ( '\0' != ( *c ) ) && ( '\0' != ( *p ) ) )
    {
        ...
        else
        {
            ...
            exitPending = StrFormatScanfStringHandling( &c,
                                                        &flag,
                                                        &field_width,
                                                        &base );
            ...
            if( ( flag & ( uint32_t ) kSCANF_DestMask ) ==
                ( uint32_t ) kSCANF_DestChar )
            {
                s = ( const char * ) p;
            ...
            else if( ( flag & ( uint32_t ) kSCANF_DestMask ) ==
                     ( uint32_t ) kSCANF_DestString )
            {
                n_decode += ScanIgnoreWhiteSpace( &p );
                s = p;
                buf = va_arg( args_ptr, char * );
                while( ( 0U != ( field_width-- ) ) && ( *p != '\0' ) &&
                       ( 0U == ScanIsWhiteSpace( *p ) ) )
                {
#if( defined( SCANF_ADVANCED_ENABLE ) && ( SCANF_ADVANCED_ENABLE > 0 ) )
                    if( 0U != ( flag & ( uint32_t ) kSCANF_Suppress ) )
                    {
                     ...
                     ( uint32_t ) kSCANF_DestFloat )
            {
                ...
                {
                    n_decode = ( uint32_t ) n_decode + ( uint32_t ) s -
                               ( uint32_t ) p;
                    p = s;
                    nassigned += StrFormatScanFillFloat( flag,
                                                         &args_ptr,
                                                         fnum );
                }
            }
