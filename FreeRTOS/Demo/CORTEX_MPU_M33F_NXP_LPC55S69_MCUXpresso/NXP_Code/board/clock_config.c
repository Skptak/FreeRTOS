...
void BOARD_BootClockFRO12M( void )
{
    ...
    CLOCK_AttachClk( kFRO12M_to_MAIN_CLK ); /*!< Switch to FRO 12MHz first to
                                               ensure we can change the clock
                                               setting */
...
void BOARD_BootClockPLL100M( void )
{
    ...
    SYSCON->CLOCK_CTRL |= SYSCON_CLOCK_CTRL_CLKIN_ENA_MASK; /* Enable clk_in
                                                               ...
                                                               clock  */
    ANACTRL
        ->XO32M_CTRL |= ANACTRL_XO32M_CTRL_ENABLE_SYSTEM_CLK_OUT_MASK; /* Enable
                                                                          clk_in
                                                                          to
                                                                          system
                                                                        */

    POWER_SetVoltageForFreq( 100000000U ); /*!< Set voltage for the one of the
                                              fastest clock outputs: System
                                              clock output */
    CLOCK_SetFLASHAccessCyclesForFreq( 100000000U ); /*!< Set FLASH wait states
                                                        for core */
    ...
    const pll_setup_t pll0Setup = {
        ...
        .pllsscg = { 0x0U,
                     ( SYSCON_PLL0SSCG1_MDIV_EXT( 100U ) |
...
void BOARD_BootClockPLL150M( void )
{
    ...
    POWER_SetVoltageForFreq( 150000000U ); /*!< Set voltage for the one of the
                                              fastest clock outputs: System
                                              clock output */
    CLOCK_SetFLASHAccessCyclesForFreq( 150000000U ); /*!< Set FLASH wait states
                                                        for core */
    ...
    const pll_setup_t pll0Setup = {
        ...
        .pllsscg = { 0x0U,
                     ( SYSCON_PLL0SSCG1_MDIV_EXT( 150U ) |
                       SYSCON_PLL0SSCG1_SEL_EXT_MASK ) },
        .pllRate = 150000000U,
        .flags = PLL_SETUPFLAG_WAITLOCK
    };
