...
__attribute__( (
    ...
    PIN_INT4_IRQHandler,  // 48: Pin interrupt 4 or pattern match engine slice 4
                          // int
    PIN_INT5_IRQHandler,  // 49: Pin interrupt 5 or pattern match engine slice 5
                          // int
    PIN_INT6_IRQHandler,  // 50: Pin interrupt 6 or pattern match engine slice 6
                          // int
    PIN_INT7_IRQHandler,  // 51: Pin interrupt 7 or pattern match engine slice 7
                          // int
    ...
    FLEXCOMM8_IRQHandler, // 56: Flexcomm Interface 8 (USART, SPI, I2C,
                          // FLEXCOMM)
    FLEXCOMM9_IRQHandler, // 57: Flexcomm Interface 9 (USART, SPI, I2C,
                          // FLEXCOMM)
    ...
    __imghdr_loadaddress, // (0x08) Load_address
#endif
    ( void ( * )( void ) )( ( ( unsigned ) _image_size ) -
                            4 ), // (0x0C) load_length, exclude 4 bytes CRC
                                 // field.
    ...
    ( void ( * )( void ) ) 0x00000000, // 0xFFFFFFFF to default 1-bit SPI mode
                                       // ；DevStrAdr
...
// memory.
//*****************************************************************************
__attribute__( ( section( ".after_vectors.init_data" ) ) ) void data_init(
...
__attribute__( ( section( ".after_vectors.init_bss" ) ) ) void bss_init(
    unsigned int start,
    unsigned int len )
{
    unsigned int * pulDest = ( unsigned int * ) start;
