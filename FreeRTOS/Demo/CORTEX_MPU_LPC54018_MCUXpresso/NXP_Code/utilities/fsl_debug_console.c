                          ...
                          uint32_t clkSrcFreq )
{
    ...
    serial_port_usb_cdc_virtual_config_t usbCdcVirtualConfig = {
        .controllerIndex = ( serial_port_usb_cdc_virtual_controller_index_t )
            instance,
    };
    #endif
    ...
    s_debugConsoleState.serialHandle = ( serial_handle_t ) &s_debugConsoleState
                                           .serialHandleBuffer[ 0 ];
    status = ( status_t ) SerialManager_Init( s_debugConsoleState.serialHandle,
                                              &serialConfig );
