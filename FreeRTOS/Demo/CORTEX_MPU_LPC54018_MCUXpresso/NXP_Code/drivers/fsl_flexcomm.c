...
void FLEXCOMM0_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 0 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 0 ],
                               s_flexcommHandle[ 0 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM1_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 1 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 1 ],
                               s_flexcommHandle[ 1 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM2_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 2 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 2 ],
                               s_flexcommHandle[ 2 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM3_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 3 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 3 ],
                               s_flexcommHandle[ 3 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM4_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 4 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 4 ],
                               s_flexcommHandle[ 4 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM5_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 5 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 5 ],
                               s_flexcommHandle[ 5 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM6_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 6 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 6 ],
                               s_flexcommHandle[ 6 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM7_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 7 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 7 ],
                               s_flexcommHandle[ 7 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM8_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 8 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 8 ],
                               s_flexcommHandle[ 8 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM9_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 9 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 9 ],
                               s_flexcommHandle[ 9 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM10_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 10 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 10 ],
                                s_flexcommHandle[ 10 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM11_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 11 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 11 ],
                                s_flexcommHandle[ 11 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM12_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 12 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 12 ],
                                s_flexcommHandle[ 12 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
...
void FLEXCOMM13_DriverIRQHandler( void )
{
    ...
    s_flexcommIrqHandler[ 13 ]( ( uint32_t * ) s_flexcommBaseAddrs[ 13 ],
                                s_flexcommHandle[ 13 ] );
    /* Add for ARM errata 838869, affects Cortex-M4, Cortex-M4F Store immediate
      overlapping exception return operation might vector to incorrect interrupt
    */
