...
{
    /* PDRUNCFGSET */
    SYSCON->PDRUNCFGSET[ ( ( uint32_t ) en >> 8UL ) ] = ( 1UL
                                                          << ( ( uint32_t ) en &
                                                               0xffU ) );
}
...
{
    /* PDRUNCFGCLR */
    SYSCON->PDRUNCFGCLR[ ( ( uint32_t ) en >> 8UL ) ] = ( 1UL
                                                          << ( ( uint32_t ) en &
                                                               0xffU ) );
}
 ...
 *
 * @param exclude_from_pd  Bit mask of the PDRUNCFG0(low 32bits) and
 * PDRUNCFG1(high 32bits) that needs to be powered on during power mode
 * selected.
 * @return none
 */
 ...
 *
 * @param exclude_from_pd  Bit mask of the PDRUNCFG0(low 32bits) and
 * PDRUNCFG1(high 32bits) bits that needs to be powered on during deep sleep
 * @return none
 */
 ...
 *
 * @param exclude_from_pd   Bit mask of the PDRUNCFG0(low 32bits) and
 PDRUNCFG1(high 32bits) that needs to be powered on during deep power
 *                          down mode, but this is has no effect as the voltages
 are cut off.
 ...
 *                note that the voltage and flash wait states should be set
