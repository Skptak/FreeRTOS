...
#define W9812G6JB6I
    ...
    #define SDRAM_REFRESHPERIOD_NS                 \
        ( 64 * 1000000 / 4096 ) /* 4096 rows/ 64ms \
                                 */
    ...
    #define SDRAM_DEV_MEMORYMAP \
        ( 0x09u ) /* 128Mbits (8M*16, 4banks, 12 rows, 9 columns)*/
#endif
...
status_t BOARD_InitDebugConsole( void )
{
    ...
    result = DbgConsole_Init( instance,
...
void BOARD_InitSDRAM( void )
{
    ...
    dynTiming.tWr_Ns = ( 1000000000 / emcFreq + SDRAM_TWRDELT_NS ); /* one clk +
                                                                       6ns */
                               ...
                               uint32_t txBuff )
{
    ...
    return BOARD_I2C_Send( BOARD_ACCEL_I2C_BASEADDR,
                           deviceAddress,
                           subAddress,
                           subaddressSize,
                           &data,
...
status_t BOARD_Accel_I2C_Receive( uint8_t deviceAddress,
                                  ...
                                  uint8_t rxBuffSize )
{
    return BOARD_I2C_Receive( BOARD_ACCEL_I2C_BASEADDR,
                              deviceAddress,
                              subAddress,
                              subaddressSize,
                              rxBuff,
...
status_t BOARD_Codec_I2C_Send( uint8_t deviceAddress,
                               ...
                               uint8_t txBuffSize )
{
    return BOARD_I2C_Send( BOARD_CODEC_I2C_BASEADDR,
                           deviceAddress,
                           subAddress,
                           subAddressSize,
                           ( uint8_t * ) txBuff,
...
status_t BOARD_Codec_I2C_Receive( uint8_t deviceAddress,
                                  ...
                                  uint8_t rxBuffSize )
{
    return BOARD_I2C_Receive( BOARD_CODEC_I2C_BASEADDR,
                              deviceAddress,
                              subAddress,
                              subAddressSize,
                              rxBuff,
