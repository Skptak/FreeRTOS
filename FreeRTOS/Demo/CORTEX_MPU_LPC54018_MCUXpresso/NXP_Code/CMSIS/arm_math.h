...
typedef enum
{
    ...
    ARM_MATH_SIZE_MISMATCH = -3,  /**< Size of matrices is not compatible with
                                     the operation */
...
__STATIC_FORCEINLINE uint32_t __QADD8( uint32_t x, uint32_t y )
{
    ...
    r = __SSAT( ( ( ( ( q31_t ) x << 24 ) >> 24 ) +
                  ( ( ( q31_t ) y << 24 ) >> 24 ) ),
                8 ) &
        ( int32_t ) 0x000000FF;
    s = __SSAT( ( ( ( ( q31_t ) x << 16 ) >> 24 ) +
                  ( ( ( q31_t ) y << 16 ) >> 24 ) ),
                8 ) &
        ( int32_t ) 0x000000FF;
    t = __SSAT( ( ( ( ( q31_t ) x << 8 ) >> 24 ) +
                  ( ( ( q31_t ) y << 8 ) >> 24 ) ),
                8 ) &
        ( int32_t ) 0x000000FF;
...
typedef struct
{
    ...
    float32_t * pState; /**< points to the state variable array. The array is of
                           length numTaps+blockSize-1. */
    const float32_t * pCoeffs; /**< points to the coefficient array. The array
...
typedef struct
{
    ...
    uint32_t twidCoefRModifier; /**< twiddle coefficient modifier that supports
                                   different size FFTs with the same twiddle
                                   factor table. */
    const float32_t * pTwiddleAReal;      /**< points to the real twiddle factor
                                             table. */
    const float32_t * pTwiddleBReal;      /**< points to the imag twiddle factor
                                             table. */
...
typedef struct
{
    ...
    arm_cfft_radix4_instance_q31 * pCfft; /**< points to the complex FFT
                                             instance. */
...
typedef struct
{
    ...
    arm_cfft_radix4_instance_q15 * pCfft; /**< points to the complex FFT
                                             instance. */
...
__STATIC_FORCEINLINE q15_t arm_pid_q15( arm_pid_instance_q15 * S, q15_t in )
{
    ...
    acc = ( q63_t ) __SMLALD( ( uint32_t ) S->A1,
                              ( uint32_t ) read_q15x2( S->state ),
                              ( uint64_t ) acc );
    #else
    /* acc = A0 * x[n]  */
    acc = ( ( q31_t ) S->A0 ) * in;
...
arm_bilinear_interp_q31( arm_bilinear_interp_instance_q31 * S,
                         q31_t X,
                         q31_t Y )
{
...
arm_bilinear_interp_q15( arm_bilinear_interp_instance_q15 * S,
                         q31_t X,
                         q31_t Y )
{
    q63_t acc = 0;               /* output */
 ...
 */
    ...
    #if defined( __CC_ARM )
        /* Enter low optimization region - place directly above function
         * definition */
