...
// #include 	<stdlib.h>					// Remove the comment when you use
// rand()
#include "stacksct.h"
...
// extern _SBYTE *_s1ptr;				// Remove the comment when you use
// strtok()
...
// object extern "C" {					// Sections C$INIT and C$END will be
// generated #endif extern void _CALL_INIT(void); extern void _CALL_END(void);
// #ifdef __cplusplus
// }
// #endif
...
void PowerON_Reset_PC( void )
{
    ...
    //	_INIT_IOLIB();					// Remove the comment when you use SIM
    // I/O

    //	errno=0;						// Remove the comment when you use errno
    //	srand((_UINT)1);				// Remove the comment when you use
    // rand() 	_s1ptr=NULL;					// Remove the comment when you
    // use strtok()
