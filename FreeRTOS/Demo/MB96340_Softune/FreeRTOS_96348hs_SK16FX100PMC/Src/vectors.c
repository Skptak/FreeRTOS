...
void InitIrqLevels( void )
{
    ...
    ICR = ( ( 51 & 0xFF ) << 8 ) |
          configKERNEL_INTERRUPT_PRIORITY; /* Reload Timer 0 of MB9634x Series
                                            */
    ICR = ( ( 12 & 0xFF ) << 8 ) |
          configKERNEL_INTERRUPT_PRIORITY; /* Delayed interrupt of 16FX Family
                                            */

    ICR = ( 79 << 8 ) |
          configKERNEL_INTERRUPT_PRIORITY; /* UART 0 Rx of MB9634x Series */
    ICR = ( 80 << 8 ) |
          configKERNEL_INTERRUPT_PRIORITY; /* UART 0 Tx of MB9634x Series */
}
...
#pragma intvect DefaultIRQHandler 88 /* SATELLITE FLASH IRQ (not on all \
                                        devices) */
