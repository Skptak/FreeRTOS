...
/*------------------------------------------------------------------------
  watchdog.h
  - This file contains the defines and function declaration for hardware
watchdog.
-------------------------------------------------------------------------*/
...
/*
 * After every WTC_CLR_PER ticks the watchdog would be cleared in the
 * prvWatchdogTask(). This period needs to be chosed in accordance with the
 * current CLKWT and the above setting WTC_PER_2_XX.
 */
