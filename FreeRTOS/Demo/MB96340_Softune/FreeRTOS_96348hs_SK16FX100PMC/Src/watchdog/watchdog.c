...
void InitWatchdog( void )
{
    ...
    WDTC_WTCS = WTC_CLKMC; /* CLKWT=CLKMC, Watchdog expiration delay = 2.097s @
                              4MHZ CLKMC*/
...
static void prvWatchdogTask( void * pvParameters )
{
    ...
    for( ;; )
    {
        ...
        /* Block the task for WTC_CLR_PER ticks (1s) at watchdog overflow period
         * of WTC_PER_2_23 CLKMC cycles */
