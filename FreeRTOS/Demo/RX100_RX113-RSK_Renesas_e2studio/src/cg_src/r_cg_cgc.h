...
#define _0000_CGC_UCLK_SYSCLK                       \
    ( 0x0000U ) /* System clock is selected as UCLK \
                 */
#define _0010_CGC_UCLK_USBPLL \
    ( 0x0010U ) /* USB-dedicated PLL is selected as UCLK */
...
#define _00_CGC_OSC_STOP_INT_DISABLE \
    ( 0x00U ) /* The oscillation stop detection interrupt is disabled */
#define _01_CGC_OSC_STOP_INT_ENABLE \
    ( 0x01U ) /* The oscillation stop detection interrupt is enabled */
/* Oscillation Stop Detection Function Enable (OSTDE) */
#define _00_CGC_OSC_STOP_DISABLE \
    ( 0x00U ) /* Oscillation stop detection function is disabled */
#define _80_CGC_OSC_STOP_ENABLE \
    ( 0x80U ) /* Oscillation stop detection function is enabled */
...
#define _05_CGC_HOCO_WAIT_CYCLE_138 \
    ( 0x05U ) /* Wait time = 138 cycles (34.5us) */
#define _06_CGC_HOCO_WAIT_CYCLE_266 \
    ( 0x06U ) /* Wait time = 266 cycles (66.5us) */
...
#define _0000_CGC_CLKOUT_ENABLE                   \
    ( 0x0000U ) /* CLKOUT pin output is operating \
                 */
#define _8000_CGC_CLKOUT_DISABLE \
    ( 0x8000U ) /* CLKOUT pin output is stopped (fixed at low level) */
...
#define _04_CGC_LCDSCLKSEL_IWDT \
    ( 0x04U ) /* IWDT-dedicated on-chip oscillator */

/***********************************************************************************************************************
Macro definitions
***********************************************************************************************************************/
#define _007B_CGC_SUBSTPWT_WAIT \
    ( 0x007BU ) /* Wait time for 5 sub clock cycles */
#define _00061A81_CGC_SUBOSCWT_WAIT \
    ( 0x00061A81U ) /* Wait time for sub clock stable */
