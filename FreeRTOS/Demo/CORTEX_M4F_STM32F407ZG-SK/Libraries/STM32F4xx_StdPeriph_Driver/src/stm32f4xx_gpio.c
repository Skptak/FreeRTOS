 ...
 *                  50 MHz or 100 MHz.
 *                - Alternate Function: Push-Pull (Pull-up, Pull-down or no
 *Pull) Open Drain (Pull-up, Pull-down or no Pull).
 *                - Analog: required mode when a pin is to be used as ADC
 *channel or DAC output.
 *
 *          3- Peripherals alternate function:
 *              - For ADC and DAC, configure the desired pin in analog mode
 *using GPIO_InitStruct->GPIO_Mode = GPIO_Mode_AN;
 ...
 *
 *          4. To get the level of a pin configured in input mode use
