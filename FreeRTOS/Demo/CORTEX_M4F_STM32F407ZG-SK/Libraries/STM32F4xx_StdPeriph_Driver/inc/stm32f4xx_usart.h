 ...
 */
    ...
    #define IS_USART_ALL_PERIPH( PERIPH )                         \
        ( ( ( PERIPH ) == USART1 ) || ( ( PERIPH ) == USART2 ) || \
          ( ( PERIPH ) == USART3 ) || ( ( PERIPH ) == UART4 ) ||  \
          ( ( PERIPH ) == UART5 ) || ( ( PERIPH ) == USART6 ) )

    #define IS_USART_1236_PERIPH( PERIPH )                        \
        ( ( ( PERIPH ) == USART1 ) || ( ( PERIPH ) == USART2 ) || \
          ( ( PERIPH ) == USART3 ) || ( ( PERIPH ) == USART6 ) )
 ...
 */
    ...
    #define USART_IT_ORE_RX                                              \
        ( ( uint16_t ) 0x0325 ) /* In case interrupt is generated if the \
                                   RXNEIE bit is set */
    ...
    #define USART_IT_ORE_ER                                                  \
        ( ( uint16_t ) 0x0360 ) /* In case interrupt is generated if the EIE \
                                   bit is set */
