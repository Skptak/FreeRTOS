...
typedef struct
{
    ...
    uint16_t CRYP_DataType; /*!< 32-bit data, 16-bit data, bit data or
                               bit-string. This parameter can be a value of @ref
                               CRYP_Data_Type */
...
typedef struct
{
    ...
    #define IS_CRYP_GET_IT( IT ) \
        ( ( ( IT ) == CRYP_IT_INI ) || ( ( IT ) == CRYP_IT_OUTI ) )
