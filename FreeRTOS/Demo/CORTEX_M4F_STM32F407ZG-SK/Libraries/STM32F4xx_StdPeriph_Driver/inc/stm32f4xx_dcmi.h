...
typedef struct
{
    ...
    uint16_t DCMI_SynchroMode; /*!< Specifies the Synchronization Mode: Hardware
                                  or Embedded. This parameter can be a value of
                                  @ref DCMI_Synchronization_Mode */

    uint16_t DCMI_PCKPolarity; /*!< Specifies the Pixel clock polarity: Falling
                                  or Rising. This parameter can be a value of
                                  @ref DCMI_PIXCK_Polarity */

    uint16_t DCMI_VSPolarity; /*!< Specifies the Vertical synchronization
                                 polarity: High or Low. This parameter can be a
                                 value of @ref DCMI_VSYNC_Polarity */

    uint16_t DCMI_HSPolarity; /*!< Specifies the Horizontal synchronization
                                 polarity: High or Low. This parameter can be a
                                 value of @ref DCMI_HSYNC_Polarity */

    uint16_t DCMI_CaptureRate; /*!< Specifies the frequency of frame capture:
                                  All, 1/2 or 1/4. This parameter can be a value
                                  of @ref DCMI_Capture_Rate */

    uint16_t DCMI_ExtendedDataMode; /*!< Specifies the data width: 8-bit,
                                       10-bit, 12-bit or 14-bit. This parameter
...
typedef struct
{
    uint16_t DCMI_VerticalStartLine; /*!< Specifies the Vertical start line
                                        count from which the image capture will
                                        start. This parameter can be a value
    ...
    uint16_t DCMI_VerticalLineCount; /*!< Specifies the number of lines to be
                                        captured from the starting point. This
                                        parameter can be a value between 0x00
                                        and 0x3FFF */

    uint16_t DCMI_CaptureCount; /*!< Specifies the number of pixel clocks to be
                                   captured from the starting point on the same
                                   line. This parameter can be a value between
                                   0x00 and 0x3FFF */
...
typedef struct
{
    ...
    #define DCMI_CaptureMode_Continuous                                     \
        ( ( uint16_t ) 0x0000 ) /*!< The received data are transferred      \
                                   continuously into the destination memory \
                                   through the DMA */
    #define DCMI_CaptureMode_SnapShot                                        \
        ( ( uint16_t ) 0x0002 ) /*!< Once activated, the interface waits for \
    ...
    #define DCMI_ExtendedDataMode_8b                                        \
        ( ( uint16_t ) 0x0000 ) /*!< Interface captures 8-bit data on every \
                                   pixel clock */
    #define DCMI_ExtendedDataMode_10b                                        \
        ( ( uint16_t ) 0x0400 ) /*!< Interface captures 10-bit data on every \
                                   pixel clock */
    #define DCMI_ExtendedDataMode_12b                                        \
        ( ( uint16_t ) 0x0800 ) /*!< Interface captures 12-bit data on every \
                                   pixel clock */
    #define DCMI_ExtendedDataMode_14b                                        \
        ( ( uint16_t ) 0x0C00 ) /*!< Interface captures 14-bit data on every \
                                   pixel clock */
    ...
    #define IS_DCMI_GET_FLAG( FLAG )                                          \
        ( ( ( FLAG ) == DCMI_FLAG_HSYNC ) ||                                  \
          ( ( FLAG ) == DCMI_FLAG_VSYNC ) || ( ( FLAG ) == DCMI_FLAG_FNE ) || \
