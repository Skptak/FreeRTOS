...
typedef struct
{
    ...
    FunctionalState ADC_ContinuousConvMode; /*!< Specifies whether the
                                               ...
                                               Continuous or Single mode. This
                                               parameter can be set to ENABLE or
                                               DISABLE. */
    uint32_t
        ADC_ExternalTrigConvEdge; /*!< Select the external trigger edge and
                                       enable the trigger of a regular
                                     group. This parameter can be a value
                                     of
                                       @ref
                                     ADC_external_trigger_edge_for_regular_channels_conversion
                                   */
    uint32_t
        ADC_ExternalTrigConv;    /*!< Select the external event used to
                                    trigger     the start of conversion of a
                                    regular group.     This parameter can be a
                                    value of
                                      @ref
...
typedef struct
{
    ...
    uint32_t ADC_Prescaler;        /*!< Select the frequency of the clock
                                      ...
                                      ADCs.        This parameter can be a value of
                                      @ref        ADC_Prescaler */
    uint32_t ADC_DMAAccessMode;    /*!< Configures the Direct memory access
                                    ...
                                    */
    uint32_t ADC_TwoSamplingDelay; /*!< Configures the Delay between 2 sampling
    ...
    #define ADC_DMAAccessMode_1                                             \
        ( ( uint32_t ) 0x00004000 ) /* DMA mode 1 enabled (2 / 3 half-words \
                                       one by one - 1 then 2 then 3)*/
    #define ADC_DMAAccessMode_2                                                \
        ( ( uint32_t ) 0x00008000 ) /* DMA mode 2 enabled (2 / 3 half-words by \
                                       pairs - 2&1 then 1&3 then 3&2)*/
    #define ADC_DMAAccessMode_3                                           \
        ( ( uint32_t ) 0x0000C000 ) /* DMA mode 3 enabled (2 / 3 bytes by \
                                       pairs - 2&1 then 1&3 then 3&2) */
