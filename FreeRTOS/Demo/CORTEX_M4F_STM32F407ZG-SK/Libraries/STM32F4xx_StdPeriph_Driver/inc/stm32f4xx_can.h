...
typedef struct
{
    ...
    FunctionalState CAN_ABOM; /*!< Enable or disable the automatic bus-off
                                 management. This parameter can be set either to
                                 ENABLE or DISABLE. */
    ...
    FunctionalState CAN_NART; /*!< Enable or disable the non-automatic
                                 retransmission mode. This parameter can be set
                                 either to ENABLE or DISABLE. */
...
typedef struct
{
    ...
    uint16_t CAN_FilterIdLow; /*!< Specifies the filter identification number
                                 ...
                                 for a 16-bit configuration). This parameter can
    ...
    uint16_t CAN_FilterMaskIdHigh; /*!< Specifies the filter mask number or
                                      ...
                                      configuration). This parameter can be a
    ...
    uint16_t CAN_FilterFIFOAssignment; /*!< Specifies the FIFO (0 or 1) which
                                          will be assigned to the filter. This
 ...
 */
    ...
    #define CAN_ModeStatus_Success                                            \
        ( ( uint8_t ) !CAN_ModeStatus_Failed ) /*!< CAN entering the specific \
                                                  mode Succeed */
    /**
     * @}
     */
    ...
    #define CAN_TxStatus_Failed \
        ( ( uint8_t ) 0x00 ) /*!< CAN transmission failed */
    #define CAN_TxStatus_Ok \
        ( ( uint8_t ) 0x01 ) /*!< CAN transmission succeeded */
    ...
    #define CAN_Sleep_Ok                                     \
        ( ( uint8_t ) 0x01 ) /*!< CAN entered the sleep mode \
                              */
    ...
    #define CAN_WakeUp_Ok                                   \
        ( ( uint8_t ) 0x01 ) /*!< CAN leaved the sleep mode \
                              */
    ...
    #define CAN_ErrorCode_ACKErr \
        ( ( uint8_t ) 0x30 ) /*!< Acknowledgment Error */
    ...
    #define CAN_FLAG_RQCP0 \
        ( ( uint32_t ) 0x38000001 ) /*!< Request MailBox0 Flag */
    #define CAN_FLAG_RQCP1 \
        ( ( uint32_t ) 0x38000100 ) /*!< Request MailBox1 Flag */
    #define CAN_FLAG_RQCP2 \
        ( ( uint32_t ) 0x38010000 ) /*!< Request MailBox2 Flag */
    ...
    #define CAN_FLAG_SLAK \
        ( ( uint32_t ) 0x31000012 ) /*!< Sleep acknowledge Flag */
    /* @note When SLAK interrupt is disabled (SLKIE=0), no polling on SLAKI is
       possible. In this case the SLAK bit can be polled.*/

    /* Error Flags */
    #define CAN_FLAG_EWG \
        ( ( uint32_t ) 0x10F00001 ) /*!< Error Warning Flag   */
    #define CAN_FLAG_EPV \
        ( ( uint32_t ) 0x10F00002 ) /*!< Error Passive Flag   */
    #define CAN_FLAG_BOF \
        ( ( uint32_t ) 0x10F00004 ) /*!< Bus-Off Flag         */
    #define CAN_FLAG_LEC \
        ( ( uint32_t ) 0x30F00070 ) /*!< Last error code Flag */
    ...
    #define CAN_IT_FF0                               \
        ( ( uint32_t ) 0x00000004 ) /*!< FIFO 0 full \
                                       Interrupt*/
    #define CAN_IT_FOV0 \
        ( ( uint32_t ) 0x00000008 ) /*!< FIFO 0 overrun Interrupt*/
    #define CAN_IT_FMP1 \
        ( ( uint32_t ) 0x00000010 ) /*!< FIFO 1 message pending Interrupt*/
    #define CAN_IT_FF1                               \
        ( ( uint32_t ) 0x00000020 ) /*!< FIFO 1 full \
                                       Interrupt*/
    #define CAN_IT_FOV1 \
        ( ( uint32_t ) 0x00000040 ) /*!< FIFO 1 overrun Interrupt*/

    /* Operating Mode Interrupts */
    #define CAN_IT_WKU ( ( uint32_t ) 0x00010000 ) /*!< Wake-up Interrupt*/
    #define CAN_IT_SLK \
        ( ( uint32_t ) 0x00020000 ) /*!< Sleep acknowledge Interrupt*/

    /* Error Interrupts */
    #define CAN_IT_EWG \
        ( ( uint32_t ) 0x00000100 ) /*!< Error warning Interrupt*/
    #define CAN_IT_EPV \
        ( ( uint32_t ) 0x00000200 ) /*!< Error passive Interrupt*/
    #define CAN_IT_BOF ( ( uint32_t ) 0x00000400 ) /*!< Bus-off Interrupt*/
    #define CAN_IT_LEC \
        ( ( uint32_t ) 0x00000800 ) /*!< Last error code Interrupt*/
