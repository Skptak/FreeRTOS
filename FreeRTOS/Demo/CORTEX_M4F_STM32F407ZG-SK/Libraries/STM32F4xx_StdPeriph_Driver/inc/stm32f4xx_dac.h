...
typedef struct
{
    ...
    uint32_t DAC_WaveGeneration; /*!< Specifies whether DAC channel noise waves
                                    or triangle waves are generated, or whether
                                    no wave is generated. This parameter can be
                                    a value of @ref DAC_wave_generation */
    ...
    uint32_t DAC_LFSRUnmask_TriangleAmplitude; /*!< Specifies the LFSR mask for
                                                  ...
                                                  generation for the DAC
                                                  channel. This parameter can be
                                                  a value of @ref
 ...
 */
    ...
    #define DAC_Trigger_None                                                  \
        ( ( uint32_t ) 0x00000000 ) /*!< Conversion is automatic once the     \
                                       DAC1_DHRxxxx register has been loaded, \
                                       and not by external trigger */
    #define DAC_Trigger_T2_TRGO                                         \
        ( ( uint32_t ) 0x00000024 ) /*!< TIM2 TRGO selected as external \
                                       conversion trigger for DAC channel */
    #define DAC_Trigger_T4_TRGO                                         \
        ( ( uint32_t ) 0x0000002C ) /*!< TIM4 TRGO selected as external \
                                       conversion trigger for DAC channel */
    #define DAC_Trigger_T5_TRGO                                         \
        ( ( uint32_t ) 0x0000001C ) /*!< TIM5 TRGO selected as external \
                                       conversion trigger for DAC channel */
    #define DAC_Trigger_T6_TRGO                                         \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM6 TRGO selected as external \
                                       conversion trigger for DAC channel */
    #define DAC_Trigger_T7_TRGO                                         \
        ( ( uint32_t ) 0x00000014 ) /*!< TIM7 TRGO selected as external \
                                       conversion trigger for DAC channel */
    #define DAC_Trigger_T8_TRGO                                         \
        ( ( uint32_t ) 0x0000000C ) /*!< TIM8 TRGO selected as external \
                                       conversion trigger for DAC channel */
    ...
    #define DAC_Trigger_Software                                        \
        ( ( uint32_t ) 0x0000003C ) /*!< Conversion started by software \
 ...
 */
    ...
    #define DAC_LFSRUnmask_Bit0                                           \
        ( ( uint32_t ) 0x00000000 ) /*!< Unmask DAC channel LFSR bit0 for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits1_0                                            \
        ( ( uint32_t ) 0x00000100 ) /*!< Unmask DAC channel LFSR bit[1:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits2_0                                            \
        ( ( uint32_t ) 0x00000200 ) /*!< Unmask DAC channel LFSR bit[2:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits3_0                                            \
        ( ( uint32_t ) 0x00000300 ) /*!< Unmask DAC channel LFSR bit[3:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits4_0                                            \
        ( ( uint32_t ) 0x00000400 ) /*!< Unmask DAC channel LFSR bit[4:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits5_0                                            \
        ( ( uint32_t ) 0x00000500 ) /*!< Unmask DAC channel LFSR bit[5:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits6_0                                            \
        ( ( uint32_t ) 0x00000600 ) /*!< Unmask DAC channel LFSR bit[6:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits7_0                                            \
        ( ( uint32_t ) 0x00000700 ) /*!< Unmask DAC channel LFSR bit[7:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits8_0                                            \
        ( ( uint32_t ) 0x00000800 ) /*!< Unmask DAC channel LFSR bit[8:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits9_0                                            \
        ( ( uint32_t ) 0x00000900 ) /*!< Unmask DAC channel LFSR bit[9:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits10_0                                            \
        ( ( uint32_t ) 0x00000A00 ) /*!< Unmask DAC channel LFSR bit[10:0] for \
                                       noise wave generation */
    #define DAC_LFSRUnmask_Bits11_0                                            \
        ( ( uint32_t ) 0x00000B00 ) /*!< Unmask DAC channel LFSR bit[11:0] for \
                                       noise wave generation */
