...
typedef struct
{
    uint32_t HASH_AlgoSelection; /*!< SHA-1 or MD5. This parameter can be a
                                    value of @ref HASH_Algo_Selection */
...
typedef struct
{
    ...
    #define HASH_AlgoSelection_SHA1 \
        ( ( uint16_t ) 0x0000 ) /*!< HASH function is SHA1 */
    #define HASH_AlgoSelection_MD5 \
        ( ( uint16_t ) 0x0080 ) /*!< HASH function is MD5 */
    ...
    #define HASH_AlgoMode_HASH                         \
        ( ( uint16_t ) 0x0000 ) /*!< Algorithm is HASH \
                                 */
    #define HASH_AlgoMode_HMAC                         \
        ( ( uint16_t ) 0x0040 ) /*!< Algorithm is HMAC \
                                 */
    ...
    #define HASH_HMACKeyType_LongKey \
        ( ( uint32_t ) 0x00010000 ) /*!< HMAC Key is > 64 bytes */
     ...
     */
    #define HASH_IT_DINI                                                    \
        ( ( uint8_t ) 0x01 ) /*!< A new block can be entered into the input \
                                buffer (DIN)*/
    #define HASH_IT_DCI                                       \
        ( ( uint8_t ) 0x02 ) /*!< Digest calculation complete \
                              */

    #define IS_HASH_IT( IT ) \
        ( ( ( ( IT ) & ( uint8_t ) 0xFC ) == 0x00 ) && ( ( IT ) != 0x00 ) )
    #define IS_HASH_GET_IT( IT ) \
        ( ( ( IT ) == HASH_IT_DINI ) || ( ( IT ) == HASH_IT_DCI ) )
    ...
    #define HASH_FLAG_DINIS                                                   \
        ( ( uint16_t ) 0x0001 ) /*!< 16 locations are free in the DIN : A new \
                                   block can be entered into the input        \
                                   buffer.*/
    #define HASH_FLAG_DCIS \
        ( ( uint16_t ) 0x0002 ) /*!< Digest calculation complete */
    #define HASH_FLAG_DMAS                                                  \
        ( ( uint16_t ) 0x0004 ) /*!< DMA interface is enabled (DMAE=1) or a \
                                   transfer is ongoing */
    #define HASH_FLAG_BUSY                                                \
        ( ( uint16_t ) 0x0008 ) /*!< The hash core is Busy : processing a \
                                   block of data */
    #define HASH_FLAG_DINNE                                                    \
        ( ( uint16_t ) 0x1000 ) /*!< DIN not empty : The input buffer contains \
