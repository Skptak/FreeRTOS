...
const uint16_t BUTTON_EXTI_LINE[ BUTTONn ] = {
    WAKEUP_BUTTON_EXTI_LINE, TAMPER_BUTTON_EXTI_LINE, USER_BUTTON_EXTI_LINE,
...
const uint16_t BUTTON_PIN_SOURCE[ BUTTONn ] = {
    ...
    USER_BUTTON_EXTI_PIN_SOURCE,   RIGHT_BUTTON_EXTI_PIN_SOURCE,
...
const uint16_t BUTTON_IRQn[ BUTTONn ] = {
    WAKEUP_BUTTON_EXTI_IRQn, TAMPER_BUTTON_EXTI_IRQn, USER_BUTTON_EXTI_IRQn,
