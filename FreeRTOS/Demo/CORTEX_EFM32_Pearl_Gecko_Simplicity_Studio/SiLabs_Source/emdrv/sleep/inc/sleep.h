 ...
 *  @li sleepEM2 - EM2, like EM1 + all HF clocks are turned off, LF clocks are
 * on.
 *  @li sleepEM3 - EM3, like EM2 + LF clocks are off, RAM retention, GPIO and
 * ACMP interrupt is on. */
