...
#include "em_letimer.h"
    ...
    /** Validation of LETIMER register block pointer reference for assert
     * statements. */
...
void LETIMER_Reset( LETIMER_TypeDef * letimer )
{
    ...
    letimer->CMD = LETIMER_CMD_STOP | LETIMER_CMD_CLEAR | LETIMER_CMD_CTO0 |
                   LETIMER_CMD_CTO1;
