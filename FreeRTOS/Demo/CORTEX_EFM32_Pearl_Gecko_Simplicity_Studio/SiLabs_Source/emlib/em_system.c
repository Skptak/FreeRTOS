...
void SYSTEM_ChipRevisionGet( SYSTEM_ChipRevision_TypeDef * rev )
{
    ...
    /* CHIP FAMILY bit [5:2] */
    tmp = ( ( ( ROMTABLE->PID1 & _ROMTABLE_PID1_FAMILYMSB_MASK ) >>
              _ROMTABLE_PID1_FAMILYMSB_SHIFT )
            << 2 );
    /* CHIP FAMILY bit [1:0] */
    tmp |= ( ( ROMTABLE->PID0 & _ROMTABLE_PID0_FAMILYLSB_MASK ) >>
             _ROMTABLE_PID0_FAMILYLSB_SHIFT );
    rev->family = tmp;

    /* CHIP MAJOR bit [3:0] */
    rev->major = ( ROMTABLE->PID0 & _ROMTABLE_PID0_REVMAJOR_MASK ) >>
    ...
    tmp = ( ( ( ROMTABLE->PID2 & _ROMTABLE_PID2_REVMINORMSB_MASK ) >>
            ...
            << 4 );
    /* CHIP MINOR bit [3:0] */
    tmp |= ( ( ROMTABLE->PID3 & _ROMTABLE_PID3_REVMINORLSB_MASK ) >>
