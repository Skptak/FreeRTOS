...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
static uc8 APBAHBPrescTable[ 16 ] = { 0, 0, 0, 0, 1, 2, 3, 4,
                                      1, 2, 3, 4, 6, 7, 8, 9 };
 ...
 *                  value.
 * Input          : - HSICalibrationValue: specifies the calibration trimming
 *value. This parameter must be a number between 0 and 0x1F. Output         :
 *None Return         : None
 *******************************************************************************/
 ...
 * Description    : Enables or disables the Internal High Speed oscillator
 *(HSI). HSI can not be stopped if it is used directly or through the PLL as
 *system clock, or if a Flash programmation is on going. Input          : -
 ...
 * Input          : - RCC_SYSCLKSource: specifies the clock source used as
 *system clock. This parameter can be one of the following values:
 ...
 * Input          : None
 * Output         : None
 * Return         : The clock source used as system clock. The returned value
 ...
 * Input          : - RCC_USBCLKSource: specifies the USB clock source. This
 *clock is derived from the PLL output. This parameter can be one of the
 *following values:
 *                       - RCC_USBCLKSource_PLLCLK_1Div5: PLL clock divided by
 *1,5 selected as USB clock source
 *                       - RCC_USBCLKSource_PLLCLK_Div1: PLL clock selected as
 *USB clock source Output         : None Return         : None
 *******************************************************************************/
 ...
 *                  Once the RTC clock is selected it can’t be changed unless
 *the Backup domain is reset. Input          : - RCC_RTCCLKSource: specifies the
 *RTC clock source. This parameter can be one of the following values:
 *                       - RCC_RTCCLKSource_LSE: LSE oscillator clock used as
 *RTC clock
 *                       - RCC_RTCCLKSource_LSI: LSI oscillator clock used as
 *RTC clock
 *                       - RCC_RTCCLKSource_HSE_Div128: HSE oscillator clock
 *divided by 128 used as RTC clock Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - RCC_AHBPeriph: specifies the AHB peripheral to gates its
 *clock. This parameter can be any combination of the following values:
 *                       - RCC_AHBPeriph_DMA
 *                       - RCC_AHBPeriph_SRAM
 *                       - RCC_AHBPeriph_FLITF
 *                    SRAM and FLITF clock can be disabled only during sleep
 *mode.
 ...
 * Description    : Enables or disables the High Speed APB (APB2) peripheral
 *clock. Input          : - RCC_APB2Periph: specifies the APB2 peripheral to
 *gates its clock. This parameter can be any combination of the following
 *values:
 *                       - RCC_APB2Periph_AFIO, RCC_APB2Periph_GPIOA,
 *RCC_APB2Periph_GPIOB RCC_APB2Periph_GPIOC, RCC_APB2Periph_GPIOD,
 *RCC_APB2Periph_GPIOE RCC_APB2Periph_ADC1, RCC_APB2Periph_ADC2,
 ...
 * Description    : Enables or disables the Low Speed APB (APB1) peripheral
 *clock. Input          : - RCC_APB1Periph: specifies the APB1 peripheral to
 *gates its clock. This parameter can be any combination of the following
 *values:
 ...
 *RCC_APB1Periph_I2C2 RCC_APB1Periph_USB, RCC_APB1Periph_CAN, RCC_APB1Periph_BKP
 ...
 * Description    : Checks whether the specified RCC interrupt has occurred or
 *not. Input          : - RCC_IT: specifies the RCC interrupt source to check.
 *                    This parameter can be one of the following values:
 *                       - RCC_IT_LSIRDY: LSI ready interrupt
 *                       - RCC_IT_LSERDY: LSE ready interrupt
 *                       - RCC_IT_HSIRDY: HSI ready interrupt
