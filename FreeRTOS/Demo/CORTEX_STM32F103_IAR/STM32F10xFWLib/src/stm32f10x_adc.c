 ...
 * Input          : - ADCx: where x can be 1 or 2 to select the ADC peripheral.
 *                  - ADC_InitStruct: pointer to a ADC_InitTypeDef structure
...
void ADC_Init( ADC_TypeDef * ADCx, ADC_InitTypeDef * ADC_InitStruct )
{
    ...
    tmpreg1 |= ( u32 ) ( ADC_InitStruct->ADC_Mode |
                         ( ( u32 ) ADC_InitStruct->ADC_ScanConvMode << 8 ) );
    /* Write to ADCx CR1 */
    ADCx->CR1 = tmpreg1;
    ...
    tmpreg1 |= ( u32 ) ( ADC_InitStruct->ADC_DataAlign |
                         ...
                         ( ( u32 ) ADC_InitStruct->ADC_ContinuousConvMode
                           << 1 ) );
    /* Write to ADCx CR2 */
    ADCx->CR2 = tmpreg1;
 ...
 * Input          : - ADCx: where x can be 1 or 2 to select the ADC peripheral.
 * Output         : None
 * Return         : The new state of ADC Reset Calibration registers (SET or
 *RESET).
 *******************************************************************************/
 ...
 *conversion. This parameter can be: ENABLE or DISABLE. Output         : None
 * Return         : None
 *******************************************************************************/
 ...
 * Input          : - ADCx: where x can be 1 or 2 to select the ADC peripheral.
 * Output         : None
 * Return         : The new state of ADC software start conversion (SET or
 *RESET).
 *******************************************************************************/
 ...
 * Description    : Configures the discontinuous mode for the selected ADC
 *regular group channel. Input          : - ADCx: where x can be 1 or 2 to
 ...
 * Description    : Configures for the selected ADC regular channel its
 *corresponding rank in the sequencer and its sample time. Input          : -
 *ADCx: where x can be 1 or 2 to select the ADC peripheral.
 ...
 *                    selected channel.
 *                    This parameter can be one of the following values:
 *                       - ADC_SampleTime_1Cycles5: Sample time equal to 1.5
 *cycles
 *                       - ADC_SampleTime_7Cycles5: Sample time equal to 7.5
 *cycles
 *                       - ADC_SampleTime_13Cycles5: Sample time equal to 13.5
 *cycles
 *                       - ADC_SampleTime_28Cycles5: Sample time equal to 28.5
 *cycles
 *                       - ADC_SampleTime_41Cycles5: Sample time equal to 41.5
 *cycles
 *                       - ADC_SampleTime_55Cycles5: Sample time equal to 55.5
 *cycles
 *                       - ADC_SampleTime_71Cycles5: Sample time equal to 71.5
 *cycles
 *                       - ADC_SampleTime_239Cycles5: Sample time equal to 239.5
 *cycles Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Enables or disables the ADCx conversion through external
 *trigger. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral.
 ...
 * Description    : Returns the last ADC conversion result data for regular
 *channel. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral. Output         : None Return         : The Data conversion value.
 *******************************************************************************/
 ...
 * Description    : Enables or disables the discontinuous mode for injected
 *group channel for the specified ADC Input          : - ADCx: where x can be 1
 *or 2 to select the ADC peripheral.
 *                  - NewState: new state of the selected ADC discontinuous mode
 ...
 * Description    : Configures the external trigger for injected channels
 *conversion. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral.
 ...
 * Description    : Enables or disables the start of the injected channels
 *conversion. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral.
 *                  - NewState: new state of the selected ADC software start
 *                    injected conversion.
 ...
 * Input          : - ADCx: where x can be 1 or 2 to select the ADC peripheral.
 * Output         : None
 * Return         : The new state of ADC software start injected conversion (SET
 *or RESET).
 *******************************************************************************/
 ...
 * Description    : Configures for the selected ADC injected channel its
 *corresponding rank in the sequencer and its sample time. Input          : -
 *ADCx: where x can be 1 or 2 to select the ADC peripheral.
 *                  - ADC_Channel: the ADC channel to configure.
 *                    This parameter can be one of the following values:
 ...
 *                       - ADC_Channel_16: ADC Channel16 selected
 *                       - ADC_Channel_17: ADC Channel17 selected
 *                  - Rank: The rank in the injected group sequencer. This
 *parameter must be between 1 to 4.
 *                  - ADC_SampleTime: The sample time value to be set for the
 *                    selected channel.
 *                    This parameter can be one of the following values:
 *                       - ADC_SampleTime_1Cycles5: Sample time equal to 1.5
                            ...
                            u16 Offset )
{
    ...
    *( ( u32 * ) ( ( *( u32 * ) &ADCx ) +
                   ADC_InjectedChannel ) ) = ( u32 ) Offset;
}
...
u16 ADC_GetInjectedConversionValue( ADC_TypeDef * ADCx, u8 ADC_InjectedChannel )
{
    ...
    return ( u16 ) ( *( u32 * ) ( ( ( *( u32 * ) &ADCx ) + ADC_InjectedChannel +
                                    JDR_Offset ) ) );
}

/*******************************************************************************
 * Function Name  : ADC_AnalogWatchdogCmd
 * Description    : Enables or disables the analog watchdog on single/all
 *regular or injected channels Input          : - ADCx: where x can be 1 or 2 to
 *select the ADC peripheral.
 *                  - ADC_AnalogWatchdog: the ADC analog watchdog configuration.
 *                    This parameter can be one of the following values:
 *                       - ADC_AnalogWatchdog_SingleRegEnable: Analog watchdog
 *on a single regular channel
 *                       - ADC_AnalogWatchdog_SingleInjecEnable: Analog watchdog
 *on a single injected channel
 ...
 *                       - ADC_AnalogWatchdog_AllRegAllInjecEnable: Analog
 *watchdog on all regular and injected channels
 ...
 * Description    : Configures the High and low thresholds of the analog
 *watchdog. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral.
 ...
 *                       - ADC_FLAG_JSTRT: Start of injected group conversion
 *flag
 ...
 * Description    : Checks whether the specified ADC interrupt has occurred or
 *not. Input          : - ADCx: where x can be 1 or 2 to select the ADC
 *peripheral.
 ...
 *                       - ADC_IT_AWD: Analog watchdog interrupt mask
 *                       - ADC_IT_JEOC: End of injected conversion interrupt
 *mask Output         : None Return         : The new state of ADC_IT (SET or
 *RESET).
 *******************************************************************************/
