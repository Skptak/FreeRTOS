 ...
 * Description    : Configures the value detected by the Power Voltage
 *Detector(PVD). Input          : - PWR_PVDLevel: specifies the PVD detection
 ...
 *                  - PWR_STOPEntry: specifies if STOP mode in entered with WFI
 *or WFE instruction. This parameter can be one of the following values:
