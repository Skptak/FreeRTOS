 ...
 *request. This parameter can be: ENABLE or DISABLE. Output         : None
 * Return         : None
 *******************************************************************************/
 ...
 * Description    : Returns the most recent received data by the SPIx
 *peripheral. Input          : - SPIx: where x can be 1 or 2 to select the SPI
 *peripheral. Output         : None Return         : The value of the received
 *data.
 *******************************************************************************/
 ...
 *selected SPI. Input          : - SPIx: where x can be 1 or 2 to select the SPI
 *peripheral.
 ...
 *SPI. Input          : - SPIx: where x can be 1 or 2 to select the SPI
 ...
 * Description    : Checks whether the specified SPI interrupt has occurred or
 *not. Input          : - SPIx: where x can be 1 or 2 to select the SPI
 *peripheral.
