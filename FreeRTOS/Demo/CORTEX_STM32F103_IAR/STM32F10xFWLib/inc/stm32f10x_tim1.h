...
typedef struct
{
    ...
    #define IS_TIM1_OC_MODE( MODE )                                           \
        ( ( MODE == TIM1_OCMode_Timing ) || ( MODE == TIM1_OCMode_Active ) || \
          ...
          ( MODE == TIM1_OCMode_Toggle ) || ( MODE == TIM1_OCMode_PWM1 ) ||   \
    ...
    #define IS_TIM1_CKD_DIV( DIV )                                \
        ( ( DIV == TIM1_CKD_DIV1 ) || ( DIV == TIM1_CKD_DIV2 ) || \
          ( DIV == TIM1_CKD_DIV4 ) )
    ...
    #define IS_TIM1_IT( IT ) \
        ( ( ( IT & ( u16 ) 0xFF00 ) == 0x0000 ) && ( IT != 0x0000 ) )
    ...
    #define IS_TIM1_DMA_BASE( BASE )                                          \
        ( ( BASE == TIM1_DMABase_CR1 ) || ( BASE == TIM1_DMABase_CR2 ) ||     \
          ( BASE == TIM1_DMABase_SMCR ) || ( BASE == TIM1_DMABase_DIER ) ||   \
          ( BASE == TIM1_DMABase_SR ) || ( BASE == TIM1_DMABase_EGR ) ||      \
          ( BASE == TIM1_DMABase_CCMR1 ) || ( BASE == TIM1_DMABase_CCMR2 ) || \
          ( BASE == TIM1_DMABase_CCER ) || ( BASE == TIM1_DMABase_CNT ) ||    \
          ( BASE == TIM1_DMABase_PSC ) || ( BASE == TIM1_DMABase_ARR ) ||     \
          ( BASE == TIM1_DMABase_RCR ) || ( BASE == TIM1_DMABase_CCR1 ) ||    \
          ( BASE == TIM1_DMABase_CCR2 ) || ( BASE == TIM1_DMABase_CCR3 ) ||   \
          ( BASE == TIM1_DMABase_CCR4 ) || ( BASE == TIM1_DMABase_BDTR ) ||   \
    ...
    #define IS_TIM1_TRIGGER_SELECTION( SELECTION )                          \
        ( ( SELECTION == TIM1_TS_ITR0 ) || ( SELECTION == TIM1_TS_ITR1 ) || \
          ( SELECTION == TIM1_TS_ITR2 ) || ( SELECTION == TIM1_TS_ITR3 ) || \
    ...
    #define IS_TIM1_EVENT_SOURCE( SOURCE ) \
        ( ( ( SOURCE & ( u16 ) 0xFF00 ) == 0x0000 ) && ( SOURCE != 0x0000 ) )
    ...
    #define IS_TIM1_OCFAST_STATE( STATE ) \
        ( ( STATE == TIM1_OCFast_Enable ) || ( STATE == TIM1_OCFast_Disable ) )
    ...
    #define IS_TIM1_CLEAR_FLAG( FLAG ) \
        ( ( ( FLAG & ( u16 ) 0xE100 ) == 0x0000 ) && ( FLAG != 0x0000 ) )
