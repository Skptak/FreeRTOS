...
/* Uncomment the line below according to the target STM32L device used in your
  ...
  */
        ...
        /* #define STM32L1XX_MD  */ /*!< STM32L1XX_MD: STM32L Ultra Low Power
                                       Medium-density devices */
        /* #define STM32L1XX_MDP */ /*!< STM32L1XX_MDP: STM32L Ultra Low Power
                                       Medium-density Plus devices */
        #define STM32L1XX_HD        /*!< STM32L1XX_HD: STM32L Ultra Low Power \
...
/*  Tip: To avoid modifying this file each time you need to switch between these
 ...
 - Ultra Low Power High-density devices are STM32L151xx, STM32L152xx and
  ...
  */
     ...
     * @brief In the following line adjust the value of External High Speed
     ...
     HSE, you can define the HSE value in your toolchain compiler preprocessor.
      */
    #if !defined( HSE_VALUE )
        #define HSE_VALUE                                                     \
            ( ( uint32_t ) 8000000 ) /*!< Value of the External oscillator in \
                                        Hz */
    #endif
     ...
     (HSI) Startup Timeout value
       */
        ...
        #define HSI_STARTUP_TIMEOUT \
            ( ( uint16_t ) 0x0500 ) /*!< Time out for HSI start up */
    #endif

    #if !defined( HSI_VALUE )
        #define HSI_VALUE                                                     \
            ( ( uint32_t ) 16000000 ) /*!< Value of the Internal High Speed   \
                                         oscillator in Hz. The real value may \
                                         vary depending on the variations in  \
                                         voltage and temperature.  */
    #endif

    #if !defined( LSI_VALUE )
        #define LSI_VALUE                                                      \
            ( ( uint32_t ) 37000 ) /*!< Value of the Internal Low Speed        \
                                      oscillator in Hz The real value may vary \
                                      depending on the variations in voltage   \
                                      and temperature.  */
    #endif

    #if !defined( LSE_VALUE )
        #define LSE_VALUE                                               \
            ( ( uint32_t ) 32768 ) /*!< Value of the External Low Speed \
                                      oscillator in Hz */
    #endif
     ...
     */
    #define __STM32L1XX_STDPERIPH_VERSION_MAIN \
        ( 0x01 ) /*!< [31:24] main version */
    #define __STM32L1XX_STDPERIPH_VERSION_SUB1 \
        ( 0x01 ) /*!< [23:16] sub1 version */
    #define __STM32L1XX_STDPERIPH_VERSION_SUB2 \
        ( 0x01 ) /*!< [15:8]  sub2 version */
    #define __STM32L1XX_STDPERIPH_VERSION_RC \
...
typedef enum IRQn
{
    ...
    TAMPER_STAMP_IRQn = 2, /*!< Tamper and Time Stamp through EXTI Line
                              Interrupts      */
...
typedef enum
{
    ...
    */
    ...
    /* TASKING Compiler
       ----------------
       RAM functions are defined using a specific toolchain pragma. This pragma
       is defined in the stm32l1xx_flash_ramfunc.c
    */
        #define __RAM_FUNC FLASH_Status
...
typedef struct
{
    __IO uint32_t CSR; /*!< COMP comparator control and status register, Address
                          offset: 0x00 */
} COMP_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t RTSR;  /*!< EXTI rising edge trigger selection register,
                            Address offset: 0x08 */
    __IO uint32_t FTSR;  /*!< EXTI Falling edge trigger selection register,
                            Address offset: 0x0C */
...
typedef struct
{
    ...
    __IO uint16_t OTYPER; /*!< GPIO port output type register, Address offset:
                             0x04      */
    ...
    __IO uint32_t PUPDR;   /*!< GPIO port pull-up/pull-down register,   Address
                              offset: 0x0C      */
    __IO uint16_t IDR; /*!< GPIO port input data register,               Address
                          offset: 0x10      */
    uint16_t RESERVED1; /*!< Reserved,                                    0x12
                         */
    __IO uint16_t ODR; /*!< GPIO port output data register,              Address
                          offset: 0x14      */
    uint16_t RESERVED2;  /*!< Reserved,                                    0x16
                          */
    __IO uint16_t BSRRL; /*!< GPIO port bit set/reset low registerBSRR, Address
                            offset: 0x18      */
    __IO uint16_t BSRRH; /*!< GPIO port bit set/reset high registerBSRR, Address
                            offset: 0x1A      */
    __IO uint32_t LCKR;  /*!< GPIO port configuration lock register,  Address
                            offset: 0x1C      */
    __IO uint32_t AFR[ 2 ]; /*!< GPIO alternate function low register, Address
                               offset: 0x20-0x24 */
    __IO uint16_t BRR; /*!< GPIO bit reset register,                     Address
                          offset: 0x28      */
...
typedef struct
{
    __IO uint16_t CR1; /*!< I2C Control register 1,                      Address
                          offset: 0x00 */
    uint16_t RESERVED0; /*!< Reserved,                                    0x02
                         */
    __IO uint16_t CR2; /*!< I2C Control register 2,                      Address
                          offset: 0x04 */
    uint16_t RESERVED1; /*!< Reserved,                                    0x06
                         */
    ...
    uint16_t RESERVED3; /*!< Reserved,                                    0x0E
                         */
    __IO uint16_t DR; /*!< I2C Data register,                           Address
                         offset: 0x10 */
    uint16_t RESERVED4; /*!< Reserved,                                    0x12
                         */
    __IO uint16_t SR1; /*!< I2C Status register 1,                       Address
                          offset: 0x14 */
    uint16_t RESERVED5; /*!< Reserved,                                    0x16
                         */
    __IO uint16_t SR2; /*!< I2C Status register 2,                       Address
                          offset: 0x18 */
    uint16_t RESERVED6; /*!< Reserved,                                    0x1A
                         */
    __IO uint16_t CCR; /*!< I2C Clock control register,                  Address
                          offset: 0x1C */
...
typedef struct
{
    __IO uint32_t CR;  /*!< LCD control register,              Address offset:
                          0x00 */
    __IO uint32_t FCR; /*!< LCD frame control register,        Address offset:
                          0x04 */
    __IO uint32_t SR;  /*!< LCD status register,               Address offset:
                          0x08 */
    __IO uint32_t CLR; /*!< LCD clear register,                Address offset:
                          0x0C */
    uint32_t RESERVED; /*!< Reserved,                          Address offset:
                          0x10 */
    __IO uint32_t RAM[ 16 ]; /*!< LCD display memory,           Address offset:
                                0x14-0x50 */
} LCD_TypeDef;
...
typedef struct
{
    __IO uint32_t ICR;    /*!< RI input capture register,             Address
                             offset: 0x00 */
    ...
    __IO uint32_t ASCR2;  /*!< RI analog switch control register 2,   Address
                             offset: 0x08 */
    __IO uint32_t HYSCR1; /*!< RI hysteresis control register,       Address
                             offset: 0x0C */
    __IO uint32_t HYSCR2; /*!< RI Hysteresis control register,       Address
                             offset: 0x10 */
    __IO uint32_t HYSCR3; /*!< RI Hysteresis control register,       Address
                             offset: 0x14 */
    __IO uint32_t HYSCR4; /*!< RI Hysteresis control register,       Address
                             offset: 0x18 */
} RI_TypeDef;
...
typedef struct
{
    __IO uint32_t POWER; /*!< SDIO power control register,    Address offset:
                            0x00 */
    __IO uint32_t CLKCR; /*!< SDI clock control register,     Address offset:
                            0x04 */
    __IO uint32_t ARG; /*!< SDIO argument register,         Address offset: 0x08
                        */
    __IO uint32_t CMD; /*!< SDIO command register,          Address offset: 0x0C
                        */
    __I uint32_t RESPCMD; /*!< SDIO command response register, Address offset:
                             0x10 */
    __I uint32_t RESP1;   /*!< SDIO response 1 register,       Address offset:
                             0x14 */
    __I uint32_t RESP2;   /*!< SDIO response 2 register,       Address offset:
                             0x18 */
    __I uint32_t RESP3;   /*!< SDIO response 3 register,       Address offset:
                             0x1C */
    __I uint32_t RESP4;   /*!< SDIO response 4 register,       Address offset:
                             0x20 */
    __IO uint32_t DTIMER; /*!< SDIO data timer register,       Address offset:
                             0x24 */
    __IO uint32_t DLEN;   /*!< SDIO data length register,      Address offset:
                             0x28 */
    __IO uint32_t DCTRL;  /*!< SDIO data control register,     Address offset:
                             0x2C */
    __I uint32_t DCOUNT;  /*!< SDIO data counter register,     Address offset:
                             0x30 */
    __I uint32_t STA;  /*!< SDIO status register,           Address offset: 0x34
                        */
    __IO uint32_t ICR; /*!< SDIO interrupt clear register,  Address offset: 0x38
                        */
    __IO uint32_t MASK; /*!< SDIO mask register,             Address offset:
                           0x3C */
    uint32_t RESERVED0[ 2 ]; /*!< Reserved, 0x40-0x44 */
    __I uint32_t FIFOCNT; /*!< SDIO FIFO counter register,     Address offset:
                             0x48 */
    uint32_t RESERVED1[ 13 ]; /*!< Reserved, 0x4C-0x7C */
    __IO uint32_t FIFO; /*!< SDIO data FIFO register,        Address offset:
                           0x80 */
} SDIO_TypeDef;
...
typedef struct
{
    __IO uint16_t CR1; /*!< TIM control register 1,              Address offset:
                          0x00 */
    uint16_t RESERVED0; /*!< Reserved, 0x02 */
    __IO uint16_t CR2; /*!< TIM control register 2,              Address offset:
                          0x04 */
    uint16_t RESERVED1; /*!< Reserved, 0x06 */
    ...
    __IO uint16_t DIER; /*!< TIM DMA/interrupt enable register,   Address
                           offset: 0x0C */
    uint16_t RESERVED3; /*!< Reserved, 0x0E */
    __IO uint16_t SR; /*!< TIM status register,                 Address offset:
                         0x10 */
    uint16_t RESERVED4; /*!< Reserved, 0x12 */
    __IO uint16_t EGR; /*!< TIM event generation register,       Address offset:
                          0x14 */
    uint16_t RESERVED5;  /*!< Reserved, 0x16  */
    ...
    __IO uint32_t CNT; /*!< TIM counter register,                Address offset:
                          0x24 */
    __IO uint16_t PSC; /*!< TIM prescaler,                       Address offset:
                          0x28 */
    ...
    __IO uint16_t DCR; /*!< TIM DMA control register,            Address offset:
                          0x48 */
    ...
    __IO uint16_t OR; /*!< TIM option register,                 Address offset:
                         0x50 */
 ...
 */
    ...
    #define FLASH_BASE                                                   \
        ( ( uint32_t ) 0x08000000 ) /*!< FLASH base address in the alias \
                                       region */
    #define SRAM_BASE                                                          \
        ( ( uint32_t ) 0x20000000 ) /*!< SRAM base address in the alias region \
                                     */
    #define PERIPH_BASE                                                       \
        ( ( uint32_t ) 0x40000000 ) /*!< Peripheral base address in the alias \
                                       region */

    #define SRAM_BB_BASE                                                   \
        ( ( uint32_t ) 0x22000000 ) /*!< SRAM base address in the bit-band \
                                       region */
    #define PERIPH_BB_BASE                                              \
        ( ( uint32_t ) 0x42000000 ) /*!< Peripheral base address in the \
                                       bit-band region */
    ...
    #define FLASH_R_BASE \
        ( AHBPERIPH_BASE + 0x3C00 ) /*!< FLASH registers base address */
    #define OB_BASE \
        ( ( uint32_t ) 0x1FF80000 ) /*!< FLASH Option Bytes base address */
 ...
 */
     ...
     * ********************/
    #define ADC_SR_AWD                                                       \
        ( ( uint32_t ) 0x00000001 )                /*!< Analog watchdog flag \
                                                    */
    ...
    #define ADC_SR_STRT \
        ( ( uint32_t ) 0x00000010 ) /*!< Regular channel Start flag */
    #define ADC_SR_OVR   ( ( uint32_t ) 0x00000020 ) /*!< Overrun flag */
    #define ADC_SR_ADONS ( ( uint32_t ) 0x00000040 ) /*!< ADC ON status */
    #define ADC_SR_RCNR \
        ( ( uint32_t ) 0x00000100 ) /*!< Regular channel not ready flag */
    #define ADC_SR_JCNR \
        ( ( uint32_t ) 0x00000200 ) /*!< Injected channel not ready flag */

    /*******************  Bit definition for ADC_CR1 register
     * ********************/
    #define ADC_CR1_AWDCH                                                 \
        ( ( uint32_t ) 0x0000001F ) /*!< AWDCH[4:0] bits (Analog watchdog \
                                       channel select bits) */
    ...
    #define ADC_CR1_JEOCIE                                             \
        ( ( uint32_t ) 0x00000080 ) /*!< Interrupt enable for injected \
                                       channels */
    #define ADC_CR1_SCAN ( ( uint32_t ) 0x00000100 ) /*!< Scan mode */
    #define ADC_CR1_AWDSGL                                               \
        ( ( uint32_t ) 0x00000200 ) /*!< Enable the watchdog on a single \
                                       channel in scan mode */
    #define ADC_CR1_JAUTO                                                    \
        ( ( uint32_t ) 0x00000400 ) /*!< Automatic injected group conversion \
                                     */
    #define ADC_CR1_DISCEN                                             \
        ( ( uint32_t ) 0x00000800 ) /*!< Discontinuous mode on regular \
                                       channels */
    #define ADC_CR1_JDISCEN                                             \
        ( ( uint32_t ) 0x00001000 ) /*!< Discontinuous mode on injected \
                                       channels */
    ...
    #define ADC_CR1_PDD \
        ( ( uint32_t ) 0x00010000 ) /*!< Power Down during Delay phase */
    #define ADC_CR1_PDI \
        ( ( uint32_t ) 0x00020000 ) /*!< Power Down during Idle phase */

    #define ADC_CR1_JAWDEN                                                  \
        ( ( uint32_t ) 0x00400000 ) /*!< Analog watchdog enable on injected \
                                       channels */
    #define ADC_CR1_AWDEN                                                  \
        ( ( uint32_t ) 0x00800000 ) /*!< Analog watchdog enable on regular \
                                       channels */

    #define ADC_CR1_RES \
        ( ( uint32_t ) 0x03000000 ) /*!< RES[1:0] bits (Resolution) */
    ...
    #define ADC_CR2_DELS \
        ( ( uint32_t ) 0x00000070 ) /*!< DELS[2:0] bits (Delay selection) */
    ...
    #define ADC_CR2_JEXTSEL                                                \
        ( ( uint32_t ) 0x000F0000 ) /*!< JEXTSEL[3:0] bits (External event \
    ...
    #define ADC_CR2_JEXTEN                                                    \
        ( ( uint32_t ) 0x00300000 ) /*!< JEXTEN[1:0] bits (External Trigger   \
                                       Conversion mode for injected channels) \
                                     */
    ...
    #define ADC_CR2_EXTSEL                                                \
        ( ( uint32_t ) 0x0F000000 ) /*!< EXTSEL[3:0] bits (External Event \
    ...
    #define ADC_CR2_EXTEN                                                    \
        ( ( uint32_t ) 0x30000000 ) /*!< EXTEN[1:0] bits (External Trigger   \
                                       Conversion mode for regular channels) \
                                     */
    ...
    #define ADC_SMPR1_SMP20                                                 \
        ( ( uint32_t ) 0x00000007 ) /*!< SMP20[2:0] bits (Channel 20 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP21                                                 \
        ( ( uint32_t ) 0x00000038 ) /*!< SMP21[2:0] bits (Channel 21 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP22                                                 \
        ( ( uint32_t ) 0x000001C0 ) /*!< SMP22[2:0] bits (Channel 22 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP23                                                 \
        ( ( uint32_t ) 0x00000E00 ) /*!< SMP23[2:0] bits (Channel 23 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP24                                                 \
        ( ( uint32_t ) 0x00007000 ) /*!< SMP24[2:0] bits (Channel 24 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP25                                                 \
        ( ( uint32_t ) 0x00038000 ) /*!< SMP25[2:0] bits (Channel 25 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP26                                                 \
        ( ( uint32_t ) 0x001C0000 ) /*!< SMP26[2:0] bits (Channel 26 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP27                                                 \
        ( ( uint32_t ) 0x00E00000 ) /*!< SMP27[2:0] bits (Channel 27 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP28                                                 \
        ( ( uint32_t ) 0x07000000 ) /*!< SMP28[2:0] bits (Channel 28 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR1_SMP29                                                 \
        ( ( uint32_t ) 0x38000000 ) /*!< SMP29[2:0] bits (Channel 29 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP10                                                 \
        ( ( uint32_t ) 0x00000007 ) /*!< SMP10[2:0] bits (Channel 10 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP11                                                 \
        ( ( uint32_t ) 0x00000038 ) /*!< SMP11[2:0] bits (Channel 11 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP12                                                 \
        ( ( uint32_t ) 0x000001C0 ) /*!< SMP12[2:0] bits (Channel 12 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP13                                                 \
        ( ( uint32_t ) 0x00000E00 ) /*!< SMP13[2:0] bits (Channel 13 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP14                                                 \
        ( ( uint32_t ) 0x00007000 ) /*!< SMP14[2:0] bits (Channel 14 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP15                                                \
        ( ( uint32_t ) 0x00038000 ) /*!< SMP15[2:0] bits (Channel 5 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP16                                                 \
        ( ( uint32_t ) 0x001C0000 ) /*!< SMP16[2:0] bits (Channel 16 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP17                                                 \
        ( ( uint32_t ) 0x00E00000 ) /*!< SMP17[2:0] bits (Channel 17 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP18                                                 \
        ( ( uint32_t ) 0x07000000 ) /*!< SMP18[2:0] bits (Channel 18 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR2_SMP19                                                 \
        ( ( uint32_t ) 0x38000000 ) /*!< SMP19[2:0] bits (Channel 19 Sample \
                                       time selection) */
    ...
    #define ADC_JOFR1_JOFFSET1 \
        ( ( uint32_t ) 0x00000FFF ) /*!< Data offset for injected channel 1 */

    /******************  Bit definition for ADC_JOFR2 register
     * *******************/
    #define ADC_JOFR2_JOFFSET2 \
        ( ( uint32_t ) 0x00000FFF ) /*!< Data offset for injected channel 2 */

    /******************  Bit definition for ADC_JOFR3 register
     * *******************/
    #define ADC_JOFR3_JOFFSET3 \
        ( ( uint32_t ) 0x00000FFF ) /*!< Data offset for injected channel 3 */

    /******************  Bit definition for ADC_JOFR4 register
     * *******************/
    #define ADC_JOFR4_JOFFSET4 \
        ( ( uint32_t ) 0x00000FFF ) /*!< Data offset for injected channel 4 */

    /*******************  Bit definition for ADC_HTR register
     * ********************/
    #define ADC_HTR_HT \
        ( ( uint32_t ) 0x00000FFF ) /*!< Analog watchdog high threshold */

    /*******************  Bit definition for ADC_LTR register
     * ********************/
    #define ADC_LTR_LT \
        ( ( uint32_t ) 0x00000FFF ) /*!< Analog watchdog low threshold */
    ...
    #define ADC_SQR1_SQ28                                                   \
        ( ( uint32_t ) 0x000F8000 ) /*!< SQ28[4:0] bits (25th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR1_SQ27                                                   \
        ( ( uint32_t ) 0x00007C00 ) /*!< SQ27[4:0] bits (27th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR1_SQ26                                                   \
        ( ( uint32_t ) 0x000003E0 ) /*!< SQ26[4:0] bits (26th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR1_SQ25                                                   \
        ( ( uint32_t ) 0x0000001F ) /*!< SQ25[4:0] bits (25th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ19                                                   \
        ( ( uint32_t ) 0x0000001F ) /*!< SQ19[4:0] bits (19th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ20                                                   \
        ( ( uint32_t ) 0x000003E0 ) /*!< SQ20[4:0] bits (20th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ21                                                   \
        ( ( uint32_t ) 0x00007C00 ) /*!< SQ21[4:0] bits (21th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ22                                                   \
        ( ( uint32_t ) 0x000F8000 ) /*!< SQ22[4:0] bits (22th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ23                                                   \
        ( ( uint32_t ) 0x01F00000 ) /*!< SQ23[4:0] bits (23th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR2_SQ24                                                   \
        ( ( uint32_t ) 0x3E000000 ) /*!< SQ24[4:0] bits (24th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ13                                                   \
        ( ( uint32_t ) 0x0000001F ) /*!< SQ13[4:0] bits (13th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ14                                                   \
        ( ( uint32_t ) 0x000003E0 ) /*!< SQ14[4:0] bits (14th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ15                                                   \
        ( ( uint32_t ) 0x00007C00 ) /*!< SQ15[4:0] bits (15th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ16                                                   \
        ( ( uint32_t ) 0x000F8000 ) /*!< SQ16[4:0] bits (16th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ17                                                   \
        ( ( uint32_t ) 0x01F00000 ) /*!< SQ17[4:0] bits (17th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR3_SQ18                                                   \
        ( ( uint32_t ) 0x3E000000 ) /*!< SQ18[4:0] bits (18th conversion in \
                                       regular sequence) */
     ...
     * *******************/
    #define ADC_SQR4_SQ7                                                  \
        ( ( uint32_t ) 0x0000001F ) /*!< SQ7[4:0] bits (7th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR4_SQ8                                                  \
        ( ( uint32_t ) 0x000003E0 ) /*!< SQ8[4:0] bits (8th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR4_SQ9                                                  \
        ( ( uint32_t ) 0x00007C00 ) /*!< SQ9[4:0] bits (9th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR4_SQ10                                                   \
        ( ( uint32_t ) 0x000F8000 ) /*!< SQ10[4:0] bits (10th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR4_SQ11                                                   \
        ( ( uint32_t ) 0x01F00000 ) /*!< SQ11[4:0] bits (11th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR4_SQ12                                                   \
        ( ( uint32_t ) 0x3E000000 ) /*!< SQ12[4:0] bits (12th conversion in \
                                       regular sequence) */
     ...
     * *******************/
    #define ADC_SQR5_SQ1                                                  \
        ( ( uint32_t ) 0x0000001F ) /*!< SQ1[4:0] bits (1st conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR5_SQ2                                                  \
        ( ( uint32_t ) 0x000003E0 ) /*!< SQ2[4:0] bits (2nd conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR5_SQ3                                                  \
        ( ( uint32_t ) 0x00007C00 ) /*!< SQ3[4:0] bits (3rd conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR5_SQ4                                                  \
        ( ( uint32_t ) 0x000F8000 ) /*!< SQ4[4:0] bits (4th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR5_SQ5                                                  \
        ( ( uint32_t ) 0x01F00000 ) /*!< SQ5[4:0] bits (5th conversion in \
                                       regular sequence) */
    ...
    #define ADC_SQR5_SQ6                                                  \
        ( ( uint32_t ) 0x3E000000 ) /*!< SQ6[4:0] bits (6th conversion in \
                                       regular sequence) */
    ...
    #define ADC_JSQR_JSQ1                                                  \
        ( ( uint32_t ) 0x0000001F ) /*!< JSQ1[4:0] bits (1st conversion in \
                                       injected sequence) */
    ...
    #define ADC_JSQR_JSQ2                                                  \
        ( ( uint32_t ) 0x000003E0 ) /*!< JSQ2[4:0] bits (2nd conversion in \
                                       injected sequence) */
    ...
    #define ADC_JSQR_JSQ3                                                  \
        ( ( uint32_t ) 0x00007C00 ) /*!< JSQ3[4:0] bits (3rd conversion in \
                                       injected sequence) */
    ...
    #define ADC_JSQR_JSQ4                                                  \
        ( ( uint32_t ) 0x000F8000 ) /*!< JSQ4[4:0] bits (4th conversion in \
                                       injected sequence) */
    ...
    #define ADC_JSQR_JL                                                  \
        ( ( uint32_t ) 0x00300000 ) /*!< JL[1:0] bits (Injected Sequence \
                                       length) */
    ...
    #define ADC_SMPR3_SMP30                                                 \
        ( ( uint32_t ) 0x00000007 ) /*!< SMP30[2:0] bits (Channel 30 Sample \
                                       time selection) */
    ...
    #define ADC_SMPR3_SMP31                                                 \
        ( ( uint32_t ) 0x00000038 ) /*!< SMP31[2:0] bits (Channel 31 Sample \
                                       time selection) */
    ...
    #define ADC_CSR_JEOC1                                             \
        ( ( uint32_t ) 0x00000004 ) /*!< ADC1 Injected channel end of \
                                       conversion */
    ...
    #define ADC_CSR_OVR1                                    \
        ( ( uint32_t ) 0x00000020 ) /*!< ADC1 overrun  flag \
                                     */
    #define ADC_CSR_ADONS1 \
        ( ( uint32_t ) 0x00000040 ) /*!< ADON status of ADC1 */
    ...
    #define AES_CR_CCFC \
        ( ( uint32_t ) 0x00000080 ) /*!< Computation Complete Flag Clear */
    #define AES_CR_ERRC ( ( uint32_t ) 0x00000100 ) /*!< Error Clear */
    #define AES_CR_CCIE                                                        \
        ( ( uint32_t ) 0x00000200 ) /*!< Computation Complete Interrupt Enable \
                                     */
    #define AES_CR_ERRIE \
        ( ( uint32_t ) 0x00000400 ) /*!< Error Interrupt Enable */
    #define AES_CR_DMAINEN                                                  \
        ( ( uint32_t ) 0x00000800 ) /*!< DMA ENable managing the data input \
                                       phase */
    #define AES_CR_DMAOUTEN                                                  \
        ( ( uint32_t ) 0x00001000 ) /*!< DMA Enable managing the data output \
                                       phase */

    /*******************  Bit definition for AES_SR register
     * *********************/
    #define AES_SR_CCF \
        ( ( uint32_t ) 0x00000001 ) /*!< Computation Complete Flag */
     ...
     * *******************/
    #define AES_DINR                                             \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Data Input Register \
                                     */

    /*******************  Bit definition for AES_DOUTR register
     * ******************/
    #define AES_DOUTR \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Data Output Register */
     ...
     * *******************/
    #define AES_IVR0                                                          \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Initialization Vector Register 0 \
                                     */

    /*******************  Bit definition for AES_IVR1 register
     * *******************/
    #define AES_IVR1                                                          \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Initialization Vector Register 1 \
                                     */

    /*******************  Bit definition for AES_IVR2 register
     * *******************/
    #define AES_IVR2                                                          \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Initialization Vector Register 2 \
                                     */

    /*******************  Bit definition for AES_IVR3 register
     * *******************/
    #define AES_IVR3                                                          \
        ( ( uint32_t ) 0x0000FFFF ) /*!< AES Initialization Vector Register 3 \
                                     */
    ...
    #define COMP_CSR_10KPU \
        ( ( uint32_t ) 0x00000001 ) /*!< 10K pull-up resistor */
    #define COMP_CSR_400KPU \
        ( ( uint32_t ) 0x00000002 ) /*!< 400K pull-up resistor */
    #define COMP_CSR_10KPD \
        ( ( uint32_t ) 0x00000004 ) /*!< 10K pull-down resistor */
    #define COMP_CSR_400KPD \
        ( ( uint32_t ) 0x00000008 ) /*!< 400K pull-down resistor */

    #define COMP_CSR_CMP1EN \
        ( ( uint32_t ) 0x00000010 ) /*!< Comparator 1 enable */
    #define COMP_CSR_SW1 \
        ( ( uint32_t ) 0x00000020 ) /*!< SW1 analog switch enable */
    #define COMP_CSR_CMP1OUT \
        ( ( uint32_t ) 0x00000080 ) /*!< Comparator 1 output */

    #define COMP_CSR_SPEED \
        ( ( uint32_t ) 0x00001000 ) /*!< Comparator 2 speed */
    #define COMP_CSR_CMP2OUT \
        ( ( uint32_t ) 0x00002000 ) /*!< Comparator 2 ouput */

    #define COMP_CSR_VREFOUTEN \
        ( ( uint32_t ) 0x00010000 ) /*!< Comparator Vref Enable */
    #define COMP_CSR_WNDWE \
        ( ( uint32_t ) 0x00020000 ) /*!< Window mode enable */

    #define COMP_CSR_INSEL                                                    \
        ( ( uint32_t ) 0x001C0000 ) /*!< INSEL[2:0] Inversion input Selection \
                                     */
    ...
    #define COMP_CSR_OUTSEL                                              \
        ( ( uint32_t ) 0x00E00000 ) /*!< OUTSEL[2:0] comparator 2 output \
                                       redirection */
    ...
    #define OPAMP_CSR_OPA1PD                            \
        ( ( uint32_t ) 0x00000001 ) /*!< OPAMP1 disable \
                                     */
    #define OPAMP_CSR_S3SEL1 \
        ( ( uint32_t ) 0x00000002 ) /*!< Switch 3 for OPAMP1 Enable */
    #define OPAMP_CSR_S4SEL1 \
        ( ( uint32_t ) 0x00000004 ) /*!< Switch 4 for OPAMP1 Enable */
    #define OPAMP_CSR_S5SEL1 \
        ( ( uint32_t ) 0x00000008 ) /*!< Switch 5 for OPAMP1 Enable */
    #define OPAMP_CSR_S6SEL1 \
        ( ( uint32_t ) 0x00000010 ) /*!< Switch 6 for OPAMP1 Enable */
    #define OPAMP_CSR_OPA1CAL_L                                          \
        ( ( uint32_t ) 0x00000020 ) /*!< OPAMP1 Offset calibration for P \
                                       differential pair */
    #define OPAMP_CSR_OPA1CAL_H                                          \
        ( ( uint32_t ) 0x00000040 ) /*!< OPAMP1 Offset calibration for N \
                                       differential pair */
    #define OPAMP_CSR_OPA1LPM \
        ( ( uint32_t ) 0x00000080 ) /*!< OPAMP1 Low power enable */
    #define OPAMP_CSR_OPA2PD                            \
        ( ( uint32_t ) 0x00000100 ) /*!< OPAMP2 disable \
                                     */
    #define OPAMP_CSR_S3SEL2 \
        ( ( uint32_t ) 0x00000200 ) /*!< Switch 3 for OPAMP2 Enable */
    #define OPAMP_CSR_S4SEL2 \
        ( ( uint32_t ) 0x00000400 ) /*!< Switch 4 for OPAMP2 Enable */
    #define OPAMP_CSR_S5SEL2 \
        ( ( uint32_t ) 0x00000800 ) /*!< Switch 5 for OPAMP2 Enable */
    #define OPAMP_CSR_S6SEL2 \
        ( ( uint32_t ) 0x00001000 ) /*!< Switch 6 for OPAMP2 Enable */
    #define OPAMP_CSR_OPA2CAL_L                                          \
        ( ( uint32_t ) 0x00002000 ) /*!< OPAMP2 Offset calibration for P \
                                       differential pair */
    #define OPAMP_CSR_OPA2CAL_H                                          \
        ( ( uint32_t ) 0x00004000 ) /*!< OPAMP2 Offset calibration for N \
                                       differential pair */
    #define OPAMP_CSR_OPA2LPM \
        ( ( uint32_t ) 0x00008000 ) /*!< OPAMP2 Low power enable */
    #define OPAMP_CSR_OPA3PD                            \
        ( ( uint32_t ) 0x00010000 ) /*!< OPAMP3 disable \
                                     */
    #define OPAMP_CSR_S3SEL3 \
        ( ( uint32_t ) 0x00020000 ) /*!< Switch 3 for OPAMP3 Enable */
    #define OPAMP_CSR_S4SEL3 \
        ( ( uint32_t ) 0x00040000 ) /*!< Switch 4 for OPAMP3 Enable */
    #define OPAMP_CSR_S5SEL3 \
        ( ( uint32_t ) 0x00080000 ) /*!< Switch 5 for OPAMP3 Enable */
    #define OPAMP_CSR_S6SEL3 \
        ( ( uint32_t ) 0x00100000 ) /*!< Switch 6 for OPAMP3 Enable */
    #define OPAMP_CSR_OPA3CAL_L                                          \
        ( ( uint32_t ) 0x00200000 ) /*!< OPAMP3 Offset calibration for P \
                                       differential pair */
    #define OPAMP_CSR_OPA3CAL_H                                          \
        ( ( uint32_t ) 0x00400000 ) /*!< OPAMP3 Offset calibration for N \
                                       differential pair */
    #define OPAMP_CSR_OPA3LPM \
        ( ( uint32_t ) 0x00800000 ) /*!< OPAMP3 Low power enable */
    #define OPAMP_CSR_ANAWSEL1 \
        ( ( uint32_t ) 0x01000000 ) /*!< Switch ANA Enable for OPAMP1 */
    #define OPAMP_CSR_ANAWSEL2 \
        ( ( uint32_t ) 0x02000000 ) /*!< Switch ANA Enable for OPAMP2 */
    #define OPAMP_CSR_ANAWSEL3 \
        ( ( uint32_t ) 0x04000000 ) /*!< Switch ANA Enable for OPAMP3 */
    #define OPAMP_CSR_S7SEL2 \
        ( ( uint32_t ) 0x08000000 ) /*!< Switch 7 for OPAMP2 Enable */
    #define OPAMP_CSR_AOP_RANGE \
        ( ( uint32_t ) 0x10000000 ) /*!< Power range selection */
    #define OPAMP_CSR_OPA1CALOUT \
        ( ( uint32_t ) 0x20000000 ) /*!< OPAMP1 calibration output */
    #define OPAMP_CSR_OPA2CALOUT \
        ( ( uint32_t ) 0x40000000 ) /*!< OPAMP2 calibration output */
    #define OPAMP_CSR_OPA3CALOUT \
        ( ( uint32_t ) 0x80000000 ) /*!< OPAMP3 calibration output */

    /*******************  Bit definition for OPAMP_OTR register
     * ******************/
    #define OPAMP_OTR_AO1_OPT_OFFSET_TRIM \
        ( ( uint32_t ) 0x000003FF ) /*!< Offset trim for OPAMP1 */
    #define OPAMP_OTR_AO2_OPT_OFFSET_TRIM \
        ( ( uint32_t ) 0x000FFC00 ) /*!< Offset trim for OPAMP2 */
    #define OPAMP_OTR_AO3_OPT_OFFSET_TRIM \
        ( ( uint32_t ) 0x3FF00000 ) /*!< Offset trim for OPAMP2 */
    #define OPAMP_OTR_OT_USER                                                \
        ( ( uint32_t ) 0x80000000 ) /*!< Switch to OPAMP offset user trimmed \
                                       values */

    /*******************  Bit definition for OPAMP_LPOTR register
     * ****************/
    #define OPAMP_LP_OTR_AO1_OPT_OFFSET_TRIM_LP                              \
        ( ( uint32_t ) 0x000003FF ) /*!< Offset trim in low power for OPAMP1 \
                                     */
    #define OPAMP_LP_OTR_AO2_OPT_OFFSET_TRIM_LP                              \
        ( ( uint32_t ) 0x000FFC00 ) /*!< Offset trim in low power for OPAMP2 \
                                     */
    #define OPAMP_LP_OTR_AO3_OPT_OFFSET_TRIM_LP                              \
        ( ( uint32_t ) 0x3FF00000 ) /*!< Offset trim in low power for OPAMP3 \
                                     */
    ...
    #define DAC_CR_TSEL1                                                 \
        ( ( uint32_t ) 0x00000038 ) /*!<TSEL1[2:0] (DAC channel1 Trigger \
                                       selection) */
    ...
    #define DAC_CR_WAVE1                                                      \
        ( ( uint32_t ) 0x000000C0 ) /*!<WAVE1[1:0] (DAC channel1              \
    ...
    #define DAC_CR_MAMP1                                         \
        ( ( uint32_t ) 0x00000F00 ) /*!<MAMP1[3:0] (DAC channel1 \
    ...
    #define DAC_CR_DMAUDRIE1                                                \
        ( ( uint32_t ) 0x00002000 ) /*!<DAC channel1 DMA underrun interrupt \
                                       enable */
    ...
    #define DAC_CR_TSEL2                                                 \
        ( ( uint32_t ) 0x00380000 ) /*!<TSEL2[2:0] (DAC channel2 Trigger \
                                       selection) */
    ...
    #define DAC_CR_WAVE2                                                      \
        ( ( uint32_t ) 0x00C00000 ) /*!<WAVE2[1:0] (DAC channel2              \
                                       noise/triangle wave generation enable) \
                                     */
    ...
    #define DAC_CR_MAMP2                                         \
        ( ( uint32_t ) 0x0F000000 ) /*!<MAMP2[3:0] (DAC channel2 \
                                       Mask/Amplitude selector) */
    ...
    #define DAC_CR_DMAUDRIE2                                                \
        ( ( uint32_t ) 0x20000000 ) /*!<DAC channel2 DMA underrun interrupt \
                                       enable */
    ...
    #define DBGMCU_IDCODE_DEV_ID \
        ( ( uint32_t ) 0x00000FFF ) /*!< Device Identifier */

    #define DBGMCU_IDCODE_REV_ID                                     \
        ( ( uint32_t ) 0xFFFF0000 ) /*!< REV_ID[15:0] bits (Revision \
                                       Identifier) */
    ...
    #define DBGMCU_CR_DBG_SLEEP \
        ( ( uint32_t ) 0x00000001 ) /*!< Debug Sleep Mode */
    #define DBGMCU_CR_DBG_STOP \
        ( ( uint32_t ) 0x00000002 ) /*!< Debug Stop Mode */
    ...
    #define DBGMCU_CR_TRACE_MODE                                         \
        ( ( uint32_t ) 0x000000C0 ) /*!< TRACE_MODE[1:0] bits (Trace Pin \
                                       Assignment Control) */
...
/******************  Bit definition for DBGMCU_APB1_FZ register  **************/
    ...
    #define DBGMCU_APB1_FZ_DBG_TIM2_STOP                                   \
        ( ( uint32_t ) 0x00000001 ) /*!< TIM2 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_TIM3_STOP                                   \
        ( ( uint32_t ) 0x00000002 ) /*!< TIM3 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_TIM4_STOP                                   \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM4 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_TIM5_STOP                                   \
        ( ( uint32_t ) 0x00000008 ) /*!< TIM5 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_TIM6_STOP                                   \
        ( ( uint32_t ) 0x00000010 ) /*!< TIM6 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_TIM7_STOP                                   \
        ( ( uint32_t ) 0x00000020 ) /*!< TIM7 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_RTC_STOP                                   \
        ( ( uint32_t ) 0x00000400 ) /*!< RTC Counter stopped when Core is \
                                       halted */
    #define DBGMCU_APB1_FZ_DBG_WWDG_STOP                                    \
        ( ( uint32_t ) 0x00000800 ) /*!< Debug Window Watchdog stopped when \
                                       Core is halted */
    #define DBGMCU_APB1_FZ_DBG_IWDG_STOP                                    \
        ( ( uint32_t ) 0x00001000 ) /*!< Debug Independent Watchdog stopped \
                                       when Core is halted */
    #define DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT                             \
        ( ( uint32_t ) 0x00200000 ) /*!< SMBUS timeout mode stopped when Core \
                                       is halted */
    #define DBGMCU_APB1_FZ_DBG_I2C2_SMBUS_TIMEOUT                             \
        ( ( uint32_t ) 0x00400000 ) /*!< SMBUS timeout mode stopped when Core \
                                       is halted */

/******************  Bit definition for DBGMCU_APB2_FZ register  **************/

    #define DBGMCU_APB2_FZ_DBG_TIM9_STOP                                   \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM9 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB2_FZ_DBG_TIM10_STOP                                   \
        ( ( uint32_t ) 0x00000008 ) /*!< TIM10 counter stopped when core is \
                                       halted */
    #define DBGMCU_APB2_FZ_DBG_TIM11_STOP                                   \
        ( ( uint32_t ) 0x00000010 ) /*!< TIM11 counter stopped when core is \
                                       halted */
    ...
    #define DMA_CCR1_DIR                                                       \
        ( ( uint16_t ) 0x0010 )                   /*!< Data transfer direction \
                                                   */
    ...
    #define DMA_CCR1_MEM2MEM \
        ( ( uint16_t ) 0x4000 ) /*!< Memory to memory mode */
    ...
    #define DMA_CNDTR1_NDT \
        ( ( uint16_t ) 0xFFFF ) /*!< Number of data to Transfer */
     ...
     * *******************/
    #define DMA_CPAR1_PA                                    \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Peripheral Address \
                                     */
     ...
     * *******************/
    #define EXTI_EMR_MR0 \
        ( ( uint32_t ) 0x00000001 ) /*!< Event Mask on line 0 */
    #define EXTI_EMR_MR1 \
        ( ( uint32_t ) 0x00000002 ) /*!< Event Mask on line 1 */
    #define EXTI_EMR_MR2 \
        ( ( uint32_t ) 0x00000004 ) /*!< Event Mask on line 2 */
    #define EXTI_EMR_MR3 \
        ( ( uint32_t ) 0x00000008 ) /*!< Event Mask on line 3 */
    #define EXTI_EMR_MR4 \
        ( ( uint32_t ) 0x00000010 ) /*!< Event Mask on line 4 */
    #define EXTI_EMR_MR5 \
        ( ( uint32_t ) 0x00000020 ) /*!< Event Mask on line 5 */
    #define EXTI_EMR_MR6 \
        ( ( uint32_t ) 0x00000040 ) /*!< Event Mask on line 6 */
    #define EXTI_EMR_MR7 \
        ( ( uint32_t ) 0x00000080 ) /*!< Event Mask on line 7 */
    #define EXTI_EMR_MR8 \
        ( ( uint32_t ) 0x00000100 ) /*!< Event Mask on line 8 */
    #define EXTI_EMR_MR9 \
        ( ( uint32_t ) 0x00000200 ) /*!< Event Mask on line 9 */
    #define EXTI_EMR_MR10 \
        ( ( uint32_t ) 0x00000400 ) /*!< Event Mask on line 10 */
    #define EXTI_EMR_MR11 \
        ( ( uint32_t ) 0x00000800 ) /*!< Event Mask on line 11 */
    #define EXTI_EMR_MR12 \
        ( ( uint32_t ) 0x00001000 ) /*!< Event Mask on line 12 */
    #define EXTI_EMR_MR13 \
        ( ( uint32_t ) 0x00002000 ) /*!< Event Mask on line 13 */
    #define EXTI_EMR_MR14 \
        ( ( uint32_t ) 0x00004000 ) /*!< Event Mask on line 14 */
    #define EXTI_EMR_MR15 \
        ( ( uint32_t ) 0x00008000 ) /*!< Event Mask on line 15 */
    #define EXTI_EMR_MR16 \
        ( ( uint32_t ) 0x00010000 ) /*!< Event Mask on line 16 */
    #define EXTI_EMR_MR17 \
        ( ( uint32_t ) 0x00020000 ) /*!< Event Mask on line 17 */
    #define EXTI_EMR_MR18 \
        ( ( uint32_t ) 0x00040000 ) /*!< Event Mask on line 18 */
    #define EXTI_EMR_MR19 \
        ( ( uint32_t ) 0x00080000 ) /*!< Event Mask on line 19 */
    #define EXTI_EMR_MR20 \
        ( ( uint32_t ) 0x00100000 ) /*!< Event Mask on line 20 */
    #define EXTI_EMR_MR21 \
        ( ( uint32_t ) 0x00200000 ) /*!< Event Mask on line 21 */
    #define EXTI_EMR_MR22 \
        ( ( uint32_t ) 0x00400000 ) /*!< Event Mask on line 22 */
    #define EXTI_EMR_MR23 \
        ( ( uint32_t ) 0x00800000 ) /*!< Event Mask on line 23 */

    /******************  Bit definition for EXTI_RTSR register
     * *******************/
    #define EXTI_RTSR_TR0                                                   \
        ( ( uint32_t ) 0x00000001 ) /*!< Rising trigger event configuration \
                                       bit of line 0 */
    #define EXTI_RTSR_TR1                                                   \
        ( ( uint32_t ) 0x00000002 ) /*!< Rising trigger event configuration \
                                       bit of line 1 */
    #define EXTI_RTSR_TR2                                                   \
        ( ( uint32_t ) 0x00000004 ) /*!< Rising trigger event configuration \
                                       bit of line 2 */
    #define EXTI_RTSR_TR3                                                   \
        ( ( uint32_t ) 0x00000008 ) /*!< Rising trigger event configuration \
                                       bit of line 3 */
    #define EXTI_RTSR_TR4                                                   \
        ( ( uint32_t ) 0x00000010 ) /*!< Rising trigger event configuration \
                                       bit of line 4 */
    #define EXTI_RTSR_TR5                                                   \
        ( ( uint32_t ) 0x00000020 ) /*!< Rising trigger event configuration \
                                       bit of line 5 */
    #define EXTI_RTSR_TR6                                                   \
        ( ( uint32_t ) 0x00000040 ) /*!< Rising trigger event configuration \
                                       bit of line 6 */
    #define EXTI_RTSR_TR7                                                   \
        ( ( uint32_t ) 0x00000080 ) /*!< Rising trigger event configuration \
                                       bit of line 7 */
    #define EXTI_RTSR_TR8                                                   \
        ( ( uint32_t ) 0x00000100 ) /*!< Rising trigger event configuration \
                                       bit of line 8 */
    #define EXTI_RTSR_TR9                                                   \
        ( ( uint32_t ) 0x00000200 ) /*!< Rising trigger event configuration \
                                       bit of line 9 */
    #define EXTI_RTSR_TR10                                                  \
        ( ( uint32_t ) 0x00000400 ) /*!< Rising trigger event configuration \
                                       bit of line 10 */
    #define EXTI_RTSR_TR11                                                  \
        ( ( uint32_t ) 0x00000800 ) /*!< Rising trigger event configuration \
                                       bit of line 11 */
    #define EXTI_RTSR_TR12                                                  \
        ( ( uint32_t ) 0x00001000 ) /*!< Rising trigger event configuration \
                                       bit of line 12 */
    #define EXTI_RTSR_TR13                                                  \
        ( ( uint32_t ) 0x00002000 ) /*!< Rising trigger event configuration \
                                       bit of line 13 */
    #define EXTI_RTSR_TR14                                                  \
        ( ( uint32_t ) 0x00004000 ) /*!< Rising trigger event configuration \
                                       bit of line 14 */
    #define EXTI_RTSR_TR15                                                  \
        ( ( uint32_t ) 0x00008000 ) /*!< Rising trigger event configuration \
                                       bit of line 15 */
    #define EXTI_RTSR_TR16                                                  \
        ( ( uint32_t ) 0x00010000 ) /*!< Rising trigger event configuration \
                                       bit of line 16 */
    #define EXTI_RTSR_TR17                                                  \
        ( ( uint32_t ) 0x00020000 ) /*!< Rising trigger event configuration \
                                       bit of line 17 */
    #define EXTI_RTSR_TR18                                                  \
        ( ( uint32_t ) 0x00040000 ) /*!< Rising trigger event configuration \
                                       bit of line 18 */
    #define EXTI_RTSR_TR19                                                  \
        ( ( uint32_t ) 0x00080000 ) /*!< Rising trigger event configuration \
                                       bit of line 19 */
    #define EXTI_RTSR_TR20                                                  \
        ( ( uint32_t ) 0x00100000 ) /*!< Rising trigger event configuration \
                                       bit of line 20 */
    #define EXTI_RTSR_TR21                                                  \
        ( ( uint32_t ) 0x00200000 ) /*!< Rising trigger event configuration \
                                       bit of line 21 */
    #define EXTI_RTSR_TR22                                                  \
        ( ( uint32_t ) 0x00400000 ) /*!< Rising trigger event configuration \
                                       bit of line 22 */
    #define EXTI_RTSR_TR23                                                  \
        ( ( uint32_t ) 0x00800000 ) /*!< Rising trigger event configuration \
                                       bit of line 23 */

    /******************  Bit definition for EXTI_FTSR register
     * *******************/
    #define EXTI_FTSR_TR0                                                    \
        ( ( uint32_t ) 0x00000001 ) /*!< Falling trigger event configuration \
                                       bit of line 0 */
    #define EXTI_FTSR_TR1                                                    \
        ( ( uint32_t ) 0x00000002 ) /*!< Falling trigger event configuration \
                                       bit of line 1 */
    #define EXTI_FTSR_TR2                                                    \
        ( ( uint32_t ) 0x00000004 ) /*!< Falling trigger event configuration \
                                       bit of line 2 */
    #define EXTI_FTSR_TR3                                                    \
        ( ( uint32_t ) 0x00000008 ) /*!< Falling trigger event configuration \
                                       bit of line 3 */
    #define EXTI_FTSR_TR4                                                    \
        ( ( uint32_t ) 0x00000010 ) /*!< Falling trigger event configuration \
                                       bit of line 4 */
    #define EXTI_FTSR_TR5                                                    \
        ( ( uint32_t ) 0x00000020 ) /*!< Falling trigger event configuration \
                                       bit of line 5 */
    #define EXTI_FTSR_TR6                                                    \
        ( ( uint32_t ) 0x00000040 ) /*!< Falling trigger event configuration \
                                       bit of line 6 */
    #define EXTI_FTSR_TR7                                                    \
        ( ( uint32_t ) 0x00000080 ) /*!< Falling trigger event configuration \
                                       bit of line 7 */
    #define EXTI_FTSR_TR8                                                    \
        ( ( uint32_t ) 0x00000100 ) /*!< Falling trigger event configuration \
                                       bit of line 8 */
    #define EXTI_FTSR_TR9                                                    \
        ( ( uint32_t ) 0x00000200 ) /*!< Falling trigger event configuration \
                                       bit of line 9 */
    #define EXTI_FTSR_TR10                                                   \
        ( ( uint32_t ) 0x00000400 ) /*!< Falling trigger event configuration \
                                       bit of line 10 */
    #define EXTI_FTSR_TR11                                                   \
        ( ( uint32_t ) 0x00000800 ) /*!< Falling trigger event configuration \
                                       bit of line 11 */
    #define EXTI_FTSR_TR12                                                   \
        ( ( uint32_t ) 0x00001000 ) /*!< Falling trigger event configuration \
                                       bit of line 12 */
    #define EXTI_FTSR_TR13                                                   \
        ( ( uint32_t ) 0x00002000 ) /*!< Falling trigger event configuration \
                                       bit of line 13 */
    #define EXTI_FTSR_TR14                                                   \
        ( ( uint32_t ) 0x00004000 ) /*!< Falling trigger event configuration \
                                       bit of line 14 */
    #define EXTI_FTSR_TR15                                                   \
        ( ( uint32_t ) 0x00008000 ) /*!< Falling trigger event configuration \
                                       bit of line 15 */
    #define EXTI_FTSR_TR16                                                   \
        ( ( uint32_t ) 0x00010000 ) /*!< Falling trigger event configuration \
                                       bit of line 16 */
    #define EXTI_FTSR_TR17                                                   \
        ( ( uint32_t ) 0x00020000 ) /*!< Falling trigger event configuration \
                                       bit of line 17 */
    #define EXTI_FTSR_TR18                                                   \
        ( ( uint32_t ) 0x00040000 ) /*!< Falling trigger event configuration \
                                       bit of line 18 */
    #define EXTI_FTSR_TR19                                                   \
        ( ( uint32_t ) 0x00080000 ) /*!< Falling trigger event configuration \
                                       bit of line 19 */
    #define EXTI_FTSR_TR20                                                   \
        ( ( uint32_t ) 0x00100000 ) /*!< Falling trigger event configuration \
                                       bit of line 20 */
    #define EXTI_FTSR_TR21                                                   \
        ( ( uint32_t ) 0x00200000 ) /*!< Falling trigger event configuration \
                                       bit of line 21 */
    #define EXTI_FTSR_TR22                                                   \
        ( ( uint32_t ) 0x00400000 ) /*!< Falling trigger event configuration \
                                       bit of line 22 */
    #define EXTI_FTSR_TR23                                                   \
        ( ( uint32_t ) 0x00800000 ) /*!< Falling trigger event configuration \
                                       bit of line 23 */
    ...
    #define FLASH_ACR_PRFTEN \
        ( ( uint32_t ) 0x00000002 ) /*!< Prefetch Buffer Enable */
    #define FLASH_ACR_ACC64 ( ( uint32_t ) 0x00000004 ) /*!< Access 64 bits */
    #define FLASH_ACR_SLEEP_PD \
        ( ( uint32_t ) 0x00000008 ) /*!< Flash mode during sleep mode */
    #define FLASH_ACR_RUN_PD \
        ( ( uint32_t ) 0x00000010 ) /*!< Flash mode during RUN mode */

    /*******************  Bit definition for FLASH_PECR register
     * ******************/
    #define FLASH_PECR_PELOCK \
        ( ( uint32_t ) 0x00000001 ) /*!< FLASH_PECR and Flash data Lock */
    #define FLASH_PECR_PRGLOCK \
        ( ( uint32_t ) 0x00000002 ) /*!< Program matrix Lock */
    #define FLASH_PECR_OPTLOCK \
        ( ( uint32_t ) 0x00000004 ) /*!< Option byte matrix Lock */
    #define FLASH_PECR_PROG \
        ( ( uint32_t ) 0x00000008 ) /*!< Program matrix selection */
    #define FLASH_PECR_DATA \
        ( ( uint32_t ) 0x00000010 ) /*!< Data matrix selection */
    #define FLASH_PECR_FTDW                                                  \
        ( ( uint32_t ) 0x00000100 ) /*!< Fixed Time Data write for Word/Half \
                                       Word/Byte programming */
    #define FLASH_PECR_ERASE \
        ( ( uint32_t ) 0x00000200 ) /*!< Page erasing mode */
    #define FLASH_PECR_FPRG                                                   \
        ( ( uint32_t ) 0x00000400 ) /*!< Fast Page/Half Page programming mode \
                                     */
    #define FLASH_PECR_PARALLBANK \
        ( ( uint32_t ) 0x00008000 ) /*!< Parallel Bank mode */
    #define FLASH_PECR_EOPIE \
        ( ( uint32_t ) 0x00010000 ) /*!< End of programming interrupt */
    #define FLASH_PECR_ERRIE                             \
        ( ( uint32_t ) 0x00020000 ) /*!< Error interrupt \
                                     */
    #define FLASH_PECR_OBL_LAUNCH \
        ( ( uint32_t ) 0x00040000 ) /*!< Launch the option byte loading */

    /******************  Bit definition for FLASH_PDKEYR register
     * ******************/
    #define FLASH_PDKEYR_PDKEYR \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< FLASH_PEC and data matrix Key */
    ...
    #define FLASH_PRGKEYR_PRGKEYR \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Program matrix Key */

    /******************  Bit definition for FLASH_OPTKEYR register
     * ******************/
    #define FLASH_OPTKEYR_OPTKEYR \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Option bytes matrix Key */
    ...
    #define FLASH_SR_ENHV \
        ( ( uint32_t ) 0x00000004 ) /*!< End of high voltage */
    #define FLASH_SR_READY \
        ( ( uint32_t ) 0x00000008 ) /*!< Flash ready after low power mode */

    #define FLASH_SR_WRPERR \
        ( ( uint32_t ) 0x00000100 ) /*!< Write protected error */
    #define FLASH_SR_PGAERR \
        ( ( uint32_t ) 0x00000200 ) /*!< Programming Alignment Error */
    ...
    #define FLASH_SR_OPTVERRUSR \
        ( ( uint32_t ) 0x00001000 ) /*!< Option User validity error */

    /******************  Bit definition for FLASH_OBR register
     * *******************/
    #define FLASH_OBR_RDPRT                              \
        ( ( uint16_t ) 0x000000AA ) /*!< Read Protection \
                                     */
    #define FLASH_OBR_BOR_LEV                                         \
        ( ( uint16_t ) 0x000F0000 ) /*!< BOR_LEV[3:0] Brown Out Reset \
                                       Threshold Level*/
    #define FLASH_OBR_USER                                 \
        ( ( uint32_t ) 0x00700000 ) /*!< User Option Bytes \
                                     */
    ...
    #define FLASH_OBR_nRST_STDBY                                            \
        ( ( uint32_t ) 0x00400000 )                         /*!< nRST_STDBY \
                                                             */
    ...
    #define FSMC_BCR1_MWID                                               \
        ( ( uint32_t ) 0x00000030 ) /*!< MWID[1:0] bits (Memory data bus \
                                       width) */
    ...
    #define FSMC_BTR1_DATAST                                           \
        ( ( uint32_t ) 0x0000FF00 ) /*!< DATAST [3:0] bits (Data-phase \
                                       duration) */
    ...
    #define FSMC_BTR1_BUSTURN                                              \
        ( ( uint32_t ) 0x000F0000 ) /*!< BUSTURN[3:0] bits (Bus turnaround \
                                       phase duration) */
    ...
    #define I2C_CR1_POS                                                 \
        ( ( uint16_t ) 0x0800 ) /*!< Acknowledge/PEC Position (for data \
                                   reception) */
     ...
     * ********************/
    #define I2C_CR2_FREQ                                              \
        ( ( uint16_t ) 0x003F ) /*!< FREQ[5:0] bits (Peripheral Clock \
                                   Frequency) */
    ...
    #define I2C_CR2_ITERREN \
        ( ( uint16_t ) 0x0100 ) /*!< Error Interrupt Enable */
    #define I2C_CR2_ITEVTEN \
        ( ( uint16_t ) 0x0200 ) /*!< Event Interrupt Enable */
    #define I2C_CR2_ITBUFEN \
        ( ( uint16_t ) 0x0400 ) /*!< Buffer Interrupt Enable */
    ...
    #define I2C_OAR2_ENDUAL \
        ( ( uint8_t ) 0x01 ) /*!< Dual addressing mode enable */
    ...
    #define I2C_SR1_ADDR                                                       \
        ( ( uint16_t ) 0x0002 ) /*!< Address sent (master mode)/matched (slave \
                                   mode) */
     ...
     * ********************/
    #define I2C_CCR_CCR                                                      \
        ( ( uint16_t ) 0x0FFF ) /*!< Clock Control Register in Fast/Standard \
                                   mode (Master mode) */
    ...
    #define LCD_CR_VSEL \
        ( ( uint32_t ) 0x00000002 ) /*!< Voltage source selector Bit */

    #define LCD_CR_DUTY \
        ( ( uint32_t ) 0x0000001C ) /*!< DUTY[2:0] bits (Duty selector) */
    #define LCD_CR_DUTY_0 \
        ( ( uint32_t ) 0x00000004 ) /*!< Duty selector Bit 0 */
    #define LCD_CR_DUTY_1 \
        ( ( uint32_t ) 0x00000008 ) /*!< Duty selector Bit 1 */
    #define LCD_CR_DUTY_2 \
        ( ( uint32_t ) 0x00000010 ) /*!< Duty selector Bit 2 */

    #define LCD_CR_BIAS \
        ( ( uint32_t ) 0x00000060 ) /*!< BIAS[1:0] bits (Bias selector) */
    #define LCD_CR_BIAS_0 \
        ( ( uint32_t ) 0x00000020 ) /*!< Bias selector Bit 0 */
    #define LCD_CR_BIAS_1 \
        ( ( uint32_t ) 0x00000040 ) /*!< Bias selector Bit 1 */

    #define LCD_CR_MUX_SEG \
        ( ( uint32_t ) 0x00000080 ) /*!< Mux Segment Enable Bit */

    /*******************  Bit definition for LCD_FCR register
     * ********************/
    #define LCD_FCR_HD                                         \
        ( ( uint32_t ) 0x00000001 ) /*!< High Drive Enable Bit \
                                     */
    #define LCD_FCR_SOFIE                                                    \
        ( ( uint32_t ) 0x00000002 ) /*!< Start of Frame Interrupt Enable Bit \
                                     */
    #define LCD_FCR_UDDIE                                                     \
        ( ( uint32_t ) 0x00000008 ) /*!< Update Display Done Interrupt Enable \
                                       Bit */

    #define LCD_FCR_PON \
        ( ( uint32_t ) 0x00000070 ) /*!< PON[2:0] bits (Puls ON Duration) */
    ...
    #define LCD_FCR_DEAD \
        ( ( uint32_t ) 0x00000380 ) /*!< DEAD[2:0] bits (DEAD Time) */
    ...
    #define LCD_FCR_CC \
        ( ( uint32_t ) 0x00001C00 ) /*!< CC[2:0] bits (Contrast Control) */
    ...
    #define LCD_FCR_BLINKF \
        ( ( uint32_t ) 0x0000E000 ) /*!< BLINKF[2:0] bits (Blink Frequency) */
    ...
    #define LCD_FCR_BLINK \
        ( ( uint32_t ) 0x00030000 ) /*!< BLINK[1:0] bits (Blink Enable) */
    #define LCD_FCR_BLINK_0 ( ( uint32_t ) 0x00010000 ) /*!< Bit 0 */
    #define LCD_FCR_BLINK_1 ( ( uint32_t ) 0x00020000 ) /*!< Bit 1 */

    #define LCD_FCR_DIV \
        ( ( uint32_t ) 0x003C0000 ) /*!< DIV[3:0] bits (Divider) */
    #define LCD_FCR_PS \
        ( ( uint32_t ) 0x03C00000 ) /*!< PS[3:0] bits (Prescaler) */

    /*******************  Bit definition for LCD_SR register
     * *********************/
    #define LCD_SR_ENS ( ( uint32_t ) 0x00000001 ) /*!< LCD Enabled Bit */
    #define LCD_SR_SOF \
        ( ( uint32_t ) 0x00000002 ) /*!< Start Of Frame Flag Bit */
    #define LCD_SR_UDR \
        ( ( uint32_t ) 0x00000004 ) /*!< Update Display Request Bit */
    #define LCD_SR_UDD \
        ( ( uint32_t ) 0x00000008 ) /*!< Update Display Done Flag Bit */
    #define LCD_SR_RDY ( ( uint32_t ) 0x00000010 ) /*!< Ready Flag Bit */
    #define LCD_SR_FCRSR                                                       \
        ( ( uint32_t ) 0x00000020 ) /*!< LCD FCR Register Synchronization Flag \
                                       Bit */

    /*******************  Bit definition for LCD_CLR register
     * ********************/
    #define LCD_CLR_SOFC \
        ( ( uint32_t ) 0x00000002 ) /*!< Start Of Frame Flag Clear Bit */
    #define LCD_CLR_UDDC \
        ( ( uint32_t ) 0x00000008 ) /*!< Update Display Done Flag Clear Bit */

    /*******************  Bit definition for LCD_RAM register
     * ********************/
    #define LCD_RAM_SEGMENT_DATA \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Segment Data Bits */
    ...
    #define PWR_CR_LPSDSR                                                    \
        ( ( uint16_t ) 0x0001 ) /*!< Low-power deepsleep/sleep/low power run \
                                 */
    #define PWR_CR_PDDS ( ( uint16_t ) 0x0002 ) /*!< Power Down Deepsleep */
    #define PWR_CR_CWUF ( ( uint16_t ) 0x0004 ) /*!< Clear Wakeup Flag */
    #define PWR_CR_CSBF ( ( uint16_t ) 0x0008 ) /*!< Clear Standby Flag */
    #define PWR_CR_PVDE \
        ( ( uint16_t ) 0x0010 ) /*!< Power Voltage Detector Enable */
    ...
    #define PWR_CR_VOS                                                    \
        ( ( uint16_t ) 0x1800 ) /*!< VOS[1:0] bits (Voltage scaling range \
                                   selection) */
    ...
    #define PWR_CSR_VREFINTRDYF                                           \
        ( ( uint16_t ) 0x0008 ) /*!< Internal voltage reference (VREFINT) \
                                   ready flag */
    #define PWR_CSR_VOSF \
        ( ( uint16_t ) 0x0010 ) /*!< Voltage Scaling select flag */
    ...
    #define RCC_CR_MSION \
        ( ( uint32_t ) 0x00000100 ) /*!< Internal Multi Speed clock enable */
    #define RCC_CR_MSIRDY                                                      \
        ( ( uint32_t ) 0x00000200 ) /*!< Internal Multi Speed clock ready flag \
                                     */
    ...
    #define RCC_CR_PLLRDY \
        ( ( uint32_t ) 0x02000000 ) /*!< PLL clock ready flag */
    #define RCC_CR_CSSON \
        ( ( uint32_t ) 0x10000000 ) /*!< Clock Security System enable */

    #define RCC_CR_RTCPRE                                                      \
        ( ( uint32_t ) 0x60000000 )                     /*!< RTC/LCD Prescaler \
                                                         */
    ...
    #define RCC_ICSCR_HSICAL                                                   \
        ( ( uint32_t ) 0x000000FF ) /*!< Internal High Speed clock Calibration \
                                     */
    #define RCC_ICSCR_HSITRIM \
        ( ( uint32_t ) 0x00001F00 ) /*!< Internal High Speed clock trimming */

    #define RCC_ICSCR_MSIRANGE \
        ( ( uint32_t ) 0x0000E000 ) /*!< Internal Multi Speed clock Range */
    #define RCC_ICSCR_MSIRANGE_0                                    \
        ( ( uint32_t ) 0x00000000 ) /*!< Internal Multi Speed clock \
                                       Range 65.536 KHz */
    #define RCC_ICSCR_MSIRANGE_1                                          \
        ( ( uint32_t ) 0x00002000 ) /*!< Internal Multi Speed clock Range \
                                       131.072 KHz */
    #define RCC_ICSCR_MSIRANGE_2                                          \
        ( ( uint32_t ) 0x00004000 ) /*!< Internal Multi Speed clock Range \
                                       262.144 KHz */
    #define RCC_ICSCR_MSIRANGE_3                                          \
        ( ( uint32_t ) 0x00006000 ) /*!< Internal Multi Speed clock Range \
                                       524.288 KHz */
    #define RCC_ICSCR_MSIRANGE_4                                    \
        ( ( uint32_t ) 0x00008000 ) /*!< Internal Multi Speed clock \
                                       Range 1.048 MHz */
    #define RCC_ICSCR_MSIRANGE_5                                    \
        ( ( uint32_t ) 0x0000A000 ) /*!< Internal Multi Speed clock \
                                       Range 2.097 MHz */
    #define RCC_ICSCR_MSIRANGE_6                                    \
        ( ( uint32_t ) 0x0000C000 ) /*!< Internal Multi Speed clock \
                                       Range 4.194 MHz */
    #define RCC_ICSCR_MSICAL                                        \
        ( ( uint32_t ) 0x00FF0000 ) /*!< Internal Multi Speed clock \
                                       Calibration */
    #define RCC_ICSCR_MSITRIM                                                \
        ( ( uint32_t ) 0xFF000000 ) /*!< Internal Multi Speed clock trimming \
                                     */
    ...
    #define RCC_CFGR_SW_MSI \
        ( ( uint32_t ) 0x00000000 ) /*!< MSI selected as system clock */
    #define RCC_CFGR_SW_HSI \
        ( ( uint32_t ) 0x00000001 ) /*!< HSI selected as system clock */
    #define RCC_CFGR_SW_HSE \
        ( ( uint32_t ) 0x00000002 ) /*!< HSE selected as system clock */
    #define RCC_CFGR_SW_PLL \
        ( ( uint32_t ) 0x00000003 ) /*!< PLL selected as system clock */

    #define RCC_CFGR_SWS                                                    \
        ( ( uint32_t ) 0x0000000C ) /*!< SWS[1:0] bits (System Clock Switch \
                                       Status) */
    ...
    #define RCC_CFGR_SWS_MSI                                                 \
        ( ( uint32_t ) 0x00000000 ) /*!< MSI oscillator used as system clock \
                                     */
    #define RCC_CFGR_SWS_HSI                                                 \
        ( ( uint32_t ) 0x00000004 ) /*!< HSI oscillator used as system clock \
                                     */
    #define RCC_CFGR_SWS_HSE                                                 \
        ( ( uint32_t ) 0x00000008 ) /*!< HSE oscillator used as system clock \
                                     */
    #define RCC_CFGR_SWS_PLL \
        ( ( uint32_t ) 0x0000000C ) /*!< PLL used as system clock */
    ...
    #define RCC_CFGR_PPRE1_DIV1 \
        ( ( uint32_t ) 0x00000000 ) /*!< HCLK not divided */
    #define RCC_CFGR_PPRE1_DIV2 \
        ( ( uint32_t ) 0x00000400 ) /*!< HCLK divided by 2 */
    #define RCC_CFGR_PPRE1_DIV4 \
        ( ( uint32_t ) 0x00000500 ) /*!< HCLK divided by 4 */
    #define RCC_CFGR_PPRE1_DIV8 \
        ( ( uint32_t ) 0x00000600 ) /*!< HCLK divided by 8 */
    ...
    #define RCC_CFGR_PPRE2_DIV2 \
        ( ( uint32_t ) 0x00002000 ) /*!< HCLK divided by 2 */
    #define RCC_CFGR_PPRE2_DIV4 \
        ( ( uint32_t ) 0x00002800 ) /*!< HCLK divided by 4 */
    #define RCC_CFGR_PPRE2_DIV8 \
        ( ( uint32_t ) 0x00003000 ) /*!< HCLK divided by 8 */
    ...
    #define RCC_CFGR_PLLSRC_HSI \
        ( ( uint32_t ) 0x00000000 ) /*!< HSI as PLL entry clock source */
    #define RCC_CFGR_PLLSRC_HSE \
        ( ( uint32_t ) 0x00010000 ) /*!< HSE as PLL entry clock source */

    #define RCC_CFGR_PLLMUL                                                   \
        ( ( uint32_t ) 0x003C0000 ) /*!< PLLMUL[3:0] bits (PLL multiplication \
                                       factor) */
    ...
    #define RCC_CFGR_PLLMUL3 \
        ( ( uint32_t ) 0x00000000 ) /*!< PLL input clock * 3 */
    #define RCC_CFGR_PLLMUL4 \
        ( ( uint32_t ) 0x00040000 ) /*!< PLL input clock * 4 */
    #define RCC_CFGR_PLLMUL6 \
        ( ( uint32_t ) 0x00080000 ) /*!< PLL input clock * 6 */
    #define RCC_CFGR_PLLMUL8 \
        ( ( uint32_t ) 0x000C0000 ) /*!< PLL input clock * 8 */
    #define RCC_CFGR_PLLMUL12 \
        ( ( uint32_t ) 0x00100000 ) /*!< PLL input clock * 12 */
    #define RCC_CFGR_PLLMUL16 \
        ( ( uint32_t ) 0x00140000 ) /*!< PLL input clock * 16 */
    #define RCC_CFGR_PLLMUL24 \
        ( ( uint32_t ) 0x00180000 ) /*!< PLL input clock * 24 */
    #define RCC_CFGR_PLLMUL32 \
        ( ( uint32_t ) 0x001C0000 ) /*!< PLL input clock * 32 */
    #define RCC_CFGR_PLLMUL48 \
        ( ( uint32_t ) 0x00200000 ) /*!< PLL input clock * 48 */

    /*!< PLLDIV configuration */
    #define RCC_CFGR_PLLDIV                                           \
        ( ( uint32_t ) 0x00C00000 ) /*!< PLLDIV[1:0] bits (PLL Output \
                                       Division) */
    ...
    #define RCC_CFGR_PLLDIV1 \
        ( ( uint32_t ) 0x00000000 ) /*!< PLL clock output = CKVCO / 1 */
    #define RCC_CFGR_PLLDIV2 \
        ( ( uint32_t ) 0x00400000 ) /*!< PLL clock output = CKVCO / 2 */
    #define RCC_CFGR_PLLDIV3 \
        ( ( uint32_t ) 0x00800000 ) /*!< PLL clock output = CKVCO / 3 */
    #define RCC_CFGR_PLLDIV4 \
        ( ( uint32_t ) 0x00C00000 ) /*!< PLL clock output = CKVCO / 4 */

    #define RCC_CFGR_MCOSEL                                                   \
        ( ( uint32_t ) 0x07000000 ) /*!< MCO[2:0] bits (Microcontroller Clock \
                                       Output) */
    ...
    #define RCC_CFGR_MCO_SYSCLK \
        ( ( uint32_t ) 0x01000000 ) /*!< System clock selected */
    #define RCC_CFGR_MCO_HSI                                                 \
        ( ( uint32_t ) 0x02000000 ) /*!< Internal 16 MHz RC oscillator clock \
                                       selected */
    #define RCC_CFGR_MCO_MSI                                                 \
        ( ( uint32_t ) 0x03000000 ) /*!< Internal Medium Speed RC oscillator \
                                       clock selected */
    #define RCC_CFGR_MCO_HSE                                                \
        ( ( uint32_t ) 0x04000000 ) /*!< External 1-25 MHz oscillator clock \
                                       selected */
    #define RCC_CFGR_MCO_PLL \
        ( ( uint32_t ) 0x05000000 ) /*!< PLL clock divided */
    ...
    #define RCC_CFGR_MCOPRE                                                \
        ( ( uint32_t ) 0x70000000 ) /*!< MCOPRE[2:0] bits (Microcontroller \
    ...
    #define RCC_CFGR_MCO_DIV1 \
        ( ( uint32_t ) 0x00000000 ) /*!< MCO Clock divided by 1 */
    #define RCC_CFGR_MCO_DIV2 \
        ( ( uint32_t ) 0x10000000 ) /*!< MCO Clock divided by 2 */
    #define RCC_CFGR_MCO_DIV4 \
        ( ( uint32_t ) 0x20000000 ) /*!< MCO Clock divided by 4 */
    #define RCC_CFGR_MCO_DIV8 \
        ( ( uint32_t ) 0x30000000 ) /*!< MCO Clock divided by 8 */
    #define RCC_CFGR_MCO_DIV16 \
        ( ( uint32_t ) 0x40000000 ) /*!< MCO Clock divided by 16 */
    ...
    #define RCC_CIR_MSIRDYF \
        ( ( uint32_t ) 0x00000020 ) /*!< MSI Ready Interrupt flag */
    #define RCC_CIR_LSECSS \
        ( ( uint32_t ) 0x00000040 ) /*!< LSE CSS Interrupt flag */
    #define RCC_CIR_CSSF                                                      \
    ...
    #define RCC_CIR_MSIRDYIE \
        ( ( uint32_t ) 0x00002000 ) /*!< MSI Ready Interrupt Enable */
    #define RCC_CIR_LSECSSIE \
        ( ( uint32_t ) 0x00004000 ) /*!< LSE CSS Interrupt Enable */
    ...
    #define RCC_CIR_MSIRDYC \
        ( ( uint32_t ) 0x00200000 ) /*!< MSI Ready Interrupt Clear */
    #define RCC_CIR_LSECSSC \
        ( ( uint32_t ) 0x00400000 ) /*!< LSE CSS Interrupt Clear */
    #define RCC_CIR_CSSC                                                       \
    ...
    #define RCC_AHBRSTR_GPIOARST \
        ( ( uint32_t ) 0x00000001 ) /*!< GPIO port A reset */
    #define RCC_AHBRSTR_GPIOBRST \
        ( ( uint32_t ) 0x00000002 ) /*!< GPIO port B reset */
    #define RCC_AHBRSTR_GPIOCRST \
        ( ( uint32_t ) 0x00000004 ) /*!< GPIO port C reset */
    #define RCC_AHBRSTR_GPIODRST \
        ( ( uint32_t ) 0x00000008 ) /*!< GPIO port D reset */
    #define RCC_AHBRSTR_GPIOERST \
        ( ( uint32_t ) 0x00000010 ) /*!< GPIO port E reset */
    #define RCC_AHBRSTR_GPIOHRST \
        ( ( uint32_t ) 0x00000020 ) /*!< GPIO port H reset */
    #define RCC_AHBRSTR_GPIOFRST \
        ( ( uint32_t ) 0x00000040 ) /*!< GPIO port F reset */
    #define RCC_AHBRSTR_GPIOGRST \
        ( ( uint32_t ) 0x00000080 ) /*!< GPIO port G reset */
    #define RCC_AHBRSTR_CRCRST ( ( uint32_t ) 0x00001000 ) /*!< CRC reset */
    #define RCC_AHBRSTR_FLITFRST                                             \
        ( ( uint32_t ) 0x00008000 )                         /*!< FLITF reset \
                                                             */
    ...
    #define RCC_APB2RSTR_SYSCFGRST \
        ( ( uint32_t ) 0x00000001 ) /*!< System Configuration SYSCFG reset */
    #define RCC_APB2RSTR_TIM9RST                    \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM9 reset \
                                     */
    #define RCC_APB2RSTR_TIM10RST \
        ( ( uint32_t ) 0x00000008 ) /*!< TIM10 reset */
    #define RCC_APB2RSTR_TIM11RST \
        ( ( uint32_t ) 0x00000010 ) /*!< TIM11 reset */
    #define RCC_APB2RSTR_ADC1RST                    \
        ( ( uint32_t ) 0x00000200 ) /*!< ADC1 reset \
                                     */
    #define RCC_APB2RSTR_SDIORST                    \
        ( ( uint32_t ) 0x00000800 ) /*!< SDIO reset \
                                     */
    #define RCC_APB2RSTR_SPI1RST                    \
        ( ( uint32_t ) 0x00001000 ) /*!< SPI1 reset \
                                     */
    #define RCC_APB2RSTR_USART1RST \
        ( ( uint32_t ) 0x00004000 ) /*!< USART1 reset */

    /*****************  Bit definition for RCC_APB1RSTR register
     * *****************/
    #define RCC_APB1RSTR_TIM2RST \
        ( ( uint32_t ) 0x00000001 ) /*!< Timer 2 reset */
    #define RCC_APB1RSTR_TIM3RST \
        ( ( uint32_t ) 0x00000002 ) /*!< Timer 3 reset */
    #define RCC_APB1RSTR_TIM4RST \
        ( ( uint32_t ) 0x00000004 ) /*!< Timer 4 reset */
    #define RCC_APB1RSTR_TIM5RST \
        ( ( uint32_t ) 0x00000008 ) /*!< Timer 5 reset */
    #define RCC_APB1RSTR_TIM6RST \
        ( ( uint32_t ) 0x00000010 ) /*!< Timer 6 reset */
    #define RCC_APB1RSTR_TIM7RST \
        ( ( uint32_t ) 0x00000020 ) /*!< Timer 7 reset */
    ...
    #define RCC_APB1RSTR_SPI2RST                     \
        ( ( uint32_t ) 0x00004000 ) /*!< SPI 2 reset \
                                     */
    #define RCC_APB1RSTR_SPI3RST                     \
        ( ( uint32_t ) 0x00008000 ) /*!< SPI 3 reset \
                                     */
    #define RCC_APB1RSTR_USART2RST \
        ( ( uint32_t ) 0x00020000 ) /*!< USART 2 reset */
    #define RCC_APB1RSTR_USART3RST \
        ( ( uint32_t ) 0x00040000 ) /*!< USART 3 reset */
    #define RCC_APB1RSTR_UART4RST \
        ( ( uint32_t ) 0x00080000 ) /*!< UART 4 reset */
    #define RCC_APB1RSTR_UART5RST \
        ( ( uint32_t ) 0x00100000 ) /*!< UART 5 reset */
    #define RCC_APB1RSTR_I2C1RST                     \
        ( ( uint32_t ) 0x00200000 ) /*!< I2C 1 reset \
                                     */
    #define RCC_APB1RSTR_I2C2RST                                             \
        ( ( uint32_t ) 0x00400000 )                         /*!< I2C 2 reset \
                                                             */
    ...
    #define RCC_APB1RSTR_COMPRST \
        ( ( uint32_t ) 0x80000000 ) /*!< Comparator interface reset */

    /******************  Bit definition for RCC_AHBENR register
     * ******************/
    #define RCC_AHBENR_GPIOAEN \
        ( ( uint32_t ) 0x00000001 ) /*!< GPIO port A clock enable */
    #define RCC_AHBENR_GPIOBEN \
        ( ( uint32_t ) 0x00000002 ) /*!< GPIO port B clock enable */
    #define RCC_AHBENR_GPIOCEN \
        ( ( uint32_t ) 0x00000004 ) /*!< GPIO port C clock enable */
    #define RCC_AHBENR_GPIODEN \
        ( ( uint32_t ) 0x00000008 ) /*!< GPIO port D clock enable */
    #define RCC_AHBENR_GPIOEEN \
        ( ( uint32_t ) 0x00000010 ) /*!< GPIO port E clock enable */
    #define RCC_AHBENR_GPIOHEN \
        ( ( uint32_t ) 0x00000020 ) /*!< GPIO port H clock enable */
    #define RCC_AHBENR_GPIOFEN \
        ( ( uint32_t ) 0x00000040 ) /*!< GPIO port F clock enable */
    #define RCC_AHBENR_GPIOGEN \
        ( ( uint32_t ) 0x00000080 ) /*!< GPIO port G clock enable */
    #define RCC_AHBENR_CRCEN \
        ( ( uint32_t ) 0x00001000 ) /*!< CRC clock enable */
    #define RCC_AHBENR_FLITFEN                                                \
        ( ( uint32_t ) 0x00008000 ) /*!< FLITF clock enable (has effect only  \
                                       when the Flash memory is in power down \
                                       mode) */
    #define RCC_AHBENR_DMA1EN \
        ( ( uint32_t ) 0x01000000 ) /*!< DMA1 clock enable */
    #define RCC_AHBENR_DMA2EN \
        ( ( uint32_t ) 0x02000000 ) /*!< DMA2 clock enable */
    #define RCC_AHBENR_AESEN \
        ( ( uint32_t ) 0x08000000 ) /*!< AES clock enable */
    #define RCC_AHBENR_FSMCEN \
        ( ( uint32_t ) 0x40000000 ) /*!< FSMC clock enable */

    /******************  Bit definition for RCC_APB2ENR register
     * *****************/
    #define RCC_APB2ENR_SYSCFGEN                                           \
        ( ( uint32_t ) 0x00000001 ) /*!< System Configuration SYSCFG clock \
                                       enable */
    #define RCC_APB2ENR_TIM9EN \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM9 interface clock enable */
    #define RCC_APB2ENR_TIM10EN \
        ( ( uint32_t ) 0x00000008 ) /*!< TIM10 interface clock enable */
    #define RCC_APB2ENR_TIM11EN \
        ( ( uint32_t ) 0x00000010 ) /*!< TIM11 Timer clock enable */
    #define RCC_APB2ENR_ADC1EN \
        ( ( uint32_t ) 0x00000200 ) /*!< ADC1 clock enable */
    #define RCC_APB2ENR_SDIOEN \
        ( ( uint32_t ) 0x00000800 ) /*!< SDIO clock enable */
    #define RCC_APB2ENR_SPI1EN \
        ( ( uint32_t ) 0x00001000 ) /*!< SPI1 clock enable */
    ...
    #define RCC_APB1ENR_TIM2EN \
        ( ( uint32_t ) 0x00000001 ) /*!< Timer 2 clock enabled*/
    ...
    #define RCC_APB1ENR_I2C1EN \
        ( ( uint32_t ) 0x00200000 ) /*!< I2C 1 clock enable */
    #define RCC_APB1ENR_I2C2EN \
        ( ( uint32_t ) 0x00400000 ) /*!< I2C 2 clock enable */
    #define RCC_APB1ENR_USBEN \
        ( ( uint32_t ) 0x00800000 ) /*!< USB clock enable */
    ...
    #define RCC_APB1ENR_COMPEN \
        ( ( uint32_t ) 0x80000000 ) /*!< Comparator interface clock enable */

    /******************  Bit definition for RCC_AHBLPENR register
     * ****************/
    #define RCC_AHBLPENR_GPIOALPEN                                          \
        ( ( uint32_t ) 0x00000001 ) /*!< GPIO port A clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOBLPEN                                          \
        ( ( uint32_t ) 0x00000002 ) /*!< GPIO port B clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOCLPEN                                          \
        ( ( uint32_t ) 0x00000004 ) /*!< GPIO port C clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIODLPEN                                          \
        ( ( uint32_t ) 0x00000008 ) /*!< GPIO port D clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOELPEN                                          \
        ( ( uint32_t ) 0x00000010 ) /*!< GPIO port E clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOHLPEN                                          \
        ( ( uint32_t ) 0x00000020 ) /*!< GPIO port H clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOFLPEN                                          \
        ( ( uint32_t ) 0x00000040 ) /*!< GPIO port F clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_GPIOGLPEN                                          \
        ( ( uint32_t ) 0x00000080 ) /*!< GPIO port G clock enabled in sleep \
                                       mode */
    #define RCC_AHBLPENR_CRCLPEN \
        ( ( uint32_t ) 0x00001000 ) /*!< CRC clock enabled in sleep mode */
    #define RCC_AHBLPENR_FLITFLPEN                                          \
        ( ( uint32_t ) 0x00008000 ) /*!< Flash Interface clock enabled in   \
                                       sleep mode (has effect only when the \
                                       Flash memory is in power down mode) */
    #define RCC_AHBLPENR_SRAMLPEN \
        ( ( uint32_t ) 0x00010000 ) /*!< SRAM clock enabled in sleep mode */
    #define RCC_AHBLPENR_DMA1LPEN \
        ( ( uint32_t ) 0x01000000 ) /*!< DMA1 clock enabled in sleep mode */
    #define RCC_AHBLPENR_DMA2LPEN \
        ( ( uint32_t ) 0x02000000 ) /*!< DMA2 clock enabled in sleep mode */
    #define RCC_AHBLPENR_AESLPEN \
        ( ( uint32_t ) 0x08000000 ) /*!< AES clock enabled in sleep mode */
    #define RCC_AHBLPENR_FSMCLPEN \
        ( ( uint32_t ) 0x40000000 ) /*!< FSMC clock enabled in sleep mode */
    ...
    #define RCC_APB2LPENR_TIM9LPEN                                             \
        ( ( uint32_t ) 0x00000004 ) /*!< TIM9 interface clock enabled in sleep \
                                       mode */
    #define RCC_APB2LPENR_TIM10LPEN                                       \
        ( ( uint32_t ) 0x00000008 ) /*!< TIM10 interface clock enabled in \
                                       sleep mode */
    #define RCC_APB2LPENR_TIM11LPEN                                         \
        ( ( uint32_t ) 0x00000010 ) /*!< TIM11 Timer clock enabled in sleep \
                                       mode */
    #define RCC_APB2LPENR_ADC1LPEN \
        ( ( uint32_t ) 0x00000200 ) /*!< ADC1 clock enabled in sleep mode */
    #define RCC_APB2LPENR_SDIOLPEN \
        ( ( uint32_t ) 0x00000800 ) /*!< SDIO clock enabled in sleep mode */
    #define RCC_APB2LPENR_SPI1LPEN \
        ( ( uint32_t ) 0x00001000 ) /*!< SPI1 clock enabled in sleep mode */
    #define RCC_APB2LPENR_USART1LPEN \
        ( ( uint32_t ) 0x00004000 ) /*!< USART1 clock enabled in sleep mode */

    /*****************  Bit definition for RCC_APB1LPENR register
     * ****************/
    #define RCC_APB1LPENR_TIM2LPEN                                           \
        ( ( uint32_t ) 0x00000001 ) /*!< Timer 2 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_TIM3LPEN                                           \
        ( ( uint32_t ) 0x00000002 ) /*!< Timer 3 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_TIM4LPEN                                           \
        ( ( uint32_t ) 0x00000004 ) /*!< Timer 4 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_TIM5LPEN                                           \
        ( ( uint32_t ) 0x00000008 ) /*!< Timer 5 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_TIM6LPEN                                           \
        ( ( uint32_t ) 0x00000010 ) /*!< Timer 6 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_TIM7LPEN                                           \
        ( ( uint32_t ) 0x00000020 ) /*!< Timer 7 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_LCDLPEN \
        ( ( uint32_t ) 0x00000200 ) /*!< LCD clock enabled in sleep mode */
    #define RCC_APB1LPENR_WWDGLPEN                                        \
        ( ( uint32_t ) 0x00000800 ) /*!< Window Watchdog clock enabled in \
                                       sleep mode */
    #define RCC_APB1LPENR_SPI2LPEN \
        ( ( uint32_t ) 0x00004000 ) /*!< SPI 2 clock enabled in sleep mode */
    #define RCC_APB1LPENR_SPI3LPEN \
        ( ( uint32_t ) 0x00008000 ) /*!< SPI 3 clock enabled in sleep mode */
    #define RCC_APB1LPENR_USART2LPEN                                         \
        ( ( uint32_t ) 0x00020000 ) /*!< USART 2 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_USART3LPEN                                         \
        ( ( uint32_t ) 0x00040000 ) /*!< USART 3 clock enabled in sleep mode \
                                     */
    #define RCC_APB1LPENR_UART4LPEN \
        ( ( uint32_t ) 0x00080000 ) /*!< UART 4 clock enabled in sleep mode */
    #define RCC_APB1LPENR_UART5LPEN \
        ( ( uint32_t ) 0x00100000 ) /*!< UART 5 clock enabled in sleep mode */
    #define RCC_APB1LPENR_I2C1LPEN \
        ( ( uint32_t ) 0x00200000 ) /*!< I2C 1 clock enabled in sleep mode */
    #define RCC_APB1LPENR_I2C2LPEN \
        ( ( uint32_t ) 0x00400000 ) /*!< I2C 2 clock enabled in sleep mode */
    #define RCC_APB1LPENR_USBLPEN \
        ( ( uint32_t ) 0x00800000 ) /*!< USB clock enabled in sleep mode */
    #define RCC_APB1LPENR_PWRLPEN                                         \
        ( ( uint32_t ) 0x10000000 ) /*!< Power interface clock enabled in \
                                       sleep mode */
    #define RCC_APB1LPENR_DACLPEN                                             \
        ( ( uint32_t ) 0x20000000 ) /*!< DAC interface clock enabled in sleep \
                                       mode */
    #define RCC_APB1LPENR_COMPLPEN                                             \
        ( ( uint32_t ) 0x80000000 ) /*!< Comparator interface clock enabled in \
                                       sleep mode*/
    ...
    #define RCC_CSR_LSEON                                                     \
        ( ( uint32_t ) 0x00000100 ) /*!< External Low Speed oscillator enable \
                                     */
    #define RCC_CSR_LSERDY                                                   \
        ( ( uint32_t ) 0x00000200 ) /*!< External Low Speed oscillator Ready \
                                     */
    #define RCC_CSR_LSEBYP                                                    \
        ( ( uint32_t ) 0x00000400 ) /*!< External Low Speed oscillator Bypass \
                                     */
    #define RCC_CSR_LSECSSON                                               \
        ( ( uint32_t ) 0x00000800 ) /*!< External Low Speed oscillator CSS \
                                       Enable */
    #define RCC_CSR_LSECSSD                                                \
        ( ( uint32_t ) 0x00001000 ) /*!< External Low Speed oscillator CSS \
                                       Detected */

    #define RCC_CSR_RTCSEL                                                  \
        ( ( uint32_t ) 0x00030000 ) /*!< RTCSEL[1:0] bits (RTC clock source \
                                       selection) */
    ...
    #define RCC_CSR_RTCSEL_NOCLOCK                \
        ( ( uint32_t ) 0x00000000 ) /*!< No clock \
                                     */
    #define RCC_CSR_RTCSEL_LSE                                            \
        ( ( uint32_t ) 0x00010000 ) /*!< LSE oscillator clock used as RTC \
                                       clock */
    #define RCC_CSR_RTCSEL_LSI                                            \
        ( ( uint32_t ) 0x00020000 ) /*!< LSI oscillator clock used as RTC \
                                       clock */
    #define RCC_CSR_RTCSEL_HSE                                                 \
        ( ( uint32_t ) 0x00030000 ) /*!< HSE oscillator clock divided by 2, 4, \
                                       8 or 16 by RTCPRE used as RTC clock */
    ...
    #define RCC_CSR_OBLRSTF \
        ( ( uint32_t ) 0x02000000 ) /*!< Option Bytes Loader reset flag */
    #define RCC_CSR_PINRSTF ( ( uint32_t ) 0x04000000 ) /*!< PIN reset flag */
    #define RCC_CSR_PORRSTF \
        ( ( uint32_t ) 0x08000000 ) /*!< POR/PDR reset flag */
    #define RCC_CSR_SFTRSTF \
        ( ( uint32_t ) 0x10000000 ) /*!< Software Reset flag */
    ...
    #define RCC_CSR_LPWRRSTF \
        ( ( uint32_t ) 0x80000000 ) /*!< Low-Power reset flag */
    ...
    #define SDIO_POWER_PWRCTRL                                            \
        ( ( uint8_t ) 0x03 ) /*!< PWRCTRL[1:0] bits (Power supply control \
                                bits) */
    ...
    #define SDIO_CLKCR_WIDBUS                                               \
        ( ( uint16_t ) 0x1800 ) /*!< WIDBUS[1:0] bits (Wide bus mode enable \
                                   bit) */
    ...
    #define SDIO_ARG_CMDARG                               \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Command argument \
                                     */
    ...
    #define SDIO_CMD_WAITRESP                                              \
        ( ( uint16_t ) 0x00C0 ) /*!< WAITRESP[1:0] bits (Wait for response \
                                   bits) */
    ...
    #define SDIO_CMD_WAITPEND                                             \
        ( ( uint16_t ) 0x0200 ) /*!< CPSM Waits for ends of data transfer \
                                   (CmdPend internal signal) */
    #define SDIO_CMD_CPSMEN                                                   \
        ( ( uint16_t ) 0x0400 ) /*!< Command path state machine (CPSM) Enable \
                                   bit */
    ...
    #define SDIO_RESPCMD_RESPCMD \
        ( ( uint8_t ) 0x3F ) /*!< Response command index */

    /******************  Bit definition for SDIO_RESP0 register
     * ******************/
    #define SDIO_RESP0_CARDSTATUS0 \
        ( ( uint32_t ) 0xFFFFFFFF ) /*!< Card Status */
    ...
    #define SDIO_DCTRL_SDIOEN \
        ( ( uint16_t ) 0x0800 ) /*!< SD I/O enable functions */
    ...
    #define SDIO_STA_CCRCFAIL                                                 \
        ( ( uint32_t ) 0x00000001 ) /*!< Command response received (CRC check \
                                       failed) */
    #define SDIO_STA_DCRCFAIL                                                \
        ( ( uint32_t ) 0x00000002 ) /*!< Data block sent/received (CRC check \
                                       failed) */
    ...
    #define SDIO_STA_CMDREND                                                  \
        ( ( uint32_t ) 0x00000040 ) /*!< Command response received (CRC check \
                                       passed) */
    #define SDIO_STA_CMDSENT                                                 \
        ( ( uint32_t ) 0x00000080 ) /*!< Command sent (no response required) \
                                     */
    #define SDIO_STA_DATAEND                                                   \
        ( ( uint32_t ) 0x00000100 ) /*!< Data end (data counter, SDIDCOUNT, is \
                                       zero) */
    #define SDIO_STA_STBITERR                                               \
        ( ( uint32_t ) 0x00000200 ) /*!< Start bit not detected on all data \
                                       signals in wide bus mode */
    #define SDIO_STA_DBCKEND                                                 \
        ( ( uint32_t ) 0x00000400 ) /*!< Data block sent/received (CRC check \
                                       passed) */
    ...
    #define SDIO_STA_TXFIFOHE                                                 \
        ( ( uint32_t ) 0x00004000 ) /*!< Transmit FIFO Half Empty: at least 8 \
                                       words can be written into the FIFO */
    #define SDIO_STA_RXFIFOHF                                                 \
        ( ( uint32_t ) 0x00008000 ) /*!< Receive FIFO Half Full: there are at \
    ...
    #define SDIO_STA_CEATAEND                                             \
        ( ( uint32_t ) 0x00800000 ) /*!< CE-ATA command completion signal \
                                       received for CMD61 */
    ...
    #define SDIO_MASK_TXUNDERRIE                                          \
        ( ( uint32_t ) 0x00000010 ) /*!< Tx FIFO UnderRun Error Interrupt \
                                       Enable */
    #define SDIO_MASK_RXOVERRIE                                          \
        ( ( uint32_t ) 0x00000020 ) /*!< Rx FIFO OverRun Error Interrupt \
                                       Enable */
    #define SDIO_MASK_CMDRENDIE                                              \
        ( ( uint32_t ) 0x00000040 ) /*!< Command Response Received Interrupt \
                                       Enable */
    ...
    #define SDIO_MASK_TXDAVLIE                                               \
        ( ( uint32_t ) 0x00100000 ) /*!< Data available in Tx FIFO interrupt \
                                       Enable */
    #define SDIO_MASK_RXDAVLIE                                               \
        ( ( uint32_t ) 0x00200000 ) /*!< Data available in Rx FIFO interrupt \
                                       Enable */
    #define SDIO_MASK_SDIOITIE                                        \
        ( ( uint32_t ) 0x00400000 ) /*!< SDIO Mode Interrupt Received \
                                       interrupt Enable */
    ...
    #define SDIO_FIFOCNT_FIFOCOUNT                                       \
        ( ( uint32_t ) 0x00FFFFFF ) /*!< Remaining number of words to be \
    ...
    #define SPI_CRCPR_CRCPOLY \
        ( ( uint16_t ) 0xFFFF ) /*!< CRC polynomial register */
    ...
    #define SPI_I2SCFGR_DATLEN                                          \
        ( ( uint16_t ) 0x0006 ) /*!<DATLEN[1:0] bits (Data length to be \
                                   transferred) */
    ...
    #define SPI_I2SCFGR_I2SMOD                         \
        ( ( uint16_t ) 0x0800 ) /*!<I2S mode selection \
                                 */
    ...
    #define SYSCFG_MEMRMP_MEM_MODE \
        ( ( uint32_t ) 0x00000003 ) /*!< SYSCFG_Memory Remap Config */
    ...
    #define SYSCFG_MEMRMP_BOOT_MODE \
        ( ( uint32_t ) 0x00000300 ) /*!< Boot mode Config */
    #define SYSCFG_MEMRMP_BOOT_MODE_0          \
        ( ( uint32_t ) 0x00000100 ) /*!< Bit 0 \
                                     */
    #define SYSCFG_MEMRMP_BOOT_MODE_1          \
        ( ( uint32_t ) 0x00000200 ) /*!< Bit 1 \
                                     */
    ...
    #define SYSCFG_EXTICR1_EXTI0 \
        ( ( uint16_t ) 0x000F ) /*!< EXTI 0 configuration */
    #define SYSCFG_EXTICR1_EXTI1 \
        ( ( uint16_t ) 0x00F0 ) /*!< EXTI 1 configuration */
    #define SYSCFG_EXTICR1_EXTI2 \
        ( ( uint16_t ) 0x0F00 ) /*!< EXTI 2 configuration */
    #define SYSCFG_EXTICR1_EXTI3 \
        ( ( uint16_t ) 0xF000 ) /*!< EXTI 3 configuration */
    ...
    #define SYSCFG_EXTICR2_EXTI4 \
        ( ( uint16_t ) 0x000F ) /*!< EXTI 4 configuration */
    #define SYSCFG_EXTICR2_EXTI5 \
        ( ( uint16_t ) 0x00F0 ) /*!< EXTI 5 configuration */
    #define SYSCFG_EXTICR2_EXTI6 \
        ( ( uint16_t ) 0x0F00 ) /*!< EXTI 6 configuration */
    #define SYSCFG_EXTICR2_EXTI7 \
        ( ( uint16_t ) 0xF000 ) /*!< EXTI 7 configuration */
    ...
    #define SYSCFG_EXTICR3_EXTI8 \
        ( ( uint16_t ) 0x000F ) /*!< EXTI 8 configuration */
    #define SYSCFG_EXTICR3_EXTI9 \
        ( ( uint16_t ) 0x00F0 ) /*!< EXTI 9 configuration */
     ...
     * ********************/
    #define RI_ICR_IC1Z                                                  \
        ( ( uint32_t ) 0x0000000F ) /*!< IC1Z[3:0] bits (Input Capture 1 \
                                       select bits) */
    ...
    #define RI_ICR_IC2Z                                                  \
        ( ( uint32_t ) 0x000000F0 ) /*!< IC2Z[3:0] bits (Input Capture 2 \
                                       select bits) */
    ...
    #define RI_ICR_IC3Z                                                  \
        ( ( uint32_t ) 0x00000F00 ) /*!< IC3Z[3:0] bits (Input Capture 3 \
                                       select bits) */
    ...
    #define RI_ICR_IC4Z                                                  \
        ( ( uint32_t ) 0x0000F000 ) /*!< IC4Z[3:0] bits (Input Capture 4 \
                                       select bits) */
    ...
    #define RI_ICR_TIM \
        ( ( uint32_t ) 0x00030000 ) /*!< TIM[3:0] bits (Timers select bits) */
     ...
     * ********************/
    #define RI_ASCR1_CH                                                    \
        ( ( uint32_t ) 0x03FCFFFF ) /*!< AS_CH[25:18] & AS_CH[15:0] bits ( \
                                       Analog switches selection bits) */
    ...
    #define RI_ASCR1_VCOMP                                               \
        ( ( uint32_t ) 0x04000000 ) /*!< ADC analog switch selection for \
                                       internal node to COMP1 */
    ...
    #define RI_ASCR1_SCM \
        ( ( uint32_t ) 0x80000000 ) /*!< I/O Switch control mode */

    /********************  Bit definition for RI_ASCR2 register
     * ********************/
    #define RI_ASCR2_GR10_1 \
        ( ( uint32_t ) 0x00000001 ) /*!< GR10-1 selection bit */
    #define RI_ASCR2_GR10_2 \
        ( ( uint32_t ) 0x00000002 ) /*!< GR10-2 selection bit */
    #define RI_ASCR2_GR10_3 \
        ( ( uint32_t ) 0x00000004 ) /*!< GR10-3 selection bit */
    #define RI_ASCR2_GR10_4 \
        ( ( uint32_t ) 0x00000008 ) /*!< GR10-4 selection bit */
    #define RI_ASCR2_GR6_1 \
        ( ( uint32_t ) 0x00000010 ) /*!< GR6-1 selection bit */
    #define RI_ASCR2_GR6_2 \
        ( ( uint32_t ) 0x00000020 ) /*!< GR6-2 selection bit */
    #define RI_ASCR2_GR5_1 \
        ( ( uint32_t ) 0x00000040 ) /*!< GR5-1 selection bit */
    #define RI_ASCR2_GR5_2 \
        ( ( uint32_t ) 0x00000080 ) /*!< GR5-2 selection bit */
    #define RI_ASCR2_GR5_3 \
        ( ( uint32_t ) 0x00000100 ) /*!< GR5-3 selection bit */
    #define RI_ASCR2_GR4_1 \
        ( ( uint32_t ) 0x00000200 ) /*!< GR4-1 selection bit */
    #define RI_ASCR2_GR4_2 \
        ( ( uint32_t ) 0x00000400 ) /*!< GR4-2 selection bit */
    #define RI_ASCR2_GR4_3 \
        ( ( uint32_t ) 0x00000800 ) /*!< GR4-3 selection bit */
    #define RI_ASCR2_GR4_4 \
        ( ( uint32_t ) 0x00008000 ) /*!< GR4-4 selection bit */
    #define RI_ASCR2_CH0b                                   \
        ( ( uint32_t ) 0x00010000 ) /*!< CH0b selection bit \
                                     */
    #define RI_ASCR2_CH1b                                   \
        ( ( uint32_t ) 0x00020000 ) /*!< CH1b selection bit \
                                     */
    #define RI_ASCR2_CH2b                                   \
        ( ( uint32_t ) 0x00040000 ) /*!< CH2b selection bit \
                                     */
    #define RI_ASCR2_CH3b                                   \
        ( ( uint32_t ) 0x00080000 ) /*!< CH3b selection bit \
                                     */
    #define RI_ASCR2_CH6b                                   \
        ( ( uint32_t ) 0x00100000 ) /*!< CH6b selection bit \
                                     */
    #define RI_ASCR2_CH7b                                   \
        ( ( uint32_t ) 0x00200000 ) /*!< CH7b selection bit \
                                     */
    #define RI_ASCR2_CH8b                                   \
        ( ( uint32_t ) 0x00400000 ) /*!< CH8b selection bit \
                                     */
    #define RI_ASCR2_CH9b                                   \
        ( ( uint32_t ) 0x00800000 ) /*!< CH9b selection bit \
                                     */
    #define RI_ASCR2_CH10b \
        ( ( uint32_t ) 0x01000000 ) /*!< CH10b selection bit */
    #define RI_ASCR2_CH11b \
        ( ( uint32_t ) 0x02000000 ) /*!< CH11b selection bit */
    #define RI_ASCR2_CH12b \
        ( ( uint32_t ) 0x04000000 ) /*!< CH12b selection bit */
    #define RI_ASCR2_GR6_3 \
        ( ( uint32_t ) 0x08000000 ) /*!< GR6-3 selection bit */
    #define RI_ASCR2_GR6_4 \
        ( ( uint32_t ) 0x10000000 ) /*!< GR6-4 selection bit */
    #define RI_ASCR2_GR5_4 \
        ( ( uint32_t ) 0x20000000 ) /*!< GR5-4 selection bit */

    /********************  Bit definition for RI_HYSCR1 register
     * ********************/
    #define RI_HYSCR1_PA                                                      \
        ( ( uint32_t ) 0x0000FFFF ) /*!< PA[15:0] Port A Hysteresis selection \
                                     */
    ...
    #define RI_HYSCR1_PB                                                      \
        ( ( uint32_t ) 0xFFFF0000 ) /*!< PB[15:0] Port B Hysteresis selection \
                                     */
     ...
     * ********************/
    #define RI_HYSCR2_PC                                                      \
        ( ( uint32_t ) 0x0000FFFF ) /*!< PC[15:0] Port C Hysteresis selection \
                                     */
    ...
    #define RI_HYSCR2_PD                                                      \
        ( ( uint32_t ) 0xFFFF0000 ) /*!< PD[15:0] Port D Hysteresis selection \
                                     */
     ...
     * ********************/
    #define RI_HYSCR2_PE                                                      \
        ( ( uint32_t ) 0x0000FFFF ) /*!< PE[15:0] Port E Hysteresis selection \
                                     */
    ...
    #define RI_HYSCR3_PF                                                      \
        ( ( uint32_t ) 0xFFFF0000 ) /*!< PF[15:0] Port F Hysteresis selection \
                                     */
     ...
     * ********************/
    #define RI_HYSCR4_PG                                                      \
        ( ( uint32_t ) 0x0000FFFF ) /*!< PG[15:0] Port G Hysteresis selection \
                                     */
    ...
    #define TIM_CR1_CMS                                                \
        ( ( uint16_t ) 0x0060 ) /*!<CMS[1:0] bits (Center-aligned mode \
                                   selection) */
    #define TIM_CR1_CMS_0 ( ( uint16_t ) 0x0020 ) /*!<Bit 0 */
    #define TIM_CR1_CMS_1 ( ( uint16_t ) 0x0040 ) /*!<Bit 1 */

    #define TIM_CR1_ARPE \
        ( ( uint16_t ) 0x0080 ) /*!<Auto-reload preload enable */
    ...
    #define TIM_SMCR_OCCS \
        ( ( uint16_t ) 0x0008 ) /*!<OCCS bits (OCref Clear Selection) */
    ...
    #define TIM_SMCR_ETPS                                            \
        ( ( uint16_t ) 0x3000 ) /*!<ETPS[1:0] bits (External trigger \
                                   prescaler) */
    ...
    #define TIM_SMCR_ETP \
        ( ( uint16_t ) 0x8000 ) /*!<External trigger polarity */

    /*******************  Bit definition for TIM_DIER register
     * *******************/
    #define TIM_DIER_UIE                                    \
        ( ( uint16_t ) 0x0001 ) /*!<Update interrupt enable \
                                 */
    ...
    #define TIM_CCMR1_CC1S                                            \
        ( ( uint16_t ) 0x0003 ) /*!<CC1S[1:0] bits (Capture/Compare 1 \
                                   Selection) */
    ...
    #define TIM_CCMR1_CC2S                                            \
        ( ( uint16_t ) 0x0300 ) /*!<CC2S[1:0] bits (Capture/Compare 2 \
                                   Selection) */
...
/*----------------------------------------------------------------------------*/
    ...
    #define TIM_CCMR1_IC1PSC                                          \
        ( ( uint16_t ) 0x000C ) /*!<IC1PSC[1:0] bits (Input Capture 1 \
                                   Prescaler) */
    ...
    #define TIM_CCMR1_IC2PSC                                          \
        ( ( uint16_t ) 0x0C00 ) /*!<IC2PSC[1:0] bits (Input Capture 2 \
                                   Prescaler) */
    ...
    #define TIM_CCMR2_CC3S                                            \
        ( ( uint16_t ) 0x0003 ) /*!<CC3S[1:0] bits (Capture/Compare 3 \
                                   Selection) */
    ...
    #define TIM_CCMR2_CC4S                                            \
        ( ( uint16_t ) 0x0300 ) /*!<CC4S[1:0] bits (Capture/Compare 4 \
                                   Selection) */
...
/*----------------------------------------------------------------------------*/
    ...
    #define TIM_CCMR2_IC3PSC                                          \
        ( ( uint16_t ) 0x000C ) /*!<IC3PSC[1:0] bits (Input Capture 3 \
                                   Prescaler) */
    ...
    #define TIM_CCMR2_IC4PSC                                          \
        ( ( uint16_t ) 0x0C00 ) /*!<IC4PSC[1:0] bits (Input Capture 4 \
                                   Prescaler) */
    ...
    #define TIM_CCER_CC1NP                                                 \
        ( ( uint16_t ) 0x0008 ) /*!<Capture/Compare 1 Complementary output \
                                   Polarity */
    ...
    #define TIM_CCER_CC2NP                                                 \
        ( ( uint16_t ) 0x0080 ) /*!<Capture/Compare 2 Complementary output \
                                   Polarity */
    ...
    #define TIM_CCER_CC3NP                                                 \
        ( ( uint16_t ) 0x0800 ) /*!<Capture/Compare 3 Complementary output \
                                   Polarity */
    ...
    #define TIM_CCER_CC4NP                                                 \
        ( ( uint16_t ) 0x8000 ) /*!<Capture/Compare 4 Complementary output \
                                   Polarity */
     ...
     * ********************/
    #define TIM_ARR_ARR                                      \
        ( ( uint16_t ) 0xFFFF ) /*!<actual auto-reload Value \
                                 */

    /*******************  Bit definition for TIM_CCR1 register
     * *******************/
    #define TIM_CCR1_CCR1                                   \
        ( ( uint16_t ) 0xFFFF ) /*!<Capture/Compare 1 Value \
                                 */

    /*******************  Bit definition for TIM_CCR2 register
     * *******************/
    #define TIM_CCR2_CCR2                                   \
        ( ( uint16_t ) 0xFFFF ) /*!<Capture/Compare 2 Value \
                                 */

    /*******************  Bit definition for TIM_CCR3 register
     * *******************/
    #define TIM_CCR3_CCR3                                   \
        ( ( uint16_t ) 0xFFFF ) /*!<Capture/Compare 3 Value \
                                 */

    /*******************  Bit definition for TIM_CCR4 register
     * *******************/
    #define TIM_CCR4_CCR4                                   \
        ( ( uint16_t ) 0xFFFF ) /*!<Capture/Compare 4 Value \
                                 */
    ...
    #define TIM_OR_TI1RMP \
        ( ( uint16_t ) 0x0003 ) /*!<Option register for TI1 Remapping */
    ...
    #define USART_SR_TXE \
        ( ( uint16_t ) 0x0080 ) /*!< Transmit Data Register Empty */
    #define USART_SR_LBD \
        ( ( uint16_t ) 0x0100 ) /*!< LIN Break Detection Flag */
    ...
    #define USART_CR1_OVER8 \
        ( ( uint16_t ) 0x8000 ) /*!< Oversampling by 8-bit mode */
    ...
    #define USART_CR2_STOP \
        ( ( uint16_t ) 0x3000 ) /*!< STOP[1:0] bits (STOP bits) */
    ...
    #define USART_CR3_EIE                                                      \
        ( ( uint16_t ) 0x0001 )                    /*!< Error Interrupt Enable \
                                                    */
    #define USART_CR3_IREN ( ( uint16_t ) 0x0002 ) /*!< IrDA mode Enable */
    #define USART_CR3_IRLP ( ( uint16_t ) 0x0004 ) /*!< IrDA Low-Power */
    #define USART_CR3_HDSEL \
        ( ( uint16_t ) 0x0008 ) /*!< Half-Duplex Selection */
    #define USART_CR3_NACK                                 \
        ( ( uint16_t ) 0x0010 ) /*!< Smartcard NACK enable \
                                 */
    #define USART_CR3_SCEN                                                    \
        ( ( uint16_t ) 0x0020 )                    /*!< Smartcard mode enable \
                                                    */
    #define USART_CR3_DMAR ( ( uint16_t ) 0x0040 ) /*!< DMA Enable Receiver */
    #define USART_CR3_DMAT \
        ( ( uint16_t ) 0x0080 ) /*!< DMA Enable Transmitter */
    #define USART_CR3_RTSE ( ( uint16_t ) 0x0100 ) /*!< RTS Enable */
    #define USART_CR3_CTSE ( ( uint16_t ) 0x0200 ) /*!< CTS Enable */
    #define USART_CR3_CTSIE                               \
        ( ( uint16_t ) 0x0400 ) /*!< CTS Interrupt Enable \
                                 */
    #define USART_CR3_ONEBIT \
        ( ( uint16_t ) 0x0800 ) /*!< One sample bit method enable */
    ...
    #define USB_EP0R_STAT_TX                                            \
        ( ( uint16_t ) 0x0030 ) /*!<STAT_TX[1:0] bits (Status bits, for \
    ...
    #define USB_EP0R_SETUP \
        ( ( uint16_t ) 0x0800 ) /*!<Setup transaction completed */

    #define USB_EP0R_STAT_RX                                            \
        ( ( uint16_t ) 0x3000 ) /*!<STAT_RX[1:0] bits (Status bits, for \
                                   reception transfers) */
    ...
    #define USB_CNTR_RESETM                              \
        ( ( uint16_t ) 0x0400 ) /*!<RESET Interrupt Mask \
                                 */
    #define USB_CNTR_SUSPM \
        ( ( uint16_t ) 0x0800 ) /*!<Suspend mode Interrupt Mask */
    #define USB_CNTR_WKUPM                                                  \
        ( ( uint16_t ) 0x1000 )                   /*!<Wakeup Interrupt Mask \
                                                   */
    ...
    #define USB_ISTR_DIR                                     \
        ( ( uint16_t ) 0x0010 ) /*!<Direction of transaction \
                                 */
    #define USB_ISTR_ESOF                                                      \
        ( ( uint16_t ) 0x0100 )                    /*!<Expected Start Of Frame \
                                                    */
    ...
    #define USB_FNR_RXDM \
        ( ( uint16_t ) 0x4000 ) /*!<Receive Data - Line Status */
    #define USB_FNR_RXDP \
        ( ( uint16_t ) 0x8000 ) /*!<Receive Data + Line Status */

    /******************  Bit definition for USB_DADDR register
     * *******************/
    #define USB_DADDR_ADD \
        ( ( uint8_t ) 0x7F ) /*!<ADD[6:0] bits (Device Address) */
    ...
    #define WWDG_CFR_EWI                                    \
        ( ( uint16_t ) 0x0200 ) /*!< Early Wakeup Interrupt \
                                 */

    /*******************  Bit definition for WWDG_SR register
     * ********************/
    #define WWDG_SR_EWIF \
        ( ( uint8_t ) 0x01 ) /*!< Early Wakeup Interrupt Flag */
    ...
    #define SysTick_CTRL_ENABLE \
        ( ( uint32_t ) 0x00000001 ) /*!< Counter enable */
    #define SysTick_CTRL_TICKINT                                              \
        ( ( uint32_t ) 0x00000002 ) /*!< Counting down to 0 pends the SysTick \
                                       handler */
    #define SysTick_CTRL_CLKSOURCE \
        ( ( uint32_t ) 0x00000004 ) /*!< Clock source */
    #define SysTick_CTRL_COUNTFLAG \
        ( ( uint32_t ) 0x00010000 ) /*!< Count Flag */

    /*****************  Bit definition for SysTick_LOAD register
     * *****************/
    #define SysTick_LOAD_RELOAD                                                \
        ( ( uint32_t ) 0x00FFFFFF ) /*!< Value to load into the SysTick        \
                                       Current Value Register when the counter \
                                       reaches 0 */

    /*****************  Bit definition for SysTick_VAL register
     * ******************/
    #define SysTick_VAL_CURRENT                                        \
        ( ( uint32_t ) 0x00FFFFFF ) /*!< Current value at the time the \
    ...
    #define SysTick_CALIB_SKEW                                               \
        ( ( uint32_t ) 0x40000000 ) /*!< Calibration value is not exactly 10 \
                                       ms */
    ...
    #define SCB_ICSR_RETTOBASE                                                 \
        ( ( uint32_t ) 0x00000800 ) /*!< All active exceptions minus the       \
                                       IPSR_current_exception yields the empty \
                                       set */
    ...
    #define SCB_ICSR_ISRPREEMPT                                                \
        ( ( uint32_t ) 0x00800000 ) /*!< It indicates that a pending interrupt \
                                       becomes active in the next running      \
                                       cycle */
    ...
    #define SCB_AIRCR_PRIGROUP0                                       \
        ( ( uint32_t ) 0x00000000 ) /*!< Priority group=0 (7 bits of  \
                                       pre-emption priority, 1 bit of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP1                                        \
        ( ( uint32_t ) 0x00000100 ) /*!< Priority group=1 (6 bits of   \
                                       pre-emption priority, 2 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP2                                        \
        ( ( uint32_t ) 0x00000200 ) /*!< Priority group=2 (5 bits of   \
                                       pre-emption priority, 3 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP3                                        \
        ( ( uint32_t ) 0x00000300 ) /*!< Priority group=3 (4 bits of   \
                                       pre-emption priority, 4 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP4                                        \
        ( ( uint32_t ) 0x00000400 ) /*!< Priority group=4 (3 bits of   \
                                       pre-emption priority, 5 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP5                                        \
        ( ( uint32_t ) 0x00000500 ) /*!< Priority group=5 (2 bits of   \
                                       pre-emption priority, 6 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP6                                        \
        ( ( uint32_t ) 0x00000600 ) /*!< Priority group=6 (1 bit of    \
                                       pre-emption priority, 7 bits of \
                                       subpriority) */
    #define SCB_AIRCR_PRIGROUP7                                           \
        ( ( uint32_t ) 0x00000700 ) /*!< Priority group=7 (no pre-emption \
                                       priority, 8 bits of subpriority) */

    #define SCB_AIRCR_ENDIANESS \
        ( ( uint32_t ) 0x00008000 ) /*!< Data endianness bit */
    #define SCB_AIRCR_VECTKEY                                              \
        ( ( uint32_t ) 0xFFFF0000 ) /*!< Register key (VECTKEY) - Reads as \
                                       0xFA05 (VECTKEYSTAT) */
    ...
    #define SCB_CCR_NONBASETHRDENA                                             \
        ( ( uint16_t ) 0x0001 ) /*!< Thread mode can be entered from any level \
                                   in Handler mode by controlled return value  \
                                 */
    #define SCB_CCR_USERSETMPEND                                             \
        ( ( uint16_t ) 0x0002 ) /*!< Enables user code to write the Software \
                                   Trigger Interrupt register to trigger     \
                                   (pend) a Main exception */
    #define SCB_CCR_UNALIGN_TRP \
        ( ( uint16_t ) 0x0008 ) /*!< Trap for unaligned access */
    #define SCB_CCR_DIV_0_TRP \
        ( ( uint16_t ) 0x0010 ) /*!< Trap on Divide by 0 */
    #define SCB_CCR_BFHFNMIGN \
        ( ( uint16_t ) 0x0100 ) /*!< Handlers running at priority -1 and -2 */
    #define SCB_CCR_STKALIGN                                                  \
        ( ( uint16_t ) 0x0200 ) /*!< On exception entry, the SP used prior to \
                                   the exception is adjusted to be 8-byte     \
                                   aligned */

    /*******************  Bit definition for SCB_SHPR register
     * ********************/
    #define SCB_SHPR_PRI_N                                                    \
        ( ( uint32_t ) 0x000000FF ) /*!< Priority of system handler 4,8,      \
                                       and 12. Mem Manage, reserved and Debug \
                                       Monitor */
    #define SCB_SHPR_PRI_N1                                              \
        ( ( uint32_t ) 0x0000FF00 ) /*!< Priority of system handler 5,9, \
                                       and 13. Bus Fault, reserved and   \
                                       reserved */
    #define SCB_SHPR_PRI_N2                                               \
        ( ( uint32_t ) 0x00FF0000 ) /*!< Priority of system handler 6,10, \
                                       and 14. Usage Fault, reserved and  \
                                       PendSV */
    #define SCB_SHPR_PRI_N3                                               \
        ( ( uint32_t ) 0xFF000000 ) /*!< Priority of system handler 7,11, \
                                       and 15. Reserved, SVCall and SysTick */
    ...
    #define SCB_CFSR_MUNSTKERR \
        ( ( uint32_t ) 0x00000008 ) /*!< Unstacking error */
    #define SCB_CFSR_MSTKERR                            \
        ( ( uint32_t ) 0x00000010 ) /*!< Stacking error \
                                     */
    #define SCB_CFSR_MMARVALID                                          \
        ( ( uint32_t ) 0x00000080 ) /*!< Memory Manage Address Register \
                                       address valid flag */
    /*!< BFSR */
    ...
    #define SCB_CFSR_UNSTKERR \
        ( ( uint32_t ) 0x00000800 )                     /*!< Unstacking error */
    #define SCB_CFSR_STKERR ( ( uint32_t ) 0x00001000 ) /*!< Stacking error */
    #define SCB_CFSR_BFARVALID                                              \
        ( ( uint32_t ) 0x00008000 ) /*!< Bus Fault Address Register address \
                                       valid flag */
    /*!< UFSR */
    ...
    #define SCB_CFSR_INVSTATE                                            \
        ( ( uint32_t ) 0x00020000 ) /*!< Invalid combination of EPSR and \
                                       instruction */
    #define SCB_CFSR_INVPC                                                  \
        ( ( uint32_t ) 0x00040000 ) /*!< Attempt to load EXC_RETURN into pc \
                                       illegally */
    #define SCB_CFSR_NOCP                                             \
        ( ( uint32_t ) 0x00080000 ) /*!< Attempt to use a coprocessor \
                                       instruction */
    #define SCB_CFSR_UNALIGNED                                                 \
        ( ( uint32_t ) 0x01000000 ) /*!< Fault occurs when there is an attempt \
                                       to make an unaligned memory access */
    #define SCB_CFSR_DIVBYZERO                                                 \
        ( ( uint32_t ) 0x02000000 ) /*!< Fault occurs when SDIV or DIV         \
                                       instruction is used with a divisor of 0 \
                                     */

    /*******************  Bit definition for SCB_HFSR register
     * *******************/
    #define SCB_HFSR_VECTTBL                                                   \
        ( ( uint32_t ) 0x00000002 ) /*!< Fault occures because of vector table \
                                       read on exception processing */
    #define SCB_HFSR_FORCED                                                \
        ( ( uint32_t ) 0x40000000 ) /*!< Hard Fault activated when a       \
                                       configurable Fault was received and \
                                       cannot activate */
