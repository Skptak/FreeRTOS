...
typedef struct
{
    ...
    uint32_t RTC_SynchPrediv; /*!< Specifies the RTC Synchronous Predivider
                              value. This parameter must be set to a value lower
                              than 0x7FFF */
} RTC_InitTypeDef;
 ...
 */
    ...
    #define RTC_TamperSamplingFreq_RTCCLK_Div16384                           \
        ( ( uint32_t ) 0x000000100 ) /*!< Each of the tamper inputs are      \
 ...
 */
    ...
    #define IS_RTC_TAMPER( TAMPER )                               \
        ( ( ( ( TAMPER ) & ( uint32_t ) 0xFFFFFFD6 ) == 0x00 ) && \
 ...
 */
    ...
    #define IS_RTC_BKP( BKP )                                           \
        ( ( ( BKP ) == RTC_BKP_DR0 ) || ( ( BKP ) == RTC_BKP_DR1 ) ||   \
          ...
          ( ( BKP ) == RTC_BKP_DR20 ) || ( ( BKP ) == RTC_BKP_DR21 ) || \
          ( ( BKP ) == RTC_BKP_DR22 ) || ( ( BKP ) == RTC_BKP_DR23 ) || \
          ( ( BKP ) == RTC_BKP_DR24 ) || ( ( BKP ) == RTC_BKP_DR25 ) || \
          ( ( BKP ) == RTC_BKP_DR26 ) || ( ( BKP ) == RTC_BKP_DR27 ) || \
          ( ( BKP ) == RTC_BKP_DR28 ) || ( ( BKP ) == RTC_BKP_DR29 ) || \
    ...
    #define RTC_IT_TAMP                                               \
        ( ( uint32_t ) 0x00000004 ) /* Used only to Enable the Tamper \
                                       Interrupt */
