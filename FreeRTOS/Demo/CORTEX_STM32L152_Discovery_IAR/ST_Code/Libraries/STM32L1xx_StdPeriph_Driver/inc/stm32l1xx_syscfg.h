 ...
 */
    ...
    #define IS_RI_INPUTCAPTURE( INPUTCAPTURE )                          \
        ( ( ( ( INPUTCAPTURE ) & ( uint32_t ) 0xFFC2FFFF ) == 0x00 ) && \
          ( ( INPUTCAPTURE ) != ( uint32_t ) 0x00 ) )
/**
 * @}
 */
 ...
 */
    ...
    #define TIM_Select_TIM2                               \
        ( ( uint32_t ) 0x00010000 ) /*!< Timer 2 selected \
                                     */
    #define TIM_Select_TIM3                               \
        ( ( uint32_t ) 0x00020000 ) /*!< Timer 3 selected \
                                     */
    #define TIM_Select_TIM4                               \
        ( ( uint32_t ) 0x00030000 ) /*!< Timer 4 selected \
                                     */

    #define IS_RI_TIM( TIM )                                                  \
        ( ( ( TIM ) == TIM_Select_None ) || ( ( TIM ) == TIM_Select_TIM2 ) || \
          ( ( TIM ) == TIM_Select_TIM3 ) || ( ( TIM ) == TIM_Select_TIM4 ) )
...
/* TIMx_IC1 TIMx_IC2  TIMx_IC3  TIMx_IC4 */
    #define RI_InputCaptureRouting_0 \
        ( ( uint32_t ) 0x00000000 ) /* PA0       PA1      PA2       PA3 */
    #define RI_InputCaptureRouting_1 \
        ( ( uint32_t ) 0x00000001 ) /* PA4       PA5      PA6       PA7 */
    #define RI_InputCaptureRouting_2 \
        ( ( uint32_t ) 0x00000002 ) /* PA8       PA9      PA10      PA11 */
    #define RI_InputCaptureRouting_3 \
        ( ( uint32_t ) 0x00000003 ) /* PA12      PA13     PA14      PA15 */
    #define RI_InputCaptureRouting_4 \
        ( ( uint32_t ) 0x00000004 ) /* PC0       PC1      PC2       PC3 */
    #define RI_InputCaptureRouting_5 \
        ( ( uint32_t ) 0x00000005 ) /* PC4       PC5      PC6       PC7 */
    #define RI_InputCaptureRouting_6 \
        ( ( uint32_t ) 0x00000006 ) /* PC8       PC9      PC10      PC11 */
    #define RI_InputCaptureRouting_7 \
        ( ( uint32_t ) 0x00000007 ) /* PC12      PC13     PC14      PC15 */
    #define RI_InputCaptureRouting_8 \
        ( ( uint32_t ) 0x00000008 ) /* PD0       PD1      PD2       PD3 */
    #define RI_InputCaptureRouting_9 \
        ( ( uint32_t ) 0x00000009 ) /* PD4       PD5      PD6       PD7 */
    #define RI_InputCaptureRouting_10 \
        ( ( uint32_t ) 0x0000000A ) /* PD8       PD9      PD10      PD11 */
    #define RI_InputCaptureRouting_11 \
        ( ( uint32_t ) 0x0000000B ) /* PD12      PD13     PD14      PD15 */
    #define RI_InputCaptureRouting_12 \
        ( ( uint32_t ) 0x0000000C ) /* PE0       PE1      PE2       PE3 */
    #define RI_InputCaptureRouting_13 \
        ( ( uint32_t ) 0x0000000D ) /* PE4       PE5      PE6       PE7 */
    #define RI_InputCaptureRouting_14 \
        ( ( uint32_t ) 0x0000000E ) /* PE8       PE9      PE10      PE11 */
    #define RI_InputCaptureRouting_15 \
        ( ( uint32_t ) 0x0000000F ) /* PE12      PE13     PE14      PE15 */
    ...
    #define RI_IOSwitch_VCOMP                                                \
        ( ( uint32_t ) 0x84000000 ) /* VCOMP is an internal switch used to   \
                                       connect selected channel to COMP1 non \
                                       inverting input */
 ...
 */
    ...
    #define IS_RI_PORT( PORT )                                    \
        ( ( ( PORT ) == RI_PortA ) || ( ( PORT ) == RI_PortB ) || \
          ( ( PORT ) == RI_PortC ) || ( ( PORT ) == RI_PortD ) || \
          ( ( PORT ) == RI_PortE ) || ( ( PORT ) == RI_PortF ) || \
          ( ( PORT ) == RI_PortG ) )
    /**
     * @}
     */
...
/*  Function used to set the SYSCFG and RI configuration to the default reset
 * state **/
