 ...
 */
    ...
    #define RCC_RTCCLKSource_HSE_Div4 \
        ( ( uint32_t ) RCC_CSR_RTCSEL_HSE | RCC_CR_RTCPRE_0 )
    #define RCC_RTCCLKSource_HSE_Div8 \
        ( ( uint32_t ) RCC_CSR_RTCSEL_HSE | RCC_CR_RTCPRE_1 )
    #define RCC_RTCCLKSource_HSE_Div16 \
        ( ( uint32_t ) RCC_CSR_RTCSEL_HSE | RCC_CR_RTCPRE )
 ...
 */
    ...
    #define IS_RCC_AHB_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0xB4FF6F00 ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
 ...
 */
    ...
    #define IS_RCC_APB2_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0xFFFFA5E2 ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
/**
 * @}
 */
 ...
 */
    ...
    #define IS_RCC_APB1_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0x4F0135C0 ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
/**
 * @}
 */
