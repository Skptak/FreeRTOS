...
@verbatim
 ...
 ===============================================================================
    [..] This driver provides functions for:
         ...
         (#) Routing of I/Os toward the input captures of timers (TIM2, TIM3 and
TIM4).
...
#define IC_ROUTING_MASK \
    ( ( uint32_t ) 0x0000000F ) /*!< Input Capture routing mask */
 ...
 *                                for EXTI lines where x can be (A, B, C, D, E,
 * F, G or H).
 ...
 * @param  RI_InputCaptureRouting: selects which pin to be routed to Input
 * Capture. This parameter can be one of the following values:
 * @param  RI_InputCaptureRouting_0 to RI_InputCaptureRouting_15
 *     e.g.
 *       SYSCFG_RITIMSelect(TIM_Select_TIM2)
 *       SYSCFG_RITIMInputCaptureConfig(RI_InputCapture_IC1,
 * RI_InputCaptureRouting_1) allows routing of Input capture IC1 of TIM2 to PA4.
 ...
 *         or DISABLE: ADC analog switches open or controlled by the ADC
 * interface. When using the ADC for acquisition, switch control mode must be
 * disabled.
 ...
 * A..E When the I/Os are programmed in input mode by standard I/O port
 ...
 *    This parameter can any value from RI_Pin_x where x can be (0..15) or
 * RI_Pin_All.
