 ...
 *   This parameter can be one of the following values:
 *     @arg TIM_OPMode_Single:: TIM One Pulse Single Mode (Counter stops
 * counting at the next update event (clearing the bit CEN)).
 ...
 * @param  TIMx: where x can be  2, 3, 4, 5, 9, 10 or 11 to select the TIM
 * peripheral.
 ...
 *   This parameter can be one of the following values:
 *     @arg TIM_OCReferenceClear_ETRF: The internal OCreference clear input is
 * connected to ETRF.
 *     @arg TIM_OCReferenceClear_OCREFCLR: The internal OCreference clear input
 * is connected to OCREF_CLR input.
 * @retval None
 */
...
@verbatim
 ...
 ===============================================================================
    [..] To use the Timer in Input Capture mode, the following steps are
mandatory:
...
configuration:
         ...
         (#) Enable the corresponding interrupt (or DMA request) to read
             the Captured value, using the function TIM_ITConfig(TIMx,
TIM_IT_CCx) (or TIM_DMA_Cmd(TIMx, TIM_DMA_CCx)).
         (#) Call the TIM_Cmd(ENABLE) function to enable the TIM counter.
 ...
 * @note TIM_IT_CC2, TIM_IT_CC3, TIM_IT_CC4 and TIM_IT_Trigger can not be used
 * with TIM10 and TIM11.
 ...
 * @note TIM10 and TIM11 can only generate an update event and Capture Compare 1
 * event.
 * @retval None
 */
 ...
 * @note TIM9 can have only update flag, TIM_FLAG_CC1, TIM_FLAG_CC2 and
 * TIM_FLAG_Trigger, TIM_FLAG_CC1OF or TIM_FLAG_CC2OF flags.
 * @note TIM10 and TIM11 can have only update flag, TIM_FLAG_CC1 or
 * TIM_FLAG_CC1OF flags
 ...
 * @note TIM6 and TIM7 can have only one update flag.
 * @note TIM9 can have only update flag, TIM_FLAG_CC1, TIM_FLAG_CC2 and
 * TIM_FLAG_Trigger flags TIM_FLAG_CC1OF or TIM_FLAG_CC2OF flags.
...
/**
  ...
  * @param  TIMx: where x can be 2, 3, 4, 5, 6, 7 or 9 to select the TIM
  peripheral.
  * @param  TIM_TRGOSource: specifies the Trigger Output source.
  *   This paramter can be one of the following values:
  *
  *  @param For all TIMx
  *     @arg TIM_TRGOSource_Reset:  The UG bit in the TIM_EGR register is used
  ...
  *     @arg TIM_TRGOSource_OC1: The trigger output sends a positive pulse when
  the CC1IF flag
  *                              is to be set, as soon as a capture or compare
  match occurs (TRGO).
 ...
 *   This parameter can be one of the following values:
 *     @arg TIM2_TIM10_OC: TIM2 ITR1 is connected to TIM10 output
 * compare(default).
 *     @arg TIM2_TIM5_TRGO: TIM2 ITR1 is connected to TIM5 Trigger output.
 *     @arg TIM3_TIM11_OC: TIM3 ITR2 is connected to TIM11 output
 * compare(default).
 *     @arg TIM3_TIM5_TRGO: TIM3 ITR2 is connected to TIM5 Trigger output.
 *     @arg TIM9_GPIO: TIM9 Channel 1 is connected to dedicated Timer
 * pin(default).
 ...
 *     @arg TIM10_GPIO: TIM10 Channel 1 is connected to dedicated Timer
 * pin(default).
 ...
 *     @arg TIM10_ETR_TIM9_TRGO: TIM10 ETR input is connected to TIM9 Trigger
 * Output.
 *     @arg TIM11_GPIO: TIM11 Channel 1 is connected to dedicated Timer
 * pin(default).
 ...
 *     @arg TIM11_ETR_TIM9_TRGO: TIM11 ETR input is connected to TIM9 Trigger
 * Output.
 * @retval None
 */
 ...
 * @param  TIMx: where x can be 2, 3, 4, 9, 10 or 11 to select the TIM
 * peripheral.
