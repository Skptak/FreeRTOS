...
ErrorStatus RTC_DeInit( void )
{
    ...
    else
    {
        ...
        do
        {
            ...
            wutcounter++;
        } while( ( wutcounter != INITMODE_TIMEOUT ) &&
                 ( wutwfstatus == 0x00 ) );
 ...
 *                with a 2-ppm step.
 *                This value should be between 0 and 126 when using positive
