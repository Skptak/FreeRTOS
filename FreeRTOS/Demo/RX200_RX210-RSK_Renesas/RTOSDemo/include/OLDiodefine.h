...
enum enum_ir
{
    ...
    IR_ICU_IRQ6,
    IR_ICU_IRQ7,
    IR_LVDCMPA_LVD1COMPA1 = 88,
    IR_LVDCMPA_LVD1COMPA2,
    IR_RTC_ALM = 92,
    IR_RTC_PRD,
    IR_S12AD_S12ADI = 102,
    IR_S12AD_GBADI,
...
enum enum_dtce
{
    ...
    DTCE_ICU_IRQ6,
    DTCE_ICU_IRQ7,
    DTCE_LVDCMPA_LVD1COMPA1 = 88,
    DTCE_LVDCMPA_LVD1COMPA2,
    DTCE_S12AD_S12ADI = 102,
    DTCE_S12AD_GBADI,
...
{
    IPR_BSC_BUSERR = 0x00,
    IPR_FCUIF_FCUERR = 0x01,
    IPR_FCUIF_FRDYI = 0x02,
    IPR_ICU_SWINT = 0x03,
    IPR_CMT0_CMI0 = 0x04,
    IPR_CMT1_CMI1 = 0x05,
    IPR_CMT2_CMI2 = 0x06,
    ...
    IPR_CAC_MENDF = 0x33,
    IPR_CAC_OVFF = 0x34,
    IPR_RSPI0_SPEI2 = 0x44,
    IPR_RSPI0_SPRI0 = 0x44,
    IPR_RSPI0_SPTI0 = 0x44,
    IPR_RSPI0_SPII0 = 0x44,
    IPR_DOC_DOPCF = 0x57,
    ...
    IPR_ICU_IRQ6 = 0x70,
    IPR_ICU_IRQ7 = 0x71,
    IPR_LVDCMPA_LVD1COMPA1 = 0x88,
    IPR_LVDCMPA_LVD1COMPA2 = 0x89,
    IPR_RTC_ALM = 0x92,
    IPR_RTC_PRD = 0x93,
    IPR_S12AD_S12ADI = 0x102,
    IPR_S12AD_GBADI = 0x103,
    IPR_ELC_ELSR18I = 0x106,
    IPR_ELC_ELSR19I = 0x107,
    IPR_MTU0_TGIA0 = 0x114,
    IPR_MTU0_TGIB0 = 0x114,
    IPR_MTU0_TGIC0 = 0x114,
    IPR_MTU0_TGID0 = 0x114,
    IPR_MTU0_TGIV0 = 0x118,
    IPR_MTU0_TGIE0 = 0x118,
    IPR_MTU0_TGIF0 = 0x118,
    IPR_MTU1_TGIA1 = 0x121,
    IPR_MTU1_TGIB1 = 0x121,
    IPR_MTU1_TGIV1 = 0x123,
    IPR_MTU1_TGIU1 = 0x123,
    IPR_MTU2_TGIA2 = 0x125,
    IPR_MTU2_TGIB2 = 0x125,
    IPR_MTU2_TGIV2 = 0x127,
    IPR_MTU2_TGIU2 = 0x127,
    IPR_MTU3_TGIA3 = 0x129,
    IPR_MTU3_TGIB3 = 0x129,
    IPR_MTU3_TGIC3 = 0x129,
    IPR_MTU3_TGID3 = 0x129,
    IPR_MTU3_TGIV3 = 0x133,
    IPR_MTU4_TGIA4 = 0x134,
    IPR_MTU4_TGIB4 = 0x134,
    IPR_MTU4_TGIC4 = 0x134,
    IPR_MTU4_TGID4 = 0x134,
    IPR_MTU4_TGIV4 = 0x138,
    IPR_MTU5_TGIU5 = 0x139,
    IPR_MTU5_TGIV5 = 0x139,
    IPR_MTU5_TGIW5 = 0x139,
    IPR_POE_OEI1 = 0x170,
    IPR_POE_OEI2 = 0x171,
    IPR_TMR0_CMIA0 = 0x174,
    IPR_TMR0_CMIB0 = 0x174,
    IPR_TMR0_OVI0 = 0x174,
    IPR_TMR1_CMIA1 = 0x177,
    IPR_TMR1_CMIB1 = 0x177,
    IPR_TMR1_OVI1 = 0x177,
    IPR_TMR2_CMIA2 = 0x180,
    IPR_TMR2_CMIB2 = 0x180,
    IPR_TMR2_OVI2 = 0x180,
    IPR_TMR3_CMIA3 = 0x183,
    IPR_TMR3_CMIB3 = 0x183,
    IPR_TMR3_OVI3 = 0x183,
    IPR_DMAC_DMAC0I = 0x198,
    IPR_DMAC_DMAC1I = 0x199,
    IPR_DMAC_DMAC2I = 0x200,
    IPR_DMAC_DMAC3I = 0x201,
    IPR_SCI0_ERI0 = 0x214,
    IPR_SCI0_RXI0 = 0x214,
    IPR_SCI0_TXI0 = 0x214,
    IPR_SCI0_TEI0 = 0x214,
    ...
    IPR_SCI9_TXI9 = 0x234,
    IPR_SCI9_TEI9 = 0x234,
    IPR_SCI12_ERI12 = 0x238,
    IPR_SCI12_RXI12 = 0x238,
    IPR_SCI12_TXI12 = 0x238,
    IPR_SCI12_TEI12 = 0x238,
    IPR_SCI12_SCIX0 = 0x242,
    IPR_SCI12_SCIX1 = 0x243,
    IPR_SCI12_SCIX2 = 0x244,
    IPR_SCI12_SCIX3 = 0x245,
    IPR_RIIC0_EEI0 = 0x246,
    IPR_RIIC0_RXI0 = 0x247,
    IPR_RIIC0_TXI0 = 0x248,
    IPR_RIIC0_TEI0 = 0x249,
    IPR_MTU0_TGI = 0x118,
    IPR_MTU1_TGI = 0x123,
    IPR_MTU2_TGI = 0x127,
    IPR_MTU5_ = 0x139,
