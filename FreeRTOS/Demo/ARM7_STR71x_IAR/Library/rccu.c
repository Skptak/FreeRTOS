 ...
 * Input          : New_Mul ( RCCU_PLL1_Mul_12, RCCU_PLL1_Mul_16,
 *RCCU_PLL1_Mul_20, RCCU_PLL1_Mul_24 ) : New_Div ( RCCU_Div_1, RCCU_Div_2,
 *RCCU_Div_3, RCCU_Div_4, RCCU_Div_5, RCCU_Div_6, RCCU_Div_7) Return         :
 *None
 *******************************************************************************/
 ...
 * Input          : New_Mul ( RCCU_PLL2_Mul_12, RCCU_PLL2_Mul_16,
 *RCCU_PLL2_Mul_20, RCCU_Mul_PLL2_28 ) : New_Div ( RCCU_Div_1, RCCU_Div_2,
 *RCCU_Div_3, RCCU_Div_4, RCCU_Div_5, RCCU_Div_6, RCCU_Div_7) Return         :
 *None
 *******************************************************************************/
...
void RCCU_RCLKSourceConfig( RCCU_RCLK_Clocks New_Clock )
{
    switch( New_Clock )
    {
        ...
        { // Resets the CSU_Cksel bit in clk_flag
            ...
            // switch off the PLL1
            RCCU->PLL1CR = ( ( RCCU->PLL1CR & ~RCCU_DX_Mask ) | 0x00000003 ) &
                           ~RCCU_FREEN_Mask;
            break;
        }
        case RCCU_CLOCK2_16:
 ...
 * Input          : RCCU_Clocks ( RCCU_CLK2, RCCU_RCLK, RCCU_MCLK, RCCU_PCLK,
 *RCCU_FCLK ) Return         : u32
 *******************************************************************************/
