 ...
 * Description    : This routine is used to force the Device to enter in WFI
 *mode Input 1        : CLOCK2_16 : Clock2_16 as system clock for WFI mode
 *                  EXTERNAL  : external clock as system clock for WFI mode
 * Input 2        : ENABLE : Enable Low Power Regulator during Wait For
 *Interrupt Mode DISABLE: Disable Low Power Regulator during Wait For Interrupt
 *Mode Input 3        : ENABLE : Enable Low Power Mode during Wait For Interrupt
 *Mode DISABLE: Disable Low Power Mode during Wait For Interrupt Mode Return :
 *None
 *******************************************************************************/
