 ...
 * Input          : New_Clock : RCCU_DEFAULT, RCCU_RCLK_2, RCCU_RCLK_4,
 *RCCU_RCLK_8 Return         : None
 *******************************************************************************/
...
{
    PCU->PDIVR = ( PCU->PDIVR & ~RCCU_FACT2_Mask ) |
                 ( New_Clock << RCCU_FACT2_Index );
}
...
{
    PCU->PLL2CR = ( PCU->PLL2CR & ~RCCU_USBEN_Mask ) |
                  ( New_Clock << RCCU_USBEN_Index );
}
