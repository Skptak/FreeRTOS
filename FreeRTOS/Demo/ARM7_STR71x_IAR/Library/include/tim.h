 ...
 *                       - TIM_INTERNAL : The TIM is clocked by the APB2
 *frequency divided by the prescaler value.
 *                       - TIM_EXTERNAL : The TIM is clocked by an external
 *Clock Return         : None
 *******************************************************************************/
 ...
 * Input          : TIM Timer
 *                : TIM_Clock_Edges : Specifies the active adge of the external
 *clock
 ...
 * Input          : TIM Timer
 * Output         : TIM_Clock_Edges : Specifies the active adge of the external
 *clock
 *                  - TIM_RISING  : The rising  edge
 *                  - TIM_FALLING : The falling edge
 *******************************************************************************/
