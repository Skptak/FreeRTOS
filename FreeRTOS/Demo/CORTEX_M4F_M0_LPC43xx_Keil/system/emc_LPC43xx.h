...
enum
{
    ...
    #define PART_WIDTH \
        ( PART_WIDTH_16 ) // part width (possibly smaller than EXT_WIDTH, e.g.
                          // two 8-bit chips cascaded as 16-bit memory.
    ...
    #define PART_WIDTH \
        ( PART_WIDTH_32 ) // part width (possibly smaller than EXT_WIDTH, e.g.
                          // two 8-bit chips cascaded as 16-bit memory.
