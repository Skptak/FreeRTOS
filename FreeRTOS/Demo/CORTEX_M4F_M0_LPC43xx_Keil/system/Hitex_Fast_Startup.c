/**********************************************************************
 * $Id: Hitex_Fast_Startup.c 8763 2011-12-08 00:45:50Z nxp21346 $
 * lpc43xx_emc.c 2011-12-07
 *//**
* @file		lpc43xx_emc.c
...
void Hitex_CGU_Init( void )
{
    ...
    vEMC_InitSRDRAM( SDRAM_BASE_ADDR,
                     SDRAM_WIDTH,
                     SDRAM_SIZE_MBITS,
                     SDRAM_DATA_BUS_BITS,
                     SDRAM_COL_ADDR_BITS );
    ...
    /* IO pins */
    LPC_SCU->SFSP3_4 = LPC_SCU->SFSP3_5 = LPC_SCU
                                              ->SFSP3_6 = LPC_SCU
                                                              ->SFSP3_7 = 0xD3;
