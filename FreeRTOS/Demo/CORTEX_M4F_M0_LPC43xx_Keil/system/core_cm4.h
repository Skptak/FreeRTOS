...
extern "C" {
    ...
    /** \mainpage CMSIS Cortex-M4
      ...
      This documentation describes the CMSIS Cortex-M Core Peripheral Access
    ...
    #define __CM4_CMSIS_VERSION_MAIN \
        ( 0x02 ) /*!< [31:16] CMSIS HAL main version */
    ...
    #define __CORTEX_M ( 0x04 ) /*!< Cortex core                    */
        ...
        #define __NVIC_PRIO_BITS \
            3 /*!< standard definition for NVIC Priority Bits */
    #endif
...
typedef struct
{
    ...
    __IO uint32_t ICSR;  /*!< Offset: 0x004 (R/W)  Interrupt Control State
                            Register                      */
    __IO uint32_t VTOR;  /*!< Offset: 0x008 (R/W)  Vector Table Offset Register
                          */
    __IO uint32_t AIRCR; /*!< Offset: 0x00C (R/W)  Application Interrupt / Reset
                            Control Register        */
...
typedef struct
{
    ...
    __IO uint32_t IRR;  /*!< Offset:       (R/W)  ITM Integration Read Register
                         */
    __IO uint32_t IMCR; /*!< Offset:       (R/W)  ITM Integration Mode Control
                           Register     */
    uint32_t RESERVED4[ 43 ];
    __IO uint32_t LAR; /*!< Offset:       (R/W)  ITM Lock Access Register */
    __IO uint32_t LSR; /*!< Offset:       (R/W)  ITM Lock Status Register */
    uint32_t RESERVED5[ 6 ];
    __I uint32_t PID4; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #4 */
    __I uint32_t PID5; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #5 */
    __I uint32_t PID6; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #6 */
    __I uint32_t PID7; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #7 */
    __I uint32_t PID0; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #0 */
    __I uint32_t PID1; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #1 */
    __I uint32_t PID2; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #2 */
    __I uint32_t PID3; /*!< Offset:       (R/ )  ITM Peripheral Identification
                          Register #3 */
    __I uint32_t CID0; /*!< Offset:       (R/ )  ITM Component  Identification
                          Register #0 */
    __I uint32_t CID1; /*!< Offset:       (R/ )  ITM Component  Identification
                          Register #1 */
    __I uint32_t CID2; /*!< Offset:       (R/ )  ITM Component  Identification
                          Register #2 */
    __I uint32_t CID3; /*!< Offset:       (R/ )  ITM Component  Identification
                          Register #3 */
} ITM_Type;
...
typedef struct
{
    ...
    __IO uint32_t ACTLR; /*!< Offset: 0x008 (R/W)  Auxiliary Control Register */
        ...
        #define IntType_ICTR_INTLINESNUM_Pos \
            0 /*!< InterruptType ICTR: INTLINESNUM Position */
        #define IntType_ICTR_INTLINESNUM_Msk                                \
            ( 0x1FUL << IntType_ICTR_INTLINESNUM_Pos ) /*!< InterruptType   \
                                                          ICTR: INTLINESNUM \
                                                          Mask */

        /* Auxiliary Control Register Definitions */
        #define IntType_ACTLR_DISFOLD_Pos \
            2 /*!< InterruptType ACTLR: DISFOLD Position */
        #define IntType_ACTLR_DISFOLD_Msk                                  \
            ( 1UL << IntType_ACTLR_DISFOLD_Pos ) /*!< InterruptType ACTLR: \
                                                    DISFOLD Mask */

        #define IntType_ACTLR_DISDEFWBUF_Pos \
            1 /*!< InterruptType ACTLR: DISDEFWBUF Position */
        #define IntType_ACTLR_DISDEFWBUF_Msk                                  \
            ( 1UL << IntType_ACTLR_DISDEFWBUF_Pos ) /*!< InterruptType ACTLR: \
                                                       DISDEFWBUF Mask */

        #define IntType_ACTLR_DISMCYCINT_Pos \
            0 /*!< InterruptType ACTLR: DISMCYCINT Position */
        #define IntType_ACTLR_DISMCYCINT_Msk                                  \
            ( 1UL << IntType_ACTLR_DISMCYCINT_Pos ) /*!< InterruptType ACTLR: \
                                                       DISMCYCINT Mask */
...
typedef struct
{
    ...
    __IO uint32_t RASR_A3; /*!< Offset: 0x028 (R/W)  MPU Alias 3 Region
            ...
            #define MPU_RASR_XN_Msk \
                ( 1UL << MPU_RASR_XN_Pos ) /*!< MPU RASR: XN Mask */

            #define MPU_RASR_AP_Pos 24 /*!< MPU RASR: AP Position */
            #define MPU_RASR_AP_Msk \
                ( 7UL << MPU_RASR_AP_Pos ) /*!< MPU RASR: AP Mask */

            #define MPU_RASR_TEX_Pos 19 /*!< MPU RASR: TEX Position */
            #define MPU_RASR_TEX_Msk \
                ( 7UL << MPU_RASR_TEX_Pos ) /*!< MPU RASR: TEX Mask */
            ...
            #define MPU_RASR_B_Pos                        \
                16 /*!< MPU RASR: Bufferable bit Position \
                    */
            ...
            #define MPU_RASR_ENA_Pos \
                0 /*!< MPU RASR: Region enable bit Position */
            #define MPU_RASR_ENA_Msk                                           \
                ( 0x1UL << MPU_RASR_ENA_Pos ) /*!< MPU RASR: Region enable bit \
                                                 Disable Mask */
...
typedef struct
{
    ...
    __IO uint32_t MVFR0;  /*!< Offset: 0x010 (R/W)  Media and VFP feature
                             register 0                      */
    __IO uint32_t MVFR1;  /*!< Offset: 0x014 (R/W)  Media and VFP feature
                             register 1                      */
} FPU_Type;
...
extern volatile int32_t ITM_RxBuffer; /*!< external variable to receive
        ...
        #define ITM_RXBUFFER_EMPTY                                           \
            0x5AA55AA5 /*!< value identifying ITM_RxBuffer is ready for next \
                          character */
