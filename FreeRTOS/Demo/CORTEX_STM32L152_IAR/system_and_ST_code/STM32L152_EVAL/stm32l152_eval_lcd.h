 ...
 *stm32l152_eval_lcd firmware driver.
 ******************************************************************************
 * @copy
 *
 ...
 *        display a bitmap picture on the LCD. This function assumes that the
 * bitmap file is loaded in the SPI Flash (mounted on STM32L152-EVAL board),
 * however user can tailor it according to his application hardware requirement.
 */
/*#define USE_LCD_DrawBMP*/

/**
 * @brief Uncomment the line below if you want to use user defined Delay
 * function (for precise timing), otherwise default _delay_ function defined
 * within this driver is used (less precise timing).
 */
/* #define USE_Delay */
        ...
        #define _delay_                                                       \
            Delay /* !< User can provide more timing precise _delay_ function \
                        (with 10ms time base), using SysTick for example */
    #else
        #define _delay_ \
            delay /* !< Default _delay_ function with less precise timing */
    #endif
