...
/*!< Uncomment the line corresponding to the desired System clock (SYSCLK)
   ...
   that:
     ...
     If you are using different crystal you have to adapt those functions
   accordingly.
    */
...
uint32_t SystemCoreClock = SYSCLK_FREQ_HSI; /*!< System Clock Frequency (Core
                                               Clock) */
...
uint32_t SystemCoreClock = SYSCLK_FREQ_4MHz; /*!< System Clock Frequency (Core
                                                Clock) */
    #elif defined SYSCLK_FREQ_8MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_8MHz; /*!< System Clock Frequency (Core
                                                Clock) */
    #elif defined SYSCLK_FREQ_16MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_16MHz; /*!< System Clock Frequency (Core
                                                 Clock) */
    #elif defined SYSCLK_FREQ_32MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_32MHz; /*!< System Clock Frequency (Core
                                                 Clock) */
...
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_64KHz; /*!< System Clock Frequency
                                                     (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_128KHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_128KHz; /*!< System Clock Frequency
                                                      (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_256KHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_256KHz; /*!< System Clock Frequency
                                                      (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_512KHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_512KHz; /*!< System Clock Frequency
                                                      (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_1MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_1MHz; /*!< System Clock Frequency
                                                    (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_2MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_2MHz; /*!< System Clock Frequency
                                                    (Core Clock) */
    #elif defined SYSCLK_FREQ_MSI_4MHz
uint32_t SystemCoreClock = SYSCLK_FREQ_MSI_4MHz; /*!< System Clock Frequency
                                                    (Core Clock) */
    #else
uint32_t SystemCoreClock = MSI_VALUE; /*!< System Clock Frequency (Core Clock)
                                       */
...
void SystemCoreClockUpdate( void )
{
    ...
    switch( tmp )
    {
        case 0x00: /* MSI used as system clock */
            ...
            SystemCoreClock = ( ( ( 1 << msirange ) * 64000 ) -
                                ( MSITable[ msirange ] * 24000 ) );
            break;
