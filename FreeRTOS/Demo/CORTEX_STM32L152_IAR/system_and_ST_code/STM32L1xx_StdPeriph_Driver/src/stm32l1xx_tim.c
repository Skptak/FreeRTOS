 ...
 *   - TIM_IT_CC2, TIM_IT_CC3, TIM_IT_CC4 and TIM_IT_Trigger can not be used
 ...
 *   - TIM10 and TIM11 can only generate an update event and Capture Compare 1
 * event.
 * @retval None
 */
 ...
 *         Compare Mode.
 *         User has to enable this channel using TIM_CCxCmd and TIM_CCxNCmd
 * functions.
 * @param  TIMx: where x can be 2, 3, 4, 9, 10 or 11 to select the TIM
 * peripheral.
 * @param  TIM_Channel: specifies the TIM Channel
...
/**
  ...
  * @param  TIMx: where x can be 2, 3, 4, 6, 7 or 9 to select the TIM
  peripheral.
 ...
 *   - TIM9 can have only update flag, TIM_FLAG_CC1, TIM_FLAG_CC2 and
 * TIM_FLAG_Trigger, TIM_FLAG_CC1OF or TIM_FLAG_CC2OF flags
 *   - TIM10 and TIM11 can have only update flag, TIM_FLAG_CC1 or TIM_FLAG_CC1OF
 * flags
