...
#define RI_ASCR1_RESET_VALUE \
    ( ( uint32_t ) 0x00000000 ) /*!< ASCR1 Reset value */
#define RI_ASCR2_RESET_VALUE \
    ( ( uint32_t ) 0x00000000 ) /*!< ASCR2 Reset value */
#define RI_HYSCR1_RESET_VALUE \
    ( ( uint32_t ) 0x00000000 ) /*!< HYSCR1 Reset value */
#define RI_HYSCR2_RESET_VALUE \
    ( ( uint32_t ) 0x00000000 ) /*!< HYSCR2 Reset value */
#define RI_HYSCR3_RESET_VALUE \
    ( ( uint32_t ) 0x00000000 ) /*!< HYSCR3 Reset value */
 ...
 * resistor. This parameter can be: ENABLE so the selected resistor is connected
