...
typedef struct
{
    ...
    uint16_t I2C_AcknowledgedAddress; /*!< Specifies if 7-bit or 10-bit address
                                         is acknowledged. This parameter can be
                                         a value of @ref
 ...
 */
     ...
     *
     * 2) In case the address sent by the master matches the second address of
     * the peripheral (configured by the function I2C_OwnAddress2Config() and
 ...
 *(I2C_IT_ERR).
 *          - I2Cx_ER_IRQHandler() which is called when the error interurpt
 *occurs. Where x is the peripheral instance (I2C1, I2C2 ...)
 *          - I2C_GetFlagStatus() or I2C_GetITStatus() to be called into the
 *I2Cx_ER_IRQHandler() function in order to determine which error occured.
