...
/* TIMx_IC1 TIMx_IC2  TIMx_IC3  TIMx_IC4 */
    ...
    /* ASCR1 I/O switch: bit 28 is set to '1' to indicate that the mask is in
     * ASCR1 register */
    ...
    #define RI_IOSwitch_VCOMP                                                \
        ( ( uint32_t ) 0x14000000 ) /* VCOMP is an internal switch used to   \
                                       connect selected channel to COMP1 non \
                                       inverting input */

    /* ASCR2 IO switch: : bit 28 is set to '0' to indicate that the mask is in
     * ASCR2 register */
