 ...
 */
    ...
    #define IS_TIM_ALL_PERIPH( PERIPH )                       \
        ( ( ( PERIPH ) == TIM2 ) || ( ( PERIPH ) == TIM3 ) || \
          ( ( PERIPH ) == TIM4 ) || ( ( PERIPH ) == TIM6 ) || \
          ( ( PERIPH ) == TIM7 ) || ( ( PERIPH ) == TIM9 ) || \
          ( ( PERIPH ) == TIM10 ) || ( ( PERIPH ) == TIM11 ) )

    #define IS_TIM_23491011_PERIPH( PERIPH )                  \
        ( ( ( PERIPH ) == TIM2 ) || ( ( PERIPH ) == TIM3 ) || \
          ( ( PERIPH ) == TIM4 ) || ( ( PERIPH ) == TIM9 ) || \
          ( ( PERIPH ) == TIM10 ) || ( ( PERIPH ) == TIM11 ) )
 ...
 */
    ...
    #define IS_TIM_REMAP( TIM_REMAP )                                          \
        ( ( ( TIM_REMAP ) == TIM9_GPIO ) || ( ( TIM_REMAP ) == TIM9_LSE ) ||   \
          ( ( TIM_REMAP ) == TIM10_GPIO ) || ( ( TIM_REMAP ) == TIM10_LSI ) || \
          ( ( TIM_REMAP ) == TIM10_LSE ) || ( ( TIM_REMAP ) == TIM10_RTC ) ||  \
          ( ( TIM_REMAP ) == TIM11_GPIO ) || ( ( TIM_REMAP ) == TIM11_MSI ) || \
