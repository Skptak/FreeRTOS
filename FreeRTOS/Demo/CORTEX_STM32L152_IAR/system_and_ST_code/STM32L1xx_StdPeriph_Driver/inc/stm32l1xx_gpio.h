...
typedef enum
{
    ...
    #define IS_GPIO_SPEED( SPEED )              \
        ( ( ( SPEED ) == GPIO_Speed_400KHz ) || \
          ( ( SPEED ) == GPIO_Speed_2MHz ) ||   \
          ( ( SPEED ) == GPIO_Speed_10MHz ) ||  \
          ( ( SPEED ) == GPIO_Speed_40MHz ) )
/**
 * @}
 */
...
typedef struct
{
    ...
    GPIOOType_TypeDef GPIO_OType; /*!< Specifies the operating output type for
                                     ...
                                     value of @ref GPIOOType_TypeDef */
    ...
    #define GPIO_AF_RTC_50Hz \
        ( ( uint8_t ) 0x00 ) /*!< RTC 50/60 Hz Alternate Function mapping */
    #define GPIO_AF_MCO \
        ( ( uint8_t ) 0x00 ) /*!< MCO Alternate Function mapping */
    #define GPIO_AF_RTC_AF1 \
        ( ( uint8_t ) 0x00 ) /*!< RTC_AF1 Alternate Function mapping */
    #define GPIO_AF_WKUP                                                    \
        ( ( uint8_t ) 0x00 ) /*!< Wakeup (WKUP1, WKUP2 and WKUP3) Alternate \
                                Function mapping */
    #define GPIO_AF_SWJ                                                        \
        ( ( uint8_t ) 0x00 ) /*!< SWJ (SW and JTAG) Alternate Function mapping \
                              */
     ...
     */
    #define GPIO_AF_USB                                                    \
        ( ( uint8_t ) 0xA ) /*!< USB Full speed device  Alternate Function \
                               mapping */
    /**
     ...
     */
    #define GPIO_AF_RI \
        ( ( uint8_t ) 0x0E ) /*!< RI Alternate Function mapping */
