...
/*  Tip: To avoid modifying this file each time you need to switch between these
  ...
  */
    ...
    #define MSI_VALUE                                                     \
        ( ( uint32_t ) 2000000 ) /*!< Default value of the Internal Multi \
                                    Speed oscillator in Hz */
    #define HSI_VALUE                                                   \
        ( ( uint32_t ) 16000000 ) /*!< Value of the Internal High Speed \
                                     oscillator in Hz */
    #define LSI_VALUE                                                          \
        ( ( uint32_t ) 37000 ) /*!< Value of the Internal Low Speed oscillator \
                                  in Hz */
    #define LSE_VALUE                                                          \
        ( ( uint32_t ) 32768 ) /*!< Value of the External Low Speed oscillator \
                                  in Hz */
    ...
    #define __STM32L1XX_STDPERIPH_VERSION_MAIN                           \
        ( 0x01 ) /*!< [31:16] STM32L1xx Standard Peripheral Library main \
                    version */
    #define __STM32L1XX_STDPERIPH_VERSION_SUB1                           \
        ( 0x00 ) /*!< [15:8]  STM32L1xx Standard Peripheral Library sub1 \
                    version */
    #define __STM32L1XX_STDPERIPH_VERSION_SUB2                          \
        ( 0x00 ) /*!< [7:0]  STM32L1xx Standard Peripheral Library sub2 \
                    version */
 ...
 */
    ...
    #define PERIPH_BB_BASE                                                    \
        ( ( uint32_t ) 0x42000000 ) /*!< Peripheral base address in the alias \
                                       region */
    #define SRAM_BB_BASE                                                       \
        ( ( uint32_t ) 0x22000000 ) /*!< SRAM base address in the alias region \
                                     */

    #define SRAM_BASE                                                      \
        ( ( uint32_t ) 0x20000000 ) /*!< SRAM base address in the bit-band \
                                       region */
    #define PERIPH_BASE                                                 \
        ( ( uint32_t ) 0x40000000 ) /*!< Peripheral base address in the \
                                       bit-band region */
...
/******************  Bit definition for DBGMCU_APB2_FZ register  **************/
    ...
    #define RCC_ICSCR_MSIRANGE_64KHz                                      \
        ( ( uint32_t ) 0x00000000 ) /*!< Internal Multi Speed clock Range \
                                       64KHz */
    #define RCC_ICSCR_MSIRANGE_128KHz                                     \
        ( ( uint32_t ) 0x00002000 ) /*!< Internal Multi Speed clock Range \
                                       128KHz */
    #define RCC_ICSCR_MSIRANGE_256KHz                                     \
        ( ( uint32_t ) 0x00004000 ) /*!< Internal Multi Speed clock Range \
                                       256KHz */
    #define RCC_ICSCR_MSIRANGE_512KHz                                     \
        ( ( uint32_t ) 0x00006000 ) /*!< Internal Multi Speed clock Range \
                                       512KHz */
    #define RCC_ICSCR_MSIRANGE_1MHz                                            \
        ( ( uint32_t ) 0x00008000 ) /*!< Internal Multi Speed clock Range 1MHz \
                                     */
    #define RCC_ICSCR_MSIRANGE_2MHz                                            \
        ( ( uint32_t ) 0x0000A000 ) /*!< Internal Multi Speed clock Range 2MHz \
                                     */
    #define RCC_ICSCR_MSIRANGE_4MHz                                            \
        ( ( uint32_t ) 0x0000C000 ) /*!< Internal Multi Speed clock Range 4MHz \
                                     */
    ...
    #define RI_ICR_IC4Z                                                  \
        ( ( uint32_t ) 0x0000F000 ) /*!< IC2Z[3:0] bits (Input Capture 2 \
                                       select bits) */
