 ...
 ******************************************************************************/
#define FM3_FLASH_BASE \
    ( 0x00000000UL ) /* Flash Base                             */
#define FM3_PERIPH_BASE \
    ( 0x40000000UL ) /* Peripheral  Base                       */
#define FM3_CM3_BASE \
    ( 0xE0100000UL ) /* CM3 Private                            */

#define FM3_FLASH_IF_BASE \
    ( FM3_PERIPH_BASE + 0x00000UL ) /* Flash interface registers */
#define FM3_CRG_BASE \
    ( FM3_PERIPH_BASE + 0x10000UL ) /* Clock and reset registers */
#define FM3_HWWDT_BASE \
    ( FM3_PERIPH_BASE + 0x11000UL ) /* Hardware watchdog registers */
#define FM3_SWWDT_BASE \
    ( FM3_PERIPH_BASE + 0x12000UL ) /* Software watchdog registers */
#define FM3_DTIM_BASE \
    ( FM3_PERIPH_BASE + 0x15000UL ) /* Dual timer 1/2 registers */
#define FM3_MFT0_FRT_BASE                                                      \
    ( FM3_PERIPH_BASE + 0x20000UL ) /* Multifunction Timer unit 0 Free Running \
                                       Timer registers */
#define FM3_MFT0_OCU_BASE                                                \
    ( FM3_PERIPH_BASE + 0x20000UL ) /* Multifunction Timer unit 0 Output \
                                       Compare Unit registers */
#define FM3_MFT0_WFG_BASE                                                     \
    ( FM3_PERIPH_BASE + 0x20000UL ) /* Multifunction Timer unit 0 Waveform    \
                                       Generator and Noise Canceler registers \
                                     */
#define FM3_MFT0_ICU_BASE                                               \
    ( FM3_PERIPH_BASE + 0x20000UL ) /* Multifunction Timer unit 0 Input \
                                       Capture Unit registers */
#define FM3_MFT0_ADCMP_BASE                                                 \
    ( FM3_PERIPH_BASE + 0x20000UL ) /* Multifunction Timer unit 0 ADC Start \
                                       Compare Unit registers */
#define FM3_MFT1_FRT_BASE                                                      \
    ( FM3_PERIPH_BASE + 0x21000UL ) /* Multifunction Timer unit 1 Free Running \
                                       Timer registers */
#define FM3_MFT1_OCU_BASE                                                \
    ( FM3_PERIPH_BASE + 0x21000UL ) /* Multifunction Timer unit 1 Output \
                                       Compare Unit registers */
#define FM3_MFT1_WFG_BASE                                                     \
    ( FM3_PERIPH_BASE + 0x21000UL ) /* Multifunction Timer unit 1 Waveform    \
                                       Generator and Noise Canceler registers \
                                     */
#define FM3_MFT1_ICU_BASE                                               \
    ( FM3_PERIPH_BASE + 0x21000UL ) /* Multifunction Timer unit 1 Input \
                                       Capture Unit registers */
#define FM3_MFT1_ADCMP_BASE                                                 \
    ( FM3_PERIPH_BASE + 0x21000UL ) /* Multifunction Timer unit 1 ADC Start \
                                       Compare Unit registers */
#define FM3_MFT_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x24000UL ) /* Multifunction Timer PPG registers */
#define FM3_BT0_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25000UL ) /* Base Timer 0 PPG registers */
#define FM3_BT0_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25000UL ) /* Base Timer 0 PWM registers */
#define FM3_BT0_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25000UL ) /* Base Timer 0 RT registers */
#define FM3_BT0_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25000UL ) /* Base Timer 0 PWC registers */
#define FM3_BT1_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25040UL ) /* Base Timer 1 PPG registers */
#define FM3_BT1_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25040UL ) /* Base Timer 1 PWM registers */
#define FM3_BT1_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25040UL ) /* Base Timer 1 RT registers */
#define FM3_BT1_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25040UL ) /* Base Timer 1 PWC registers */
#define FM3_BT2_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25080UL ) /* Base Timer 2 PPG registers */
#define FM3_BT2_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25080UL ) /* Base Timer 2 PWM registers */
#define FM3_BT2_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25080UL ) /* Base Timer 2 RT registers */
#define FM3_BT2_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25080UL ) /* Base Timer 2 PWC registers */
#define FM3_BT3_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x250C0UL ) /* Base Timer 3 PPG registers */
#define FM3_BT3_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x250C0UL ) /* Base Timer 3 PWM registers */
#define FM3_BT3_RT_BASE \
    ( FM3_PERIPH_BASE + 0x250C0UL ) /* Base Timer 3 RT registers */
#define FM3_BT3_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x250C0UL ) /* Base Timer 3 PWC registers */
#define FM3_BT4_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25200UL ) /* Base Timer 4 PPG registers */
#define FM3_BT4_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25200UL ) /* Base Timer 4 PWM registers */
#define FM3_BT4_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25200UL ) /* Base Timer 4 RT registers */
#define FM3_BT4_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25200UL ) /* Base Timer 4 PWC registers */
#define FM3_BT5_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25240UL ) /* Base Timer 5 PPG registers */
#define FM3_BT5_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25240UL ) /* Base Timer 5 PWM registers */
#define FM3_BT5_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25240UL ) /* Base Timer 5 RT registers */
#define FM3_BT5_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25240UL ) /* Base Timer 5 PWC registers */
#define FM3_BT6_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x25280UL ) /* Base Timer 6 PPG registers */
#define FM3_BT6_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x25280UL ) /* Base Timer 6 PWM registers */
#define FM3_BT6_RT_BASE \
    ( FM3_PERIPH_BASE + 0x25280UL ) /* Base Timer 6 RT registers */
#define FM3_BT6_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x25280UL ) /* Base Timer 6 PWC registers */
#define FM3_BT7_PPG_BASE \
    ( FM3_PERIPH_BASE + 0x252C0UL ) /* Base Timer 7 PPG registers */
#define FM3_BT7_PWM_BASE \
    ( FM3_PERIPH_BASE + 0x252C0UL ) /* Base Timer 7 PWM registers */
#define FM3_BT7_RT_BASE \
    ( FM3_PERIPH_BASE + 0x252C0UL ) /* Base Timer 7 RT registers */
#define FM3_BT7_PWC_BASE \
    ( FM3_PERIPH_BASE + 0x252C0UL ) /* Base Timer 7 PWC registers */
#define FM3_BTIOSEL03_BASE                                                 \
    ( FM3_PERIPH_BASE + 0x25100UL ) /* Base Timer I/O selector channel 0 - \
                                       channel 3 registers */
#define FM3_BTIOSEL47_BASE                                                 \
    ( FM3_PERIPH_BASE + 0x25300UL ) /* Base Timer I/O selector channel 4 - \
                                       channel 7 registers */
#define FM3_SBSSR_BASE                                                         \
    ( FM3_PERIPH_BASE + 0x25FFCUL ) /* Software based Simulation Startup (Base \
                                       Timer) register */
#define FM3_QPRC0_BASE                                                      \
    ( FM3_PERIPH_BASE + 0x26000UL ) /* Quad position and revolution counter \
                                       channel 0 registers */
#define FM3_QPRC1_BASE                                                      \
    ( FM3_PERIPH_BASE + 0x26040UL ) /* Quad position and revolution counter \
                                       channel 1 registers */
#define FM3_ADC0_BASE \
    ( FM3_PERIPH_BASE + 0x27000UL ) /* 12-bit ADC unit 0 registers */
#define FM3_ADC1_BASE \
    ( FM3_PERIPH_BASE + 0x27100UL ) /* 12-bit ADC unit 1 registers */
#define FM3_ADC2_BASE \
    ( FM3_PERIPH_BASE + 0x27200UL ) /* 12-bit ADC unit 2 registers */
#define FM3_CRTRIM_BASE \
    ( FM3_PERIPH_BASE + 0x2E000UL ) /* CR trimming registers */
#define FM3_EXTI_BASE \
    ( FM3_PERIPH_BASE + 0x30000UL ) /* External interrupt registers */
#define FM3_INTREQ_BASE \
    ( FM3_PERIPH_BASE + 0x31000UL ) /* Interrupt request read registers */
#define FM3_GPIO_BASE \
    ( FM3_PERIPH_BASE + 0x33000UL ) /* General purpose I/O registers */
#define FM3_LVD_BASE \
    ( FM3_PERIPH_BASE + 0x35000UL ) /* Low voltage detection registers */
#define FM3_USBCLK_BASE \
    ( FM3_PERIPH_BASE + 0x36000UL ) /* USB clock registers */
#define FM3_CANPRES_BASE \
    ( FM3_PERIPH_BASE + 0x37000UL ) /* CAN prescaler register */
#define FM3_MFS0_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38000UL ) /* UART asynchronous channel 0 registers \
                                     */
#define FM3_MFS0_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38000UL ) /* UART synchronous channel 0 registers */
#define FM3_MFS0_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38000UL ) /* UART LIN channel 0 registers */
#define FM3_MFS0_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38000UL ) /* I2C channel 0 registers */
#define FM3_MFS1_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38100UL ) /* UART asynchronous channel 1 registers \
                                     */
#define FM3_MFS1_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38100UL ) /* UART synchronous channel 1 registers */
#define FM3_MFS1_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38100UL ) /* UART LIN channel 1 registers */
#define FM3_MFS1_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38100UL ) /* I2C channel 1 registers */
#define FM3_MFS2_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38200UL ) /* UART asynchronous channel 2 registers \
                                     */
#define FM3_MFS2_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38200UL ) /* UART synchronous channel 2 registers */
#define FM3_MFS2_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38200UL ) /* UART LIN channel 2 registers */
#define FM3_MFS2_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38200UL ) /* I2C channel 2 registers */
#define FM3_MFS3_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38300UL ) /* UART asynchronous channel 3 registers \
                                     */
#define FM3_MFS3_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38300UL ) /* UART synchronous channel 3 registers */
#define FM3_MFS3_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38300UL ) /* UART LIN channel 3 registers */
#define FM3_MFS3_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38300UL ) /* I2C channel 3 registers */
#define FM3_MFS4_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38400UL ) /* UART asynchronous channel 4 registers \
                                     */
#define FM3_MFS4_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38400UL ) /* UART synchronous channel 4 registers */
#define FM3_MFS4_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38400UL ) /* UART LIN channel 4 registers */
#define FM3_MFS4_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38400UL ) /* I2C channel 4 registers */
#define FM3_MFS5_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38500UL ) /* UART asynchronous channel 5 registers \
                                     */
#define FM3_MFS5_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38500UL ) /* UART synchronous channel 5 registers */
#define FM3_MFS5_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38500UL ) /* UART LIN channel 5 registers */
#define FM3_MFS5_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38500UL ) /* I2C channel 5 registers */
#define FM3_MFS6_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38600UL ) /* UART asynchronous channel 6 registers \
                                     */
#define FM3_MFS6_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38600UL ) /* UART synchronous channel 6 registers */
#define FM3_MFS6_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38600UL ) /* UART LIN channel 6 registers */
#define FM3_MFS6_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38600UL ) /* I2C channel 6 registers */
#define FM3_MFS7_UART_BASE                                                   \
    ( FM3_PERIPH_BASE + 0x38700UL ) /* UART asynchronous channel 7 registers \
                                     */
#define FM3_MFS7_CSIO_BASE \
    ( FM3_PERIPH_BASE + 0x38700UL ) /* UART synchronous channel 7 registers */
#define FM3_MFS7_LIN_BASE \
    ( FM3_PERIPH_BASE + 0x38700UL ) /* UART LIN channel 7 registers */
#define FM3_MFS7_I2C_BASE \
    ( FM3_PERIPH_BASE + 0x38700UL ) /* I2C channel 7 registers */
#define FM3_CRC_BASE ( FM3_PERIPH_BASE + 0x39000UL ) /* CRC registers */
#define FM3_WC_BASE \
    ( FM3_PERIPH_BASE + 0x3A000UL ) /* Watch counter registers */
#define FM3_EXBUS_BASE \
    ( FM3_PERIPH_BASE + 0x3F000UL ) /* External bus interface registers */
#define FM3_USB0_BASE \
    ( FM3_PERIPH_BASE + 0x42100UL ) /* USB channel 0 registers */
#define FM3_DMAC_BASE ( FM3_PERIPH_BASE + 0x60000UL ) /* DMA controller */
#define FM3_CAN0_BASE \
    ( FM3_PERIPH_BASE + 0x62000UL ) /* CAN channel 0 registers */
#define FM3_CAN1_BASE \
    ( FM3_PERIPH_BASE + 0x63000UL ) /* CAN channel 1 registers */
...
/* Flash interface registers */
#define bFM3_FLASH_IF_FASZR_ASZ0 \
    *( ( volatile unsigned int * ) ( 0x42000000UL ) )
#define bFM3_FLASH_IF_FASZR_ASZ1 \
    *( ( volatile unsigned int * ) ( 0x42000004UL ) )
#define bFM3_FLASH_IF_FRWTR_RWT0 \
    *( ( volatile unsigned int * ) ( 0x42000080UL ) )
#define bFM3_FLASH_IF_FRWTR_RWT1 \
    *( ( volatile unsigned int * ) ( 0x42000084UL ) )
...
#define bFM3_FLASH_IF_FSYNDN_SD0 \
    *( ( volatile unsigned int * ) ( 0x42000200UL ) )
#define bFM3_FLASH_IF_FSYNDN_SD1 \
    *( ( volatile unsigned int * ) ( 0x42000204UL ) )
#define bFM3_FLASH_IF_FSYNDN_SD2 \
    *( ( volatile unsigned int * ) ( 0x42000208UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM0 \
    *( ( volatile unsigned int * ) ( 0x42002000UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM1 \
    *( ( volatile unsigned int * ) ( 0x42002004UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM2 \
    *( ( volatile unsigned int * ) ( 0x42002008UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM3 \
    *( ( volatile unsigned int * ) ( 0x4200200CUL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM4 \
    *( ( volatile unsigned int * ) ( 0x42002010UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM5 \
    *( ( volatile unsigned int * ) ( 0x42002014UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM6 \
    *( ( volatile unsigned int * ) ( 0x42002018UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM7 \
    *( ( volatile unsigned int * ) ( 0x4200201CUL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM8 \
    *( ( volatile unsigned int * ) ( 0x42002020UL ) )
#define bFM3_FLASH_IF_CRTRMM_TRMM9 \
    *( ( volatile unsigned int * ) ( 0x42002024UL ) )
...
#define bFM3_CRG_APBC0_PSR_APBC00 \
    *( ( volatile unsigned int * ) ( 0x42200280UL ) )
#define bFM3_CRG_APBC0_PSR_APBC01 \
    *( ( volatile unsigned int * ) ( 0x42200284UL ) )
#define bFM3_CRG_APBC1_PSR_APBC10 \
    *( ( volatile unsigned int * ) ( 0x42200300UL ) )
#define bFM3_CRG_APBC1_PSR_APBC11 \
    *( ( volatile unsigned int * ) ( 0x42200304UL ) )
#define bFM3_CRG_APBC1_PSR_APBC1RST \
    *( ( volatile unsigned int * ) ( 0x42200310UL ) )
#define bFM3_CRG_APBC1_PSR_APBC1EN \
    *( ( volatile unsigned int * ) ( 0x4220031CUL ) )
#define bFM3_CRG_APBC2_PSR_APBC20 \
    *( ( volatile unsigned int * ) ( 0x42200380UL ) )
#define bFM3_CRG_APBC2_PSR_APBC21 \
    *( ( volatile unsigned int * ) ( 0x42200384UL ) )
#define bFM3_CRG_APBC2_PSR_APBC2RST \
    *( ( volatile unsigned int * ) ( 0x42200390UL ) )
#define bFM3_CRG_APBC2_PSR_APBC2EN \
    *( ( volatile unsigned int * ) ( 0x4220039CUL ) )
...
#define bFM3_CRG_PLL_CTL1_PLLM0 \
    *( ( volatile unsigned int * ) ( 0x42200700UL ) )
#define bFM3_CRG_PLL_CTL1_PLLM1 \
    *( ( volatile unsigned int * ) ( 0x42200704UL ) )
#define bFM3_CRG_PLL_CTL1_PLLM2 \
    *( ( volatile unsigned int * ) ( 0x42200708UL ) )
#define bFM3_CRG_PLL_CTL1_PLLM3 \
    *( ( volatile unsigned int * ) ( 0x4220070CUL ) )
#define bFM3_CRG_PLL_CTL1_PLLK0 \
    *( ( volatile unsigned int * ) ( 0x42200710UL ) )
#define bFM3_CRG_PLL_CTL1_PLLK1 \
    *( ( volatile unsigned int * ) ( 0x42200714UL ) )
#define bFM3_CRG_PLL_CTL1_PLLK2 \
    *( ( volatile unsigned int * ) ( 0x42200718UL ) )
#define bFM3_CRG_PLL_CTL1_PLLK3 \
    *( ( volatile unsigned int * ) ( 0x4220071CUL ) )
#define bFM3_CRG_PLL_CTL2_PLLN0 \
    *( ( volatile unsigned int * ) ( 0x42200780UL ) )
#define bFM3_CRG_PLL_CTL2_PLLN1 \
    *( ( volatile unsigned int * ) ( 0x42200784UL ) )
#define bFM3_CRG_PLL_CTL2_PLLN2 \
    *( ( volatile unsigned int * ) ( 0x42200788UL ) )
#define bFM3_CRG_PLL_CTL2_PLLN3 \
    *( ( volatile unsigned int * ) ( 0x4220078CUL ) )
#define bFM3_CRG_PLL_CTL2_PLLN4 \
...
#define bFM3_CRG_DBWDT_CTL_DPSWBE \
    *( ( volatile unsigned int * ) ( 0x42200A94UL ) )
#define bFM3_CRG_DBWDT_CTL_DPHWBE \
    *( ( volatile unsigned int * ) ( 0x42200A9CUL ) )
...
/* Hardware watchdog registers */
#define bFM3_HWWDT_WDG_CTL_INTEN \
    *( ( volatile unsigned int * ) ( 0x42220100UL ) )
#define bFM3_HWWDT_WDG_CTL_RESEN \
    *( ( volatile unsigned int * ) ( 0x42220104UL ) )
#define bFM3_HWWDT_WDG_RIS_RIS *( ( volatile unsigned int * ) ( 0x42220200UL ) )

/* Software watchdog registers */
#define bFM3_SWWDT_WDOGCONTROL_INTEN \
    *( ( volatile unsigned int * ) ( 0x42240100UL ) )
#define bFM3_SWWDT_WDOGCONTROL_RESEN \
    *( ( volatile unsigned int * ) ( 0x42240104UL ) )
#define bFM3_SWWDT_WDOGRIS_RIS *( ( volatile unsigned int * ) ( 0x42240200UL ) )

/* Dual timer 1/2 registers */
#define bFM3_DTIM_TIMER1CONTROL_ONESHOT \
    *( ( volatile unsigned int * ) ( 0x422A0100UL ) )
#define bFM3_DTIM_TIMER1CONTROL_TIMERSIZE \
    *( ( volatile unsigned int * ) ( 0x422A0104UL ) )
#define bFM3_DTIM_TIMER1CONTROL_TIMERPRE0 \
    *( ( volatile unsigned int * ) ( 0x422A0108UL ) )
#define bFM3_DTIM_TIMER1CONTROL_TIMERPRE1 \
    *( ( volatile unsigned int * ) ( 0x422A010CUL ) )
#define bFM3_DTIM_TIMER1CONTROL_INTENABLE \
    *( ( volatile unsigned int * ) ( 0x422A0114UL ) )
#define bFM3_DTIM_TIMER1CONTROL_TIMERMODE \
    *( ( volatile unsigned int * ) ( 0x422A0118UL ) )
#define bFM3_DTIM_TIMER1CONTROL_TIMEREN \
    *( ( volatile unsigned int * ) ( 0x422A011CUL ) )
#define bFM3_DTIM_TIMER1RIS_TIMERXRIS \
    *( ( volatile unsigned int * ) ( 0x422A0200UL ) )
#define bFM3_DTIM_TIMER1MIS_TIMERXRIS \
    *( ( volatile unsigned int * ) ( 0x422A0280UL ) )
#define bFM3_DTIM_TIMER2CONTROL_ONESHOT \
    *( ( volatile unsigned int * ) ( 0x422A0500UL ) )
#define bFM3_DTIM_TIMER2CONTROL_TIMERSIZE \
    *( ( volatile unsigned int * ) ( 0x422A0504UL ) )
#define bFM3_DTIM_TIMER2CONTROL_TIMERPRE0 \
    *( ( volatile unsigned int * ) ( 0x422A0508UL ) )
#define bFM3_DTIM_TIMER2CONTROL_TIMERPRE1 \
    *( ( volatile unsigned int * ) ( 0x422A050CUL ) )
#define bFM3_DTIM_TIMER2CONTROL_INTENABLE \
    *( ( volatile unsigned int * ) ( 0x422A0514UL ) )
#define bFM3_DTIM_TIMER2CONTROL_TIMERMODE \
    *( ( volatile unsigned int * ) ( 0x422A0518UL ) )
#define bFM3_DTIM_TIMER2CONTROL_TIMEREN \
    *( ( volatile unsigned int * ) ( 0x422A051CUL ) )
#define bFM3_DTIM_TIMER2RIS_TIMERXRIS \
    *( ( volatile unsigned int * ) ( 0x422A0600UL ) )
#define bFM3_DTIM_TIMER2MIS_TIMERXRIS \
    *( ( volatile unsigned int * ) ( 0x422A0680UL ) )

/* Multifunction Timer unit 0 Free Running Timer registers */
#define bFM3_MFT0_FRT_TCSA0_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42400600UL ) )
#define bFM3_MFT0_FRT_TCSA0_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42400604UL ) )
#define bFM3_MFT0_FRT_TCSA0_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42400608UL ) )
#define bFM3_MFT0_FRT_TCSA0_CLK3 \
    *( ( volatile unsigned int * ) ( 0x4240060CUL ) )
#define bFM3_MFT0_FRT_TCSA0_SCLR \
    *( ( volatile unsigned int * ) ( 0x42400610UL ) )
#define bFM3_MFT0_FRT_TCSA0_MODE \
    *( ( volatile unsigned int * ) ( 0x42400614UL ) )
#define bFM3_MFT0_FRT_TCSA0_STOP \
    *( ( volatile unsigned int * ) ( 0x42400618UL ) )
#define bFM3_MFT0_FRT_TCSA0_BFE \
    *( ( volatile unsigned int * ) ( 0x4240061CUL ) )
#define bFM3_MFT0_FRT_TCSA0_ICRE \
    *( ( volatile unsigned int * ) ( 0x42400620UL ) )
#define bFM3_MFT0_FRT_TCSA0_ICLR \
    *( ( volatile unsigned int * ) ( 0x42400624UL ) )
#define bFM3_MFT0_FRT_TCSA0_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42400634UL ) )
#define bFM3_MFT0_FRT_TCSA0_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42400638UL ) )
#define bFM3_MFT0_FRT_TCSA0_ECKE \
    *( ( volatile unsigned int * ) ( 0x4240063CUL ) )
#define bFM3_MFT0_FRT_TCSB0_AD0E \
    *( ( volatile unsigned int * ) ( 0x42400680UL ) )
#define bFM3_MFT0_FRT_TCSB0_AD1E \
    *( ( volatile unsigned int * ) ( 0x42400684UL ) )
#define bFM3_MFT0_FRT_TCSB0_AD2E \
    *( ( volatile unsigned int * ) ( 0x42400688UL ) )
#define bFM3_MFT0_FRT_TCSA1_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42400800UL ) )
#define bFM3_MFT0_FRT_TCSA1_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42400804UL ) )
#define bFM3_MFT0_FRT_TCSA1_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42400808UL ) )
#define bFM3_MFT0_FRT_TCSA1_CLK3 \
    *( ( volatile unsigned int * ) ( 0x4240080CUL ) )
#define bFM3_MFT0_FRT_TCSA1_SCLR \
    *( ( volatile unsigned int * ) ( 0x42400810UL ) )
#define bFM3_MFT0_FRT_TCSA1_MODE \
    *( ( volatile unsigned int * ) ( 0x42400814UL ) )
#define bFM3_MFT0_FRT_TCSA1_STOP \
    *( ( volatile unsigned int * ) ( 0x42400818UL ) )
#define bFM3_MFT0_FRT_TCSA1_BFE \
    *( ( volatile unsigned int * ) ( 0x4240081CUL ) )
#define bFM3_MFT0_FRT_TCSA1_ICRE \
    *( ( volatile unsigned int * ) ( 0x42400820UL ) )
#define bFM3_MFT0_FRT_TCSA1_ICLR \
    *( ( volatile unsigned int * ) ( 0x42400824UL ) )
#define bFM3_MFT0_FRT_TCSA1_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42400834UL ) )
#define bFM3_MFT0_FRT_TCSA1_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42400838UL ) )
#define bFM3_MFT0_FRT_TCSA1_ECKE \
    *( ( volatile unsigned int * ) ( 0x4240083CUL ) )
#define bFM3_MFT0_FRT_TCSB1_AD0E \
    *( ( volatile unsigned int * ) ( 0x42400880UL ) )
#define bFM3_MFT0_FRT_TCSB1_AD1E \
    *( ( volatile unsigned int * ) ( 0x42400884UL ) )
#define bFM3_MFT0_FRT_TCSB1_AD2E \
    *( ( volatile unsigned int * ) ( 0x42400888UL ) )
#define bFM3_MFT0_FRT_TCSA2_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42400A00UL ) )
#define bFM3_MFT0_FRT_TCSA2_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42400A04UL ) )
#define bFM3_MFT0_FRT_TCSA2_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42400A08UL ) )
#define bFM3_MFT0_FRT_TCSA2_CLK3 \
    *( ( volatile unsigned int * ) ( 0x42400A0CUL ) )
#define bFM3_MFT0_FRT_TCSA2_SCLR \
    *( ( volatile unsigned int * ) ( 0x42400A10UL ) )
#define bFM3_MFT0_FRT_TCSA2_MODE \
    *( ( volatile unsigned int * ) ( 0x42400A14UL ) )
#define bFM3_MFT0_FRT_TCSA2_STOP \
    *( ( volatile unsigned int * ) ( 0x42400A18UL ) )
#define bFM3_MFT0_FRT_TCSA2_BFE \
    *( ( volatile unsigned int * ) ( 0x42400A1CUL ) )
#define bFM3_MFT0_FRT_TCSA2_ICRE \
    *( ( volatile unsigned int * ) ( 0x42400A20UL ) )
#define bFM3_MFT0_FRT_TCSA2_ICLR \
    *( ( volatile unsigned int * ) ( 0x42400A24UL ) )
#define bFM3_MFT0_FRT_TCSA2_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42400A34UL ) )
#define bFM3_MFT0_FRT_TCSA2_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42400A38UL ) )
#define bFM3_MFT0_FRT_TCSA2_ECKE \
    *( ( volatile unsigned int * ) ( 0x42400A3CUL ) )
#define bFM3_MFT0_FRT_TCSB2_AD0E \
    *( ( volatile unsigned int * ) ( 0x42400A80UL ) )
#define bFM3_MFT0_FRT_TCSB2_AD1E \
    *( ( volatile unsigned int * ) ( 0x42400A84UL ) )
#define bFM3_MFT0_FRT_TCSB2_AD2E \
    *( ( volatile unsigned int * ) ( 0x42400A88UL ) )

/* Multifunction Timer unit 0 Output Compare Unit registers */
#define bFM3_MFT0_OCU_OCSA10_CST0 \
    *( ( volatile unsigned int * ) ( 0x42400300UL ) )
#define bFM3_MFT0_OCU_OCSA10_CST1 \
    *( ( volatile unsigned int * ) ( 0x42400304UL ) )
#define bFM3_MFT0_OCU_OCSA10_BDIS0 \
    *( ( volatile unsigned int * ) ( 0x42400308UL ) )
#define bFM3_MFT0_OCU_OCSA10_BDIS1 \
    *( ( volatile unsigned int * ) ( 0x4240030CUL ) )
#define bFM3_MFT0_OCU_OCSA10_IOE0 \
    *( ( volatile unsigned int * ) ( 0x42400310UL ) )
#define bFM3_MFT0_OCU_OCSA10_IOE1 \
    *( ( volatile unsigned int * ) ( 0x42400314UL ) )
#define bFM3_MFT0_OCU_OCSA10_IOP0 \
    *( ( volatile unsigned int * ) ( 0x42400318UL ) )
#define bFM3_MFT0_OCU_OCSA10_IOP1 \
    *( ( volatile unsigned int * ) ( 0x4240031CUL ) )
#define bFM3_MFT0_OCU_OCSB10_OTD0 \
    *( ( volatile unsigned int * ) ( 0x42400320UL ) )
#define bFM3_MFT0_OCU_OCSB10_OTD1 \
    *( ( volatile unsigned int * ) ( 0x42400324UL ) )
#define bFM3_MFT0_OCU_OCSB10_CMOD \
    *( ( volatile unsigned int * ) ( 0x42400330UL ) )
#define bFM3_MFT0_OCU_OCSB10_BTS0 \
    *( ( volatile unsigned int * ) ( 0x42400334UL ) )
#define bFM3_MFT0_OCU_OCSB10_BTS1 \
    *( ( volatile unsigned int * ) ( 0x42400338UL ) )
#define bFM3_MFT0_OCU_OCSA32_CST2 \
    *( ( volatile unsigned int * ) ( 0x42400380UL ) )
#define bFM3_MFT0_OCU_OCSA32_CST3 \
    *( ( volatile unsigned int * ) ( 0x42400384UL ) )
#define bFM3_MFT0_OCU_OCSA32_BDIS2 \
    *( ( volatile unsigned int * ) ( 0x42400388UL ) )
#define bFM3_MFT0_OCU_OCSA32_BDIS3 \
    *( ( volatile unsigned int * ) ( 0x4240038CUL ) )
#define bFM3_MFT0_OCU_OCSA32_IOE2 \
    *( ( volatile unsigned int * ) ( 0x42400390UL ) )
#define bFM3_MFT0_OCU_OCSA32_IOE3 \
    *( ( volatile unsigned int * ) ( 0x42400394UL ) )
#define bFM3_MFT0_OCU_OCSA32_IOP2 \
    *( ( volatile unsigned int * ) ( 0x42400398UL ) )
#define bFM3_MFT0_OCU_OCSA32_IOP3 \
    *( ( volatile unsigned int * ) ( 0x4240039CUL ) )
#define bFM3_MFT0_OCU_OCSB32_OTD2 \
    *( ( volatile unsigned int * ) ( 0x424003A0UL ) )
#define bFM3_MFT0_OCU_OCSB32_OTD3 \
    *( ( volatile unsigned int * ) ( 0x424003A4UL ) )
#define bFM3_MFT0_OCU_OCSB32_CMOD \
    *( ( volatile unsigned int * ) ( 0x424003B0UL ) )
#define bFM3_MFT0_OCU_OCSB32_BTS2 \
    *( ( volatile unsigned int * ) ( 0x424003B4UL ) )
#define bFM3_MFT0_OCU_OCSB32_BTS3 \
    *( ( volatile unsigned int * ) ( 0x424003B8UL ) )
#define bFM3_MFT0_OCU_OCSA54_CST4 \
    *( ( volatile unsigned int * ) ( 0x42400400UL ) )
#define bFM3_MFT0_OCU_OCSA54_CST5 \
    *( ( volatile unsigned int * ) ( 0x42400404UL ) )
#define bFM3_MFT0_OCU_OCSA54_BDIS4 \
    *( ( volatile unsigned int * ) ( 0x42400408UL ) )
#define bFM3_MFT0_OCU_OCSA54_BDIS5 \
    *( ( volatile unsigned int * ) ( 0x4240040CUL ) )
#define bFM3_MFT0_OCU_OCSA54_IOE4 \
    *( ( volatile unsigned int * ) ( 0x42400410UL ) )
#define bFM3_MFT0_OCU_OCSA54_IOE5 \
    *( ( volatile unsigned int * ) ( 0x42400414UL ) )
#define bFM3_MFT0_OCU_OCSA54_IOP4 \
    *( ( volatile unsigned int * ) ( 0x42400418UL ) )
#define bFM3_MFT0_OCU_OCSA54_IOP5 \
    *( ( volatile unsigned int * ) ( 0x4240041CUL ) )
#define bFM3_MFT0_OCU_OCSB54_OTD4 \
    *( ( volatile unsigned int * ) ( 0x42400420UL ) )
#define bFM3_MFT0_OCU_OCSB54_OTD5 \
    *( ( volatile unsigned int * ) ( 0x42400424UL ) )
#define bFM3_MFT0_OCU_OCSB54_CMOD \
    *( ( volatile unsigned int * ) ( 0x42400430UL ) )
#define bFM3_MFT0_OCU_OCSB54_BTS4 \
    *( ( volatile unsigned int * ) ( 0x42400434UL ) )
#define bFM3_MFT0_OCU_OCSB54_BTS5 \
    *( ( volatile unsigned int * ) ( 0x42400438UL ) )
#define bFM3_MFT0_OCU_OCSC_MOD0 \
    *( ( volatile unsigned int * ) ( 0x424004A0UL ) )
#define bFM3_MFT0_OCU_OCSC_MOD1 \
    *( ( volatile unsigned int * ) ( 0x424004A4UL ) )
#define bFM3_MFT0_OCU_OCSC_MOD2 \
    *( ( volatile unsigned int * ) ( 0x424004A8UL ) )
#define bFM3_MFT0_OCU_OCSC_MOD3 \
    *( ( volatile unsigned int * ) ( 0x424004ACUL ) )
#define bFM3_MFT0_OCU_OCSC_MOD4 \
    *( ( volatile unsigned int * ) ( 0x424004B0UL ) )
#define bFM3_MFT0_OCU_OCSC_MOD5 \
    *( ( volatile unsigned int * ) ( 0x424004B4UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO00 \
    *( ( volatile unsigned int * ) ( 0x42400B00UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO01 \
    *( ( volatile unsigned int * ) ( 0x42400B04UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO02 \
    *( ( volatile unsigned int * ) ( 0x42400B08UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO03 \
    *( ( volatile unsigned int * ) ( 0x42400B0CUL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO10 \
    *( ( volatile unsigned int * ) ( 0x42400B10UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO11 \
    *( ( volatile unsigned int * ) ( 0x42400B14UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO12 \
    *( ( volatile unsigned int * ) ( 0x42400B18UL ) )
#define bFM3_MFT0_OCU_OCFS10_FSO13 \
    *( ( volatile unsigned int * ) ( 0x42400B1CUL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO20 \
    *( ( volatile unsigned int * ) ( 0x42400B20UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO21 \
    *( ( volatile unsigned int * ) ( 0x42400B24UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO22 \
    *( ( volatile unsigned int * ) ( 0x42400B28UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO23 \
    *( ( volatile unsigned int * ) ( 0x42400B2CUL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO30 \
    *( ( volatile unsigned int * ) ( 0x42400B30UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO31 \
    *( ( volatile unsigned int * ) ( 0x42400B34UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO32 \
    *( ( volatile unsigned int * ) ( 0x42400B38UL ) )
#define bFM3_MFT0_OCU_OCFS32_FSO33 \
    *( ( volatile unsigned int * ) ( 0x42400B3CUL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO40 \
    *( ( volatile unsigned int * ) ( 0x42400B80UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO41 \
    *( ( volatile unsigned int * ) ( 0x42400B84UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO42 \
    *( ( volatile unsigned int * ) ( 0x42400B88UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO43 \
    *( ( volatile unsigned int * ) ( 0x42400B8CUL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO50 \
    *( ( volatile unsigned int * ) ( 0x42400B90UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO51 \
    *( ( volatile unsigned int * ) ( 0x42400B94UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO52 \
    *( ( volatile unsigned int * ) ( 0x42400B98UL ) )
#define bFM3_MFT0_OCU_OCFS54_FSO53 \
    *( ( volatile unsigned int * ) ( 0x42400B9CUL ) )

/* Multifunction Timer unit 0 Waveform Generator and Noise Canceler registers */
#define bFM3_MFT0_WFG_WFSA10_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42401180UL ) )
#define bFM3_MFT0_WFG_WFSA10_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42401184UL ) )
#define bFM3_MFT0_WFG_WFSA10_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42401188UL ) )
#define bFM3_MFT0_WFG_WFSA10_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4240118CUL ) )
#define bFM3_MFT0_WFG_WFSA10_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42401190UL ) )
#define bFM3_MFT0_WFG_WFSA10_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42401194UL ) )
#define bFM3_MFT0_WFG_WFSA10_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42401198UL ) )
#define bFM3_MFT0_WFG_WFSA10_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4240119CUL ) )
#define bFM3_MFT0_WFG_WFSA10_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x424011A0UL ) )
#define bFM3_MFT0_WFG_WFSA10_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x424011A4UL ) )
#define bFM3_MFT0_WFG_WFSA10_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x424011A8UL ) )
#define bFM3_MFT0_WFG_WFSA10_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x424011ACUL ) )
#define bFM3_MFT0_WFG_WFSA10_DMOD \
    *( ( volatile unsigned int * ) ( 0x424011B0UL ) )
#define bFM3_MFT0_WFG_WFSA32_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42401200UL ) )
#define bFM3_MFT0_WFG_WFSA32_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42401204UL ) )
#define bFM3_MFT0_WFG_WFSA32_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42401208UL ) )
#define bFM3_MFT0_WFG_WFSA32_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4240120CUL ) )
#define bFM3_MFT0_WFG_WFSA32_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42401210UL ) )
#define bFM3_MFT0_WFG_WFSA32_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42401214UL ) )
#define bFM3_MFT0_WFG_WFSA32_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42401218UL ) )
#define bFM3_MFT0_WFG_WFSA32_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4240121CUL ) )
#define bFM3_MFT0_WFG_WFSA32_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x42401220UL ) )
#define bFM3_MFT0_WFG_WFSA32_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x42401224UL ) )
#define bFM3_MFT0_WFG_WFSA32_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x42401228UL ) )
#define bFM3_MFT0_WFG_WFSA32_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x4240122CUL ) )
#define bFM3_MFT0_WFG_WFSA32_DMOD \
    *( ( volatile unsigned int * ) ( 0x42401230UL ) )
#define bFM3_MFT0_WFG_WFSA54_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42401280UL ) )
#define bFM3_MFT0_WFG_WFSA54_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42401284UL ) )
#define bFM3_MFT0_WFG_WFSA54_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42401288UL ) )
#define bFM3_MFT0_WFG_WFSA54_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4240128CUL ) )
#define bFM3_MFT0_WFG_WFSA54_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42401290UL ) )
#define bFM3_MFT0_WFG_WFSA54_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42401294UL ) )
#define bFM3_MFT0_WFG_WFSA54_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42401298UL ) )
#define bFM3_MFT0_WFG_WFSA54_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4240129CUL ) )
#define bFM3_MFT0_WFG_WFSA54_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x424012A0UL ) )
#define bFM3_MFT0_WFG_WFSA54_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x424012A4UL ) )
#define bFM3_MFT0_WFG_WFSA54_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x424012A8UL ) )
#define bFM3_MFT0_WFG_WFSA54_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x424012ACUL ) )
#define bFM3_MFT0_WFG_WFSA54_DMOD \
    *( ( volatile unsigned int * ) ( 0x424012B0UL ) )
#define bFM3_MFT0_WFG_WFIR_DTIF \
    *( ( volatile unsigned int * ) ( 0x42401300UL ) )
#define bFM3_MFT0_WFG_WFIR_DTIC \
    *( ( volatile unsigned int * ) ( 0x42401304UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIF10 \
    *( ( volatile unsigned int * ) ( 0x42401310UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIC10 \
    *( ( volatile unsigned int * ) ( 0x42401314UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIE10 \
    *( ( volatile unsigned int * ) ( 0x42401318UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIS10 \
    *( ( volatile unsigned int * ) ( 0x4240131CUL ) )
#define bFM3_MFT0_WFG_WFIR_TMIF32 \
    *( ( volatile unsigned int * ) ( 0x42401320UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIC32 \
    *( ( volatile unsigned int * ) ( 0x42401324UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIE32 \
    *( ( volatile unsigned int * ) ( 0x42401328UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIS32 \
    *( ( volatile unsigned int * ) ( 0x4240132CUL ) )
#define bFM3_MFT0_WFG_WFIR_TMIF54 \
    *( ( volatile unsigned int * ) ( 0x42401330UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIC54 \
    *( ( volatile unsigned int * ) ( 0x42401334UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIE54 \
    *( ( volatile unsigned int * ) ( 0x42401338UL ) )
#define bFM3_MFT0_WFG_WFIR_TMIS54 \
    *( ( volatile unsigned int * ) ( 0x4240133CUL ) )
#define bFM3_MFT0_WFG_NZCL_DTIE \
    *( ( volatile unsigned int * ) ( 0x42401380UL ) )
#define bFM3_MFT0_WFG_NZCL_NWS0 \
    *( ( volatile unsigned int * ) ( 0x42401384UL ) )
#define bFM3_MFT0_WFG_NZCL_NWS1 \
    *( ( volatile unsigned int * ) ( 0x42401388UL ) )
#define bFM3_MFT0_WFG_NZCL_NWS2 \
    *( ( volatile unsigned int * ) ( 0x4240138CUL ) )
#define bFM3_MFT0_WFG_NZCL_SDTI \
    *( ( volatile unsigned int * ) ( 0x42401390UL ) )

/* Multifunction Timer unit 0 Input Capture Unit registers */
#define bFM3_MFT0_ICU_ICFS10_FSI00 \
    *( ( volatile unsigned int * ) ( 0x42400C00UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI01 \
    *( ( volatile unsigned int * ) ( 0x42400C04UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI02 \
    *( ( volatile unsigned int * ) ( 0x42400C08UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI03 \
    *( ( volatile unsigned int * ) ( 0x42400C0CUL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI10 \
    *( ( volatile unsigned int * ) ( 0x42400C10UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI11 \
    *( ( volatile unsigned int * ) ( 0x42400C14UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI12 \
    *( ( volatile unsigned int * ) ( 0x42400C18UL ) )
#define bFM3_MFT0_ICU_ICFS10_FSI13 \
    *( ( volatile unsigned int * ) ( 0x42400C1CUL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI20 \
    *( ( volatile unsigned int * ) ( 0x42400C20UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI21 \
    *( ( volatile unsigned int * ) ( 0x42400C24UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI22 \
    *( ( volatile unsigned int * ) ( 0x42400C28UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI23 \
    *( ( volatile unsigned int * ) ( 0x42400C2CUL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI30 \
    *( ( volatile unsigned int * ) ( 0x42400C30UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI31 \
    *( ( volatile unsigned int * ) ( 0x42400C34UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI32 \
    *( ( volatile unsigned int * ) ( 0x42400C38UL ) )
#define bFM3_MFT0_ICU_ICFS32_FSI33 \
    *( ( volatile unsigned int * ) ( 0x42400C3CUL ) )
#define bFM3_MFT0_ICU_ICSA10_EG00 \
    *( ( volatile unsigned int * ) ( 0x42400F00UL ) )
#define bFM3_MFT0_ICU_ICSA10_EG01 \
    *( ( volatile unsigned int * ) ( 0x42400F04UL ) )
#define bFM3_MFT0_ICU_ICSA10_EG10 \
    *( ( volatile unsigned int * ) ( 0x42400F08UL ) )
#define bFM3_MFT0_ICU_ICSA10_EG11 \
    *( ( volatile unsigned int * ) ( 0x42400F0CUL ) )
#define bFM3_MFT0_ICU_ICSA10_ICE0 \
    *( ( volatile unsigned int * ) ( 0x42400F10UL ) )
#define bFM3_MFT0_ICU_ICSA10_ICE1 \
    *( ( volatile unsigned int * ) ( 0x42400F14UL ) )
#define bFM3_MFT0_ICU_ICSA10_IPC0 \
    *( ( volatile unsigned int * ) ( 0x42400F18UL ) )
#define bFM3_MFT0_ICU_ICSA10_IPC1 \
    *( ( volatile unsigned int * ) ( 0x42400F1CUL ) )
#define bFM3_MFT0_ICU_ICSB10_IEI0 \
    *( ( volatile unsigned int * ) ( 0x42400F20UL ) )
#define bFM3_MFT0_ICU_ICSB10_IEI1 \
    *( ( volatile unsigned int * ) ( 0x42400F24UL ) )
#define bFM3_MFT0_ICU_ICSA32_EG20 \
    *( ( volatile unsigned int * ) ( 0x42400F80UL ) )
#define bFM3_MFT0_ICU_ICSA32_EG21 \
    *( ( volatile unsigned int * ) ( 0x42400F84UL ) )
#define bFM3_MFT0_ICU_ICSA32_EG30 \
    *( ( volatile unsigned int * ) ( 0x42400F88UL ) )
#define bFM3_MFT0_ICU_ICSA32_EG31 \
    *( ( volatile unsigned int * ) ( 0x42400F8CUL ) )
#define bFM3_MFT0_ICU_ICSA32_ICE2 \
    *( ( volatile unsigned int * ) ( 0x42400F90UL ) )
#define bFM3_MFT0_ICU_ICSA32_ICE3 \
    *( ( volatile unsigned int * ) ( 0x42400F94UL ) )
#define bFM3_MFT0_ICU_ICSA32_IPC2 \
    *( ( volatile unsigned int * ) ( 0x42400F98UL ) )
#define bFM3_MFT0_ICU_ICSA32_IPC3 \
    *( ( volatile unsigned int * ) ( 0x42400F9CUL ) )
#define bFM3_MFT0_ICU_ICSB32_IEI2 \
    *( ( volatile unsigned int * ) ( 0x42400FA0UL ) )
#define bFM3_MFT0_ICU_ICSB32_IEI3 \
    *( ( volatile unsigned int * ) ( 0x42400FA4UL ) )

/* Multifunction Timer unit 0 ADC Start Compare Unit registers */
#define bFM3_MFT0_ADCMP_ACSB_BDIS0 \
    *( ( volatile unsigned int * ) ( 0x42401700UL ) )
#define bFM3_MFT0_ADCMP_ACSB_BDIS1 \
    *( ( volatile unsigned int * ) ( 0x42401704UL ) )
#define bFM3_MFT0_ADCMP_ACSB_BDIS2 \
    *( ( volatile unsigned int * ) ( 0x42401708UL ) )
#define bFM3_MFT0_ADCMP_ACSB_BTS0 \
    *( ( volatile unsigned int * ) ( 0x42401710UL ) )
#define bFM3_MFT0_ADCMP_ACSB_BTS1 \
    *( ( volatile unsigned int * ) ( 0x42401714UL ) )
#define bFM3_MFT0_ADCMP_ACSB_BTS2 \
    *( ( volatile unsigned int * ) ( 0x42401718UL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE00 \
    *( ( volatile unsigned int * ) ( 0x42401780UL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE01 \
    *( ( volatile unsigned int * ) ( 0x42401784UL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE10 \
    *( ( volatile unsigned int * ) ( 0x42401788UL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE11 \
    *( ( volatile unsigned int * ) ( 0x4240178CUL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE20 \
    *( ( volatile unsigned int * ) ( 0x42401790UL ) )
#define bFM3_MFT0_ADCMP_ACSA_CE21 \
    *( ( volatile unsigned int * ) ( 0x42401794UL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL00 \
    *( ( volatile unsigned int * ) ( 0x424017A0UL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL01 \
    *( ( volatile unsigned int * ) ( 0x424017A4UL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL10 \
    *( ( volatile unsigned int * ) ( 0x424017A8UL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL11 \
    *( ( volatile unsigned int * ) ( 0x424017ACUL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL20 \
    *( ( volatile unsigned int * ) ( 0x424017B0UL ) )
#define bFM3_MFT0_ADCMP_ACSA_SEL21 \
    *( ( volatile unsigned int * ) ( 0x424017B4UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD0S0 \
    *( ( volatile unsigned int * ) ( 0x42401800UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD0S1 \
    *( ( volatile unsigned int * ) ( 0x42401804UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD1S0 \
    *( ( volatile unsigned int * ) ( 0x42401808UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD1S1 \
    *( ( volatile unsigned int * ) ( 0x4240180CUL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD2S0 \
    *( ( volatile unsigned int * ) ( 0x42401810UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD2S1 \
    *( ( volatile unsigned int * ) ( 0x42401814UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD0P0 \
    *( ( volatile unsigned int * ) ( 0x42401820UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD0P1 \
    *( ( volatile unsigned int * ) ( 0x42401824UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD1P0 \
    *( ( volatile unsigned int * ) ( 0x42401828UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD1P1 \
    *( ( volatile unsigned int * ) ( 0x4240182CUL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD2P0 \
    *( ( volatile unsigned int * ) ( 0x42401830UL ) )
#define bFM3_MFT0_ADCMP_ATSA_AD2P1 \
    *( ( volatile unsigned int * ) ( 0x42401834UL ) )

/* Multifunction Timer unit 1 Free Running Timer registers */
#define bFM3_MFT1_FRT_TCSA0_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42420600UL ) )
#define bFM3_MFT1_FRT_TCSA0_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42420604UL ) )
#define bFM3_MFT1_FRT_TCSA0_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42420608UL ) )
#define bFM3_MFT1_FRT_TCSA0_CLK3 \
    *( ( volatile unsigned int * ) ( 0x4242060CUL ) )
#define bFM3_MFT1_FRT_TCSA0_SCLR \
    *( ( volatile unsigned int * ) ( 0x42420610UL ) )
#define bFM3_MFT1_FRT_TCSA0_MODE \
    *( ( volatile unsigned int * ) ( 0x42420614UL ) )
#define bFM3_MFT1_FRT_TCSA0_STOP \
    *( ( volatile unsigned int * ) ( 0x42420618UL ) )
#define bFM3_MFT1_FRT_TCSA0_BFE \
    *( ( volatile unsigned int * ) ( 0x4242061CUL ) )
#define bFM3_MFT1_FRT_TCSA0_ICRE \
    *( ( volatile unsigned int * ) ( 0x42420620UL ) )
#define bFM3_MFT1_FRT_TCSA0_ICLR \
    *( ( volatile unsigned int * ) ( 0x42420624UL ) )
#define bFM3_MFT1_FRT_TCSA0_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42420634UL ) )
#define bFM3_MFT1_FRT_TCSA0_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42420638UL ) )
#define bFM3_MFT1_FRT_TCSA0_ECKE \
    *( ( volatile unsigned int * ) ( 0x4242063CUL ) )
#define bFM3_MFT1_FRT_TCSB0_AD0E \
    *( ( volatile unsigned int * ) ( 0x42420680UL ) )
#define bFM3_MFT1_FRT_TCSB0_AD1E \
    *( ( volatile unsigned int * ) ( 0x42420684UL ) )
#define bFM3_MFT1_FRT_TCSB0_AD2E \
    *( ( volatile unsigned int * ) ( 0x42420688UL ) )
#define bFM3_MFT1_FRT_TCSA1_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42420800UL ) )
#define bFM3_MFT1_FRT_TCSA1_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42420804UL ) )
#define bFM3_MFT1_FRT_TCSA1_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42420808UL ) )
#define bFM3_MFT1_FRT_TCSA1_CLK3 \
    *( ( volatile unsigned int * ) ( 0x4242080CUL ) )
#define bFM3_MFT1_FRT_TCSA1_SCLR \
    *( ( volatile unsigned int * ) ( 0x42420810UL ) )
#define bFM3_MFT1_FRT_TCSA1_MODE \
    *( ( volatile unsigned int * ) ( 0x42420814UL ) )
#define bFM3_MFT1_FRT_TCSA1_STOP \
    *( ( volatile unsigned int * ) ( 0x42420818UL ) )
#define bFM3_MFT1_FRT_TCSA1_BFE \
    *( ( volatile unsigned int * ) ( 0x4242081CUL ) )
#define bFM3_MFT1_FRT_TCSA1_ICRE \
    *( ( volatile unsigned int * ) ( 0x42420820UL ) )
#define bFM3_MFT1_FRT_TCSA1_ICLR \
    *( ( volatile unsigned int * ) ( 0x42420824UL ) )
#define bFM3_MFT1_FRT_TCSA1_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42420834UL ) )
#define bFM3_MFT1_FRT_TCSA1_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42420838UL ) )
#define bFM3_MFT1_FRT_TCSA1_ECKE \
    *( ( volatile unsigned int * ) ( 0x4242083CUL ) )
#define bFM3_MFT1_FRT_TCSB1_AD0E \
    *( ( volatile unsigned int * ) ( 0x42420880UL ) )
#define bFM3_MFT1_FRT_TCSB1_AD1E \
    *( ( volatile unsigned int * ) ( 0x42420884UL ) )
#define bFM3_MFT1_FRT_TCSB1_AD2E \
    *( ( volatile unsigned int * ) ( 0x42420888UL ) )
#define bFM3_MFT1_FRT_TCSA2_CLK0 \
    *( ( volatile unsigned int * ) ( 0x42420A00UL ) )
#define bFM3_MFT1_FRT_TCSA2_CLK1 \
    *( ( volatile unsigned int * ) ( 0x42420A04UL ) )
#define bFM3_MFT1_FRT_TCSA2_CLK2 \
    *( ( volatile unsigned int * ) ( 0x42420A08UL ) )
#define bFM3_MFT1_FRT_TCSA2_CLK3 \
    *( ( volatile unsigned int * ) ( 0x42420A0CUL ) )
#define bFM3_MFT1_FRT_TCSA2_SCLR \
    *( ( volatile unsigned int * ) ( 0x42420A10UL ) )
#define bFM3_MFT1_FRT_TCSA2_MODE \
    *( ( volatile unsigned int * ) ( 0x42420A14UL ) )
#define bFM3_MFT1_FRT_TCSA2_STOP \
    *( ( volatile unsigned int * ) ( 0x42420A18UL ) )
#define bFM3_MFT1_FRT_TCSA2_BFE \
    *( ( volatile unsigned int * ) ( 0x42420A1CUL ) )
#define bFM3_MFT1_FRT_TCSA2_ICRE \
    *( ( volatile unsigned int * ) ( 0x42420A20UL ) )
#define bFM3_MFT1_FRT_TCSA2_ICLR \
    *( ( volatile unsigned int * ) ( 0x42420A24UL ) )
#define bFM3_MFT1_FRT_TCSA2_IRQZE \
    *( ( volatile unsigned int * ) ( 0x42420A34UL ) )
#define bFM3_MFT1_FRT_TCSA2_IRQZF \
    *( ( volatile unsigned int * ) ( 0x42420A38UL ) )
#define bFM3_MFT1_FRT_TCSA2_ECKE \
    *( ( volatile unsigned int * ) ( 0x42420A3CUL ) )
#define bFM3_MFT1_FRT_TCSB2_AD0E \
    *( ( volatile unsigned int * ) ( 0x42420A80UL ) )
#define bFM3_MFT1_FRT_TCSB2_AD1E \
    *( ( volatile unsigned int * ) ( 0x42420A84UL ) )
#define bFM3_MFT1_FRT_TCSB2_AD2E \
    *( ( volatile unsigned int * ) ( 0x42420A88UL ) )

/* Multifunction Timer unit 1 Output Compare Unit registers */
#define bFM3_MFT1_OCU_OCSA10_CST0 \
    *( ( volatile unsigned int * ) ( 0x42420300UL ) )
#define bFM3_MFT1_OCU_OCSA10_CST1 \
    *( ( volatile unsigned int * ) ( 0x42420304UL ) )
#define bFM3_MFT1_OCU_OCSA10_BDIS0 \
    *( ( volatile unsigned int * ) ( 0x42420308UL ) )
#define bFM3_MFT1_OCU_OCSA10_BDIS1 \
    *( ( volatile unsigned int * ) ( 0x4242030CUL ) )
#define bFM3_MFT1_OCU_OCSA10_IOE0 \
    *( ( volatile unsigned int * ) ( 0x42420310UL ) )
#define bFM3_MFT1_OCU_OCSA10_IOE1 \
    *( ( volatile unsigned int * ) ( 0x42420314UL ) )
#define bFM3_MFT1_OCU_OCSA10_IOP0 \
    *( ( volatile unsigned int * ) ( 0x42420318UL ) )
#define bFM3_MFT1_OCU_OCSA10_IOP1 \
    *( ( volatile unsigned int * ) ( 0x4242031CUL ) )
#define bFM3_MFT1_OCU_OCSB10_OTD0 \
    *( ( volatile unsigned int * ) ( 0x42420320UL ) )
#define bFM3_MFT1_OCU_OCSB10_OTD1 \
    *( ( volatile unsigned int * ) ( 0x42420324UL ) )
#define bFM3_MFT1_OCU_OCSB10_CMOD \
    *( ( volatile unsigned int * ) ( 0x42420330UL ) )
#define bFM3_MFT1_OCU_OCSB10_BTS0 \
    *( ( volatile unsigned int * ) ( 0x42420334UL ) )
#define bFM3_MFT1_OCU_OCSB10_BTS1 \
    *( ( volatile unsigned int * ) ( 0x42420338UL ) )
#define bFM3_MFT1_OCU_OCSA32_CST2 \
    *( ( volatile unsigned int * ) ( 0x42420380UL ) )
#define bFM3_MFT1_OCU_OCSA32_CST3 \
    *( ( volatile unsigned int * ) ( 0x42420384UL ) )
#define bFM3_MFT1_OCU_OCSA32_BDIS2 \
    *( ( volatile unsigned int * ) ( 0x42420388UL ) )
#define bFM3_MFT1_OCU_OCSA32_BDIS3 \
    *( ( volatile unsigned int * ) ( 0x4242038CUL ) )
#define bFM3_MFT1_OCU_OCSA32_IOE2 \
    *( ( volatile unsigned int * ) ( 0x42420390UL ) )
#define bFM3_MFT1_OCU_OCSA32_IOE3 \
    *( ( volatile unsigned int * ) ( 0x42420394UL ) )
#define bFM3_MFT1_OCU_OCSA32_IOP2 \
    *( ( volatile unsigned int * ) ( 0x42420398UL ) )
#define bFM3_MFT1_OCU_OCSA32_IOP3 \
    *( ( volatile unsigned int * ) ( 0x4242039CUL ) )
#define bFM3_MFT1_OCU_OCSB32_OTD2 \
    *( ( volatile unsigned int * ) ( 0x424203A0UL ) )
#define bFM3_MFT1_OCU_OCSB32_OTD3 \
    *( ( volatile unsigned int * ) ( 0x424203A4UL ) )
#define bFM3_MFT1_OCU_OCSB32_CMOD \
    *( ( volatile unsigned int * ) ( 0x424203B0UL ) )
#define bFM3_MFT1_OCU_OCSB32_BTS2 \
    *( ( volatile unsigned int * ) ( 0x424203B4UL ) )
#define bFM3_MFT1_OCU_OCSB32_BTS3 \
    *( ( volatile unsigned int * ) ( 0x424203B8UL ) )
#define bFM3_MFT1_OCU_OCSA54_CST4 \
    *( ( volatile unsigned int * ) ( 0x42420400UL ) )
#define bFM3_MFT1_OCU_OCSA54_CST5 \
    *( ( volatile unsigned int * ) ( 0x42420404UL ) )
#define bFM3_MFT1_OCU_OCSA54_BDIS4 \
    *( ( volatile unsigned int * ) ( 0x42420408UL ) )
#define bFM3_MFT1_OCU_OCSA54_BDIS5 \
    *( ( volatile unsigned int * ) ( 0x4242040CUL ) )
#define bFM3_MFT1_OCU_OCSA54_IOE4 \
    *( ( volatile unsigned int * ) ( 0x42420410UL ) )
#define bFM3_MFT1_OCU_OCSA54_IOE5 \
    *( ( volatile unsigned int * ) ( 0x42420414UL ) )
#define bFM3_MFT1_OCU_OCSA54_IOP4 \
    *( ( volatile unsigned int * ) ( 0x42420418UL ) )
#define bFM3_MFT1_OCU_OCSA54_IOP5 \
    *( ( volatile unsigned int * ) ( 0x4242041CUL ) )
#define bFM3_MFT1_OCU_OCSB54_OTD4 \
    *( ( volatile unsigned int * ) ( 0x42420420UL ) )
#define bFM3_MFT1_OCU_OCSB54_OTD5 \
    *( ( volatile unsigned int * ) ( 0x42420424UL ) )
#define bFM3_MFT1_OCU_OCSB54_CMOD \
    *( ( volatile unsigned int * ) ( 0x42420430UL ) )
#define bFM3_MFT1_OCU_OCSB54_BTS4 \
    *( ( volatile unsigned int * ) ( 0x42420434UL ) )
#define bFM3_MFT1_OCU_OCSB54_BTS5 \
    *( ( volatile unsigned int * ) ( 0x42420438UL ) )
#define bFM3_MFT1_OCU_OCSC_MOD0 \
    *( ( volatile unsigned int * ) ( 0x424204A0UL ) )
#define bFM3_MFT1_OCU_OCSC_MOD1 \
    *( ( volatile unsigned int * ) ( 0x424204A4UL ) )
#define bFM3_MFT1_OCU_OCSC_MOD2 \
    *( ( volatile unsigned int * ) ( 0x424204A8UL ) )
#define bFM3_MFT1_OCU_OCSC_MOD3 \
    *( ( volatile unsigned int * ) ( 0x424204ACUL ) )
#define bFM3_MFT1_OCU_OCSC_MOD4 \
    *( ( volatile unsigned int * ) ( 0x424204B0UL ) )
#define bFM3_MFT1_OCU_OCSC_MOD5 \
    *( ( volatile unsigned int * ) ( 0x424204B4UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO00 \
    *( ( volatile unsigned int * ) ( 0x42420B00UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO01 \
    *( ( volatile unsigned int * ) ( 0x42420B04UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO02 \
    *( ( volatile unsigned int * ) ( 0x42420B08UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO03 \
    *( ( volatile unsigned int * ) ( 0x42420B0CUL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO10 \
    *( ( volatile unsigned int * ) ( 0x42420B10UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO11 \
    *( ( volatile unsigned int * ) ( 0x42420B14UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO12 \
    *( ( volatile unsigned int * ) ( 0x42420B18UL ) )
#define bFM3_MFT1_OCU_OCFS10_FSO13 \
    *( ( volatile unsigned int * ) ( 0x42420B1CUL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO20 \
    *( ( volatile unsigned int * ) ( 0x42420B20UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO21 \
    *( ( volatile unsigned int * ) ( 0x42420B24UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO22 \
    *( ( volatile unsigned int * ) ( 0x42420B28UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO23 \
    *( ( volatile unsigned int * ) ( 0x42420B2CUL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO30 \
    *( ( volatile unsigned int * ) ( 0x42420B30UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO31 \
    *( ( volatile unsigned int * ) ( 0x42420B34UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO32 \
    *( ( volatile unsigned int * ) ( 0x42420B38UL ) )
#define bFM3_MFT1_OCU_OCFS32_FSO33 \
    *( ( volatile unsigned int * ) ( 0x42420B3CUL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO40 \
    *( ( volatile unsigned int * ) ( 0x42420B80UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO41 \
    *( ( volatile unsigned int * ) ( 0x42420B84UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO42 \
    *( ( volatile unsigned int * ) ( 0x42420B88UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO43 \
    *( ( volatile unsigned int * ) ( 0x42420B8CUL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO50 \
    *( ( volatile unsigned int * ) ( 0x42420B90UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO51 \
    *( ( volatile unsigned int * ) ( 0x42420B94UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO52 \
    *( ( volatile unsigned int * ) ( 0x42420B98UL ) )
#define bFM3_MFT1_OCU_OCFS54_FSO53 \
    *( ( volatile unsigned int * ) ( 0x42420B9CUL ) )

/* Multifunction Timer unit 1 Waveform Generator and Noise Canceler registers */
#define bFM3_MFT1_WFG_WFSA10_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42421180UL ) )
#define bFM3_MFT1_WFG_WFSA10_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42421184UL ) )
#define bFM3_MFT1_WFG_WFSA10_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42421188UL ) )
#define bFM3_MFT1_WFG_WFSA10_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4242118CUL ) )
#define bFM3_MFT1_WFG_WFSA10_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42421190UL ) )
#define bFM3_MFT1_WFG_WFSA10_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42421194UL ) )
#define bFM3_MFT1_WFG_WFSA10_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42421198UL ) )
#define bFM3_MFT1_WFG_WFSA10_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4242119CUL ) )
#define bFM3_MFT1_WFG_WFSA10_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x424211A0UL ) )
#define bFM3_MFT1_WFG_WFSA10_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x424211A4UL ) )
#define bFM3_MFT1_WFG_WFSA10_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x424211A8UL ) )
#define bFM3_MFT1_WFG_WFSA10_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x424211ACUL ) )
#define bFM3_MFT1_WFG_WFSA10_DMOD \
    *( ( volatile unsigned int * ) ( 0x424211B0UL ) )
#define bFM3_MFT1_WFG_WFSA32_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42421200UL ) )
#define bFM3_MFT1_WFG_WFSA32_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42421204UL ) )
#define bFM3_MFT1_WFG_WFSA32_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42421208UL ) )
#define bFM3_MFT1_WFG_WFSA32_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4242120CUL ) )
#define bFM3_MFT1_WFG_WFSA32_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42421210UL ) )
#define bFM3_MFT1_WFG_WFSA32_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42421214UL ) )
#define bFM3_MFT1_WFG_WFSA32_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42421218UL ) )
#define bFM3_MFT1_WFG_WFSA32_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4242121CUL ) )
#define bFM3_MFT1_WFG_WFSA32_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x42421220UL ) )
#define bFM3_MFT1_WFG_WFSA32_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x42421224UL ) )
#define bFM3_MFT1_WFG_WFSA32_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x42421228UL ) )
#define bFM3_MFT1_WFG_WFSA32_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x4242122CUL ) )
#define bFM3_MFT1_WFG_WFSA32_DMOD \
    *( ( volatile unsigned int * ) ( 0x42421230UL ) )
#define bFM3_MFT1_WFG_WFSA54_DCK0 \
    *( ( volatile unsigned int * ) ( 0x42421280UL ) )
#define bFM3_MFT1_WFG_WFSA54_DCK1 \
    *( ( volatile unsigned int * ) ( 0x42421284UL ) )
#define bFM3_MFT1_WFG_WFSA54_DCK2 \
    *( ( volatile unsigned int * ) ( 0x42421288UL ) )
#define bFM3_MFT1_WFG_WFSA54_TMD0 \
    *( ( volatile unsigned int * ) ( 0x4242128CUL ) )
#define bFM3_MFT1_WFG_WFSA54_TMD1 \
    *( ( volatile unsigned int * ) ( 0x42421290UL ) )
#define bFM3_MFT1_WFG_WFSA54_TMD2 \
    *( ( volatile unsigned int * ) ( 0x42421294UL ) )
#define bFM3_MFT1_WFG_WFSA54_GTEN0 \
    *( ( volatile unsigned int * ) ( 0x42421298UL ) )
#define bFM3_MFT1_WFG_WFSA54_GTEN1 \
    *( ( volatile unsigned int * ) ( 0x4242129CUL ) )
#define bFM3_MFT1_WFG_WFSA54_PSEL0 \
    *( ( volatile unsigned int * ) ( 0x424212A0UL ) )
#define bFM3_MFT1_WFG_WFSA54_PSEL1 \
    *( ( volatile unsigned int * ) ( 0x424212A4UL ) )
#define bFM3_MFT1_WFG_WFSA54_PGEN0 \
    *( ( volatile unsigned int * ) ( 0x424212A8UL ) )
#define bFM3_MFT1_WFG_WFSA54_PGEN1 \
    *( ( volatile unsigned int * ) ( 0x424212ACUL ) )
#define bFM3_MFT1_WFG_WFSA54_DMOD \
    *( ( volatile unsigned int * ) ( 0x424212B0UL ) )
#define bFM3_MFT1_WFG_WFIR_DTIF \
    *( ( volatile unsigned int * ) ( 0x42421300UL ) )
#define bFM3_MFT1_WFG_WFIR_DTIC \
    *( ( volatile unsigned int * ) ( 0x42421304UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIF10 \
    *( ( volatile unsigned int * ) ( 0x42421310UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIC10 \
    *( ( volatile unsigned int * ) ( 0x42421314UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIE10 \
    *( ( volatile unsigned int * ) ( 0x42421318UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIS10 \
    *( ( volatile unsigned int * ) ( 0x4242131CUL ) )
#define bFM3_MFT1_WFG_WFIR_TMIF32 \
    *( ( volatile unsigned int * ) ( 0x42421320UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIC32 \
    *( ( volatile unsigned int * ) ( 0x42421324UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIE32 \
    *( ( volatile unsigned int * ) ( 0x42421328UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIS32 \
    *( ( volatile unsigned int * ) ( 0x4242132CUL ) )
#define bFM3_MFT1_WFG_WFIR_TMIF54 \
    *( ( volatile unsigned int * ) ( 0x42421330UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIC54 \
    *( ( volatile unsigned int * ) ( 0x42421334UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIE54 \
    *( ( volatile unsigned int * ) ( 0x42421338UL ) )
#define bFM3_MFT1_WFG_WFIR_TMIS54 \
    *( ( volatile unsigned int * ) ( 0x4242133CUL ) )
#define bFM3_MFT1_WFG_NZCL_DTIE \
    *( ( volatile unsigned int * ) ( 0x42421380UL ) )
#define bFM3_MFT1_WFG_NZCL_NWS0 \
    *( ( volatile unsigned int * ) ( 0x42421384UL ) )
#define bFM3_MFT1_WFG_NZCL_NWS1 \
    *( ( volatile unsigned int * ) ( 0x42421388UL ) )
#define bFM3_MFT1_WFG_NZCL_NWS2 \
    *( ( volatile unsigned int * ) ( 0x4242138CUL ) )
#define bFM3_MFT1_WFG_NZCL_SDTI \
    *( ( volatile unsigned int * ) ( 0x42421390UL ) )

/* Multifunction Timer unit 1 Input Capture Unit registers */
#define bFM3_MFT1_ICU_ICFS10_FSI00 \
    *( ( volatile unsigned int * ) ( 0x42420C00UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI01 \
    *( ( volatile unsigned int * ) ( 0x42420C04UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI02 \
    *( ( volatile unsigned int * ) ( 0x42420C08UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI03 \
    *( ( volatile unsigned int * ) ( 0x42420C0CUL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI10 \
    *( ( volatile unsigned int * ) ( 0x42420C10UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI11 \
    *( ( volatile unsigned int * ) ( 0x42420C14UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI12 \
    *( ( volatile unsigned int * ) ( 0x42420C18UL ) )
#define bFM3_MFT1_ICU_ICFS10_FSI13 \
    *( ( volatile unsigned int * ) ( 0x42420C1CUL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI20 \
    *( ( volatile unsigned int * ) ( 0x42420C20UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI21 \
    *( ( volatile unsigned int * ) ( 0x42420C24UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI22 \
    *( ( volatile unsigned int * ) ( 0x42420C28UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI23 \
    *( ( volatile unsigned int * ) ( 0x42420C2CUL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI30 \
    *( ( volatile unsigned int * ) ( 0x42420C30UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI31 \
    *( ( volatile unsigned int * ) ( 0x42420C34UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI32 \
    *( ( volatile unsigned int * ) ( 0x42420C38UL ) )
#define bFM3_MFT1_ICU_ICFS32_FSI33 \
    *( ( volatile unsigned int * ) ( 0x42420C3CUL ) )
#define bFM3_MFT1_ICU_ICSA10_EG00 \
    *( ( volatile unsigned int * ) ( 0x42420F00UL ) )
#define bFM3_MFT1_ICU_ICSA10_EG01 \
    *( ( volatile unsigned int * ) ( 0x42420F04UL ) )
#define bFM3_MFT1_ICU_ICSA10_EG10 \
    *( ( volatile unsigned int * ) ( 0x42420F08UL ) )
#define bFM3_MFT1_ICU_ICSA10_EG11 \
    *( ( volatile unsigned int * ) ( 0x42420F0CUL ) )
#define bFM3_MFT1_ICU_ICSA10_ICE0 \
    *( ( volatile unsigned int * ) ( 0x42420F10UL ) )
#define bFM3_MFT1_ICU_ICSA10_ICE1 \
    *( ( volatile unsigned int * ) ( 0x42420F14UL ) )
#define bFM3_MFT1_ICU_ICSA10_IPC0 \
    *( ( volatile unsigned int * ) ( 0x42420F18UL ) )
#define bFM3_MFT1_ICU_ICSA10_IPC1 \
    *( ( volatile unsigned int * ) ( 0x42420F1CUL ) )
#define bFM3_MFT1_ICU_ICSB10_IEI0 \
    *( ( volatile unsigned int * ) ( 0x42420F20UL ) )
#define bFM3_MFT1_ICU_ICSB10_IEI1 \
    *( ( volatile unsigned int * ) ( 0x42420F24UL ) )
#define bFM3_MFT1_ICU_ICSA32_EG20 \
    *( ( volatile unsigned int * ) ( 0x42420F80UL ) )
#define bFM3_MFT1_ICU_ICSA32_EG21 \
    *( ( volatile unsigned int * ) ( 0x42420F84UL ) )
#define bFM3_MFT1_ICU_ICSA32_EG30 \
    *( ( volatile unsigned int * ) ( 0x42420F88UL ) )
#define bFM3_MFT1_ICU_ICSA32_EG31 \
    *( ( volatile unsigned int * ) ( 0x42420F8CUL ) )
#define bFM3_MFT1_ICU_ICSA32_ICE2 \
    *( ( volatile unsigned int * ) ( 0x42420F90UL ) )
#define bFM3_MFT1_ICU_ICSA32_ICE3 \
    *( ( volatile unsigned int * ) ( 0x42420F94UL ) )
#define bFM3_MFT1_ICU_ICSA32_IPC2 \
    *( ( volatile unsigned int * ) ( 0x42420F98UL ) )
#define bFM3_MFT1_ICU_ICSA32_IPC3 \
    *( ( volatile unsigned int * ) ( 0x42420F9CUL ) )
#define bFM3_MFT1_ICU_ICSB32_IEI2 \
    *( ( volatile unsigned int * ) ( 0x42420FA0UL ) )
#define bFM3_MFT1_ICU_ICSB32_IEI3 \
    *( ( volatile unsigned int * ) ( 0x42420FA4UL ) )

/* Multifunction Timer unit 1 ADC Start Compare Unit registers */
#define bFM3_MFT1_ADCMP_ACSB_BDIS0 \
    *( ( volatile unsigned int * ) ( 0x42421700UL ) )
#define bFM3_MFT1_ADCMP_ACSB_BDIS1 \
    *( ( volatile unsigned int * ) ( 0x42421704UL ) )
#define bFM3_MFT1_ADCMP_ACSB_BDIS2 \
    *( ( volatile unsigned int * ) ( 0x42421708UL ) )
#define bFM3_MFT1_ADCMP_ACSB_BTS0 \
    *( ( volatile unsigned int * ) ( 0x42421710UL ) )
#define bFM3_MFT1_ADCMP_ACSB_BTS1 \
    *( ( volatile unsigned int * ) ( 0x42421714UL ) )
#define bFM3_MFT1_ADCMP_ACSB_BTS2 \
    *( ( volatile unsigned int * ) ( 0x42421718UL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE00 \
    *( ( volatile unsigned int * ) ( 0x42421780UL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE01 \
    *( ( volatile unsigned int * ) ( 0x42421784UL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE10 \
    *( ( volatile unsigned int * ) ( 0x42421788UL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE11 \
    *( ( volatile unsigned int * ) ( 0x4242178CUL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE20 \
    *( ( volatile unsigned int * ) ( 0x42421790UL ) )
#define bFM3_MFT1_ADCMP_ACSA_CE21 \
    *( ( volatile unsigned int * ) ( 0x42421794UL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL00 \
    *( ( volatile unsigned int * ) ( 0x424217A0UL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL01 \
    *( ( volatile unsigned int * ) ( 0x424217A4UL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL10 \
    *( ( volatile unsigned int * ) ( 0x424217A8UL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL11 \
    *( ( volatile unsigned int * ) ( 0x424217ACUL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL20 \
    *( ( volatile unsigned int * ) ( 0x424217B0UL ) )
#define bFM3_MFT1_ADCMP_ACSA_SEL21 \
    *( ( volatile unsigned int * ) ( 0x424217B4UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD0S0 \
    *( ( volatile unsigned int * ) ( 0x42421800UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD0S1 \
    *( ( volatile unsigned int * ) ( 0x42421804UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD1S0 \
    *( ( volatile unsigned int * ) ( 0x42421808UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD1S1 \
    *( ( volatile unsigned int * ) ( 0x4242180CUL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD2S0 \
    *( ( volatile unsigned int * ) ( 0x42421810UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD2S1 \
    *( ( volatile unsigned int * ) ( 0x42421814UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD0P0 \
    *( ( volatile unsigned int * ) ( 0x42421820UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD0P1 \
    *( ( volatile unsigned int * ) ( 0x42421824UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD1P0 \
    *( ( volatile unsigned int * ) ( 0x42421828UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD1P1 \
    *( ( volatile unsigned int * ) ( 0x4242182CUL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD2P0 \
    *( ( volatile unsigned int * ) ( 0x42421830UL ) )
#define bFM3_MFT1_ADCMP_ATSA_AD2P1 \
    *( ( volatile unsigned int * ) ( 0x42421834UL ) )

/* Multifunction Timer PPG registers */
#define bFM3_MFT_PPG_TTCR0_STR0 \
    *( ( volatile unsigned int * ) ( 0x42480020UL ) )
#define bFM3_MFT_PPG_TTCR0_MONI0 \
    *( ( volatile unsigned int * ) ( 0x42480024UL ) )
#define bFM3_MFT_PPG_TTCR0_CS00 \
    *( ( volatile unsigned int * ) ( 0x42480028UL ) )
#define bFM3_MFT_PPG_TTCR0_CS01 \
    *( ( volatile unsigned int * ) ( 0x4248002CUL ) )
#define bFM3_MFT_PPG_TTCR0_TRG0O \
    *( ( volatile unsigned int * ) ( 0x42480030UL ) )
#define bFM3_MFT_PPG_TTCR0_TRG2O \
    *( ( volatile unsigned int * ) ( 0x42480034UL ) )
#define bFM3_MFT_PPG_TTCR0_TRG4O \
    *( ( volatile unsigned int * ) ( 0x42480038UL ) )
#define bFM3_MFT_PPG_TTCR0_TRG6O \
    *( ( volatile unsigned int * ) ( 0x4248003CUL ) )
#define bFM3_MFT_PPG_TTCR1_STR1 \
    *( ( volatile unsigned int * ) ( 0x42480420UL ) )
#define bFM3_MFT_PPG_TTCR1_MONI1 \
    *( ( volatile unsigned int * ) ( 0x42480424UL ) )
#define bFM3_MFT_PPG_TTCR1_CS10 \
    *( ( volatile unsigned int * ) ( 0x42480428UL ) )
#define bFM3_MFT_PPG_TTCR1_CS11 \
    *( ( volatile unsigned int * ) ( 0x4248042CUL ) )
#define bFM3_MFT_PPG_TTCR1_TRG1O \
    *( ( volatile unsigned int * ) ( 0x42480430UL ) )
#define bFM3_MFT_PPG_TTCR1_TRG3O \
    *( ( volatile unsigned int * ) ( 0x42480434UL ) )
#define bFM3_MFT_PPG_TTCR1_TRG5O \
    *( ( volatile unsigned int * ) ( 0x42480438UL ) )
#define bFM3_MFT_PPG_TTCR1_TRG7O \
    *( ( volatile unsigned int * ) ( 0x4248043CUL ) )
...
#define bFM3_MFT_PPG_REVC_REV00 \
    *( ( volatile unsigned int * ) ( 0x42482080UL ) )
#define bFM3_MFT_PPG_REVC_REV01 \
    *( ( volatile unsigned int * ) ( 0x42482084UL ) )
#define bFM3_MFT_PPG_REVC_REV02 \
    *( ( volatile unsigned int * ) ( 0x42482088UL ) )
#define bFM3_MFT_PPG_REVC_REV03 \
    *( ( volatile unsigned int * ) ( 0x4248208CUL ) )
#define bFM3_MFT_PPG_REVC_REV04 \
    *( ( volatile unsigned int * ) ( 0x42482090UL ) )
#define bFM3_MFT_PPG_REVC_REV05 \
    *( ( volatile unsigned int * ) ( 0x42482094UL ) )
#define bFM3_MFT_PPG_REVC_REV06 \
    *( ( volatile unsigned int * ) ( 0x42482098UL ) )
#define bFM3_MFT_PPG_REVC_REV07 \
    *( ( volatile unsigned int * ) ( 0x4248209CUL ) )
#define bFM3_MFT_PPG_REVC_REV08 \
    *( ( volatile unsigned int * ) ( 0x424820A0UL ) )
#define bFM3_MFT_PPG_REVC_REV09 \
    *( ( volatile unsigned int * ) ( 0x424820A4UL ) )
#define bFM3_MFT_PPG_REVC_REV10 \
    *( ( volatile unsigned int * ) ( 0x424820A8UL ) )
#define bFM3_MFT_PPG_REVC_REV11 \
    *( ( volatile unsigned int * ) ( 0x424820ACUL ) )
#define bFM3_MFT_PPG_REVC_REV12 \
    *( ( volatile unsigned int * ) ( 0x424820B0UL ) )
#define bFM3_MFT_PPG_REVC_REV13 \
    *( ( volatile unsigned int * ) ( 0x424820B4UL ) )
#define bFM3_MFT_PPG_REVC_REV14 \
    *( ( volatile unsigned int * ) ( 0x424820B8UL ) )
#define bFM3_MFT_PPG_REVC_REV15 \
    *( ( volatile unsigned int * ) ( 0x424820BCUL ) )
#define bFM3_MFT_PPG_PPGC1_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484000UL ) )
...
#define bFM3_MFT_PPG_PPGC1_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248400CUL ) )
#define bFM3_MFT_PPG_PPGC1_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484010UL ) )
#define bFM3_MFT_PPG_PPGC1_INTM \
    *( ( volatile unsigned int * ) ( 0x42484014UL ) )
...
#define bFM3_MFT_PPG_PPGC0_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484020UL ) )
...
#define bFM3_MFT_PPG_PPGC0_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248402CUL ) )
#define bFM3_MFT_PPG_PPGC0_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484030UL ) )
#define bFM3_MFT_PPG_PPGC0_INTM \
    *( ( volatile unsigned int * ) ( 0x42484034UL ) )
...
#define bFM3_MFT_PPG_PPGC3_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484080UL ) )
...
#define bFM3_MFT_PPG_PPGC3_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248408CUL ) )
#define bFM3_MFT_PPG_PPGC3_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484090UL ) )
#define bFM3_MFT_PPG_PPGC3_INTM \
    *( ( volatile unsigned int * ) ( 0x42484094UL ) )
...
#define bFM3_MFT_PPG_PPGC2_TTRG \
    *( ( volatile unsigned int * ) ( 0x424840A0UL ) )
...
#define bFM3_MFT_PPG_PPGC2_PCS0 \
    *( ( volatile unsigned int * ) ( 0x424840ACUL ) )
#define bFM3_MFT_PPG_PPGC2_PCS1 \
    *( ( volatile unsigned int * ) ( 0x424840B0UL ) )
#define bFM3_MFT_PPG_PPGC2_INTM \
    *( ( volatile unsigned int * ) ( 0x424840B4UL ) )
...
#define bFM3_MFT_PPG_GATEC0_EDGE0 \
    *( ( volatile unsigned int * ) ( 0x42484300UL ) )
#define bFM3_MFT_PPG_GATEC0_STRG0 \
    *( ( volatile unsigned int * ) ( 0x42484304UL ) )
#define bFM3_MFT_PPG_GATEC0_EDGE2 \
    *( ( volatile unsigned int * ) ( 0x42484310UL ) )
#define bFM3_MFT_PPG_GATEC0_STRG2 \
    *( ( volatile unsigned int * ) ( 0x42484314UL ) )
#define bFM3_MFT_PPG_PPGC5_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484800UL ) )
...
#define bFM3_MFT_PPG_PPGC5_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248480CUL ) )
#define bFM3_MFT_PPG_PPGC5_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484810UL ) )
#define bFM3_MFT_PPG_PPGC5_INTM \
    *( ( volatile unsigned int * ) ( 0x42484814UL ) )
...
#define bFM3_MFT_PPG_PPGC4_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484820UL ) )
...
#define bFM3_MFT_PPG_PPGC4_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248482CUL ) )
#define bFM3_MFT_PPG_PPGC4_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484830UL ) )
#define bFM3_MFT_PPG_PPGC4_INTM \
    *( ( volatile unsigned int * ) ( 0x42484834UL ) )
...
#define bFM3_MFT_PPG_PPGC7_TTRG \
    *( ( volatile unsigned int * ) ( 0x42484880UL ) )
...
#define bFM3_MFT_PPG_PPGC7_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248488CUL ) )
#define bFM3_MFT_PPG_PPGC7_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42484890UL ) )
#define bFM3_MFT_PPG_PPGC7_INTM \
    *( ( volatile unsigned int * ) ( 0x42484894UL ) )
...
#define bFM3_MFT_PPG_PPGC6_TTRG \
    *( ( volatile unsigned int * ) ( 0x424848A0UL ) )
...
#define bFM3_MFT_PPG_PPGC6_PCS0 \
    *( ( volatile unsigned int * ) ( 0x424848ACUL ) )
#define bFM3_MFT_PPG_PPGC6_PCS1 \
    *( ( volatile unsigned int * ) ( 0x424848B0UL ) )
#define bFM3_MFT_PPG_PPGC6_INTM \
    *( ( volatile unsigned int * ) ( 0x424848B4UL ) )
...
#define bFM3_MFT_PPG_GATEC4_EDGE4 \
    *( ( volatile unsigned int * ) ( 0x42484B00UL ) )
#define bFM3_MFT_PPG_GATEC4_STRG4 \
    *( ( volatile unsigned int * ) ( 0x42484B04UL ) )
#define bFM3_MFT_PPG_GATEC4_EDGE6 \
    *( ( volatile unsigned int * ) ( 0x42484B10UL ) )
#define bFM3_MFT_PPG_GATEC4_STRG6 \
    *( ( volatile unsigned int * ) ( 0x42484B14UL ) )
#define bFM3_MFT_PPG_PPGC9_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485000UL ) )
...
#define bFM3_MFT_PPG_PPGC9_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248500CUL ) )
#define bFM3_MFT_PPG_PPGC9_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485010UL ) )
#define bFM3_MFT_PPG_PPGC9_INTM \
    *( ( volatile unsigned int * ) ( 0x42485014UL ) )
...
#define bFM3_MFT_PPG_PPGC8_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485020UL ) )
...
#define bFM3_MFT_PPG_PPGC8_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248502CUL ) )
#define bFM3_MFT_PPG_PPGC8_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485030UL ) )
#define bFM3_MFT_PPG_PPGC8_INTM \
    *( ( volatile unsigned int * ) ( 0x42485034UL ) )
...
#define bFM3_MFT_PPG_PPGC11_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485080UL ) )
#define bFM3_MFT_PPG_PPGC11_MD0 \
    *( ( volatile unsigned int * ) ( 0x42485084UL ) )
#define bFM3_MFT_PPG_PPGC11_MD1 \
    *( ( volatile unsigned int * ) ( 0x42485088UL ) )
#define bFM3_MFT_PPG_PPGC11_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248508CUL ) )
#define bFM3_MFT_PPG_PPGC11_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485090UL ) )
#define bFM3_MFT_PPG_PPGC11_INTM \
    *( ( volatile unsigned int * ) ( 0x42485094UL ) )
#define bFM3_MFT_PPG_PPGC11_PUF \
    *( ( volatile unsigned int * ) ( 0x42485098UL ) )
#define bFM3_MFT_PPG_PPGC11_PIE \
    *( ( volatile unsigned int * ) ( 0x4248509CUL ) )
#define bFM3_MFT_PPG_PPGC10_TTRG \
    *( ( volatile unsigned int * ) ( 0x424850A0UL ) )
#define bFM3_MFT_PPG_PPGC10_MD0 \
    *( ( volatile unsigned int * ) ( 0x424850A4UL ) )
#define bFM3_MFT_PPG_PPGC10_MD1 \
    *( ( volatile unsigned int * ) ( 0x424850A8UL ) )
#define bFM3_MFT_PPG_PPGC10_PCS0 \
    *( ( volatile unsigned int * ) ( 0x424850ACUL ) )
#define bFM3_MFT_PPG_PPGC10_PCS1 \
    *( ( volatile unsigned int * ) ( 0x424850B0UL ) )
#define bFM3_MFT_PPG_PPGC10_INTM \
    *( ( volatile unsigned int * ) ( 0x424850B4UL ) )
#define bFM3_MFT_PPG_PPGC10_PUF \
    *( ( volatile unsigned int * ) ( 0x424850B8UL ) )
#define bFM3_MFT_PPG_PPGC10_PIE \
    *( ( volatile unsigned int * ) ( 0x424850BCUL ) )
#define bFM3_MFT_PPG_GATEC8_EDGE8 \
    *( ( volatile unsigned int * ) ( 0x42485300UL ) )
#define bFM3_MFT_PPG_GATEC8_STRG8 \
    *( ( volatile unsigned int * ) ( 0x42485304UL ) )
#define bFM3_MFT_PPG_GATEC8_EDGE10 \
    *( ( volatile unsigned int * ) ( 0x42485310UL ) )
#define bFM3_MFT_PPG_GATEC8_STRG10 \
    *( ( volatile unsigned int * ) ( 0x42485314UL ) )
#define bFM3_MFT_PPG_PPGC13_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485800UL ) )
#define bFM3_MFT_PPG_PPGC13_MD0 \
    *( ( volatile unsigned int * ) ( 0x42485804UL ) )
#define bFM3_MFT_PPG_PPGC13_MD1 \
    *( ( volatile unsigned int * ) ( 0x42485808UL ) )
#define bFM3_MFT_PPG_PPGC13_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248580CUL ) )
#define bFM3_MFT_PPG_PPGC13_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485810UL ) )
#define bFM3_MFT_PPG_PPGC13_INTM \
    *( ( volatile unsigned int * ) ( 0x42485814UL ) )
#define bFM3_MFT_PPG_PPGC13_PUF \
    *( ( volatile unsigned int * ) ( 0x42485818UL ) )
#define bFM3_MFT_PPG_PPGC13_PIE \
    *( ( volatile unsigned int * ) ( 0x4248581CUL ) )
#define bFM3_MFT_PPG_PPGC12_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485820UL ) )
#define bFM3_MFT_PPG_PPGC12_MD0 \
    *( ( volatile unsigned int * ) ( 0x42485824UL ) )
#define bFM3_MFT_PPG_PPGC12_MD1 \
    *( ( volatile unsigned int * ) ( 0x42485828UL ) )
#define bFM3_MFT_PPG_PPGC12_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248582CUL ) )
#define bFM3_MFT_PPG_PPGC12_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485830UL ) )
#define bFM3_MFT_PPG_PPGC12_INTM \
    *( ( volatile unsigned int * ) ( 0x42485834UL ) )
#define bFM3_MFT_PPG_PPGC12_PUF \
    *( ( volatile unsigned int * ) ( 0x42485838UL ) )
#define bFM3_MFT_PPG_PPGC12_PIE \
    *( ( volatile unsigned int * ) ( 0x4248583CUL ) )
#define bFM3_MFT_PPG_PPGC15_TTRG \
    *( ( volatile unsigned int * ) ( 0x42485880UL ) )
#define bFM3_MFT_PPG_PPGC15_MD0 \
    *( ( volatile unsigned int * ) ( 0x42485884UL ) )
#define bFM3_MFT_PPG_PPGC15_MD1 \
    *( ( volatile unsigned int * ) ( 0x42485888UL ) )
#define bFM3_MFT_PPG_PPGC15_PCS0 \
    *( ( volatile unsigned int * ) ( 0x4248588CUL ) )
#define bFM3_MFT_PPG_PPGC15_PCS1 \
    *( ( volatile unsigned int * ) ( 0x42485890UL ) )
#define bFM3_MFT_PPG_PPGC15_INTM \
    *( ( volatile unsigned int * ) ( 0x42485894UL ) )
#define bFM3_MFT_PPG_PPGC15_PUF \
    *( ( volatile unsigned int * ) ( 0x42485898UL ) )
#define bFM3_MFT_PPG_PPGC15_PIE \
    *( ( volatile unsigned int * ) ( 0x4248589CUL ) )
#define bFM3_MFT_PPG_PPGC14_TTRG \
    *( ( volatile unsigned int * ) ( 0x424858A0UL ) )
#define bFM3_MFT_PPG_PPGC14_MD0 \
    *( ( volatile unsigned int * ) ( 0x424858A4UL ) )
#define bFM3_MFT_PPG_PPGC14_MD1 \
    *( ( volatile unsigned int * ) ( 0x424858A8UL ) )
#define bFM3_MFT_PPG_PPGC14_PCS0 \
    *( ( volatile unsigned int * ) ( 0x424858ACUL ) )
#define bFM3_MFT_PPG_PPGC14_PCS1 \
    *( ( volatile unsigned int * ) ( 0x424858B0UL ) )
#define bFM3_MFT_PPG_PPGC14_INTM \
    *( ( volatile unsigned int * ) ( 0x424858B4UL ) )
#define bFM3_MFT_PPG_PPGC14_PUF \
    *( ( volatile unsigned int * ) ( 0x424858B8UL ) )
#define bFM3_MFT_PPG_PPGC14_PIE \
    *( ( volatile unsigned int * ) ( 0x424858BCUL ) )
#define bFM3_MFT_PPG_GATEC12_EDGE12 \
    *( ( volatile unsigned int * ) ( 0x42485B00UL ) )
#define bFM3_MFT_PPG_GATEC12_STRG12 \
    *( ( volatile unsigned int * ) ( 0x42485B04UL ) )
#define bFM3_MFT_PPG_GATEC12_EDGE14 \
    *( ( volatile unsigned int * ) ( 0x42485B10UL ) )
#define bFM3_MFT_PPG_GATEC12_STRG14 \
    *( ( volatile unsigned int * ) ( 0x42485B14UL ) )
...
#define bFM3_BT0_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A01ACUL ) )
...
#define bFM3_BT0_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0220UL ) )
...
#define bFM3_BT0_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A01ACUL ) )
...
#define bFM3_BT0_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0220UL ) )
...
#define bFM3_BT0_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0220UL ) )
...
#define bFM3_BT1_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A09ACUL ) )
...
#define bFM3_BT1_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0A20UL ) )
...
#define bFM3_BT1_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A09ACUL ) )
...
#define bFM3_BT1_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0A20UL ) )
...
#define bFM3_BT1_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A0A20UL ) )
...
#define bFM3_BT2_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A11ACUL ) )
...
#define bFM3_BT2_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1220UL ) )
...
#define bFM3_BT2_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A11ACUL ) )
...
#define bFM3_BT2_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1220UL ) )
...
#define bFM3_BT2_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1220UL ) )
...
#define bFM3_BT3_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A19ACUL ) )
...
#define bFM3_BT3_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1A20UL ) )
...
#define bFM3_BT3_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A19ACUL ) )
...
#define bFM3_BT3_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1A20UL ) )
...
#define bFM3_BT3_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A1A20UL ) )
...
#define bFM3_BT4_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A41ACUL ) )
...
#define bFM3_BT4_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4220UL ) )
...
#define bFM3_BT4_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A41ACUL ) )
...
#define bFM3_BT4_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4220UL ) )
...
#define bFM3_BT4_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4220UL ) )
...
#define bFM3_BT5_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A49ACUL ) )
...
#define bFM3_BT5_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4A20UL ) )
...
#define bFM3_BT5_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A49ACUL ) )
...
#define bFM3_BT5_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4A20UL ) )
...
#define bFM3_BT5_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A4A20UL ) )
...
#define bFM3_BT6_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A51ACUL ) )
...
#define bFM3_BT6_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5220UL ) )
...
#define bFM3_BT6_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A51ACUL ) )
...
#define bFM3_BT6_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5220UL ) )
...
#define bFM3_BT6_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5220UL ) )
...
#define bFM3_BT7_PPG_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A59ACUL ) )
...
#define bFM3_BT7_PPG_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5A20UL ) )
...
#define bFM3_BT7_PWM_TMCR_RTGEN \
    *( ( volatile unsigned int * ) ( 0x424A59ACUL ) )
...
#define bFM3_BT7_PWM_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5A20UL ) )
...
#define bFM3_BT7_PWC_TMCR2_CKS3 \
    *( ( volatile unsigned int * ) ( 0x424A5A20UL ) )

/* Base Timer I/O selector channel 0 - channel 3 registers */
#define bFM3_BTIOSEL03_BTSEL0123_SEL01_0 \
    *( ( volatile unsigned int * ) ( 0x424A2020UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL01_1 \
    *( ( volatile unsigned int * ) ( 0x424A2024UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL01_2 \
    *( ( volatile unsigned int * ) ( 0x424A2028UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL01_3 \
    *( ( volatile unsigned int * ) ( 0x424A202CUL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL23_0 \
    *( ( volatile unsigned int * ) ( 0x424A2030UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL23_1 \
    *( ( volatile unsigned int * ) ( 0x424A2034UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL23_2 \
    *( ( volatile unsigned int * ) ( 0x424A2038UL ) )
#define bFM3_BTIOSEL03_BTSEL0123_SEL23_3 \
    *( ( volatile unsigned int * ) ( 0x424A203CUL ) )

/* Base Timer I/O selector channel 4 - channel 7 registers */
#define bFM3_BTIOSEL47_BTSEL4567_SEL45_0 \
    *( ( volatile unsigned int * ) ( 0x424A6020UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL45_1 \
    *( ( volatile unsigned int * ) ( 0x424A6024UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL45_2 \
    *( ( volatile unsigned int * ) ( 0x424A6028UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL45_3 \
    *( ( volatile unsigned int * ) ( 0x424A602CUL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL67_0 \
    *( ( volatile unsigned int * ) ( 0x424A6030UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL67_1 \
    *( ( volatile unsigned int * ) ( 0x424A6034UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL67_2 \
    *( ( volatile unsigned int * ) ( 0x424A6038UL ) )
#define bFM3_BTIOSEL47_BTSEL4567_SEL67_3 \
    *( ( volatile unsigned int * ) ( 0x424A603CUL ) )
...
#define bFM3_SBSSR_BTSSSR_SSR10 \
    *( ( volatile unsigned int * ) ( 0x424BFFA8UL ) )
#define bFM3_SBSSR_BTSSSR_SSR11 \
    *( ( volatile unsigned int * ) ( 0x424BFFACUL ) )
#define bFM3_SBSSR_BTSSSR_SSR12 \
    *( ( volatile unsigned int * ) ( 0x424BFFB0UL ) )
#define bFM3_SBSSR_BTSSSR_SSR13 \
    *( ( volatile unsigned int * ) ( 0x424BFFB4UL ) )
#define bFM3_SBSSR_BTSSSR_SSR14 \
    *( ( volatile unsigned int * ) ( 0x424BFFB8UL ) )
#define bFM3_SBSSR_BTSSSR_SSR15 \
    *( ( volatile unsigned int * ) ( 0x424BFFBCUL ) )
...
#define bFM3_QPRC0_QICR_QPRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0288UL ) )
...
#define bFM3_QPRC0_QICR_QPCNRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C02B0UL ) )
#define bFM3_QPRC0_QICR_QPCNRCMF \
    *( ( volatile unsigned int * ) ( 0x424C02B4UL ) )
#define bFM3_QPRC0_QICRL_QPCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0280UL ) )
#define bFM3_QPRC0_QICRL_QPCMF *( ( volatile unsigned int * ) ( 0x424C0284UL ) )
#define bFM3_QPRC0_QICRL_QPRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0288UL ) )
#define bFM3_QPRC0_QICRL_QPRCMF \
    *( ( volatile unsigned int * ) ( 0x424C028CUL ) )
...
#define bFM3_QPRC0_QICRH_QPCNRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C02B0UL ) )
#define bFM3_QPRC0_QICRH_QPCNRCMF \
    *( ( volatile unsigned int * ) ( 0x424C02B4UL ) )
...
#define bFM3_QPRC1_QICR_QPRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0A88UL ) )
...
#define bFM3_QPRC1_QICR_QPCNRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0AB0UL ) )
#define bFM3_QPRC1_QICR_QPCNRCMF \
    *( ( volatile unsigned int * ) ( 0x424C0AB4UL ) )
#define bFM3_QPRC1_QICRL_QPCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0A80UL ) )
#define bFM3_QPRC1_QICRL_QPCMF *( ( volatile unsigned int * ) ( 0x424C0A84UL ) )
#define bFM3_QPRC1_QICRL_QPRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0A88UL ) )
#define bFM3_QPRC1_QICRL_QPRCMF \
    *( ( volatile unsigned int * ) ( 0x424C0A8CUL ) )
...
#define bFM3_QPRC1_QICRH_QPCNRCMIE \
    *( ( volatile unsigned int * ) ( 0x424C0AB0UL ) )
#define bFM3_QPRC1_QICRH_QPCNRCMF \
    *( ( volatile unsigned int * ) ( 0x424C0AB4UL ) )
...
/* CR trimming registers */
#define bFM3_CRTRIM_MCR_PSR_CSR0 \
    *( ( volatile unsigned int * ) ( 0x425C0000UL ) )
#define bFM3_CRTRIM_MCR_PSR_CSR1 \
    *( ( volatile unsigned int * ) ( 0x425C0004UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD0 \
    *( ( volatile unsigned int * ) ( 0x425C0080UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD1 \
    *( ( volatile unsigned int * ) ( 0x425C0084UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD2 \
    *( ( volatile unsigned int * ) ( 0x425C0088UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD3 \
    *( ( volatile unsigned int * ) ( 0x425C008CUL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD4 \
    *( ( volatile unsigned int * ) ( 0x425C0090UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD5 \
    *( ( volatile unsigned int * ) ( 0x425C0094UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD6 \
    *( ( volatile unsigned int * ) ( 0x425C0098UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD7 \
    *( ( volatile unsigned int * ) ( 0x425C009CUL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD8 \
    *( ( volatile unsigned int * ) ( 0x425C00A0UL ) )
#define bFM3_CRTRIM_MCR_FTRM_TRD9 \
    *( ( volatile unsigned int * ) ( 0x425C00A4UL ) )
...
/* Interrupt request read registers */
#define bFM3_INTREQ_DRQSEL_DRQSEL0 \
    *( ( volatile unsigned int * ) ( 0x42620000UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL1 \
    *( ( volatile unsigned int * ) ( 0x42620004UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL2 \
    *( ( volatile unsigned int * ) ( 0x42620008UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL3 \
    *( ( volatile unsigned int * ) ( 0x4262000CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL4 \
    *( ( volatile unsigned int * ) ( 0x42620010UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL5 \
    *( ( volatile unsigned int * ) ( 0x42620014UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL6 \
    *( ( volatile unsigned int * ) ( 0x42620018UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL7 \
    *( ( volatile unsigned int * ) ( 0x4262001CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL8 \
    *( ( volatile unsigned int * ) ( 0x42620020UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL9 \
    *( ( volatile unsigned int * ) ( 0x42620024UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL10 \
    *( ( volatile unsigned int * ) ( 0x42620028UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL11 \
    *( ( volatile unsigned int * ) ( 0x4262002CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL12 \
    *( ( volatile unsigned int * ) ( 0x42620030UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL13 \
    *( ( volatile unsigned int * ) ( 0x42620034UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL14 \
    *( ( volatile unsigned int * ) ( 0x42620038UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL15 \
    *( ( volatile unsigned int * ) ( 0x4262003CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL16 \
    *( ( volatile unsigned int * ) ( 0x42620040UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL17 \
    *( ( volatile unsigned int * ) ( 0x42620044UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL18 \
    *( ( volatile unsigned int * ) ( 0x42620048UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL19 \
    *( ( volatile unsigned int * ) ( 0x4262004CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL20 \
    *( ( volatile unsigned int * ) ( 0x42620050UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL21 \
    *( ( volatile unsigned int * ) ( 0x42620054UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL22 \
    *( ( volatile unsigned int * ) ( 0x42620058UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL23 \
    *( ( volatile unsigned int * ) ( 0x4262005CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL24 \
    *( ( volatile unsigned int * ) ( 0x42620060UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL25 \
    *( ( volatile unsigned int * ) ( 0x42620064UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL26 \
    *( ( volatile unsigned int * ) ( 0x42620068UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL27 \
    *( ( volatile unsigned int * ) ( 0x4262006CUL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL28 \
    *( ( volatile unsigned int * ) ( 0x42620070UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL29 \
    *( ( volatile unsigned int * ) ( 0x42620074UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL30 \
    *( ( volatile unsigned int * ) ( 0x42620078UL ) )
#define bFM3_INTREQ_DRQSEL_DRQSEL31 \
    *( ( volatile unsigned int * ) ( 0x4262007CUL ) )
#define bFM3_INTREQ_EXC02MON_NMI \
    *( ( volatile unsigned int * ) ( 0x42620200UL ) )
#define bFM3_INTREQ_EXC02MON_HWINT \
    *( ( volatile unsigned int * ) ( 0x42620204UL ) )
#define bFM3_INTREQ_IRQ00MON_FCSINT \
    *( ( volatile unsigned int * ) ( 0x42620280UL ) )
#define bFM3_INTREQ_IRQ01MON_SWWDTINT \
    *( ( volatile unsigned int * ) ( 0x42620300UL ) )
#define bFM3_INTREQ_IRQ02MON_LVDINT \
    *( ( volatile unsigned int * ) ( 0x42620380UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE0INT0 \
    *( ( volatile unsigned int * ) ( 0x42620400UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE0INT1 \
    *( ( volatile unsigned int * ) ( 0x42620404UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE0INT2 \
    *( ( volatile unsigned int * ) ( 0x42620408UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262040CUL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE1INT0 \
    *( ( volatile unsigned int * ) ( 0x42620410UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE1INT1 \
    *( ( volatile unsigned int * ) ( 0x42620414UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE1INT2 \
    *( ( volatile unsigned int * ) ( 0x42620418UL ) )
#define bFM3_INTREQ_IRQ03MON_WAVE1INT3 \
    *( ( volatile unsigned int * ) ( 0x4262041CUL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT0 \
    *( ( volatile unsigned int * ) ( 0x42620480UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT1 \
    *( ( volatile unsigned int * ) ( 0x42620484UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT2 \
    *( ( volatile unsigned int * ) ( 0x42620488UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT3 \
    *( ( volatile unsigned int * ) ( 0x4262048CUL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT4 \
    *( ( volatile unsigned int * ) ( 0x42620490UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT5 \
    *( ( volatile unsigned int * ) ( 0x42620494UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT6 \
    *( ( volatile unsigned int * ) ( 0x42620498UL ) )
#define bFM3_INTREQ_IRQ04MON_EXTINT7 \
    *( ( volatile unsigned int * ) ( 0x4262049CUL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT0 \
    *( ( volatile unsigned int * ) ( 0x42620500UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT1 \
    *( ( volatile unsigned int * ) ( 0x42620504UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT2 \
    *( ( volatile unsigned int * ) ( 0x42620508UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT3 \
    *( ( volatile unsigned int * ) ( 0x4262050CUL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT4 \
    *( ( volatile unsigned int * ) ( 0x42620510UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT5 \
    *( ( volatile unsigned int * ) ( 0x42620514UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT6 \
    *( ( volatile unsigned int * ) ( 0x42620518UL ) )
#define bFM3_INTREQ_IRQ05MON_EXTINT7 \
    *( ( volatile unsigned int * ) ( 0x4262051CUL ) )
#define bFM3_INTREQ_IRQ06MON_TIMINT0 \
    *( ( volatile unsigned int * ) ( 0x42620580UL ) )
#define bFM3_INTREQ_IRQ06MON_TIMINT1 \
    *( ( volatile unsigned int * ) ( 0x42620584UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT0 \
    *( ( volatile unsigned int * ) ( 0x42620588UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT1 \
    *( ( volatile unsigned int * ) ( 0x4262058CUL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT2 \
    *( ( volatile unsigned int * ) ( 0x42620590UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT3 \
    *( ( volatile unsigned int * ) ( 0x42620594UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT4 \
    *( ( volatile unsigned int * ) ( 0x42620598UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD0INT5 \
    *( ( volatile unsigned int * ) ( 0x4262059CUL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT0 \
    *( ( volatile unsigned int * ) ( 0x426205A0UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT1 \
    *( ( volatile unsigned int * ) ( 0x426205A4UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT2 \
    *( ( volatile unsigned int * ) ( 0x426205A8UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT3 \
    *( ( volatile unsigned int * ) ( 0x426205ACUL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT4 \
    *( ( volatile unsigned int * ) ( 0x426205B0UL ) )
#define bFM3_INTREQ_IRQ06MON_QUD1INT5 \
    *( ( volatile unsigned int * ) ( 0x426205B4UL ) )
#define bFM3_INTREQ_IRQ07MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620600UL ) )
#define bFM3_INTREQ_IRQ08MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620680UL ) )
#define bFM3_INTREQ_IRQ08MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620684UL ) )
#define bFM3_INTREQ_IRQ09MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620700UL ) )
#define bFM3_INTREQ_IRQ10MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620780UL ) )
#define bFM3_INTREQ_IRQ10MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620784UL ) )
#define bFM3_INTREQ_IRQ11MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620800UL ) )
#define bFM3_INTREQ_IRQ12MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620880UL ) )
#define bFM3_INTREQ_IRQ12MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620884UL ) )
#define bFM3_INTREQ_IRQ13MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620900UL ) )
#define bFM3_INTREQ_IRQ14MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620980UL ) )
#define bFM3_INTREQ_IRQ14MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620984UL ) )
#define bFM3_INTREQ_IRQ15MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620A00UL ) )
#define bFM3_INTREQ_IRQ16MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620A80UL ) )
#define bFM3_INTREQ_IRQ16MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620A84UL ) )
#define bFM3_INTREQ_IRQ17MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620B00UL ) )
#define bFM3_INTREQ_IRQ18MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620B80UL ) )
#define bFM3_INTREQ_IRQ18MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620B84UL ) )
#define bFM3_INTREQ_IRQ19MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620C00UL ) )
#define bFM3_INTREQ_IRQ20MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620C80UL ) )
#define bFM3_INTREQ_IRQ20MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620C84UL ) )
#define bFM3_INTREQ_IRQ21MON_FMSINT \
    *( ( volatile unsigned int * ) ( 0x42620D00UL ) )
#define bFM3_INTREQ_IRQ22MON_MFSINT0 \
    *( ( volatile unsigned int * ) ( 0x42620D80UL ) )
#define bFM3_INTREQ_IRQ22MON_MFSINT1 \
    *( ( volatile unsigned int * ) ( 0x42620D84UL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT0 \
    *( ( volatile unsigned int * ) ( 0x42620E00UL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT1 \
    *( ( volatile unsigned int * ) ( 0x42620E04UL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT2 \
    *( ( volatile unsigned int * ) ( 0x42620E08UL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT3 \
    *( ( volatile unsigned int * ) ( 0x42620E0CUL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT4 \
    *( ( volatile unsigned int * ) ( 0x42620E10UL ) )
#define bFM3_INTREQ_IRQ23MON_PPGINT5 \
    *( ( volatile unsigned int * ) ( 0x42620E14UL ) )
#define bFM3_INTREQ_IRQ24MON_MOSCINT \
    *( ( volatile unsigned int * ) ( 0x42620E80UL ) )
#define bFM3_INTREQ_IRQ24MON_SOSCINT \
    *( ( volatile unsigned int * ) ( 0x42620E84UL ) )
#define bFM3_INTREQ_IRQ24MON_MPLLINT \
    *( ( volatile unsigned int * ) ( 0x42620E88UL ) )
#define bFM3_INTREQ_IRQ24MON_UPLLINT \
    *( ( volatile unsigned int * ) ( 0x42620E8CUL ) )
#define bFM3_INTREQ_IRQ24MON_WCINT \
    *( ( volatile unsigned int * ) ( 0x42620E90UL ) )
#define bFM3_INTREQ_IRQ25MON_ADCINT0 \
    *( ( volatile unsigned int * ) ( 0x42620F00UL ) )
#define bFM3_INTREQ_IRQ25MON_ADCINT1 \
    *( ( volatile unsigned int * ) ( 0x42620F04UL ) )
#define bFM3_INTREQ_IRQ25MON_ADCINT2 \
    *( ( volatile unsigned int * ) ( 0x42620F08UL ) )
#define bFM3_INTREQ_IRQ25MON_ADCINT3 \
    *( ( volatile unsigned int * ) ( 0x42620F0CUL ) )
#define bFM3_INTREQ_IRQ26MON_ADCINT0 \
    *( ( volatile unsigned int * ) ( 0x42620F80UL ) )
#define bFM3_INTREQ_IRQ26MON_ADCINT1 \
    *( ( volatile unsigned int * ) ( 0x42620F84UL ) )
#define bFM3_INTREQ_IRQ26MON_ADCINT2 \
    *( ( volatile unsigned int * ) ( 0x42620F88UL ) )
#define bFM3_INTREQ_IRQ26MON_ADCINT3 \
    *( ( volatile unsigned int * ) ( 0x42620F8CUL ) )
#define bFM3_INTREQ_IRQ27MON_ADCINT0 \
    *( ( volatile unsigned int * ) ( 0x42621000UL ) )
#define bFM3_INTREQ_IRQ27MON_ADCINT1 \
    *( ( volatile unsigned int * ) ( 0x42621004UL ) )
#define bFM3_INTREQ_IRQ27MON_ADCINT2 \
    *( ( volatile unsigned int * ) ( 0x42621008UL ) )
#define bFM3_INTREQ_IRQ27MON_ADCINT3 \
    *( ( volatile unsigned int * ) ( 0x4262100CUL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT0 \
    *( ( volatile unsigned int * ) ( 0x42621080UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT1 \
    *( ( volatile unsigned int * ) ( 0x42621084UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT2 \
    *( ( volatile unsigned int * ) ( 0x42621088UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262108CUL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT4 \
    *( ( volatile unsigned int * ) ( 0x42621090UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT0INT5 \
    *( ( volatile unsigned int * ) ( 0x42621094UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT0 \
    *( ( volatile unsigned int * ) ( 0x42621098UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT1 \
    *( ( volatile unsigned int * ) ( 0x4262109CUL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT2 \
    *( ( volatile unsigned int * ) ( 0x426210A0UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT3 \
    *( ( volatile unsigned int * ) ( 0x426210A4UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT4 \
    *( ( volatile unsigned int * ) ( 0x426210A8UL ) )
#define bFM3_INTREQ_IRQ28MON_FRT1INT5 \
    *( ( volatile unsigned int * ) ( 0x426210ACUL ) )
#define bFM3_INTREQ_IRQ29MON_ICU0INT0 \
    *( ( volatile unsigned int * ) ( 0x42621100UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU0INT1 \
    *( ( volatile unsigned int * ) ( 0x42621104UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU0INT2 \
    *( ( volatile unsigned int * ) ( 0x42621108UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262110CUL ) )
#define bFM3_INTREQ_IRQ29MON_ICU1INT0 \
    *( ( volatile unsigned int * ) ( 0x42621110UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU1INT1 \
    *( ( volatile unsigned int * ) ( 0x42621114UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU1INT2 \
    *( ( volatile unsigned int * ) ( 0x42621118UL ) )
#define bFM3_INTREQ_IRQ29MON_ICU1INT3 \
    *( ( volatile unsigned int * ) ( 0x4262111CUL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT0 \
    *( ( volatile unsigned int * ) ( 0x42621180UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT1 \
    *( ( volatile unsigned int * ) ( 0x42621184UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT2 \
    *( ( volatile unsigned int * ) ( 0x42621188UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262118CUL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT4 \
    *( ( volatile unsigned int * ) ( 0x42621190UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU0INT5 \
    *( ( volatile unsigned int * ) ( 0x42621194UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT0 \
    *( ( volatile unsigned int * ) ( 0x42621198UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT1 \
    *( ( volatile unsigned int * ) ( 0x4262119CUL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT2 \
    *( ( volatile unsigned int * ) ( 0x426211A0UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT3 \
    *( ( volatile unsigned int * ) ( 0x426211A4UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT4 \
    *( ( volatile unsigned int * ) ( 0x426211A8UL ) )
#define bFM3_INTREQ_IRQ30MON_OCU1INT5 \
    *( ( volatile unsigned int * ) ( 0x426211ACUL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT0 \
    *( ( volatile unsigned int * ) ( 0x42621200UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT1 \
    *( ( volatile unsigned int * ) ( 0x42621204UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT2 \
    *( ( volatile unsigned int * ) ( 0x42621208UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT3 \
    *( ( volatile unsigned int * ) ( 0x4262120CUL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT4 \
    *( ( volatile unsigned int * ) ( 0x42621210UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT5 \
    *( ( volatile unsigned int * ) ( 0x42621214UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT6 \
    *( ( volatile unsigned int * ) ( 0x42621218UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT7 \
    *( ( volatile unsigned int * ) ( 0x4262121CUL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT8 \
    *( ( volatile unsigned int * ) ( 0x42621220UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT9 \
    *( ( volatile unsigned int * ) ( 0x42621224UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT10 \
    *( ( volatile unsigned int * ) ( 0x42621228UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT11 \
    *( ( volatile unsigned int * ) ( 0x4262122CUL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT12 \
    *( ( volatile unsigned int * ) ( 0x42621230UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT13 \
    *( ( volatile unsigned int * ) ( 0x42621234UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT14 \
    *( ( volatile unsigned int * ) ( 0x42621238UL ) )
#define bFM3_INTREQ_IRQ31MON_BTINT15 \
    *( ( volatile unsigned int * ) ( 0x4262123CUL ) )
#define bFM3_INTREQ_IRQ32MON_CANINT \
    *( ( volatile unsigned int * ) ( 0x42621280UL ) )
#define bFM3_INTREQ_IRQ33MON_CANINT \
    *( ( volatile unsigned int * ) ( 0x42621300UL ) )
#define bFM3_INTREQ_IRQ34MON_USB0INT0 \
    *( ( volatile unsigned int * ) ( 0x42621380UL ) )
#define bFM3_INTREQ_IRQ34MON_USB0INT1 \
    *( ( volatile unsigned int * ) ( 0x42621384UL ) )
#define bFM3_INTREQ_IRQ34MON_USB0INT2 \
    *( ( volatile unsigned int * ) ( 0x42621388UL ) )
#define bFM3_INTREQ_IRQ34MON_USB0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262138CUL ) )
#define bFM3_INTREQ_IRQ34MON_USB0INT4 \
    *( ( volatile unsigned int * ) ( 0x42621390UL ) )
#define bFM3_INTREQ_IRQ35MON_USB0INT0 \
    *( ( volatile unsigned int * ) ( 0x42621400UL ) )
#define bFM3_INTREQ_IRQ35MON_USB0INT1 \
    *( ( volatile unsigned int * ) ( 0x42621404UL ) )
#define bFM3_INTREQ_IRQ35MON_USB0INT2 \
    *( ( volatile unsigned int * ) ( 0x42621408UL ) )
#define bFM3_INTREQ_IRQ35MON_USB0INT3 \
    *( ( volatile unsigned int * ) ( 0x4262140CUL ) )
#define bFM3_INTREQ_IRQ35MON_USB0INT4 \
    *( ( volatile unsigned int * ) ( 0x42621410UL ) )
#define bFM3_INTREQ_IRQ38MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621580UL ) )
#define bFM3_INTREQ_IRQ39MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621600UL ) )
#define bFM3_INTREQ_IRQ40MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621680UL ) )
#define bFM3_INTREQ_IRQ41MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621700UL ) )
#define bFM3_INTREQ_IRQ42MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621780UL ) )
#define bFM3_INTREQ_IRQ43MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621800UL ) )
#define bFM3_INTREQ_IRQ44MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621880UL ) )
#define bFM3_INTREQ_IRQ45MON_DMAINT \
    *( ( volatile unsigned int * ) ( 0x42621900UL ) )
...
#define bFM3_GPIO_EPFR00_CROUTE \
    *( ( volatile unsigned int * ) ( 0x4266C004UL ) )
#define bFM3_GPIO_EPFR00_USB0PE \
    *( ( volatile unsigned int * ) ( 0x4266C024UL ) )
#define bFM3_GPIO_EPFR00_JTAGEN0B \
    *( ( volatile unsigned int * ) ( 0x4266C040UL ) )
#define bFM3_GPIO_EPFR00_JTAGEN1S \
    *( ( volatile unsigned int * ) ( 0x4266C044UL ) )
...
#define bFM3_GPIO_EPFR01_RTO00E0 \
    *( ( volatile unsigned int * ) ( 0x4266C080UL ) )
#define bFM3_GPIO_EPFR01_RTO00E1 \
    *( ( volatile unsigned int * ) ( 0x4266C084UL ) )
#define bFM3_GPIO_EPFR01_RTO01E0 \
    *( ( volatile unsigned int * ) ( 0x4266C088UL ) )
#define bFM3_GPIO_EPFR01_RTO01E1 \
    *( ( volatile unsigned int * ) ( 0x4266C08CUL ) )
#define bFM3_GPIO_EPFR01_RTO02E0 \
    *( ( volatile unsigned int * ) ( 0x4266C090UL ) )
#define bFM3_GPIO_EPFR01_RTO02E1 \
    *( ( volatile unsigned int * ) ( 0x4266C094UL ) )
#define bFM3_GPIO_EPFR01_RTO03E0 \
    *( ( volatile unsigned int * ) ( 0x4266C098UL ) )
#define bFM3_GPIO_EPFR01_RTO03E1 \
    *( ( volatile unsigned int * ) ( 0x4266C09CUL ) )
#define bFM3_GPIO_EPFR01_RTO04E0 \
    *( ( volatile unsigned int * ) ( 0x4266C0A0UL ) )
#define bFM3_GPIO_EPFR01_RTO04E1 \
    *( ( volatile unsigned int * ) ( 0x4266C0A4UL ) )
#define bFM3_GPIO_EPFR01_RTO05E0 \
    *( ( volatile unsigned int * ) ( 0x4266C0A8UL ) )
#define bFM3_GPIO_EPFR01_RTO05E1 \
    *( ( volatile unsigned int * ) ( 0x4266C0ACUL ) )
#define bFM3_GPIO_EPFR01_DTTI0C \
    *( ( volatile unsigned int * ) ( 0x4266C0B0UL ) )
#define bFM3_GPIO_EPFR01_DTTI0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0C0UL ) )
#define bFM3_GPIO_EPFR01_DTTI0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0C4UL ) )
#define bFM3_GPIO_EPFR01_FRCK0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0C8UL ) )
#define bFM3_GPIO_EPFR01_FRCK0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0CCUL ) )
#define bFM3_GPIO_EPFR01_IC00S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0D0UL ) )
#define bFM3_GPIO_EPFR01_IC00S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0D4UL ) )
#define bFM3_GPIO_EPFR01_IC00S2 \
    *( ( volatile unsigned int * ) ( 0x4266C0D8UL ) )
#define bFM3_GPIO_EPFR01_IC01S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0DCUL ) )
#define bFM3_GPIO_EPFR01_IC01S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0E0UL ) )
#define bFM3_GPIO_EPFR01_IC01S2 \
    *( ( volatile unsigned int * ) ( 0x4266C0E4UL ) )
#define bFM3_GPIO_EPFR01_IC02S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0E8UL ) )
#define bFM3_GPIO_EPFR01_IC02S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0ECUL ) )
#define bFM3_GPIO_EPFR01_IC02S2 \
    *( ( volatile unsigned int * ) ( 0x4266C0F0UL ) )
#define bFM3_GPIO_EPFR01_IC03S0 \
    *( ( volatile unsigned int * ) ( 0x4266C0F4UL ) )
#define bFM3_GPIO_EPFR01_IC03S1 \
    *( ( volatile unsigned int * ) ( 0x4266C0F8UL ) )
#define bFM3_GPIO_EPFR01_IC03S2 \
    *( ( volatile unsigned int * ) ( 0x4266C0FCUL ) )
#define bFM3_GPIO_EPFR02_RTO10E0 \
    *( ( volatile unsigned int * ) ( 0x4266C100UL ) )
#define bFM3_GPIO_EPFR02_RTO10E1 \
    *( ( volatile unsigned int * ) ( 0x4266C104UL ) )
#define bFM3_GPIO_EPFR02_RTO11E0 \
    *( ( volatile unsigned int * ) ( 0x4266C108UL ) )
#define bFM3_GPIO_EPFR02_RTO11E1 \
    *( ( volatile unsigned int * ) ( 0x4266C10CUL ) )
#define bFM3_GPIO_EPFR02_RTO12E0 \
    *( ( volatile unsigned int * ) ( 0x4266C110UL ) )
#define bFM3_GPIO_EPFR02_RTO12E1 \
    *( ( volatile unsigned int * ) ( 0x4266C114UL ) )
#define bFM3_GPIO_EPFR02_RTO13E0 \
    *( ( volatile unsigned int * ) ( 0x4266C118UL ) )
#define bFM3_GPIO_EPFR02_RTO13E1 \
    *( ( volatile unsigned int * ) ( 0x4266C11CUL ) )
#define bFM3_GPIO_EPFR02_RTO14E0 \
    *( ( volatile unsigned int * ) ( 0x4266C120UL ) )
#define bFM3_GPIO_EPFR02_RTO14E1 \
    *( ( volatile unsigned int * ) ( 0x4266C124UL ) )
#define bFM3_GPIO_EPFR02_RTO15E0 \
    *( ( volatile unsigned int * ) ( 0x4266C128UL ) )
#define bFM3_GPIO_EPFR02_RTO15E1 \
    *( ( volatile unsigned int * ) ( 0x4266C12CUL ) )
#define bFM3_GPIO_EPFR02_DTTI1C \
    *( ( volatile unsigned int * ) ( 0x4266C130UL ) )
#define bFM3_GPIO_EPFR02_DTTI1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C140UL ) )
#define bFM3_GPIO_EPFR02_DTTI1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C144UL ) )
#define bFM3_GPIO_EPFR02_FRCK1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C148UL ) )
#define bFM3_GPIO_EPFR02_FRCK1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C14CUL ) )
#define bFM3_GPIO_EPFR02_IC10S0 \
    *( ( volatile unsigned int * ) ( 0x4266C150UL ) )
#define bFM3_GPIO_EPFR02_IC10S1 \
    *( ( volatile unsigned int * ) ( 0x4266C154UL ) )
#define bFM3_GPIO_EPFR02_IC10S2 \
    *( ( volatile unsigned int * ) ( 0x4266C158UL ) )
#define bFM3_GPIO_EPFR02_IC11S0 \
    *( ( volatile unsigned int * ) ( 0x4266C15CUL ) )
#define bFM3_GPIO_EPFR02_IC11S1 \
    *( ( volatile unsigned int * ) ( 0x4266C160UL ) )
#define bFM3_GPIO_EPFR02_IC11S2 \
    *( ( volatile unsigned int * ) ( 0x4266C164UL ) )
#define bFM3_GPIO_EPFR02_IC12S0 \
    *( ( volatile unsigned int * ) ( 0x4266C168UL ) )
#define bFM3_GPIO_EPFR02_IC12S1 \
    *( ( volatile unsigned int * ) ( 0x4266C16CUL ) )
#define bFM3_GPIO_EPFR02_IC12S2 \
    *( ( volatile unsigned int * ) ( 0x4266C170UL ) )
#define bFM3_GPIO_EPFR02_IC13S0 \
    *( ( volatile unsigned int * ) ( 0x4266C174UL ) )
#define bFM3_GPIO_EPFR02_IC13S1 \
    *( ( volatile unsigned int * ) ( 0x4266C178UL ) )
#define bFM3_GPIO_EPFR02_IC13S2 \
    *( ( volatile unsigned int * ) ( 0x4266C17CUL ) )
#define bFM3_GPIO_EPFR04_TIOA0E0 \
    *( ( volatile unsigned int * ) ( 0x4266C208UL ) )
#define bFM3_GPIO_EPFR04_TIOA0E1 \
    *( ( volatile unsigned int * ) ( 0x4266C20CUL ) )
#define bFM3_GPIO_EPFR04_TIOB0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C210UL ) )
#define bFM3_GPIO_EPFR04_TIOB0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C214UL ) )
#define bFM3_GPIO_EPFR04_TIOA1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C220UL ) )
#define bFM3_GPIO_EPFR04_TIOA1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C224UL ) )
#define bFM3_GPIO_EPFR04_TIOA1E0 \
    *( ( volatile unsigned int * ) ( 0x4266C228UL ) )
#define bFM3_GPIO_EPFR04_TIOA1E1 \
    *( ( volatile unsigned int * ) ( 0x4266C22CUL ) )
#define bFM3_GPIO_EPFR04_TIOB1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C230UL ) )
#define bFM3_GPIO_EPFR04_TIOB1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C234UL ) )
#define bFM3_GPIO_EPFR04_TIOA2E0 \
    *( ( volatile unsigned int * ) ( 0x4266C248UL ) )
#define bFM3_GPIO_EPFR04_TIOA2E1 \
    *( ( volatile unsigned int * ) ( 0x4266C24CUL ) )
#define bFM3_GPIO_EPFR04_TIOB2S0 \
    *( ( volatile unsigned int * ) ( 0x4266C250UL ) )
#define bFM3_GPIO_EPFR04_TIOB2S1 \
    *( ( volatile unsigned int * ) ( 0x4266C254UL ) )
#define bFM3_GPIO_EPFR04_TIOA3S0 \
    *( ( volatile unsigned int * ) ( 0x4266C260UL ) )
#define bFM3_GPIO_EPFR04_TIOA3S1 \
    *( ( volatile unsigned int * ) ( 0x4266C264UL ) )
#define bFM3_GPIO_EPFR04_TIOA3E0 \
    *( ( volatile unsigned int * ) ( 0x4266C268UL ) )
#define bFM3_GPIO_EPFR04_TIOA3E1 \
    *( ( volatile unsigned int * ) ( 0x4266C26CUL ) )
#define bFM3_GPIO_EPFR04_TIOB3S0 \
    *( ( volatile unsigned int * ) ( 0x4266C270UL ) )
#define bFM3_GPIO_EPFR04_TIOB3S1 \
    *( ( volatile unsigned int * ) ( 0x4266C274UL ) )
#define bFM3_GPIO_EPFR05_TIOA4E0 \
    *( ( volatile unsigned int * ) ( 0x4266C288UL ) )
#define bFM3_GPIO_EPFR05_TIOA4E1 \
    *( ( volatile unsigned int * ) ( 0x4266C28CUL ) )
#define bFM3_GPIO_EPFR05_TIOB4S0 \
    *( ( volatile unsigned int * ) ( 0x4266C290UL ) )
#define bFM3_GPIO_EPFR05_TIOB4S1 \
    *( ( volatile unsigned int * ) ( 0x4266C294UL ) )
#define bFM3_GPIO_EPFR05_TIOA5S0 \
    *( ( volatile unsigned int * ) ( 0x4266C2A0UL ) )
#define bFM3_GPIO_EPFR05_TIOA5S1 \
    *( ( volatile unsigned int * ) ( 0x4266C2A4UL ) )
#define bFM3_GPIO_EPFR05_TIOA5E0 \
    *( ( volatile unsigned int * ) ( 0x4266C2A8UL ) )
#define bFM3_GPIO_EPFR05_TIOA5E1 \
    *( ( volatile unsigned int * ) ( 0x4266C2ACUL ) )
#define bFM3_GPIO_EPFR05_TIOB5S0 \
    *( ( volatile unsigned int * ) ( 0x4266C2B0UL ) )
#define bFM3_GPIO_EPFR05_TIOB5S1 \
    *( ( volatile unsigned int * ) ( 0x4266C2B4UL ) )
#define bFM3_GPIO_EPFR05_TIOA6E0 \
    *( ( volatile unsigned int * ) ( 0x4266C2C8UL ) )
#define bFM3_GPIO_EPFR05_TIOA6E1 \
    *( ( volatile unsigned int * ) ( 0x4266C2CCUL ) )
#define bFM3_GPIO_EPFR05_TIOB6S0 \
    *( ( volatile unsigned int * ) ( 0x4266C2D0UL ) )
#define bFM3_GPIO_EPFR05_TIOB6S1 \
    *( ( volatile unsigned int * ) ( 0x4266C2D4UL ) )
#define bFM3_GPIO_EPFR05_TIOA7S0 \
    *( ( volatile unsigned int * ) ( 0x4266C2E0UL ) )
#define bFM3_GPIO_EPFR05_TIOA7S1 \
    *( ( volatile unsigned int * ) ( 0x4266C2E4UL ) )
#define bFM3_GPIO_EPFR05_TIOA7E0 \
    *( ( volatile unsigned int * ) ( 0x4266C2E8UL ) )
#define bFM3_GPIO_EPFR05_TIOA7E1 \
    *( ( volatile unsigned int * ) ( 0x4266C2ECUL ) )
#define bFM3_GPIO_EPFR05_TIOB7S0 \
    *( ( volatile unsigned int * ) ( 0x4266C2F0UL ) )
#define bFM3_GPIO_EPFR05_TIOB7S1 \
    *( ( volatile unsigned int * ) ( 0x4266C2F4UL ) )
#define bFM3_GPIO_EPFR06_EINT00S0 \
    *( ( volatile unsigned int * ) ( 0x4266C300UL ) )
#define bFM3_GPIO_EPFR06_EINT00S1 \
    *( ( volatile unsigned int * ) ( 0x4266C304UL ) )
#define bFM3_GPIO_EPFR06_EINT01S0 \
    *( ( volatile unsigned int * ) ( 0x4266C308UL ) )
#define bFM3_GPIO_EPFR06_EINT01S1 \
    *( ( volatile unsigned int * ) ( 0x4266C30CUL ) )
#define bFM3_GPIO_EPFR06_EINT02S0 \
    *( ( volatile unsigned int * ) ( 0x4266C310UL ) )
#define bFM3_GPIO_EPFR06_EINT02S1 \
    *( ( volatile unsigned int * ) ( 0x4266C314UL ) )
#define bFM3_GPIO_EPFR06_EINT03S0 \
    *( ( volatile unsigned int * ) ( 0x4266C318UL ) )
#define bFM3_GPIO_EPFR06_EINT03S1 \
    *( ( volatile unsigned int * ) ( 0x4266C31CUL ) )
#define bFM3_GPIO_EPFR06_EINT04S0 \
    *( ( volatile unsigned int * ) ( 0x4266C320UL ) )
#define bFM3_GPIO_EPFR06_EINT04S1 \
    *( ( volatile unsigned int * ) ( 0x4266C324UL ) )
#define bFM3_GPIO_EPFR06_EINT05S0 \
    *( ( volatile unsigned int * ) ( 0x4266C328UL ) )
#define bFM3_GPIO_EPFR06_EINT05S1 \
    *( ( volatile unsigned int * ) ( 0x4266C32CUL ) )
#define bFM3_GPIO_EPFR06_EINT06S0 \
    *( ( volatile unsigned int * ) ( 0x4266C330UL ) )
#define bFM3_GPIO_EPFR06_EINT06S1 \
    *( ( volatile unsigned int * ) ( 0x4266C334UL ) )
#define bFM3_GPIO_EPFR06_EINT07S0 \
    *( ( volatile unsigned int * ) ( 0x4266C338UL ) )
#define bFM3_GPIO_EPFR06_EINT07S1 \
    *( ( volatile unsigned int * ) ( 0x4266C33CUL ) )
#define bFM3_GPIO_EPFR06_EINT08S0 \
    *( ( volatile unsigned int * ) ( 0x4266C340UL ) )
#define bFM3_GPIO_EPFR06_EINT08S1 \
    *( ( volatile unsigned int * ) ( 0x4266C344UL ) )
#define bFM3_GPIO_EPFR06_EINT09S0 \
    *( ( volatile unsigned int * ) ( 0x4266C348UL ) )
#define bFM3_GPIO_EPFR06_EINT09S1 \
    *( ( volatile unsigned int * ) ( 0x4266C34CUL ) )
#define bFM3_GPIO_EPFR06_EINT10S0 \
    *( ( volatile unsigned int * ) ( 0x4266C350UL ) )
#define bFM3_GPIO_EPFR06_EINT10S1 \
    *( ( volatile unsigned int * ) ( 0x4266C354UL ) )
#define bFM3_GPIO_EPFR06_EINT11S0 \
    *( ( volatile unsigned int * ) ( 0x4266C358UL ) )
#define bFM3_GPIO_EPFR06_EINT11S1 \
    *( ( volatile unsigned int * ) ( 0x4266C35CUL ) )
#define bFM3_GPIO_EPFR06_EINT12S0 \
    *( ( volatile unsigned int * ) ( 0x4266C360UL ) )
#define bFM3_GPIO_EPFR06_EINT12S1 \
    *( ( volatile unsigned int * ) ( 0x4266C364UL ) )
#define bFM3_GPIO_EPFR06_EINT13S0 \
    *( ( volatile unsigned int * ) ( 0x4266C368UL ) )
#define bFM3_GPIO_EPFR06_EINT13S1 \
    *( ( volatile unsigned int * ) ( 0x4266C36CUL ) )
#define bFM3_GPIO_EPFR06_EINT14S0 \
    *( ( volatile unsigned int * ) ( 0x4266C370UL ) )
#define bFM3_GPIO_EPFR06_EINT14S1 \
    *( ( volatile unsigned int * ) ( 0x4266C374UL ) )
#define bFM3_GPIO_EPFR06_EINT15S0 \
    *( ( volatile unsigned int * ) ( 0x4266C378UL ) )
#define bFM3_GPIO_EPFR06_EINT15S1 \
    *( ( volatile unsigned int * ) ( 0x4266C37CUL ) )
#define bFM3_GPIO_EPFR07_SIN0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C390UL ) )
#define bFM3_GPIO_EPFR07_SIN0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C394UL ) )
#define bFM3_GPIO_EPFR07_SOT0B0 \
    *( ( volatile unsigned int * ) ( 0x4266C398UL ) )
#define bFM3_GPIO_EPFR07_SOT0B1 \
    *( ( volatile unsigned int * ) ( 0x4266C39CUL ) )
#define bFM3_GPIO_EPFR07_SCK0B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3A0UL ) )
#define bFM3_GPIO_EPFR07_SCK0B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3A4UL ) )
#define bFM3_GPIO_EPFR07_SIN1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C3A8UL ) )
#define bFM3_GPIO_EPFR07_SIN1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C3ACUL ) )
#define bFM3_GPIO_EPFR07_SOT1B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3B0UL ) )
#define bFM3_GPIO_EPFR07_SOT1B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3B4UL ) )
#define bFM3_GPIO_EPFR07_SCK1B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3B8UL ) )
#define bFM3_GPIO_EPFR07_SCK1B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3BCUL ) )
#define bFM3_GPIO_EPFR07_SIN2S0 \
    *( ( volatile unsigned int * ) ( 0x4266C3C0UL ) )
#define bFM3_GPIO_EPFR07_SIN2S1 \
    *( ( volatile unsigned int * ) ( 0x4266C3C4UL ) )
#define bFM3_GPIO_EPFR07_SOT2B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3C8UL ) )
#define bFM3_GPIO_EPFR07_SOT2B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3CCUL ) )
#define bFM3_GPIO_EPFR07_SCK2B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3D0UL ) )
#define bFM3_GPIO_EPFR07_SCK2B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3D4UL ) )
#define bFM3_GPIO_EPFR07_SIN3S0 \
    *( ( volatile unsigned int * ) ( 0x4266C3D8UL ) )
#define bFM3_GPIO_EPFR07_SIN3S1 \
    *( ( volatile unsigned int * ) ( 0x4266C3DCUL ) )
#define bFM3_GPIO_EPFR07_SOT3B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3E0UL ) )
#define bFM3_GPIO_EPFR07_SOT3B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3E4UL ) )
#define bFM3_GPIO_EPFR07_SCK3B0 \
    *( ( volatile unsigned int * ) ( 0x4266C3E8UL ) )
#define bFM3_GPIO_EPFR07_SCK3B1 \
    *( ( volatile unsigned int * ) ( 0x4266C3ECUL ) )
#define bFM3_GPIO_EPFR08_RTS4E0 \
    *( ( volatile unsigned int * ) ( 0x4266C400UL ) )
#define bFM3_GPIO_EPFR08_RTS4E1 \
    *( ( volatile unsigned int * ) ( 0x4266C404UL ) )
#define bFM3_GPIO_EPFR08_CTS4S0 \
    *( ( volatile unsigned int * ) ( 0x4266C408UL ) )
#define bFM3_GPIO_EPFR08_CTS4S1 \
    *( ( volatile unsigned int * ) ( 0x4266C40CUL ) )
#define bFM3_GPIO_EPFR08_SIN4S0 \
    *( ( volatile unsigned int * ) ( 0x4266C410UL ) )
#define bFM3_GPIO_EPFR08_SIN4S1 \
    *( ( volatile unsigned int * ) ( 0x4266C414UL ) )
#define bFM3_GPIO_EPFR08_SOT4B0 \
    *( ( volatile unsigned int * ) ( 0x4266C418UL ) )
#define bFM3_GPIO_EPFR08_SOT4B1 \
    *( ( volatile unsigned int * ) ( 0x4266C41CUL ) )
#define bFM3_GPIO_EPFR08_SCK4B0 \
    *( ( volatile unsigned int * ) ( 0x4266C420UL ) )
#define bFM3_GPIO_EPFR08_SCK4B1 \
    *( ( volatile unsigned int * ) ( 0x4266C424UL ) )
#define bFM3_GPIO_EPFR08_SIN5S0 \
    *( ( volatile unsigned int * ) ( 0x4266C428UL ) )
#define bFM3_GPIO_EPFR08_SIN5S1 \
    *( ( volatile unsigned int * ) ( 0x4266C42CUL ) )
#define bFM3_GPIO_EPFR08_SOT5B0 \
    *( ( volatile unsigned int * ) ( 0x4266C430UL ) )
#define bFM3_GPIO_EPFR08_SOT5B1 \
    *( ( volatile unsigned int * ) ( 0x4266C434UL ) )
#define bFM3_GPIO_EPFR08_SCK5B0 \
    *( ( volatile unsigned int * ) ( 0x4266C438UL ) )
#define bFM3_GPIO_EPFR08_SCK5B1 \
    *( ( volatile unsigned int * ) ( 0x4266C43CUL ) )
#define bFM3_GPIO_EPFR08_SIN6S0 \
    *( ( volatile unsigned int * ) ( 0x4266C440UL ) )
#define bFM3_GPIO_EPFR08_SIN6S1 \
    *( ( volatile unsigned int * ) ( 0x4266C444UL ) )
#define bFM3_GPIO_EPFR08_SOT6B0 \
    *( ( volatile unsigned int * ) ( 0x4266C448UL ) )
#define bFM3_GPIO_EPFR08_SOT6B1 \
    *( ( volatile unsigned int * ) ( 0x4266C44CUL ) )
#define bFM3_GPIO_EPFR08_SCK6B0 \
    *( ( volatile unsigned int * ) ( 0x4266C450UL ) )
#define bFM3_GPIO_EPFR08_SCK6B1 \
    *( ( volatile unsigned int * ) ( 0x4266C454UL ) )
#define bFM3_GPIO_EPFR08_SIN7S0 \
    *( ( volatile unsigned int * ) ( 0x4266C458UL ) )
#define bFM3_GPIO_EPFR08_SIN7S1 \
    *( ( volatile unsigned int * ) ( 0x4266C45CUL ) )
#define bFM3_GPIO_EPFR08_SOT7B0 \
    *( ( volatile unsigned int * ) ( 0x4266C460UL ) )
#define bFM3_GPIO_EPFR08_SOT7B1 \
    *( ( volatile unsigned int * ) ( 0x4266C464UL ) )
#define bFM3_GPIO_EPFR08_SCK7B0 \
    *( ( volatile unsigned int * ) ( 0x4266C468UL ) )
#define bFM3_GPIO_EPFR08_SCK7B1 \
    *( ( volatile unsigned int * ) ( 0x4266C46CUL ) )
#define bFM3_GPIO_EPFR09_QAIN0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C480UL ) )
#define bFM3_GPIO_EPFR09_QAIN0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C484UL ) )
#define bFM3_GPIO_EPFR09_QBIN0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C488UL ) )
#define bFM3_GPIO_EPFR09_QBIN0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C48CUL ) )
#define bFM3_GPIO_EPFR09_QZIN0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C490UL ) )
#define bFM3_GPIO_EPFR09_QZIN0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C494UL ) )
#define bFM3_GPIO_EPFR09_QAIN1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C498UL ) )
#define bFM3_GPIO_EPFR09_QAIN1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C49CUL ) )
#define bFM3_GPIO_EPFR09_QBIN1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4A0UL ) )
#define bFM3_GPIO_EPFR09_QBIN1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4A4UL ) )
#define bFM3_GPIO_EPFR09_QZIN1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4A8UL ) )
#define bFM3_GPIO_EPFR09_QZIN1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4ACUL ) )
#define bFM3_GPIO_EPFR09_ADTRG0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4B0UL ) )
#define bFM3_GPIO_EPFR09_ADTRG0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4B4UL ) )
#define bFM3_GPIO_EPFR09_ADTRG0S2 \
    *( ( volatile unsigned int * ) ( 0x4266C4B8UL ) )
#define bFM3_GPIO_EPFR09_ADTRG0S3 \
    *( ( volatile unsigned int * ) ( 0x4266C4BCUL ) )
#define bFM3_GPIO_EPFR09_ADTRG1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4C0UL ) )
#define bFM3_GPIO_EPFR09_ADTRG1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4C4UL ) )
#define bFM3_GPIO_EPFR09_ADTRG1S2 \
    *( ( volatile unsigned int * ) ( 0x4266C4C8UL ) )
#define bFM3_GPIO_EPFR09_ADTRG1S3 \
    *( ( volatile unsigned int * ) ( 0x4266C4CCUL ) )
#define bFM3_GPIO_EPFR09_ADTRG2S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4D0UL ) )
#define bFM3_GPIO_EPFR09_ADTRG2S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4D4UL ) )
#define bFM3_GPIO_EPFR09_ADTRG2S2 \
    *( ( volatile unsigned int * ) ( 0x4266C4D8UL ) )
#define bFM3_GPIO_EPFR09_ADTRG2S3 \
    *( ( volatile unsigned int * ) ( 0x4266C4DCUL ) )
#define bFM3_GPIO_EPFR09_CRX0S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4E0UL ) )
#define bFM3_GPIO_EPFR09_CRX0S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4E4UL ) )
#define bFM3_GPIO_EPFR09_CTX0E0 \
    *( ( volatile unsigned int * ) ( 0x4266C4E8UL ) )
#define bFM3_GPIO_EPFR09_CTX0E1 \
    *( ( volatile unsigned int * ) ( 0x4266C4ECUL ) )
#define bFM3_GPIO_EPFR09_CRX1S0 \
    *( ( volatile unsigned int * ) ( 0x4266C4F0UL ) )
#define bFM3_GPIO_EPFR09_CRX1S1 \
    *( ( volatile unsigned int * ) ( 0x4266C4F4UL ) )
#define bFM3_GPIO_EPFR09_CTX1E0 \
    *( ( volatile unsigned int * ) ( 0x4266C4F8UL ) )
#define bFM3_GPIO_EPFR09_CTX1E1 \
    *( ( volatile unsigned int * ) ( 0x4266C4FCUL ) )
#define bFM3_GPIO_EPFR10_UEDEFB \
    *( ( volatile unsigned int * ) ( 0x4266C500UL ) )
#define bFM3_GPIO_EPFR10_UEDTHB \
    *( ( volatile unsigned int * ) ( 0x4266C504UL ) )
#define bFM3_GPIO_EPFR10_TESTB *( ( volatile unsigned int * ) ( 0x4266C508UL ) )
#define bFM3_GPIO_EPFR10_UEWEXE \
    *( ( volatile unsigned int * ) ( 0x4266C50CUL ) )
#define bFM3_GPIO_EPFR10_UEDQME \
    *( ( volatile unsigned int * ) ( 0x4266C510UL ) )
#define bFM3_GPIO_EPFR10_UEOEXE \
    *( ( volatile unsigned int * ) ( 0x4266C514UL ) )
#define bFM3_GPIO_EPFR10_UEFLSE \
    *( ( volatile unsigned int * ) ( 0x4266C518UL ) )
#define bFM3_GPIO_EPFR10_UECS1E \
    *( ( volatile unsigned int * ) ( 0x4266C51CUL ) )
#define bFM3_GPIO_EPFR10_UECS2E \
    *( ( volatile unsigned int * ) ( 0x4266C520UL ) )
#define bFM3_GPIO_EPFR10_UECS3E \
    *( ( volatile unsigned int * ) ( 0x4266C524UL ) )
#define bFM3_GPIO_EPFR10_UECS4E \
    *( ( volatile unsigned int * ) ( 0x4266C528UL ) )
#define bFM3_GPIO_EPFR10_UECS5E \
    *( ( volatile unsigned int * ) ( 0x4266C52CUL ) )
#define bFM3_GPIO_EPFR10_UECS6E \
    *( ( volatile unsigned int * ) ( 0x4266C530UL ) )
#define bFM3_GPIO_EPFR10_UECS7E \
    *( ( volatile unsigned int * ) ( 0x4266C534UL ) )
#define bFM3_GPIO_EPFR10_UEAOOE \
    *( ( volatile unsigned int * ) ( 0x4266C538UL ) )
#define bFM3_GPIO_EPFR10_UEA08E \
    *( ( volatile unsigned int * ) ( 0x4266C53CUL ) )
#define bFM3_GPIO_EPFR10_UEA09E \
    *( ( volatile unsigned int * ) ( 0x4266C540UL ) )
#define bFM3_GPIO_EPFR10_UEA10E \
    *( ( volatile unsigned int * ) ( 0x4266C544UL ) )
#define bFM3_GPIO_EPFR10_UEA11E \
    *( ( volatile unsigned int * ) ( 0x4266C548UL ) )
#define bFM3_GPIO_EPFR10_UEA12E \
    *( ( volatile unsigned int * ) ( 0x4266C54CUL ) )
#define bFM3_GPIO_EPFR10_UEA13E \
    *( ( volatile unsigned int * ) ( 0x4266C550UL ) )
#define bFM3_GPIO_EPFR10_UEA14E \
    *( ( volatile unsigned int * ) ( 0x4266C554UL ) )
#define bFM3_GPIO_EPFR10_UEA15E \
    *( ( volatile unsigned int * ) ( 0x4266C558UL ) )
#define bFM3_GPIO_EPFR10_UEA16E \
    *( ( volatile unsigned int * ) ( 0x4266C55CUL ) )
#define bFM3_GPIO_EPFR10_UEA17E \
    *( ( volatile unsigned int * ) ( 0x4266C560UL ) )
#define bFM3_GPIO_EPFR10_UEA18E \
    *( ( volatile unsigned int * ) ( 0x4266C564UL ) )
#define bFM3_GPIO_EPFR10_UEA19E \
    *( ( volatile unsigned int * ) ( 0x4266C568UL ) )
#define bFM3_GPIO_EPFR10_UEA20E \
    *( ( volatile unsigned int * ) ( 0x4266C56CUL ) )
#define bFM3_GPIO_EPFR10_UEA21E \
    *( ( volatile unsigned int * ) ( 0x4266C570UL ) )
#define bFM3_GPIO_EPFR10_UEA22E \
    *( ( volatile unsigned int * ) ( 0x4266C574UL ) )
#define bFM3_GPIO_EPFR10_UEA23E \
    *( ( volatile unsigned int * ) ( 0x4266C578UL ) )
#define bFM3_GPIO_EPFR10_UEA24E \
    *( ( volatile unsigned int * ) ( 0x4266C57CUL ) )
...
#define bFM3_LVD_LVD_STR2_LVDIRDY \
    *( ( volatile unsigned int * ) ( 0x426A021CUL ) )
...
#define bFM3_USBCLK_UPCR1_UPLLEN \
    *( ( volatile unsigned int * ) ( 0x426C0080UL ) )
#define bFM3_USBCLK_UPCR1_UPINC \
    *( ( volatile unsigned int * ) ( 0x426C0084UL ) )
#define bFM3_USBCLK_UPCR2_UPOWT0 \
    *( ( volatile unsigned int * ) ( 0x426C0100UL ) )
#define bFM3_USBCLK_UPCR2_UPOWT1 \
    *( ( volatile unsigned int * ) ( 0x426C0104UL ) )
#define bFM3_USBCLK_UPCR2_UPOWT2 \
    *( ( volatile unsigned int * ) ( 0x426C0108UL ) )
#define bFM3_USBCLK_UPCR3_UPLLK0 \
    *( ( volatile unsigned int * ) ( 0x426C0180UL ) )
#define bFM3_USBCLK_UPCR3_UPLLK1 \
    *( ( volatile unsigned int * ) ( 0x426C0184UL ) )
#define bFM3_USBCLK_UPCR3_UPLLK2 \
    *( ( volatile unsigned int * ) ( 0x426C0188UL ) )
#define bFM3_USBCLK_UPCR3_UPLLK3 \
    *( ( volatile unsigned int * ) ( 0x426C018CUL ) )
#define bFM3_USBCLK_UPCR3_UPLLK4 \
    *( ( volatile unsigned int * ) ( 0x426C0190UL ) )
#define bFM3_USBCLK_UPCR4_UPLLN0 \
    *( ( volatile unsigned int * ) ( 0x426C0200UL ) )
#define bFM3_USBCLK_UPCR4_UPLLN1 \
    *( ( volatile unsigned int * ) ( 0x426C0204UL ) )
#define bFM3_USBCLK_UPCR4_UPLLN2 \
    *( ( volatile unsigned int * ) ( 0x426C0208UL ) )
#define bFM3_USBCLK_UPCR4_UPLLN3 \
    *( ( volatile unsigned int * ) ( 0x426C020CUL ) )
#define bFM3_USBCLK_UPCR4_UPLLN4 \
    *( ( volatile unsigned int * ) ( 0x426C0210UL ) )
#define bFM3_USBCLK_UP_STR_UPRDY \
    *( ( volatile unsigned int * ) ( 0x426C0280UL ) )
#define bFM3_USBCLK_UPINT_ENR_UPCSE \
    *( ( volatile unsigned int * ) ( 0x426C0300UL ) )
#define bFM3_USBCLK_UPINT_CLR_UPCSC \
    *( ( volatile unsigned int * ) ( 0x426C0380UL ) )
#define bFM3_USBCLK_UPINT_STR_UPCSI \
    *( ( volatile unsigned int * ) ( 0x426C0400UL ) )
#define bFM3_USBCLK_USBEN_USBEN \
    *( ( volatile unsigned int * ) ( 0x426C0600UL ) )

/* CAN prescaler register */
#define bFM3_CANPRES_CANPRE_CANPRE0 \
    *( ( volatile unsigned int * ) ( 0x426E0000UL ) )
#define bFM3_CANPRES_CANPRE_CANPRE1 \
    *( ( volatile unsigned int * ) ( 0x426E0004UL ) )
#define bFM3_CANPRES_CANPRE_CANPRE2 \
    *( ( volatile unsigned int * ) ( 0x426E0008UL ) )
#define bFM3_CANPRES_CANPRE_CANPRE3 \
    *( ( volatile unsigned int * ) ( 0x426E000CUL ) )
...
#define bFM3_MFS0_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42700010UL ) )
...
#define bFM3_MFS0_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42700028UL ) )
...
#define bFM3_MFS0_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270003CUL ) )
...
#define bFM3_MFS0_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x42700090UL ) )
#define bFM3_MFS0_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x42700094UL ) )
#define bFM3_MFS0_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42700098UL ) )
#define bFM3_MFS0_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270009CUL ) )
#define bFM3_MFS0_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x427000A0UL ) )
#define bFM3_MFS0_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427000A4UL ) )
#define bFM3_MFS0_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427000A8UL ) )
...
#define bFM3_MFS0_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x427001BCUL ) )

/* UART synchronous channel 0 registers */
#define bFM3_MFS0_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x42700000UL ) )
#define bFM3_MFS0_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x42700004UL ) )
#define bFM3_MFS0_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x42700008UL ) )
#define bFM3_MFS0_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270000CUL ) )
#define bFM3_MFS0_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42700010UL ) )
...
#define bFM3_MFS0_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42700028UL ) )
...
#define bFM3_MFS0_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270003CUL ) )
...
#define bFM3_MFS0_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270008CUL ) )
#define bFM3_MFS0_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x42700090UL ) )
#define bFM3_MFS0_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270009CUL ) )
#define bFM3_MFS0_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x427000A0UL ) )
#define bFM3_MFS0_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427000A4UL ) )
#define bFM3_MFS0_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427000A8UL ) )
...
#define bFM3_MFS0_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x42700080UL ) )
#define bFM3_MFS0_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x42700084UL ) )
#define bFM3_MFS0_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x42700088UL ) )
#define bFM3_MFS0_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270008CUL ) )
#define bFM3_MFS0_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x42700090UL ) )
#define bFM3_MFS0_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42700098UL ) )
...
#define bFM3_MFS0_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x42700000UL ) )
#define bFM3_MFS0_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x42700004UL ) )
...
#define bFM3_MFS0_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x42700028UL ) )
#define bFM3_MFS0_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270002CUL ) )
#define bFM3_MFS0_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x42700030UL ) )
#define bFM3_MFS0_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x42700034UL ) )
...
#define bFM3_MFS0_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x42700098UL ) )
...
#define bFM3_MFS0_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270021CUL ) )
...
#define bFM3_MFS1_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42702010UL ) )
...
#define bFM3_MFS1_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42702028UL ) )
...
#define bFM3_MFS1_UART_SCR_UPCL \
...
#define bFM3_MFS1_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x42702090UL ) )
#define bFM3_MFS1_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x42702094UL ) )
#define bFM3_MFS1_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42702098UL ) )
#define bFM3_MFS1_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270209CUL ) )
#define bFM3_MFS1_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x427020A0UL ) )
#define bFM3_MFS1_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427020A4UL ) )
#define bFM3_MFS1_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427020A8UL ) )
...
#define bFM3_MFS1_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x427021BCUL ) )

/* UART synchronous channel 1 registers */
#define bFM3_MFS1_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x42702000UL ) )
#define bFM3_MFS1_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x42702004UL ) )
#define bFM3_MFS1_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x42702008UL ) )
#define bFM3_MFS1_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270200CUL ) )
#define bFM3_MFS1_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42702010UL ) )
...
#define bFM3_MFS1_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42702028UL ) )
...
#define bFM3_MFS1_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270203CUL ) )
...
#define bFM3_MFS1_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270208CUL ) )
#define bFM3_MFS1_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x42702090UL ) )
#define bFM3_MFS1_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270209CUL ) )
#define bFM3_MFS1_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x427020A0UL ) )
#define bFM3_MFS1_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427020A4UL ) )
#define bFM3_MFS1_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427020A8UL ) )
...
#define bFM3_MFS1_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x42702080UL ) )
#define bFM3_MFS1_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x42702084UL ) )
#define bFM3_MFS1_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x42702088UL ) )
#define bFM3_MFS1_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270208CUL ) )
#define bFM3_MFS1_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x42702090UL ) )
#define bFM3_MFS1_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42702098UL ) )
...
#define bFM3_MFS1_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x42702000UL ) )
#define bFM3_MFS1_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x42702004UL ) )
...
#define bFM3_MFS1_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x42702028UL ) )
#define bFM3_MFS1_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270202CUL ) )
#define bFM3_MFS1_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x42702030UL ) )
#define bFM3_MFS1_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x42702034UL ) )
...
#define bFM3_MFS1_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x42702098UL ) )
...
#define bFM3_MFS1_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270221CUL ) )
...
#define bFM3_MFS2_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42704010UL ) )
...
#define bFM3_MFS2_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42704028UL ) )
...
#define bFM3_MFS2_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270403CUL ) )
...
#define bFM3_MFS2_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x42704090UL ) )
#define bFM3_MFS2_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x42704094UL ) )
#define bFM3_MFS2_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42704098UL ) )
#define bFM3_MFS2_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270409CUL ) )
#define bFM3_MFS2_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x427040A0UL ) )
#define bFM3_MFS2_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427040A4UL ) )
#define bFM3_MFS2_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427040A8UL ) )
...
#define bFM3_MFS2_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x427041BCUL ) )

/* UART synchronous channel 2 registers */
#define bFM3_MFS2_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x42704000UL ) )
#define bFM3_MFS2_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x42704004UL ) )
#define bFM3_MFS2_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x42704008UL ) )
#define bFM3_MFS2_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270400CUL ) )
#define bFM3_MFS2_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42704010UL ) )
...
#define bFM3_MFS2_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42704028UL ) )
...
#define bFM3_MFS2_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270403CUL ) )
...
#define bFM3_MFS2_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270408CUL ) )
#define bFM3_MFS2_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x42704090UL ) )
#define bFM3_MFS2_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270409CUL ) )
#define bFM3_MFS2_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x427040A0UL ) )
#define bFM3_MFS2_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427040A4UL ) )
#define bFM3_MFS2_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427040A8UL ) )
...
#define bFM3_MFS2_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x42704080UL ) )
#define bFM3_MFS2_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x42704084UL ) )
#define bFM3_MFS2_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x42704088UL ) )
#define bFM3_MFS2_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270408CUL ) )
#define bFM3_MFS2_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x42704090UL ) )
#define bFM3_MFS2_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42704098UL ) )
...
#define bFM3_MFS2_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x42704000UL ) )
#define bFM3_MFS2_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x42704004UL ) )
...
#define bFM3_MFS2_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x42704028UL ) )
#define bFM3_MFS2_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270402CUL ) )
#define bFM3_MFS2_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x42704030UL ) )
#define bFM3_MFS2_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x42704034UL ) )
...
#define bFM3_MFS2_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x42704098UL ) )
...
#define bFM3_MFS2_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270421CUL ) )
...
#define bFM3_MFS3_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42706010UL ) )
...
#define bFM3_MFS3_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42706028UL ) )
...
#define bFM3_MFS3_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270603CUL ) )
...
#define bFM3_MFS3_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x42706090UL ) )
#define bFM3_MFS3_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x42706094UL ) )
#define bFM3_MFS3_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42706098UL ) )
#define bFM3_MFS3_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270609CUL ) )
#define bFM3_MFS3_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x427060A0UL ) )
#define bFM3_MFS3_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427060A4UL ) )
#define bFM3_MFS3_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427060A8UL ) )
...
#define bFM3_MFS3_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x427061BCUL ) )

/* UART synchronous channel 3 registers */
#define bFM3_MFS3_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x42706000UL ) )
#define bFM3_MFS3_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x42706004UL ) )
#define bFM3_MFS3_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x42706008UL ) )
#define bFM3_MFS3_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270600CUL ) )
#define bFM3_MFS3_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42706010UL ) )
...
#define bFM3_MFS3_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42706028UL ) )
...
#define bFM3_MFS3_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270603CUL ) )
...
#define bFM3_MFS3_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270608CUL ) )
#define bFM3_MFS3_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x42706090UL ) )
#define bFM3_MFS3_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270609CUL ) )
#define bFM3_MFS3_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x427060A0UL ) )
#define bFM3_MFS3_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427060A4UL ) )
#define bFM3_MFS3_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427060A8UL ) )
...
#define bFM3_MFS3_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x42706080UL ) )
#define bFM3_MFS3_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x42706084UL ) )
#define bFM3_MFS3_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x42706088UL ) )
#define bFM3_MFS3_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270608CUL ) )
#define bFM3_MFS3_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x42706090UL ) )
#define bFM3_MFS3_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42706098UL ) )
...
#define bFM3_MFS3_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x42706000UL ) )
#define bFM3_MFS3_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x42706004UL ) )
...
#define bFM3_MFS3_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x42706028UL ) )
#define bFM3_MFS3_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270602CUL ) )
#define bFM3_MFS3_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x42706030UL ) )
#define bFM3_MFS3_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x42706034UL ) )
...
#define bFM3_MFS3_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x42706098UL ) )
...
#define bFM3_MFS3_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270621CUL ) )
...
#define bFM3_MFS4_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42708010UL ) )
...
#define bFM3_MFS4_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42708028UL ) )
...
#define bFM3_MFS4_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270803CUL ) )
...
#define bFM3_MFS4_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x42708090UL ) )
#define bFM3_MFS4_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x42708094UL ) )
#define bFM3_MFS4_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42708098UL ) )
#define bFM3_MFS4_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270809CUL ) )
#define bFM3_MFS4_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x427080A0UL ) )
#define bFM3_MFS4_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427080A4UL ) )
#define bFM3_MFS4_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427080A8UL ) )
...
#define bFM3_MFS4_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x427081BCUL ) )
...
#define bFM3_MFS4_UART_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_UART_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_UART_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_UART_FCR_FLD *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_UART_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_UART_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_UART_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_UART_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_UART_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_UART_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_UART_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_UART_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_UART_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x42708280UL ) )
#define bFM3_MFS4_UART_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x42708284UL ) )
#define bFM3_MFS4_UART_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_UART_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_UART_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_UART_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_UART_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_UART_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_UART_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_UART_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_UART_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_UART_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_UART_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_UART_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_UART_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_UART_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_UART_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_UART_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_UART_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_UART_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_UART_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_UART_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_UART_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708320UL ) )
#define bFM3_MFS4_UART_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708324UL ) )
#define bFM3_MFS4_UART_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708328UL ) )
#define bFM3_MFS4_UART_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270832CUL ) )
#define bFM3_MFS4_UART_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708330UL ) )
#define bFM3_MFS4_UART_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708334UL ) )
#define bFM3_MFS4_UART_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708338UL ) )
#define bFM3_MFS4_UART_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270833CUL ) )
#define bFM3_MFS4_UART_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_UART_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_UART_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_UART_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708320UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708324UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708328UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270832CUL ) )
#define bFM3_MFS4_UART_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708330UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708334UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708338UL ) )
#define bFM3_MFS4_UART_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270833CUL ) )

/* UART synchronous channel 4 registers */
#define bFM3_MFS4_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x42708000UL ) )
#define bFM3_MFS4_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x42708004UL ) )
#define bFM3_MFS4_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x42708008UL ) )
#define bFM3_MFS4_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270800CUL ) )
#define bFM3_MFS4_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x42708010UL ) )
...
#define bFM3_MFS4_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x42708028UL ) )
...
#define bFM3_MFS4_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270803CUL ) )
...
#define bFM3_MFS4_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270808CUL ) )
#define bFM3_MFS4_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x42708090UL ) )
#define bFM3_MFS4_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270809CUL ) )
#define bFM3_MFS4_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x427080A0UL ) )
#define bFM3_MFS4_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x427080A4UL ) )
#define bFM3_MFS4_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x427080A8UL ) )
...
#define bFM3_MFS4_CSIO_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_CSIO_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_CSIO_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_CSIO_FCR_FLD *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_CSIO_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_CSIO_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_CSIO_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_CSIO_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_CSIO_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_CSIO_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_CSIO_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_CSIO_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_CSIO_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x42708280UL ) )
#define bFM3_MFS4_CSIO_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x42708284UL ) )
#define bFM3_MFS4_CSIO_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_CSIO_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_CSIO_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_CSIO_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_CSIO_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_CSIO_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_CSIO_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_CSIO_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_CSIO_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_CSIO_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_CSIO_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_CSIO_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708320UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708324UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708328UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270832CUL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708330UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708334UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708338UL ) )
#define bFM3_MFS4_CSIO_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270833CUL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_CSIO_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708340UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708344UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708348UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270834CUL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708350UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708354UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708358UL ) )
#define bFM3_MFS4_CSIO_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270835CUL ) )
...
#define bFM3_MFS4_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x42708080UL ) )
#define bFM3_MFS4_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x42708084UL ) )
#define bFM3_MFS4_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x42708088UL ) )
#define bFM3_MFS4_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270808CUL ) )
#define bFM3_MFS4_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x42708090UL ) )
#define bFM3_MFS4_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x42708098UL ) )
...
#define bFM3_MFS4_LIN_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_LIN_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_LIN_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
...
#define bFM3_MFS4_LIN_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_LIN_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_LIN_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_LIN_FCR0_FLD *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_LIN_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_LIN_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_LIN_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_LIN_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_LIN_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_LIN_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_LIN_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_LIN_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_LIN_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_LIN_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_LIN_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708320UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708324UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708328UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270832CUL ) )
#define bFM3_MFS4_LIN_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708330UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708334UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708338UL ) )
#define bFM3_MFS4_LIN_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270833CUL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_LIN_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708340UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708344UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708348UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270834CUL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708350UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708354UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708358UL ) )
#define bFM3_MFS4_LIN_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270835CUL ) )

/* I2C channel 4 registers */
#define bFM3_MFS4_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x42708000UL ) )
#define bFM3_MFS4_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x42708004UL ) )
...
#define bFM3_MFS4_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x42708028UL ) )
#define bFM3_MFS4_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270802CUL ) )
#define bFM3_MFS4_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x42708030UL ) )
#define bFM3_MFS4_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x42708034UL ) )
...
#define bFM3_MFS4_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x42708098UL ) )
...
#define bFM3_MFS4_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270821CUL ) )
...
#define bFM3_MFS4_I2C_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_I2C_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_I2C_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
...
#define bFM3_MFS4_I2C_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x42708288UL ) )
#define bFM3_MFS4_I2C_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270828CUL ) )
#define bFM3_MFS4_I2C_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x42708290UL ) )
#define bFM3_MFS4_I2C_FCR0_FLD *( ( volatile unsigned int * ) ( 0x42708294UL ) )
#define bFM3_MFS4_I2C_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x42708298UL ) )
#define bFM3_MFS4_I2C_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x427082A0UL ) )
#define bFM3_MFS4_I2C_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x427082A4UL ) )
#define bFM3_MFS4_I2C_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x427082A8UL ) )
#define bFM3_MFS4_I2C_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x427082ACUL ) )
#define bFM3_MFS4_I2C_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x427082B0UL ) )
#define bFM3_MFS4_I2C_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x427082B8UL ) )
#define bFM3_MFS4_I2C_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x427082BCUL ) )
#define bFM3_MFS4_I2C_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_I2C_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_I2C_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708320UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708324UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708328UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270832CUL ) )
#define bFM3_MFS4_I2C_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708330UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708334UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708338UL ) )
#define bFM3_MFS4_I2C_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270833CUL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x42708300UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x42708304UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x42708308UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270830CUL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x42708310UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x42708314UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x42708318UL ) )
#define bFM3_MFS4_I2C_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270831CUL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x42708340UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x42708344UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x42708348UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270834CUL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x42708350UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x42708354UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x42708358UL ) )
#define bFM3_MFS4_I2C_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270835CUL ) )
...
#define bFM3_MFS5_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270A010UL ) )
...
#define bFM3_MFS5_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270A028UL ) )
...
#define bFM3_MFS5_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270A03CUL ) )
...
#define bFM3_MFS5_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x4270A090UL ) )
#define bFM3_MFS5_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x4270A094UL ) )
#define bFM3_MFS5_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270A098UL ) )
#define bFM3_MFS5_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270A09CUL ) )
#define bFM3_MFS5_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270A0A0UL ) )
#define bFM3_MFS5_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270A0A4UL ) )
#define bFM3_MFS5_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270A0A8UL ) )
...
#define bFM3_MFS5_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x4270A1BCUL ) )
...
#define bFM3_MFS5_UART_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_UART_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_UART_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_UART_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_UART_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_UART_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_UART_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_UART_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_UART_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_UART_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_UART_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_UART_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_UART_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270A280UL ) )
#define bFM3_MFS5_UART_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270A284UL ) )
#define bFM3_MFS5_UART_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_UART_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_UART_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_UART_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_UART_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_UART_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_UART_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_UART_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_UART_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_UART_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_UART_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_UART_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_UART_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_UART_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_UART_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_UART_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_UART_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_UART_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_UART_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_UART_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_UART_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A320UL ) )
#define bFM3_MFS5_UART_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A324UL ) )
#define bFM3_MFS5_UART_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A328UL ) )
#define bFM3_MFS5_UART_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A32CUL ) )
#define bFM3_MFS5_UART_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A330UL ) )
#define bFM3_MFS5_UART_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A334UL ) )
#define bFM3_MFS5_UART_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A338UL ) )
#define bFM3_MFS5_UART_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A33CUL ) )
#define bFM3_MFS5_UART_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_UART_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_UART_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_UART_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A320UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A324UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A328UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A32CUL ) )
#define bFM3_MFS5_UART_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A330UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A334UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A338UL ) )
#define bFM3_MFS5_UART_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A33CUL ) )

/* UART synchronous channel 5 registers */
#define bFM3_MFS5_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x4270A000UL ) )
#define bFM3_MFS5_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x4270A004UL ) )
#define bFM3_MFS5_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x4270A008UL ) )
#define bFM3_MFS5_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270A00CUL ) )
#define bFM3_MFS5_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270A010UL ) )
...
#define bFM3_MFS5_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270A028UL ) )
...
#define bFM3_MFS5_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270A03CUL ) )
...
#define bFM3_MFS5_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270A08CUL ) )
#define bFM3_MFS5_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x4270A090UL ) )
#define bFM3_MFS5_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270A09CUL ) )
#define bFM3_MFS5_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270A0A0UL ) )
#define bFM3_MFS5_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270A0A4UL ) )
#define bFM3_MFS5_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270A0A8UL ) )
...
#define bFM3_MFS5_CSIO_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_CSIO_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_CSIO_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_CSIO_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_CSIO_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_CSIO_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_CSIO_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_CSIO_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_CSIO_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_CSIO_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_CSIO_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_CSIO_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_CSIO_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270A280UL ) )
#define bFM3_MFS5_CSIO_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270A284UL ) )
#define bFM3_MFS5_CSIO_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_CSIO_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_CSIO_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_CSIO_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_CSIO_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_CSIO_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_CSIO_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_CSIO_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_CSIO_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_CSIO_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_CSIO_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_CSIO_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A320UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A324UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A328UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A32CUL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A330UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A334UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A338UL ) )
#define bFM3_MFS5_CSIO_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A33CUL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_CSIO_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A340UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A344UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A348UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A34CUL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A350UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A354UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A358UL ) )
#define bFM3_MFS5_CSIO_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A35CUL ) )
...
#define bFM3_MFS5_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x4270A080UL ) )
#define bFM3_MFS5_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x4270A084UL ) )
#define bFM3_MFS5_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x4270A088UL ) )
#define bFM3_MFS5_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270A08CUL ) )
#define bFM3_MFS5_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x4270A090UL ) )
#define bFM3_MFS5_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270A098UL ) )
...
#define bFM3_MFS5_LIN_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_LIN_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_LIN_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
...
#define bFM3_MFS5_LIN_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_LIN_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_LIN_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_LIN_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_LIN_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_LIN_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_LIN_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_LIN_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_LIN_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_LIN_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_LIN_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_LIN_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_LIN_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_LIN_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_LIN_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A320UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A324UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A328UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A32CUL ) )
#define bFM3_MFS5_LIN_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A330UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A334UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A338UL ) )
#define bFM3_MFS5_LIN_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A33CUL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_LIN_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A340UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A344UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A348UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A34CUL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A350UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A354UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A358UL ) )
#define bFM3_MFS5_LIN_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A35CUL ) )

/* I2C channel 5 registers */
#define bFM3_MFS5_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x4270A000UL ) )
#define bFM3_MFS5_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x4270A004UL ) )
...
#define bFM3_MFS5_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x4270A028UL ) )
#define bFM3_MFS5_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270A02CUL ) )
#define bFM3_MFS5_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x4270A030UL ) )
#define bFM3_MFS5_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x4270A034UL ) )
...
#define bFM3_MFS5_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x4270A098UL ) )
...
#define bFM3_MFS5_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270A21CUL ) )
...
#define bFM3_MFS5_I2C_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_I2C_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_I2C_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
...
#define bFM3_MFS5_I2C_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270A288UL ) )
#define bFM3_MFS5_I2C_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270A28CUL ) )
#define bFM3_MFS5_I2C_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270A290UL ) )
#define bFM3_MFS5_I2C_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270A294UL ) )
#define bFM3_MFS5_I2C_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270A298UL ) )
#define bFM3_MFS5_I2C_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270A2A0UL ) )
#define bFM3_MFS5_I2C_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270A2A4UL ) )
#define bFM3_MFS5_I2C_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270A2A8UL ) )
#define bFM3_MFS5_I2C_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270A2ACUL ) )
#define bFM3_MFS5_I2C_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270A2B0UL ) )
#define bFM3_MFS5_I2C_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270A2B8UL ) )
#define bFM3_MFS5_I2C_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270A2BCUL ) )
#define bFM3_MFS5_I2C_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_I2C_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_I2C_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A320UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A324UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A328UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A32CUL ) )
#define bFM3_MFS5_I2C_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A330UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A334UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A338UL ) )
#define bFM3_MFS5_I2C_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A33CUL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270A300UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270A304UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270A308UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270A30CUL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270A310UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270A314UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270A318UL ) )
#define bFM3_MFS5_I2C_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270A31CUL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270A340UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270A344UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270A348UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270A34CUL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270A350UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270A354UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270A358UL ) )
#define bFM3_MFS5_I2C_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270A35CUL ) )
...
#define bFM3_MFS6_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270C010UL ) )
...
#define bFM3_MFS6_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270C028UL ) )
...
#define bFM3_MFS6_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270C03CUL ) )
...
#define bFM3_MFS6_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x4270C090UL ) )
#define bFM3_MFS6_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x4270C094UL ) )
#define bFM3_MFS6_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270C098UL ) )
#define bFM3_MFS6_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270C09CUL ) )
#define bFM3_MFS6_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270C0A0UL ) )
#define bFM3_MFS6_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270C0A4UL ) )
#define bFM3_MFS6_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270C0A8UL ) )
...
#define bFM3_MFS6_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x4270C1BCUL ) )
...
#define bFM3_MFS6_UART_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_UART_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_UART_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_UART_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_UART_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_UART_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_UART_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_UART_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_UART_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_UART_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_UART_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_UART_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_UART_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270C280UL ) )
#define bFM3_MFS6_UART_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270C284UL ) )
#define bFM3_MFS6_UART_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_UART_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_UART_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_UART_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_UART_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_UART_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_UART_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_UART_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_UART_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_UART_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_UART_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_UART_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_UART_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_UART_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_UART_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_UART_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_UART_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_UART_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_UART_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_UART_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_UART_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C320UL ) )
#define bFM3_MFS6_UART_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C324UL ) )
#define bFM3_MFS6_UART_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C328UL ) )
#define bFM3_MFS6_UART_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C32CUL ) )
#define bFM3_MFS6_UART_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C330UL ) )
#define bFM3_MFS6_UART_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C334UL ) )
#define bFM3_MFS6_UART_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C338UL ) )
#define bFM3_MFS6_UART_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C33CUL ) )
#define bFM3_MFS6_UART_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_UART_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_UART_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_UART_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C320UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C324UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C328UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C32CUL ) )
#define bFM3_MFS6_UART_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C330UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C334UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C338UL ) )
#define bFM3_MFS6_UART_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C33CUL ) )

/* UART synchronous channel 6 registers */
#define bFM3_MFS6_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x4270C000UL ) )
#define bFM3_MFS6_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x4270C004UL ) )
#define bFM3_MFS6_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x4270C008UL ) )
#define bFM3_MFS6_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270C00CUL ) )
#define bFM3_MFS6_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270C010UL ) )
...
#define bFM3_MFS6_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270C028UL ) )
...
#define bFM3_MFS6_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270C03CUL ) )
...
#define bFM3_MFS6_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270C08CUL ) )
#define bFM3_MFS6_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x4270C090UL ) )
#define bFM3_MFS6_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270C09CUL ) )
#define bFM3_MFS6_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270C0A0UL ) )
#define bFM3_MFS6_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270C0A4UL ) )
#define bFM3_MFS6_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270C0A8UL ) )
...
#define bFM3_MFS6_CSIO_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_CSIO_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_CSIO_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_CSIO_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_CSIO_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_CSIO_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_CSIO_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_CSIO_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_CSIO_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_CSIO_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_CSIO_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_CSIO_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_CSIO_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270C280UL ) )
#define bFM3_MFS6_CSIO_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270C284UL ) )
#define bFM3_MFS6_CSIO_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_CSIO_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_CSIO_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_CSIO_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_CSIO_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_CSIO_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_CSIO_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_CSIO_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_CSIO_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_CSIO_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_CSIO_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_CSIO_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C320UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C324UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C328UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C32CUL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C330UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C334UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C338UL ) )
#define bFM3_MFS6_CSIO_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C33CUL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_CSIO_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C340UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C344UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C348UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C34CUL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C350UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C354UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C358UL ) )
#define bFM3_MFS6_CSIO_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C35CUL ) )
...
#define bFM3_MFS6_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x4270C080UL ) )
#define bFM3_MFS6_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x4270C084UL ) )
#define bFM3_MFS6_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x4270C088UL ) )
#define bFM3_MFS6_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270C08CUL ) )
#define bFM3_MFS6_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x4270C090UL ) )
#define bFM3_MFS6_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270C098UL ) )
...
#define bFM3_MFS6_LIN_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_LIN_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_LIN_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
...
#define bFM3_MFS6_LIN_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_LIN_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_LIN_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_LIN_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_LIN_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_LIN_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_LIN_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_LIN_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_LIN_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_LIN_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_LIN_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_LIN_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_LIN_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_LIN_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_LIN_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C320UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C324UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C328UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C32CUL ) )
#define bFM3_MFS6_LIN_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C330UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C334UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C338UL ) )
#define bFM3_MFS6_LIN_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C33CUL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_LIN_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C340UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C344UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C348UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C34CUL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C350UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C354UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C358UL ) )
#define bFM3_MFS6_LIN_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C35CUL ) )

/* I2C channel 6 registers */
#define bFM3_MFS6_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x4270C000UL ) )
#define bFM3_MFS6_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x4270C004UL ) )
...
#define bFM3_MFS6_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x4270C028UL ) )
#define bFM3_MFS6_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270C02CUL ) )
#define bFM3_MFS6_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x4270C030UL ) )
#define bFM3_MFS6_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x4270C034UL ) )
...
#define bFM3_MFS6_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x4270C098UL ) )
...
#define bFM3_MFS6_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270C21CUL ) )
...
#define bFM3_MFS6_I2C_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_I2C_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_I2C_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
...
#define bFM3_MFS6_I2C_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270C288UL ) )
#define bFM3_MFS6_I2C_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270C28CUL ) )
#define bFM3_MFS6_I2C_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270C290UL ) )
#define bFM3_MFS6_I2C_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270C294UL ) )
#define bFM3_MFS6_I2C_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270C298UL ) )
#define bFM3_MFS6_I2C_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270C2A0UL ) )
#define bFM3_MFS6_I2C_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270C2A4UL ) )
#define bFM3_MFS6_I2C_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270C2A8UL ) )
#define bFM3_MFS6_I2C_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270C2ACUL ) )
#define bFM3_MFS6_I2C_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270C2B0UL ) )
#define bFM3_MFS6_I2C_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270C2B8UL ) )
#define bFM3_MFS6_I2C_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270C2BCUL ) )
#define bFM3_MFS6_I2C_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_I2C_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_I2C_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C320UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C324UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C328UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C32CUL ) )
#define bFM3_MFS6_I2C_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C330UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C334UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C338UL ) )
#define bFM3_MFS6_I2C_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C33CUL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270C300UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270C304UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270C308UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270C30CUL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270C310UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270C314UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270C318UL ) )
#define bFM3_MFS6_I2C_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270C31CUL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270C340UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270C344UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270C348UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270C34CUL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270C350UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270C354UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270C358UL ) )
#define bFM3_MFS6_I2C_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270C35CUL ) )
...
#define bFM3_MFS7_UART_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270E010UL ) )
...
#define bFM3_MFS7_UART_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270E028UL ) )
...
#define bFM3_MFS7_UART_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270E03CUL ) )
...
#define bFM3_MFS7_UART_ESCR_PEN \
    *( ( volatile unsigned int * ) ( 0x4270E090UL ) )
#define bFM3_MFS7_UART_ESCR_INV \
    *( ( volatile unsigned int * ) ( 0x4270E094UL ) )
#define bFM3_MFS7_UART_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270E098UL ) )
#define bFM3_MFS7_UART_ESCR_FLWEN \
    *( ( volatile unsigned int * ) ( 0x4270E09CUL ) )
#define bFM3_MFS7_UART_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270E0A0UL ) )
#define bFM3_MFS7_UART_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270E0A4UL ) )
#define bFM3_MFS7_UART_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270E0A8UL ) )
...
#define bFM3_MFS7_UART_BGR1_EXT \
    *( ( volatile unsigned int * ) ( 0x4270E1BCUL ) )
...
#define bFM3_MFS7_UART_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_UART_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_UART_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_UART_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_UART_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_UART_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_UART_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_UART_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_UART_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_UART_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_UART_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_UART_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_UART_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270E280UL ) )
#define bFM3_MFS7_UART_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270E284UL ) )
#define bFM3_MFS7_UART_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_UART_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_UART_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_UART_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_UART_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_UART_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_UART_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_UART_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_UART_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_UART_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_UART_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_UART_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_UART_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_UART_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_UART_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_UART_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_UART_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_UART_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_UART_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_UART_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_UART_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E320UL ) )
#define bFM3_MFS7_UART_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E324UL ) )
#define bFM3_MFS7_UART_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E328UL ) )
#define bFM3_MFS7_UART_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E32CUL ) )
#define bFM3_MFS7_UART_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E330UL ) )
#define bFM3_MFS7_UART_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E334UL ) )
#define bFM3_MFS7_UART_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E338UL ) )
#define bFM3_MFS7_UART_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E33CUL ) )
#define bFM3_MFS7_UART_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_UART_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_UART_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_UART_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E320UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E324UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E328UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E32CUL ) )
#define bFM3_MFS7_UART_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E330UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E334UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E338UL ) )
#define bFM3_MFS7_UART_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E33CUL ) )

/* UART synchronous channel 7 registers */
#define bFM3_MFS7_CSIO_SMR_SOE *( ( volatile unsigned int * ) ( 0x4270E000UL ) )
#define bFM3_MFS7_CSIO_SMR_SCKE \
    *( ( volatile unsigned int * ) ( 0x4270E004UL ) )
#define bFM3_MFS7_CSIO_SMR_BDS *( ( volatile unsigned int * ) ( 0x4270E008UL ) )
#define bFM3_MFS7_CSIO_SMR_SCINV \
    *( ( volatile unsigned int * ) ( 0x4270E00CUL ) )
#define bFM3_MFS7_CSIO_SMR_WUCR \
    *( ( volatile unsigned int * ) ( 0x4270E010UL ) )
...
#define bFM3_MFS7_CSIO_SCR_TBIE \
    *( ( volatile unsigned int * ) ( 0x4270E028UL ) )
...
#define bFM3_MFS7_CSIO_SCR_UPCL \
    *( ( volatile unsigned int * ) ( 0x4270E03CUL ) )
...
#define bFM3_MFS7_CSIO_ESCR_WT0 \
    *( ( volatile unsigned int * ) ( 0x4270E08CUL ) )
#define bFM3_MFS7_CSIO_ESCR_WT1 \
    *( ( volatile unsigned int * ) ( 0x4270E090UL ) )
#define bFM3_MFS7_CSIO_ESCR_SOP \
    *( ( volatile unsigned int * ) ( 0x4270E09CUL ) )
#define bFM3_MFS7_CSIO_SSR_TBI *( ( volatile unsigned int * ) ( 0x4270E0A0UL ) )
#define bFM3_MFS7_CSIO_SSR_TDRE \
    *( ( volatile unsigned int * ) ( 0x4270E0A4UL ) )
#define bFM3_MFS7_CSIO_SSR_RDRF \
    *( ( volatile unsigned int * ) ( 0x4270E0A8UL ) )
...
#define bFM3_MFS7_CSIO_FCR_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_CSIO_FCR_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_CSIO_FCR_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_CSIO_FCR_FLD *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_CSIO_FCR_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_CSIO_FCR_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_CSIO_FCR_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_CSIO_FCR_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_CSIO_FCR_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_CSIO_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_CSIO_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_CSIO_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_CSIO_FCR0_FE1 \
    *( ( volatile unsigned int * ) ( 0x4270E280UL ) )
#define bFM3_MFS7_CSIO_FCR0_FE2 \
    *( ( volatile unsigned int * ) ( 0x4270E284UL ) )
#define bFM3_MFS7_CSIO_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_CSIO_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_CSIO_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_CSIO_FCR0_FLD \
    *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_CSIO_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_CSIO_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_CSIO_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_CSIO_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_CSIO_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_CSIO_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_CSIO_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_CSIO_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E320UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E324UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E328UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E32CUL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E330UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E334UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E338UL ) )
#define bFM3_MFS7_CSIO_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E33CUL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_CSIO_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E340UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E344UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E348UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E34CUL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E350UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E354UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E358UL ) )
#define bFM3_MFS7_CSIO_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E35CUL ) )
...
#define bFM3_MFS7_LIN_ESCR_DEL0 \
    *( ( volatile unsigned int * ) ( 0x4270E080UL ) )
#define bFM3_MFS7_LIN_ESCR_DEL1 \
    *( ( volatile unsigned int * ) ( 0x4270E084UL ) )
#define bFM3_MFS7_LIN_ESCR_LBL0 \
    *( ( volatile unsigned int * ) ( 0x4270E088UL ) )
#define bFM3_MFS7_LIN_ESCR_LBL1 \
    *( ( volatile unsigned int * ) ( 0x4270E08CUL ) )
#define bFM3_MFS7_LIN_ESCR_LBIE \
    *( ( volatile unsigned int * ) ( 0x4270E090UL ) )
#define bFM3_MFS7_LIN_ESCR_ESBL \
    *( ( volatile unsigned int * ) ( 0x4270E098UL ) )
...
#define bFM3_MFS7_LIN_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_LIN_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_LIN_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
...
#define bFM3_MFS7_LIN_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_LIN_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_LIN_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_LIN_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_LIN_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_LIN_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_LIN_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_LIN_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_LIN_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_LIN_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_LIN_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_LIN_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_LIN_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_LIN_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_LIN_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E320UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E324UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E328UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E32CUL ) )
#define bFM3_MFS7_LIN_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E330UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E334UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E338UL ) )
#define bFM3_MFS7_LIN_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E33CUL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_LIN_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E340UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E344UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E348UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E34CUL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E350UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E354UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E358UL ) )
#define bFM3_MFS7_LIN_FBYTE2_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E35CUL ) )

/* I2C channel 7 registers */
#define bFM3_MFS7_I2C_SMR_ITST0 \
    *( ( volatile unsigned int * ) ( 0x4270E000UL ) )
#define bFM3_MFS7_I2C_SMR_ITST1 \
    *( ( volatile unsigned int * ) ( 0x4270E004UL ) )
...
#define bFM3_MFS7_I2C_IBCR_INTE \
    *( ( volatile unsigned int * ) ( 0x4270E028UL ) )
#define bFM3_MFS7_I2C_IBCR_CNDE \
    *( ( volatile unsigned int * ) ( 0x4270E02CUL ) )
#define bFM3_MFS7_I2C_IBCR_WSEL \
    *( ( volatile unsigned int * ) ( 0x4270E030UL ) )
#define bFM3_MFS7_I2C_IBCR_ACKE \
    *( ( volatile unsigned int * ) ( 0x4270E034UL ) )
...
#define bFM3_MFS7_I2C_IBSR_RACK \
    *( ( volatile unsigned int * ) ( 0x4270E098UL ) )
...
#define bFM3_MFS7_I2C_ISBA_SAEN \
    *( ( volatile unsigned int * ) ( 0x4270E21CUL ) )
...
#define bFM3_MFS7_I2C_FCR_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_I2C_FCR_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_I2C_FCR_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
...
#define bFM3_MFS7_I2C_FCR0_FCL1 \
    *( ( volatile unsigned int * ) ( 0x4270E288UL ) )
#define bFM3_MFS7_I2C_FCR0_FCL2 \
    *( ( volatile unsigned int * ) ( 0x4270E28CUL ) )
#define bFM3_MFS7_I2C_FCR0_FSET \
    *( ( volatile unsigned int * ) ( 0x4270E290UL ) )
#define bFM3_MFS7_I2C_FCR0_FLD *( ( volatile unsigned int * ) ( 0x4270E294UL ) )
#define bFM3_MFS7_I2C_FCR0_FLST \
    *( ( volatile unsigned int * ) ( 0x4270E298UL ) )
#define bFM3_MFS7_I2C_FCR1_FSEL \
    *( ( volatile unsigned int * ) ( 0x4270E2A0UL ) )
#define bFM3_MFS7_I2C_FCR1_FTIE \
    *( ( volatile unsigned int * ) ( 0x4270E2A4UL ) )
#define bFM3_MFS7_I2C_FCR1_FDRQ \
    *( ( volatile unsigned int * ) ( 0x4270E2A8UL ) )
#define bFM3_MFS7_I2C_FCR1_FRIE \
    *( ( volatile unsigned int * ) ( 0x4270E2ACUL ) )
#define bFM3_MFS7_I2C_FCR1_FLSTE \
    *( ( volatile unsigned int * ) ( 0x4270E2B0UL ) )
#define bFM3_MFS7_I2C_FCR1_FTST0 \
    *( ( volatile unsigned int * ) ( 0x4270E2B8UL ) )
#define bFM3_MFS7_I2C_FCR1_FTST1 \
    *( ( volatile unsigned int * ) ( 0x4270E2BCUL ) )
#define bFM3_MFS7_I2C_FBYTE_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_I2C_FBYTE_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_I2C_FBYTE_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E320UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E324UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E328UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E32CUL ) )
#define bFM3_MFS7_I2C_FBYTE_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E330UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E334UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E338UL ) )
#define bFM3_MFS7_I2C_FBYTE_FD15 \
    *( ( volatile unsigned int * ) ( 0x4270E33CUL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD0 \
    *( ( volatile unsigned int * ) ( 0x4270E300UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD1 \
    *( ( volatile unsigned int * ) ( 0x4270E304UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD2 \
    *( ( volatile unsigned int * ) ( 0x4270E308UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD3 \
    *( ( volatile unsigned int * ) ( 0x4270E30CUL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD4 \
    *( ( volatile unsigned int * ) ( 0x4270E310UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD5 \
    *( ( volatile unsigned int * ) ( 0x4270E314UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD6 \
    *( ( volatile unsigned int * ) ( 0x4270E318UL ) )
#define bFM3_MFS7_I2C_FBYTE1_FD7 \
    *( ( volatile unsigned int * ) ( 0x4270E31CUL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD8 \
    *( ( volatile unsigned int * ) ( 0x4270E340UL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD9 \
    *( ( volatile unsigned int * ) ( 0x4270E344UL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD10 \
    *( ( volatile unsigned int * ) ( 0x4270E348UL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD11 \
    *( ( volatile unsigned int * ) ( 0x4270E34CUL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD12 \
    *( ( volatile unsigned int * ) ( 0x4270E350UL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD13 \
    *( ( volatile unsigned int * ) ( 0x4270E354UL ) )
#define bFM3_MFS7_I2C_FBYTE2_FD14 \
    *( ( volatile unsigned int * ) ( 0x4270E358UL ) )
...
#define bFM3_WC_CLK_SEL_SEL_OUT \
    *( ( volatile unsigned int * ) ( 0x42740220UL ) )
#define bFM3_WC_CLK_EN_CLK_EN *( ( volatile unsigned int * ) ( 0x42740280UL ) )
#define bFM3_WC_CLK_EN_CLK_EN_R \
    *( ( volatile unsigned int * ) ( 0x42740284UL ) )
...
#define bFM3_USB0_HCNT1_SOFSTEP \
    *( ( volatile unsigned int * ) ( 0x42842028UL ) )
...
#define bFM3_USB0_HSTATE_SOFBUSY \
    *( ( volatile unsigned int * ) ( 0x4284210CUL ) )
#define bFM3_USB0_HSTATE_CLKSEL \
    *( ( volatile unsigned int * ) ( 0x42842110UL ) )
#define bFM3_USB0_HSTATE_ALIVE *( ( volatile unsigned int * ) ( 0x42842114UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP0 \
    *( ( volatile unsigned int * ) ( 0x42842120UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP1 \
    *( ( volatile unsigned int * ) ( 0x42842124UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP2 \
    *( ( volatile unsigned int * ) ( 0x42842128UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP3 \
    *( ( volatile unsigned int * ) ( 0x4284212CUL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP4 \
    *( ( volatile unsigned int * ) ( 0x42842130UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP5 \
    *( ( volatile unsigned int * ) ( 0x42842134UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP6 \
    *( ( volatile unsigned int * ) ( 0x42842138UL ) )
#define bFM3_USB0_HFCOMP_FRAMECOMP7 \
    *( ( volatile unsigned int * ) ( 0x4284213CUL ) )
#define bFM3_USB0_HRTIMER_RTIMER0 \
    *( ( volatile unsigned int * ) ( 0x42842180UL ) )
#define bFM3_USB0_HRTIMER_RTIMER1 \
    *( ( volatile unsigned int * ) ( 0x42842184UL ) )
#define bFM3_USB0_HRTIMER_RTIMER2 \
    *( ( volatile unsigned int * ) ( 0x42842188UL ) )
#define bFM3_USB0_HRTIMER_RTIMER3 \
    *( ( volatile unsigned int * ) ( 0x4284218CUL ) )
#define bFM3_USB0_HRTIMER_RTIMER4 \
    *( ( volatile unsigned int * ) ( 0x42842190UL ) )
#define bFM3_USB0_HRTIMER_RTIMER5 \
    *( ( volatile unsigned int * ) ( 0x42842194UL ) )
#define bFM3_USB0_HRTIMER_RTIMER6 \
    *( ( volatile unsigned int * ) ( 0x42842198UL ) )
#define bFM3_USB0_HRTIMER_RTIMER7 \
    *( ( volatile unsigned int * ) ( 0x4284219CUL ) )
#define bFM3_USB0_HRTIMER_RTIMER8 \
    *( ( volatile unsigned int * ) ( 0x428421A0UL ) )
#define bFM3_USB0_HRTIMER_RTIMER9 \
    *( ( volatile unsigned int * ) ( 0x428421A4UL ) )
#define bFM3_USB0_HRTIMER_RTIMER10 \
    *( ( volatile unsigned int * ) ( 0x428421A8UL ) )
#define bFM3_USB0_HRTIMER_RTIMER11 \
    *( ( volatile unsigned int * ) ( 0x428421ACUL ) )
#define bFM3_USB0_HRTIMER_RTIMER12 \
    *( ( volatile unsigned int * ) ( 0x428421B0UL ) )
#define bFM3_USB0_HRTIMER_RTIMER13 \
    *( ( volatile unsigned int * ) ( 0x428421B4UL ) )
#define bFM3_USB0_HRTIMER_RTIMER14 \
    *( ( volatile unsigned int * ) ( 0x428421B8UL ) )
#define bFM3_USB0_HRTIMER_RTIMER15 \
    *( ( volatile unsigned int * ) ( 0x428421BCUL ) )
#define bFM3_USB0_HRTIMER0_RTIMER00 \
    *( ( volatile unsigned int * ) ( 0x42842180UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER01 \
    *( ( volatile unsigned int * ) ( 0x42842184UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER02 \
    *( ( volatile unsigned int * ) ( 0x42842188UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER03 \
    *( ( volatile unsigned int * ) ( 0x4284218CUL ) )
#define bFM3_USB0_HRTIMER0_RTIMER04 \
    *( ( volatile unsigned int * ) ( 0x42842190UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER05 \
    *( ( volatile unsigned int * ) ( 0x42842194UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER06 \
    *( ( volatile unsigned int * ) ( 0x42842198UL ) )
#define bFM3_USB0_HRTIMER0_RTIMER07 \
    *( ( volatile unsigned int * ) ( 0x4284219CUL ) )
#define bFM3_USB0_HRTIMER1_RTIMER10 \
    *( ( volatile unsigned int * ) ( 0x428421A0UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER11 \
    *( ( volatile unsigned int * ) ( 0x428421A4UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER12 \
    *( ( volatile unsigned int * ) ( 0x428421A8UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER13 \
    *( ( volatile unsigned int * ) ( 0x428421ACUL ) )
#define bFM3_USB0_HRTIMER1_RTIMER14 \
    *( ( volatile unsigned int * ) ( 0x428421B0UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER15 \
    *( ( volatile unsigned int * ) ( 0x428421B4UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER16 \
    *( ( volatile unsigned int * ) ( 0x428421B8UL ) )
#define bFM3_USB0_HRTIMER1_RTIMER17 \
    *( ( volatile unsigned int * ) ( 0x428421BCUL ) )
#define bFM3_USB0_HRTIMER2_RTIMER20 \
    *( ( volatile unsigned int * ) ( 0x42842200UL ) )
#define bFM3_USB0_HRTIMER2_RTIMER21 \
    *( ( volatile unsigned int * ) ( 0x42842204UL ) )
#define bFM3_USB0_HRTIMER2_RTIMER22 \
    *( ( volatile unsigned int * ) ( 0x42842208UL ) )
#define bFM3_USB0_HADR_ADDRESS0 \
    *( ( volatile unsigned int * ) ( 0x42842220UL ) )
#define bFM3_USB0_HADR_ADDRESS1 \
    *( ( volatile unsigned int * ) ( 0x42842224UL ) )
#define bFM3_USB0_HADR_ADDRESS2 \
    *( ( volatile unsigned int * ) ( 0x42842228UL ) )
#define bFM3_USB0_HADR_ADDRESS3 \
    *( ( volatile unsigned int * ) ( 0x4284222CUL ) )
#define bFM3_USB0_HADR_ADDRESS4 \
    *( ( volatile unsigned int * ) ( 0x42842230UL ) )
#define bFM3_USB0_HADR_ADDRESS5 \
    *( ( volatile unsigned int * ) ( 0x42842234UL ) )
#define bFM3_USB0_HADR_ADDRESS6 \
    *( ( volatile unsigned int * ) ( 0x42842238UL ) )
...
#define bFM3_USB0_HFRAME_FRAME0 \
    *( ( volatile unsigned int * ) ( 0x42842300UL ) )
#define bFM3_USB0_HFRAME_FRAME1 \
    *( ( volatile unsigned int * ) ( 0x42842304UL ) )
#define bFM3_USB0_HFRAME_FRAME2 \
    *( ( volatile unsigned int * ) ( 0x42842308UL ) )
#define bFM3_USB0_HFRAME_FRAME3 \
    *( ( volatile unsigned int * ) ( 0x4284230CUL ) )
#define bFM3_USB0_HFRAME_FRAME4 \
    *( ( volatile unsigned int * ) ( 0x42842310UL ) )
#define bFM3_USB0_HFRAME_FRAME5 \
    *( ( volatile unsigned int * ) ( 0x42842314UL ) )
#define bFM3_USB0_HFRAME_FRAME6 \
    *( ( volatile unsigned int * ) ( 0x42842318UL ) )
#define bFM3_USB0_HFRAME_FRAME7 \
    *( ( volatile unsigned int * ) ( 0x4284231CUL ) )
#define bFM3_USB0_HFRAME_FRAME8 \
    *( ( volatile unsigned int * ) ( 0x42842320UL ) )
#define bFM3_USB0_HFRAME_FRAME9 \
    *( ( volatile unsigned int * ) ( 0x42842324UL ) )
#define bFM3_USB0_HFRAME_FRAME10 \
    *( ( volatile unsigned int * ) ( 0x42842328UL ) )
#define bFM3_USB0_HFRAME0_FRAME00 \
    *( ( volatile unsigned int * ) ( 0x42842300UL ) )
#define bFM3_USB0_HFRAME0_FRAME01 \
    *( ( volatile unsigned int * ) ( 0x42842304UL ) )
#define bFM3_USB0_HFRAME0_FRAME02 \
    *( ( volatile unsigned int * ) ( 0x42842308UL ) )
#define bFM3_USB0_HFRAME0_FRAME03 \
    *( ( volatile unsigned int * ) ( 0x4284230CUL ) )
#define bFM3_USB0_HFRAME0_FRAME04 \
    *( ( volatile unsigned int * ) ( 0x42842310UL ) )
#define bFM3_USB0_HFRAME0_FRAME05 \
    *( ( volatile unsigned int * ) ( 0x42842314UL ) )
#define bFM3_USB0_HFRAME0_FRAME06 \
    *( ( volatile unsigned int * ) ( 0x42842318UL ) )
#define bFM3_USB0_HFRAME0_FRAME07 \
    *( ( volatile unsigned int * ) ( 0x4284231CUL ) )
#define bFM3_USB0_HFRAME1_FRAME10 \
    *( ( volatile unsigned int * ) ( 0x42842320UL ) )
#define bFM3_USB0_HFRAME1_FRAME11 \
    *( ( volatile unsigned int * ) ( 0x42842324UL ) )
#define bFM3_USB0_HFRAME1_FRAME12 \
    *( ( volatile unsigned int * ) ( 0x42842328UL ) )
#define bFM3_USB0_HFRAME1_FRAME13 \
    *( ( volatile unsigned int * ) ( 0x4284232CUL ) )
#define bFM3_USB0_HTOKEN_ENDPT0 \
    *( ( volatile unsigned int * ) ( 0x42842380UL ) )
#define bFM3_USB0_HTOKEN_ENDPT1 \
    *( ( volatile unsigned int * ) ( 0x42842384UL ) )
#define bFM3_USB0_HTOKEN_ENDPT2 \
    *( ( volatile unsigned int * ) ( 0x42842388UL ) )
#define bFM3_USB0_HTOKEN_ENDPT3 \
    *( ( volatile unsigned int * ) ( 0x4284238CUL ) )
#define bFM3_USB0_HTOKEN_TKNEN0 \
    *( ( volatile unsigned int * ) ( 0x42842390UL ) )
#define bFM3_USB0_HTOKEN_TKNEN1 \
    *( ( volatile unsigned int * ) ( 0x42842394UL ) )
#define bFM3_USB0_HTOKEN_TKNEN2 \
    *( ( volatile unsigned int * ) ( 0x42842398UL ) )
...
#define bFM3_USB0_UDCC_STALCLREN \
    *( ( volatile unsigned int * ) ( 0x4284240CUL ) )
...
#define bFM3_CAN0_IF1CMSK_DATAB \
    *( ( volatile unsigned int * ) ( 0x42C40240UL ) )
#define bFM3_CAN0_IF1CMSK_DATAA \
    *( ( volatile unsigned int * ) ( 0x42C40244UL ) )
#define bFM3_CAN0_IF1CMSK_TXREST \
    *( ( volatile unsigned int * ) ( 0x42C40248UL ) )
#define bFM3_CAN0_IF1CMSK_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C40248UL ) )
#define bFM3_CAN0_IF1CMSK_CIP *( ( volatile unsigned int * ) ( 0x42C4024CUL ) )
#define bFM3_CAN0_IF1CMSK_CONTROL \
    *( ( volatile unsigned int * ) ( 0x42C40250UL ) )
...
#define bFM3_CAN0_IF1ARB_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C4037CUL ) )
...
#define bFM3_CAN0_IF1ARB2_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C4037CUL ) )
...
#define bFM3_CAN0_IF1MCTR_TXRQST \
    *( ( volatile unsigned int * ) ( 0x42C403A0UL ) )
#define bFM3_CAN0_IF1MCTR_RMTEN \
    *( ( volatile unsigned int * ) ( 0x42C403A4UL ) )
...
#define bFM3_CAN0_IF1MCTR_UMASK \
    *( ( volatile unsigned int * ) ( 0x42C403B0UL ) )
#define bFM3_CAN0_IF1MCTR_INTPND \
    *( ( volatile unsigned int * ) ( 0x42C403B4UL ) )
#define bFM3_CAN0_IF1MCTR_MSGLST \
    *( ( volatile unsigned int * ) ( 0x42C403B8UL ) )
#define bFM3_CAN0_IF1MCTR_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C403BCUL ) )
#define bFM3_CAN0_IF2CREQ_BUSY *( ( volatile unsigned int * ) ( 0x42C4083CUL ) )
#define bFM3_CAN0_IF2CMSK_DATAB \
    *( ( volatile unsigned int * ) ( 0x42C40840UL ) )
#define bFM3_CAN0_IF2CMSK_DATAA \
    *( ( volatile unsigned int * ) ( 0x42C40844UL ) )
#define bFM3_CAN0_IF2CMSK_TXREST \
    *( ( volatile unsigned int * ) ( 0x42C40848UL ) )
#define bFM3_CAN0_IF2CMSK_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C40848UL ) )
#define bFM3_CAN0_IF2CMSK_CIP *( ( volatile unsigned int * ) ( 0x42C4084CUL ) )
#define bFM3_CAN0_IF2CMSK_CONTROL \
    *( ( volatile unsigned int * ) ( 0x42C40850UL ) )
...
#define bFM3_CAN0_IF2ARB_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C4097CUL ) )
...
#define bFM3_CAN0_IF2ARB2_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C4097CUL ) )
...
#define bFM3_CAN0_IF2MCTR_TXRQST \
    *( ( volatile unsigned int * ) ( 0x42C409A0UL ) )
#define bFM3_CAN0_IF2MCTR_RMTEN \
    *( ( volatile unsigned int * ) ( 0x42C409A4UL ) )
...
#define bFM3_CAN0_IF2MCTR_UMASK \
    *( ( volatile unsigned int * ) ( 0x42C409B0UL ) )
#define bFM3_CAN0_IF2MCTR_INTPND \
    *( ( volatile unsigned int * ) ( 0x42C409B4UL ) )
#define bFM3_CAN0_IF2MCTR_MSGLST \
    *( ( volatile unsigned int * ) ( 0x42C409B8UL ) )
#define bFM3_CAN0_IF2MCTR_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C409BCUL ) )
#define bFM3_CAN0_TREQR_TXRQST1 \
    *( ( volatile unsigned int * ) ( 0x42C41000UL ) )
#define bFM3_CAN0_TREQR_TXRQST2 \
    *( ( volatile unsigned int * ) ( 0x42C41004UL ) )
#define bFM3_CAN0_TREQR_TXRQST3 \
    *( ( volatile unsigned int * ) ( 0x42C41008UL ) )
#define bFM3_CAN0_TREQR_TXRQST4 \
    *( ( volatile unsigned int * ) ( 0x42C4100CUL ) )
#define bFM3_CAN0_TREQR_TXRQST5 \
    *( ( volatile unsigned int * ) ( 0x42C41010UL ) )
#define bFM3_CAN0_TREQR_TXRQST6 \
    *( ( volatile unsigned int * ) ( 0x42C41014UL ) )
#define bFM3_CAN0_TREQR_TXRQST7 \
    *( ( volatile unsigned int * ) ( 0x42C41018UL ) )
#define bFM3_CAN0_TREQR_TXRQST8 \
    *( ( volatile unsigned int * ) ( 0x42C4101CUL ) )
#define bFM3_CAN0_TREQR_TXRQST9 \
    *( ( volatile unsigned int * ) ( 0x42C41020UL ) )
#define bFM3_CAN0_TREQR_TXRQST10 \
    *( ( volatile unsigned int * ) ( 0x42C41024UL ) )
#define bFM3_CAN0_TREQR_TXRQST11 \
    *( ( volatile unsigned int * ) ( 0x42C41028UL ) )
#define bFM3_CAN0_TREQR_TXRQST12 \
    *( ( volatile unsigned int * ) ( 0x42C4102CUL ) )
#define bFM3_CAN0_TREQR_TXRQST13 \
    *( ( volatile unsigned int * ) ( 0x42C41030UL ) )
#define bFM3_CAN0_TREQR_TXRQST14 \
    *( ( volatile unsigned int * ) ( 0x42C41034UL ) )
#define bFM3_CAN0_TREQR_TXRQST15 \
    *( ( volatile unsigned int * ) ( 0x42C41038UL ) )
#define bFM3_CAN0_TREQR_TXRQST16 \
    *( ( volatile unsigned int * ) ( 0x42C4103CUL ) )
#define bFM3_CAN0_TREQR_TXRQST17 \
    *( ( volatile unsigned int * ) ( 0x42C41040UL ) )
#define bFM3_CAN0_TREQR_TXRQST18 \
    *( ( volatile unsigned int * ) ( 0x42C41044UL ) )
#define bFM3_CAN0_TREQR_TXRQST19 \
    *( ( volatile unsigned int * ) ( 0x42C41048UL ) )
#define bFM3_CAN0_TREQR_TXRQST20 \
    *( ( volatile unsigned int * ) ( 0x42C4104CUL ) )
#define bFM3_CAN0_TREQR_TXRQST21 \
    *( ( volatile unsigned int * ) ( 0x42C41050UL ) )
#define bFM3_CAN0_TREQR_TXRQST22 \
    *( ( volatile unsigned int * ) ( 0x42C41054UL ) )
#define bFM3_CAN0_TREQR_TXRQST23 \
    *( ( volatile unsigned int * ) ( 0x42C41058UL ) )
#define bFM3_CAN0_TREQR_TXRQST24 \
    *( ( volatile unsigned int * ) ( 0x42C4105CUL ) )
#define bFM3_CAN0_TREQR_TXRQST25 \
    *( ( volatile unsigned int * ) ( 0x42C41060UL ) )
#define bFM3_CAN0_TREQR_TXRQST26 \
    *( ( volatile unsigned int * ) ( 0x42C41064UL ) )
#define bFM3_CAN0_TREQR_TXRQST27 \
    *( ( volatile unsigned int * ) ( 0x42C41068UL ) )
#define bFM3_CAN0_TREQR_TXRQST28 \
    *( ( volatile unsigned int * ) ( 0x42C4106CUL ) )
#define bFM3_CAN0_TREQR_TXRQST29 \
    *( ( volatile unsigned int * ) ( 0x42C41070UL ) )
#define bFM3_CAN0_TREQR_TXRQST30 \
    *( ( volatile unsigned int * ) ( 0x42C41074UL ) )
#define bFM3_CAN0_TREQR_TXRQST31 \
    *( ( volatile unsigned int * ) ( 0x42C41078UL ) )
#define bFM3_CAN0_TREQR_TXRQST32 \
    *( ( volatile unsigned int * ) ( 0x42C4107CUL ) )
#define bFM3_CAN0_TREQR1_TXRQST1 \
    *( ( volatile unsigned int * ) ( 0x42C41000UL ) )
#define bFM3_CAN0_TREQR1_TXRQST2 \
    *( ( volatile unsigned int * ) ( 0x42C41004UL ) )
#define bFM3_CAN0_TREQR1_TXRQST3 \
    *( ( volatile unsigned int * ) ( 0x42C41008UL ) )
#define bFM3_CAN0_TREQR1_TXRQST4 \
    *( ( volatile unsigned int * ) ( 0x42C4100CUL ) )
#define bFM3_CAN0_TREQR1_TXRQST5 \
    *( ( volatile unsigned int * ) ( 0x42C41010UL ) )
#define bFM3_CAN0_TREQR1_TXRQST6 \
    *( ( volatile unsigned int * ) ( 0x42C41014UL ) )
#define bFM3_CAN0_TREQR1_TXRQST7 \
    *( ( volatile unsigned int * ) ( 0x42C41018UL ) )
#define bFM3_CAN0_TREQR1_TXRQST8 \
    *( ( volatile unsigned int * ) ( 0x42C4101CUL ) )
#define bFM3_CAN0_TREQR1_TXRQST9 \
    *( ( volatile unsigned int * ) ( 0x42C41020UL ) )
#define bFM3_CAN0_TREQR1_TXRQST10 \
    *( ( volatile unsigned int * ) ( 0x42C41024UL ) )
#define bFM3_CAN0_TREQR1_TXRQST11 \
    *( ( volatile unsigned int * ) ( 0x42C41028UL ) )
#define bFM3_CAN0_TREQR1_TXRQST12 \
    *( ( volatile unsigned int * ) ( 0x42C4102CUL ) )
#define bFM3_CAN0_TREQR1_TXRQST13 \
    *( ( volatile unsigned int * ) ( 0x42C41030UL ) )
#define bFM3_CAN0_TREQR1_TXRQST14 \
    *( ( volatile unsigned int * ) ( 0x42C41034UL ) )
#define bFM3_CAN0_TREQR1_TXRQST15 \
    *( ( volatile unsigned int * ) ( 0x42C41038UL ) )
#define bFM3_CAN0_TREQR1_TXRQST16 \
    *( ( volatile unsigned int * ) ( 0x42C4103CUL ) )
#define bFM3_CAN0_TREQR2_TXRQST17 \
    *( ( volatile unsigned int * ) ( 0x42C41040UL ) )
#define bFM3_CAN0_TREQR2_TXRQST18 \
    *( ( volatile unsigned int * ) ( 0x42C41044UL ) )
#define bFM3_CAN0_TREQR2_TXRQST19 \
    *( ( volatile unsigned int * ) ( 0x42C41048UL ) )
#define bFM3_CAN0_TREQR2_TXRQST20 \
    *( ( volatile unsigned int * ) ( 0x42C4104CUL ) )
#define bFM3_CAN0_TREQR2_TXRQST21 \
    *( ( volatile unsigned int * ) ( 0x42C41050UL ) )
#define bFM3_CAN0_TREQR2_TXRQST22 \
    *( ( volatile unsigned int * ) ( 0x42C41054UL ) )
#define bFM3_CAN0_TREQR2_TXRQST23 \
    *( ( volatile unsigned int * ) ( 0x42C41058UL ) )
#define bFM3_CAN0_TREQR2_TXRQST24 \
    *( ( volatile unsigned int * ) ( 0x42C4105CUL ) )
#define bFM3_CAN0_TREQR2_TXRQST25 \
    *( ( volatile unsigned int * ) ( 0x42C41060UL ) )
#define bFM3_CAN0_TREQR2_TXRQST26 \
    *( ( volatile unsigned int * ) ( 0x42C41064UL ) )
#define bFM3_CAN0_TREQR2_TXRQST27 \
    *( ( volatile unsigned int * ) ( 0x42C41068UL ) )
#define bFM3_CAN0_TREQR2_TXRQST28 \
    *( ( volatile unsigned int * ) ( 0x42C4106CUL ) )
#define bFM3_CAN0_TREQR2_TXRQST29 \
    *( ( volatile unsigned int * ) ( 0x42C41070UL ) )
#define bFM3_CAN0_TREQR2_TXRQST30 \
    *( ( volatile unsigned int * ) ( 0x42C41074UL ) )
#define bFM3_CAN0_TREQR2_TXRQST31 \
    *( ( volatile unsigned int * ) ( 0x42C41078UL ) )
#define bFM3_CAN0_TREQR2_TXRQST32 \
    *( ( volatile unsigned int * ) ( 0x42C4107CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT1 \
    *( ( volatile unsigned int * ) ( 0x42C41200UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT2 \
    *( ( volatile unsigned int * ) ( 0x42C41204UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT3 \
    *( ( volatile unsigned int * ) ( 0x42C41208UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT4 \
    *( ( volatile unsigned int * ) ( 0x42C4120CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT5 \
    *( ( volatile unsigned int * ) ( 0x42C41210UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT6 \
    *( ( volatile unsigned int * ) ( 0x42C41214UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT7 \
    *( ( volatile unsigned int * ) ( 0x42C41218UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT8 \
    *( ( volatile unsigned int * ) ( 0x42C4121CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT9 \
    *( ( volatile unsigned int * ) ( 0x42C41220UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT10 \
    *( ( volatile unsigned int * ) ( 0x42C41224UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT11 \
    *( ( volatile unsigned int * ) ( 0x42C41228UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT12 \
    *( ( volatile unsigned int * ) ( 0x42C4122CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT13 \
    *( ( volatile unsigned int * ) ( 0x42C41230UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT14 \
    *( ( volatile unsigned int * ) ( 0x42C41234UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT15 \
    *( ( volatile unsigned int * ) ( 0x42C41238UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT16 \
    *( ( volatile unsigned int * ) ( 0x42C4123CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT17 \
    *( ( volatile unsigned int * ) ( 0x42C41240UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT18 \
    *( ( volatile unsigned int * ) ( 0x42C41244UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT19 \
    *( ( volatile unsigned int * ) ( 0x42C41248UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT20 \
    *( ( volatile unsigned int * ) ( 0x42C4124CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT21 \
    *( ( volatile unsigned int * ) ( 0x42C41250UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT22 \
    *( ( volatile unsigned int * ) ( 0x42C41254UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT23 \
    *( ( volatile unsigned int * ) ( 0x42C41258UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT24 \
    *( ( volatile unsigned int * ) ( 0x42C4125CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT25 \
    *( ( volatile unsigned int * ) ( 0x42C41260UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT26 \
    *( ( volatile unsigned int * ) ( 0x42C41264UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT27 \
    *( ( volatile unsigned int * ) ( 0x42C41268UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT28 \
    *( ( volatile unsigned int * ) ( 0x42C4126CUL ) )
#define bFM3_CAN0_NEWDT_NEWDAT29 \
    *( ( volatile unsigned int * ) ( 0x42C41270UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT30 \
    *( ( volatile unsigned int * ) ( 0x42C41274UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT31 \
    *( ( volatile unsigned int * ) ( 0x42C41278UL ) )
#define bFM3_CAN0_NEWDT_NEWDAT32 \
    *( ( volatile unsigned int * ) ( 0x42C4127CUL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT1 \
    *( ( volatile unsigned int * ) ( 0x42C41200UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT2 \
    *( ( volatile unsigned int * ) ( 0x42C41204UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT3 \
    *( ( volatile unsigned int * ) ( 0x42C41208UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT4 \
    *( ( volatile unsigned int * ) ( 0x42C4120CUL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT5 \
    *( ( volatile unsigned int * ) ( 0x42C41210UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT6 \
    *( ( volatile unsigned int * ) ( 0x42C41214UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT7 \
    *( ( volatile unsigned int * ) ( 0x42C41218UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT8 \
    *( ( volatile unsigned int * ) ( 0x42C4121CUL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT9 \
    *( ( volatile unsigned int * ) ( 0x42C41220UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT10 \
    *( ( volatile unsigned int * ) ( 0x42C41224UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT11 \
    *( ( volatile unsigned int * ) ( 0x42C41228UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT12 \
    *( ( volatile unsigned int * ) ( 0x42C4122CUL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT13 \
    *( ( volatile unsigned int * ) ( 0x42C41230UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT14 \
    *( ( volatile unsigned int * ) ( 0x42C41234UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT15 \
    *( ( volatile unsigned int * ) ( 0x42C41238UL ) )
#define bFM3_CAN0_NEWDT1_NEWDAT16 \
    *( ( volatile unsigned int * ) ( 0x42C4123CUL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT17 \
    *( ( volatile unsigned int * ) ( 0x42C41240UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT18 \
    *( ( volatile unsigned int * ) ( 0x42C41244UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT19 \
    *( ( volatile unsigned int * ) ( 0x42C41248UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT20 \
    *( ( volatile unsigned int * ) ( 0x42C4124CUL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT21 \
    *( ( volatile unsigned int * ) ( 0x42C41250UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT22 \
    *( ( volatile unsigned int * ) ( 0x42C41254UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT23 \
    *( ( volatile unsigned int * ) ( 0x42C41258UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT24 \
    *( ( volatile unsigned int * ) ( 0x42C4125CUL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT25 \
    *( ( volatile unsigned int * ) ( 0x42C41260UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT26 \
    *( ( volatile unsigned int * ) ( 0x42C41264UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT27 \
    *( ( volatile unsigned int * ) ( 0x42C41268UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT28 \
    *( ( volatile unsigned int * ) ( 0x42C4126CUL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT29 \
    *( ( volatile unsigned int * ) ( 0x42C41270UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT30 \
    *( ( volatile unsigned int * ) ( 0x42C41274UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT31 \
    *( ( volatile unsigned int * ) ( 0x42C41278UL ) )
#define bFM3_CAN0_NEWDT2_NEWDAT32 \
    *( ( volatile unsigned int * ) ( 0x42C4127CUL ) )
#define bFM3_CAN0_INTPND_INTPND1 \
    *( ( volatile unsigned int * ) ( 0x42C41400UL ) )
#define bFM3_CAN0_INTPND_INTPND2 \
    *( ( volatile unsigned int * ) ( 0x42C41404UL ) )
#define bFM3_CAN0_INTPND_INTPND3 \
    *( ( volatile unsigned int * ) ( 0x42C41408UL ) )
#define bFM3_CAN0_INTPND_INTPND4 \
    *( ( volatile unsigned int * ) ( 0x42C4140CUL ) )
#define bFM3_CAN0_INTPND_INTPND5 \
    *( ( volatile unsigned int * ) ( 0x42C41410UL ) )
#define bFM3_CAN0_INTPND_INTPND6 \
    *( ( volatile unsigned int * ) ( 0x42C41414UL ) )
#define bFM3_CAN0_INTPND_INTPND7 \
    *( ( volatile unsigned int * ) ( 0x42C41418UL ) )
#define bFM3_CAN0_INTPND_INTPND8 \
    *( ( volatile unsigned int * ) ( 0x42C4141CUL ) )
#define bFM3_CAN0_INTPND_INTPND9 \
    *( ( volatile unsigned int * ) ( 0x42C41420UL ) )
#define bFM3_CAN0_INTPND_INTPND10 \
    *( ( volatile unsigned int * ) ( 0x42C41424UL ) )
#define bFM3_CAN0_INTPND_INTPND11 \
    *( ( volatile unsigned int * ) ( 0x42C41428UL ) )
#define bFM3_CAN0_INTPND_INTPND12 \
    *( ( volatile unsigned int * ) ( 0x42C4142CUL ) )
#define bFM3_CAN0_INTPND_INTPND13 \
    *( ( volatile unsigned int * ) ( 0x42C41430UL ) )
#define bFM3_CAN0_INTPND_INTPND14 \
    *( ( volatile unsigned int * ) ( 0x42C41434UL ) )
#define bFM3_CAN0_INTPND_INTPND15 \
    *( ( volatile unsigned int * ) ( 0x42C41438UL ) )
#define bFM3_CAN0_INTPND_INTPND16 \
    *( ( volatile unsigned int * ) ( 0x42C4143CUL ) )
#define bFM3_CAN0_INTPND_INTPND17 \
    *( ( volatile unsigned int * ) ( 0x42C41440UL ) )
#define bFM3_CAN0_INTPND_INTPND18 \
    *( ( volatile unsigned int * ) ( 0x42C41444UL ) )
#define bFM3_CAN0_INTPND_INTPND19 \
    *( ( volatile unsigned int * ) ( 0x42C41448UL ) )
#define bFM3_CAN0_INTPND_INTPND20 \
    *( ( volatile unsigned int * ) ( 0x42C4144CUL ) )
#define bFM3_CAN0_INTPND_INTPND21 \
    *( ( volatile unsigned int * ) ( 0x42C41450UL ) )
#define bFM3_CAN0_INTPND_INTPND22 \
    *( ( volatile unsigned int * ) ( 0x42C41454UL ) )
#define bFM3_CAN0_INTPND_INTPND23 \
    *( ( volatile unsigned int * ) ( 0x42C41458UL ) )
#define bFM3_CAN0_INTPND_INTPND24 \
    *( ( volatile unsigned int * ) ( 0x42C4145CUL ) )
#define bFM3_CAN0_INTPND_INTPND25 \
    *( ( volatile unsigned int * ) ( 0x42C41460UL ) )
#define bFM3_CAN0_INTPND_INTPND26 \
    *( ( volatile unsigned int * ) ( 0x42C41464UL ) )
#define bFM3_CAN0_INTPND_INTPND27 \
    *( ( volatile unsigned int * ) ( 0x42C41468UL ) )
#define bFM3_CAN0_INTPND_INTPND28 \
    *( ( volatile unsigned int * ) ( 0x42C4146CUL ) )
#define bFM3_CAN0_INTPND_INTPND29 \
    *( ( volatile unsigned int * ) ( 0x42C41470UL ) )
#define bFM3_CAN0_INTPND_INTPND30 \
    *( ( volatile unsigned int * ) ( 0x42C41474UL ) )
#define bFM3_CAN0_INTPND_INTPND31 \
    *( ( volatile unsigned int * ) ( 0x42C41478UL ) )
#define bFM3_CAN0_INTPND_INTPND32 \
    *( ( volatile unsigned int * ) ( 0x42C4147CUL ) )
#define bFM3_CAN0_INTPND1_INTPND1 \
    *( ( volatile unsigned int * ) ( 0x42C41400UL ) )
#define bFM3_CAN0_INTPND1_INTPND2 \
    *( ( volatile unsigned int * ) ( 0x42C41404UL ) )
#define bFM3_CAN0_INTPND1_INTPND3 \
    *( ( volatile unsigned int * ) ( 0x42C41408UL ) )
#define bFM3_CAN0_INTPND1_INTPND4 \
    *( ( volatile unsigned int * ) ( 0x42C4140CUL ) )
#define bFM3_CAN0_INTPND1_INTPND5 \
    *( ( volatile unsigned int * ) ( 0x42C41410UL ) )
#define bFM3_CAN0_INTPND1_INTPND6 \
    *( ( volatile unsigned int * ) ( 0x42C41414UL ) )
#define bFM3_CAN0_INTPND1_INTPND7 \
    *( ( volatile unsigned int * ) ( 0x42C41418UL ) )
#define bFM3_CAN0_INTPND1_INTPND8 \
    *( ( volatile unsigned int * ) ( 0x42C4141CUL ) )
#define bFM3_CAN0_INTPND1_INTPND9 \
    *( ( volatile unsigned int * ) ( 0x42C41420UL ) )
#define bFM3_CAN0_INTPND1_INTPND10 \
    *( ( volatile unsigned int * ) ( 0x42C41424UL ) )
#define bFM3_CAN0_INTPND1_INTPND11 \
    *( ( volatile unsigned int * ) ( 0x42C41428UL ) )
#define bFM3_CAN0_INTPND1_INTPND12 \
    *( ( volatile unsigned int * ) ( 0x42C4142CUL ) )
#define bFM3_CAN0_INTPND1_INTPND13 \
    *( ( volatile unsigned int * ) ( 0x42C41430UL ) )
#define bFM3_CAN0_INTPND1_INTPND14 \
    *( ( volatile unsigned int * ) ( 0x42C41434UL ) )
#define bFM3_CAN0_INTPND1_INTPND15 \
    *( ( volatile unsigned int * ) ( 0x42C41438UL ) )
#define bFM3_CAN0_INTPND1_INTPND16 \
    *( ( volatile unsigned int * ) ( 0x42C4143CUL ) )
#define bFM3_CAN0_INTPND2_INTPND17 \
    *( ( volatile unsigned int * ) ( 0x42C41440UL ) )
#define bFM3_CAN0_INTPND2_INTPND18 \
    *( ( volatile unsigned int * ) ( 0x42C41444UL ) )
#define bFM3_CAN0_INTPND2_INTPND19 \
    *( ( volatile unsigned int * ) ( 0x42C41448UL ) )
#define bFM3_CAN0_INTPND2_INTPND20 \
    *( ( volatile unsigned int * ) ( 0x42C4144CUL ) )
#define bFM3_CAN0_INTPND2_INTPND21 \
    *( ( volatile unsigned int * ) ( 0x42C41450UL ) )
#define bFM3_CAN0_INTPND2_INTPND22 \
    *( ( volatile unsigned int * ) ( 0x42C41454UL ) )
#define bFM3_CAN0_INTPND2_INTPND23 \
    *( ( volatile unsigned int * ) ( 0x42C41458UL ) )
#define bFM3_CAN0_INTPND2_INTPND24 \
    *( ( volatile unsigned int * ) ( 0x42C4145CUL ) )
#define bFM3_CAN0_INTPND2_INTPND25 \
    *( ( volatile unsigned int * ) ( 0x42C41460UL ) )
#define bFM3_CAN0_INTPND2_INTPND26 \
    *( ( volatile unsigned int * ) ( 0x42C41464UL ) )
#define bFM3_CAN0_INTPND2_INTPND27 \
    *( ( volatile unsigned int * ) ( 0x42C41468UL ) )
#define bFM3_CAN0_INTPND2_INTPND28 \
    *( ( volatile unsigned int * ) ( 0x42C4146CUL ) )
#define bFM3_CAN0_INTPND2_INTPND29 \
    *( ( volatile unsigned int * ) ( 0x42C41470UL ) )
#define bFM3_CAN0_INTPND2_INTPND30 \
    *( ( volatile unsigned int * ) ( 0x42C41474UL ) )
#define bFM3_CAN0_INTPND2_INTPND31 \
    *( ( volatile unsigned int * ) ( 0x42C41478UL ) )
#define bFM3_CAN0_INTPND2_INTPND32 \
    *( ( volatile unsigned int * ) ( 0x42C4147CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL1 \
    *( ( volatile unsigned int * ) ( 0x42C41600UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL2 \
    *( ( volatile unsigned int * ) ( 0x42C41604UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL3 \
    *( ( volatile unsigned int * ) ( 0x42C41608UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL4 \
    *( ( volatile unsigned int * ) ( 0x42C4160CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL5 \
    *( ( volatile unsigned int * ) ( 0x42C41610UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL6 \
    *( ( volatile unsigned int * ) ( 0x42C41614UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL7 \
    *( ( volatile unsigned int * ) ( 0x42C41618UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL8 \
    *( ( volatile unsigned int * ) ( 0x42C4161CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL9 \
    *( ( volatile unsigned int * ) ( 0x42C41620UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL10 \
    *( ( volatile unsigned int * ) ( 0x42C41624UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL11 \
    *( ( volatile unsigned int * ) ( 0x42C41628UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL12 \
    *( ( volatile unsigned int * ) ( 0x42C4162CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL13 \
    *( ( volatile unsigned int * ) ( 0x42C41630UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL14 \
    *( ( volatile unsigned int * ) ( 0x42C41634UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL15 \
    *( ( volatile unsigned int * ) ( 0x42C41638UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL16 \
    *( ( volatile unsigned int * ) ( 0x42C4163CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL17 \
    *( ( volatile unsigned int * ) ( 0x42C41640UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL18 \
    *( ( volatile unsigned int * ) ( 0x42C41644UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL19 \
    *( ( volatile unsigned int * ) ( 0x42C41648UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL20 \
    *( ( volatile unsigned int * ) ( 0x42C4164CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL21 \
    *( ( volatile unsigned int * ) ( 0x42C41650UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL22 \
    *( ( volatile unsigned int * ) ( 0x42C41654UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL23 \
    *( ( volatile unsigned int * ) ( 0x42C41658UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL24 \
    *( ( volatile unsigned int * ) ( 0x42C4165CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL25 \
    *( ( volatile unsigned int * ) ( 0x42C41660UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL26 \
    *( ( volatile unsigned int * ) ( 0x42C41664UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL27 \
    *( ( volatile unsigned int * ) ( 0x42C41668UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL28 \
    *( ( volatile unsigned int * ) ( 0x42C4166CUL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL29 \
    *( ( volatile unsigned int * ) ( 0x42C41670UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL30 \
    *( ( volatile unsigned int * ) ( 0x42C41674UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL31 \
    *( ( volatile unsigned int * ) ( 0x42C41678UL ) )
#define bFM3_CAN0_MSGVAL_MSGVAL32 \
    *( ( volatile unsigned int * ) ( 0x42C4167CUL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL1 \
    *( ( volatile unsigned int * ) ( 0x42C41600UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL2 \
    *( ( volatile unsigned int * ) ( 0x42C41604UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL3 \
    *( ( volatile unsigned int * ) ( 0x42C41608UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL4 \
    *( ( volatile unsigned int * ) ( 0x42C4160CUL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL5 \
    *( ( volatile unsigned int * ) ( 0x42C41610UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL6 \
    *( ( volatile unsigned int * ) ( 0x42C41614UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL7 \
    *( ( volatile unsigned int * ) ( 0x42C41618UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL8 \
    *( ( volatile unsigned int * ) ( 0x42C4161CUL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL9 \
    *( ( volatile unsigned int * ) ( 0x42C41620UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL10 \
    *( ( volatile unsigned int * ) ( 0x42C41624UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL11 \
    *( ( volatile unsigned int * ) ( 0x42C41628UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL12 \
    *( ( volatile unsigned int * ) ( 0x42C4162CUL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL13 \
    *( ( volatile unsigned int * ) ( 0x42C41630UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL14 \
    *( ( volatile unsigned int * ) ( 0x42C41634UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL15 \
    *( ( volatile unsigned int * ) ( 0x42C41638UL ) )
#define bFM3_CAN0_MSGVAL1_MSGVAL16 \
    *( ( volatile unsigned int * ) ( 0x42C4163CUL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL17 \
    *( ( volatile unsigned int * ) ( 0x42C41640UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL18 \
    *( ( volatile unsigned int * ) ( 0x42C41644UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL19 \
    *( ( volatile unsigned int * ) ( 0x42C41648UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL20 \
    *( ( volatile unsigned int * ) ( 0x42C4164CUL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL21 \
    *( ( volatile unsigned int * ) ( 0x42C41650UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL22 \
    *( ( volatile unsigned int * ) ( 0x42C41654UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL23 \
    *( ( volatile unsigned int * ) ( 0x42C41658UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL24 \
    *( ( volatile unsigned int * ) ( 0x42C4165CUL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL25 \
    *( ( volatile unsigned int * ) ( 0x42C41660UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL26 \
    *( ( volatile unsigned int * ) ( 0x42C41664UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL27 \
    *( ( volatile unsigned int * ) ( 0x42C41668UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL28 \
    *( ( volatile unsigned int * ) ( 0x42C4166CUL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL29 \
    *( ( volatile unsigned int * ) ( 0x42C41670UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL30 \
    *( ( volatile unsigned int * ) ( 0x42C41674UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL31 \
    *( ( volatile unsigned int * ) ( 0x42C41678UL ) )
#define bFM3_CAN0_MSGVAL2_MSGVAL32 \
    *( ( volatile unsigned int * ) ( 0x42C4167CUL ) )
...
#define bFM3_CAN1_IF1CMSK_DATAB \
    *( ( volatile unsigned int * ) ( 0x42C60240UL ) )
#define bFM3_CAN1_IF1CMSK_DATAA \
    *( ( volatile unsigned int * ) ( 0x42C60244UL ) )
#define bFM3_CAN1_IF1CMSK_TXREST \
    *( ( volatile unsigned int * ) ( 0x42C60248UL ) )
#define bFM3_CAN1_IF1CMSK_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C60248UL ) )
#define bFM3_CAN1_IF1CMSK_CIP *( ( volatile unsigned int * ) ( 0x42C6024CUL ) )
#define bFM3_CAN1_IF1CMSK_CONTROL \
    *( ( volatile unsigned int * ) ( 0x42C60250UL ) )
...
#define bFM3_CAN1_IF1ARB_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C6037CUL ) )
...
#define bFM3_CAN1_IF1ARB2_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C6037CUL ) )
...
#define bFM3_CAN1_IF1MCTR_TXRQST \
    *( ( volatile unsigned int * ) ( 0x42C603A0UL ) )
#define bFM3_CAN1_IF1MCTR_RMTEN \
    *( ( volatile unsigned int * ) ( 0x42C603A4UL ) )
...
#define bFM3_CAN1_IF1MCTR_UMASK \
    *( ( volatile unsigned int * ) ( 0x42C603B0UL ) )
#define bFM3_CAN1_IF1MCTR_INTPND \
    *( ( volatile unsigned int * ) ( 0x42C603B4UL ) )
#define bFM3_CAN1_IF1MCTR_MSGLST \
    *( ( volatile unsigned int * ) ( 0x42C603B8UL ) )
#define bFM3_CAN1_IF1MCTR_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C603BCUL ) )
#define bFM3_CAN1_IF2CREQ_BUSY *( ( volatile unsigned int * ) ( 0x42C6083CUL ) )
#define bFM3_CAN1_IF2CMSK_DATAB \
    *( ( volatile unsigned int * ) ( 0x42C60840UL ) )
#define bFM3_CAN1_IF2CMSK_DATAA \
    *( ( volatile unsigned int * ) ( 0x42C60844UL ) )
#define bFM3_CAN1_IF2CMSK_TXREST \
    *( ( volatile unsigned int * ) ( 0x42C60848UL ) )
#define bFM3_CAN1_IF2CMSK_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C60848UL ) )
#define bFM3_CAN1_IF2CMSK_CIP *( ( volatile unsigned int * ) ( 0x42C6084CUL ) )
#define bFM3_CAN1_IF2CMSK_CONTROL \
    *( ( volatile unsigned int * ) ( 0x42C60850UL ) )
...
#define bFM3_CAN1_IF2ARB_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C6097CUL ) )
...
#define bFM3_CAN1_IF2ARB2_MSGVAL \
    *( ( volatile unsigned int * ) ( 0x42C6097CUL ) )
...
#define bFM3_CAN1_IF2MCTR_TXRQST \
    *( ( volatile unsigned int * ) ( 0x42C609A0UL ) )
#define bFM3_CAN1_IF2MCTR_RMTEN \
    *( ( volatile unsigned int * ) ( 0x42C609A4UL ) )
...
#define bFM3_CAN1_IF2MCTR_UMASK \
    *( ( volatile unsigned int * ) ( 0x42C609B0UL ) )
#define bFM3_CAN1_IF2MCTR_INTPND \
    *( ( volatile unsigned int * ) ( 0x42C609B4UL ) )
#define bFM3_CAN1_IF2MCTR_MSGLST \
    *( ( volatile unsigned int * ) ( 0x42C609B8UL ) )
#define bFM3_CAN1_IF2MCTR_NEWDAT \
    *( ( volatile unsigned int * ) ( 0x42C609BCUL ) )
#define bFM3_CAN1_TREQR_TXRQST1 \
    *( ( volatile unsigned int * ) ( 0x42C61000UL ) )
#define bFM3_CAN1_TREQR_TXRQST2 \
    *( ( volatile unsigned int * ) ( 0x42C61004UL ) )
#define bFM3_CAN1_TREQR_TXRQST3 \
    *( ( volatile unsigned int * ) ( 0x42C61008UL ) )
#define bFM3_CAN1_TREQR_TXRQST4 \
    *( ( volatile unsigned int * ) ( 0x42C6100CUL ) )
#define bFM3_CAN1_TREQR_TXRQST5 \
    *( ( volatile unsigned int * ) ( 0x42C61010UL ) )
#define bFM3_CAN1_TREQR_TXRQST6 \
    *( ( volatile unsigned int * ) ( 0x42C61014UL ) )
#define bFM3_CAN1_TREQR_TXRQST7 \
    *( ( volatile unsigned int * ) ( 0x42C61018UL ) )
#define bFM3_CAN1_TREQR_TXRQST8 \
    *( ( volatile unsigned int * ) ( 0x42C6101CUL ) )
#define bFM3_CAN1_TREQR_TXRQST9 \
    *( ( volatile unsigned int * ) ( 0x42C61020UL ) )
#define bFM3_CAN1_TREQR_TXRQST10 \
    *( ( volatile unsigned int * ) ( 0x42C61024UL ) )
#define bFM3_CAN1_TREQR_TXRQST11 \
    *( ( volatile unsigned int * ) ( 0x42C61028UL ) )
#define bFM3_CAN1_TREQR_TXRQST12 \
    *( ( volatile unsigned int * ) ( 0x42C6102CUL ) )
#define bFM3_CAN1_TREQR_TXRQST13 \
    *( ( volatile unsigned int * ) ( 0x42C61030UL ) )
#define bFM3_CAN1_TREQR_TXRQST14 \
    *( ( volatile unsigned int * ) ( 0x42C61034UL ) )
#define bFM3_CAN1_TREQR_TXRQST15 \
    *( ( volatile unsigned int * ) ( 0x42C61038UL ) )
#define bFM3_CAN1_TREQR_TXRQST16 \
    *( ( volatile unsigned int * ) ( 0x42C6103CUL ) )
#define bFM3_CAN1_TREQR_TXRQST17 \
    *( ( volatile unsigned int * ) ( 0x42C61040UL ) )
#define bFM3_CAN1_TREQR_TXRQST18 \
    *( ( volatile unsigned int * ) ( 0x42C61044UL ) )
#define bFM3_CAN1_TREQR_TXRQST19 \
    *( ( volatile unsigned int * ) ( 0x42C61048UL ) )
#define bFM3_CAN1_TREQR_TXRQST20 \
    *( ( volatile unsigned int * ) ( 0x42C6104CUL ) )
#define bFM3_CAN1_TREQR_TXRQST21 \
    *( ( volatile unsigned int * ) ( 0x42C61050UL ) )
#define bFM3_CAN1_TREQR_TXRQST22 \
    *( ( volatile unsigned int * ) ( 0x42C61054UL ) )
#define bFM3_CAN1_TREQR_TXRQST23 \
    *( ( volatile unsigned int * ) ( 0x42C61058UL ) )
#define bFM3_CAN1_TREQR_TXRQST24 \
    *( ( volatile unsigned int * ) ( 0x42C6105CUL ) )
#define bFM3_CAN1_TREQR_TXRQST25 \
    *( ( volatile unsigned int * ) ( 0x42C61060UL ) )
#define bFM3_CAN1_TREQR_TXRQST26 \
    *( ( volatile unsigned int * ) ( 0x42C61064UL ) )
#define bFM3_CAN1_TREQR_TXRQST27 \
    *( ( volatile unsigned int * ) ( 0x42C61068UL ) )
#define bFM3_CAN1_TREQR_TXRQST28 \
    *( ( volatile unsigned int * ) ( 0x42C6106CUL ) )
#define bFM3_CAN1_TREQR_TXRQST29 \
    *( ( volatile unsigned int * ) ( 0x42C61070UL ) )
#define bFM3_CAN1_TREQR_TXRQST30 \
    *( ( volatile unsigned int * ) ( 0x42C61074UL ) )
#define bFM3_CAN1_TREQR_TXRQST31 \
    *( ( volatile unsigned int * ) ( 0x42C61078UL ) )
#define bFM3_CAN1_TREQR_TXRQST32 \
    *( ( volatile unsigned int * ) ( 0x42C6107CUL ) )
#define bFM3_CAN1_TREQR1_TXRQST1 \
    *( ( volatile unsigned int * ) ( 0x42C61000UL ) )
#define bFM3_CAN1_TREQR1_TXRQST2 \
    *( ( volatile unsigned int * ) ( 0x42C61004UL ) )
#define bFM3_CAN1_TREQR1_TXRQST3 \
    *( ( volatile unsigned int * ) ( 0x42C61008UL ) )
#define bFM3_CAN1_TREQR1_TXRQST4 \
    *( ( volatile unsigned int * ) ( 0x42C6100CUL ) )
#define bFM3_CAN1_TREQR1_TXRQST5 \
    *( ( volatile unsigned int * ) ( 0x42C61010UL ) )
#define bFM3_CAN1_TREQR1_TXRQST6 \
    *( ( volatile unsigned int * ) ( 0x42C61014UL ) )
#define bFM3_CAN1_TREQR1_TXRQST7 \
    *( ( volatile unsigned int * ) ( 0x42C61018UL ) )
#define bFM3_CAN1_TREQR1_TXRQST8 \
    *( ( volatile unsigned int * ) ( 0x42C6101CUL ) )
#define bFM3_CAN1_TREQR1_TXRQST9 \
    *( ( volatile unsigned int * ) ( 0x42C61020UL ) )
#define bFM3_CAN1_TREQR1_TXRQST10 \
    *( ( volatile unsigned int * ) ( 0x42C61024UL ) )
#define bFM3_CAN1_TREQR1_TXRQST11 \
    *( ( volatile unsigned int * ) ( 0x42C61028UL ) )
#define bFM3_CAN1_TREQR1_TXRQST12 \
    *( ( volatile unsigned int * ) ( 0x42C6102CUL ) )
#define bFM3_CAN1_TREQR1_TXRQST13 \
    *( ( volatile unsigned int * ) ( 0x42C61030UL ) )
#define bFM3_CAN1_TREQR1_TXRQST14 \
    *( ( volatile unsigned int * ) ( 0x42C61034UL ) )
#define bFM3_CAN1_TREQR1_TXRQST15 \
    *( ( volatile unsigned int * ) ( 0x42C61038UL ) )
#define bFM3_CAN1_TREQR1_TXRQST16 \
    *( ( volatile unsigned int * ) ( 0x42C6103CUL ) )
#define bFM3_CAN1_TREQR2_TXRQST17 \
    *( ( volatile unsigned int * ) ( 0x42C61040UL ) )
#define bFM3_CAN1_TREQR2_TXRQST18 \
    *( ( volatile unsigned int * ) ( 0x42C61044UL ) )
#define bFM3_CAN1_TREQR2_TXRQST19 \
    *( ( volatile unsigned int * ) ( 0x42C61048UL ) )
#define bFM3_CAN1_TREQR2_TXRQST20 \
    *( ( volatile unsigned int * ) ( 0x42C6104CUL ) )
#define bFM3_CAN1_TREQR2_TXRQST21 \
    *( ( volatile unsigned int * ) ( 0x42C61050UL ) )
#define bFM3_CAN1_TREQR2_TXRQST22 \
    *( ( volatile unsigned int * ) ( 0x42C61054UL ) )
#define bFM3_CAN1_TREQR2_TXRQST23 \
    *( ( volatile unsigned int * ) ( 0x42C61058UL ) )
#define bFM3_CAN1_TREQR2_TXRQST24 \
    *( ( volatile unsigned int * ) ( 0x42C6105CUL ) )
#define bFM3_CAN1_TREQR2_TXRQST25 \
    *( ( volatile unsigned int * ) ( 0x42C61060UL ) )
#define bFM3_CAN1_TREQR2_TXRQST26 \
    *( ( volatile unsigned int * ) ( 0x42C61064UL ) )
#define bFM3_CAN1_TREQR2_TXRQST27 \
    *( ( volatile unsigned int * ) ( 0x42C61068UL ) )
#define bFM3_CAN1_TREQR2_TXRQST28 \
    *( ( volatile unsigned int * ) ( 0x42C6106CUL ) )
#define bFM3_CAN1_TREQR2_TXRQST29 \
    *( ( volatile unsigned int * ) ( 0x42C61070UL ) )
#define bFM3_CAN1_TREQR2_TXRQST30 \
    *( ( volatile unsigned int * ) ( 0x42C61074UL ) )
#define bFM3_CAN1_TREQR2_TXRQST31 \
    *( ( volatile unsigned int * ) ( 0x42C61078UL ) )
#define bFM3_CAN1_TREQR2_TXRQST32 \
    *( ( volatile unsigned int * ) ( 0x42C6107CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT1 \
    *( ( volatile unsigned int * ) ( 0x42C61200UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT2 \
    *( ( volatile unsigned int * ) ( 0x42C61204UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT3 \
    *( ( volatile unsigned int * ) ( 0x42C61208UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT4 \
    *( ( volatile unsigned int * ) ( 0x42C6120CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT5 \
    *( ( volatile unsigned int * ) ( 0x42C61210UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT6 \
    *( ( volatile unsigned int * ) ( 0x42C61214UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT7 \
    *( ( volatile unsigned int * ) ( 0x42C61218UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT8 \
    *( ( volatile unsigned int * ) ( 0x42C6121CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT9 \
    *( ( volatile unsigned int * ) ( 0x42C61220UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT10 \
    *( ( volatile unsigned int * ) ( 0x42C61224UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT11 \
    *( ( volatile unsigned int * ) ( 0x42C61228UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT12 \
    *( ( volatile unsigned int * ) ( 0x42C6122CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT13 \
    *( ( volatile unsigned int * ) ( 0x42C61230UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT14 \
    *( ( volatile unsigned int * ) ( 0x42C61234UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT15 \
    *( ( volatile unsigned int * ) ( 0x42C61238UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT16 \
    *( ( volatile unsigned int * ) ( 0x42C6123CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT17 \
    *( ( volatile unsigned int * ) ( 0x42C61240UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT18 \
    *( ( volatile unsigned int * ) ( 0x42C61244UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT19 \
    *( ( volatile unsigned int * ) ( 0x42C61248UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT20 \
    *( ( volatile unsigned int * ) ( 0x42C6124CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT21 \
    *( ( volatile unsigned int * ) ( 0x42C61250UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT22 \
    *( ( volatile unsigned int * ) ( 0x42C61254UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT23 \
    *( ( volatile unsigned int * ) ( 0x42C61258UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT24 \
    *( ( volatile unsigned int * ) ( 0x42C6125CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT25 \
    *( ( volatile unsigned int * ) ( 0x42C61260UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT26 \
    *( ( volatile unsigned int * ) ( 0x42C61264UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT27 \
    *( ( volatile unsigned int * ) ( 0x42C61268UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT28 \
    *( ( volatile unsigned int * ) ( 0x42C6126CUL ) )
#define bFM3_CAN1_NEWDT_NEWDAT29 \
    *( ( volatile unsigned int * ) ( 0x42C61270UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT30 \
    *( ( volatile unsigned int * ) ( 0x42C61274UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT31 \
    *( ( volatile unsigned int * ) ( 0x42C61278UL ) )
#define bFM3_CAN1_NEWDT_NEWDAT32 \
    *( ( volatile unsigned int * ) ( 0x42C6127CUL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT1 \
    *( ( volatile unsigned int * ) ( 0x42C61200UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT2 \
    *( ( volatile unsigned int * ) ( 0x42C61204UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT3 \
    *( ( volatile unsigned int * ) ( 0x42C61208UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT4 \
    *( ( volatile unsigned int * ) ( 0x42C6120CUL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT5 \
    *( ( volatile unsigned int * ) ( 0x42C61210UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT6 \
    *( ( volatile unsigned int * ) ( 0x42C61214UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT7 \
    *( ( volatile unsigned int * ) ( 0x42C61218UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT8 \
    *( ( volatile unsigned int * ) ( 0x42C6121CUL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT9 \
    *( ( volatile unsigned int * ) ( 0x42C61220UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT10 \
    *( ( volatile unsigned int * ) ( 0x42C61224UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT11 \
    *( ( volatile unsigned int * ) ( 0x42C61228UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT12 \
    *( ( volatile unsigned int * ) ( 0x42C6122CUL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT13 \
    *( ( volatile unsigned int * ) ( 0x42C61230UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT14 \
    *( ( volatile unsigned int * ) ( 0x42C61234UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT15 \
    *( ( volatile unsigned int * ) ( 0x42C61238UL ) )
#define bFM3_CAN1_NEWDT1_NEWDAT16 \
    *( ( volatile unsigned int * ) ( 0x42C6123CUL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT17 \
    *( ( volatile unsigned int * ) ( 0x42C61240UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT18 \
    *( ( volatile unsigned int * ) ( 0x42C61244UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT19 \
    *( ( volatile unsigned int * ) ( 0x42C61248UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT20 \
    *( ( volatile unsigned int * ) ( 0x42C6124CUL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT21 \
    *( ( volatile unsigned int * ) ( 0x42C61250UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT22 \
    *( ( volatile unsigned int * ) ( 0x42C61254UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT23 \
    *( ( volatile unsigned int * ) ( 0x42C61258UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT24 \
    *( ( volatile unsigned int * ) ( 0x42C6125CUL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT25 \
    *( ( volatile unsigned int * ) ( 0x42C61260UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT26 \
    *( ( volatile unsigned int * ) ( 0x42C61264UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT27 \
    *( ( volatile unsigned int * ) ( 0x42C61268UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT28 \
    *( ( volatile unsigned int * ) ( 0x42C6126CUL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT29 \
    *( ( volatile unsigned int * ) ( 0x42C61270UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT30 \
    *( ( volatile unsigned int * ) ( 0x42C61274UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT31 \
    *( ( volatile unsigned int * ) ( 0x42C61278UL ) )
#define bFM3_CAN1_NEWDT2_NEWDAT32 \
    *( ( volatile unsigned int * ) ( 0x42C6127CUL ) )
#define bFM3_CAN1_INTPND_INTPND1 \
    *( ( volatile unsigned int * ) ( 0x42C61400UL ) )
#define bFM3_CAN1_INTPND_INTPND2 \
    *( ( volatile unsigned int * ) ( 0x42C61404UL ) )
#define bFM3_CAN1_INTPND_INTPND3 \
    *( ( volatile unsigned int * ) ( 0x42C61408UL ) )
#define bFM3_CAN1_INTPND_INTPND4 \
    *( ( volatile unsigned int * ) ( 0x42C6140CUL ) )
#define bFM3_CAN1_INTPND_INTPND5 \
    *( ( volatile unsigned int * ) ( 0x42C61410UL ) )
#define bFM3_CAN1_INTPND_INTPND6 \
    *( ( volatile unsigned int * ) ( 0x42C61414UL ) )
#define bFM3_CAN1_INTPND_INTPND7 \
    *( ( volatile unsigned int * ) ( 0x42C61418UL ) )
#define bFM3_CAN1_INTPND_INTPND8 \
    *( ( volatile unsigned int * ) ( 0x42C6141CUL ) )
#define bFM3_CAN1_INTPND_INTPND9 \
    *( ( volatile unsigned int * ) ( 0x42C61420UL ) )
#define bFM3_CAN1_INTPND_INTPND10 \
    *( ( volatile unsigned int * ) ( 0x42C61424UL ) )
#define bFM3_CAN1_INTPND_INTPND11 \
    *( ( volatile unsigned int * ) ( 0x42C61428UL ) )
#define bFM3_CAN1_INTPND_INTPND12 \
    *( ( volatile unsigned int * ) ( 0x42C6142CUL ) )
#define bFM3_CAN1_INTPND_INTPND13 \
    *( ( volatile unsigned int * ) ( 0x42C61430UL ) )
#define bFM3_CAN1_INTPND_INTPND14 \
    *( ( volatile unsigned int * ) ( 0x42C61434UL ) )
#define bFM3_CAN1_INTPND_INTPND15 \
    *( ( volatile unsigned int * ) ( 0x42C61438UL ) )
#define bFM3_CAN1_INTPND_INTPND16 \
    *( ( volatile unsigned int * ) ( 0x42C6143CUL ) )
#define bFM3_CAN1_INTPND_INTPND17 \
    *( ( volatile unsigned int * ) ( 0x42C61440UL ) )
#define bFM3_CAN1_INTPND_INTPND18 \
    *( ( volatile unsigned int * ) ( 0x42C61444UL ) )
#define bFM3_CAN1_INTPND_INTPND19 \
    *( ( volatile unsigned int * ) ( 0x42C61448UL ) )
#define bFM3_CAN1_INTPND_INTPND20 \
    *( ( volatile unsigned int * ) ( 0x42C6144CUL ) )
#define bFM3_CAN1_INTPND_INTPND21 \
    *( ( volatile unsigned int * ) ( 0x42C61450UL ) )
#define bFM3_CAN1_INTPND_INTPND22 \
    *( ( volatile unsigned int * ) ( 0x42C61454UL ) )
#define bFM3_CAN1_INTPND_INTPND23 \
    *( ( volatile unsigned int * ) ( 0x42C61458UL ) )
#define bFM3_CAN1_INTPND_INTPND24 \
    *( ( volatile unsigned int * ) ( 0x42C6145CUL ) )
#define bFM3_CAN1_INTPND_INTPND25 \
    *( ( volatile unsigned int * ) ( 0x42C61460UL ) )
#define bFM3_CAN1_INTPND_INTPND26 \
    *( ( volatile unsigned int * ) ( 0x42C61464UL ) )
#define bFM3_CAN1_INTPND_INTPND27 \
    *( ( volatile unsigned int * ) ( 0x42C61468UL ) )
#define bFM3_CAN1_INTPND_INTPND28 \
    *( ( volatile unsigned int * ) ( 0x42C6146CUL ) )
#define bFM3_CAN1_INTPND_INTPND29 \
    *( ( volatile unsigned int * ) ( 0x42C61470UL ) )
#define bFM3_CAN1_INTPND_INTPND30 \
    *( ( volatile unsigned int * ) ( 0x42C61474UL ) )
#define bFM3_CAN1_INTPND_INTPND31 \
    *( ( volatile unsigned int * ) ( 0x42C61478UL ) )
#define bFM3_CAN1_INTPND_INTPND32 \
    *( ( volatile unsigned int * ) ( 0x42C6147CUL ) )
#define bFM3_CAN1_INTPND1_INTPND1 \
    *( ( volatile unsigned int * ) ( 0x42C61400UL ) )
#define bFM3_CAN1_INTPND1_INTPND2 \
    *( ( volatile unsigned int * ) ( 0x42C61404UL ) )
#define bFM3_CAN1_INTPND1_INTPND3 \
    *( ( volatile unsigned int * ) ( 0x42C61408UL ) )
#define bFM3_CAN1_INTPND1_INTPND4 \
    *( ( volatile unsigned int * ) ( 0x42C6140CUL ) )
#define bFM3_CAN1_INTPND1_INTPND5 \
    *( ( volatile unsigned int * ) ( 0x42C61410UL ) )
#define bFM3_CAN1_INTPND1_INTPND6 \
    *( ( volatile unsigned int * ) ( 0x42C61414UL ) )
#define bFM3_CAN1_INTPND1_INTPND7 \
    *( ( volatile unsigned int * ) ( 0x42C61418UL ) )
#define bFM3_CAN1_INTPND1_INTPND8 \
    *( ( volatile unsigned int * ) ( 0x42C6141CUL ) )
#define bFM3_CAN1_INTPND1_INTPND9 \
    *( ( volatile unsigned int * ) ( 0x42C61420UL ) )
#define bFM3_CAN1_INTPND1_INTPND10 \
    *( ( volatile unsigned int * ) ( 0x42C61424UL ) )
#define bFM3_CAN1_INTPND1_INTPND11 \
    *( ( volatile unsigned int * ) ( 0x42C61428UL ) )
#define bFM3_CAN1_INTPND1_INTPND12 \
    *( ( volatile unsigned int * ) ( 0x42C6142CUL ) )
#define bFM3_CAN1_INTPND1_INTPND13 \
    *( ( volatile unsigned int * ) ( 0x42C61430UL ) )
#define bFM3_CAN1_INTPND1_INTPND14 \
    *( ( volatile unsigned int * ) ( 0x42C61434UL ) )
#define bFM3_CAN1_INTPND1_INTPND15 \
    *( ( volatile unsigned int * ) ( 0x42C61438UL ) )
#define bFM3_CAN1_INTPND1_INTPND16 \
    *( ( volatile unsigned int * ) ( 0x42C6143CUL ) )
#define bFM3_CAN1_INTPND2_INTPND17 \
    *( ( volatile unsigned int * ) ( 0x42C61440UL ) )
#define bFM3_CAN1_INTPND2_INTPND18 \
    *( ( volatile unsigned int * ) ( 0x42C61444UL ) )
#define bFM3_CAN1_INTPND2_INTPND19 \
    *( ( volatile unsigned int * ) ( 0x42C61448UL ) )
#define bFM3_CAN1_INTPND2_INTPND20 \
    *( ( volatile unsigned int * ) ( 0x42C6144CUL ) )
#define bFM3_CAN1_INTPND2_INTPND21 \
    *( ( volatile unsigned int * ) ( 0x42C61450UL ) )
#define bFM3_CAN1_INTPND2_INTPND22 \
    *( ( volatile unsigned int * ) ( 0x42C61454UL ) )
#define bFM3_CAN1_INTPND2_INTPND23 \
    *( ( volatile unsigned int * ) ( 0x42C61458UL ) )
#define bFM3_CAN1_INTPND2_INTPND24 \
    *( ( volatile unsigned int * ) ( 0x42C6145CUL ) )
#define bFM3_CAN1_INTPND2_INTPND25 \
    *( ( volatile unsigned int * ) ( 0x42C61460UL ) )
#define bFM3_CAN1_INTPND2_INTPND26 \
    *( ( volatile unsigned int * ) ( 0x42C61464UL ) )
#define bFM3_CAN1_INTPND2_INTPND27 \
    *( ( volatile unsigned int * ) ( 0x42C61468UL ) )
#define bFM3_CAN1_INTPND2_INTPND28 \
    *( ( volatile unsigned int * ) ( 0x42C6146CUL ) )
#define bFM3_CAN1_INTPND2_INTPND29 \
    *( ( volatile unsigned int * ) ( 0x42C61470UL ) )
#define bFM3_CAN1_INTPND2_INTPND30 \
    *( ( volatile unsigned int * ) ( 0x42C61474UL ) )
#define bFM3_CAN1_INTPND2_INTPND31 \
    *( ( volatile unsigned int * ) ( 0x42C61478UL ) )
#define bFM3_CAN1_INTPND2_INTPND32 \
    *( ( volatile unsigned int * ) ( 0x42C6147CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL1 \
    *( ( volatile unsigned int * ) ( 0x42C61600UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL2 \
    *( ( volatile unsigned int * ) ( 0x42C61604UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL3 \
    *( ( volatile unsigned int * ) ( 0x42C61608UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL4 \
    *( ( volatile unsigned int * ) ( 0x42C6160CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL5 \
    *( ( volatile unsigned int * ) ( 0x42C61610UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL6 \
    *( ( volatile unsigned int * ) ( 0x42C61614UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL7 \
    *( ( volatile unsigned int * ) ( 0x42C61618UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL8 \
    *( ( volatile unsigned int * ) ( 0x42C6161CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL9 \
    *( ( volatile unsigned int * ) ( 0x42C61620UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL10 \
    *( ( volatile unsigned int * ) ( 0x42C61624UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL11 \
    *( ( volatile unsigned int * ) ( 0x42C61628UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL12 \
    *( ( volatile unsigned int * ) ( 0x42C6162CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL13 \
    *( ( volatile unsigned int * ) ( 0x42C61630UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL14 \
    *( ( volatile unsigned int * ) ( 0x42C61634UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL15 \
    *( ( volatile unsigned int * ) ( 0x42C61638UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL16 \
    *( ( volatile unsigned int * ) ( 0x42C6163CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL17 \
    *( ( volatile unsigned int * ) ( 0x42C61640UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL18 \
    *( ( volatile unsigned int * ) ( 0x42C61644UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL19 \
    *( ( volatile unsigned int * ) ( 0x42C61648UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL20 \
    *( ( volatile unsigned int * ) ( 0x42C6164CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL21 \
    *( ( volatile unsigned int * ) ( 0x42C61650UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL22 \
    *( ( volatile unsigned int * ) ( 0x42C61654UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL23 \
    *( ( volatile unsigned int * ) ( 0x42C61658UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL24 \
    *( ( volatile unsigned int * ) ( 0x42C6165CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL25 \
    *( ( volatile unsigned int * ) ( 0x42C61660UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL26 \
    *( ( volatile unsigned int * ) ( 0x42C61664UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL27 \
    *( ( volatile unsigned int * ) ( 0x42C61668UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL28 \
    *( ( volatile unsigned int * ) ( 0x42C6166CUL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL29 \
    *( ( volatile unsigned int * ) ( 0x42C61670UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL30 \
    *( ( volatile unsigned int * ) ( 0x42C61674UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL31 \
    *( ( volatile unsigned int * ) ( 0x42C61678UL ) )
#define bFM3_CAN1_MSGVAL_MSGVAL32 \
    *( ( volatile unsigned int * ) ( 0x42C6167CUL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL1 \
    *( ( volatile unsigned int * ) ( 0x42C61600UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL2 \
    *( ( volatile unsigned int * ) ( 0x42C61604UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL3 \
    *( ( volatile unsigned int * ) ( 0x42C61608UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL4 \
    *( ( volatile unsigned int * ) ( 0x42C6160CUL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL5 \
    *( ( volatile unsigned int * ) ( 0x42C61610UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL6 \
    *( ( volatile unsigned int * ) ( 0x42C61614UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL7 \
    *( ( volatile unsigned int * ) ( 0x42C61618UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL8 \
    *( ( volatile unsigned int * ) ( 0x42C6161CUL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL9 \
    *( ( volatile unsigned int * ) ( 0x42C61620UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL10 \
    *( ( volatile unsigned int * ) ( 0x42C61624UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL11 \
    *( ( volatile unsigned int * ) ( 0x42C61628UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL12 \
    *( ( volatile unsigned int * ) ( 0x42C6162CUL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL13 \
    *( ( volatile unsigned int * ) ( 0x42C61630UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL14 \
    *( ( volatile unsigned int * ) ( 0x42C61634UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL15 \
    *( ( volatile unsigned int * ) ( 0x42C61638UL ) )
#define bFM3_CAN1_MSGVAL1_MSGVAL16 \
    *( ( volatile unsigned int * ) ( 0x42C6163CUL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL17 \
    *( ( volatile unsigned int * ) ( 0x42C61640UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL18 \
    *( ( volatile unsigned int * ) ( 0x42C61644UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL19 \
    *( ( volatile unsigned int * ) ( 0x42C61648UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL20 \
    *( ( volatile unsigned int * ) ( 0x42C6164CUL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL21 \
    *( ( volatile unsigned int * ) ( 0x42C61650UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL22 \
    *( ( volatile unsigned int * ) ( 0x42C61654UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL23 \
    *( ( volatile unsigned int * ) ( 0x42C61658UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL24 \
    *( ( volatile unsigned int * ) ( 0x42C6165CUL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL25 \
    *( ( volatile unsigned int * ) ( 0x42C61660UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL26 \
    *( ( volatile unsigned int * ) ( 0x42C61664UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL27 \
    *( ( volatile unsigned int * ) ( 0x42C61668UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL28 \
    *( ( volatile unsigned int * ) ( 0x42C6166CUL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL29 \
    *( ( volatile unsigned int * ) ( 0x42C61670UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL30 \
    *( ( volatile unsigned int * ) ( 0x42C61674UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL31 \
    *( ( volatile unsigned int * ) ( 0x42C61678UL ) )
#define bFM3_CAN1_MSGVAL2_MSGVAL32 \
    *( ( volatile unsigned int * ) ( 0x42C6167CUL ) )
