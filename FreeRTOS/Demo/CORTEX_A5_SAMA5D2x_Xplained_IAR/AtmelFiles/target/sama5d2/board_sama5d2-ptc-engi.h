 ...
 *
 *  - sama5d2-PTC-ENGI
 *  - For sama5d2-PTC-ENGI information, see \subpage
 * sama5d2_ptc_engi_board_info.
...
#define PIN_LED_0                                          \
    {                                                      \
        PIO_GROUP_A, PIO_PA30, PIO_OUTPUT_1, PIO_OPENDRAIN \
    }

/** LED #1 pin definition (Green). */
#define PIN_LED_1                                          \
    {                                                      \
        PIO_GROUP_A, PIO_PA31, PIO_OUTPUT_1, PIO_OPENDRAIN \
    }

/** LED #2 pin definition (Blue). */
#define PIN_LED_2                                         \
    {                                                     \
        PIO_GROUP_B, PIO_PB2, PIO_OUTPUT_1, PIO_OPENDRAIN \
    }
