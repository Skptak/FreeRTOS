...
/* RGB LED index */
#define LED_RED \
    0 /* led red shared with SDMMC0 (eMMC) card detect used only by RomBoot */
#define LED_GREEN 1
#define LED_BLUE  2
...
#define PIN_LED_0                                          \
    {                                                      \
        PIO_GROUP_A, PIO_PA13, PIO_OUTPUT_0, PIO_OPENDRAIN \
    }
...
#define PIN_PUSHBUTTON_1                            \
    {                                               \
        PIO_GROUP_B, PIO_PB6, PIO_INPUT, PIO_CFG_PB \
    }
...
#define SDMMC0_PINS                                                      \
    {                                                                    \
        PINS_SDMMC0_8B_IOS1, PIN_SDMMC0_CK_IOS1, PIN_SDMMC0_VDDSEL_IOS1, \
