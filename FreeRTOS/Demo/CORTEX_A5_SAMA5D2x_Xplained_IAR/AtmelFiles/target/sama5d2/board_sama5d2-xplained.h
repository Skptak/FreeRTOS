...
/* WHIS: ADDED CODE BELOW TO RE-MAP THE LED DEFINITIONS TO BOARD
    ...
    #define PIN_LED_0                                                        \
        {                                                                    \
            PIO_GROUP_B, PIO_PB25, PIO_OUTPUT_0, PIO_DEFAULT | PIO_DRVSTR_HI \
        }

    /** LED #1 pin definition Pin 32. */
    #define PIN_LED_1                                                       \
        {                                                                   \
            PIO_GROUP_C, PIO_PC8, PIO_OUTPUT_0, PIO_DEFAULT | PIO_DRVSTR_HI \
        }

    /** LED #2 pin definition Pin 34  */
    #define PIN_LED_2                                                        \
        {                                                                    \
            PIO_GROUP_C, PIO_PC26, PIO_OUTPUT_0, PIO_DEFAULT | PIO_DRVSTR_HI \
        }
    ...
    #define PIN_LED_0                                         \
        {                                                     \
            PIO_GROUP_B, PIO_PB6, PIO_OUTPUT_1, PIO_OPENDRAIN \
        }

    /** LED #1 pin definition (Green). */
    #define PIN_LED_1                                         \
        {                                                     \
            PIO_GROUP_B, PIO_PB5, PIO_OUTPUT_1, PIO_OPENDRAIN \
        }

    /** LED #2 pin definition (Blue). */
    #define PIN_LED_2                                         \
        {                                                     \
            PIO_GROUP_B, PIO_PB0, PIO_OUTPUT_1, PIO_OPENDRAIN \
        }
#endif
...
/** LED #1 pin definition (Green). */
#define PIN_PWM_LED_0                                         \
    {                                                         \
        PIO_GROUP_B, PIO_PB5C_PWMH2, PIO_PERIPH_C, PIO_PULLUP \
    }

/** LED #2 pin definition (Blue). */
#define PIN_PWM_LED_1                                         \
    {                                                         \
        PIO_GROUP_B, PIO_PB0D_PWMH1, PIO_PERIPH_D, PIO_PULLUP \
    }

/** List of all PWM LED channels */
#define PWM_LEDS_CH                \
    {                              \
        PWM_LED_CH_0, PWM_LED_CH_1 \
    }

/** List of all LEDs definitions in PWM mode (red LED is not on a PWM pin) */
#define PINS_PWM_LEDS                \
    {                                \
        PIN_PWM_LED_0, PIN_PWM_LED_1 \
    }
...
#define PIN_PUSHBUTTON_1                            \
    {                                               \
        PIO_GROUP_B, PIO_PB9, PIO_INPUT, PIO_CFG_PB \
    }
...
#define PIN_MXT_IRQ                                                    \
    {                                                                  \
        PIO_GROUP_B, PIO_PB7, PIO_INPUT, PIO_PULLUP | PIO_IT_LOW_LEVEL \
    }
...
#define BOARD_CLASSD_PINS                                           \
    {                                                               \
        PIN_CLASSD_R0_IOS1, PIN_CLASSD_R1_IOS1, PIN_CLASSD_R2_IOS1, \
            PIN_CLASSD_R3_IOS1                                      \
    }
...
#define SDMMC0_PINS                                                  \
    {                                                                \
        PINS_SDMMC0_8B_IOS1, PIN_SDMMC0_CK_IOS1, PIN_SDMMC0_CD_IOS1, \
            PIN_SDMMC0_VDDSEL_IOS1, PIN_SDMMC0_RSTN_IOS1             \
    }

#define SDMMC1_PINS                                                 \
    {                                                               \
        PINS_SDMMC1_4B_IOS1, PIN_SDMMC1_CK_IOS1, PIN_SDMMC1_CD_IOS1 \
    }
