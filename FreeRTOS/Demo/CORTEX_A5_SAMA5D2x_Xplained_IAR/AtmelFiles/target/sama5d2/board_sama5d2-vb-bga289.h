...
#define PIN_LED_0                                          \
    {                                                      \
        PIO_GROUP_D, PIO_PD21, PIO_OUTPUT_0, PIO_OPENDRAIN \
    }

/** LED #1 pin definition (Green). */
#define PIN_LED_1                                          \
    {                                                      \
        PIO_GROUP_D, PIO_PD22, PIO_OUTPUT_0, PIO_OPENDRAIN \
    }
...
#define PIN_PUSHBUTTON_1                             \
    {                                                \
        PIO_GROUP_D, PIO_PD23, PIO_INPUT, PIO_CFG_PB \
    }

#define PIN_PUSHBUTTON_2                             \
    {                                                \
        PIO_GROUP_D, PIO_PD24, PIO_INPUT, PIO_CFG_PB \
    }

/** List of all push button definitions. */
#define PINS_PUSHBUTTONS                   \
    {                                      \
        PIN_PUSHBUTTON_1, PIN_PUSHBUTTON_2 \
    }
...
#define SDMMC0_PINS                                                          \
    {                                                                        \
        PINS_SDMMC0_8B_IOS1, PIN_SDMMC0_CK_IOS1, PIN_SDMMC0_CD_IOS1,         \
            PIN_SDMMC0_VDDSEL_IOS1, PIN_SDMMC0_RSTN_IOS1, PIN_SDMMC0_WP_IOS1 \
    }

#define SDMMC1_PINS                                                  \
    {                                                                \
        PINS_SDMMC1_4B_IOS1, PIN_SDMMC1_CK_IOS1, PIN_SDMMC1_CD_IOS1, \
            PIN_SDMMC1_RSTN_IOS1, PIN_SDMMC1_WP_IOS1                 \
    }
