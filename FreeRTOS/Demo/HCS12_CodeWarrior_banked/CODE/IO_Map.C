...
volatile CAN0IDACSTR _CAN0IDAC;   /* MSCAN 0 Identifier Acceptance Control
                                     Register */
...
volatile CAN1IDACSTR _CAN1IDAC;     /* MSCAN 1 Identifier Acceptance Control
                                       Register */
...
volatile CAN2IDACSTR _CAN2IDAC;     /* MSCAN 2 Identifier Acceptance Control
                                       Register */
...
volatile CAN3IDACSTR _CAN3IDAC;     /* MSCAN 3 Identifier Acceptance Control
                                       Register */
...
volatile INITEESTR _INITEE; /* Initialization of Internal EEPROM Position
                               Register */
volatile INITRGSTR _INITRG; /* Initialization of Internal Register Position
                               Register */
