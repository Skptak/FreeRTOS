...
** ===================================================================
*/
extern void _Startup( void ); /* Forward declaration of external startup
                                 function declared in file Start12.c */
...
void _EntryPoint( void )
{
    ...
    /* Initialization of the registers INITRG, INITRM, INITEE is done to protect
     * them to be written accidentally later by the application */
...
void PE_low_level_init( void )
{
    ...
    /* PWMSDN:
     * PWMIF=0,PWMIE=0,PWMRSTRT=0,PWMLVL=0,??=0,PWM7IN=0,PWM7INL=0,PWM7ENA=0 */
    output( PWMSDN, 0 );
