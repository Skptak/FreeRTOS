...
void systemInit( void )
{
    ...
    /* 100MHz */
    flashWREG->FRDCNTL = 0x01000000U | ( 2U << 8U ) | ( 0U << 4U ) | 1U;
#else
    /* 180MHz */
    flashWREG->FRDCNTL = 0x01000000U | ( 3U << 8U ) | ( 1U << 4U ) | 1U;
#endif
...
#if startupCPU_100MHZ == 1
    /* 100MHz */
    systemREG1->PLLCTL1 = 0x00000000U | 0x20000000U | ( 0U << 24U ) |
                          0x00000000U | ( 5U << 16U ) | ( 74U << 8U );
#else
    /* 180Mhz */
    systemREG1->PLLCTL1 = 0x00000000U | 0x20000000U | ( 0U << 24U ) |
                          0x00000000U | ( 5U << 16U ) | ( 134U << 8U );
#endif
    ...
    systemREG1->CSDISCLR = 0x00000000U | 0x00000000U | 0x00000000U |
                           0x00000000U | 0x00000002U;

    /** - Wait for until clocks are locked */
    while( ( systemREG1->CSVSTAT & 0x00000002U ) == 0x00 )
        ; /* wait for PLL */

    /** - Setup GCLK, HCLK and VCLK clock source for normal operation, power
     * down mode and after wakeup */
    systemREG1->GHVSRC = ( SYS_PLL << 24U ) | ( SYS_PLL << 16U ) | SYS_PLL;
