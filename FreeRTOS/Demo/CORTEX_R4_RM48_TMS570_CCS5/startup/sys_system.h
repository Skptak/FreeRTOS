 ...
 *
 *   This pointer is used by the system driver to access the system frame 1
 * registers.
 */
 ...
 *
 *   This pointer is used by the system driver to access the system frame 2
 * registers.
 */
 ...
 *
 *   This enumeration is used to provide alias names for the flash bank power
 * modes:
 *     - sleep
 *     - standby
 *     - active
 ...
 *
 *   This pointer is used by the system driver to access the flash wrapper
 * registers.
 */
