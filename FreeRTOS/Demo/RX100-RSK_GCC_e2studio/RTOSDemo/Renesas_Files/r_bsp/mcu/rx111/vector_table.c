...
const unsigned char Endian_Select[] __attribute__( (
    section( ".endian_bytes" ) ) ) = { 0xff, 0xff, 0xff, 0xff };
#elif __RX_BIG_ENDIAN__
const unsigned char Endian_Select[] __attribute__( (
    section( ".endian_bytes" ) ) ) = { 0xff, 0xff, 0xff, 0xf8 };
#endif

// Option bytes setting for OFS1:0xFFFFFF88 and OFS0:0xFFFFFF8C
const unsigned char Security_Id[] __attribute__( ( section(
    ".option_bytes" ) ) ) = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };
