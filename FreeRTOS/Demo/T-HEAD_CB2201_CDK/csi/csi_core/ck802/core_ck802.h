...
#define __CK802_CSI_VERSION_MAIN                                            \
    ( 0x04U )                             /*!< [31:16] CSI HAL main version \
                                           */
...
extern "C" {
    ...
    // #warning "__GSR_GCR_PRESENT not defined in device header file; using
    // default!"
    #endif

    #ifndef __MGU_PRESENT
        #define __MGU_PRESENT 0U
    // #warning "__MGU_PRESENT not defined in device header file; using
    // default!"
    #endif
    // #endif
...
typedef union
{
    ...
    #define PACK_BASE_ADDR_Msk \
        ( 0x3FFFFFUL << PACR_BASE_ADDR_Pos ) /*!< PACR: base_addr Mask */
...
typedef struct
{
    ...
    #define CORET_CTRL_COUNTFLAG_Pos            \
        16U /*!< CORET CTRL: COUNTFLAG Position \
             */
    #define CORET_CTRL_COUNTFLAG_Msk \
        ( 1UL << CORET_CTRL_COUNTFLAG_Pos ) /*!< CORET CTRL: COUNTFLAG Mask */

    #define CORET_CTRL_CLKSOURCE_Pos 2U /*!< CORET CTRL: CLKSOURCE Position */
    #define CORET_CTRL_CLKSOURCE_Msk \
        ( 1UL << CORET_CTRL_CLKSOURCE_Pos ) /*!< CORET CTRL: CLKSOURCE Mask */

    #define CORET_CTRL_TICKINT_Pos 1U /*!< CORET CTRL: TICKINT Position */
    #define CORET_CTRL_TICKINT_Msk \
        ( 1UL << CORET_CTRL_TICKINT_Pos ) /*!< CORET CTRL: TICKINT Mask */

    #define CORET_CTRL_ENABLE_Pos 0U /*!< CORET CTRL: ENABLE Position */
    #define CORET_CTRL_ENABLE_Msk \
        ( 1UL /*<< CORET_CTRL_ENABLE_Pos*/ ) /*!< CORET CTRL: ENABLE Mask */

    /* CORET Reload Register Definitions */
    #define CORET_LOAD_RELOAD_Pos 0U /*!< CORET LOAD: RELOAD Position */
    #define CORET_LOAD_RELOAD_Msk                                           \
        ( 0xFFFFFFUL /*<< CORET_LOAD_RELOAD_Pos*/ ) /*!< CORET LOAD: RELOAD \
                                                       Mask */

    /* CORET Current Register Definitions */
    #define CORET_VAL_CURRENT_Pos 0U /*!< CORET VAL: CURRENT Position */
    #define CORET_VAL_CURRENT_Msk                                           \
        ( 0xFFFFFFUL /*<< CORET_VAL_CURRENT_Pos*/ ) /*!< CORET VAL: CURRENT \
                                                       Mask */

    /* CORET Calibration Register Definitions */
    #define CORET_CALIB_NOREF_Pos 31U /*!< CORET CALIB: NOREF Position */
    #define CORET_CALIB_NOREF_Msk \
        ( 1UL << CORET_CALIB_NOREF_Pos ) /*!< CORET CALIB: NOREF Mask */

    #define CORET_CALIB_SKEW_Pos 30U /*!< CORET CALIB: SKEW Position */
    #define CORET_CALIB_SKEW_Msk \
        ( 1UL << CORET_CALIB_SKEW_Pos ) /*!< CORET CALIB: SKEW Mask */

    #define CORET_CALIB_TENMS_Pos 0U /*!< CORET CALIB: TENMS Position */
    #define CORET_CALIB_TENMS_Msk                                           \
        ( 0xFFFFFFUL /*<< CORET_CALIB_TENMS_Pos*/ ) /*!< CORET CALIB: TENMS \
                                                       Mask */
...
typedef struct
{
    ...
    #define DCC_HCR_JW_Msk \
        ( 1UL << DCC_HCR_JW_Pos ) /*!< DCC HCR: jw_int_en Mask */

    #define DCC_HCR_JR_Pos 19U /*!< DCC HCR: jr_int_en Position */
    #define DCC_HCR_JR_Msk \
        ( 1UL << DCC_HCR_JR_Pos ) /*!< DCC HCR: jr_int_en Mask */

    #define DCC_EHSR_JW_Pos 1U /*!< DCC EHSR: jw_vld Position */
    #define DCC_EHSR_JW_Msk \
        ( 1UL << DCC_EHSR_JW_Pos ) /*!< DCC EHSR: jw_vld Mask */

    #define DCC_EHSR_JR_Pos 2U /*!< DCC EHSR: jr_vld Position */
    #define DCC_EHSR_JR_Msk \
        ( 1UL << DCC_EHSR_JR_Pos ) /*!< DCC EHSR: jr_vld Mask */
    ...
    */
    ...
    #define CORET \
        ( ( CORET_Type * ) CORET_BASE ) /*!< SysTick configuration struct */
    #define NVIC                                                           \
