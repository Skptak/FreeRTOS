...
/**
  ...
  controller. \param [in]      irq_num  External interrupt number. Value cannot
  be negative.
 */
...
/**
  ...
  for the specified interrupt. \param [in]      irq_num  Interrupt number.
...
/**
  ...
  the device specific interrupt. \param [in]      irq_num  Device specific
