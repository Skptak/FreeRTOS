 ...
 * IIC0(PA4,PA5)
 ******************************************************************************/
#define GPIO0_REUSE_EN                                                    \
    ( GPIO_SET_BIT0 | GPIO_SET_BIT1 | GPIO_SET_BIT4 | GPIO_SET_BIT5 |     \
      GPIO_SET_BIT6 | GPIO_SET_BIT9 | GPIO_SET_BIT10 | GPIO_SET_BIT11 |   \
      GPIO_SET_BIT16 | GPIO_SET_BIT17 | GPIO_SET_BIT18 | GPIO_SET_BIT22 | \
      GPIO_SET_BIT23 | GPIO_SET_BIT26 | GPIO_SET_BIT27 )
#define GPIO1_REUSE_EN ( GPIO_SET_BIT0 )
#define IOMUX0L_FUNCTION_SEL                                      \
    ( PA0_UART0_TX | PA1_UART0_RX | PA4_I2C0_SCL | PA5_I2C0_SDA | \
      PA6_ETB_TRIG0 | PA9_PWM_CH0 | PA10_UART1_TX | PA11_UART1_RX )
#define IOMUX0H_FUNCTION_SEL                                        \
    ( PA16_SPI1_CLK | PA17_SPI1_TX | PA18_SPI1_RX | PA22_UART2_RX | \
      PA23_UART2_TX | PA26_UART3_TX | PA27_UART3_RX )
#define IOMUX1L_FUNCTION_SEL ( PB0_ADC0 )

#define PWM_GPIO0_REUSE_EN                                             \
    ( GPIO0_REUSE_EN | GPIO_SET_BIT0 | GPIO_SET_BIT1 | GPIO_SET_BIT2 | \
      GPIO_SET_BIT12 | GPIO_SET_BIT13 | GPIO_SET_BIT14 )
#define PWM_IOMUX0L_FUNCTION_SEL                                       \
    ( IOMUX0L_FUNCTION_SEL | PA0_PWM_CH0 | PA1_PWM_CH1 | PA2_PWM_CH2 | \
      PA12_PWM_CH3 | PA13_PWM_CH4 | PA14_PWM_CH5 )
