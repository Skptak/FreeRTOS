...
struct
{
    uint32_t base;
    uint32_t irq;
} const sg_pmu_config[ CONFIG_PMU_NUM ] = { { CSKY_CLKGEN_BASE, POWM_IRQn } };
...
struct
{
    uint32_t base;
    uint32_t irq;
} const sg_rtc_config[ CONFIG_RTC_NUM ] = { { CSKY_RTC0_BASE, RTC_IRQn },
...
const static usart_pin_map_t s_usart_pin_map[] = {
    { PA2_TXD0_SPI0MISO, PA3_RXD0_SPI0MOSI, -1, -1, 0, 0 },
    { PA10_ADC2_TXD0, PA11_ACMP0N_ADC3_RXD0, -1, -1, 0, 2 },
    { PA17_TXD1_ADC9, PA16_RXD1_ADC8, -1, -1, 1, 0 },
    {
...
const static spi_pin_map_t s_spi_pin_map[] = { { PA2_TXD0_SPI0MISO,
                                                 PA3_RXD0_SPI0MOSI,
...
const static iic_pin_map_t s_iic_pin_map[] = {
    { PB0_SCL0_PWM2_I2SMCLK, PB1_SDA0_PWM3_I2SSCK, 0, 0 },
    { PA6_SPI0MOSI_PWM6_SCL0, PA7_SPI0SSN_PWM7_SDA0, 0, 2 },
    { PC0_SCL1_CTS1_PWM10_ADC14, PC1_SDA1_RTS1_PWM11_ADC15, 1, 0 }
};
         ...
         idx++ )
    {
        if( s_iic_pin_map[ idx ].scl == scl && s_iic_pin_map[ idx ].sda == sda )
        {
            ...
            *irq = sg_iic_config[ s_iic_pin_map[ idx ].cfg_idx ].irq;
            ...
            {
                pin_mux( s_iic_pin_map[ idx ].scl,
                         s_iic_pin_map[ idx ].function );
                pin_mux( s_iic_pin_map[ idx ].sda,
                         s_iic_pin_map[ idx ].function );
            }
