...
#define DW_FCR_RT_FIFO_SINGLE \
    0x0 << 6 /* rcvr trigger 1 character in the FIFO */
...
#define DW_FCR_RT_FIFO_LESSTWO                                               \
    0x3 << 6                           /* rcvr trigger FIFO 2 less than full \
                                        */
#define DW_FCR_TET_FIFO_EMPTY 0x0 << 4 /* tx empty trigger FIFO empty */
#define DW_FCR_TET_FIFO_TWO \
    0x1 << 4 /* tx empty trigger 2 characters in the FIFO */
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t DLH; /* Offset: 0x004 (R/W)  Clock frequency division
                               high section register */
