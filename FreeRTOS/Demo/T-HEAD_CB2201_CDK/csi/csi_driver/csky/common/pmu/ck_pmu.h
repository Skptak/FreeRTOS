...
typedef struct
{
    ...
    __IOM uint32_t CLKSTBST; /* Offset: 0x01c (R/W) clock stable interrupt
                                statue register */
    __IOM uint32_t CLKSTBMK; /* Offset: 0x020 (R/W) clock stable interrupt mask
                                register */
    __IOM uint32_t CSSCR;    /* Offset: 0x024 (R/W) clock source stable counter
                                register */
    __IOM uint32_t DFCC;     /* Offset: 0x028 (R/W) dynamic frequence conversion
                                control register */
    ...
    __IOM uint32_t SCGCR;   /* Offset: 0x04c (R/W) security clock gate control
                               register */
    __IOM uint32_t SCGSR;   /* Offset: 0x050 (R/W) security clock gate status
                               register */
} ck_pmu_reg_t;
