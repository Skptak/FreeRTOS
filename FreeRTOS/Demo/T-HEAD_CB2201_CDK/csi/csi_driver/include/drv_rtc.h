...
typedef void ( *rtc_event_cb_t )( rtc_event_e event ); ///< Pointer to \ref
                                                       ///< rtc_event_cb_t : RTC
                                                       ///< Event call back.
...
/**
  ...
  the RTC interface 2.registers event callback function \param[in]   idx  must
  not exceed return value of csi_rtc_get_instance_count() \param[in]   cb_event
  Pointer to \ref rtc_event_cb_t \return      pointer to rtc instance
*/
