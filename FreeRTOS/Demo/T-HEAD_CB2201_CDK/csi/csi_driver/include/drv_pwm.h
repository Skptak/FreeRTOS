...
/**
  ...
  the PWM interface 2.registers event callback function \param[in]   pwm_pin pin
  name of pwm \return      handle pwm handle to operate.
*/
...
/**
  ...
  \param[in]   duty      the PMW duty.  ( 0 - 10000 represents 0% - 100% ,other
  values are invalid) \return      error code
*/
