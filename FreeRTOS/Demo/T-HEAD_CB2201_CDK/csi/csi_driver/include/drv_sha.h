...
typedef void ( *sha_event_cb_t )( sha_event_e event ); ///< Pointer to \ref
                                                       ///< sha_event_cb_t : SHA
                                                       ///< Event call back.
...
/**
  ...
  the SHA interface 2.registers event callback function \param[in]   handle
  Pointer to the buffer store the sha context \param[in]   cb_event  Pointer to
  \ref sha_event_cb_t \return      return sha handle if success
*/
