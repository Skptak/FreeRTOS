...
typedef void ( *eflash_event_cb_t )(
    eflash_event_e event ); ///< Pointer to
                            ///< \ref
                            ///< eflash_event_cb_t
                            ///< : EFLASH Event
                            ///< call back.
...
/**
  ...
  must not exceed return value of csi_eflash_get_instance_count() \param[in]
  cb_event  Pointer to \ref eflash_event_cb_t \return      pointer to eflash
  handle
*/
