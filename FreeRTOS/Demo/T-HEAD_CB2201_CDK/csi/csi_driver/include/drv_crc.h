...
typedef void ( *crc_event_cb_t )( crc_event_e event ); ///< Pointer to \ref
                                                       ///< crc_event_cb_t : CRC
                                                       ///< Event call back.
...
/**
  ...
  the CRC interface 2.registers event callback function \param[in]   idx must
  not exceed return value of csi_crc_get_handle_count() \param[in]   cb_event
  Pointer to \ref crc_event_cb_t \return      return crc handle if success
*/
