 ...
 * @Note anyone should not use any global variable in this function since this
 * function is called at before data section's initialization. Since here
 * SystemInit is a weak symbol, any vendor can override this symbol on its own
 * wishes.
 */
...
__attribute__( ( weak ) ) void SystemInit( void )
{
    ...
    drv_coret_config( CONFIG_SYSTEM_FREQ / CONFIG_SYSTICK_HZ,
                      CORET_IRQn ); // 10ms
