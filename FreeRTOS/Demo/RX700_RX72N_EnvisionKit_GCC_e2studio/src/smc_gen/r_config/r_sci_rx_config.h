 ...
 *           02.07.2014 1.30    Fixed bug that caused Group12 rx errors to only
 *be enabled for channel 2. 25.11.2014 1.40    Added comments for RX113 support
 *           30.09.2015 1.70    Added comments for RX23T support
 *           01.10.2016 1.80    Added support for RX65N (comments and TX/RX FIFO
 *THRESHOLD options) 19.12.2016 1.90    Added comments for RX24U support
 ...
 *                              Added support received data match function for
 *RX65N 28.06.2019 3.10    Added comments for RX23W support 15.08.2019 3.20
 *Added support received data match function for RX72M (SCI0- SCI11) Added
 *support FIFO mode for RX72M (SCI7 - SCI11) 25.11.2019 3.30    Added support
 *RX13T. Removed support for Generation 1 devices. 30.12.2019 3.40    Added
 *support RX66N, RX72N. 31.03.2020 3.50    Added support RX23E-A.
 ***********************************************************************************************************************/
#ifndef SCI_CONFIG_H
#define SCI_CONFIG_H
 ...
 *
 * CH#  110 111 113 130 230 231 23T 24T 24U 64M 71M 65N 66T 72T 23W 72M 13T 72N
 * 66N RX23E-A
 * ---  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
 * --- ------- CH0           X   Xa  X   X               X   X   Xn X       X X
 * CH1   X   X*  X*  Xu  X   X   Xu  Xu  Xu  X   X   Xs  X   X   X   X   X   X
 * X     Xu CH2           X                           X   X   Xu              X
 * X   X CH3                                       X   X   Xs              X X X
 * CH4                                       X   X   Xn              X       X X
 * CH5   X   X   X   X   X   Xu  X   X   X   X   X   X   X   X   X   X   X   X
 * X     X CH6           X   X   X   X       X   X   X   X   Xn  X   X       Xu
 * X   X     X CH7                                       Xu  Xu  Xn X       X X
 * CH8           X   Xa  X   X           X           X   X   X   Xu  X       X X
 * CH9           X   Xa  X   X           X           Xs  X   X       X       X X
 * CH10                                              X               X       X X
 * CH11                                  X           Xs  X   X       X       X X
 * CH12  X   X   X   X   X   X               X   X   Xs  X   X   X   X   X   X
 * X     X
 */
...
/* SPECIFY ASYNC MODE TX QUEUE BUFFER SIZES (will not allocate if chan not
 * enabled */
...
/* SPECIFY ASYNC MODE RX QUEUE BUFFER SIZES (will not allocate if chan not
 * enabled */
...
/*
 * SET GROUPBL0 (ERI, TEI) INTERRUPT PRIORITY;
 * RX64M/RX71M/RX65N/RX72M/RX72N/RX66N ONLY SET GROUPBL1; RX65N ONLY SET
 * GROUPAL0 (ERI,TEI) INTERRUPT PRIORITY; RX65N, RX72M, RX72N, RX66N ONLY This
 * sets the priority level for receiver overrun, framing, and parity errors as
 * well as TEI interrupts for all SCI channels.
 */
#define SCI_CFG_ERI_TEI_PRIORITY                                             \
    ( 3 ) /* (RX64M/RX71M/RX65N/RX72M/RX72N/RX66N ONLY) 1 lowest, 15 highest \
           */
 ...
 */
/* Set the same value for TX FIFO THRESHOLD and RX FIFO THRESHOLD in Clock
 * Synchronous Mode and Simple SPI Mode. */
...
/* ENABLE Received Data match function (SCIj and SCIi supported MCU
 * RX65N/RX66T/RX72T/RX72M/RX72N/RX66N ONLY) 1=included, 0=not */
