...
/* Multiple inclusion prevention macro */
    ...
    /* CPU cycles. Known number of RXv3 CPU cycles required to execute the
     * delay_wait() loop */
    ...
    #else
        #error \
            "ERROR - BSP_CFG_MCU_PART_SERIES - Unknown MCU Series chosen in r_bsp_config.h"
    #endif

    /* This macro means that this MCU is part of the RX72x collection of MCUs
     * (i.e. RX72N). */
    ...
    #else
        #error \
            "ERROR - BSP_CFG_MCU_PART_GROUP - Unknown MCU Group chosen in r_bsp_config.h"
    #endif
    ...
    #else
        #error \
            "ERROR - BSP_CFG_MCU_PART_PACKAGE - Unknown package chosen in r_bsp_config.h"
    #endif
    ...
    #else
        #error \
            "ERROR - BSP_CFG_MCU_PART_MEMORY_SIZE - Unknown memory size chosen in r_bsp_config.h"
    #endif
    ...
    */
        ...
        #define BSP_SELECTED_CLOCK_HZ ( BSP_SUB_CLOCK_HZ )
            ...
            #define BSP_SELECTED_CLOCK_HZ \
                ( ( BSP_CFG_XTAL_HZ / BSP_CFG_PLL_DIV ) * BSP_CFG_PLL_MUL )
        #elif BSP_CFG_PLL_SRC == 1
            #define BSP_SELECTED_CLOCK_HZ \
                ( ( BSP_HOCO_HZ / BSP_CFG_PLL_DIV ) * BSP_CFG_PLL_MUL )
        #else
            #error \
    ...
    #else
        #error \
            "ERROR - BSP_CFG_CLOCK_SOURCE - Unknown clock source chosen in r_bsp_config.h"
    #endif

    /* Define frequency of PPLL clock. */
    #if BSP_CFG_PLL_SRC == 0
        #define BSP_PPLL_CLOCK_HZ \
            ( ( BSP_CFG_XTAL_HZ / BSP_CFG_PPLL_DIV ) * BSP_CFG_PPLL_MUL )
    #elif BSP_CFG_PLL_SRC == 1
        #define BSP_PPLL_CLOCK_HZ \
            ( ( BSP_HOCO_HZ / BSP_CFG_PPLL_DIV ) * BSP_CFG_PPLL_MUL )
    #else
        #error \
            "ERROR - Valid PLL clock source must be chosen in r_bsp_config.h using BSP_CFG_PLL_SRC macro."
    #endif
    ...
    */
    ...
    #else
        #error \
            "ERROR - BSP_CFG_USB_CLOCK_SOURCE - Unknown usb clock source chosen in r_bsp_config.h"
    #endif
    ...
    #define FIT_NO_FUNC \
        ( ( void ( * )( void * ) ) 0x10000000 )       /* Reserved space on RX */
