 ...
 *                               Fixed coding style.
 *                               Added definition for section of D_8, B_8, and
 *C_8. : 08.10.2019 3.01     Added section for Renesas RTOS (RI600V4 or
 *RI600PX). : 14.02.2020 3.02     Corrected pragma declaration of unpack.
 ***********************************************************************************************************************/
...
extern st_dtbl_t const _DTBL[] = {
    ...
    { __sectop( "D_1" ), __secend( "D_1" ), __sectop( "R_1" ) }
            ...
            ( BSP_CFG_RENESAS_RTOS_USED == RENESAS_RI600PX )
    ,
...
extern st_btbl_t const _BTBL[] = {
    ...
    { __sectop( "B_1" ), __secend( "B_1" ) }
        #if( BSP_CFG_RTOS_USED == 4 ) && \
            ( BSP_CFG_RENESAS_RTOS_USED == RENESAS_RI600V4 )
    ,
...
uint8_t * const _CTBL[] = { __sectop( "C_1" ), __sectop( "C_2" ),
                            __sectop( "C" ),
        #ifdef BSP_MCU_DOUBLE_PRECISION_FLOATING_POINT
                            __sectop( "C_8" ),
        #endif
                            __sectop( "W_1" ), __sectop( "W_2" ),
                            __sectop( "W" ) };

        /* Preprocessor directive */
        #pragma packoption

        /* This is to ensure compatibility with new L section in version 1.1 and
         * up of the RXC compiler.  Do not remove! */
        #pragma section C L
