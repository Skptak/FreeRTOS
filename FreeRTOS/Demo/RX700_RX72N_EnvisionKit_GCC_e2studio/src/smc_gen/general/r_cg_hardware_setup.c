...
{
    /* Start user code for r_undefined_exception. Do not edit comment generated
     * here */
    /* End user code. Do not edit comment generated here */
}
...
void R_FIT_Board_Support_Settings( void )
{
    /* Do not call any functions which enables generating any interrupt
     * requests. */

    /* GPIO for LED */
    R_GPIO_PinWrite( U_GPIO_PIN_LED0,
                     ( gpio_level_t ) LED_OFF ); // for the initial level after
                                                 // input --> output
    ...
    R_SCI_Open( U_SCI_UART_CLI_SCI_CH,
                SCI_MODE_ASYNC,
                &xSerialSciConfig,
                vSerialSciCallback,
                &xSerialSciHandle );
