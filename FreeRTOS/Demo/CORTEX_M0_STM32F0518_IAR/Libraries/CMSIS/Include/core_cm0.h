...
typedef struct
{
    ...
    __I uint32_t CALIB; /*!< Offset: 0x00C (R/ )  SysTick Calibration Register
        ...
        /** \ingroup  CMSIS_core_register
          ...
          Cortex-M0 Core Debug Registers (DCB registers, SHCSR, and DFSR) are
          only accessible over DAP and not via processor. Therefore they are not
          covered by the Cortex-M0 header file.
          @{
         */
