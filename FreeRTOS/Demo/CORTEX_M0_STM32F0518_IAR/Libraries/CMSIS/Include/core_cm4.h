...
extern "C" {
    ...
    /** \defgroup CMSIS_MISRA_Exceptions  CMSIS MISRA-C:2004 Compliance
      Exceptions CMSIS violates following MISRA-C2004 Rules:

       - Violates MISRA 2004 Required Rule 8.5, object/function definition in
      header file.<br> Function definitions in header files are used to allow
      'inlining'.

       - Violates MISRA 2004 Required Rule 18.4, declaration of union type or
      object of union type: '{...}'.<br> Unions are used for effective
      representation of core registers.

       - Violates MISRA 2004 Advisory Rule 19.7, Function-like macro
      defined.<br> Function-like macros are used to allow more efficient code.
    ...
    #define __CM4_CMSIS_VERSION_SUB \
        ( 0x10 ) /*!< [15:0]  CMSIS HAL sub version  */
    ...
    /*!< __FPU_USED to be checked prior to making use of FPU specific registers
     * and functions */
    #if defined( __CC_ARM )
