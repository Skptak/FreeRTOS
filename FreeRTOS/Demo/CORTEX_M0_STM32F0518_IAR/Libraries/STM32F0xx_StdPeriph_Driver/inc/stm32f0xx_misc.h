...
typedef struct
{
    uint8_t NVIC_IRQChannel; /*!< Specifies the IRQ channel to be enabled or
                                ...
                                IRQn_Type (For the complete STM32 Devices IRQ
                                Channels list, please refer to stm32f0xx.h file)
                              */

    uint8_t NVIC_IRQChannelPriority; /*!< Specifies the priority level for the
                                        IRQ channel specified in
                                        NVIC_IRQChannel. This parameter can be a
    ...
    FunctionalState NVIC_IRQChannelCmd; /*!< Specifies whether the IRQ channel
                                           ...
                                           can be set either to ENABLE or
                                           DISABLE */
} NVIC_InitTypeDef;
