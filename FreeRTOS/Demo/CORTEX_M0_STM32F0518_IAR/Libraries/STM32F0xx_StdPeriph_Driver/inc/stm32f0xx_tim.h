...
typedef struct
{
    ...
    uint32_t TIM_Pulse; /*!< Specifies the pulse value to be loaded into the
                           ...
                           number between 0x0000 and 0xFFFF ( or 0xFFFFFFFF for
                           TIM2) */
...
typedef struct
{
    ...
    uint16_t TIM_DeadTime; /*!< Specifies the delay time between the
                              switching-off and the switching-on of the outputs.
 ...
 */
    ...
    #define IS_TIM_ALL_PERIPH( PERIPH )                         \
        ( ( ( PERIPH ) == TIM1 ) || ( ( PERIPH ) == TIM2 ) ||   \
          ( ( PERIPH ) == TIM3 ) || ( ( PERIPH ) == TIM6 ) ||   \
          ( ( PERIPH ) == TIM14 ) || ( ( PERIPH ) == TIM15 ) || \
    ...
    #define IS_TIM_LIST4_PERIPH( PERIPH )                       \
        ( ( ( PERIPH ) == TIM1 ) || ( ( PERIPH ) == TIM2 ) ||   \
          ( ( PERIPH ) == TIM3 ) || ( ( PERIPH ) == TIM14 ) ||  \
          ( ( PERIPH ) == TIM15 ) || ( ( PERIPH ) == TIM16 ) || \
          ( ( PERIPH ) == TIM17 ) )

    /* LIST4: TIM 1, 2, 3, 15, 16 and 17 */
    #define IS_TIM_LIST5_PERIPH( PERIPH )                      \
        ( ( ( PERIPH ) == TIM1 ) || ( ( PERIPH ) == TIM2 ) ||  \
          ( ( PERIPH ) == TIM3 ) || ( ( PERIPH ) == TIM15 ) || \
          ( ( PERIPH ) == TIM16 ) || ( ( PERIPH ) == TIM17 ) )
 ...
 */
    ...
    #define TIM_ICPSC_DIV1                                                  \
        ( ( uint16_t ) 0x0000 ) /*!< Capture performed each time an edge is \
 ...
 */
    ...
    #define IS_TIM_DMA_BASE( BASE )                                            \
        ( ( ( BASE ) == TIM_DMABase_CR1 ) ||                                   \
          ...
          ( ( BASE ) == TIM_DMABase_BDTR ) || ( ( BASE ) == TIM_DMABase_OR ) )
/**
 * @}
 */
 ...
 */
    ...
    #define TIM_UpdateSource_Global                                         \
        ( ( uint16_t ) 0x0000 ) /*!< Source of update is the counter        \
                                   overflow/underflow or the setting of UG  \
                                   bit, or an update generation through the \
                                   slave mode controller. */
    #define TIM_UpdateSource_Regular                             \
        ( ( uint16_t ) 0x0001 ) /*!< Source of update is counter \
                                   overflow/underflow. */
 ...
 */
    ...
    #define IS_TIM_GET_FLAG( FLAG )                                           \
        ( ( ( FLAG ) == TIM_FLAG_Update ) || ( ( FLAG ) == TIM_FLAG_CC1 ) ||  \
          ...
          ( ( FLAG ) == TIM_FLAG_Break ) || ( ( FLAG ) == TIM_FLAG_CC1OF ) || \
          ( ( FLAG ) == TIM_FLAG_CC2OF ) || ( ( FLAG ) == TIM_FLAG_CC3OF ) || \
          ( ( FLAG ) == TIM_FLAG_CC4OF ) )

    #define IS_TIM_CLEAR_FLAG( TIM_FLAG )                         \
        ( ( ( ( TIM_FLAG ) & ( uint16_t ) 0xE100 ) == 0x0000 ) && \
          ( ( TIM_FLAG ) != 0x0000 ) )
/**
 * @}
 */
