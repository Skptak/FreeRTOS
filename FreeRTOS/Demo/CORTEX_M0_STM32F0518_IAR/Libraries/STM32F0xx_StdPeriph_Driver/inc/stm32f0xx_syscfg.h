...
extern "C" {
    ...
    #define SYSCFG_DMARemap_TIM17                                            \
        SYSCFG_CFGR1_TIM17_DMA_RMP /* Remap TIM17 DMA requests from channel1 \
                                      to channel2 */
    #define SYSCFG_DMARemap_TIM16                                            \
        SYSCFG_CFGR1_TIM16_DMA_RMP /* Remap TIM16 DMA requests from channel3 \
                                      to channel4 */
    #define SYSCFG_DMARemap_USART1Rx                                       \
        SYSCFG_CFGR1_USART1RX_DMA_RMP /* Remap USART1 Rx DMA requests from \
                                         channel3 to channel5 */
    #define SYSCFG_DMARemap_USART1Tx                                       \
        SYSCFG_CFGR1_USART1TX_DMA_RMP /* Remap USART1 Tx DMA requests from \
                                         channel2 to channel4 */
    #define SYSCFG_DMARemap_ADC1                                             \
        SYSCFG_CFGR1_ADC_DMA_RMP /* Remap ADC1 DMA requests from channel1 to \
                                    channel2 */
    ...
    #define SYSCFG_Break_PVD                                                 \
        SYSCFG_CFGR2_PVD_LOCK /*!< Connects the PVD event to the Break Input \
                                 of TIM1 */
    #define SYSCFG_Break_SRAMParity                                       \
        SYSCFG_CFGR2_SRAM_PARITY_LOCK /*!< Connects the SRAM_PARITY error \
                                         signal to the Break Input of TIM1 */
    #define SYSCFG_Break_Lockup                                             \
        SYSCFG_CFGR2_LOCKUP_LOCK /*!< Connects Lockup output of CortexM0 to \
