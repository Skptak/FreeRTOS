...
typedef struct
{
    uint16_t SPI_Direction; /*!< Specifies the SPI unidirectional or
                               bidirectional data mode. This parameter can be a
                               value of @ref SPI_data_direction */
    ...
    uint16_t SPI_BaudRatePrescaler; /*!< Specifies the Baud Rate prescaler value
                                       ...
                                       derived from the master clock. The slave
                                       clock does not need to be set. */
 ...
 */
    ...
    #define IS_SPI_I2S_GET_FLAG( FLAG )                                        \
        ( ( ( FLAG ) == SPI_I2S_FLAG_BSY ) ||                                  \
          ...
          ( ( FLAG ) == I2S_FLAG_CHSIDE ) || ( ( FLAG ) == I2S_FLAG_UDR ) )
/**
 * @}
 */
