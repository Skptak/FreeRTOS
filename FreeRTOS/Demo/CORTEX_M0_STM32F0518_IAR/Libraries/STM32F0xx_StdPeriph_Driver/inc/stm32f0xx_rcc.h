 ...
 */
    ...
    #define IS_RCC_ADCCLK( ADCCLK )                 \
        ( ( ( ADCCLK ) == RCC_ADCCLK_HSI14 ) ||     \
          ( ( ADCCLK ) == RCC_ADCCLK_PCLK_Div2 ) || \
 ...
 */
    ...
    #define IS_RCC_CECCLK( CECCLK )                  \
        ( ( ( CECCLK ) == RCC_CECCLK_HSI_Div244 ) || \
          ( ( CECCLK ) == RCC_CECCLK_LSE ) )
 ...
 */
    ...
    #define IS_RCC_AHB_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0xFEA1FFAA ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
    #define IS_RCC_AHB_RST_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0xFEA1FFFF ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
 ...
 */
    ...
    #define IS_RCC_APB1_PERIPH( PERIPH ) \
        ( ( ( ( PERIPH ) &0x8F9DB6EC ) == 0x00 ) && ( ( PERIPH ) != 0x00 ) )
/**
 * @}
 */
