 ...
 *     @arg SYSCFG_MemoryRemap_SystemMemory: System Flash memory mapped at
 * 0x00000000
 ...
 *   This parameter can be one of the following values:
 *     @arg SYSCFG_DMARemap_TIM17: Remap TIM17 DMA requests from channel1 to
 * channel2
 *     @arg SYSCFG_DMARemap_TIM16: Remap TIM16 DMA requests from channel3 to
 * channel4
 *     @arg SYSCFG_DMARemap_USART1Rx: Remap USART1 Rx DMA requests from channel3
 * to channel5
 *     @arg SYSCFG_DMARemap_USART1Tx: Remap USART1 Tx DMA requests from channel2
 * to channel4
 *     @arg SYSCFG_DMARemap_ADC1: Remap ADC1 DMA requests from channel1 to
 * channel2
 ...
 * @note   When disabled, Default DMA channel is mapped to the selected
 * peripheral
 * @note
 ...
 *   This parameter can be one of the following values:
 *     @arg SYSCFG_I2CFastModePlus_PB6: Configure fast mode plus driving
 * capability for PB6
 *     @arg SYSCFG_I2CFastModePlus_PB7: Configure fast mode plus driving
 * capability for PB7
 *     @arg SYSCFG_I2CFastModePlus_PB8: Configure fast mode plus driving
 * capability for PB8
 *     @arg SYSCFG_I2CFastModePlus_PB9: Configure fast mode plus driving
 * capability for PB9
 * @param  NewState: new state of the DMA channel remapping.
 *         This parameter can be: ENABLE or DISABLE.
 ...
 *                                for EXTI lines where x can be (A, B, C, D or
 * F).
 ...
 *     @arg SYSCFG_Break_SRAMParity: Connects the SRAM_PARITY error signal to
 * the Break Input of TIM1 .
 *     @arg SYSCFG_Break_Lockup: Connects Lockup output of CortexM0 to the break
 * input of TIM1.
 * @retval None
 */
