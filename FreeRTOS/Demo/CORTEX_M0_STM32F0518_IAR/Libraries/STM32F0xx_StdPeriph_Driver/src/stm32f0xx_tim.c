 ...
 * @param  TIMx: where x can be  1, 2, 3, 14, 15, 16 and 17 to select the TIM
 * peripheral.
...
@verbatim
 ...
 ===============================================================================
       ...
       ===================================================================
       [..] After configuring the Timer channel(s) in the appropriate Output
Compare mode:
...
void TIM_OC1Init( TIM_TypeDef * TIMx, TIM_OCInitTypeDef * TIM_OCInitStruct )
{
        ...
        ( TIMx == TIM17 ) )
    {
        ...
        assert_param(
            IS_TIM_OCIDLE_STATE( TIM_OCInitStruct->TIM_OCIdleState ) );
 ...
 * @param  TIMx: where x can be 1, 2, 3, 14, 15, 16 or 17 to select the TIM
 * peripheral.
 ...
 * @param  TIMx: where x can be 1, 2, 3, 6, 14, 15, 16 or 17 to select the TIMx
 * peripheral.
 ...
 * @param  TIMx: where x can be 1, 2, 3, 6, 14, 15, 16 or 17 to select the TIM
 * peripheral.
 ...
 *   - TIM15 can have only TIM_IT_Update, TIM_IT_CC1, TIM_IT_CC2 or
 * TIM_IT_Trigger.
 *   - TIM14, TIM16 and TIM17 can have TIM_IT_Update or TIM_IT_CC1.
 *   - TIM_IT_Break is used only with TIM1 and TIM15.
 *   - TIM_IT_COM is used only with TIM1, TIM15, TIM16 and TIM17.
 ...
 * @param  TIMx: where x can be 1, 2, 3, 15, 16 or 17  to select the TIM
 * peripheral.
 ...
 * @param  TIMx: where x can be 1, 2, 3, 6, 15, 16 or 17 to select the TIM
 * peripheral.
