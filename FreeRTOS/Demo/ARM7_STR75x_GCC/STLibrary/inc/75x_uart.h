...
typedef enum
{
    ...
    #define UART_StopBits_1                      \
        0xFFF7 /* One stop bit is transmitted at \
                  the end of frame */
    #define UART_StopBits_2                     \
        0x0008 /* Tow stop bits are transmitted \
                  at the end of frame */
    ...
    /* UART0 DMA On Error */
    #define UART0_DMAOnError_Enable               \
        0xFFFB /* DMA receive request enabled     \
                   when the UART0 error interrupt \
                   is asserted. */
    #define UART0_DMAOnError_Disable              \
