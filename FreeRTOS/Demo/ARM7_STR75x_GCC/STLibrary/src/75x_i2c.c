...
void I2C_Init( I2C_InitTypeDef * I2C_InitStruct )
{
    ...
    if( I2C_InitStruct->I2C_CLKSpeed <= 100000 )
    {
        ...
        /* Set speed value and clear FM/SM bit for standard mode in LSB clock
         * divider */
...
void I2C_Cmd( FunctionalState NewState )
{
    if( NewState == ENABLE )
    {
        /* Enable the I2C peripheral by setting twice the PE bit on the CR
         * register */
        I2C->CR |= I2C_PE_Set;
        I2C->CR |= I2C_PE_Set;
    }
 ...
 *                  as parameter.
 * Input          : - I2C_EVENT: specifies the event to be checked. This
 ...
 * Input          : - Address: specifies the slave address which will be
 *transmitted
 *                  - Direction: specifies whether the I2C device will be a
 *                    Transmitter or a Receiver. This parameter can be one of
 ...
 *                         - I2C_FLAG_ADD10: 10-bit addressing in Master mode
 *flag
...
void I2C_ClearFlag( u16 I2C_FLAG, ... )
{
    ...
    else if( I2C_FLAG == I2C_FLAG_SB || I2C_FLAG == I2C_FLAG_ADSL ||
             I2C_FLAG == I2C_FLAG_BTF || I2C_FLAG == I2C_FLAG_TRA )
    {
        ...
        {
            /* return the received byte in the variable passed as second
             * parameter  */
            Tmp = I2C->DR;
        }
    }
