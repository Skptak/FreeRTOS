 ...
 *                  contains the configuration information for the TB
...
void TB_Init( TB_InitTypeDef * TB_InitStruct )
{
    ...
    {
        TB->SCR &= TB_SME_Reset & TB_SlaveModeSelection_Mask &
                   TB_TriggerSelection_Mask;
 ...
 *                         - TB_CounterMode_CenterAligned: TB Center Aligned
 ...
 *                         - TB_SMSMode_External: The rising edge of selected
 ...
 * Description    : Checks whether the specified TB interrupt has occurred or
 *not. Input          : TB_IT: specifies the interrupt to check. This parameter
