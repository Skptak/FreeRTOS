 ...
 *                  contains the configuration information for the WDG
 ...
 * Input          : None
 * Output         : None
 * Return         : The new state of WDG End of Count(EC) interrupt (SET or
 *RESET).
 *******************************************************************************/
ITStatus WDG_GetITStatus( void )
{
    if( ( ( WDG->SR & WDG_IT_EC ) != RESET ) &&
        ( ( WDG->MR & WDG_IT_EC ) != RESET ) )
    {
        return SET;
    }
    else
