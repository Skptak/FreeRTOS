 ...
 * Input          : - SSPx: where x can be 0 or 1 to select the SSP peripheral.
 *                  - SSP_InitStruct: pointer to a SSP_InitTypeDef structure
 ...
 *                    following values:
 *                         - SSP_IT_TxFifo: Transmit FIFO half empty or less
 *interrupt
 *                         - SSP_IT_RxFifo: Receive FIFO half full or less
 *interrupt
 ...
 *                           request enabled
 *                         - SSP0_DMATxReq_Burst: Transmit FIFO DMA burst
 *request enabled Output         : None Return         : None
 *******************************************************************************/
 ...
 *                    be enabled. This parameter can be one of the following
 *                    values:
 *                         - SSP0_DMARxReq_Single: Receive FIFO DMA burst
 *request enabled
 *                         - SSP0_DMARxReq_Burst: Receive FIFO DMA single
 *request enabled Output         : None Return         : None
 *******************************************************************************/
 ...
 *                         - SSP_FLAG_RxFifoNotEmpty: Receive FIFO not empty
 *flag
 *                         - SSP_FLAG_TxFifoNotFull: Transmit FIFO not full flag
 *                         - SSP_FLAG_TxFifoEmpty: Transmit FIFO empty flag
 *                         - SSP_FLAG_TxFifo: Transmit FIFO half empty or less
 *flag
 *                         - SSP_FLAG_RxFifo: Receive FIFO half full or less
 *flag
 ...
 * Description    : Checks whether the specified SSP interrupt has occurred or
 *not. Input          : - SSPx: where x can be 0 or 1 to select the SSP
 *peripheral.
