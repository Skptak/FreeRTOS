 ...
 * Description    : Deinitializes the DMA streamx registers to their default
 *reset values. Input          : - DMA_Streamx: where x can be 0, 1, 2 or 3 to
 *select the DMA Stream. Output         : None Return         : None
 *******************************************************************************/
 ...
 *that contains the configuration information for the specified DMA stream.
 * Output         : None
 * Return         : None
 ******************************************************************************/
 ...
 *                    is located.
 *                    This member must be a number between 0 and the stream
 *BufferSize-1. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Checks whether the specified DMA interrupt has occured or
 *not. Input          : - DMA_IT: specifies the DMA interrupt source to check.
