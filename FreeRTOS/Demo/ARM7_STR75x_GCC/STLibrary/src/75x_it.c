 ...
 *                      The following routines are all empty, user can write
 *code for exceptions handlers and peripherals IRQ interrupts.
 ********************************************************************************
 * History:
 * 07/17/2006 : V1.0
 * 03/10/2006 : V0.1
 ...
 * Description    : This function handles TIM2 Output Compare 2 interrupt
 ...
 * Description    : This function handles TIM2 Output Compare 1 interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : This function handles TIM1 Output Compare 2 interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : This function handles TIM1 Output Compare 1 interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : This function handles TIM0 Output Compare 2 interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : This function handles External lines 14 to 1 interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : This function handles Flash and SMI global interrupt
 *request. Input          : None Output         : None Return         : None
 *******************************************************************************/
