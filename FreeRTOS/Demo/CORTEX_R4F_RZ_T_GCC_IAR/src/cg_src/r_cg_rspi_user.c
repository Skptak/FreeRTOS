...
#endif /* __ICCARM__ */
    void
    r_rspi1_transmit_interrupt( void )
{
    uint16_t frame_cnt;
 ...
 * Description  : This function is a callback function when RSPI1 finishes
