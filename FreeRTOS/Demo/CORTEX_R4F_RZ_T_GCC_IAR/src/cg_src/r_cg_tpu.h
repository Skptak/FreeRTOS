...
#define _TPU2_PCLKD_1024 \
    ( 0x07U ) /* TPU2 Internal clock: counts on PCLKD/1024 */
#define _TPU3_PCLKD_1024 \
    ( 0x05U ) /* TPU3 Internal clock: counts on PCLKD/1024 */
#define _TPU4_PCLKD_1024 \
    ( 0x06U ) /* TPU4 Internal clock: counts on PCLKD/1024 */
#define _TPU8_PCLKD_1024 \
    ( 0x07U ) /* TPU8 Internal clock: counts on PCLKD/1024 */
#define _TPU9_PCLKD_1024 \
    ( 0x05U ) /* TPU9 Internal clock: counts on PCLKD/1024 */
#define _TPU10_PCLKD_1024 \
    ( 0x06U ) /* TPU10 Internal clock: counts on PCLKD/1024 */
...
#define _TPU_TCLKC_06                                      \
    ( 0x06U ) /* External clock: counts on TCLKC pin input \
               */
#define _TPU_TCLKC_05                                                     \
    ( 0x05U )                /* External clock: counts on TCLKC pin input \
                              */
...
#define _TPU_TCLKG_06                                      \
    ( 0x06U ) /* External clock: counts on TCLKG pin input \
               */
#define _TPU_TCLKG_05                                                     \
    ( 0x05U )                /* External clock: counts on TCLKG pin input \
                              */
#define _TPU_TCLKH ( 0x07U ) /* External clock: counts on TCLKH pin input */
#define _TPU2_COUNT \
    ( 0x07U ) /* TPU1: Counts on TPU2.TCNT counter overflow/underflow */
#define _TPU5_COUNT \
    ( 0x07U ) /* TPU4: Counts on TPU5.TCNT counter overflow/underflow */
#define _TPU8_COUNT \
    ( 0x07U ) /* TPU7: Counts on TPU8.TCNT counter overflow/underflow */
#define _TPU11_COUNT \
    ( 0x07U ) /* TPU10: Counts on TPU11.TCNT counter overflow/underflow */
...
#define _TPU_CKCL_A \
    ( 0x20U ) /* TCNT cleared by TGRA compare match/input capture */
#define _TPU_CKCL_B \
    ( 0x40U ) /* TCNT cleared by TGRB compare match/input capture */
#define _TPU_CKCL_SYN                                                    \
    ( 0x60U ) /* TCNT cleared by counter clearing in another synchronous \
                 channel */
#define _TPU_CKCL_C \
    ( 0xA0U ) /* TCNT cleared by TGRC compare match/input capture */
#define _TPU_CKCL_D \
    ( 0xC0U ) /* TCNT cleared by TGRD compare match/input capture */
...
#define _TPU_BFA_NORMAL \
    ( 0x00U ) /* TPUm.TGRA operates normally (m = 0, 3, 6, 9) */
#define _TPU_BFA_BUFFER \
    ( 0x10U ) /* TPUm.TGRA and TPUm.TGRC used together for buffer operation */
/* Buffer Operation B (BFB) */
#define _TPU_BFB_NORMAL \
    ( 0x00U ) /* TPUm.TGRB operates normally (m = 0, 3, 6, 9) */
#define _TPU_BFB_BUFFER \
    ( 0x20U ) /* TPUm.TGRB and TPUm.TGRD used together for buffer operation */
/* TGRB Input Capture Input Select (ICSELB) */
#define _TPU_ICSELB_BPIN \
    ( 0x00U ) /* Input capture input source is TIOCBn pin */
#define _TPU_ICSELB_APIN \
    ( 0x40U ) /* Input capture input source is TIOCAn pin (n = 0 to 11) */
/* TGRD Input Capture Input Select (ICSELD) */
#define _TPU_ICSELD_DPIN \
    ( 0x00U ) /* Input capture input source is TIOCDn pin */
#define _TPU_ICSELD_CPIN \
    ( 0x80U ) /* Input capture input source is TIOCCn pin (n = 0, 3, 6, 9) */

/*
    Timer I/O Control Register (TIOR)
*/
/* I/O Control A (IOA[3:0]) for TPU0.TIORH, TPU1.TIOR, TPU2.TIOR, TPU3.TIORH,
   TPU4.TIORH, TPU5.TIOR TPU6.TIORH, TPU7.TIOR, TPU8.TIOR, TPU9.TIORH,
   TPU10.TIOR, TPU11.TIOR*/
#define _TPU_IOA_DISABLE ( 0x00U ) /* Output prohibited */
#define _TPU_IOA_LL \
    ( 0x01U ) /* Initial output is low. Low output at compare match */
#define _TPU_IOA_LH \
    ( 0x02U ) /* Initial output is low. High output at compare match */
#define _TPU_IOA_LT \
    ( 0x03U ) /* Initial output is low. Toggle output at compare match */
#define _TPU_IOA_HL \
    ( 0x05U ) /* Initial output is high. Low output at compare match */
#define _TPU_IOA_HH \
    ( 0x06U ) /* Initial output is high. High output at compare match */
#define _TPU_IOA_HT \
    ( 0x07U ) /* Initial output is high. Toggle output at compare match */
...
#define _TPU_IOA_EX                                                           \
    ( 0x0CU ) /* Input capture at TPU1.TCNT or TPU4.TCNT up-count/down-count  \
                               or TPU7.TCNT or TPU10.TCNT up-count/down-count \
               */
#define _TPU_IOA_TGRA                                                          \
    ( 0x0DU ) /* Input capture at TPU0.TGRA or TPU3.TGRA compare match/input   \
                 capture or TPU6.TGRA or TPU9.TGRA compare match/input capture \
               */
/* I/O Control B (IOB[3:0]) for TPU0.TIORH, TPU1.TIOR, TPU2.TIOR, TPU3.TIORH,
   TPU4.TIORH, TPU5.TIOR TPU6.TIORH, TPU7.TIOR, TPU8.TIOR, TPU9.TIORH,
   TPU10.TIOR, TPU11.TIOR*/
#define _TPU_IOB_DISABLE ( 0x00U ) /* Output prohibited */
#define _TPU_IOB_LL \
    ( 0x10U ) /* Initial output is low. Low output at compare match */
#define _TPU_IOB_LH \
    ( 0x20U ) /* Initial output is low. High output at compare match */
#define _TPU_IOB_LT \
    ( 0x30U ) /* Initial output is low. Toggle output at compare match */
#define _TPU_IOB_HL \
    ( 0x50U ) /* Initial output is high. Low output at compare match */
#define _TPU_IOB_HH \
    ( 0x60U ) /* Initial output is high. High output at compare match */
#define _TPU_IOB_HT \
    ( 0x70U ) /* Initial output is high. Toggle output at compare match */
...
#define _TPU_IOB_EX                                                          \
    ( 0xC0U ) /* Input capture at TPU1.TCNT or TPU4.TCNT up-count/down-count \
                               or TPU7.TCNT or TPU10.TCNT                    \
                 up-count/down-count*/
#define _TPU_IOB_TGRC                                                        \
    ( 0xD0U ) /* Input capture at TPU0.TGRC or TPU3.TGRC compare match/input \
                 capture or TPU6.TGRC or TPU9.TGRC compare match/input       \
                 capture*/
...
#define _TPU_NFAEN_DISABLE \
    ( 0x00U ) /* The noise filter for the TIOCAm pin is disabled */
#define _TPU_NFAEN_ENABLE \
    ( 0x01U ) /* The noise filter for the TIOCAm pin is enabled */
/* Noise Filter B Enable Bit (NFBEN) */
#define _TPU_NFBEN_DISABLE \
    ( 0x00U ) /* The noise filter for the TIOCBm pin is disabled */
#define _TPU_NFBEN_ENABLE \
    ( 0x02U ) /* The noise filter for the TIOCBm pin is enabled */
/* Noise Filter C Enable Bit (NFCEN) */
#define _TPU_NFCEN_DISABLE \
    ( 0x00U ) /* The noise filter for the TIOCCm pin is disabled */
#define _TPU_NFCEN_ENABLE \
    ( 0x04U ) /* The noise filter for the TIOCCm pin is enabled */
/* Noise Filter D Enable Bit (NFDEN) */
#define _TPU_NFDEN_DISABLE \
    ( 0x00U ) /* The noise filter for the TIOCDm pin is disabled */
#define _TPU_NFDEN_ENABLE \
    ( 0x08U ) /* The noise filter for the TIOCDm pin is enabled */
...
#define _TPU_NFCS_EXCLK \
    ( 0x30U ) /* The clock source for counting is the external clock */

/*
    PWM Feedback Select Register (PWMFBSLR)
*/
/* TPU (Unit 0) Internal PWM Feedback Enable (TPU0EN)*/
#define _TPU_TPU0EN_DISABLE                                            \
    ( 0x00000000UL ) /* Internal PWM feedback input function unit 0 is \
                        disabled */
#define _TPU_TPU0EN_ENABLE                                                     \
    ( 0x00000001UL ) /* Internal PWM feedback input function unit 0 is enabled \
                      */
/* Internal PWM Feedback Input Source Select 0 (FBSL0[2:0]) */
#define _TPU0_PWM_SIG_MTU34 \
    ( 0x00000010UL ) /* PWM output signals of MTU3 and MTU4 */
#define _TPU0_PWM_SIG_MTU67 \
    ( 0x00000014UL ) /* PWM output signals of MTU6 and MTU7 */
#define _TPU0_PWM_SIG_GPT02 \
    ( 0x00000018UL ) /* PWM output signals of GPT0 to GPT2 */
/* TPU (Unit 1) Internal PWM Feedback Enable (TPU1EN)*/
#define _TPU_TPU1EN_DISABLE                                            \
    ( 0x00000000UL ) /* Internal PWM feedback input function unit 1 is \
                        disabled */
#define _TPU_TPU1EN_ENABLE                                                     \
    ( 0x00000100UL ) /* Internal PWM feedback input function unit 1 is enabled \
                      */
/* Internal PWM Feedback Input Source Select 1 (FBSL1[2:0]) */
#define _TPU1_PWM_SIG_MTU34 \
    ( 0x00001000UL ) /* PWM output signals of MTU3 and MTU4 */
#define _TPU1_PWM_SIG_MTU67 \
    ( 0x00001400UL ) /* PWM output signals of MTU6 and MTU7 */
#define _TPU1_PWM_SIG_GPT02 \
    ( 0x00001800UL ) /* PWM output signals of GPT0 to GPT2 */
/*
...
#define _TPU_TTGE_DISABLE \
    ( 0x00U ) /* A/D converter start request generation disabled */
#define _TPU_TTGE_ENABLE \
    ( 0x80U ) /* A/D converter start request generation enabled */
