...
void R_CGC_Create( void )
{
    ...
    SYSTEM.SCKCR.LONG = _CGC_CKIO_0 | _CGC_TCLK_0 | _CGC_PCLKE_0 |
                        _CGC_PCLKF_0 | _CGC_PCLKG_0 | _CGC_SERICLK_0 |
    ...
    /* Delta-sigma interface operation setting, DSCLK0 and DSCLK1 both in master
     * mode */
    SYSTEM.DSCR.LONG = _CGC_DSSEL0_MASTER | _CGC_DSCLK0_0 | _CGC_DSSEL1_MASTER |
                       _CGC_DSCLK1_0;
}
 ...
 *                 And dummy read the register in order to fix the register
 *value. Arguments    : none Return Value : none
 ***********************************************************************************************************************/
