...
***********************************************************************************************************************/
#ifndef __TYPEDEF__
    #define DI() \
        asm( "cpsid i" ) /* Disable IRQ interrupt (Set CPSR.I bit to 1)  */
    #define EI() \
        asm( "cpsie i" ) /* Enable IRQ interrupt (Clear CPSR.I bit to 0) */
    #define nop()         asm( "nop" )
    ...
    #define MD_ARGERROR \
        ( MD_ERRORBASE + 0x01U ) /* error argument input error */
