...
void R_RSPI1_Create( void )
{
    ...
    RSPI1.SPPCR.BYTE = _RSPI_MOSI_LEVEL_HIGH | _RSPI_MOSI_FIXING_MOIFV_BIT |
                       _RSPI_OUTPUT_PIN_CMOS | _RSPI_LOOPBACK_DISABLED |
                       _RSPI_LOOPBACK2_DISABLED;
    ...
    RSPI1.SPCMD0.WORD = _RSPI_RSPCK_SAMPLING_EVEN | _RSPI_RSPCK_POLARITY_HIGH |
                        _RSPI_BASE_BITRATE_1 | _RSPI_SIGNAL_ASSERT_SSL0 |
                        _RSPI_SSL_KEEP_DISABLE | _RSPI_DATA_LENGTH_BITS_8 |
                        _RSPI_MSB_FIRST | _RSPI_NEXT_ACCESS_DELAY_DISABLE |
                        _RSPI_NEGATION_DELAY_DISABLE |
 ...
 *DMAC) tx_num - buffer size Return Value : status - MD_OK or MD_ARGERROR
 ***********************************************************************************************************************/
