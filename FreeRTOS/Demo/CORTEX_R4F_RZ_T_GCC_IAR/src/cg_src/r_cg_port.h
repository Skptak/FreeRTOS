...
#define _Pm0_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm0 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm0_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0001U ) /* Pm0 pull-down resistor connected */
#define _Pm0_PULLUPDOWN_PULLUP_ON \
    ( 0x0002U ) /* Pm0 pull-up resistor connected */
#define _Pm1_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm1 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm1_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0004U ) /* Pm1 pull-down resistor connected */
#define _Pm1_PULLUPDOWN_PULLUP_ON \
    ( 0x0008U ) /* Pm1 pull-up resistor connected */
#define _Pm2_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm2 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm2_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0010U ) /* Pm2 pull-down resistor connected */
#define _Pm2_PULLUPDOWN_PULLUP_ON \
    ( 0x0020U ) /* Pm2 pull-up resistor connected */
#define _Pm3_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm3 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm3_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0040U ) /* Pm3 pull-down resistor connected */
#define _Pm3_PULLUPDOWN_PULLUP_ON \
    ( 0x0080U ) /* Pm3 pull-up resistor connected */
#define _Pm4_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm4 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm4_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0100U ) /* Pm4 pull-down resistor connected */
#define _Pm4_PULLUPDOWN_PULLUP_ON \
    ( 0x0200U ) /* Pm4 pull-up resistor connected */
#define _Pm5_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm5 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm5_PULLUPDOWN_PULLDOWN_ON \
    ( 0x0400U ) /* Pm5 pull-down resistor connected */
#define _Pm5_PULLUPDOWN_PULLUP_ON \
    ( 0x0800U ) /* Pm5 pull-up resistor connected */
#define _Pm6_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm6 pull-up resistor and pull-down resistor not connected \
                 */
...
#define _Pm7_PULLUPDOWN_DISABLE                                              \
    ( 0x0000U ) /* Pm7 pull-up resistor and pull-down resistor not connected \
                 */
#define _Pm7_PULLUPDOWN_PULLDOWN_ON \
    ( 0x4000U ) /* Pm7 pull-down resistor connected */
#define _Pm7_PULLUPDOWN_PULLUP_ON \
    ( 0x8000U ) /* Pm7 pull-up resistor connected */
