...
void R_TPU_Create( void )
{
    ...
    TPU9.TIER.BYTE |= _TPU_TGIEA_DISABLE | _TPU_TGIEB_DISABLE |
                      _TPU_TGIEC_DISABLE | _TPU_TGIED_DISABLE |
    ...
    TPU9.TMDR.BYTE = _TPU_NORMAL | _TPU_BFA_NORMAL | _TPU_BFB_NORMAL |
                     _TPU_ICSELB_BPIN | _TPU_ICSELD_DPIN;
