 ...
 *                 the SCI5 is used. This can be modified to the SCI connected
 *to the PMOD interface. The SCI driver file will also be required.
 *
 ...
 *                 Init_LCD(); Initialise the serial port and set up the
 *display.
 *
 *                 Clear the display.
 *                 The font colour is set to white and background colour to
 *black.
 *
...
/* Multiple inclusion prevention macro */
    ...
    ***********************************************************************************************************************/
     ...
     *  SCREEN
     *
     *  The screen size is 128 x 128 pixels, with coordinate 0,0 at the top
     *left. The display controller is ST7735 or ST7715.
     *
     ***********************************************************************************************************************/
    /* 16 lines @ 8 bits = 128. */
