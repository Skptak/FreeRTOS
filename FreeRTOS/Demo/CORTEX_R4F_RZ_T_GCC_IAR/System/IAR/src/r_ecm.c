...
void R_ECM_Init( void )
{
    ...
    result = R_ECM_Write_Reg32( ECM_COMMON,
                                &( ECM.ECMESSTC0.LONG ),
                                0xDFFFFFF7 );
    result = R_ECM_Write_Reg32( ECM_COMMON,
                                &( ECM.ECMESSTC1.LONG ),
    ...
    /* Mask ECM maskable, non-maskable interrupt and ECM reset of ECM compare
       match error (ECMMICFG2, ECMNMICFG2, ECMIRCFG2) */
    result = R_ECM_Write_Reg32( ECM_COMMON,
                                &( ECM.ECMMICFG2.LONG ),
                                0x00000000 );
    result = R_ECM_Write_Reg32( ECM_COMMON,
 ...
 * Description   : Wait about 15 us for ECM compare error stabilizeation by
 *using CMT0 Arguments    : none Return Value : none
 *******************************************************************************/
 ...
 * Arguments    :  reg_type
 *                     The type of ECM register (ECM_MASETR, ECM_CHECKER,
 *ECM_COMMON) *reg The address of ECM protected register value The 8-bit value
 *of writing to protected register Return Value : none
 *******************************************************************************/
 ...
 * Description   : Writing the special sequence for 32-bit ECM protected
 *register Arguments    :  reg_type The type of ECM register (ECM_MASETR,
 *ECM_CHECKER, ECM_COMMON) *reg The address of ECM protected register value The
 *32-bit value of writing to protected register Return Value : none
 *******************************************************************************/
