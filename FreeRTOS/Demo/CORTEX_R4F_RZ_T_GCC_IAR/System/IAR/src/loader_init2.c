 ...
 *                 When error source number 35 is generated, set P77 pin to
 *High. Arguments    : none Return Value : none
 *******************************************************************************/
void reset_check( void )
{
    ...
    else if( RST_SOURCE_SWR1 == SYSTEM.RSTSR0.LONG ) // Software reset 1 is
                                                     // generated
    {
        /* Clear reset status flag */
        r_rst_write_enable(); // Enable writing to the RSTSR0 register
    ...
    else if( RST_SOURCE_RES == SYSTEM.RSTSR0.LONG ) // RES# pin reset is
                                                    // generated
    {
        /* Clear reset status flag */
        r_rst_write_enable(); // Enable writing to the RSTSR0 register
