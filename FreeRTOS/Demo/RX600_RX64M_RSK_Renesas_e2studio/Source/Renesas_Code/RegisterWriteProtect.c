...
void EnablePRCR( uint16_t protect )
{
     ...
     * 			SCKCR, SCKCR2, SCKCR3, PLLCR, PLLCR2, BCKCR, MOSCCR, SOSCCR,
     * LOCOCR, ILOCOCR, HOCOCR, HOCOCR2, OSTDCR, OSTDSR
     *
     * PRC1 	Registers related to the operating modes:
     * 			SYSCR0, SYSCR1
     *
     * 			Registers related to the low power consumption functions:
     * 			SBYCR, MSTPCRA, MSTPCRB, MSTPCRC, MSTPCRD, OPCCR, RSTCKCR,
     * DPSBYCR, DPSIER0 to DPSIER3, DPSIFR0 to DPSIFR3, DPSIEGR0 to DPSIEGR3
     *
     ...
     * 			LVCMPCR, LVDLVLR, LVD1CR0, LVD1CR1, LVD1SR, LVD2CR0, LVD2CR1,
     * LVD2SR
     */
