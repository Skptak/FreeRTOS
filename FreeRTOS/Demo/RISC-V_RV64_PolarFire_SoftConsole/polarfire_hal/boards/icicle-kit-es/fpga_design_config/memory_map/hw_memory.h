...
extern "C" {
    ...
    #define LIBERO_SETTING_RESERVED_SNVM_SIZE \
        0x00000000 /* Length of memory block*/
#endif
    ...
    #define LIBERO_SETTING_RESERVED_ENVM_SIZE \
        0x00000000 /* Length of memory block*/
#endif
