...
extern "C" {
    ...
    /*Tip config: Referenced receivers in the CA bus are turned on for CA
    training. These burn static power.(0x01 => turn off ; 0x00 => no action ) */
    ...
    /*Tip config: Pick what trainings we want performed by the TIP, default is
     * 0x1F
     */
    ...
    /*in simulation we need to set this to 2, for hardware it will be dependent
    on the trace lengths */
