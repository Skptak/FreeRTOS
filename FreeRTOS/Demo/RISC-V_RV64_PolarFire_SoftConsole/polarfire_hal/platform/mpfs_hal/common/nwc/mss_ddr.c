...
static uint32_t ddr_setup( void )
{
    ...
    switch( ddr_training_state )
    {
            ...
            else if( retry_count == TOTAL_SWEEPS )
            {
                ...
                if( get_best_sweep( &index ) == 0U )
                {
                    ...
                    tip_cfg_params = ( ( tip_cfg_params &
                                         ( ~ADDRESS_CMD_OFFSETT_MASK ) ) |
                                       ( addr_cmd_value ) );
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_V_MASK ) ) |
                                 ( dpc_vrgen_v_value
                                   << BCLK_DPC_VRGEN_V_SHIFT ) );
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_H_MASK ) ) |
                                 ( dpc_vrgen_h_value
                                   << BCLK_DPC_VRGEN_H_SHIFT ) );
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_VS_MASK ) ) |
                                 ( dpc_vrgen_vs_value
                                   << BCLK_DPC_VRGEN_VS_SHIFT ) );
                    ddr_training_state = DDR_TRAINING_CHECK_FOR_OFFMODE;
                }
    ...
    #ifdef SWEEP_ENABLED
        {
            ...
            switch( sweep_state )
            {
                case INIT_SWEEP:
                    ...
                    __attribute__( ( fallthrough ) ); /* deliberately fall
                                                         through */
                case ADDR_CMD_OFFSET_SWEEP:
                    /*
                     * Record sweep result
                     */
                    sweep_results[ sweep_count_dpc_vs_bits ]
                     ...
                     */
                    addr_cmd_value++;
                    if( addr_cmd_value > LIBERO_SETTING_MAX_ADDRESS_CMD_OFFSET )
                    {
                        addr_cmd_value = LIBERO_SETTING_MIN_ADDRESS_CMD_OFFSET;
                    }
                    ...
                    else
                    {
                        ...
                        ddr_error_count = 0U;
                        error = 0U;
                        memfill( ( uint8_t * ) &calib_data,
                                 0U,
                                 sizeof( calib_data ) );
                        DDRCFG->DFI.PHY_DFI_INIT_START
                            .PHY_DFI_INIT_START = 0x00000000U;
                        /* reset controller */
                        DDRCFG->MC_BASE2.CTRLR_INIT.CTRLR_INIT = 0x00000000U;
                        CFG_DDR_SGMII_PHY->training_start
                            .training_start = 0x00000000U;
                        ddr_training_state = DDR_TRAINING_CHECK_FOR_OFFMODE;
                    }
                    break;
                ...
                case DPC_VRGEN_V_SWEEP:
                     ...
                     */
                    dpc_vrgen_v_value++;
                    if( dpc_vrgen_v_value > LIBERO_SETTING_MAX_DPC_V_GEN )
                    {
                        dpc_vrgen_v_value = LIBERO_SETTING_MIN_DPC_V_GEN;
                    }
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_V_MASK ) ) |
                ...
                case DPC_VRGEN_H_SWEEP:
                     ...
                     */
                    dpc_vrgen_h_value++;
                    if( dpc_vrgen_h_value > LIBERO_SETTING_MAX_DPC_H_GEN )
                    {
                        dpc_vrgen_h_value = LIBERO_SETTING_MIN_DPC_H_GEN;
                    }
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_H_MASK ) ) |
                ...
                case DPC_VRGEN_VS_SWEEP:
                     ...
                     */
                    dpc_vrgen_vs_value++;
                    if( dpc_vrgen_vs_value > LIBERO_SETTING_MAX_DPC_VS_GEN )
                    {
                        dpc_vrgen_vs_value = LIBERO_SETTING_MIN_DPC_VS_GEN;
                    }
                    dpc_bits = ( ( dpc_bits & ( ~BCLK_DPC_VRGEN_VS_MASK ) ) |
        ...
        case DDR_TRAINING_CHECK_FOR_OFFMODE:
            ...
            else
            {
                ...
                if( fabric_noise_en )
                {
                    ...
                    MSS_GPIO_set_outputs( GPIO2_LO,
                                          0x00000UL ); /* bits 15:0 - 0, noise
                                                          logic  disabled */
                    delay( 100 );
                    /*MSS_GPIO_set_outputs(GPIO2_LO, 0x00FFFUL);*/ /* bits 12:0
                                                                      - 1,  56%
                                                                      enabled */
                    noise_ena = ( 1 << num_of_noise_blocks_en ) - 1;
                    MSS_GPIO_set_outputs( GPIO2_LO,
                                          noise_ena ); /* num_of_noise_blocks_en
                                                        * 4.72% */
                    fabric_noise_en = 0;
                }
        ...
        case DDR_TRAINING_FLASH_REGS:
            ...
            CFG_DDR_SGMII_PHY->SOFT_RESET_DECODER_DRIVER
                .SOFT_RESET_DECODER_DRIVER = 1U;
            CFG_DDR_SGMII_PHY->SOFT_RESET_DECODER_ODT
                .SOFT_RESET_DECODER_ODT = 1U;
        ...
        case DDR_TRAINING_CALIBRATE_IO:
            ...
            ( void ) uprint32( g_debug_uart,
                               "\n\r PCODE = ",
                               ( CFG_DDR_SGMII_PHY->IOC_REG2.IOC_REG2 &
                                 0x7FU ) );
            ( void ) uprint32( g_debug_uart,
                               "\n\r NCODE = ",
                               ( ( ( CFG_DDR_SGMII_PHY->IOC_REG2.IOC_REG2 ) >>
    ...
    /* To verify if separate reset required for DDR4 - believe it is not */
        ...
        case DDR_TRAINING_ROTATE_CLK:
            ...
            CFG_DDR_SGMII_PHY->expert_pllcnt.expert_pllcnt = 0x66U; /* increment
                                                                     */
            for( uint32_t d = 0;
                 d < LIBERO_SETTING_TIP_CONFIG_PARAMS_BCLK_VCOPHS_OFFSET;
                 d++ )
            {
            ...
            CFG_DDR_SGMII_PHY->expert_dlycnt_mv_rd_dly_reg
                .expert_dlycnt_mv_rd_dly_reg = 0x1FU;
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
                .expert_dlycnt_load_reg1 = 0xFFFFFFFFU; /* setting to 1 to load
                                                           delaylines */
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
                .expert_dlycnt_load_reg1 = 0x00000000U;

            /* write w DFICFG_REG mv_rd_dly 0x00000000 #
               tip_apb_write(12'h89C, 32'h0);   mv_rd_dly  */
            CFG_DDR_SGMII_PHY->expert_dlycnt_mv_rd_dly_reg
                .expert_dlycnt_mv_rd_dly_reg = 0x0U;
            ...
            CFG_DDR_SGMII_PHY->expert_dlycnt_pause
                .expert_dlycnt_pause = 0x0000003FU;
            CFG_DDR_SGMII_PHY->expert_dlycnt_pause
                .expert_dlycnt_pause = 0x00000000U;

            /* DQ */
            /*    dfi_training_complete_shim = 1'b1
                  dfi_wrlvl_en_shim = 1'b1 */
            CFG_DDR_SGMII_PHY->expert_dfi_status_override_to_shim
                .expert_dfi_status_override_to_shim = 0x6;
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg0
                .expert_dlycnt_load_reg0 = 0xFFFFFFFFU; /* load output delays */
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
                .expert_dlycnt_load_reg1 = 0xF; /* (ECC) - load output delays */
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg0
                .expert_dlycnt_load_reg0 = 0x0; /* clear */
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
                .expert_dlycnt_load_reg1 = 0x0; /* (ECC) clear */

            /* DQS
             * dfi_wrlvl_en_shim = 1'b1 */
            CFG_DDR_SGMII_PHY->expert_dfi_status_override_to_shim
                .expert_dfi_status_override_to_shim = 0x4;
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg0
                .expert_dlycnt_load_reg0 = 0xFFFFFFFFU; /* load output delays */
            CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
                .expert_dlycnt_load_reg1 = 0xF; /* (ECC) - load output delays */
            ...
            CFG_DDR_SGMII_PHY->expert_dfi_status_override_to_shim
                .expert_dfi_status_override_to_shim = 0x0; /* clear */
            ...
            CFG_DDR_SGMII_PHY->expert_mode_en.expert_mode_en = 0x00000000U;
        ...
        case DDR_TRAINING_SET_TRAINING_PARAMETERS:
             ...
             */
            {
                ...
                if( use_software_bclk_sclk_training( ddr_type ) == 1U )
                {
                    ...
                    DDRCFG->MC_BASE2.CTRLR_SOFT_RESET_N
                        .CTRLR_SOFT_RESET_N = 0x00000001U;
    #endif
        ...
        case DDR_TRAINING_IP_SM_BCLKSCLK_SW:
             ...
             */
            {
                ...
                bclk_answer = 0U;
                {
                    ...
                    uint32_t answer_count[ 8U ] = { 0U, 0U, 0U, 0U,
                                                    0U, 0U, 0U, 0U };
                    ...
                    for( uint32_t i = 0U; i < ( 8U * 100 ); i++ )
                    {
                         ...
                         * LOAD BCLK90 PHASE
                         */
                        MSS_SCB_DDR_PLL->PLL_PHADJ = ( 0x00004003UL |
                                                       bclk_phase |
                                                       bclk90_phase );
                        MSS_SCB_DDR_PLL->PLL_PHADJ = ( 0x00000003UL |
                                                       bclk_phase |
                                                       bclk90_phase );
                        MSS_SCB_DDR_PLL->PLL_PHADJ = ( 0x00004003UL |
                                                       bclk_phase |
                        ...
                        {
                            /* sweep through found answers and select the most
                             * common */
                    ...
                    if( LIBERO_SETTING_TRAINING_SKIP_SETTING & ADDCMD_BIT )
                    {
                        ...
                        refclk_phase =
                            ( uint32_t ) ( ( ( bclk_answer +
                                               SW_TRAING_BCLK_SCLK_OFFSET + 5U +
                                               LIBERO_SETTING_MANUAL_REF_CLK_PHASE_OFFSET ) &
                                             0x07UL )
                                           << 2U );
                        bclk_phase = ( ( bclk_answer +
                                         SW_TRAING_BCLK_SCLK_OFFSET ) &
                                       0x07UL )
                                     << 8U;
                        bclk90_phase = ( ( bclk_answer +
                                           SW_TRAING_BCLK_SCLK_OFFSET + 2U ) &
                                         0x07UL )
                                       << 11U;
                        MSS_SCB_DDR_PLL->PLL_PHADJ = ( 0x00004003UL |
                                                       bclk_phase |
        ...
        case DDR_TRAINING_IP_SM_START:
        {
            CFG_DDR_SGMII_PHY->training_skip
                .training_skip = LIBERO_SETTING_TRAINING_SKIP_SETTING;
            if( ( ddr_type == DDR3 ) || ( ddr_type == LPDDR4 ) ||
                ( ddr_type == DDR4 ) )
            {
                /* RX_MD_CLKN */
        ...
        }
            {
                ...
                DDRCFG->DFI.PHY_DFI_INIT_START.PHY_DFI_INIT_START = 0x00000001U;
                DDRCFG->MC_BASE2.CTRLR_INIT.CTRLR_INIT = 0x00000000U;
        ...
        case DDR_TRAINING_IP_SM_START_CHECK:
    ...
    #endif
            {
                ...
                CFG_DDR_SGMII_PHY->lane_alignment_fifo_control
                    .lane_alignment_fifo_control = 0x00U;
                CFG_DDR_SGMII_PHY->lane_alignment_fifo_control
                    .lane_alignment_fifo_control = 0x02U;
    #endif
        ...
        case DDR_TRAINING_IP_SM_BCLKSCLK:
            if( CFG_DDR_SGMII_PHY->training_status.training_status &
                BCLK_SCLK_BIT )
            {
                timeout = 0xFFFF;
                ddr_training_state = DDR_TRAINING_IP_SM_ADDCMD;
        ...
        case DDR_TRAINING_IP_SM_ADDCMD:
            ...
            else if( CFG_DDR_SGMII_PHY->training_status.training_status &
                     ADDCMD_BIT )
            {
                timeout = 0xFFFFF;
                ddr_training_state = DDR_TRAINING_IP_SM_WRLVL;
        ...
        case DDR_TRAINING_IP_SM_VERIFY:
            if( ( DDRCFG->DFI.STAT_DFI_TRAINING_COMPLETE
                  ...
                  0x01U ) == 0x01U )
            {
                ...
                for( lane_sel = 0U; lane_sel < LIBERO_SETTING_DATA_LANES_USED;
                     lane_sel++ )
                {
                    SIM_FEEDBACK1( 1000U );
                    delay( 10U );
                    ...
                    if( CFG_DDR_SGMII_PHY->dq_dqs_err_done.dq_dqs_err_done !=
                        8U )
                    {
                        t_status = t_status | 0x01U;
                    }
                    ...
                    if( ( ( CFG_DDR_SGMII_PHY->gt_txdly.gt_txdly ) & 0xFFU ) ==
                        0U ) // Gate training tx_dly check: AL
                    {
                        t_status = t_status | 0x01U;
                    }
                    if( ( ( CFG_DDR_SGMII_PHY->gt_txdly.gt_txdly >> 8U ) &
                          0xFFU ) == 0U )
                    {
                        t_status = t_status | 0x01U;
                    }
                    if( ( ( CFG_DDR_SGMII_PHY->gt_txdly.gt_txdly >> 16U ) &
                          0xFFU ) == 0U )
                    {
                        t_status = t_status | 0x01U;
                    }
                    if( ( ( CFG_DDR_SGMII_PHY->gt_txdly.gt_txdly >> 24U ) &
                          0xFFU ) == 0U )
                    {
                        t_status = t_status | 0x01U;
                    }
        ...
        case DDR_TRAINING_SET_FINAL_MODE:
            ...
            CFG_DDR_SGMII_PHY->DDRPHY_MODE
                .DDRPHY_MODE = LIBERO_SETTING_DDRPHY_MODE;
    #ifdef DEBUG_DDR_INIT
            ( void ) uprint32( g_debug_uart,
                               "\n\r\n\r DDR FINAL_MODE: ",
            ...
            ( void ) print_reg_array( g_debug_uart,
                                      ...
                                      ( sizeof( CFG_DDR_SGMII_PHY_TypeDef ) /
                                        4U ) );
        #endif
        #ifdef DEBUG_DDR_DDRCFG
            debug_read_ddrcfg();
        ...
        case DDR_TRAINING_WRITE_CALIBRATION:
            ...
            if( error == 0U )
            {
                if( ddr_type == LPDDR4 )
                {
                    ...
                    for( lane = 0U; lane < number_of_lanes_to_calibrate;
                         lane++ )
                    {
                        load_dq( lane );
                    }
    ...
    #else
                    error = write_calibration_using_mtc(
                        number_of_lanes_to_calibrate );
    #endif
                }
                else
        ...
        case DDR_TRAINING_WRITE_CALIBRATION_RETRY:
            ...
            {
                DDRCFG->DFI.CFG_DFI_T_PHY_WRLAT
                    .CFG_DFI_T_PHY_WRLAT = write_latency;
    #ifdef DEBUG_DDR_INIT
                ( void ) uprint32( g_debug_uart,
                                   "\n\r\n\r wr write latency ",
                                   write_latency );
        ...
        case DDR_FULL_MTC_CHECK:
        {
            ...
            uint32_t size = ONE_MB_MTC; /* Number of reads for each iteration
                                           2**size*/
            uint8_t mask;
            if( get_num_lanes() <= 3U )
            {
        ...
        case DDR_FULL_32BIT_NC_CHECK:
             ...
             */
            {
                ...
                error = ddr_read_write_fn( ( uint64_t * )
        ...
        case DDR_VERIFY_PATTERN_IN_CACHE:
            ...
            else
            {
                ...
                CFG_DDR_SGMII_PHY->expert_dlycnt_pause
                    .expert_dlycnt_pause = 0x0000003EU;
                CFG_DDR_SGMII_PHY->expert_dlycnt_pause
                    .expert_dlycnt_pause = 0x00000000U;
    ...
    */
    {
                ...
                DDRPHY_MODE_ECC_ON )
        {
             ...
             */
            CFG_DDR_SGMII_PHY->DDRPHY_MODE
                .DDRPHY_MODE = ( LIBERO_SETTING_DDRPHY_MODE & DMI_DBI_MASK );
        }
        else
        {
            CFG_DDR_SGMII_PHY->DDRPHY_MODE
...
static void set_ddr_rpc_regs( DDR_TYPE ddr_type )
{
        ...
        switch( ddr_type )
        {
            ...
            case LPDDR4:
            {
                ...
                CFG_DDR_SGMII_PHY->ovrt10
                    .ovrt10 = LIBERO_SETTING_RPC_EN_ADDCMD1_OVRT10;
                {
                ...
                CFG_DDR_SGMII_PHY->ovrt11
                    .ovrt11 = LIBERO_SETTING_RPC_EN_ADDCMD2_OVRT11;
    #endif
                /* Required when rank x 2 */
                if( ( LIBERO_SETTING_DDRPHY_MODE & DDRPHY_MODE_RANK_MASK ) ==
                    DDRPHY_MODE_TWO_RANKS )
    ...
    {
        /*
         *  Each lane has its own FIFO. This paramater adjusts offset for all
         * lanes.
         */
    #if( TUNE_RPC_166_VALUE == 1 )
        CFG_DDR_SGMII_PHY->rpc166.rpc166 = rpc_166_fifo_offset;
...
static void ddr_off_mode( void )
{
    ...
    CFG_DDR_SGMII_PHY->DDRPHY_MODE
        .DDRPHY_MODE = ( LIBERO_SETTING_DDRPHY_MODE_OFF /* & DMI_DBI_MASK */ );
    /*
     * VS for off mode
     */
    CFG_DDR_SGMII_PHY->DPC_BITS.DPC_BITS = LIBERO_SETTING_DPC_BITS_OFF_MODE;
...
static uint8_t memory_tests( void )
{
                                        ...
                                        mult by (4 lanes) */
    {
        ...
        start_address = ( uint64_t ) ( 0xC0000000U +
                                       ( 0x1U << shift_walking_one ) );
        error = rw_sanity_chk( ( uint64_t * ) start_address,
                               ( uint32_t ) 0x5U );
    ...
    while(shift_walking_one <= 28U)  //28 => 1G (0x10000000(address) * 4 (32bits wide))
    {
        ...
        if(error)
        {
            ...
            #if 0 /* this check will not work as written, need to look further \
                     into flushing cache as part of this test */
        /*
...
static void load_dq( uint8_t lane )
{
    ...
    else
    {
        CFG_DDR_SGMII_PHY->expert_dlycnt_move_reg1
            .expert_dlycnt_move_reg1 = ( CFG_DDR_SGMII_PHY
    ...
    // set expert_dfi_status_override_to_shim = 0x7
    CFG_DDR_SGMII_PHY->expert_dfi_status_override_to_shim
        .expert_dfi_status_override_to_shim = 0x07U;
    // set expert_mode_en = 0x21
    ...
    {
        CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg0
            .expert_dlycnt_load_reg0 = ( 0xFFU << ( lane * 8U ) );
    }
    else
    {
        CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
            .expert_dlycnt_load_reg1 |= 0x0FU;
    }
    // set dyn_ovr_dlycnt_dq_load* = 0
    ...
    {
        CFG_DDR_SGMII_PHY->expert_dlycnt_load_reg1
            .expert_dlycnt_load_reg1 = ( CFG_DDR_SGMII_PHY
...
static void increment_dq( uint8_t lane, uint32_t move_count )
{
    ...
    if( lane < 4U )
    {
        CFG_DDR_SGMII_PHY->expert_dlycnt_direction_reg0
            .expert_dlycnt_direction_reg0 = ( 0xFFU << ( lane * 8U ) );
    }
    else
    {
        /* only four lines, use 0xFU */
        CFG_DDR_SGMII_PHY->expert_dlycnt_direction_reg1
            .expert_dlycnt_direction_reg1 |= 0xFU;
    }
    /*   set expert_dfi_status_override_to_shim = 0x7 */
    CFG_DDR_SGMII_PHY->expert_dfi_status_override_to_shim
        .expert_dfi_status_override_to_shim = 0x07U;
    ...
    while( move_count )
    {
        ...
        if( lane < 4U )
        {
            CFG_DDR_SGMII_PHY->expert_dlycnt_move_reg0
                .expert_dlycnt_move_reg0 = ( 0xFFU << ( lane * 8U ) );
        }
        else
        {
            CFG_DDR_SGMII_PHY->expert_dlycnt_move_reg1
                .expert_dlycnt_move_reg1 |= 0x0FU;
        }
        //   set dyn_ovr_dlycnt_dq_move* = 0
        CFG_DDR_SGMII_PHY->expert_dlycnt_move_reg0.expert_dlycnt_move_reg0 = 0U;
        if( lane < 4U )
...
static void set_write_calib( uint8_t user_lanes )
{
    ...
    for( lane_to_set = 0x00U;
         lane_to_set < user_lanes /*USER_TOTAL_LANES_USED */;
         lane_to_set++ )
    {
        temp = calib_data.write_cal.lower[ lane_to_set ];
        calib_data.write_cal.lane_calib_result = calib_data.write_cal
                                                     .lane_calib_result |
                                                 ( temp << ( shift ) );
    ...
    CFG_DDR_SGMII_PHY->expert_wrcalib.expert_wrcalib = calib_data.write_cal
                                                           .lane_calib_result;
}
...
static void set_calib_values( uint8_t user_lanes )
{
    ...
    for( lane_to_set = 0x00U; lane_to_set < user_lanes; lane_to_set++ )
    {
...
/***************************************************************************/ /**
                                                                               ...
                                                                               * @return
                                                                               */
static uint8_t write_calibration_using_mtc(
    uint8_t number_of_lanes_to_calibrate )
{
    uint8_t laneToTest;
    uint32_t result = 0U;
     ...
     */
    for( cal_data = 0x00000U; cal_data < 0xfffffU;
         cal_data = cal_data + 0x11111U )
    {
    #ifdef DEBUG_DDR_INIT
        ( void ) uprint32( g_debug_uart,
                           "\n\rCalibration offset used:",
                           cal_data & 0xFUL );
    #endif
             ...
             laneToTest++ )
        {
             ...
             * read must be discarded as it is unreliable after a series of bad
             * writes.
             */
            uint8_t mask = ( uint8_t ) ( 1U << laneToTest );
            result = MTC_test( mask,
                               start_address,
                               size,
                               MTC_COUNTING_PATTERN,
                               MTC_ADD_SEQUENTIAL,
            ...
            if( result == 0U ) /* if passed for this lane */
            {
                if( ( calib_data.write_cal.status_lower &
                      ( 0x01U << laneToTest ) ) == 0U ) /* Still looking for
                                                           good value */
                {
                    calib_data.write_cal.lower[ laneToTest ] = ( cal_data &
                                                                 0xFU );
                    calib_data.write_cal.status_lower |= ( 0x01U
                                                           << laneToTest );
                }
                /*
                 * Check the result
                ...
                for( laneToCheck = 0x00U;
                     laneToCheck < number_of_lanes_to_calibrate;
                     laneToCheck++ )
                {
                    if( ( ( calib_data.write_cal.status_lower ) &
                ...
                if( result == 0U ) /* if true, we are good for all lanes, can
                                      stop looking */
                {
...
static uint8_t mode_register_write( uint32_t MR_ADDR, uint32_t MR_DATA )
{
    ...
    while( ( DDRCFG->MC_BASE2.INIT_ACK.INIT_ACK & 0x01U ) == 0U ) /* wait for
                                              ack- to confirm register is
                                              written */
    {
        test--;
        if( test-- == 0U )
...
static uint8_t FPGA_VREFDQ_calibration_using_mtc( void )
{
    ...
    uint32_t count = 0U;
    /* each bit .25% of VDD ?? */
    for( vRef = ( 0x1U << 4U ); vRef < ( 0x1fU << 4U );
         vRef = vRef + ( 0x1U << 4U ) )
    {
        /*
           ...
           (~(0x1U<<10U)));
            CFG_DDR_SGMII_PHY->DPC_BITS.DPC_BITS =\
                  (CFG_DDR_SGMII_PHY->DPC_BITS.DPC_BITS & (~(0x1fU<<4U))) |
           vRef;
        */
    ...
    if( calib_data.fpga_vref.upper != VREF_INVALID ) /* we found lower/upper */
    {
         ...
         * */
        vRef = ( ( calib_data.fpga_vref.lower + calib_data.fpga_vref.upper ) >>
                 1U );
        CFG_DDR_SGMII_PHY->DPC_BITS
            .DPC_BITS = ( CFG_DDR_SGMII_PHY->DPC_BITS.DPC_BITS &
                          ( 0x1fU << 4U ) ) |
                        vRef;
...
static uint8_t VREFDQ_calibration_using_mtc( void )
{
     ...
     */
    {
        ...
        DDRCFG->MC_BASE2.INIT_MR_W_REQ.INIT_MR_W_REQ = 0x01U;
        if( ( DDRCFG->MC_BASE2.INIT_ACK.INIT_ACK & 0x01U ) == 0U ) /* wait for
                                                   ack- to confirm register is
                                                   written */
        {
        }
                                                         ...
                                                         */
    {
         ...
         *                                    (left side + right side) / 2
         * */
        vRef = ( ( calib_data.mem_vref.lower + calib_data.mem_vref.lower ) >
                 1U );
        CFG_DDR_SGMII_PHY->DPC_BITS
            .DPC_BITS = ( CFG_DDR_SGMII_PHY->DPC_BITS.DPC_BITS &
                          ( 0x1fU << 4U ) ) |
                         ...
                         uint32_t * error )
{
    ...
    if( add_pattern != MTC_ADD_RANDOM )
    {
         ...
         */
        DDRCFG->MEM_TEST.MT_START_ADDR_0
            .MT_START_ADDR_0 = ( uint32_t ) ( start_address & 0xFFFFFFFFUL );
        /* The address here is as see from DDR controller => start at 0x0*/
        DDRCFG->MEM_TEST.MT_START_ADDR_1.MT_START_ADDR_1 = ( uint32_t ) ( (
            start_address >> 32U ) );
    }
    else
    {
    ...
    DDRCFG->MEM_TEST.MT_ADDR_BITS.MT_ADDR_BITS = size; /* 2 power 24 => 256k to
                                                          do- make user
                                                          programmable */
...
static void init_ddrc( void )
{
    DDRCFG->ADDR_MAP.CFG_MANUAL_ADDRESS_MAP
        .CFG_MANUAL_ADDRESS_MAP = LIBERO_SETTING_CFG_MANUAL_ADDRESS_MAP;
    DDRCFG->ADDR_MAP.CFG_CHIPADDR_MAP
        .CFG_CHIPADDR_MAP = LIBERO_SETTING_CFG_CHIPADDR_MAP;
    DDRCFG->ADDR_MAP.CFG_CIDADDR_MAP
        .CFG_CIDADDR_MAP = LIBERO_SETTING_CFG_CIDADDR_MAP;
    DDRCFG->ADDR_MAP.CFG_MB_AUTOPCH_COL_BIT_POS_LOW
    ...
    DDRCFG->ADDR_MAP.CFG_BANKADDR_MAP_0
        .CFG_BANKADDR_MAP_0 = LIBERO_SETTING_CFG_BANKADDR_MAP_0;
    DDRCFG->ADDR_MAP.CFG_BANKADDR_MAP_1
        .CFG_BANKADDR_MAP_1 = LIBERO_SETTING_CFG_BANKADDR_MAP_1;
    DDRCFG->ADDR_MAP.CFG_ROWADDR_MAP_0
        .CFG_ROWADDR_MAP_0 = LIBERO_SETTING_CFG_ROWADDR_MAP_0;
    DDRCFG->ADDR_MAP.CFG_ROWADDR_MAP_1
        .CFG_ROWADDR_MAP_1 = LIBERO_SETTING_CFG_ROWADDR_MAP_1;
    DDRCFG->ADDR_MAP.CFG_ROWADDR_MAP_2
        .CFG_ROWADDR_MAP_2 = LIBERO_SETTING_CFG_ROWADDR_MAP_2;
    DDRCFG->ADDR_MAP.CFG_ROWADDR_MAP_3
        .CFG_ROWADDR_MAP_3 = LIBERO_SETTING_CFG_ROWADDR_MAP_3;
    DDRCFG->ADDR_MAP.CFG_COLADDR_MAP_0
        .CFG_COLADDR_MAP_0 = LIBERO_SETTING_CFG_COLADDR_MAP_0;
    DDRCFG->ADDR_MAP.CFG_COLADDR_MAP_1
        .CFG_COLADDR_MAP_1 = LIBERO_SETTING_CFG_COLADDR_MAP_1;
    DDRCFG->ADDR_MAP.CFG_COLADDR_MAP_2
        .CFG_COLADDR_MAP_2 = LIBERO_SETTING_CFG_COLADDR_MAP_2;
    DDRCFG->MC_BASE3.CFG_VRCG_ENABLE
        .CFG_VRCG_ENABLE = LIBERO_SETTING_CFG_VRCG_ENABLE;
    DDRCFG->MC_BASE3.CFG_VRCG_DISABLE
        .CFG_VRCG_DISABLE = LIBERO_SETTING_CFG_VRCG_DISABLE;
    DDRCFG->MC_BASE3.CFG_WRITE_LATENCY_SET
        .CFG_WRITE_LATENCY_SET = LIBERO_SETTING_CFG_WRITE_LATENCY_SET;
    DDRCFG->MC_BASE3.CFG_THERMAL_OFFSET
        .CFG_THERMAL_OFFSET = LIBERO_SETTING_CFG_THERMAL_OFFSET;
    ...
    DDRCFG->MC_BASE3.CFG_LPDDR4_FSP_OP
        .CFG_LPDDR4_FSP_OP = LIBERO_SETTING_CFG_LPDDR4_FSP_OP;
    DDRCFG->MC_BASE3.CFG_GENERATE_REFRESH_ON_SRX
        .CFG_GENERATE_REFRESH_ON_SRX = LIBERO_SETTING_CFG_GENERATE_REFRESH_ON_SRX;
    DDRCFG->MC_BASE3.CFG_DBI_CL.CFG_DBI_CL = LIBERO_SETTING_CFG_DBI_CL;
    DDRCFG->MC_BASE3.CFG_NON_DBI_CL
        .CFG_NON_DBI_CL = LIBERO_SETTING_CFG_NON_DBI_CL;
    DDRCFG->MC_BASE3.INIT_FORCE_WRITE_DATA_0
        .INIT_FORCE_WRITE_DATA_0 = LIBERO_SETTING_INIT_FORCE_WRITE_DATA_0;
    DDRCFG->MC_BASE1.CFG_WRITE_CRC.CFG_WRITE_CRC = LIBERO_SETTING_CFG_WRITE_CRC;
    DDRCFG->MC_BASE1.CFG_MPR_READ_FORMAT
        .CFG_MPR_READ_FORMAT = LIBERO_SETTING_CFG_MPR_READ_FORMAT;
    DDRCFG->MC_BASE1.CFG_WR_CMD_LAT_CRC_DM
        .CFG_WR_CMD_LAT_CRC_DM = LIBERO_SETTING_CFG_WR_CMD_LAT_CRC_DM;
    DDRCFG->MC_BASE1.CFG_FINE_GRAN_REF_MODE
        .CFG_FINE_GRAN_REF_MODE = LIBERO_SETTING_CFG_FINE_GRAN_REF_MODE;
    DDRCFG->MC_BASE1.CFG_TEMP_SENSOR_READOUT
        .CFG_TEMP_SENSOR_READOUT = LIBERO_SETTING_CFG_TEMP_SENSOR_READOUT;
    DDRCFG->MC_BASE1.CFG_PER_DRAM_ADDR_EN
        .CFG_PER_DRAM_ADDR_EN = LIBERO_SETTING_CFG_PER_DRAM_ADDR_EN;
    DDRCFG->MC_BASE1.CFG_GEARDOWN_MODE
        .CFG_GEARDOWN_MODE = LIBERO_SETTING_CFG_GEARDOWN_MODE;
    DDRCFG->MC_BASE1.CFG_WR_PREAMBLE
        .CFG_WR_PREAMBLE = LIBERO_SETTING_CFG_WR_PREAMBLE;
    DDRCFG->MC_BASE1.CFG_RD_PREAMBLE
        .CFG_RD_PREAMBLE = LIBERO_SETTING_CFG_RD_PREAMBLE;
    DDRCFG->MC_BASE1.CFG_RD_PREAMB_TRN_MODE
        .CFG_RD_PREAMB_TRN_MODE = LIBERO_SETTING_CFG_RD_PREAMB_TRN_MODE;
    DDRCFG->MC_BASE1.CFG_SR_ABORT.CFG_SR_ABORT = LIBERO_SETTING_CFG_SR_ABORT;
    DDRCFG->MC_BASE1.CFG_CS_TO_CMDADDR_LATENCY
        .CFG_CS_TO_CMDADDR_LATENCY = LIBERO_SETTING_CFG_CS_TO_CMDADDR_LATENCY;
    DDRCFG->MC_BASE1.CFG_INT_VREF_MON
        .CFG_INT_VREF_MON = LIBERO_SETTING_CFG_INT_VREF_MON;
    DDRCFG->MC_BASE1.CFG_TEMP_CTRL_REF_MODE
        .CFG_TEMP_CTRL_REF_MODE = LIBERO_SETTING_CFG_TEMP_CTRL_REF_MODE;
    DDRCFG->MC_BASE1.CFG_TEMP_CTRL_REF_RANGE
        .CFG_TEMP_CTRL_REF_RANGE = LIBERO_SETTING_CFG_TEMP_CTRL_REF_RANGE;
    DDRCFG->MC_BASE1.CFG_MAX_PWR_DOWN_MODE
        .CFG_MAX_PWR_DOWN_MODE = LIBERO_SETTING_CFG_MAX_PWR_DOWN_MODE;
    DDRCFG->MC_BASE1.CFG_READ_DBI.CFG_READ_DBI = LIBERO_SETTING_CFG_READ_DBI;
    DDRCFG->MC_BASE1.CFG_WRITE_DBI.CFG_WRITE_DBI = LIBERO_SETTING_CFG_WRITE_DBI;
    DDRCFG->MC_BASE1.CFG_DATA_MASK.CFG_DATA_MASK = LIBERO_SETTING_CFG_DATA_MASK;
    DDRCFG->MC_BASE1.CFG_CA_PARITY_PERSIST_ERR
        .CFG_CA_PARITY_PERSIST_ERR = LIBERO_SETTING_CFG_CA_PARITY_PERSIST_ERR;
    DDRCFG->MC_BASE1.CFG_RTT_PARK.CFG_RTT_PARK = LIBERO_SETTING_CFG_RTT_PARK;
    DDRCFG->MC_BASE1.CFG_ODT_INBUF_4_PD
        .CFG_ODT_INBUF_4_PD = LIBERO_SETTING_CFG_ODT_INBUF_4_PD;
    DDRCFG->MC_BASE1.CFG_CA_PARITY_ERR_STATUS
        .CFG_CA_PARITY_ERR_STATUS = LIBERO_SETTING_CFG_CA_PARITY_ERR_STATUS;
    DDRCFG->MC_BASE1.CFG_CRC_ERROR_CLEAR
        .CFG_CRC_ERROR_CLEAR = LIBERO_SETTING_CFG_CRC_ERROR_CLEAR;
    DDRCFG->MC_BASE1.CFG_CA_PARITY_LATENCY
        .CFG_CA_PARITY_LATENCY = LIBERO_SETTING_CFG_CA_PARITY_LATENCY;
    DDRCFG->MC_BASE1.CFG_CCD_S.CFG_CCD_S = LIBERO_SETTING_CFG_CCD_S;
    DDRCFG->MC_BASE1.CFG_CCD_L.CFG_CCD_L = LIBERO_SETTING_CFG_CCD_L;
    DDRCFG->MC_BASE1.CFG_VREFDQ_TRN_ENABLE
        .CFG_VREFDQ_TRN_ENABLE = LIBERO_SETTING_CFG_VREFDQ_TRN_ENABLE;
    DDRCFG->MC_BASE1.CFG_VREFDQ_TRN_RANGE
        .CFG_VREFDQ_TRN_RANGE = LIBERO_SETTING_CFG_VREFDQ_TRN_RANGE;
    DDRCFG->MC_BASE1.CFG_VREFDQ_TRN_VALUE
        .CFG_VREFDQ_TRN_VALUE = LIBERO_SETTING_CFG_VREFDQ_TRN_VALUE;
    ...
    DDRCFG->MC_BASE1.CFG_WTR_S_CRC_DM
        .CFG_WTR_S_CRC_DM = LIBERO_SETTING_CFG_WTR_S_CRC_DM;
    DDRCFG->MC_BASE1.CFG_WTR_L_CRC_DM
        .CFG_WTR_L_CRC_DM = LIBERO_SETTING_CFG_WTR_L_CRC_DM;
    DDRCFG->MC_BASE1.CFG_WR_CRC_DM.CFG_WR_CRC_DM = LIBERO_SETTING_CFG_WR_CRC_DM;
    ...
    DDRCFG->MC_BASE1.CFG_NIBBLE_DEVICES
        .CFG_NIBBLE_DEVICES = LIBERO_SETTING_CFG_NIBBLE_DEVICES;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS0_0
        .CFG_BIT_MAP_INDEX_CS0_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS0_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS0_1
        .CFG_BIT_MAP_INDEX_CS0_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS0_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS1_0
        .CFG_BIT_MAP_INDEX_CS1_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS1_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS1_1
        .CFG_BIT_MAP_INDEX_CS1_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS1_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS2_0
        .CFG_BIT_MAP_INDEX_CS2_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS2_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS2_1
        .CFG_BIT_MAP_INDEX_CS2_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS2_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS3_0
        .CFG_BIT_MAP_INDEX_CS3_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS3_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS3_1
        .CFG_BIT_MAP_INDEX_CS3_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS3_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS4_0
        .CFG_BIT_MAP_INDEX_CS4_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS4_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS4_1
        .CFG_BIT_MAP_INDEX_CS4_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS4_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS5_0
        .CFG_BIT_MAP_INDEX_CS5_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS5_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS5_1
        .CFG_BIT_MAP_INDEX_CS5_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS5_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS6_0
        .CFG_BIT_MAP_INDEX_CS6_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS6_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS6_1
        .CFG_BIT_MAP_INDEX_CS6_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS6_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS7_0
        .CFG_BIT_MAP_INDEX_CS7_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS7_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS7_1
        .CFG_BIT_MAP_INDEX_CS7_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS7_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS8_0
        .CFG_BIT_MAP_INDEX_CS8_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS8_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS8_1
        .CFG_BIT_MAP_INDEX_CS8_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS8_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS9_0
        .CFG_BIT_MAP_INDEX_CS9_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS9_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS9_1
        .CFG_BIT_MAP_INDEX_CS9_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS9_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS10_0
        .CFG_BIT_MAP_INDEX_CS10_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS10_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS10_1
        .CFG_BIT_MAP_INDEX_CS10_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS10_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS11_0
        .CFG_BIT_MAP_INDEX_CS11_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS11_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS11_1
        .CFG_BIT_MAP_INDEX_CS11_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS11_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS12_0
        .CFG_BIT_MAP_INDEX_CS12_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS12_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS12_1
        .CFG_BIT_MAP_INDEX_CS12_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS12_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS13_0
        .CFG_BIT_MAP_INDEX_CS13_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS13_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS13_1
        .CFG_BIT_MAP_INDEX_CS13_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS13_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS14_0
        .CFG_BIT_MAP_INDEX_CS14_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS14_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS14_1
        .CFG_BIT_MAP_INDEX_CS14_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS14_1;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS15_0
        .CFG_BIT_MAP_INDEX_CS15_0 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS15_0;
    DDRCFG->MC_BASE1.CFG_BIT_MAP_INDEX_CS15_1
        .CFG_BIT_MAP_INDEX_CS15_1 = LIBERO_SETTING_CFG_BIT_MAP_INDEX_CS15_1;
    DDRCFG->MC_BASE1.CFG_NUM_LOGICAL_RANKS_PER_3DS
    ...
    DDRCFG->MC_BASE1.CFG_ADVANCE_ACTIVATE_READY
        .CFG_ADVANCE_ACTIVATE_READY = LIBERO_SETTING_CFG_ADVANCE_ACTIVATE_READY;
    DDRCFG->MC_BASE2.CTRLR_SOFT_RESET_N
        .CTRLR_SOFT_RESET_N = LIBERO_SETTING_CTRLR_SOFT_RESET_N;
    DDRCFG->MC_BASE2.CFG_LOOKAHEAD_PCH
        .CFG_LOOKAHEAD_PCH = LIBERO_SETTING_CFG_LOOKAHEAD_PCH;
    DDRCFG->MC_BASE2.CFG_LOOKAHEAD_ACT
        .CFG_LOOKAHEAD_ACT = LIBERO_SETTING_CFG_LOOKAHEAD_ACT;
    DDRCFG->MC_BASE2.INIT_AUTOINIT_DISABLE
        .INIT_AUTOINIT_DISABLE = LIBERO_SETTING_INIT_AUTOINIT_DISABLE;
    DDRCFG->MC_BASE2.INIT_FORCE_RESET
        .INIT_FORCE_RESET = LIBERO_SETTING_INIT_FORCE_RESET;
    DDRCFG->MC_BASE2.INIT_GEARDOWN_EN
        .INIT_GEARDOWN_EN = LIBERO_SETTING_INIT_GEARDOWN_EN;
    DDRCFG->MC_BASE2.INIT_DISABLE_CKE
        .INIT_DISABLE_CKE = LIBERO_SETTING_INIT_DISABLE_CKE;
    DDRCFG->MC_BASE2.INIT_CS.INIT_CS = LIBERO_SETTING_INIT_CS;
    DDRCFG->MC_BASE2.INIT_PRECHARGE_ALL
        .INIT_PRECHARGE_ALL = LIBERO_SETTING_INIT_PRECHARGE_ALL;
    DDRCFG->MC_BASE2.INIT_REFRESH.INIT_REFRESH = LIBERO_SETTING_INIT_REFRESH;
    DDRCFG->MC_BASE2.INIT_ZQ_CAL_REQ
        .INIT_ZQ_CAL_REQ = LIBERO_SETTING_INIT_ZQ_CAL_REQ;
    DDRCFG->MC_BASE2.CFG_BL.CFG_BL = LIBERO_SETTING_CFG_BL;
    DDRCFG->MC_BASE2.CTRLR_INIT.CTRLR_INIT = LIBERO_SETTING_CTRLR_INIT;
    DDRCFG->MC_BASE2.CFG_AUTO_REF_EN
        .CFG_AUTO_REF_EN = LIBERO_SETTING_CFG_AUTO_REF_EN;
    ...
    DDRCFG->MC_BASE2.CFG_READ_TO_WRITE
        .CFG_READ_TO_WRITE = LIBERO_SETTING_CFG_READ_TO_WRITE;
    DDRCFG->MC_BASE2.CFG_WRITE_TO_WRITE
        .CFG_WRITE_TO_WRITE = LIBERO_SETTING_CFG_WRITE_TO_WRITE;
    DDRCFG->MC_BASE2.CFG_READ_TO_READ
        .CFG_READ_TO_READ = LIBERO_SETTING_CFG_READ_TO_READ;
    DDRCFG->MC_BASE2.CFG_WRITE_TO_READ
        .CFG_WRITE_TO_READ = LIBERO_SETTING_CFG_WRITE_TO_READ;
    DDRCFG->MC_BASE2.CFG_READ_TO_WRITE_ODT
        .CFG_READ_TO_WRITE_ODT = LIBERO_SETTING_CFG_READ_TO_WRITE_ODT;
    DDRCFG->MC_BASE2.CFG_WRITE_TO_WRITE_ODT
        .CFG_WRITE_TO_WRITE_ODT = LIBERO_SETTING_CFG_WRITE_TO_WRITE_ODT;
    DDRCFG->MC_BASE2.CFG_READ_TO_READ_ODT
        .CFG_READ_TO_READ_ODT = LIBERO_SETTING_CFG_READ_TO_READ_ODT;
    DDRCFG->MC_BASE2.CFG_WRITE_TO_READ_ODT
        .CFG_WRITE_TO_READ_ODT = LIBERO_SETTING_CFG_WRITE_TO_READ_ODT;
    DDRCFG->MC_BASE2.CFG_MIN_READ_IDLE
        .CFG_MIN_READ_IDLE = LIBERO_SETTING_CFG_MIN_READ_IDLE;
    ...
    DDRCFG->MC_BASE2.CFG_DLL_DISABLE
        .CFG_DLL_DISABLE = LIBERO_SETTING_CFG_DLL_DISABLE;
    DDRCFG->MC_BASE2.CFG_REF_PER.CFG_REF_PER = LIBERO_SETTING_CFG_REF_PER;
    DDRCFG->MC_BASE2.CFG_STARTUP_DELAY
        .CFG_STARTUP_DELAY = LIBERO_SETTING_CFG_STARTUP_DELAY;
    DDRCFG->MC_BASE2.CFG_MEM_COLBITS
        .CFG_MEM_COLBITS = LIBERO_SETTING_CFG_MEM_COLBITS;
    DDRCFG->MC_BASE2.CFG_MEM_ROWBITS
        .CFG_MEM_ROWBITS = LIBERO_SETTING_CFG_MEM_ROWBITS;
    DDRCFG->MC_BASE2.CFG_MEM_BANKBITS
        .CFG_MEM_BANKBITS = LIBERO_SETTING_CFG_MEM_BANKBITS;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS0
        .CFG_ODT_RD_MAP_CS0 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS0;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS1
        .CFG_ODT_RD_MAP_CS1 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS1;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS2
        .CFG_ODT_RD_MAP_CS2 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS2;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS3
        .CFG_ODT_RD_MAP_CS3 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS3;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS4
        .CFG_ODT_RD_MAP_CS4 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS4;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS5
        .CFG_ODT_RD_MAP_CS5 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS5;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS6
        .CFG_ODT_RD_MAP_CS6 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS6;
    DDRCFG->MC_BASE2.CFG_ODT_RD_MAP_CS7
        .CFG_ODT_RD_MAP_CS7 = LIBERO_SETTING_CFG_ODT_RD_MAP_CS7;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS0
        .CFG_ODT_WR_MAP_CS0 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS0;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS1
        .CFG_ODT_WR_MAP_CS1 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS1;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS2
        .CFG_ODT_WR_MAP_CS2 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS2;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS3
        .CFG_ODT_WR_MAP_CS3 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS3;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS4
        .CFG_ODT_WR_MAP_CS4 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS4;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS5
        .CFG_ODT_WR_MAP_CS5 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS5;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS6
        .CFG_ODT_WR_MAP_CS6 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS6;
    DDRCFG->MC_BASE2.CFG_ODT_WR_MAP_CS7
        .CFG_ODT_WR_MAP_CS7 = LIBERO_SETTING_CFG_ODT_WR_MAP_CS7;
    DDRCFG->MC_BASE2.CFG_ODT_RD_TURN_ON
        .CFG_ODT_RD_TURN_ON = LIBERO_SETTING_CFG_ODT_RD_TURN_ON;
    DDRCFG->MC_BASE2.CFG_ODT_WR_TURN_ON
        .CFG_ODT_WR_TURN_ON = LIBERO_SETTING_CFG_ODT_WR_TURN_ON;
    DDRCFG->MC_BASE2.CFG_ODT_RD_TURN_OFF
        .CFG_ODT_RD_TURN_OFF = LIBERO_SETTING_CFG_ODT_RD_TURN_OFF;
    DDRCFG->MC_BASE2.CFG_ODT_WR_TURN_OFF
        .CFG_ODT_WR_TURN_OFF = LIBERO_SETTING_CFG_ODT_WR_TURN_OFF;
    DDRCFG->MC_BASE2.CFG_EMR3.CFG_EMR3 = LIBERO_SETTING_CFG_EMR3;
    DDRCFG->MC_BASE2.CFG_TWO_T.CFG_TWO_T = LIBERO_SETTING_CFG_TWO_T;
    DDRCFG->MC_BASE2.CFG_TWO_T_SEL_CYCLE
        .CFG_TWO_T_SEL_CYCLE = LIBERO_SETTING_CFG_TWO_T_SEL_CYCLE;
    ...
    DDRCFG->MC_BASE2.CFG_ADDR_MIRROR
        .CFG_ADDR_MIRROR = LIBERO_SETTING_CFG_ADDR_MIRROR;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_TYPE
        .CFG_ZQ_CAL_TYPE = LIBERO_SETTING_CFG_ZQ_CAL_TYPE;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_PER
        .CFG_ZQ_CAL_PER = LIBERO_SETTING_CFG_ZQ_CAL_PER;
    DDRCFG->MC_BASE2.CFG_AUTO_ZQ_CAL_EN
        .CFG_AUTO_ZQ_CAL_EN = LIBERO_SETTING_CFG_AUTO_ZQ_CAL_EN;
    DDRCFG->MC_BASE2.CFG_MEMORY_TYPE
        .CFG_MEMORY_TYPE = LIBERO_SETTING_CFG_MEMORY_TYPE;
    DDRCFG->MC_BASE2.CFG_ONLY_SRANK_CMDS
        .CFG_ONLY_SRANK_CMDS = LIBERO_SETTING_CFG_ONLY_SRANK_CMDS;
    DDRCFG->MC_BASE2.CFG_NUM_RANKS.CFG_NUM_RANKS = LIBERO_SETTING_CFG_NUM_RANKS;
    DDRCFG->MC_BASE2.CFG_QUAD_RANK.CFG_QUAD_RANK = LIBERO_SETTING_CFG_QUAD_RANK;
    DDRCFG->MC_BASE2.CFG_EARLY_RANK_TO_WR_START
        .CFG_EARLY_RANK_TO_WR_START = LIBERO_SETTING_CFG_EARLY_RANK_TO_WR_START;
    DDRCFG->MC_BASE2.CFG_EARLY_RANK_TO_RD_START
        .CFG_EARLY_RANK_TO_RD_START = LIBERO_SETTING_CFG_EARLY_RANK_TO_RD_START;
    DDRCFG->MC_BASE2.CFG_PASR_BANK.CFG_PASR_BANK = LIBERO_SETTING_CFG_PASR_BANK;
    DDRCFG->MC_BASE2.CFG_PASR_SEG.CFG_PASR_SEG = LIBERO_SETTING_CFG_PASR_SEG;
    DDRCFG->MC_BASE2.INIT_MRR_MODE.INIT_MRR_MODE = LIBERO_SETTING_INIT_MRR_MODE;
    DDRCFG->MC_BASE2.INIT_MR_W_REQ.INIT_MR_W_REQ = LIBERO_SETTING_INIT_MR_W_REQ;
    DDRCFG->MC_BASE2.INIT_MR_ADDR.INIT_MR_ADDR = LIBERO_SETTING_INIT_MR_ADDR;
    DDRCFG->MC_BASE2.INIT_MR_WR_DATA
        .INIT_MR_WR_DATA = LIBERO_SETTING_INIT_MR_WR_DATA;
    DDRCFG->MC_BASE2.INIT_MR_WR_MASK
        .INIT_MR_WR_MASK = LIBERO_SETTING_INIT_MR_WR_MASK;
    DDRCFG->MC_BASE2.INIT_NOP.INIT_NOP = LIBERO_SETTING_INIT_NOP;
    DDRCFG->MC_BASE2.CFG_INIT_DURATION
        .CFG_INIT_DURATION = LIBERO_SETTING_CFG_INIT_DURATION;
    DDRCFG->MC_BASE2.CFG_ZQINIT_CAL_DURATION
        .CFG_ZQINIT_CAL_DURATION = LIBERO_SETTING_CFG_ZQINIT_CAL_DURATION;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_L_DURATION
        .CFG_ZQ_CAL_L_DURATION = LIBERO_SETTING_CFG_ZQ_CAL_L_DURATION;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_S_DURATION
        .CFG_ZQ_CAL_S_DURATION = LIBERO_SETTING_CFG_ZQ_CAL_S_DURATION;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_R_DURATION
        .CFG_ZQ_CAL_R_DURATION = LIBERO_SETTING_CFG_ZQ_CAL_R_DURATION;
    DDRCFG->MC_BASE2.CFG_MRR.CFG_MRR = LIBERO_SETTING_CFG_MRR;
    DDRCFG->MC_BASE2.CFG_MRW.CFG_MRW = LIBERO_SETTING_CFG_MRW;
    DDRCFG->MC_BASE2.CFG_ODT_POWERDOWN
        .CFG_ODT_POWERDOWN = LIBERO_SETTING_CFG_ODT_POWERDOWN;
    DDRCFG->MC_BASE2.CFG_WL.CFG_WL = LIBERO_SETTING_CFG_WL;
    DDRCFG->MC_BASE2.CFG_RL.CFG_RL = LIBERO_SETTING_CFG_RL;
    DDRCFG->MC_BASE2.CFG_CAL_READ_PERIOD
        .CFG_CAL_READ_PERIOD = LIBERO_SETTING_CFG_CAL_READ_PERIOD;
    DDRCFG->MC_BASE2.CFG_NUM_CAL_READS
        .CFG_NUM_CAL_READS = LIBERO_SETTING_CFG_NUM_CAL_READS;
    DDRCFG->MC_BASE2.INIT_SELF_REFRESH
        .INIT_SELF_REFRESH = LIBERO_SETTING_INIT_SELF_REFRESH;
    DDRCFG->MC_BASE2.INIT_POWER_DOWN
        .INIT_POWER_DOWN = LIBERO_SETTING_INIT_POWER_DOWN;
    DDRCFG->MC_BASE2.INIT_FORCE_WRITE
        .INIT_FORCE_WRITE = LIBERO_SETTING_INIT_FORCE_WRITE;
    DDRCFG->MC_BASE2.INIT_FORCE_WRITE_CS
        .INIT_FORCE_WRITE_CS = LIBERO_SETTING_INIT_FORCE_WRITE_CS;
    DDRCFG->MC_BASE2.CFG_CTRLR_INIT_DISABLE
        .CFG_CTRLR_INIT_DISABLE = LIBERO_SETTING_CFG_CTRLR_INIT_DISABLE;
    DDRCFG->MC_BASE2.INIT_RDIMM_COMPLETE
        .INIT_RDIMM_COMPLETE = LIBERO_SETTING_INIT_RDIMM_COMPLETE;
    DDRCFG->MC_BASE2.CFG_RDIMM_LAT.CFG_RDIMM_LAT = LIBERO_SETTING_CFG_RDIMM_LAT;
    DDRCFG->MC_BASE2.CFG_RDIMM_BSIDE_INVERT
        .CFG_RDIMM_BSIDE_INVERT = LIBERO_SETTING_CFG_RDIMM_BSIDE_INVERT;
    DDRCFG->MC_BASE2.CFG_LRDIMM.CFG_LRDIMM = LIBERO_SETTING_CFG_LRDIMM;
    DDRCFG->MC_BASE2.INIT_MEMORY_RESET_MASK
        .INIT_MEMORY_RESET_MASK = LIBERO_SETTING_INIT_MEMORY_RESET_MASK;
    DDRCFG->MC_BASE2.CFG_RD_PREAMB_TOGGLE
        .CFG_RD_PREAMB_TOGGLE = LIBERO_SETTING_CFG_RD_PREAMB_TOGGLE;
    DDRCFG->MC_BASE2.CFG_RD_POSTAMBLE
        .CFG_RD_POSTAMBLE = LIBERO_SETTING_CFG_RD_POSTAMBLE;
    ...
    DDRCFG->MC_BASE2.CFG_ZQLATCH_DURATION
        .CFG_ZQLATCH_DURATION = LIBERO_SETTING_CFG_ZQLATCH_DURATION;
    DDRCFG->MC_BASE2.INIT_CAL_SELECT
        .INIT_CAL_SELECT = LIBERO_SETTING_INIT_CAL_SELECT;
    DDRCFG->MC_BASE2.INIT_CAL_L_R_REQ
        .INIT_CAL_L_R_REQ = LIBERO_SETTING_INIT_CAL_L_R_REQ;
    DDRCFG->MC_BASE2.INIT_CAL_L_B_SIZE
        .INIT_CAL_L_B_SIZE = LIBERO_SETTING_INIT_CAL_L_B_SIZE;
    DDRCFG->MC_BASE2.INIT_RWFIFO.INIT_RWFIFO = LIBERO_SETTING_INIT_RWFIFO;
    DDRCFG->MC_BASE2.INIT_RD_DQCAL.INIT_RD_DQCAL = LIBERO_SETTING_INIT_RD_DQCAL;
    DDRCFG->MC_BASE2.INIT_START_DQSOSC
        .INIT_START_DQSOSC = LIBERO_SETTING_INIT_START_DQSOSC;
    DDRCFG->MC_BASE2.INIT_STOP_DQSOSC
        .INIT_STOP_DQSOSC = LIBERO_SETTING_INIT_STOP_DQSOSC;
    DDRCFG->MC_BASE2.INIT_ZQ_CAL_START
        .INIT_ZQ_CAL_START = LIBERO_SETTING_INIT_ZQ_CAL_START;
    DDRCFG->MC_BASE2.CFG_WR_POSTAMBLE
        .CFG_WR_POSTAMBLE = LIBERO_SETTING_CFG_WR_POSTAMBLE;
    DDRCFG->MC_BASE2.INIT_CAL_L_ADDR_0
        .INIT_CAL_L_ADDR_0 = LIBERO_SETTING_INIT_CAL_L_ADDR_0;
    DDRCFG->MC_BASE2.INIT_CAL_L_ADDR_1
        .INIT_CAL_L_ADDR_1 = LIBERO_SETTING_INIT_CAL_L_ADDR_1;
    DDRCFG->MC_BASE2.CFG_CTRLUPD_TRIG
        .CFG_CTRLUPD_TRIG = LIBERO_SETTING_CFG_CTRLUPD_TRIG;
    DDRCFG->MC_BASE2.CFG_CTRLUPD_START_DELAY
        .CFG_CTRLUPD_START_DELAY = LIBERO_SETTING_CFG_CTRLUPD_START_DELAY;
    DDRCFG->MC_BASE2.CFG_DFI_T_CTRLUPD_MAX
        .CFG_DFI_T_CTRLUPD_MAX = LIBERO_SETTING_CFG_DFI_T_CTRLUPD_MAX;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_SEL
        .CFG_CTRLR_BUSY_SEL = LIBERO_SETTING_CFG_CTRLR_BUSY_SEL;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_VALUE
        .CFG_CTRLR_BUSY_VALUE = LIBERO_SETTING_CFG_CTRLR_BUSY_VALUE;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_TURN_OFF_DELAY
        .CFG_CTRLR_BUSY_TURN_OFF_DELAY =
        LIBERO_SETTING_CFG_CTRLR_BUSY_TURN_OFF_DELAY;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_SLOW_RESTART_WINDOW
        .CFG_CTRLR_BUSY_SLOW_RESTART_WINDOW =
        LIBERO_SETTING_CFG_CTRLR_BUSY_SLOW_RESTART_WINDOW;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_RESTART_HOLDOFF
        .CFG_CTRLR_BUSY_RESTART_HOLDOFF =
        LIBERO_SETTING_CFG_CTRLR_BUSY_RESTART_HOLDOFF;
    DDRCFG->MC_BASE2.CFG_PARITY_RDIMM_DELAY
        .CFG_PARITY_RDIMM_DELAY = LIBERO_SETTING_CFG_PARITY_RDIMM_DELAY;
    DDRCFG->MC_BASE2.CFG_CTRLR_BUSY_ENABLE
        .CFG_CTRLR_BUSY_ENABLE = LIBERO_SETTING_CFG_CTRLR_BUSY_ENABLE;
    DDRCFG->MC_BASE2.CFG_ASYNC_ODT.CFG_ASYNC_ODT = LIBERO_SETTING_CFG_ASYNC_ODT;
    DDRCFG->MC_BASE2.CFG_ZQ_CAL_DURATION
        .CFG_ZQ_CAL_DURATION = LIBERO_SETTING_CFG_ZQ_CAL_DURATION;
    DDRCFG->MC_BASE2.CFG_MRRI.CFG_MRRI = LIBERO_SETTING_CFG_MRRI;
    DDRCFG->MC_BASE2.INIT_ODT_FORCE_EN
        .INIT_ODT_FORCE_EN = LIBERO_SETTING_INIT_ODT_FORCE_EN;
    DDRCFG->MC_BASE2.INIT_ODT_FORCE_RANK
        .INIT_ODT_FORCE_RANK = LIBERO_SETTING_INIT_ODT_FORCE_RANK;
    DDRCFG->MC_BASE2.CFG_PHYUPD_ACK_DELAY
        .CFG_PHYUPD_ACK_DELAY = LIBERO_SETTING_CFG_PHYUPD_ACK_DELAY;
    DDRCFG->MC_BASE2.CFG_MIRROR_X16_BG0_BG1
        .CFG_MIRROR_X16_BG0_BG1 = LIBERO_SETTING_CFG_MIRROR_X16_BG0_BG1;
    DDRCFG->MC_BASE2.INIT_PDA_MR_W_REQ
        .INIT_PDA_MR_W_REQ = LIBERO_SETTING_INIT_PDA_MR_W_REQ;
    DDRCFG->MC_BASE2.INIT_PDA_NIBBLE_SELECT
        .INIT_PDA_NIBBLE_SELECT = LIBERO_SETTING_INIT_PDA_NIBBLE_SELECT;
    DDRCFG->MC_BASE2.CFG_DRAM_CLK_DISABLE_IN_SELF_REFRESH
    ...
    DDRCFG->MC_BASE2.CFG_DFI_T_CTRL_DELAY
        .CFG_DFI_T_CTRL_DELAY = LIBERO_SETTING_CFG_DFI_T_CTRL_DELAY;
    DDRCFG->MC_BASE2.CFG_DFI_T_DRAM_CLK_ENABLE
        .CFG_DFI_T_DRAM_CLK_ENABLE = LIBERO_SETTING_CFG_DFI_T_DRAM_CLK_ENABLE;
    DDRCFG->MC_BASE2.CFG_IDLE_TIME_TO_SELF_REFRESH
        .CFG_IDLE_TIME_TO_SELF_REFRESH =
        LIBERO_SETTING_CFG_IDLE_TIME_TO_SELF_REFRESH;
    DDRCFG->MC_BASE2.CFG_IDLE_TIME_TO_POWER_DOWN
        .CFG_IDLE_TIME_TO_POWER_DOWN = LIBERO_SETTING_CFG_IDLE_TIME_TO_POWER_DOWN;
    DDRCFG->MC_BASE2.CFG_BURST_RW_REFRESH_HOLDOFF
        .CFG_BURST_RW_REFRESH_HOLDOFF = LIBERO_SETTING_CFG_BURST_RW_REFRESH_HOLDOFF;
    DDRCFG->MC_BASE2.CFG_BG_INTERLEAVE
        .CFG_BG_INTERLEAVE = LIBERO_SETTING_CFG_BG_INTERLEAVE;
    DDRCFG->MC_BASE2.CFG_REFRESH_DURING_PHY_TRAINING
        .CFG_REFRESH_DURING_PHY_TRAINING =
        LIBERO_SETTING_CFG_REFRESH_DURING_PHY_TRAINING;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P0
        .CFG_STARVE_TIMEOUT_P0 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P0;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P1
        .CFG_STARVE_TIMEOUT_P1 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P1;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P2
        .CFG_STARVE_TIMEOUT_P2 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P2;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P3
        .CFG_STARVE_TIMEOUT_P3 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P3;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P4
        .CFG_STARVE_TIMEOUT_P4 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P4;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P5
        .CFG_STARVE_TIMEOUT_P5 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P5;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P6
        .CFG_STARVE_TIMEOUT_P6 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P6;
    DDRCFG->MPFE.CFG_STARVE_TIMEOUT_P7
        .CFG_STARVE_TIMEOUT_P7 = LIBERO_SETTING_CFG_STARVE_TIMEOUT_P7;
    DDRCFG->REORDER.CFG_REORDER_EN
        .CFG_REORDER_EN = LIBERO_SETTING_CFG_REORDER_EN;
    DDRCFG->REORDER.CFG_REORDER_QUEUE_EN
        .CFG_REORDER_QUEUE_EN = LIBERO_SETTING_CFG_REORDER_QUEUE_EN;
    DDRCFG->REORDER.CFG_INTRAPORT_REORDER_EN
        .CFG_INTRAPORT_REORDER_EN = LIBERO_SETTING_CFG_INTRAPORT_REORDER_EN;
    DDRCFG->REORDER.CFG_MAINTAIN_COHERENCY
        .CFG_MAINTAIN_COHERENCY = LIBERO_SETTING_CFG_MAINTAIN_COHERENCY;
    DDRCFG->REORDER.CFG_Q_AGE_LIMIT
        .CFG_Q_AGE_LIMIT = LIBERO_SETTING_CFG_Q_AGE_LIMIT;
    DDRCFG->REORDER.CFG_RO_CLOSED_PAGE_POLICY
        .CFG_RO_CLOSED_PAGE_POLICY = LIBERO_SETTING_CFG_RO_CLOSED_PAGE_POLICY;
    DDRCFG->REORDER.CFG_REORDER_RW_ONLY
        .CFG_REORDER_RW_ONLY = LIBERO_SETTING_CFG_REORDER_RW_ONLY;
    DDRCFG->REORDER.CFG_RO_PRIORITY_EN
        .CFG_RO_PRIORITY_EN = LIBERO_SETTING_CFG_RO_PRIORITY_EN;
    DDRCFG->RMW.CFG_DM_EN.CFG_DM_EN = LIBERO_SETTING_CFG_DM_EN;
    DDRCFG->RMW.CFG_RMW_EN.CFG_RMW_EN = LIBERO_SETTING_CFG_RMW_EN;
    DDRCFG->ECC.CFG_ECC_CORRECTION_EN
        .CFG_ECC_CORRECTION_EN = LIBERO_SETTING_CFG_ECC_CORRECTION_EN;
    DDRCFG->ECC.CFG_ECC_BYPASS.CFG_ECC_BYPASS = LIBERO_SETTING_CFG_ECC_BYPASS;
    DDRCFG->ECC.INIT_WRITE_DATA_1B_ECC_ERROR_GEN
        .INIT_WRITE_DATA_1B_ECC_ERROR_GEN =
        LIBERO_SETTING_INIT_WRITE_DATA_1B_ECC_ERROR_GEN;
    DDRCFG->ECC.INIT_WRITE_DATA_2B_ECC_ERROR_GEN
        .INIT_WRITE_DATA_2B_ECC_ERROR_GEN =
        LIBERO_SETTING_INIT_WRITE_DATA_2B_ECC_ERROR_GEN;
    DDRCFG->ECC.CFG_ECC_1BIT_INT_THRESH
        .CFG_ECC_1BIT_INT_THRESH = LIBERO_SETTING_CFG_ECC_1BIT_INT_THRESH;
    DDRCFG->READ_CAPT.INIT_READ_CAPTURE_ADDR
        .INIT_READ_CAPTURE_ADDR = LIBERO_SETTING_INIT_READ_CAPTURE_ADDR;
    DDRCFG->MTA.CFG_ERROR_GROUP_SEL
        .CFG_ERROR_GROUP_SEL = LIBERO_SETTING_CFG_ERROR_GROUP_SEL;
    ...
    DDRCFG->MTA.CFG_POST_TRIG_CYCS
        .CFG_POST_TRIG_CYCS = LIBERO_SETTING_CFG_POST_TRIG_CYCS;
    ...
    DDRCFG->MTA.CFG_TRIG_MT_ADDR_0
        .CFG_TRIG_MT_ADDR_0 = LIBERO_SETTING_CFG_TRIG_MT_ADDR_0;
    DDRCFG->MTA.CFG_TRIG_MT_ADDR_1
        .CFG_TRIG_MT_ADDR_1 = LIBERO_SETTING_CFG_TRIG_MT_ADDR_1;
    DDRCFG->MTA.CFG_TRIG_ERR_MASK_0
        .CFG_TRIG_ERR_MASK_0 = LIBERO_SETTING_CFG_TRIG_ERR_MASK_0;
    DDRCFG->MTA.CFG_TRIG_ERR_MASK_1
        .CFG_TRIG_ERR_MASK_1 = LIBERO_SETTING_CFG_TRIG_ERR_MASK_1;
    DDRCFG->MTA.CFG_TRIG_ERR_MASK_2
        .CFG_TRIG_ERR_MASK_2 = LIBERO_SETTING_CFG_TRIG_ERR_MASK_2;
    DDRCFG->MTA.CFG_TRIG_ERR_MASK_3
        .CFG_TRIG_ERR_MASK_3 = LIBERO_SETTING_CFG_TRIG_ERR_MASK_3;
    DDRCFG->MTA.CFG_TRIG_ERR_MASK_4
        .CFG_TRIG_ERR_MASK_4 = LIBERO_SETTING_CFG_TRIG_ERR_MASK_4;
    DDRCFG->MTA.MTC_ACQ_WR_DATA_0
        .MTC_ACQ_WR_DATA_0 = LIBERO_SETTING_MTC_ACQ_WR_DATA_0;
    DDRCFG->MTA.MTC_ACQ_WR_DATA_1
        .MTC_ACQ_WR_DATA_1 = LIBERO_SETTING_MTC_ACQ_WR_DATA_1;
    DDRCFG->MTA.MTC_ACQ_WR_DATA_2
        .MTC_ACQ_WR_DATA_2 = LIBERO_SETTING_MTC_ACQ_WR_DATA_2;
    DDRCFG->MTA.CFG_PRE_TRIG_CYCS
        .CFG_PRE_TRIG_CYCS = LIBERO_SETTING_CFG_PRE_TRIG_CYCS;
    DDRCFG->MTA.CFG_DATA_SEL_FIRST_ERROR
        .CFG_DATA_SEL_FIRST_ERROR = LIBERO_SETTING_CFG_DATA_SEL_FIRST_ERROR;
    DDRCFG->DYN_WIDTH_ADJ.CFG_DQ_WIDTH
        .CFG_DQ_WIDTH = LIBERO_SETTING_CFG_DQ_WIDTH;
    DDRCFG->DYN_WIDTH_ADJ.CFG_ACTIVE_DQ_SEL
        .CFG_ACTIVE_DQ_SEL = LIBERO_SETTING_CFG_ACTIVE_DQ_SEL;
    DDRCFG->CA_PAR_ERR.INIT_CA_PARITY_ERROR_GEN_REQ
        .INIT_CA_PARITY_ERROR_GEN_REQ = LIBERO_SETTING_INIT_CA_PARITY_ERROR_GEN_REQ;
    DDRCFG->CA_PAR_ERR.INIT_CA_PARITY_ERROR_GEN_CMD
        .INIT_CA_PARITY_ERROR_GEN_CMD = LIBERO_SETTING_INIT_CA_PARITY_ERROR_GEN_CMD;
    DDRCFG->DFI.CFG_DFI_T_RDDATA_EN
        .CFG_DFI_T_RDDATA_EN = LIBERO_SETTING_CFG_DFI_T_RDDATA_EN;
    DDRCFG->DFI.CFG_DFI_T_PHY_RDLAT
        .CFG_DFI_T_PHY_RDLAT = LIBERO_SETTING_CFG_DFI_T_PHY_RDLAT;
    DDRCFG->DFI.CFG_DFI_T_PHY_WRLAT
        .CFG_DFI_T_PHY_WRLAT = LIBERO_SETTING_CFG_DFI_T_PHY_WRLAT;
    DDRCFG->DFI.CFG_DFI_PHYUPD_EN
        .CFG_DFI_PHYUPD_EN = LIBERO_SETTING_CFG_DFI_PHYUPD_EN;
    DDRCFG->DFI.INIT_DFI_LP_DATA_REQ
        .INIT_DFI_LP_DATA_REQ = LIBERO_SETTING_INIT_DFI_LP_DATA_REQ;
    DDRCFG->DFI.INIT_DFI_LP_CTRL_REQ
        .INIT_DFI_LP_CTRL_REQ = LIBERO_SETTING_INIT_DFI_LP_CTRL_REQ;
    DDRCFG->DFI.INIT_DFI_LP_WAKEUP
        .INIT_DFI_LP_WAKEUP = LIBERO_SETTING_INIT_DFI_LP_WAKEUP;
    DDRCFG->DFI.INIT_DFI_DRAM_CLK_DISABLE
        .INIT_DFI_DRAM_CLK_DISABLE = LIBERO_SETTING_INIT_DFI_DRAM_CLK_DISABLE;
    DDRCFG->DFI.CFG_DFI_DATA_BYTE_DISABLE
        .CFG_DFI_DATA_BYTE_DISABLE = LIBERO_SETTING_CFG_DFI_DATA_BYTE_DISABLE;
    DDRCFG->DFI.CFG_DFI_LVL_SEL.CFG_DFI_LVL_SEL = LIBERO_SETTING_CFG_DFI_LVL_SEL;
    DDRCFG->DFI.CFG_DFI_LVL_PERIODIC
        .CFG_DFI_LVL_PERIODIC = LIBERO_SETTING_CFG_DFI_LVL_PERIODIC;
    DDRCFG->DFI.CFG_DFI_LVL_PATTERN
        .CFG_DFI_LVL_PATTERN = LIBERO_SETTING_CFG_DFI_LVL_PATTERN;
    DDRCFG->DFI.PHY_DFI_INIT_START
        .PHY_DFI_INIT_START = LIBERO_SETTING_PHY_DFI_INIT_START;
    DDRCFG->AXI_IF.CFG_AXI_START_ADDRESS_AXI1_0
        .CFG_AXI_START_ADDRESS_AXI1_0 = LIBERO_SETTING_CFG_AXI_START_ADDRESS_AXI1_0;
    DDRCFG->AXI_IF.CFG_AXI_START_ADDRESS_AXI1_1
        .CFG_AXI_START_ADDRESS_AXI1_1 = LIBERO_SETTING_CFG_AXI_START_ADDRESS_AXI1_1;
    DDRCFG->AXI_IF.CFG_AXI_START_ADDRESS_AXI2_0
        .CFG_AXI_START_ADDRESS_AXI2_0 = LIBERO_SETTING_CFG_AXI_START_ADDRESS_AXI2_0;
    DDRCFG->AXI_IF.CFG_AXI_START_ADDRESS_AXI2_1
        .CFG_AXI_START_ADDRESS_AXI2_1 = LIBERO_SETTING_CFG_AXI_START_ADDRESS_AXI2_1;
    DDRCFG->AXI_IF.CFG_AXI_END_ADDRESS_AXI1_0
        .CFG_AXI_END_ADDRESS_AXI1_0 = LIBERO_SETTING_CFG_AXI_END_ADDRESS_AXI1_0;
    DDRCFG->AXI_IF.CFG_AXI_END_ADDRESS_AXI1_1
        .CFG_AXI_END_ADDRESS_AXI1_1 = LIBERO_SETTING_CFG_AXI_END_ADDRESS_AXI1_1;
    DDRCFG->AXI_IF.CFG_AXI_END_ADDRESS_AXI2_0
        .CFG_AXI_END_ADDRESS_AXI2_0 = LIBERO_SETTING_CFG_AXI_END_ADDRESS_AXI2_0;
    DDRCFG->AXI_IF.CFG_AXI_END_ADDRESS_AXI2_1
        .CFG_AXI_END_ADDRESS_AXI2_1 = LIBERO_SETTING_CFG_AXI_END_ADDRESS_AXI2_1;
    DDRCFG->AXI_IF.CFG_MEM_START_ADDRESS_AXI1_0
        .CFG_MEM_START_ADDRESS_AXI1_0 = LIBERO_SETTING_CFG_MEM_START_ADDRESS_AXI1_0;
    DDRCFG->AXI_IF.CFG_MEM_START_ADDRESS_AXI1_1
        .CFG_MEM_START_ADDRESS_AXI1_1 = LIBERO_SETTING_CFG_MEM_START_ADDRESS_AXI1_1;
    ...
    DDRCFG->AXI_IF.CFG_MEM_START_ADDRESS_AXI2_1
        .CFG_MEM_START_ADDRESS_AXI2_1 = LIBERO_SETTING_CFG_MEM_START_ADDRESS_AXI2_1;
    DDRCFG->AXI_IF.CFG_ENABLE_BUS_HOLD_AXI1
        .CFG_ENABLE_BUS_HOLD_AXI1 = LIBERO_SETTING_CFG_ENABLE_BUS_HOLD_AXI1;
    DDRCFG->AXI_IF.CFG_ENABLE_BUS_HOLD_AXI2
        .CFG_ENABLE_BUS_HOLD_AXI2 = LIBERO_SETTING_CFG_ENABLE_BUS_HOLD_AXI2;
    DDRCFG->AXI_IF.CFG_AXI_AUTO_PCH
        .CFG_AXI_AUTO_PCH = LIBERO_SETTING_CFG_AXI_AUTO_PCH;
    DDRCFG->csr_custom.PHY_RESET_CONTROL
        .PHY_RESET_CONTROL = LIBERO_SETTING_PHY_RESET_CONTROL;
    DDRCFG->csr_custom.PHY_RESET_CONTROL
        .PHY_RESET_CONTROL = ( LIBERO_SETTING_PHY_RESET_CONTROL & ~0x8000UL );
    DDRCFG->csr_custom.PHY_PC_RANK.PHY_PC_RANK = LIBERO_SETTING_PHY_PC_RANK;
    DDRCFG->csr_custom.PHY_RANKS_TO_TRAIN
        .PHY_RANKS_TO_TRAIN = LIBERO_SETTING_PHY_RANKS_TO_TRAIN;
    DDRCFG->csr_custom.PHY_WRITE_REQUEST
        .PHY_WRITE_REQUEST = LIBERO_SETTING_PHY_WRITE_REQUEST;
    DDRCFG->csr_custom.PHY_READ_REQUEST
        .PHY_READ_REQUEST = LIBERO_SETTING_PHY_READ_REQUEST;
    DDRCFG->csr_custom.PHY_WRITE_LEVEL_DELAY
        .PHY_WRITE_LEVEL_DELAY = LIBERO_SETTING_PHY_WRITE_LEVEL_DELAY;
    DDRCFG->csr_custom.PHY_GATE_TRAIN_DELAY
        .PHY_GATE_TRAIN_DELAY = LIBERO_SETTING_PHY_GATE_TRAIN_DELAY;
    DDRCFG->csr_custom.PHY_EYE_TRAIN_DELAY
        .PHY_EYE_TRAIN_DELAY = LIBERO_SETTING_PHY_EYE_TRAIN_DELAY;
    DDRCFG->csr_custom.PHY_EYE_PAT.PHY_EYE_PAT = LIBERO_SETTING_PHY_EYE_PAT;
    DDRCFG->csr_custom.PHY_START_RECAL
        .PHY_START_RECAL = LIBERO_SETTING_PHY_START_RECAL;
    DDRCFG->csr_custom.PHY_CLR_DFI_LVL_PERIODIC
        .PHY_CLR_DFI_LVL_PERIODIC = LIBERO_SETTING_PHY_CLR_DFI_LVL_PERIODIC;
    DDRCFG->csr_custom.PHY_TRAIN_STEP_ENABLE
        .PHY_TRAIN_STEP_ENABLE = LIBERO_SETTING_PHY_TRAIN_STEP_ENABLE;
    DDRCFG->csr_custom.PHY_LPDDR_DQ_CAL_PAT
        .PHY_LPDDR_DQ_CAL_PAT = LIBERO_SETTING_PHY_LPDDR_DQ_CAL_PAT;
    DDRCFG->csr_custom.PHY_INDPNDT_TRAINING
        .PHY_INDPNDT_TRAINING = LIBERO_SETTING_PHY_INDPNDT_TRAINING;
    DDRCFG->csr_custom.PHY_ENCODED_QUAD_CS
        .PHY_ENCODED_QUAD_CS = LIBERO_SETTING_PHY_ENCODED_QUAD_CS;
    DDRCFG->csr_custom.PHY_HALF_CLK_DLY_ENABLE
        .PHY_HALF_CLK_DLY_ENABLE = LIBERO_SETTING_PHY_HALF_CLK_DLY_ENABLE;
}
...
static uint8_t get_best_sweep( sweep_index * good_index )
{
    ...
    for( dpc_vgen_vs_index = 0U;
         dpc_vgen_vs_index < MAX_NUMBER_DPC_VS_GEN_SWEEPS;
         dpc_vgen_vs_index++ )
    {
        for( dpc_vgen_h_index = 0U;
             dpc_vgen_h_index < MAX_NUMBER_DPC_H_GEN_SWEEPS;
             dpc_vgen_h_index++ )
        {
            for( dpc_vgen_index = 0U;
                 dpc_vgen_index < MAX_NUMBER_DPC_V_GEN_SWEEPS;
                 dpc_vgen_index++ )
            {
                for( bclk_sclk_index = 0U;
                     bclk_sclk_index < MAX_NUMBER__BCLK_SCLK_OFFSET_SWEEPS;
                     bclk_sclk_index++ )
                {
                    good_in_row = 0U;
                    for( cmd_index = 0U;
                         cmd_index < MAX_NUMBER_ADDR_CMD_OFFSET_SWEEPS;
                         cmd_index++ )
                    {
                        if( sweep_results[ dpc_vgen_vs_index ]
                                         [ dpc_vgen_h_index ][ dpc_vgen_index ]
                                         [ bclk_sclk_index ][ cmd_index ] ==
                            CALIBRATION_PASSED )
                        {
                            good_in_row++;
                            /*
                             * look for 3 in a row,in x and y direction and pick
                             * the middle one
                             * */
                            if( ( good_in_row > 2U ) &&
                                ( bclk_sclk_index > 1 ) &&
                                ( bclk_sclk_index <
                                  MAX_NUMBER__BCLK_SCLK_OFFSET_SWEEPS - 1 ) )
                            {
                                if( ( sweep_results[ dpc_vgen_vs_index ]
                                                   [ dpc_vgen_h_index ]
                                                   [ dpc_vgen_index ]
                                ...
                                {
                                    good_index
                                        ->dpc_vgen_vs_index = dpc_vgen_vs_index;
                                    good_index
                                        ->dpc_vgen_h_index = dpc_vgen_h_index;
                                    good_index
                                        ->bclk_sclk_index = bclk_sclk_index;
    ...
    #ifdef DDR_DIAGNOSTICS /* todo: add support for diagnostics below during \
                              board bring-up */
...
/*-------------------------------------------------------------------------*/ /**
   ...
   Example:
     ...
     @endcode
  */
uint8_t MSS_DDR_status( uint8_t option, uint32_t * return_data )
{
    uint8_t error = 0U;
