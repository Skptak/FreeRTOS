...
PLL_TypeDef * const MSS_SCB_MSS_PLL = ( (
    PLL_TypeDef * ) MSS_SCB_MSS_PLL_BASE );
PLL_TypeDef * const MSS_SCB_DDR_PLL = ( (
    PLL_TypeDef * ) MSS_SCB_DDR_PLL_BASE );
PLL_TypeDef * const MSS_SCB_SGMII_PLL = ( (
    PLL_TypeDef * ) MSS_SCB_SGMII_PLL_BASE );
...
IOSCB_IO_CALIB_STRUCT * const IOSCB_IO_CALIB_SGMII = ( IOSCB_IO_CALIB_STRUCT * )
    IOSCB_IO_CALIB_SGMII_BASE;
IOSCB_IO_CALIB_STRUCT * const IOSCB_IO_CALIB_DDR = ( IOSCB_IO_CALIB_STRUCT * )
...
/***************************************************************************/ /**
                                                                               ...
                                                                               ******************************************************************************/
__attribute__( ( section( ".ram_codetext" ) ) ) static void mss_mux_post_mss_pll_config(
    void )
{
    /*
...
void sgmii_mux_config( uint8_t option )
{
    switch( option )
    {
        ...
        case SCB_UPDATE: /* write to   SCB register */
            ...
            MSS_SCB_CFM_SGMII_MUX
                ->SGMII_CLKMUX = LIBERO_SETTING_SGMII_SGMII_CLKMUX;
            /*
             ...
             */
            MSS_SCB_CFM_SGMII_MUX
                ->CLK_XCVR = LIBERO_SETTING_SGMII_CLK_XCVR; /* 0x2011 */
            /*
            ...
            MSS_SCB_CFM_SGMII_MUX->RFCKMUX = LIBERO_SETTING_SGMII_REFCLKMUX;
            break;
    ...
    switch( option )
    {
        ...
        case RPC_REG_UPDATE:
            ...
            CFG_DDR_SGMII_PHY->PLL_CTRL_MAIN
                .PLL_CTRL_MAIN = LIBERO_SETTING_DDR_PLL_CTRL | 0x01U;
            CFG_DDR_SGMII_PHY->PLL_REF_FB_MAIN
                .PLL_REF_FB_MAIN = LIBERO_SETTING_DDR_PLL_REF_FB;
            /* Read only in RPC
             * CFG_DDR_SGMII_PHY->PLL_FRACN_MAIN.PLL_FRACN_MAIN      =\
             *  LIBERO_SETTING_DDR_PLL_FRACN; */
            CFG_DDR_SGMII_PHY->PLL_DIV_0_1_MAIN
                .PLL_DIV_0_1_MAIN = LIBERO_SETTING_DDR_PLL_DIV_0_1;
            CFG_DDR_SGMII_PHY->PLL_DIV_2_3_MAIN
                .PLL_DIV_2_3_MAIN = LIBERO_SETTING_DDR_PLL_DIV_2_3;
            CFG_DDR_SGMII_PHY->PLL_CTRL2_MAIN
                .PLL_CTRL2_MAIN = LIBERO_SETTING_DDR_PLL_CTRL2;
            ...
            CFG_DDR_SGMII_PHY->PLL_PHADJ_MAIN
                .PLL_PHADJ_MAIN = LIBERO_SETTING_DDR_PLL_PHADJ;
            ...
            CFG_DDR_SGMII_PHY->SSCG_REG_2_MAIN
                .SSCG_REG_2_MAIN = LIBERO_SETTING_DDR_SSCG_REG_2;
...
uint8_t sgmii_pll_lock_scb( void )
{
    uint8_t result = 1U;
        #ifndef RENODE_DEBUG
    if( ( MSS_SCB_SGMII_PLL->PLL_CTRL & PLL_CTRL_LOCK_BIT ) ==
        PLL_CTRL_LOCK_BIT )
    {
        result = 0U; /* PLL lock has occurred */
    }
