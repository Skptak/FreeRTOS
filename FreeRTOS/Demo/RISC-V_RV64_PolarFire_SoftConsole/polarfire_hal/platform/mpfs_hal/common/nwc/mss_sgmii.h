...
#define REG_CDR_MOVE_STEP \
    ( 1U << 22U ) /* delay taps 1 => 3 taps moved, 0 => 2 taps move. */
...
#define IOSCB_BANK_CNTL_SGMII \
    ( ( volatile IOSCB_BANK_CNTL_SGMII_STRUCT * ) IOSCB_BANK_CNTL_SGMII_BASE )
...
#define IOSCB_DLL_SGMII \
    ( ( volatile IOSCB_DLL_SGMII_STRUCT * ) IOSCB_DLL_SGMII_BASE )
...
#define SGMIIPHY_LANE01 \
    ( ( volatile IOSCB_SGMIIPHY_LANE01_STRUCT * ) SGMIIPHY_LANE01_BASE )
#define SGMIIPHY_LANE23 \
    ( ( volatile IOSCB_SGMIIPHY_LANE01_STRUCT * ) SGMIIPHY_LANE23_BASE )
...
{
    __IO uint32_t network_control; /* The network configuration register
                                      contains functions for setting the mode of
