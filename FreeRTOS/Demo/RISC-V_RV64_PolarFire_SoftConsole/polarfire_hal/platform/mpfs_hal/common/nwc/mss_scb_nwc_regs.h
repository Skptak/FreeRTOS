...
#define MSS_SCB_MSS_PLL_BASE \
    ( 0x3E001000U ) /*!< ( MSS_SCB_MSS_PLL_BASE ) Base Address */
#define MSS_SCB_DDR_PLL_BASE \
    ( 0x3E010000U ) /*!< ( MSS_SCB_DDR_PLL_BASE ) Base Address */
#define MSS_SCB_SGMII_PLL_BASE \
    ( 0x3E080000U ) /*!< ( MSS_SCB_SGMII_PLL_BASE ) Base Address */

#define MSS_SCB_MSS_MUX_BASE \
    ( 0x3E002000U ) /*!< ( MSS_SCB_MSS_MUX_BASE ) Base Address */
#define MSS_SCB_SGMII_MUX_BASE \
    ( 0x3E200000U ) /*!< ( MSS_SCB_SGMII_PLL_BASE ) Base Address */

#define IOSCB_IO_CALIB_SGMII_BASE \
    ( 0x3E800000U ) /*!< ( IOSCB_IO_CALIB_SGMII_BASE ) Base Address */
#define IOSCB_IO_CALIB_DDR_BASE \
    ( 0x3E040000U ) /*!< ( IOSCB_IO_CALIB_SGMII_BASE ) Base Address */
