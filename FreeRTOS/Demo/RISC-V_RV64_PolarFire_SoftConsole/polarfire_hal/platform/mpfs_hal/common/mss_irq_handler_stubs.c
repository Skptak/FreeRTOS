...
#ifndef SIFIVE_HIFIVE_UNLEASHED
__attribute__( ( weak ) ) uint8_t gpio0_bit0_or_gpio2_bit13_plic_0_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit1_or_gpio2_bit13_plic_1_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit2_or_gpio2_bit13_plic_2_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit3_or_gpio2_bit13_plic_3_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit4_or_gpio2_bit13_plic_4_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit5_or_gpio2_bit13_plic_5_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit6_or_gpio2_bit13_plic_6_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit7_or_gpio2_bit13_plic_7_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit8_or_gpio2_bit13_plic_8_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit9_or_gpio2_bit13_plic_9_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit10_or_gpio2_bit13_plic_10_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit11_or_gpio2_bit13_plic_11_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit12_or_gpio2_bit13_plic_12_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio0_bit13_or_gpio2_bit13_plic_13_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit0_or_gpio2_bit14_plic_14_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit1_or_gpio2_bit15_plic_15_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit2_or_gpio2_bit16_plic_16_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit3_or_gpio2_bit17_plic_17_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit4_or_gpio2_bit18_plic_18_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit5_or_gpio2_bit19_plic_19_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit6_or_gpio2_bit20_plic_20_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit7_or_gpio2_bit21_plic_21_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit8_or_gpio2_bit22_plic_22_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit9_or_gpio2_bit23_plic_23_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit10_or_gpio2_bit24_plic_24_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit11_or_gpio2_bit25_plic_25_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit12_or_gpio2_bit26_plic_26_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit13_or_gpio2_bit27_plic_27_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit14_or_gpio2_bit28_plic_28_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit15_or_gpio2_bit29_plic_29_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit16_or_gpio2_bit30_plic_30_IRQHandler(
    void )
{
    return ( 0U );
}

__attribute__( ( weak ) ) uint8_t gpio1_bit17_or_gpio2_bit31_plic_31_IRQHandler(
    void )
{
    return ( 0U );
}
