...
#define RXRDY_TXRDYN_EN_MASK \
    ( 0x01u << 0u )                        /* Enable TXRDY and RXRDY signals */
#define CLEAR_RX_FIFO_MASK ( 0x01u << 1u ) /* Clear receiver FIFO */
#define CLEAR_TX_FIFO_MASK ( 0x01u << 2u ) /* Clear transmitter FIFO */
#define RDYMODE_MASK                                        \
    ( 0x01u << 3u ) /* Mode 0 or Mode 1 for TXRDY and RXRDY \
                     */
...
#define ETBEI_MASK \
    ( 0x01u << 1u ) /* Enable transmitter buffer empty interrupt */
