...
/***************************************************************************/ /**
   ...
   provides the allowed values for the UART_16550_set_loopback() function’s
   loopback parameter.
  */
typedef enum
{
...
/***************************************************************************/ /**
   This typedef specifies the function prototype for Core16550 interrupt
   handlers. All interrupt handlers registered with the Core16550 driver must be
   of this type. The interrupt handlers are registered with the driver through
   the UART_16550_set_rx_handler(), UART_16550_set_tx_handler(),
   UART_16550_set_rxstatus_handler(), and UART_16550_set_modemstatus_handler()
   functions.

   The this_uart parameter is a pointer to a uart_16550_instance_t structure
   that holds all data regarding this instance of the Core16550.
  */
...
/***************************************************************************/ /**
  ...
  *
  * Note:    The driver’s top level interrupt handler function UART_16550_isr()
  * will call your receive status handler function in response to an MS
  interrupt
  * from the Core16550.
  *
