 ...
 */
#define HW_get_uint32_reg( BASE_ADDR, REG_OFFSET ) \
    ( *( ( uint32_t volatile * ) ( BASE_ADDR + REG_OFFSET##_REG_OFFSET ) ) )

#define HW_set_uint32_reg( BASE_ADDR, REG_OFFSET, VALUE ) \
    ( *( ( uint32_t volatile * ) ( BASE_ADDR +            \
                                   REG_OFFSET##_REG_OFFSET ) ) = ( VALUE ) )
 ...
 */
#define HW_get_uint32( BASE_ADDR ) \
    ( *( ( uint32_t volatile * ) ( BASE_ADDR ) ) )

#define HW_set_uint32( BASE_ADDR, VALUE ) \
    ( *( ( uint32_t volatile * ) ( BASE_ADDR ) ) = ( VALUE ) )

/*------------------------------------------------------------------------------
 * 16 bits registers access:
 */
#define HW_get_uint16_reg( BASE_ADDR, REG_OFFSET ) \
    ( *( ( uint16_t volatile * ) ( BASE_ADDR + REG_OFFSET##_REG_OFFSET ) ) )

#define HW_set_uint16_reg( BASE_ADDR, REG_OFFSET, VALUE ) \
    ( *( ( uint16_t volatile * ) ( BASE_ADDR +            \
                                   REG_OFFSET##_REG_OFFSET ) ) = ( VALUE ) )
 ...
 */
#define HW_get_uint8_reg( BASE_ADDR, REG_OFFSET ) \
    ( *( ( uint8_t volatile * ) ( BASE_ADDR + REG_OFFSET##_REG_OFFSET ) ) )

#define HW_set_uint8_reg( BASE_ADDR, REG_OFFSET, VALUE ) \
    ( *( ( uint8_t volatile * ) ( BASE_ADDR +            \
                                  REG_OFFSET##_REG_OFFSET ) ) = ( VALUE ) )

#define HW_set_uint8_reg_field( BASE_ADDR, FIELD, VALUE )                      \
    ( *( ( uint8_t volatile * ) ( BASE_ADDR + FIELD##_OFFSET ) ) =             \
          ( ( uint8_t ) ( ( *( ( uint8_t volatile * ) ( BASE_ADDR +            \
                                                        FIELD##_OFFSET ) ) ) & \
                          ~FIELD##_MASK ) |                                    \
...
#define HW_set_uint8( BASE_ADDR, VALUE ) \
    ( *( ( uint8_t volatile * ) ( BASE_ADDR ) ) = ( VALUE ) )
