...
uint8_t ( *ext_irq_handler_table[ 32 ] )( void ) = {
    ...
    External_3_IRQHandler,  External_4_IRQHandler,  External_5_IRQHandler,
    ...
    External_21_IRQHandler, External_22_IRQHandler, External_23_IRQHandler,
    External_24_IRQHandler, External_25_IRQHandler, External_26_IRQHandler,
    External_27_IRQHandler, External_28_IRQHandler, External_29_IRQHandler,
    External_30_IRQHandler, External_31_IRQHandler
};
