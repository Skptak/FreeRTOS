...
/***************************************************************************/ /**
    ...
    #define MSCC_STDIO_UART_BASE_ADDR COREUARTAPB0_BASE_ADDR
        ...
        /*
         * The MSCC_STDIO_BAUD_VALUE define should be set in your project's
         * settings to specify the baud value used by the standard output
         * CoreUARTapb instance for generating the UART's baud rate if you want
         * a different baud rate from the default of 115200 baud
         */
