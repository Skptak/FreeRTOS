...
static inline void nrf53_handle_approtect( void )
{
    ...
    NRF_CTRLAP_S->APPROTECT.LOCK = CTRLAPPERI_APPROTECT_LOCK_LOCK_Locked;
            ...
            /* Do nothing, allow user code to handle APPROTECT. Use this if you
     ...
     * point. */
    NRF_CTRLAP_S->SECUREAPPROTECT
        .LOCK = CTRLAPPERI_SECUREAPPROTECT_LOCK_LOCK_Locked;

    #elif defined( ENABLE_SECURE_APPROTECT_USER_HANDLING )
            /* Do nothing, allow user code to handle SECURE APPROTECT. Use this
             * if you want to enable authenticated debug. */
