...
typedef enum IRQn
{
    ...
    HSMCI0_IRQn = 21, /**< 21 SAMA5D3x High Speed Multimedia Card Interface 0
                         (HSMCI0) */
    HSMCI1_IRQn = 22, /**< 22 SAMA5D3x High Speed Multimedia Card Interface 1
                         (HSMCI1) */
    HSMCI2_IRQn = 23, /**< 23 SAMA5D3x High Speed Multimedia Card Interface 2
                         (HSMCI2) */
...
#define ID_HSMCI0 \
    ( 21 ) /**< \brief High Speed Multimedia Card Interface 0 (HSMCI0) */
#define ID_HSMCI1 \
    ( 22 ) /**< \brief High Speed Multimedia Card Interface 1 (HSMCI1) */
#define ID_HSMCI2 \
    ( 23 ) /**< \brief High Speed Multimedia Card Interface 2 (HSMCI2) */
...
/*@{*/
    ...
    #define AXIMX \
        ( ( Aximx * ) 0x00800000U ) /**< \brief (AXIMX ) Base Address */
    #define HSMCI0 \
        ( ( Hsmci * ) 0xF0000000U ) /**< \brief (HSMCI0) Base Address */
    #define SPI0                                                    \
        ( ( Spi * ) 0xF0004000U ) /**< \brief (SPI0  ) Base Address \
                                   */
    #define SSC0                                                    \
        ( ( Ssc * ) 0xF0008000U ) /**< \brief (SSC0  ) Base Address \
                                   */
    #define CAN0                                                           \
        ( ( Can * ) 0xF000C000U )        /**< \brief (CAN0  ) Base Address \
                                          */
    #define TC0 ( ( Tc * ) 0xF0010000U ) /**< \brief (TC0   ) Base Address */
    #define TWI0                                                    \
        ( ( Twi * ) 0xF0014000U ) /**< \brief (TWI0  ) Base Address \
                                   */
    #define TWI1                                                    \
        ( ( Twi * ) 0xF0018000U ) /**< \brief (TWI1  ) Base Address \
                                   */
    #define USART0 \
        ( ( Usart * ) 0xF001C000U ) /**< \brief (USART0) Base Address */
    #define USART1 \
        ( ( Usart * ) 0xF0020000U ) /**< \brief (USART1) Base Address */
    #define UART0 \
        ( ( Uart * ) 0xF0024000U ) /**< \brief (UART0 ) Base Address */
    #define GMAC                                                            \
        ( ( Gmac * ) 0xF0028000U )        /**< \brief (GMAC  ) Base Address \
                                           */
    #define PWM ( ( Pwm * ) 0xF002C000U ) /**< \brief (PWM   ) Base Address */
    #define LCDC                                                            \
        ( ( Lcdc * ) 0xF0030000U )        /**< \brief (LCDC  ) Base Address \
                                           */
    #define ISI ( ( Isi * ) 0xF0034000U ) /**< \brief (ISI   ) Base Address */
    #define SFR ( ( Sfr * ) 0xF0038000U ) /**< \brief (SFR   ) Base Address */
    #define HSMCI1 \
        ( ( Hsmci * ) 0xF8000000U ) /**< \brief (HSMCI1) Base Address */
    #define HSMCI2 \
        ( ( Hsmci * ) 0xF8004000U ) /**< \brief (HSMCI2) Base Address */
    #define SPI1                                                    \
        ( ( Spi * ) 0xF8008000U ) /**< \brief (SPI1  ) Base Address \
                                   */
    #define SSC1                                                    \
        ( ( Ssc * ) 0xF800C000U ) /**< \brief (SSC1  ) Base Address \
                                   */
    #define CAN1                                                            \
        ( ( Can * ) 0xF8010000U )         /**< \brief (CAN1  ) Base Address \
                                           */
    #define TC1 ( ( Tc * ) 0xF8014000U )  /**< \brief (TC1   ) Base Address */
    #define ADC ( ( Adc * ) 0xF8018000U ) /**< \brief (ADC   ) Base Address */
    #define TWI2                                                    \
        ( ( Twi * ) 0xF801C000U ) /**< \brief (TWI2  ) Base Address \
                                   */
    #define USART2 \
        ( ( Usart * ) 0xF8020000U ) /**< \brief (USART2) Base Address */
    #define USART3 \
        ( ( Usart * ) 0xF8024000U ) /**< \brief (USART3) Base Address */
    #define UART1 \
        ( ( Uart * ) 0xF8028000U ) /**< \brief (UART1 ) Base Address */
    #define EMAC                                                     \
        ( ( Emac * ) 0xF802C000U ) /**< \brief (EMAC  ) Base Address \
                                    */
    #define UDPHS \
        ( ( Udphs * ) 0xF8030000U )       /**< \brief (UDPHS ) Base Address */
    #define SHA ( ( Sha * ) 0xF8034000U ) /**< \brief (SHA   ) Base Address */
    #define AES ( ( Aes * ) 0xF8038000U ) /**< \brief (AES   ) Base Address */
    #define TDES                                                     \
        ( ( Tdes * ) 0xF803C000U ) /**< \brief (TDES  ) Base Address \
                                    */
    #define TRNG                                                            \
        ( ( Trng * ) 0xF8040000U )        /**< \brief (TRNG  ) Base Address \
                                           */
    #define SMC ( ( Smc * ) 0xFFFFC000U ) /**< \brief (SMC   ) Base Address */
    #define FUSE                                                     \
        ( ( Fuse * ) 0xFFFFE400U ) /**< \brief (FUSE  ) Base Address \
                                    */
    #define DMAC0 \
        ( ( Dmac * ) 0xFFFFE600U ) /**< \brief (DMAC0 ) Base Address */
    #define DMAC1 \
        ( ( Dmac * ) 0xFFFFE800U ) /**< \brief (DMAC1 ) Base Address */
    #define MPDDRC \
        ( ( Mpddrc * ) 0xFFFFEA00U ) /**< \brief (MPDDRC) Base Address */
    #define MATRIX \
        ( ( Matrix * ) 0xFFFFEC00U ) /**< \brief (MATRIX) Base Address */
    #define DBGU                                                            \
        ( ( Dbgu * ) 0xFFFFEE00U )        /**< \brief (DBGU  ) Base Address \
                                           */
    #define AIC ( ( Aic * ) 0xFFFFF000U ) /**< \brief (AIC   ) Base Address */
    #define PIOA                                                    \
        ( ( Pio * ) 0xFFFFF200U ) /**< \brief (PIOA  ) Base Address \
                                   */
    #define PIOB                                                    \
        ( ( Pio * ) 0xFFFFF400U ) /**< \brief (PIOB  ) Base Address \
                                   */
    #define PIOC                                                    \
        ( ( Pio * ) 0xFFFFF600U ) /**< \brief (PIOC  ) Base Address \
                                   */
    #define PIOD                                                    \
        ( ( Pio * ) 0xFFFFF800U ) /**< \brief (PIOD  ) Base Address \
                                   */
    #define PIOE                                                            \
        ( ( Pio * ) 0xFFFFFA00U )         /**< \brief (PIOE  ) Base Address \
                                           */
    #define PMC ( ( Pmc * ) 0xFFFFFC00U ) /**< \brief (PMC   ) Base Address */
    #define RSTC                                                     \
        ( ( Rstc * ) 0xFFFFFE00U ) /**< \brief (RSTC  ) Base Address \
                                    */
    #define SHDWC \
        ( ( Shdwc * ) 0xFFFFFE10U )       /**< \brief (SHDWC ) Base Address */
    #define PIT ( ( Pit * ) 0xFFFFFE30U ) /**< \brief (PIT   ) Base Address */
    #define WDT ( ( Wdt * ) 0xFFFFFE40U ) /**< \brief (WDT   ) Base Address */
    #define SCKC                                                            \
        ( ( Sckc * ) 0xFFFFFE50U )        /**< \brief (SCKC  ) Base Address \
                                           */
    #define BSC ( ( Bsc * ) 0xFFFFFE54U ) /**< \brief (BSC   ) Base Address */
    #define GPBR                                                            \
        ( ( Gpbr * ) 0xFFFFFE60U )        /**< \brief (GPBR  ) Base Address \
                                           */
...
#define PIO_PD13A_SPI0_NPCS0                         \
    ( 1u << 13 ) /**< \brief Spi0 signal: SPI0_NPCS0 \
                  */
#define PIO_PD14B_SPI0_NPCS1                         \
    ( 1u << 14 ) /**< \brief Spi0 signal: SPI0_NPCS1 \
                  */
#define PIO_PD15B_SPI0_NPCS2                         \
    ( 1u << 15 ) /**< \brief Spi0 signal: SPI0_NPCS2 \
                  */
#define PIO_PD16B_SPI0_NPCS3                                                 \
    ( 1u << 16 )                         /**< \brief Spi0 signal: SPI0_NPCS3 \
                                          */
...
#define PIO_PC25A_SPI1_NPCS0                         \
    ( 1u << 25 ) /**< \brief Spi1 signal: SPI1_NPCS0 \
                  */
#define PIO_PC26A_SPI1_NPCS1                         \
    ( 1u << 26 ) /**< \brief Spi1 signal: SPI1_NPCS1 \
                  */
#define PIO_PC27A_SPI1_NPCS2                         \
    ( 1u << 27 ) /**< \brief Spi1 signal: SPI1_NPCS2 \
                  */
#define PIO_PC28A_SPI1_NPCS3                                                 \
...
#define EBI_NF_ADDR \
    ( 0x60000000u ) /**< NAND Flash on EBI Chip Select 3 base address */
#define NFC_ADDR \
    ( 0x70000000u ) /**< NAND Flash Controller Command base address */
...
#define IRAM0_ADDR ( 0x00300000u ) /**< Internal RAM 0 base address */
    ...
    #define IRAM1_ADDR \
        ( IRAM0_ADDR + IRAM0_SIZE ) /**< Internal RAM 1 base address */
#endif
#define SMD_ADDR ( 0x00400000u ) /**< Software Modem Device base address */
#define UDPHS_RAM_ADDR \
    ( 0x00500000u ) /**< USB High Speed Device Port RAM base address */
