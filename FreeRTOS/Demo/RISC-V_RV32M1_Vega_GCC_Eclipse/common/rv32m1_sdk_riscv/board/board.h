...
#define LED1_INIT( output )                                                   \
    ...
    BOARD_LED1_GPIO->PDDR |= ( 1U << BOARD_LED1_GPIO_PIN ) /*!< Enable target \
                                                              LED1 */
#define LED1_ON()                                                            \
    GPIO_SetPinsOutput( BOARD_LED1_GPIO,                                     \
                        1U << BOARD_LED1_GPIO_PIN ) /*!< Turn on target LED1 \
                                                     */
#define LED1_OFF()                                                         \
    GPIO_ClearPinsOutput( BOARD_LED1_GPIO,                                 \
                          1U << BOARD_LED1_GPIO_PIN ) /*!< Turn off target \
                                                         LED1 */
#define LED1_TOGGLE()                                                        \
    GPIO_TogglePinsOutput( BOARD_LED1_GPIO,                                  \
                           1U << BOARD_LED1_GPIO_PIN ) /*!< Toggle on target \
                                                          LED1 */

#define LED2_INIT( output )                                                   \
    GPIO_WritePinOutput( BOARD_LED2_GPIO, BOARD_LED2_GPIO_PIN, output );      \
    BOARD_LED2_GPIO->PDDR |= ( 1U << BOARD_LED2_GPIO_PIN ) /*!< Enable target \
                                                              LED2 */
#define LED2_ON()                                                            \
    GPIO_SetPinsOutput( BOARD_LED2_GPIO,                                     \
                        1U << BOARD_LED2_GPIO_PIN ) /*!< Turn on target LED2 \
                                                     */
#define LED2_OFF()                                                         \
    GPIO_ClearPinsOutput( BOARD_LED2_GPIO,                                 \
                          1U << BOARD_LED2_GPIO_PIN ) /*!< Turn off target \
                                                         LED2 */
#define LED2_TOGGLE()                                                        \
    GPIO_TogglePinsOutput( BOARD_LED2_GPIO,                                  \
                           1U << BOARD_LED2_GPIO_PIN ) /*!< Toggle on target \
                                                          LED2 */

#define LED3_INIT( output )                                                   \
    GPIO_WritePinOutput( BOARD_LED3_GPIO, BOARD_LED3_GPIO_PIN, output );      \
    BOARD_LED3_GPIO->PDDR |= ( 1U << BOARD_LED3_GPIO_PIN ) /*!< Enable target \
                                                              LED3 */
#define LED3_ON()                                                            \
    GPIO_SetPinsOutput( BOARD_LED3_GPIO,                                     \
                        1U << BOARD_LED3_GPIO_PIN ) /*!< Turn on target LED3 \
                                                     */
#define LED3_OFF()                                                         \
    GPIO_ClearPinsOutput( BOARD_LED3_GPIO,                                 \
                          1U << BOARD_LED3_GPIO_PIN ) /*!< Turn off target \
                                                         LED3 */
#define LED3_TOGGLE()                                                        \
    GPIO_TogglePinsOutput( BOARD_LED3_GPIO,                                  \
                           1U << BOARD_LED3_GPIO_PIN ) /*!< Toggle on target \
                                                          LED3 */
...
#define BOARD_USDHC_CD_GPIO_INIT()                               \
    {                                                            \
        ...
        GPIO_PinInit( BOARD_USDHC_CD_GPIO_BASE,                  \
                      BOARD_USDHC_CD_GPIO_PIN,                   \
                      &sw_config );                              \
        PORT_SetPinInterruptConfig( BOARD_USDHC_CD_PORT_BASE,    \
                                    BOARD_USDHC_CD_GPIO_PIN,     \
                                    kPORT_InterruptRisingEdge ); \
    }

#define BOARD_USDHC_CD_STATUS() \
    ( GPIO_ReadPinInput( BOARD_USDHC_CD_GPIO_BASE, BOARD_USDHC_CD_GPIO_PIN ) )

#define BOARD_USDHC_CD_INTERRUPT_STATUS() \
    ( GPIO_GetPinsInterruptFlags( BOARD_USDHC_CD_GPIO_BASE ) )
#define BOARD_USDHC_CD_CLEAR_INTERRUPT( flag ) \
    ( GPIO_ClearPinsInterruptFlags( BOARD_USDHC_CD_GPIO_BASE, flag ) )
