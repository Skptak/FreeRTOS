...
/* @brief Enable support for low voltage reference on option 1 reference
 * (bitfield CFG[VREF1RNG]). */
...
/* @brief Has flags indicating the status of the FlexRAM (register bits
 * FCNFG[EEERDY], FCNFG[RAMRDY] and FCNFG[PFLSH]). */
...
/* @brief Has flash access control (registers XACCHn, SACCHn, where n is a
 * number, FACSS and FACSN). */
...
/* @brief P-Flash flash size coding rule version, value 0 for K1 and K2, value 1
 * for RV32M1. */
...
/* @brief FlexNVM partition code 0000 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_0000       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 0001 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_0001       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 0010 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_0010       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 0011 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
...
/* @brief FlexNVM partition code 0101 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_0101       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 0110 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_0110       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 0111 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
...
/* @brief FlexNVM partition code 1001 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1001       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1010 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1010       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1011 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1011       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1100 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1100       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1101 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1101       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1110 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1110       ( 0xFFFFFFFF )
/* @brief FlexNVM partition code 1111 mapping to data flash size in bytes
 * (0xFFFFFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_DFLASH_SIZE_FOR_DEPART_1111       ( 0xFFFFFFFF )
/* @brief Emulated eeprom size code 0000 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0000      ( 0xFFFF )
/* @brief Emulated eeprom size code 0001 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0001      ( 0xFFFF )
/* @brief Emulated eeprom size code 0010 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0010      ( 0x1000 )
/* @brief Emulated eeprom size code 0011 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0011      ( 0x0800 )
/* @brief Emulated eeprom size code 0100 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0100      ( 0x0400 )
/* @brief Emulated eeprom size code 0101 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0101      ( 0x0200 )
/* @brief Emulated eeprom size code 0110 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0110      ( 0x0100 )
/* @brief Emulated eeprom size code 0111 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_0111      ( 0x0080 )
/* @brief Emulated eeprom size code 1000 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1000      ( 0x0040 )
/* @brief Emulated eeprom size code 1001 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1001      ( 0x0020 )
/* @brief Emulated eeprom size code 1010 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1010      ( 0xFFFF )
/* @brief Emulated eeprom size code 1011 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1011      ( 0xFFFF )
/* @brief Emulated eeprom size code 1100 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1100      ( 0xFFFF )
/* @brief Emulated eeprom size code 1101 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1101      ( 0xFFFF )
/* @brief Emulated eeprom size code 1110 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1110      ( 0xFFFF )
/* @brief Emulated eeprom size code 1111 mapping to emulated eeprom size in
 * bytes (0xFFFF = reserved). */
#define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1111      ( 0x0000 )

/* GPIO module features */

/* @brief Has fast (single cycle) access capability via a dedicated memory
 * region. */
...
/* @brief Has possibility to enable reset in low leakage power mode and enable
 * digital filter for RESET pin (register LLWU_RST). */
...
/* @brief brief MU does not support enable clock of the other core, CR[CLKE] or
 * CCR[CLKE]. */
#define FSL_FEATURE_MU_NO_CLKE                                       ( 0 )
/* @brief brief MU does not support NMI, CR[NMI]. */
#define FSL_FEATURE_MU_NO_NMI                                        ( 0 )
/* @brief brief MU does not support hold the other core reset. CR[RSTH] or
 * CCR[RSTH]. */
...
/* @brief 32k oscillator clock selection width (width of register bit field
 * SOPT1[OSC32KSEL]). */
...
/* @brief Has number of NFC hold cycle in case of FlexBus request (register bit
 * SOPT6[MCC]). */
#define FSL_FEATURE_SIM_OPT_HAS_MCC                                  ( 0 )
/* @brief Has UART open drain enable (register bits UARTnODE, where n is a
 * number, in register SOPT5). */
#define FSL_FEATURE_SIM_OPT_HAS_ODE                                  ( 0 )
/* @brief Number of LPUART modules (number of register bits LPUARTn, where n is
 * a number, in register SCGC5). */
#define FSL_FEATURE_SIM_OPT_LPUART_COUNT                             ( 0 )
/* @brief Number of UART modules (number of register bits UARTn, where n is a
 * number, in register SCGC4). */
...
/* @brief UART0 transmit data source selection width (width of register bit
 * SOPT5[UART0TXSRC]). */
...
/* @brief UART0 receive data source selection width (width of register bit
 * SOPT5[UART0RXSRC]). */
...
/* @brief UART1 receive data source selection width (width of register bit
 * SOPT5[UART1RXSRC]). */
...
/* @brief Has FTM0 triggers source selection (register bits SOPT4[FTM0TRGnSRC],
 * where n is a number). */
#define FSL_FEATURE_SIM_OPT_HAS_FTM0_TRIGGER                         ( 0 )
/* @brief Has FTM3 triggers source selection (register bits SOPT4[FTM3TRGnSRC],
 * where n is a number). */
...
/* @brief Number of configurable FTM0 fault detection input (number of register
 * bits SOPT4[FTM0FLTn], where n is a number starting from zero). */
#define FSL_FEATURE_SIM_OPT_FTM0_FAULT_COUNT                         ( 0 )
/* @brief Number of configurable FTM1 fault detection input (number of register
 * bits SOPT4[FTM1FLTn], where n is a number starting from zero). */
#define FSL_FEATURE_SIM_OPT_FTM1_FAULT_COUNT                         ( 0 )
/* @brief Number of configurable FTM2 fault detection input (number of register
 * bits SOPT4[FTM2FLTn], where n is a number starting from zero). */
#define FSL_FEATURE_SIM_OPT_FTM2_FAULT_COUNT                         ( 0 )
/* @brief Number of configurable FTM3 fault detection input (number of register
 * bits SOPT4[FTM3FLTn], where n is a number starting from zero). */
#define FSL_FEATURE_SIM_OPT_FTM3_FAULT_COUNT                         ( 0 )
/* @brief Has FTM hardware trigger 0 software synchronization (register bit
 * SOPT8[FTMnSYNCBIT], where n is a module instance index). */
 ...
 * (register bits TPMnCH0SRC, TPMnCLKSEL, where n is a module instance index).
 */
#define FSL_FEATURE_SIM_OPT_HAS_TPM_CHANNELS_CONFIG_IN_SOPT4_REG     ( 0 )
/* @brief Has TPM1 channel 0 input capture source selection (register bit field
 * SOPT4[TPM1CH0SRC] or SOPT9[TPM1CH0SRC]). */
...
/* @brief TPM1 channel 0 input capture source selection width (width of register
 * bit field SOPT4[TPM1CH0SRC] or SOPT9[TPM1CH0SRC]). */
#define FSL_FEATURE_SIM_OPT_TPM1_CH0_SRC_SELECTION_WIDTH             ( 0 )
/* @brief Has TPM2 channel 0 input capture source selection (register bit field
 * SOPT4[TPM2CH0SRC]). */
...
/* @brief ADC0 alternate trigger enable width (width of bit field ADC0ALTTRGEN
 * of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_ADC0ALTTRGEN_WIDTH                       ( 0 )
/* @brief ADC1 alternate trigger enable width (width of bit field ADC1ALTTRGEN
 * of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_ADC1ALTTRGEN_WIDTH                       ( 0 )
/* @brief ADC2 alternate trigger enable width (width of bit field ADC2ALTTRGEN
 * of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_ADC2ALTTRGEN_WIDTH                       ( 0 )
/* @brief ADC3 alternate trigger enable width (width of bit field ADC3ALTTRGEN
 * of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_ADC3ALTTRGEN_WIDTH                       ( 0 )
/* @brief HSADC0 converter A alternate trigger enable width (width of bit field
 * HSADC0AALTTRGEN of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_HSADC0AALTTRGEN_WIDTH                    ( 0 )
/* @brief HSADC1 converter A alternate trigger enable width (width of bit field
 * HSADC1AALTTRGEN of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_HSADC1AALTTRGEN_WIDTH                    ( 0 )
/* @brief ADC converter A alternate trigger enable width (width of bit field
 * ADCAALTTRGEN of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_ADCAALTTRGEN_WIDTH                       ( 0 )
/* @brief HSADC0 converter B alternate trigger enable width (width of bit field
 * HSADC0BALTTRGEN of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_HSADC0BALTTRGEN_WIDTH                    ( 0 )
/* @brief HSADC1 converter B alternate trigger enable width (width of bit field
 * HSADC1BALTTRGEN of register SOPT7). */
#define FSL_FEATURE_SIM_OPT_HSADC1BALTTRGEN_WIDTH                    ( 0 )
/* @brief ADC converter B alternate trigger enable width (width of bit field
 * ADCBALTTRGEN of register SOPT7). */
...
/* @brief Has USB FS clock divider (register bit field CLKDIV2[USBFSDIV] and
 * CLKDIV2[USBFSFRAC]). */
#define FSL_FEATURE_SIM_DIVIDER_HAS_USBFSDIV                         ( 0 )
/* @brief Has USB HS clock divider (register bit field CLKDIV2[USBHSDIV] and
 * CLKDIV2[USBHSFRAC]). */
#define FSL_FEATURE_SIM_DIVIDER_HAS_USBHSDIV                         ( 0 )
/* @brief Has PLL/FLL clock divider (register bit field CLKDIV3[PLLFLLDIV] and
 * CLKDIV3[PLLFLLFRAC]). */
...
/* @brief Has trace clock divider (register bit field CLKDIV4[TRACEDIV] and
 * CLKDIV4[TRACEFRAC]). */
...
/* @brief Maximum flash address block 0 address specifier (register bit field
 * FCFG2[MAXADDR0]). */
#define FSL_FEATURE_SIM_FCFG_HAS_MAXADDR0                            ( 0 )
/* @brief Maximum flash address block 1 address specifier (register bit field
 * FCFG2[MAXADDR1]). */
#define FSL_FEATURE_SIM_FCFG_HAS_MAXADDR1                            ( 0 )
/* @brief Maximum flash address block 0 or 1 address specifier (register bit
 * field FCFG2[MAXADDR01]). */
#define FSL_FEATURE_SIM_FCFG_HAS_MAXADDR01                           ( 1 )
/* @brief Maximum flash address block 2 or 3 address specifier (register bit
 * field FCFG2[MAXADDR23]). */
...
/* @brief Has COP watchdog stop (register bits COPC[COPSTPEN], COPC[COPDBGEN]
 * and COPC[COPCLKSEL]). */
...
/* @brief Has POR power option (register bit STOPCTRL[PORPO] or
 * VLLSCTRL[PORPO]). */
...
#define FSL_FEATURE_TPM_CHANNEL_COUNTn( x ) \
    ( ( x ) == TPM0                         \
          ...
          : ( ( x ) == TPM1                 \
                  ...
                  : ( ( x ) == TPM2 ? ( 6 ) \
                                    : ( ( x ) == TPM3 ? ( 2 ) : ( -1 ) ) ) ) )
/* @brief Has counter reset by the selected input capture event (register bits
 * C0SC[ICRST], C1SC[ICRST], ...). */
...
#define FSL_FEATURE_USB_KHCI_KEEP_ALIVE_MODE_CONTROL \
    ( USB_KEEP_ALIVE_CTRL_WAKE_REQ_EN_MASK )
...
/* @brief Does not have logical partition enable option (register bit
 * MDA_W[LPE]). */
#define FSL_FEATURE_XRDC_NO_MDA_LPE                                ( 1 )
/* @brief Does not have peripheral semaphore enable option (register bit
 * PDAC_W0[SE]). */
#define FSL_FEATURE_XRDC_NO_PDAC_SE                                ( 1 )
/* @brief Does not have peripheral semaphore number (register bit
 * PDAC_W0[SNUM]). */
#define FSL_FEATURE_XRDC_NO_PDAC_SNUM                              ( 1 )
/* @brief Has peripheral excessive access lock owner (register bit
 * PDAC_W0[EALO]). */
#define FSL_FEATURE_XRDC_HAS_PDAC_EALO                             ( 1 )
/* @brief Has peripheral excessive access lock option (register bit
 * PDAC_W1[EAL]). */
...
/* @brief Does not have memory region semaphore enable option (register bit
 * MRGD_W2[SE]). */
#define FSL_FEATURE_XRDC_NO_MRGD_SE                                ( 1 )
/* @brief Does not have memory region semaphore number (register bit
 * MRGD_W2[SNUM]). */
#define FSL_FEATURE_XRDC_NO_MRGD_SNUM                              ( 1 )
/* @brief Does not domain x access control policy option (register bit
 * MRGD_W2[DxACP]). */
...
/* @brief Has memory region excessive access lock owner (register bit
 * MRGD_W2[EALO]). */
#define FSL_FEATURE_XRDC_HAS_MRGD_EALO                             ( 1 )
/* @brief Has domain x access policy select option (register bit
 * MRGD_W2[DxSEL]). */
#define FSL_FEATURE_XRDC_HAS_MRGD_DXSEL                            ( 1 )
/* @brief Has memory region excessive access lock option (register bit
 * MRGD_W3[EAL]). */
#define FSL_FEATURE_XRDC_HAS_MRGD_EAL                              ( 1 )
/* @brief Does not have lock option in MRGD_W3 register (register bit
 * MRGD_W3[LK2]). */
#define FSL_FEATURE_XRDC_NO_MRGD_W3_LK2                            ( 1 )
/* @brief Does not have valid option in MRGD_W3 register (register bit
 * MRGD_W3[VLD]). */
...
/* @brief Has programmable access flags (register bit
 * MRGD_W4[ACCSET1]/[ACCSET2]). */
