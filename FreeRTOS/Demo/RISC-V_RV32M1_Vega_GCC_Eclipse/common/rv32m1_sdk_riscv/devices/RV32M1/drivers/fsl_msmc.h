...
{
    kSMC_AllowPowerModeVlls = SMC_PMPROT_AVLLS_MASK, /*!< Allow Very-Low-Leakage
                                                        Stop Mode. */
    kSMC_AllowPowerModeLls = SMC_PMPROT_ALLS_MASK,   /*!< Allow Low-Leakage Stop
                                                        Mode.      */
    kSMC_AllowPowerModeVlp = SMC_PMPROT_AVLP_MASK,   /*!< Allow Very-Low-Power
                                                        Mode.        */
    kSMC_AllowPowerModeHsrun = SMC_PMPROT_AHSRUN_MASK, /*!< Allow High Speed Run
                                                          mode.        */
    kSMC_AllowPowerModeAll = SMC_PMPROT_AVLLS_MASK | SMC_PMPROT_ALLS_MASK |
...
typedef enum _smc_power_state
{
    ...
    kSMC_PowerStateStop = 1U << 1U, /*!< 0000_0010 - Current power mode is any
                                       STOP mode  */
    kSMC_PowerStateVlpr = 1U
                          << 2U, /*!< 0000_0100 - Current power mode is VLPR  */
    kSMC_PowerStateHsrun = 1U
                           << 7U /*!< 1000_0000 - Current power mode is HSRUN */
} smc_power_state_t;
...
{
    kSMC_PowerStopEntryAlt0 = 1U, /*!< Indicates a Stop mode entry since this
                                     field was last cleared. */
    kSMC_PowerStopEntryAlt1 = 1U << 1, /*!< Indicates the system bus masters
                                          acknowledged the Stop mode entry. */
    kSMC_PowerStopEntryAlt2 = 1U
                              << 2, /*!< Indicates the system clock peripherals
                                       acknowledged the Stop mode entry. */
    kSMC_PowerStopEntryAlt3 = 1U << 3, /*!< Indicates the bus clock peripherals
                                          acknowledged the Stop mode entry. */
    kSMC_PowerStopEntryAlt4 = 1U << 4, /*!< Indicates the slow clock peripherals
                                          acknowledged the Stop mode entry. */
    kSMC_PowerStopEntryAlt5 = 1U
                              << 5, /*!< Indicates Stop mode entry completed. */
...
typedef enum _smc_stop_mode
{
    ...
    kSMC_StopLls = 3U,    /*!< Low-Leakage Stop mode.      */
     ...
     FSL_FEATURE_SMC_HAS_SUB_STOP_MODE )
    #if( defined( FSL_FEATURE_SMC_HAS_STOP_SUBMODE2 ) && \
         FSL_FEATURE_SMC_HAS_STOP_SUBMODE2 )
    kSMC_StopVlls2 = 4U, /*!< Very-Low-Leakage Stop mode, VLPS2/3. */
    #endif               /* FSL_FEATURE_SMC_HAS_STOP_SUBMODE2 */
    #if( defined( FSL_FEATURE_SMC_HAS_STOP_SUBMODE0 ) && \
         FSL_FEATURE_SMC_HAS_STOP_SUBMODE0 )
...
typedef enum _smc_partial_stop_mode
{
    ...
    kSMC_PartialStop1 = 1U, /*!< Partial Stop with both system and bus clocks
                               disabled*/
    kSMC_PartialStop2 = 2U, /*!< Partial Stop with system clock disabled and bus
                               clock enabled*/
    kSMC_PartialStop3 = 3U, /*!< Partial Stop with system clock enabled and bus
                               clock disabled*/
...
enum _smc_status
{
    kStatus_SMC_StopAbort = MAKE_STATUS( kStatusGroup_POWER,
                                         0 ), /*!< Entering Stop mode is abort*/
};
...
typedef enum _smc_reset_source
{
    ...
    kSMC_SourceWarm = SMC_SRS_WARM_MASK,   /*!< Warm reset. Warm Reset flag will
                                              assert if any of the system reset
                                               sources in this register assert
                                              (SRS[31:8]) */
    kSMC_SourceFatal = SMC_SRS_FATAL_MASK, /*!< Fatal reset */
    kSMC_SourceCore = SMC_SRS_CORE_MASK, /*!< Software reset that only reset the
                                            core, NOT a sticky system reset
                                            source. */
    kSMC_SourcePin = SMC_SRS_PIN_MASK,   /*!< RESET_B pin reset. */
    kSMC_SourceMdm = SMC_SRS_MDM_MASK,   /*!< MDM reset. */
    kSMC_SourceRstAck = SMC_SRS_RSTACK_MASK,   /*!< Reset Controller timeout
                                                  reset. */
    ...
    kSMC_SourceLockup = SMC_SRS_LOCKUP_MASK, /*!< Lockup reset. Core lockup or
                                                exception. */
    kSMC_SourceJtag = SMC_SRS_JTAG_MASK,     /*!< JTAG system reset */
#if( defined( FSL_FEATURE_SMC_HAS_SRS_SECVIO ) && \
     FSL_FEATURE_SMC_HAS_SRS_SECVIO )
    kSMC_SourceSecVio = SMC_SRS_SECVIO_MASK, /*!< Security violation reset */
#endif /* FSL_FEATURE_SMC_HAS_SRS_SECVIO */
#if( defined( FSL_FEATURE_SMC_HAS_SRS_TAMPER ) && \
     FSL_FEATURE_SMC_HAS_SRS_TAMPER )
    ...
    /* Source All. */
    kSMC_SourceAll = SMC_SRS_WAKEUP_MASK | SMC_SRS_POR_MASK | SMC_SRS_LVD_MASK |
                     SMC_SRS_HVD_MASK | SMC_SRS_WARM_MASK | SMC_SRS_FATAL_MASK |
                     SMC_SRS_CORE_MASK | SMC_SRS_PIN_MASK | SMC_SRS_MDM_MASK |
                     SMC_SRS_RSTACK_MASK | SMC_SRS_STOPACK_MASK |
                     SMC_SRS_SCG_MASK | SMC_SRS_WDOG_MASK | SMC_SRS_SW_MASK |
                     SMC_SRS_LOCKUP_MASK | SMC_SRS_JTAG_MASK
#if( defined( FSL_FEATURE_SMC_HAS_SRS_SECVIO ) && \
     FSL_FEATURE_SMC_HAS_SRS_SECVIO )
                     | SMC_SRS_SECVIO_MASK
#endif /* FSL_FEATURE_SMC_HAS_SRS_SECVIO */
...
typedef enum _smc_interrupt_enable
{
...
#if( defined( FSL_FEATURE_SMC_HAS_CSRE_CORE0 ) && \
     FSL_FEATURE_SMC_HAS_CSRE_CORE0 )
    kSMC_IntCore0 = SMC_SRIE_CORE0_MASK, /*! Core 0 interrupts. */
#endif                                   /* FSL_FEATURE_SMC_HAS_CSRE_CORE0 */
#if( defined( FSL_FEATURE_SMC_HAS_CSRE_CORE1 ) && \
     FSL_FEATURE_SMC_HAS_CSRE_CORE1 )
    ...
    kSMC_IntAll = SMC_SRIE_PIN_MASK | /*!< All system reset interrupts.      */
                  SMC_SRIE_MDM_MASK | SMC_SRIE_STOPACK_MASK |
                  SMC_SRIE_WDOG_MASK | SMC_SRIE_SW_MASK | SMC_SRIE_LOCKUP_MASK
#if( defined( FSL_FEATURE_SMC_HAS_CSRE_CORE0 ) && \
     FSL_FEATURE_SMC_HAS_CSRE_CORE0 )
                  | SMC_SRIE_CORE0_MASK
#endif /* FSL_FEATURE_SMC_HAS_CSRE_CORE0 */
...
{
    uint8_t slowClockFilterCount; /*!< Reset pin bus clock filter width from 1
                                     to 32 slow clock cycles.  */
    bool enableFilter;            /*!< Reset pin filter enable/disable. */
#if( defined( FSL_FEATURE_SMC_HAS_RPC_LPOFEN ) && \
     FSL_FEATURE_SMC_HAS_RPC_LPOFEN )
 ...
 * are defined in the smc_power_mode_protection_t. This should be done at an
 * early system level initialization stage. See the reference manual for
 * details. This register can only write once after the power reset.
 *
 * The allowed modes are passed as bit map, for example, to allow LLS and VLLS,
 * use SMC_SetPowerModeProtection(kSMC_AllowPowerModeLls |
 * kSMC_AllowPowerModeVlls). To allow all modes, use
...
{
    return ( smc_power_state_t ) ( ( base->PMSTAT & SMC_PMSTAT_PMSTAT_MASK ) >>
                                   SMC_PMSTAT_PMSTAT_SHIFT );
}

#if( defined( FSL_FEATURE_SMC_HAS_PMSTAT_STOPSTAT ) && \
     FSL_FEATURE_SMC_HAS_PMSTAT_STOPSTAT )
/*!
 ...
 */
static inline smc_power_stop_entry_status_t SMC_GetStopEntryStatus(
    SMC_Type * base )
{
    return ( smc_power_stop_entry_status_t ) ( ( base->PMSTAT &
                                                 SMC_PMSTAT_STOPSTAT_MASK ) >>
...
static inline void SMC_ClearStopEntryStatus( SMC_Type * base )
{
    ...
    base->PMSTAT = ( base->PMSTAT & ~SMC_PMSTAT_STOPSTAT_MASK ) |
                   SMC_PMSTAT_STOPSTAT( 0x01 );
}
 ...
 *
 * This function sets the reset pin filter including the enablement/disablement
 * and filter width.
 *
 * @param base SMC peripheral base address.
 ...
 *
 * For a graceful shut down, the MSMC supports delaying the assertion of the
 * system reset for a period of time when the reset interrupt is generated. This
 * function can be used to enable the interrupt. The interrupts are passed in as
 * bit mask. See smc_interrupt_enable_t for details. For example, to delay a
 * reset after the WDOG timeout or PIN reset occurs, configure as follows:
 ...
 *
 * This function clears the source status of the reset interrupt. Use source
 masks
 * defined in the smc_interrupt_enable_t to get the desired source status.
 *
 * Example:
 ...
 *
 * The MSMC supports delaying the assertion of the system reset for a period of
 * time while a core software reset is generated. This allows software to
 * recover without reseting the entire system. This function can be used to
 * enable/disable the core software reset feature. The interrupts are passed in
 * as bit mask. See smc_interrupt_enable_t for details. For example, to delay a
 * system after the WDOG timeout or PIN core software reset occurs, configure as
 * follows: SMC_SetCoreSoftwareResetConfig(SMC0, (kSMC_IntWdog | kSMC_IntPin));
 *
 * @param base SMC peripheral base address.
 ...
 *
 * @param base SMC peripheral base address.
 * @return The boot option configuration. 1 means boot option enabled. 0 means
 * not.
 */
 ...
 *
 * This function sets the focus boot option configuration of MSMC. It can force
 * the corresponding boot option config to assert on next system reset.
 *
 * @param base SMC peripheral base address.
 * @param val The boot option configuration for next system reset. 1 - boot
 * option enabled. 0 - not.
 */
 ...
 *
 * This function enables the conresponding SRAM array in low power retention
 * mode. By default, the SRAM low pwer is disabled, and only in RUN mode.
 *
 * @param base SMC peripheral base address.
                                               ...
                                               bool enable )
{
    ...
    {
        base->SRAMLPR &= ~( 1U << arrayIdx ); /* Clear to be placed in low power
                                                 retention mode. */
    }
}
 ...
 *
 * This function enables the conresponding SRAM array in STOP modes. By default,
 * the SRAM is retained in STOP modes. When disabled, the corresponding SRAM
 * array is powered off in STOP modes.
 *
 * @param base SMC peripheral base address.
 * @param arrayIdx Index of responding SRAM array.
                                                ...
                                                bool enable )
{
    if( enable )
    {
        base->SRAMDSR &= ~( 1U << arrayIdx ); /* Clear to be retained in STOP
                                                 modes. */
    }
    else
    {
        base->SRAMDSR |= ( 1U << arrayIdx ); /* Set to be powered off in STOP
                                                modes. */
    }
}
