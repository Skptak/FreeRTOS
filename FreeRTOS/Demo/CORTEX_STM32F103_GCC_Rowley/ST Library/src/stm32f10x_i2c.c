 ...
 * Input          : - I2Cx: where x can be 1 or 2 to select the I2C peripheral.
 *                  - I2C_InitStruct: pointer to a I2C_InitTypeDef structure
...
void I2C_Init( I2C_TypeDef * I2Cx, I2C_InitTypeDef * I2C_InitStruct )
{
    ...
    tmpreg |= ( u16 ) ( ( u32 ) I2C_InitStruct->I2C_Mode |
 ...
 * Description    : Returns the most recent received data by the I2Cx
 *peripheral. Input          : - I2Cx: where x can be 1 or 2 to select the I2C
 ...
 *passed as parameter. Input          : - I2Cx: where x can be 1 or 2 to select
 *the I2C peripheral.
 ...
 *                       - I2C_FLAG_SMBDEFAULT: SMBus default header (Slave
 *mode)
 ...
 * Description    : Checks whether the specified I2C interrupt has occurred or
 *not. Input          : - I2Cx: where x can be 1 or 2 to select the I2C
 *peripheral.
