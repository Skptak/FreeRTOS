 ...
 * Description    : Resets the RCC clock configuration to the default reset
 *state. Input          : None Output         : None Return         : None
 *******************************************************************************/
 ...
 *system clock. Input          : - NewState: new state of the HSI. This
 *parameter can be: ENABLE or DISABLE. Output         : None Return         :
 *None
 *******************************************************************************/
 ...
 *RCC_APB2Periph_ADC3, RCC_APB2Periph_ALL
 *                  - NewState: new state of the specified peripheral clock.
 *                    This parameter can be: ENABLE or DISABLE.
 * Output         : None
 * Return         : None
 ...
 *RCC_APB1Periph_BKP, RCC_APB1Periph_PWR, RCC_APB1Periph_DAC, RCC_APB1Periph_ALL
 *                  - NewState: new state of the specified peripheral clock.
 *                    This parameter can be: ENABLE or DISABLE.
 * Output         : None
 * Return         : None
