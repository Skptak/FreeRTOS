 ...
 * Input          : - SPIx: where x can be 1, 2 or 3 to select the SPI
...
void SPI_Init( SPI_TypeDef * SPIx, SPI_InitTypeDef * SPI_InitStruct )
{
    ...
    tmpreg |= ( u16 ) ( ( u32 ) SPI_InitStruct->SPI_Direction |
...
void I2S_Init( SPI_TypeDef * SPIx, I2S_InitTypeDef * I2S_InitStruct )
{
    ...
    else
    {
        ...
        if( I2S_InitStruct->I2S_MCLKOutput == I2S_MCLKOutput_Enable )
        {
            ...
            tmp = ( u16 ) ( ( ( 10 * RCC_Clocks.SYSCLK_Frequency ) /
                              ( 256 * I2S_InitStruct->I2S_AudioFreq ) ) +
                            5 );
        }
        else
        {
 ...
 * Description    : Enables or disables the specified SPI peripheral (in I2S
 *mode). Input          : - SPIx: where x can be 2 or 3 to select the SPI
 *peripheral.
 *                  - NewState: new state of the SPIx peripheral.
 *                    This parameter can be: ENABLE or DISABLE.
 * Output         : None
 ...
 * Description    : Returns the most recent received data by the SPIx/I2Sx
 *peripheral. Input          : - SPIx: where x can be :
 *                         - 1, 2 or 3 in SPI mode
 *                         - 2 or 3 in I2S mode
 * Output         : None
 ...
 * Description    : Configures internally by software the NSS pin for the
 *selected SPI. Input          : - SPIx: where x can be 1, 2 or 3 to select the
 *SPI peripheral.
 ...
 * Description    : Returns the CRC Polynomial register value for the specified
 *SPI. Input          : - SPIx: where x can be 1, 2 or 3 to select the SPI
 *peripheral. Output         : None Return         : The CRC Polynomial register
 *value.
 *******************************************************************************/
 ...
 *                          SPI_I2S_DR register, so that the last data is not
 *lost. Output         : None Return         : None
 *******************************************************************************/
void SPI_I2S_ClearFlag( SPI_TypeDef * SPIx, u16 SPI_I2S_FLAG )
{
    ...
    else if( ( SPI_I2S_FLAG == SPI_I2S_FLAG_OVR ) ||
             ( SPI_I2S_FLAG == I2S_FLAG_UDR ) )
    {
 ...
 * Description    : Checks whether the specified SPI/I2S interrupt has occurred
 *or not. Input          : - SPIx: where x can be :
 *                         - 1, 2 or 3 in SPI mode
 *                         - 2 or 3 in I2S mode
 *                  - SPI_I2S_IT: specifies the SPI/I2S interrupt source to
 ...
 *                         - 1, 2 or 3 in SPI mode
 *                         - 2 or 3 in I2S mode
 *                  - SPI_I2S_IT: specifies the SPI/I2S interrupt pending bit to
 *clear. This parameter can be one of the following values:
 *                       - SPI_I2S_IT_OVR: Overrun interrupt.
 *                       - SPI_IT_MODF: Mode Fault interrupt.
 *                       - SPI_IT_CRCERR: CRC Error interrupt.
 *                       - I2S_IT_UDR: Underrun Error interrupt.
