...
typedef struct
{
    ...
    #define CAN_Mode_Silent_LoopBack \
        ( ( u8 ) 0x03 ) /* loopback combined with silent mode */
    ...
    #define CAN_FilterFIFO0 \
        ( ( u8 ) 0x00 ) /* Filter FIFO 0 assignment for filter x */
    #define CAN_FilterFIFO1 \
        ( ( u8 ) 0x01 ) /* Filter FIFO 1 assignment for filter x */
    ...
    /* CAN interrupts */
    #define CAN_IT_RQCP0 \
        ( ( u32 ) 0x00000005 ) /* Request completed mailbox 0 */
    #define CAN_IT_RQCP1 \
        ( ( u32 ) 0x00000006 ) /* Request completed mailbox 1 */
    #define CAN_IT_RQCP2 \
        ( ( u32 ) 0x00000007 )                 /* Request completed mailbox 2 */
