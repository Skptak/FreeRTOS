...
/* Define to prevent recursive inclusion -------------------------------------*/
    ...
    #define IS_PWR_PVD_LEVEL( LEVEL )          \
        ( ( ( LEVEL ) == PWR_PVDLevel_2V2 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V3 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V4 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V5 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V6 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V7 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V8 ) || \
          ( ( LEVEL ) == PWR_PVDLevel_2V9 ) )
