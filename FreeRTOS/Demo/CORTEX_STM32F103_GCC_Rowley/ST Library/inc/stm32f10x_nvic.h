...
typedef struct
{
    ...
    #define DMA1_Channel1_IRQChannel \
        ( ( u8 ) 0x0B ) /* DMA1 Channel 1 global Interrupt */
    #define DMA1_Channel2_IRQChannel \
        ( ( u8 ) 0x0C ) /* DMA1 Channel 2 global Interrupt */
    #define DMA1_Channel3_IRQChannel \
        ( ( u8 ) 0x0D ) /* DMA1 Channel 3 global Interrupt */
    #define DMA1_Channel4_IRQChannel \
        ( ( u8 ) 0x0E ) /* DMA1 Channel 4 global Interrupt */
    #define DMA1_Channel5_IRQChannel \
        ( ( u8 ) 0x0F ) /* DMA1 Channel 5 global Interrupt */
    #define DMA1_Channel6_IRQChannel \
        ( ( u8 ) 0x10 ) /* DMA1 Channel 6 global Interrupt */
    #define DMA1_Channel7_IRQChannel \
        ( ( u8 ) 0x11 ) /* DMA1 Channel 7 global Interrupt */
    #define ADC1_2_IRQChannel \
        ( ( u8 ) 0x12 ) /* ADC1 et ADC2 global Interrupt */
    #define USB_HP_CAN_TX_IRQChannel \
        ( ( u8 ) 0x13 ) /* USB High Priority or CAN TX Interrupts */
    #define USB_LP_CAN_RX0_IRQChannel \
        ( ( u8 ) 0x14 ) /* USB Low Priority or CAN RX0 Interrupts */
    #define CAN_RX1_IRQChannel ( ( u8 ) 0x15 ) /* CAN RX1 Interrupt */
    #define CAN_SCE_IRQChannel ( ( u8 ) 0x16 ) /* CAN SCE Interrupt */
    #define EXTI9_5_IRQChannel \
        ( ( u8 ) 0x17 ) /* External Line[9:5] Interrupts */
    #define TIM1_BRK_IRQChannel ( ( u8 ) 0x18 ) /* TIM1 Break Interrupt */
    #define TIM1_UP_IRQChannel  ( ( u8 ) 0x19 ) /* TIM1 Update Interrupt */
    #define TIM1_TRG_COM_IRQChannel \
        ( ( u8 ) 0x1A ) /* TIM1 Trigger and Commutation Interrupt */
    #define TIM1_CC_IRQChannel \
        ( ( u8 ) 0x1B ) /* TIM1 Capture Compare Interrupt */
    ...
    #define EXTI15_10_IRQChannel \
        ( ( u8 ) 0x28 ) /* External Line[15:10] Interrupts */
    #define RTCAlarm_IRQChannel \
        ( ( u8 ) 0x29 ) /* RTC Alarm through EXTI Line Interrupt */
    #define USBWakeUp_IRQChannel                                               \
        ( ( u8 ) 0x2A ) /* USB WakeUp from suspend through EXTI Line Interrupt \
                         */
    #define TIM8_BRK_IRQChannel ( ( u8 ) 0x2B ) /* TIM8 Break Interrupt */
    #define TIM8_UP_IRQChannel  ( ( u8 ) 0x2C ) /* TIM8 Update Interrupt */
    #define TIM8_TRG_COM_IRQChannel \
        ( ( u8 ) 0x2D ) /* TIM8 Trigger and Commutation Interrupt */
    #define TIM8_CC_IRQChannel \
        ( ( u8 ) 0x2E ) /* TIM8 Capture Compare Interrupt */
    ...
    #define DMA2_Channel1_IRQChannel \
        ( ( u8 ) 0x38 ) /* DMA2 Channel 1 global Interrupt */
    #define DMA2_Channel2_IRQChannel \
        ( ( u8 ) 0x39 ) /* DMA2 Channel 2 global Interrupt */
    #define DMA2_Channel3_IRQChannel \
        ( ( u8 ) 0x3A ) /* DMA2 Channel 3 global Interrupt */
    #define DMA2_Channel4_5_IRQChannel                                        \
        ( ( u8 ) 0x3B ) /* DMA2 Channel 4 and DMA2 Channel 5 global Interrupt \
                         */
    ...
    #define SystemHandler_HardFault \
        ( ( u32 ) 0x000000 ) /* Hard Fault Handler */
    #define SystemHandler_MemoryManage \
        ( ( u32 ) 0x043430 ) /* Memory Manage Handler */
    #define SystemHandler_BusFault                \
        ( ( u32 ) 0x547931 ) /* Bus Fault Handler \
                              */
    #define SystemHandler_UsageFault \
        ( ( u32 ) 0x24C232 )                          /* Usage Fault Handler */
    #define SystemHandler_SVCall ( ( u32 ) 0x01FF40 ) /* SVCall Handler */
    #define SystemHandler_DebugMonitor \
        ( ( u32 ) 0x0A0080 ) /* Debug Monitor Handler */
