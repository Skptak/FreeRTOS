...
typedef struct
{
     ...
     * -------------------------------------------------*/
    #define SDIO_Wait_No \
        ( ( u32 ) 0x00000000 ) /* SDIO No Wait, TimeOut is enabled */
    #define SDIO_Wait_IT \
        ( ( u32 ) 0x00000100 ) /* SDIO Wait Interrupt Request */
    #define SDIO_Wait_Pend \
        ( ( u32 ) 0x00000200 ) /* SDIO Wait End of transfer */
