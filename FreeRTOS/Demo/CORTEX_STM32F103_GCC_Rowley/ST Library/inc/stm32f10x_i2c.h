...
typedef struct
{
    ...
    #define I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED \
        ( ( u32 ) 0x00070082 ) /* BUSY, MSL, ADDR, TXE and TRA flags */
    #define I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED \
        ( ( u32 ) 0x00030002 ) /* BUSY, MSL and ADDR flags */

    /* EV7 */
    #define I2C_EVENT_MASTER_BYTE_RECEIVED \
        ( ( u32 ) 0x00030040 ) /* BUSY, MSL and RXNE flags */

    /* EV8 */
    #define I2C_EVENT_MASTER_BYTE_TRANSMITTED \
        ( ( u32 ) 0x00070084 ) /* TRA, BUSY, MSL, TXE and BTF flags */

    /* EV9 */
    #define I2C_EVENT_MASTER_MODE_ADDRESS10 \
        ( ( u32 ) 0x00030008 ) /* BUSY, MSL and ADD10 flags */
