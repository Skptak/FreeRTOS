...
/* Define to prevent recursive inclusion -------------------------------------*/
    ...
    #define IS_BKP_DR( DR )                                   \
        ( ( ( DR ) == BKP_DR1 ) || ( ( DR ) == BKP_DR2 ) ||   \
          ( ( DR ) == BKP_DR3 ) || ( ( DR ) == BKP_DR4 ) ||   \
          ( ( DR ) == BKP_DR5 ) || ( ( DR ) == BKP_DR6 ) ||   \
          ( ( DR ) == BKP_DR7 ) || ( ( DR ) == BKP_DR8 ) ||   \
          ( ( DR ) == BKP_DR9 ) || ( ( DR ) == BKP_DR10 ) ||  \
          ( ( DR ) == BKP_DR11 ) || ( ( DR ) == BKP_DR12 ) || \
          ( ( DR ) == BKP_DR13 ) || ( ( DR ) == BKP_DR14 ) || \
          ( ( DR ) == BKP_DR15 ) || ( ( DR ) == BKP_DR16 ) || \
          ( ( DR ) == BKP_DR17 ) || ( ( DR ) == BKP_DR18 ) || \
          ( ( DR ) == BKP_DR19 ) || ( ( DR ) == BKP_DR20 ) || \
          ( ( DR ) == BKP_DR21 ) || ( ( DR ) == BKP_DR22 ) || \
          ( ( DR ) == BKP_DR23 ) || ( ( DR ) == BKP_DR24 ) || \
          ( ( DR ) == BKP_DR25 ) || ( ( DR ) == BKP_DR26 ) || \
          ( ( DR ) == BKP_DR27 ) || ( ( DR ) == BKP_DR28 ) || \
          ( ( DR ) == BKP_DR29 ) || ( ( DR ) == BKP_DR30 ) || \
          ( ( DR ) == BKP_DR31 ) || ( ( DR ) == BKP_DR32 ) || \
          ( ( DR ) == BKP_DR33 ) || ( ( DR ) == BKP_DR34 ) || \
          ( ( DR ) == BKP_DR35 ) || ( ( DR ) == BKP_DR36 ) || \
          ( ( DR ) == BKP_DR37 ) || ( ( DR ) == BKP_DR38 ) || \
          ( ( DR ) == BKP_DR39 ) || ( ( DR ) == BKP_DR40 ) || \
