...
void mcf5225x_init( void )
{
    ...
    MCF_EPORT_EPPAR = 0 | MCF_EPORT_EPPAR_EPPA1_FALLING |
    ...
    MCF_EPORT_EPIER = 0 | MCF_EPORT_EPIER_EPIE1 | MCF_EPORT_EPIER_EPIE2 |
                      MCF_EPORT_EPIER_EPIE5 | MCF_EPORT_EPIER_EPIE6 |
                      MCF_EPORT_EPIER_EPIE7;

    /* Enable interrupts in the interrupt controller */
    MCF_INTC0_IMRL &= ~( 0 | MCF_INTC_IMRL_INT_MASK1 | MCF_INTC_IMRL_INT_MASK2 |
                         MCF_INTC_IMRL_INT_MASK5 | MCF_INTC_IMRL_INT_MASK6 |
                         MCF_INTC_IMRL_INT_MASK7 | MCF_INTC_IMRL_MASKALL );
...
void mcf5225x_pll_init( void )
{
    /*Required if booting with internal relaxation oscillator & pll off,
     * clkmod[1:0]=00 & xtal=1 */
     ...
     * Multiply 48Mhz reference crystal /CCHR by 10 to acheive system clock of
     * 80Mhz
     */
...
void mcf5225x_scm_init( void )
{
     ...
     */
    MCF_SCM_RAMBAR = ( 0 | MCF_SCM_RAMBAR_BA( SRAM_ADDRESS ) |
                       MCF_SCM_RAMBAR_BDE );
}
/********************************************************************/
void mcf5225x_gpio_init( void )
...
void mcf5225x_uart_init( void )
{
     ...
     */
    MCF_GPIO_PUAPAR = 0 | MCF_GPIO_PUAPAR_URXD0_URXD0 |
                      MCF_GPIO_PUAPAR_UTXD0_UTXD0;

    MCF_GPIO_PUBPAR = 0 | MCF_GPIO_PUBPAR_URXD1_URXD1 |
                      MCF_GPIO_PUBPAR_UTXD1_UTXD1;

    MCF_GPIO_PUCPAR = 0 | MCF_GPIO_PUCPAR_URXD2_URXD2 |
     ...
     */
    MCF_UART0_UMR1 = ( 0 | MCF_UART_UMR_PM_NONE | MCF_UART_UMR_BC_8 );
    MCF_UART1_UMR1 = ( 0 | MCF_UART_UMR_PM_NONE | MCF_UART_UMR_BC_8 );
    MCF_UART2_UMR1 = ( 0 | MCF_UART_UMR_PM_NONE | MCF_UART_UMR_BC_8 );

    /*
     * No echo or loopback, 1 stop bit
     */
    MCF_UART0_UMR2 = ( 0 | MCF_UART_UMR_CM_NORMAL |
                       MCF_UART_UMR_SB_STOP_BITS_1 );
    MCF_UART1_UMR2 = ( 0 | MCF_UART_UMR_CM_NORMAL |
                       MCF_UART_UMR_SB_STOP_BITS_1 );
    MCF_UART2_UMR2 = ( 0 | MCF_UART_UMR_CM_NORMAL |
                       MCF_UART_UMR_SB_STOP_BITS_1 );

    /*
     * Set Rx and Tx baud by SYSTEM CLOCK
     */
    MCF_UART0_UCSR = ( 0 | MCF_UART_UCSR_RCS_SYS_CLK |
                       MCF_UART_UCSR_TCS_SYS_CLK );
    MCF_UART1_UCSR = ( 0 | MCF_UART_UCSR_RCS_SYS_CLK |
                       MCF_UART_UCSR_TCS_SYS_CLK );
    MCF_UART2_UCSR = ( 0 | MCF_UART_UCSR_RCS_SYS_CLK |
                       MCF_UART_UCSR_TCS_SYS_CLK );
    ...
    MCF_UART2_UCR = ( 0 | MCF_UART_UCR_TX_ENABLED | MCF_UART_UCR_RX_ENABLED );
}
/********************************************************************/
