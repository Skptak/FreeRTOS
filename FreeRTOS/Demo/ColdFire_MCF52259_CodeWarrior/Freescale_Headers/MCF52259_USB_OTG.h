...
#define MCF_USB_OTG_ENDPT( x ) \
    ( *( vuint8 * ) ( &__IPSBAR[ 0x1C00C0 + ( ( x ) *0x4 ) ] ) )

/* Other macros */
#define MCF_USB_OTG_FRM_NUM                                \
    ( MCF_USB_OTG_INT_STAT = MCF_USB_OTG_INT_STAT_SOF_TOK, \
      MCF_USB_OTG_FRM_NUML | ( ( ( vuint16 ) MCF_USB_OTG_FRM_NUMH ) << 8 ) )
