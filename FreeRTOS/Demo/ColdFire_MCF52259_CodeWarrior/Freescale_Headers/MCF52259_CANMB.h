...
#define MCF_CANMB_CODE( x ) \
    ( *( vuint8 * ) ( &__IPSBAR[ 0x170080 + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_CTRL( x ) \
    ( *( vuint8 * ) ( &__IPSBAR[ 0x170081 + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_TIME( x ) \
    ( *( vuint16 * ) ( &__IPSBAR[ 0x170082 + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_ID( x ) \
    ( *( vuint32 * ) ( &__IPSBAR[ 0x170084 + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_DATA_WORD_1( x ) \
    ( *( vuint16 * ) ( &__IPSBAR[ 0x170088 + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_DATA_WORD_2( x ) \
    ( *( vuint16 * ) ( &__IPSBAR[ 0x17008A + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_DATA_WORD_3( x ) \
    ( *( vuint16 * ) ( &__IPSBAR[ 0x17008C + ( ( x ) *0x10 ) ] ) )
#define MCF_CANMB_DATA_WORD_4( x ) \
    ( *( vuint16 * ) ( &__IPSBAR[ 0x17008E + ( ( x ) *0x10 ) ] ) )

/* Other macros */
#define MCF_CANMB_BYTE( x, y ) \
    ( *( vuint8 * ) ( &__IPSBAR[ ( ( 0x170088 + ( ( x ) *0x10 ) + y ) ) ] ) )
