...
#define MCF_INTC0_ICR( x ) \
    ( *( vuint8 * ) ( 0x40000C41 + ( ( x - 1 ) * 0x1 ) ) )
#define MCF_INTC0_LIACK( x ) \
    ( *( vuint8 * ) ( 0x40000CE4 + ( ( x - 1 ) * 0x4 ) ) )
...
#define MCF_INTC1_ICR( x ) \
    ( *( vuint8 * ) ( 0x40000D41 + ( ( x - 1 ) * 0x1 ) ) )
#define MCF_INTC1_LIACK( x ) \
    ( *( vuint8 * ) ( 0x40000DE4 + ( ( x - 1 ) * 0x4 ) ) )
...
#define MCF_INTC_INTFRCH( x ) \
    ( *( vuint32 * ) ( 0x40000C10 + ( ( x ) *0x100 ) ) )
#define MCF_INTC_INTFRCL( x ) \
    ( *( vuint32 * ) ( 0x40000C14 + ( ( x ) *0x100 ) ) )
#define MCF_INTC_IRLR( x ) ( *( vuint8 * ) ( 0x40000C18 + ( ( x ) *0x100 ) ) )
#define MCF_INTC_IACKLPR( x ) \
    ( *( vuint8 * ) ( 0x40000C19 + ( ( x ) *0x100 ) ) )
