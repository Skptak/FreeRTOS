...
#define FORBYP                                                              \
    PORTIO_8( IO_BASE + 0x3d )           /* clock force and bypass register \
                                          */
#define CTCTL PORTIO_8( IO_BASE + 0x3e ) /* clock test control register */
#define ARMCOP                                                         \
    PORTIO_8( IO_BASE + 0x3f ) /* COP arm/reset register with sequence \
                                  0x55,0xaa. */
...
#define CAN0TIER                                                \
    PORTIO_8( IO_BASE + 0x147 ) /* CAN0 transmitter control reg \
                                 */
#define CAN0TARQ \
    PORTIO_8( IO_BASE + 0x148 ) /* CAN0 transmitter abort request */
#define CAN0TAAK \
    PORTIO_8( IO_BASE + 0x149 ) /* CAN0 transmitter abort acknowledge */
#define CAN0TBSEL \
    PORTIO_8( IO_BASE + 0x14a ) /* CAN0 transmit buffer selection */
...
#define CAN0TXERR                                                            \
    PORTIO_8( IO_BASE + 0x14f )               /* CAN0 transmit error counter \
                                               */
...
#define CAN1TIER                                                \
    PORTIO_8( IO_BASE + 0x187 ) /* CAN1 transmitter control reg \
                                 */
#define CAN1TARQ \
    PORTIO_8( IO_BASE + 0x188 ) /* CAN1 transmitter abort request */
#define CAN1TAAK \
    PORTIO_8( IO_BASE + 0x189 ) /* CAN1 transmitter abort acknowledge */
#define CAN1TBSEL \
    PORTIO_8( IO_BASE + 0x18a ) /* CAN1 transmit buffer selection */
#define CAN1IDAC PORTIO_8( IO_BASE + 0x18b ) /* CAN1 identifier acceptance */
#define CAN1RXERR                                               \
    PORTIO_8( IO_BASE + 0x18e ) /* CAN1 transmitter control reg \
                                 */
#define CAN1TXERR                                                            \
    PORTIO_8( IO_BASE + 0x18f )               /* CAN1 transmit error counter \
                                               */
...
#define CAN2TIER                                                \
    PORTIO_8( IO_BASE + 0x1c7 ) /* CAN2 transmitter control reg \
                                 */
#define CAN2TARQ \
    PORTIO_8( IO_BASE + 0x1c8 ) /* CAN2 transmitter abort request */
#define CAN2TAAK \
    PORTIO_8( IO_BASE + 0x1c9 ) /* CAN2 transmitter abort acknowledge */
#define CAN2TBSEL \
    PORTIO_8( IO_BASE + 0x1ca ) /* CAN2 transmit buffer selection */
#define CAN2IDAC PORTIO_8( IO_BASE + 0x1cb ) /* CAN2 identifier acceptance */
#define CAN2RXERR                                               \
    PORTIO_8( IO_BASE + 0x1ce ) /* CAN2 transmitter control reg \
                                 */
#define CAN2TXERR                                                            \
    PORTIO_8( IO_BASE + 0x1cf )               /* CAN2 transmit error counter \
                                               */
...
#define CAN3TIER                                                \
    PORTIO_8( IO_BASE + 0x207 ) /* CAN3 transmitter control reg \
                                 */
#define CAN3TARQ \
    PORTIO_8( IO_BASE + 0x208 ) /* CAN3 transmitter abort request */
#define CAN3TAAK \
    PORTIO_8( IO_BASE + 0x209 ) /* CAN3 transmitter abort acknowledge */
#define CAN3TBSEL \
    PORTIO_8( IO_BASE + 0x20a ) /* CAN3 transmit buffer selection */
#define CAN3IDAC PORTIO_8( IO_BASE + 0x20b ) /* CAN3 identifier acceptance */
#define CAN3RXERR                                               \
    PORTIO_8( IO_BASE + 0x20e ) /* CAN3 transmitter control reg \
                                 */
#define CAN3TXERR                                                            \
    PORTIO_8( IO_BASE + 0x20f )               /* CAN3 transmit error counter \
                                               */
...
#define CAN4TIER                                                \
    PORTIO_8( IO_BASE + 0x287 ) /* CAN4 transmitter control reg \
                                 */
#define CAN4TARQ \
    PORTIO_8( IO_BASE + 0x288 ) /* CAN4 transmitter abort request */
#define CAN4TAAK \
    PORTIO_8( IO_BASE + 0x289 ) /* CAN4 transmitter abort acknowledge */
#define CAN4TBSEL \
    PORTIO_8( IO_BASE + 0x28a ) /* CAN4 transmit buffer selection */
#define CAN4IDAC PORTIO_8( IO_BASE + 0x28b ) /* CAN4 identifier acceptance */
#define CAN4RXERR                                               \
    PORTIO_8( IO_BASE + 0x28e ) /* CAN4 transmitter control reg \
                                 */
#define CAN4TXERR                                                            \
    PORTIO_8( IO_BASE + 0x28f )               /* CAN4 transmit error counter \
                                               */
