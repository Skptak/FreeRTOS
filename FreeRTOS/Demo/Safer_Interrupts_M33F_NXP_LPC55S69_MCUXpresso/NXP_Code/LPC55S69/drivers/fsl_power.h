...
typedef enum pd_bits
{
    ...
    /*
       This enum member has no practical meaning,it is used to avoid MISRA
       issue, user should not trying to use it.
       */
...
typedef enum _power_device_reset_cause
{
    ...
    kRESET_CAUSE_BODRESET = 2UL, /*!< Brown-out Detector reset (either BODVBAT
                                    or BODCORE) */
    ...
    kRESET_CAUSE_DPDRESET_WAKEUPIO_RTC = 10UL, /*!< Any of the 4 wake-up pins
                                                  and RTC (it is not possible to
                                                  distinguish which of these 2
                                                  events occured first) */
    kRESET_CAUSE_DPDRESET_WAKEUPIO_OSTIMER = 11UL, /*!< Any of the 4 wake-up
                                                      pins and OSTIMER (it is
                                                      not possible to
                                                      distinguish which of these
                                                      2 events occured first) */
    kRESET_CAUSE_DPDRESET_RTC_OSTIMER = 12UL, /*!< Real Time Counter or OS Event
                                                 Timer (it is not possible to
                                                 distinguish which of these 2
                                                 events occured first) */
    kRESET_CAUSE_DPDRESET_WAKEUPIO_RTC_OSTIMER = 13UL, /*!< Any of the 4 wake-up
                                                          pins (it is not
                                                          possible to
                                                          distinguish which of
                                                          these 3 events occured
                                                          first) */
    /* Miscallenous */
    kRESET_CAUSE_NOT_RELEVANT = 14UL, /*!< No reset cause (for example, this
                                         code is used when waking up from
                                         DEEP-SLEEP low power mode) */
    kRESET_CAUSE_NOT_DETERMINISTIC = 15UL, /*!< Unknown Reset Cause. Should be
                                              treated like "Hardware Pin Reset"
...
typedef enum _power_device_boot_mode
{
    ...
    kBOOT_MODE_LP_POWER_DOWN = 2UL, /*!< Wake up from POWER-DOWN Low Power mode
                                     */
    kBOOT_MODE_LP_DEEP_POWER_DOWN = 4UL, /*!< Wake up from DEEP-POWER-DOWN Low
                                            Power mode */
...
#define LOWPOWER_SRAMRETCTRL_RETEN_RAMX0                                  \
    ( 1UL << 0 ) /*!< Enable SRAMX_0 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAMX1                                  \
    ( 1UL << 1 ) /*!< Enable SRAMX_1 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAMX2                                  \
    ( 1UL << 2 ) /*!< Enable SRAMX_2 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAMX3                                  \
    ( 1UL << 3 ) /*!< Enable SRAMX_3 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM00                                  \
    ( 1UL << 4 ) /*!< Enable SRAM0_0 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM01                                  \
    ( 1UL << 5 ) /*!< Enable SRAM0_1 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM10                                  \
    ( 1UL << 6 ) /*!< Enable SRAM1_0 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM20                                  \
    ( 1UL << 7 ) /*!< Enable SRAM2_0 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM30                                  \
    ( 1UL << 8 ) /*!< Enable SRAM3_0 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM31                                  \
    ( 1UL << 9 ) /*!< Enable SRAM3_1 retention when entering in Low power \
                    modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM40                                   \
    ( 1UL << 10 ) /*!< Enable SRAM4_0 retention when entering in Low power \
                     modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM41                                   \
    ( 1UL << 11 ) /*!< Enable SRAM4_1 retention when entering in Low power \
                     modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM42                                   \
    ( 1UL << 12 ) /*!< Enable SRAM4_2 retention when entering in Low power \
                     modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM43                                   \
    ( 1UL << 13 ) /*!< Enable SRAM4_3 retention when entering in Low power \
                     modes       */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM_USB_HS                                  \
    ( 1UL << 14 ) /*!< Enable SRAM USB HS retention when entering in Low power \
                     modes   */
#define LOWPOWER_SRAMRETCTRL_RETEN_RAM_PUF                                   \
    ( 1UL << 15 ) /*!< Enable SRAM PUFF retention when entering in Low power \
                     modes     */
...
#define WAKEUP_SYS                                                                 \
    ( 1ULL                                                                         \
      << 0 ) /*!< [SLEEP, DEEP SLEEP                             ] */ /* WWDT0_IRQ \
                                                                         and       \
                                                                         BOD_IRQ*/
#define WAKEUP_SDMA0 \
    ( 1ULL << 1 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_GLOBALINT0 \
    ( 1ULL << 2 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN                 ] */
#define WAKEUP_GPIO_GLOBALINT1 \
    ( 1ULL << 3 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN                 ] */
#define WAKEUP_GPIO_INT0_0 \
    ( 1ULL << 4 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_1 \
    ( 1ULL << 5 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_2 \
    ( 1ULL << 6 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_3 \
    ( 1ULL << 7 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_UTICK \
    ( 1ULL << 8 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_MRT \
    ( 1ULL << 9 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_CTIMER0 \
    ( 1ULL << 10 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_CTIMER1 \
    ( 1ULL << 11 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_SCT \
    ( 1ULL << 12 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_CTIMER3 \
    ( 1ULL << 13 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM0 \
    ( 1ULL << 14 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM1 \
    ( 1ULL << 15 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM2 \
    ( 1ULL << 16 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM3 \
    ( 1ULL << 17 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN                 ] */
#define WAKEUP_FLEXCOMM4 \
    ( 1ULL << 18 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM5 \
    ( 1ULL << 19 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM6 \
    ( 1ULL << 20 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_FLEXCOMM7 \
    ( 1ULL << 21 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_ADC \
    ( 1ULL << 22 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_ACMP_CAPT \
    ( 1ULL << 24 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN                 ] */
// reserved                                         (1ULL << 25)
// reserved                                         (1ULL << 26)
#define WAKEUP_USB0_NEEDCLK \
    ( 1ULL << 27 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_USB0 \
    ( 1ULL << 28 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_RTC_LITE_ALARM_WAKEUP \
    ( 1ULL << 29 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN, DEEP POWER DOWN] */
#define WAKEUP_EZH_ARCH_B \
    ( 1ULL << 30 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_WAKEUP_MAILBOX \
    ( 1ULL << 31 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN                 ] */
#define WAKEUP_GPIO_INT0_4 \
    ( 1ULL << 32 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_5 \
    ( 1ULL << 33 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_6 \
    ( 1ULL << 34 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_GPIO_INT0_7 \
    ( 1ULL << 35 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_CTIMER2 \
    ( 1ULL << 36 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_CTIMER4 \
    ( 1ULL << 37 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_OS_EVENT_TIMER \
    ( 1ULL << 38 ) /*!< [SLEEP, DEEP SLEEP, POWER DOWN, DEEP POWER DOWN] */
// reserved                                         (1ULL << 39)
// reserved                                         (1ULL << 40)
// reserved                                         (1ULL << 41)
#define WAKEUP_SDIO \
...
// reserved                                         (1ULL << 46)
#define WAKEUP_USB1 \
    ( 1ULL << 47 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_USB1_NEEDCLK \
    ( 1ULL << 48 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_SEC_HYPERVISOR_CALL \
    ( 1ULL << 49 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_SEC_GPIO_INT0_0 \
    ( 1ULL << 50 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_SEC_GPIO_INT0_1 \
    ( 1ULL << 51 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_PLU \
    ( 1ULL << 52 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_SEC_VIO ( 1ULL << 53 )
#define WAKEUP_SHA \
    ( 1ULL << 54 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_CASPER \
    ( 1ULL << 55 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_PUFF \
    ( 1ULL << 56 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_PQ \
    ( 1ULL << 57 ) /*!< [SLEEP,                                        ] */
#define WAKEUP_SDMA1 \
    ( 1ULL << 58 ) /*!< [SLEEP, DEEP SLEEP                             ] */
#define WAKEUP_LSPI_HS \
    ( 1ULL << 59 ) /*!< [SLEEP, DEEP SLEEP                             ] */
// reserved WAKEUP_PVTVF0_AMBER                     (1ULL << 60)
// reserved WAKEUP_PVTVF0_RED                       (1ULL << 61)
// reserved WAKEUP_PVTVF1_AMBER                     (1ULL << 62)
#define WAKEUP_ALLWAKEUPIOS \
    ( 1ULL << 63 ) /*!< [                             , DEEP POWER DOWN] */

/**
 * @brief Sleep Postpone
 */
#define LOWPOWER_HWWAKE_FORCED                                               \
    ( 1UL << 0 ) /*!< Force peripheral clocking to stay on during deep-sleep \
                    mode. */
#define LOWPOWER_HWWAKE_PERIPHERALS                                            \
    ( 1UL << 1 ) /*!< Wake for Flexcomms. Any Flexcomm FIFO reaching the level \
                    specified by its own TXLVL will cause peripheral clocking  \
                    to wake up temporarily while the related status is         \
                    asserted */
#define LOWPOWER_HWWAKE_SDMA0                                               \
    ( 1UL << 3 ) /*!< Wake for DMA0. DMA0 being busy will cause peripheral  \
                    clocking to remain running until DMA completes. Used in \
                    conjonction with LOWPOWER_HWWAKE_PERIPHERALS */
#define LOWPOWER_HWWAKE_SDMA1                                               \
    ( 1UL << 5 ) /*!< Wake for DMA1. DMA0 being busy will cause peripheral  \
                    clocking to remain running until DMA completes. Used in \
                    conjonction with LOWPOWER_HWWAKE_PERIPHERALS */
#define LOWPOWER_HWWAKE_ENABLE_FRO192M                                         \
    ( 1UL << 31 ) /*!< Need to be set if FRO192M is disable - via PDCTRL0 - in \
                     Deep Sleep mode and any of LOWPOWER_HWWAKE_PERIPHERALS,   \
                     LOWPOWER_HWWAKE_SDMA0 or LOWPOWER_HWWAKE_SDMA1 is set */

#define LOWPOWER_CPURETCTRL_ENA_DISABLE \
    0 /*!< In POWER DOWN mode, CPU Retention is disabled */
#define LOWPOWER_CPURETCTRL_ENA_ENABLE \
    1 /*!< In POWER DOWN mode, CPU Retention is enabled  */
/**
...
#define LOWPOWER_WAKEUPIOSRC_DISABLE \
    0 /*!< Wake up is disable                      */
#define LOWPOWER_WAKEUPIOSRC_RISING \
    1 /*!< Wake up on rising edge                  */
#define LOWPOWER_WAKEUPIOSRC_FALLING \
    2 /*!< Wake up on falling edge                 */
#define LOWPOWER_WAKEUPIOSRC_RISING_FALLING \
    3 /*!< Wake up on both rising or falling edges */

#define LOWPOWER_WAKEUPIO_PIO0_PULLUPDOWN_INDEX \
    8 /*!< Wake-up I/O 0 pull-up/down configuration index */
#define LOWPOWER_WAKEUPIO_PIO1_PULLUPDOWN_INDEX \
    9 /*!< Wake-up I/O 1 pull-up/down configuration index */
#define LOWPOWER_WAKEUPIO_PIO2_PULLUPDOWN_INDEX \
    10 /*!< Wake-up I/O 2 pull-up/down configuration index */
#define LOWPOWER_WAKEUPIO_PIO3_PULLUPDOWN_INDEX \
    11 /*!< Wake-up I/O 3 pull-up/down configuration index */

#define LOWPOWER_WAKEUPIO_PIO0_PULLUPDOWN_MASK                            \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO0_PULLUPDOWN_INDEX ) /*!< Wake-up I/O 0 \
                                                          pull-up/down mask */
#define LOWPOWER_WAKEUPIO_PIO1_PULLUPDOWN_MASK                            \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO1_PULLUPDOWN_INDEX ) /*!< Wake-up I/O 1 \
                                                          pull-up/down mask */
#define LOWPOWER_WAKEUPIO_PIO2_PULLUPDOWN_MASK                            \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO2_PULLUPDOWN_INDEX ) /*!< Wake-up I/O 2 \
                                                          pull-up/down mask */
#define LOWPOWER_WAKEUPIO_PIO3_PULLUPDOWN_MASK                            \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO3_PULLUPDOWN_INDEX ) /*!< Wake-up I/O 3 \
                                                          pull-up/down mask */
...
#define LOWPOWER_WAKEUPIO_PIO0_DISABLEPULLUPDOWN_MASK                           \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO0_DISABLEPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 0              \
                                                                 pull-up/down   \
                                                                 disable/enable \
                                                                 mask */
#define LOWPOWER_WAKEUPIO_PIO1_DISABLEPULLUPDOWN_MASK                           \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO1_DISABLEPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 1              \
                                                                 pull-up/down   \
                                                                 disable/enable \
                                                                 mask */
#define LOWPOWER_WAKEUPIO_PIO2_DISABLEPULLUPDOWN_MASK                           \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO2_DISABLEPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 2              \
                                                                 pull-up/down   \
                                                                 disable/enable \
                                                                 mask */
#define LOWPOWER_WAKEUPIO_PIO3_DISABLEPULLUPDOWN_MASK                           \
    ( 1UL << LOWPOWER_WAKEUPIO_PIO3_DISABLEPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 3              \
                                                                 pull-up/down   \
                                                                 disable/enable \
                                                                 mask */
...
#define LOWPOWER_WAKEUPIO_PIO0_USEEXTERNALPULLUPDOWN_INDEX                     \
    ( 16 ) /*!< Wake-up I/O 0 use external pull-up/down disable/enable control \
              index*/
#define LOWPOWER_WAKEUPIO_PIO1_USEEXTERNALPULLUPDOWN_INDEX                     \
    ( 17 ) /*!< Wake-up I/O 1 use external pull-up/down disable/enable control \
              index */
#define LOWPOWER_WAKEUPIO_PIO2_USEEXTERNALPULLUPDOWN_INDEX                     \
    ( 18 ) /*!< Wake-up I/O 2 use external pull-up/down disable/enable control \
              index */
#define LOWPOWER_WAKEUPIO_PIO3_USEEXTERNALPULLUPDOWN_INDEX                     \
    ( 19 ) /*!< Wake-up I/O 3 use external pull-up/down disable/enable control \
              index */
#define LOWPOWER_WAKEUPIO_PIO0_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO0_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 0 use          \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 disable/enable \
...
#define LOWPOWER_WAKEUPIO_PIO1_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO1_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 1 use          \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 disable/enable \
...
#define LOWPOWER_WAKEUPIO_PIO2_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO2_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 2 use          \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 disable/enable \
...
#define LOWPOWER_WAKEUPIO_PIO3_USEEXTERNALPULLUPDOWN_MASK                       \
    ( 1UL                                                                       \
      << LOWPOWER_WAKEUPIO_PIO3_USEEXTERNALPULLUPDOWN_INDEX ) /*!< Wake-up I/O  \
                                                                 3 use          \
                                                                 external       \
                                                                 pull-up/down   \
                                                                 disable/enable \
...
/*!
 * @brief API to enable PDRUNCFG bit in the Syscon. Note that enabling the bit
 * powers down the peripheral
 *
...
/*!
 * @brief API to disable PDRUNCFG bit in the Syscon. Note that disabling the bit
...
static inline void POWER_SetBodVbatLevel( power_bod_vbat_level_t level,
                                          ...
                                          bool enBodVbatReset )
{
    PMC->BODVBAT = ( PMC->BODVBAT & ( ~( PMC_BODVBAT_TRIGLVL_MASK |
                                         PMC_BODVBAT_HYST_MASK ) ) ) |
                   PMC_BODVBAT_TRIGLVL( level ) | PMC_BODVBAT_HYST( hyst );
    PMC->RESETCTRL = ( PMC->RESETCTRL &
...
static inline void POWER_SetBodCoreLevel( power_bod_core_level_t level,
                                          ...
                                          bool enBodCoreReset )
{
    PMC->BODCORE = ( PMC->BODCORE & ( ~( PMC_BODCORE_TRIGLVL_MASK |
                                         PMC_BODCORE_HYST_MASK ) ) ) |
                   PMC_BODCORE_TRIGLVL( level ) | PMC_BODCORE_HYST( hyst );
    PMC->RESETCTRL = ( PMC->RESETCTRL &
                       ( ~PMC_RESETCTRL_BODCORERESETENABLE_MASK ) ) |
                     PMC_RESETCTRL_BODCORERESETENABLE( enBodCoreReset );
}
#endif
 ...
 * after wake-up event This MUST BE EXECUTED outside the Flash: either from ROM
 * or from SRAM. The rest could stay in Flash. But, for consistency, it is
 ...
 *
 *          !!! IMPORTANT NOTES :
 0 - CPU0 & System CLock frequency is switched to FRO12MHz and is NOT restored
 back by the API.
 *           1 - CPU0 Interrupt Enable registers (NVIC->ISER) are modified by
 this function. They are restored back in case of CPU retention or if POWERDOWN
 is not taken (for instance because an interrupt is pending).
 *           2 - The Non Maskable Interrupt (NMI) is disabled and its
 configuration before calling this function will be restored back if POWERDOWN
 is not taken (for instance because an RTC or OSTIMER interrupt is pending).
 *           3 - The HARD FAULT handler should execute from SRAM. (The Hard
 fault handler should initiate a full chip reset) reset)
 */
 ...
 * @param   sram_retention_ctrl:
 * @param   wakeup_interrupts:
 * @param   cpu_retention_ctrl:  0 = CPU retention is disable / 1 = CPU
 retention is enabled, all other values are RESERVED.
 ...
 *           2 - The Non Maskable Interrupt (NMI) is disabled and its
 configuration before calling this function will be restored back if POWERDOWN
 is not taken (for instance because an RTC or OSTIMER interrupt is pending).
 *           3 - In case of CPU retention, it is the responsability of the user
 to make sure that SRAM instance containing the stack used to call this function
 WILL BE preserved during low power (via parameter "sram_retention_ctrl")
 *           4 - The HARD FAULT handler should execute from SRAM. (The Hard
 fault handler should initiate a full chip reset) reset)
 */
 ...
 *          !!! IMPORTANT NOTES :
 ...
 back by the API.
 *           1 - CPU0 Interrupt Enable registers (NVIC->ISER) are modified by
 this function. They are restored back if DEEPPOWERDOWN is not taken (for
 instance because an RTC or OSTIMER interrupt is pending).
 *           2 - The Non Maskable Interrupt (NMI) is disabled and its
 configuration before calling this function will be restored back if
 DEEPPOWERDOWN is not taken (for instance because an RTC or OSTIMER interrupt is
 pending).
 *           3 - The HARD FAULT handler should execute from SRAM. (The Hard
...
/*!
 * @brief Power Library API to choose normal regulation and set the voltage for
 * the desired operating frequency.
 *
 * @param system_freq_hz  - The desired frequency (in Hertz) at which the part
 * would like to operate, note that the voltage and flash wait states should be
 * set before changing frequency
 * @return none
 */
 ...
 * @param   pi32_16MfXtalIecLoadpF_x100 Load capacitance, pF x 100. For example,
 * 6pF becomes 600, 1.2pF becomes 120
 * @param   pi32_16MfXtalPPcbParCappF_x100 PCB +ve parasitic capacitance, pF x
 * 100. For example, 6pF becomes 600, 1.2pF becomes 120
 * @param   pi32_16MfXtalNPcbParCappF_x100 PCB -ve parasitic capacitance, pF x
 * 100. For example, 6pF becomes 600, 1.2pF becomes 120
 * @return  none
 * @note    Following default Values can be used:
 *          pi32_32MfXtalIecLoadpF_x100    Load capacitance, pF x 100 : 600
 *          pi32_32MfXtalPPcbParCappF_x100 PCB +ve parasitic capacitance, pF x
 * 100 : 20 pi32_32MfXtalNPcbParCappF_x100 PCB -ve parasitic capacitance, pF x
 * 100 : 40
 */
extern void POWER_Xtal16mhzCapabankTrim(
    int32_t pi32_16MfXtalIecLoadpF_x100,
 ...
 * @param   pi32_32kfXtalIecLoadpF_x100 Load capacitance, pF x 100. For example,
 6pF becomes 600, 1.2pF becomes 120
 * @param   pi32_32kfXtalPPcbParCappF_x100 PCB +ve parasitic capacitance, pF x
 100. For example, 6pF becomes 600, 1.2pF becomes 120
 * @param   pi32_32kfXtalNPcbParCappF_x100 PCB -ve parasitic capacitance, pF x
 100. For example, 6pF becomes 600, 1.2pF becomes 120

 * @return  none
 * @note    Following default Values can be used:
 *          pi32_32kfXtalIecLoadpF_x100    Load capacitance, pF x 100 : 600
 *          pi32_32kfXtalPPcbParCappF_x100 PCB +ve parasitic capacitance, pF x
 100 : 40
 *          pi32_32kfXtalNPcbParCappF_x100 PCB -ve parasitic capacitance, pF x
 100 : 40
 */
extern void POWER_Xtal32khzCapabankTrim(
    int32_t pi32_32kfXtalIecLoadpF_x100,
