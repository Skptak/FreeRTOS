...
__attribute__( (
    ...
    WDT_BOD_IRQHandler,   // 16: Windowed watchdog timer, Brownout detect, Flash
                          // interrupt
    ...
    MAILBOX_IRQHandler,  // 47: WAKEUP,Mailbox interrupt (present on selected
                         // devices)
...
// library.
//*****************************************************************************
__attribute__( ( naked, section( ".after_vectors.reset" ) ) ) void ResetISR(
    void )
{
    // Disable interrupts
