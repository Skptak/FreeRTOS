...
void BOARD_InitPins( void )
{
    ...
    GPIO_PinInit( BOARD_INITPINS_LED_BLUE_GPIO,
                  BOARD_INITPINS_LED_BLUE_PORT,
    ...
    GPIO_PinInit( BOARD_INITPINS_LED_RED_GPIO,
    ...
    GPIO_PinInit( BOARD_INITPINS_LED_GREEN_GPIO,
                  BOARD_INITPINS_LED_GREEN_PORT,
                  BOARD_INITPINS_LED_GREEN_PIN,
                  &LED_GREEN_config );
    ...
    IOCON_PinMuxSet( IOCON,
                     BOARD_INITPINS_UART_RX_PORT,
                     BOARD_INITPINS_UART_RX_PIN,
                     UART_RX );
    ...
    IOCON_PinMuxSet( IOCON,
                     BOARD_INITPINS_UART_TX_PORT,
                     BOARD_INITPINS_UART_TX_PIN,
                     UART_TX );
