...
/*! @brief serial port uart handle size*/
    ...
    #define SERIAL_USE_CONFIGURE_STRUCTURE \
        ( 0U ) /*!< Enable or disable the confgure structure pointer */
#endif
...
typedef struct _serial_port_uart_config
{
    ...
    serial_port_uart_parity_mode_t parityMode;      /*!< Parity mode, disabled
                                                       (default), even, odd */
    serial_port_uart_stop_bit_count_t stopBitCount; /*!< Number of stop bits, 1
                                                       stop bit (default) or 2
                                                       stop bits  */
    ...
    uint8_t instance;    /*!< Instance (0 - UART0, 1 - UART1, ...), detail
                            information    please refer to the SOC corresponding
                            RM.
                          */
#if( defined( SERIAL_MANAGER_NON_BLOCKING_MODE ) && \
     ( SERIAL_MANAGER_NON_BLOCKING_MODE > 0U ) )
