                                         ...
                                         void * serialConfig )
{
    ...
    if( kStatus_HAL_UartSuccess !=
        HAL_UartInit( ( ( hal_uart_handle_t ) &serialUartHandle
                            ->usartHandleBuffer[ 0 ] ),
                      &config ) )
    {
    ...
    if( kStatus_HAL_UartSuccess !=
        ...
        #else
    if( kStatus_HAL_UartSuccess !=
        HAL_UartInstallCallback( ( ( hal_uart_handle_t ) &serialUartHandle
                                       ->usartHandleBuffer[ 0 ] ),
                                 Serial_UartCallback,
                                 serialUartHandle ) )
        #endif
                                          ...
                                          uint32_t length )
{
    ...
    if( kStatus_HAL_UartSuccess !=
        ...
        #else
    if( kStatus_HAL_UartSuccess !=
        HAL_UartSendNonBlocking( ( ( hal_uart_handle_t ) &serialUartHandle
                                       ->usartHandleBuffer[ 0 ] ),
                                 buffer,
                                 length ) )
        #endif
