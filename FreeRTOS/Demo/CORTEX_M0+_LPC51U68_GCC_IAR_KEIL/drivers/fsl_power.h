...
static inline void POWER_PowerDownFlash( void )
{
    ...
    /* TURN OFF clock for Flash Controller (only needed for FLASH programming,
     * will be turned on by ROM API) */
 ...
 *
 * @param exclude_from_pd  Bit mask of the PDRUNCFG bits that needs to be
 ...
 *
 * @param exclude_from_pd  Bit mask of the PDRUNCFG bits that needs to be
 * powered on during deep power down mode, but this is has no effect as the
...
/*!
 * @brief Power Library API to choose low power regulation and set the voltage
