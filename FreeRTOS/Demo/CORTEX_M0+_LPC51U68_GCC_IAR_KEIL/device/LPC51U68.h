...
**                          MCUXpresso Compiler
**
**     Reference manual:    LPC51U68 User manual User manual Rev. 1.0 13 Dec
*2017
...
{
    kFlexcomm_Interface0_RX_I2C_Slave = 0U,   /**< Flexcomm Interface 0 RX/I2C
                                                 Slave */
    kFlexcomm_Interface0_TX_I2C_Master = 1U,  /**< Flexcomm Interface 0 TX/I2C
                                                 Master */
    kFlexcomm_Interface1_RX_I2C_Slave = 2U,   /**< Flexcomm Interface 1 RX/I2C
                                                 Slave */
    kFlexcomm_Interface1_TX_I2C_Master = 3U,  /**< Flexcomm Interface 1 TX/I2C
                                                 Master */
    kFlexcomm_Interface2_RX_I2C_Slave = 4U,   /**< Flexcomm Interface 2 RX/I2C
                                                 Slave */
    kFlexcomm_Interface2_TX_I2C_Master = 5U,  /**< Flexcomm Interface 2 TX/I2C
                                                 Master */
    kFlexcomm_Interface3_RX_I2C_Slave = 6U,   /**< Flexcomm Interface 3 RX/I2C
                                                 Slave */
    kFlexcomm_Interface3_TX_I2C_Master = 7U,  /**< Flexcomm Interface 3 TX/I2C
                                                 Master */
    kFlexcomm_Interface4_RX_I2C_Slave = 8U,   /**< Flexcomm Interface 4 RX/I2C
                                                 Slave */
    kFlexcomm_Interface4_TX_I2C_Master = 9U,  /**< Flexcomm Interface 4 TX/I2C
                                                 Master */
    kFlexcomm_Interface5_RX_I2C_Slave = 10U,  /**< Flexcomm Interface 5 RX/I2C
                                                 Slave */
    kFlexcomm_Interface5_TX_I2C_Master = 11U, /**< Flexcomm Interface 5 TX/I2C
                                                 Master */
    kFlexcomm_Interface6_RX_I2C_Slave = 12U,  /**< Flexcomm Interface 6 RX/I2C
                                                 Slave */
    kFlexcomm_Interface6_TX_I2C_Master = 13U, /**< Flexcomm Interface 6 TX/I2C
                                                 Master */
    kFlexcomm_Interface7_RX_I2C_Slave = 14U,  /**< Flexcomm Interface 7 RX/I2C
                                                 Slave */
    kFlexcomm_Interface7_TX_I2C_Master = 15U, /**< Flexcomm Interface 7 TX/I2C
                                                 Master */
...
typedef struct
{
    __IO uint32_t CTRL;  /**< ADC Control register. Contains the clock divide
                            value, resolution selection, sampling time selection,
                            and mode controls., offset: 0x0 */
    __IO uint32_t INSEL; /**< Input Select. Allows selection of the temperature
                            sensor as an alternate input to ADC channel 0.,
                            offset: 0x4 */
    __IO uint32_t SEQ_CTRL[ 2 ]; /**< ADC Conversion Sequence-n control
                                    register: Controls triggering and channel
                                    selection for conversion sequence-n. Also
                                    specifies interrupt mode for sequence-n.,
                                    array offset: 0x8, array step: 0x4 */
    __I uint32_t SEQ_GDAT[ 2 ];  /**< ADC Sequence-n Global Data register. This
                                    register contains the result of the most
                                    recent ADC conversion performed under
                                    sequence-n., array offset: 0x10, array step:
                                    0x4 */
    uint8_t RESERVED_0[ 8 ];
    __I uint32_t DAT[ 12 ];  /**< ADC Channel 0 Data register. This register
                                contains the result of the most recent conversion
                                completed on channel 0., array offset: 0x20,
                                array step: 0x4 */
    __IO uint32_t THR0_LOW;  /**< ADC Low Compare Threshold register 0: Contains
                                the lower threshold level for automatic threshold
                                comparison for any channels linked to threshold
                                pair 0., offset: 0x50 */
    __IO uint32_t THR1_LOW;  /**< ADC Low Compare Threshold register 1: Contains
                                the lower threshold level for automatic threshold
                                comparison for any channels linked to threshold
                                pair 1., offset: 0x54 */
    __IO uint32_t THR0_HIGH; /**< ADC High Compare Threshold register 0:
                                Contains the upper threshold level for automatic
                                threshold comparison for any channels linked to
                                threshold pair 0., offset: 0x58 */
    __IO uint32_t THR1_HIGH; /**< ADC High Compare Threshold register 1:
                                Contains the upper threshold level for automatic
                                threshold comparison for any channels linked to
                                threshold pair 1., offset: 0x5C */
    __IO uint32_t CHAN_THRSEL; /**< ADC Channel-Threshold Select register.
                                  Specifies which set of threshold compare
                                  registers are to be used for each channel,
                                  offset: 0x60 */
    __IO uint32_t INTEN;       /**< ADC Interrupt Enable register. This register
                                  contains enable bits that enable the sequence-A,
                                  sequence-B, threshold compare and data overrun
                                  interrupts to be generated., offset: 0x64 */
    __IO uint32_t FLAGS;       /**< ADC Flags register. Contains the four
                                  interrupt/DMA trigger flags and the individual
                                  component overrun and threshold-compare flags. (The
                                  overrun bits replicate information stored in the
                                  result registers)., offset: 0x68 */
...
/*! @name CTRL - ADC Control register. Contains the clock divide value,
 * resolution selection, sampling time selection, and mode controls. */
/*! @{ */
#define ADC_CTRL_CLKDIV_MASK  ( 0xFFU )
#define ADC_CTRL_CLKDIV_SHIFT ( 0U )
#define ADC_CTRL_CLKDIV( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_CTRL_CLKDIV_SHIFT ) ) & \
      ADC_CTRL_CLKDIV_MASK )
#define ADC_CTRL_ASYNMODE_MASK  ( 0x100U )
#define ADC_CTRL_ASYNMODE_SHIFT ( 8U )
/*! ASYNMODE - Select clock mode.
 *  0b0..Synchronous mode. The ADC clock is derived from the system clock based
 * on the divide value selected in the CLKDIV field. The ADC clock will be
 * started in a controlled fashion in response to a trigger to eliminate any
 * uncertainty in the launching of an ADC conversion in response to any
 * synchronous (on-chip) trigger. In Synchronous mode with the SYNCBYPASS bit
 * (in a sequence control register) set, sampling of the ADC input and start of
 * conversion will initiate 2 system clocks after the leading edge of a
 * (synchronous) trigger pulse. 0b1..Asynchronous mode. The ADC clock is based
 * on the output of the ADC clock divider ADCCLKSEL in the SYSCON block.
 */
#define ADC_CTRL_ASYNMODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_CTRL_ASYNMODE_SHIFT ) ) & \
      ADC_CTRL_ASYNMODE_MASK )
#define ADC_CTRL_RESOL_MASK  ( 0x600U )
#define ADC_CTRL_RESOL_SHIFT ( 9U )
/*! RESOL - The number of bits of ADC resolution. Accuracy can be reduced to
 * achieve higher conversion rates. A single conversion (including one
 * conversion in a burst or sequence) requires the selected number of bits of
 * resolution plus 3 ADC clocks. This field must only be altered when the ADC is
 * fully idle. Changing it during any kind of ADC operation may have
 * unpredictable results. ADC clock frequencies for various resolutions must not
 * exceed: - 5x the system clock rate for 12-bit resolution - 4.3x the system
 * clock rate for 10-bit resolution - 3.6x the system clock for 8-bit resolution
 * - 3x the bus clock rate for 6-bit resolution 0b00..6-bit resolution. An ADC
 * conversion requires 9 ADC clocks, plus any clocks specified by the TSAMP
 * field. 0b01..8-bit resolution. An ADC conversion requires 11 ADC clocks, plus
 * any clocks specified by the TSAMP field. 0b10..10-bit resolution. An ADC
 * conversion requires 13 ADC clocks, plus any clocks specified by the TSAMP
 * field. 0b11..12-bit resolution. An ADC conversion requires 15 ADC clocks,
 * plus any clocks specified by the TSAMP field.
 */
#define ADC_CTRL_RESOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_CTRL_RESOL_SHIFT ) ) & \
      ADC_CTRL_RESOL_MASK )
#define ADC_CTRL_BYPASSCAL_MASK  ( 0x800U )
#define ADC_CTRL_BYPASSCAL_SHIFT ( 11U )
/*! BYPASSCAL - Bypass Calibration. This bit may be set to avoid the need to
 * calibrate if offset error is not a concern in the application.
 *  0b0..Calibrate. The stored calibration value will be applied to the ADC
 * during conversions to compensated for offset error. A calibration cycle must
 * be performed each time the chip is powered-up. Re-calibration may be
 * warranted periodically - especially if operating conditions have changed.
 *  0b1..Bypass calibration. Calibration is not utilized. Less time is required
 * when enabling the ADC - particularly following chip power-up. Attempts to
 * launch a calibration cycle are blocked when this bit is set.
 */
#define ADC_CTRL_BYPASSCAL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << ADC_CTRL_BYPASSCAL_SHIFT ) ) & \
      ADC_CTRL_BYPASSCAL_MASK )
#define ADC_CTRL_TSAMP_MASK  ( 0x7000U )
#define ADC_CTRL_TSAMP_SHIFT ( 12U )
#define ADC_CTRL_TSAMP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_CTRL_TSAMP_SHIFT ) ) & \
      ADC_CTRL_TSAMP_MASK )
/*! @} */

/*! @name INSEL - Input Select. Allows selection of the temperature sensor as an
 ...
 */
#define ADC_INSEL_SEL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_INSEL_SEL_SHIFT ) ) & \
      ADC_INSEL_SEL_MASK )
/*! @} */

/*! @name SEQ_CTRL - ADC Conversion Sequence-n control register: Controls
 * triggering and channel selection for conversion sequence-n. Also specifies
 * interrupt mode for sequence-n. */
/*! @{ */
...
/*! TRIGPOL - Select the polarity of the selected input trigger for this
 * conversion sequence. In order to avoid generating a spurious trigger, it is
 * recommended writing to this field only when SEQA_ENA (bit 31) is low. It is
 * safe to change this field and set bit 31 in the same write. 0b0..Negative
 * edge. A negative edge launches the conversion sequence on the selected
 * trigger input. 0b1..Positive edge. A positive edge launches the conversion
 * sequence on the selected trigger input.
 */
...
/*! SYNCBYPASS - Setting this bit allows the hardware trigger input to bypass
 * synchronization flip-flop stages and therefore shorten the time between the
 * trigger input signal and the start of a conversion. There are slightly
 ...
 * from an on-chip, system-clock-based timer). Whether this bit is set or not, a
 * trigger pulse must be maintained for at least one system clock period.
 * Asynchronous mode (the ASYNMODE in the CTRL register = 1): Synchronization
 * may be bypassed (this bit may be set) if it is certain that the duration of a
 * trigger input pulse will be at least one cycle of the ADC clock (regardless
 ...
 * clock period. 0b0..Enable trigger synchronization. The hardware trigger
 * bypass is not enabled. 0b1..Bypass trigger synchronization. The hardware
 ...
 *  0b0..Low priority. Any B trigger which occurs while an A conversion sequence
 * is active will be ignored and lost. 0b1..High priority. Setting this bit to a
 * 1 will permit any enabled B sequence trigger (including a B sequence software
 * start) to immediately interrupt sequence A and launch a B sequence in it's
 * place. The conversion currently in progress will be terminated. The A
 * sequence that was interrupted will automatically resume after the B sequence
 * completes. The channel whose conversion was terminated will be re-sampled and
 * the conversion sequence will resume from that point.
 */
...
/*! MODE - Indicates whether the primary method for retrieving conversion
 ...
 * result registers at the end of the entire sequence. Impacts when
 * conversion-complete interrupt/DMA trigger for sequence-A will be generated
 * and which overrun conditions contribute to an overrun interrupt as described
 * below. 0b0..End of conversion. The sequence A interrupt/DMA trigger will be
 * set at the end of each individual ADC conversion performed under sequence A.
 * This flag will mirror the DATAVALID bit in the SEQA_GDAT register. The
 * OVERRUN bit in the SEQA_GDAT register will contribute to generation of an
 * overrun interrupt/DMA trigger if enabled. 0b1..End of sequence. The sequence
 * A interrupt/DMA trigger will be set when the entire set of sequence-A
 * conversions completes. This flag will need to be explicitly cleared by
 * software or by the DMA-clear signal in this mode. The OVERRUN bit in the
 * SEQA_GDAT register will NOT contribute to generation of an overrun
 * interrupt/DMA trigger since it is assumed this register may not be utilized
 * in this mode.
 */
#define ADC_SEQ_CTRL_MODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_SEQ_CTRL_MODE_SHIFT ) ) & \
      ADC_SEQ_CTRL_MODE_MASK )
#define ADC_SEQ_CTRL_SEQ_ENA_MASK  ( 0x80000000U )
#define ADC_SEQ_CTRL_SEQ_ENA_SHIFT ( 31U )
/*! SEQ_ENA - Sequence Enable. In order to avoid spuriously triggering the
 * sequence, care should be taken to only set the SEQn_ENA bit when the selected
 * trigger input is in its INACTIVE state (as defined by the TRIGPOL bit). If
 * this condition is not met, the sequence will be triggered immediately upon
 * being enabled. In order to avoid spuriously triggering the sequence, care
 * should be taken to only set the SEQn_ENA bit when the selected trigger input
 * is in its INACTIVE state (as defined by the TRIGPOL bit). If this condition
 * is not met, the sequence will be triggered immediately upon being enabled.
 *  0b0..Disabled. Sequence n is disabled. Sequence n triggers are ignored. If
 * this bit is cleared while sequence n is in progress, the sequence will be
 * halted at the end of the current conversion. After the sequence is
 * re-enabled, a new trigger will be required to restart the sequence beginning
 * with the next enabled channel. 0b1..Enabled. Sequence n is enabled.
 */
...
/*! @name SEQ_GDAT - ADC Sequence-n Global Data register. This register contains
 * the result of the most recent ADC conversion performed under sequence-n. */
/*! @{ */
...
#define ADC_SEQ_GDAT_CHN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_SEQ_GDAT_CHN_SHIFT ) ) & \
...
/*! @name DAT - ADC Channel 0 Data register. This register contains the result
...
#define ADC_DAT_RESULT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_DAT_RESULT_SHIFT ) ) & \
      ADC_DAT_RESULT_MASK )
...
#define ADC_DAT_DATAVALID( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_DAT_DATAVALID_SHIFT ) ) & \
...
/*! @name THR0_LOW - ADC Low Compare Threshold register 0: Contains the lower
 * threshold level for automatic threshold comparison for any channels linked to
 * threshold pair 0. */
/*! @{ */
...
/*! @name THR1_LOW - ADC Low Compare Threshold register 1: Contains the lower
 * threshold level for automatic threshold comparison for any channels linked to
 * threshold pair 1. */
/*! @{ */
...
/*! @name THR0_HIGH - ADC High Compare Threshold register 0: Contains the upper
 * threshold level for automatic threshold comparison for any channels linked to
 * threshold pair 0. */
/*! @{ */
...
/*! @name THR1_HIGH - ADC High Compare Threshold register 1: Contains the upper
 * threshold level for automatic threshold comparison for any channels linked to
 * threshold pair 1. */
/*! @{ */
...
/*! @name CHAN_THRSEL - ADC Channel-Threshold Select register. Specifies which
 * set of threshold compare registers are to be used for each channel */
/*! @{ */
 ...
 *  0b0..Threshold 0. Results for this channel will be compared against the
 * threshold levels indicated in the THR0_LOW and THR0_HIGH registers.
 *  0b1..Threshold 1. Results for this channel will be compared against the
...
/*! @name INTEN - ADC Interrupt Enable register. This register contains enable
 * bits that enable the sequence-A, sequence-B, threshold compare and data
 ...
 *  0b1..Enabled. The sequence A interrupt/DMA trigger is enabled and will be
 ...
 *  0b1..Enabled. The sequence B interrupt/DMA trigger is enabled and will be
 * asserted either upon completion of each individual conversion performed as
 ...
 *  0b1..Enabled. The overrun interrupt is enabled. Detection of an overrun
 * condition on any of the 12 channel data registers will cause an overrun
 * interrupt/DMA trigger. In addition, if the MODE bit for a particular sequence
 * is 0, then an overrun in the global data register for that sequence will also
 * cause this interrupt/DMA trigger to be asserted.
 */
...
/*! @name FLAGS - ADC Flags register. Contains the four interrupt/DMA trigger
 * flags and the individual component overrun and threshold-compare flags. (The
...
#define ADC_FLAGS_OVR_INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << ADC_FLAGS_OVR_INT_SHIFT ) ) & \
...
#define ADC_SEQ_IRQS                   \
    {                                  \
        ADC0_SEQA_IRQn, ADC0_SEQB_IRQn \
    }
#define ADC_THCMP_IRQS  \
    {                   \
        ADC0_THCMP_IRQn \
    }
...
/*!
 * @addtogroup ASYNC_SYSCON_Peripheral_Access_Layer ASYNC_SYSCON Peripheral
 * Access Layer
 * @{
 */
...
typedef struct
{
    __IO uint32_t ASYNCPRESETCTRL; /**< Async peripheral reset control, offset:
                                      0x0 */
    __O uint32_t ASYNCPRESETCTRLSET; /**< Set bits in ASYNCPRESETCTRL, offset:
                                        0x4 */
    __O uint32_t ASYNCPRESETCTRLCLR; /**< Clear bits in ASYNCPRESETCTRL, offset:
                                        0x8 */
    uint8_t RESERVED_0[ 4 ];
    __IO uint32_t ASYNCAPBCLKCTRL; /**< Async peripheral clock control, offset:
                                      0x10 */
    __O uint32_t ASYNCAPBCLKCTRLSET; /**< Set bits in ASYNCAPBCLKCTRL, offset:
                                        0x14 */
    __O uint32_t ASYNCAPBCLKCTRLCLR; /**< Clear bits in ASYNCAPBCLKCTRL, offset:
                                        0x18 */
    uint8_t RESERVED_1[ 4 ];
    __IO uint32_t ASYNCAPBCLKSELA; /**< Async APB clock source select A, offset:
                                      0x20 */
} ASYNC_SYSCON_Type;
...
#define ASYNC_SYSCON_ASYNCPRESETCTRL_CTIMER3( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                              \
...
#define ASYNC_SYSCON_ASYNCPRESETCTRLSET_ARST_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                                  \
...
#define ASYNC_SYSCON_ASYNCPRESETCTRLCLR_ARST_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                                  \
...
#define ASYNC_SYSCON_ASYNCAPBCLKCTRL_CTIMER3( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                              \
...
#define ASYNC_SYSCON_ASYNCAPBCLKCTRLSET_ACLK_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                                  \
...
#define ASYNC_SYSCON_ASYNCAPBCLKCTRLCLR_ACLK_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                                  \
 ...
 */
#define ASYNC_SYSCON_ASYNCAPBCLKSELA_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                          \
...
#define ASYNC_SYSCON_BASE_ADDRS \
    {                           \
        ASYNC_SYSCON_BASE       \
    }
/** Array initializer of ASYNC_SYSCON peripheral base pointers */
#define ASYNC_SYSCON_BASE_PTRS \
    {                          \
        ASYNC_SYSCON           \
    }
...
#define CRC_MODE_CMPL_SUM( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CRC_MODE_CMPL_SUM_SHIFT ) ) & \
...
#define CRC_SEED_CRC_SEED( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CRC_SEED_CRC_SEED_SHIFT ) ) & \
...
#define CRC_SUM_CRC_SUM( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CRC_SUM_CRC_SUM_SHIFT ) ) & \
...
typedef struct
{
    __IO uint32_t IR;  /**< Interrupt Register. The IR can be written to clear
                          ...
                          eight possible interrupt sources are pending., offset:
                          0x0 */
    __IO uint32_t TCR; /**< Timer Control Register. The TCR is used to control
                          the Timer Counter functions. The Timer Counter can be
                          disabled or reset through the TCR., offset: 0x4 */
    __IO uint32_t TC;  /**< Timer Counter. The 32 bit TC is incremented every
                          PR+1 cycles of the APB bus clock. The TC is controlled
                          through the TCR., offset: 0x8 */
    __IO uint32_t PR;  /**< Prescale Register. When the Prescale Counter (PC) is
                          equal to this value, the next clock increments the TC
                          and clears the PC., offset: 0xC */
    __IO uint32_t PC; /**< Prescale Counter. The 32 bit PC is a counter which is
                         incremented to the value stored in PR. When the value
                         in PR is reached, the TC is incremented and the PC is
                         cleared. The PC is observable and controllable through
                         the bus interface., offset: 0x10 */
    __IO uint32_t MCR; /**< Match Control Register. The MCR is used to control
                          if an interrupt is generated and if the TC is reset
                          when a Match occurs., offset: 0x14 */
    __IO uint32_t MR[ 4 ]; /**< Match Register . MR can be enabled through the
                              MCR to reset the TC, stop both the TC and PC,
                              and/or generate an interrupt every time MR matches
                              the TC., array offset: 0x18, array step: 0x4 */
    __IO uint32_t CCR;     /**< Capture Control Register. The CCR controls which
                              edges of the capture inputs are used to load the
                              Capture Registers and whether or not an interrupt is
                              generated when a capture takes place., offset: 0x28 */
    __I uint32_t CR[ 4 ]; /**< Capture Register . CR is loaded with the value of
                             TC when there is an event on the CAPn. input.,
                             array offset: 0x2C, array step: 0x4 */
    __IO uint32_t EMR; /**< External Match Register. The EMR controls the match
                          function and the external match pins., offset: 0x3C */
    uint8_t RESERVED_0[ 48 ];
    __IO uint32_t CTCR; /**< Count Control Register. The CTCR selects between
                           Timer and Counter mode, and in Counter mode selects
                           the signal and edge(s) for counting., offset: 0x70 */
    __IO uint32_t PWMC; /**< PWM Control Register. The PWMCON enables PWM mode
                           for the external match pins., offset: 0x74 */
} CTIMER_Type;
...
/*! @name IR - Interrupt Register. The IR can be written to clear interrupts.
 * The IR can be read to identify which of eight possible interrupt sources are
 * pending. */
/*! @{ */
#define CTIMER_IR_MR0INT_MASK  ( 0x1U )
#define CTIMER_IR_MR0INT_SHIFT ( 0U )
#define CTIMER_IR_MR0INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_MR0INT_SHIFT ) ) & \
      CTIMER_IR_MR0INT_MASK )
#define CTIMER_IR_MR1INT_MASK  ( 0x2U )
#define CTIMER_IR_MR1INT_SHIFT ( 1U )
#define CTIMER_IR_MR1INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_MR1INT_SHIFT ) ) & \
      CTIMER_IR_MR1INT_MASK )
#define CTIMER_IR_MR2INT_MASK  ( 0x4U )
#define CTIMER_IR_MR2INT_SHIFT ( 2U )
#define CTIMER_IR_MR2INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_MR2INT_SHIFT ) ) & \
      CTIMER_IR_MR2INT_MASK )
#define CTIMER_IR_MR3INT_MASK  ( 0x8U )
#define CTIMER_IR_MR3INT_SHIFT ( 3U )
#define CTIMER_IR_MR3INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_MR3INT_SHIFT ) ) & \
      CTIMER_IR_MR3INT_MASK )
#define CTIMER_IR_CR0INT_MASK  ( 0x10U )
#define CTIMER_IR_CR0INT_SHIFT ( 4U )
#define CTIMER_IR_CR0INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_CR0INT_SHIFT ) ) & \
      CTIMER_IR_CR0INT_MASK )
#define CTIMER_IR_CR1INT_MASK  ( 0x20U )
#define CTIMER_IR_CR1INT_SHIFT ( 5U )
#define CTIMER_IR_CR1INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_CR1INT_SHIFT ) ) & \
      CTIMER_IR_CR1INT_MASK )
#define CTIMER_IR_CR2INT_MASK  ( 0x40U )
#define CTIMER_IR_CR2INT_SHIFT ( 6U )
#define CTIMER_IR_CR2INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_CR2INT_SHIFT ) ) & \
      CTIMER_IR_CR2INT_MASK )
#define CTIMER_IR_CR3INT_MASK  ( 0x80U )
#define CTIMER_IR_CR3INT_SHIFT ( 7U )
#define CTIMER_IR_CR3INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_IR_CR3INT_SHIFT ) ) & \
      CTIMER_IR_CR3INT_MASK )
/*! @} */

/*! @name TCR - Timer Control Register. The TCR is used to control the Timer
 ...
 */
#define CTIMER_TCR_CEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_TCR_CEN_SHIFT ) ) & \
      CTIMER_TCR_CEN_MASK )
#define CTIMER_TCR_CRST_MASK  ( 0x2U )
#define CTIMER_TCR_CRST_SHIFT ( 1U )
/*! CRST - Counter reset.
 *  0b0..Disabled. Do nothing.
 *  0b1..Enabled. The Timer Counter and the Prescale Counter are synchronously
 * reset on the next positive edge of the APB bus clock. The counters remain
 * reset until TCR[1] is returned to zero.
 */
#define CTIMER_TCR_CRST( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_TCR_CRST_SHIFT ) ) & \
      CTIMER_TCR_CRST_MASK )
/*! @} */

/*! @name TC - Timer Counter. The 32 bit TC is incremented every PR+1 cycles of
...
#define CTIMER_TC_TCVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_TC_TCVAL_SHIFT ) ) & \
      CTIMER_TC_TCVAL_MASK )
/*! @} */

/*! @name PR - Prescale Register. When the Prescale Counter (PC) is equal to
...
#define CTIMER_PR_PRVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_PR_PRVAL_SHIFT ) ) & \
      CTIMER_PR_PRVAL_MASK )
/*! @} */

/*! @name PC - Prescale Counter. The 32 bit PC is a counter which is incremented
...
#define CTIMER_PC_PCVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_PC_PCVAL_SHIFT ) ) & \
      CTIMER_PC_PCVAL_MASK )
/*! @} */

/*! @name MCR - Match Control Register. The MCR is used to control if an
...
#define CTIMER_MR_MATCH( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_MR_MATCH_SHIFT ) ) & \
...
/*! @name CCR - Capture Control Register. The CCR controls which edges of the
...
/*! @name EMR - External Match Register. The EMR controls the match function and
 * the external match pins. */
/*! @{ */
#define CTIMER_EMR_EM0_MASK  ( 0x1U )
#define CTIMER_EMR_EM0_SHIFT ( 0U )
#define CTIMER_EMR_EM0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EM0_SHIFT ) ) & \
      CTIMER_EMR_EM0_MASK )
#define CTIMER_EMR_EM1_MASK  ( 0x2U )
#define CTIMER_EMR_EM1_SHIFT ( 1U )
#define CTIMER_EMR_EM1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EM1_SHIFT ) ) & \
      CTIMER_EMR_EM1_MASK )
#define CTIMER_EMR_EM2_MASK  ( 0x4U )
#define CTIMER_EMR_EM2_SHIFT ( 2U )
#define CTIMER_EMR_EM2( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EM2_SHIFT ) ) & \
      CTIMER_EMR_EM2_MASK )
#define CTIMER_EMR_EM3_MASK  ( 0x8U )
#define CTIMER_EMR_EM3_SHIFT ( 3U )
#define CTIMER_EMR_EM3( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EM3_SHIFT ) ) & \
      CTIMER_EMR_EM3_MASK )
#define CTIMER_EMR_EMC0_MASK  ( 0x30U )
#define CTIMER_EMR_EMC0_SHIFT ( 4U )
/*! EMC0 - External Match Control 0. Determines the functionality of External
 * Match 0. 0b00..Do Nothing. 0b01..Clear. Clear the corresponding External
 * Match bit/output to 0 (MAT0 pin is LOW if pinned out). 0b10..Set. Set the
 * corresponding External Match bit/output to 1 (MAT0 pin is HIGH if pinned
 * out). 0b11..Toggle. Toggle the corresponding External Match bit/output.
 */
#define CTIMER_EMR_EMC0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EMC0_SHIFT ) ) & \
      CTIMER_EMR_EMC0_MASK )
#define CTIMER_EMR_EMC1_MASK  ( 0xC0U )
#define CTIMER_EMR_EMC1_SHIFT ( 6U )
/*! EMC1 - External Match Control 1. Determines the functionality of External
 * Match 1. 0b00..Do Nothing. 0b01..Clear. Clear the corresponding External
 * Match bit/output to 0 (MAT1 pin is LOW if pinned out). 0b10..Set. Set the
 * corresponding External Match bit/output to 1 (MAT1 pin is HIGH if pinned
 * out). 0b11..Toggle. Toggle the corresponding External Match bit/output.
 */
#define CTIMER_EMR_EMC1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EMC1_SHIFT ) ) & \
      CTIMER_EMR_EMC1_MASK )
#define CTIMER_EMR_EMC2_MASK  ( 0x300U )
#define CTIMER_EMR_EMC2_SHIFT ( 8U )
/*! EMC2 - External Match Control 2. Determines the functionality of External
 * Match 2. 0b00..Do Nothing. 0b01..Clear. Clear the corresponding External
 * Match bit/output to 0 (MAT2 pin is LOW if pinned out). 0b10..Set. Set the
 * corresponding External Match bit/output to 1 (MAT2 pin is HIGH if pinned
 * out). 0b11..Toggle. Toggle the corresponding External Match bit/output.
 */
#define CTIMER_EMR_EMC2( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EMC2_SHIFT ) ) & \
      CTIMER_EMR_EMC2_MASK )
#define CTIMER_EMR_EMC3_MASK  ( 0xC00U )
#define CTIMER_EMR_EMC3_SHIFT ( 10U )
/*! EMC3 - External Match Control 3. Determines the functionality of External
 * Match 3. 0b00..Do Nothing. 0b01..Clear. Clear the corresponding External
 * Match bit/output to 0 (MAT3 pin is LOW if pinned out). 0b10..Set. Set the
 * corresponding External Match bit/output to 1 (MAT3 pin is HIGH if pinned
 * out). 0b11..Toggle. Toggle the corresponding External Match bit/output.
 */
#define CTIMER_EMR_EMC3( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_EMR_EMC3_SHIFT ) ) & \
      CTIMER_EMR_EMC3_MASK )
/*! @} */

/*! @name CTCR - Count Control Register. The CTCR selects between Timer and
...
/*! CTMODE - Counter/Timer Mode This field selects which rising APB bus clock
 ...
 * Counter matches the Prescale Register. 0b00..Timer Mode. Incremented every
 * rising APB bus clock edge. 0b01..Counter Mode rising edge. TC is incremented
 * on rising edges on the CAP input selected by bits 3:2. 0b10..Counter Mode
 * falling edge. TC is incremented on falling edges on the CAP input selected by
 * bits 3:2. 0b11..Counter Mode dual edge. TC is incremented on both edges on
 * the CAP input selected by bits 3:2.
 */
#define CTIMER_CTCR_CTMODE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << CTIMER_CTCR_CTMODE_SHIFT ) ) & \
      CTIMER_CTCR_CTMODE_MASK )
#define CTIMER_CTCR_CINSEL_MASK  ( 0xCU )
#define CTIMER_CTCR_CINSEL_SHIFT ( 2U )
/*! CINSEL - Count Input Select When bits 1:0 in this register are not 00, these
 * bits select which CAP pin is sampled for clocking. Note: If Counter mode is
 * selected for a particular CAPn input in the CTCR, the 3 bits for that input
 * in the Capture Control Register (CCR) must be programmed as 000. However,
 * capture and/or interrupt can be selected for the other 3 CAPn inputs in the
 * same timer. 0b00..Channel 0. CAPn.0 for CTIMERn 0b01..Channel 1. CAPn.1 for
 * CTIMERn 0b10..Channel 2. CAPn.2 for CTIMERn 0b11..Channel 3. CAPn.3 for
 * CTIMERn
 */
#define CTIMER_CTCR_CINSEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << CTIMER_CTCR_CINSEL_SHIFT ) ) & \
      CTIMER_CTCR_CINSEL_MASK )
#define CTIMER_CTCR_ENCC_MASK  ( 0x10U )
#define CTIMER_CTCR_ENCC_SHIFT ( 4U )
#define CTIMER_CTCR_ENCC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_CTCR_ENCC_SHIFT ) ) & \
      CTIMER_CTCR_ENCC_MASK )
#define CTIMER_CTCR_SELCC_MASK  ( 0xE0U )
#define CTIMER_CTCR_SELCC_SHIFT ( 5U )
/*! SELCC - Edge select. When bit 4 is 1, these bits select which capture input
 ...
 *  0b000..Channel 0 Rising Edge. Rising edge of the signal on capture channel 0
 * clears the timer (if bit 4 is set). 0b001..Channel 0 Falling Edge. Falling
 * edge of the signal on capture channel 0 clears the timer (if bit 4 is set).
 *  0b010..Channel 1 Rising Edge. Rising edge of the signal on capture channel 1
 * clears the timer (if bit 4 is set). 0b011..Channel 1 Falling Edge. Falling
 * edge of the signal on capture channel 1 clears the timer (if bit 4 is set).
 *  0b100..Channel 2 Rising Edge. Rising edge of the signal on capture channel 2
 * clears the timer (if bit 4 is set). 0b101..Channel 2 Falling Edge. Falling
 * edge of the signal on capture channel 2 clears the timer (if bit 4 is set).
 */
#define CTIMER_CTCR_SELCC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << CTIMER_CTCR_SELCC_SHIFT ) ) & \
      CTIMER_CTCR_SELCC_MASK )
/*! @} */

/*! @name PWMC - PWM Control Register. The PWMCON enables PWM mode for the
 * external match pins. */
/*! @{ */
 ...
 */
#define CTIMER_PWMC_PWMEN2( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << CTIMER_PWMC_PWMEN2_SHIFT ) ) & \
      CTIMER_PWMC_PWMEN2_MASK )
#define CTIMER_PWMC_PWMEN3_MASK  ( 0x8U )
#define CTIMER_PWMC_PWMEN3_SHIFT ( 3U )
/*! PWMEN3 - PWM mode enable for channel3. Note: It is recommended to use match
 * channel 3 to set the PWM cycle. 0b0..Match. CTIMERn_MAT3 is controlled by
 * EM3. 0b1..PWM. PWM mode is enabled for CT132Bn_MAT3.
 */
#define CTIMER_PWMC_PWMEN3( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
...
#define CTIMER_BASE_ADDRS                        \
    {                                            \
        CTIMER0_BASE, CTIMER1_BASE, CTIMER3_BASE \
    }
/** Array initializer of CTIMER peripheral base pointers */
#define CTIMER_BASE_PTRS          \
    {                             \
        CTIMER0, CTIMER1, CTIMER3 \
    }
/** Interrupt vectors for the CTIMER peripheral type */
#define CTIMER_IRQS                              \
    {                                            \
        CTIMER0_IRQn, CTIMER1_IRQn, CTIMER3_IRQn \
    }
...
typedef struct
{
    ...
    __IO uint32_t SRAMBASE; /**< SRAM address of the channel configuration
                               table., offset: 0x8 */
    uint8_t RESERVED_0[ 20 ];
    struct
    {                            /* offset: 0x20, array step: 0x5C */
        __IO uint32_t ENABLESET; /**< Channel Enable read and Set for all DMA
                                    channels., array offset: 0x20, array step:
                                    0x5C */
        uint8_t RESERVED_0[ 4 ];
        __O uint32_t ENABLECLR; /**< Channel Enable Clear for all DMA channels.,
                                   array offset: 0x28, array step: 0x5C */
        uint8_t RESERVED_1[ 4 ];
        __I uint32_t ACTIVE; /**< Channel Active status for all DMA channels.,
                                array offset: 0x30, array step: 0x5C */
        uint8_t RESERVED_2[ 4 ];
        __I uint32_t BUSY; /**< Channel Busy status for all DMA channels., array
                              offset: 0x38, array step: 0x5C */
        uint8_t RESERVED_3[ 4 ];
        __IO uint32_t ERRINT; /**< Error Interrupt status for all DMA channels.,
                                 array offset: 0x40, array step: 0x5C */
        uint8_t RESERVED_4[ 4 ];
        __IO uint32_t INTENSET; /**< Interrupt Enable read and Set for all DMA
                                   channels., array offset: 0x48, array step:
                                   0x5C */
        uint8_t RESERVED_5[ 4 ];
        __O uint32_t INTENCLR; /**< Interrupt Enable Clear for all DMA
                                  channels., array offset: 0x50, array step:
                                  0x5C */
        uint8_t RESERVED_6[ 4 ];
        __IO uint32_t INTA; /**< Interrupt A status for all DMA channels., array
                               offset: 0x58, array step: 0x5C */
        uint8_t RESERVED_7[ 4 ];
        __IO uint32_t INTB; /**< Interrupt B status for all DMA channels., array
                               offset: 0x60, array step: 0x5C */
        uint8_t RESERVED_8[ 4 ];
        __O uint32_t SETVALID; /**< Set ValidPending control bits for all DMA
                                  channels., array offset: 0x68, array step:
                                  0x5C */
        uint8_t RESERVED_9[ 4 ];
        __O uint32_t SETTRIG; /**< Set Trigger control bits for all DMA
                                 channels., array offset: 0x70, array step: 0x5C
                               */
        uint8_t RESERVED_10[ 4 ];
        __O uint32_t ABORT; /**< Channel Abort control for all DMA channels.,
                               array offset: 0x78, array step: 0x5C */
    } COMMON[ 1 ];
    uint8_t RESERVED_1[ 900 ];
    struct
    {                      /* offset: 0x400, array step: 0x10 */
        __IO uint32_t CFG; /**< Configuration register for DMA channel ., array
                              offset: 0x400, array step: 0x10 */
        __I uint32_t CTLSTAT;  /**< Control and status register for DMA channel
                                  ., array offset: 0x404, array step: 0x10 */
        __IO uint32_t XFERCFG; /**< Transfer configuration register for DMA
                                  channel ., array offset: 0x408, array step:
                                  0x10 */
        uint8_t RESERVED_0[ 4 ];
    } CHANNEL[ 20 ];
} DMA_Type;
 ...
 *  0b0..Disabled. The DMA controller is disabled. This clears any triggers that
 * were asserted at the point when disabled, but does not prevent re-triggering
 * when the DMA controller is re-enabled. 0b1..Enabled. The DMA controller is
 * enabled.
 */
#define DMA_CTRL_ENABLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << DMA_CTRL_ENABLE_SHIFT ) ) & \
...
/*! ACTIVEINT - Summarizes whether any enabled interrupts (other than error
 * interrupts) are pending. 0b0..Not pending. No enabled interrupts are pending.
...
/*! PERIPHREQEN - Peripheral request Enable. If a DMA channel is used to perform
 * a memory-to-memory move, any peripheral DMA request associated with that
 * channel can be disabled to prevent any interaction between the peripheral and
 * the DMA controller. 0b0..Disabled. Peripheral DMA requests are disabled.
...
/*! TRIGPOL - Trigger Polarity. Selects the polarity of a hardware trigger for
 * this channel. 0b0..Active low - falling edge. Hardware trigger is active low
 * or falling edge triggered, based on TRIGTYPE. 0b1..Active high - rising edge.
 * Hardware trigger is active high or rising edge triggered, based on TRIGTYPE.
 */
...
/*! TRIGTYPE - Trigger Type. Selects hardware trigger as edge triggered or level
 * triggered. 0b0..Edge. Hardware trigger is edge triggered. Transfers will be
 * initiated and completed, as specified for a single trigger. 0b1..Level.
 * Hardware trigger is level triggered. Note that when level triggering without
 * burst (BURSTPOWER = 0) is selected, only hardware triggers should be used on
 * that channel. Transfers continue as long as the trigger level is asserted.
 * Once the trigger is de-asserted, the transfer will be paused until the
 * trigger is, again, asserted. However, the transfer will not be paused until
 * any remaining transfers within the current BURSTPOWER length are completed.
 */
...
/*! TRIGBURST - Trigger Burst. Selects whether hardware triggers cause a single
 * or burst transfer. 0b0..Single transfer. Hardware trigger causes a single
 * transfer. 0b1..Burst transfer. When the trigger for this channel is set to
 * edge triggered, a hardware trigger causes a burst transfer, as defined by
 * BURSTPOWER. When the trigger for this channel is set to level triggered, a
 * hardware trigger causes transfers to continue as long as the trigger is
...
/*! SRCBURSTWRAP - Source Burst Wrap. When enabled, the source data address for
 * the DMA is 'wrapped', meaning that the source address range for each burst
 * will be the same. As an example, this could be used to read several
 * sequential registers from a peripheral for each DMA burst, reading the same
 * registers again for each burst. 0b0..Disabled. Source burst wrapping is not
 * enabled for this DMA channel. 0b1..Enabled. Source burst wrapping is enabled
...
/*! DSTBURSTWRAP - Destination Burst Wrap. When enabled, the destination data
 * address for the DMA is 'wrapped', meaning that the destination address range
 * for each burst will be the same. As an example, this could be used to write
 * several sequential registers to a peripheral for each DMA burst, writing the
 * same registers again for each burst. 0b0..Disabled. Destination burst
 * wrapping is not enabled for this DMA channel. 0b1..Enabled. Destination burst
 * wrapping is enabled for this DMA channel.
 */
...
/*! VALIDPENDING - Valid pending flag for this channel. This bit is set when a 1
 * is written to the corresponding bit in the related SETVALID register when
 * CFGVALID = 1 for the same channel. 0b0..No effect. No effect on DMA
 * operation. 0b1..Valid pending.
 */
...
/*! TRIG - Trigger flag. Indicates that the trigger for this channel is
 * currently set. This bit is cleared at the end of an entire transfer or upon
 * reload when CLRTRIG = 1. 0b0..Not triggered. The trigger for this DMA channel
 * is not set. DMA operations will not be carried out. 0b1..Triggered. The
 * trigger for this DMA channel is set. DMA operations will be carried out.
 */
...
/*! CFGVALID - Configuration Valid flag. This bit indicates whether the current
 * channel descriptor is valid and can potentially be acted upon, if all other
 * activation criteria are fulfilled. 0b0..Not valid. The channel descriptor is
 * not considered valid until validated by an associated SETVALID0 setting.
...
/*! RELOAD - Indicates whether the channel's control structure will be reloaded
 * when the current descriptor is exhausted. Reloading allows ping-pong and
 * linked transfers. 0b0..Disabled. Do not reload the channels' control
 * structure when the current descriptor is exhausted. 0b1..Enabled. Reload the
 * channels' control structure when the current descriptor is exhausted.
 */
 ...
 *  0b0..Not set. When written by software, the trigger for this channel is not
 * set. A new trigger, as defined by the HWTRIGEN, TRIGPOL, and TRIGTYPE will be
 * needed to start the channel. 0b1..Set. When written by software, the trigger
 * for this channel is set immediately. This feature should not be used with
 * level triggering when TRIGBURST = 0.
 */
 ...
 *  0b0..Not cleared. The trigger is not cleared when this descriptor is
...
/*! SETINTA - Set Interrupt flag A for this channel. There is no hardware
 * distinction between interrupt A and B. They can be used by software to assist
 * with more complex descriptor usage. By convention, interrupt A may be used
 * when only one interrupt flag is needed. 0b0..No effect. 0b1..Set. The INTA
 * flag for this channel will be set when the current descriptor is exhausted.
 */
...
/*! SETINTB - Set Interrupt flag B for this channel. There is no hardware
 * distinction between interrupt A and B. They can be used by software to assist
 * with more complex descriptor usage. By convention, interrupt A may be used
 * when only one interrupt flag is needed. 0b0..No effect. 0b1..Set. The INTB
 * flag for this channel will be set when the current descriptor is exhausted.
 */
 ...
 *  0b00..8-bit. 8-bit transfers are performed (8-bit source reads and
 * destination writes). 0b01..16-bit. 6-bit transfers are performed (16-bit
 * source reads and destination writes). 0b10..32-bit. 32-bit transfers are
 * performed (32-bit source reads and destination writes). 0b11..Reserved.
...
/*! SRCINC - Determines whether the source address is incremented for each DMA
 * transfer. 0b00..No increment. The source address is not incremented for each
 * transfer. This is the usual case when the source is a peripheral device.
 *  0b01..1 x width. The source address is incremented by the amount specified
 * by Width for each transfer. This is the usual case when the source is memory.
 *  0b10..2 x width. The source address is incremented by 2 times the amount
 * specified by Width for each transfer. 0b11..4 x width. The source address is
 * incremented by 4 times the amount specified by Width for each transfer.
 */
 ...
 * DMA transfer. 0b00..No increment. The destination address is not incremented
 * for each transfer. This is the usual case when the destination is a
 * peripheral device. 0b01..1 x width. The destination address is incremented by
 * the amount specified by Width for each transfer. This is the usual case when
 * the destination is memory. 0b10..2 x width. The destination address is
 * incremented by 2 times the amount specified by Width for each transfer.
 *  0b11..4 x width. The destination address is incremented by 4 times the
...
typedef struct
{
    ...
    __IO uint32_t PSELID; /**< Peripheral Select and Flexcomm ID register.,
                             offset: 0xFF8 */
 ...
 *  0b1..Peripheral select is locked and cannot be changed until this Flexcomm
...
#define FLEXCOMM_BASE_ADDRS                                                \
    {                                                                      \
        FLEXCOMM0_BASE, FLEXCOMM1_BASE, FLEXCOMM2_BASE, FLEXCOMM3_BASE,    \
            FLEXCOMM4_BASE, FLEXCOMM5_BASE, FLEXCOMM6_BASE, FLEXCOMM7_BASE \
    }
...
typedef struct
{
    ...
    uint8_t RESERVED_2[ 4 ];
    __I uint32_t FMSW[ 4 ]; /**< Words of 128-bit signature word, array offset:
                               0x2C, array step: 0x4 */
    uint8_t RESERVED_3[ 4004 ];
    __I uint32_t FMSTAT; /**< Signature generation status register, offset:
                            0xFE0 */
    uint8_t RESERVED_4[ 4 ];
    __O uint32_t FMSTATCLR; /**< Signature generation status clear register,
                               offset: 0xFE8 */
} FMC_Type;
...
#define FMC_FCTR_FS_RD0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << FMC_FCTR_FS_RD0_SHIFT ) ) & \
      FMC_FCTR_FS_RD0_MASK )
#define FMC_FCTR_FS_RD1_MASK  ( 0x10U )
#define FMC_FCTR_FS_RD1_SHIFT ( 4U )
#define FMC_FCTR_FS_RD1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << FMC_FCTR_FS_RD1_SHIFT ) ) & \
...
#define FMC_FMSW_SW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << FMC_FMSW_SW_SHIFT ) ) & \
      FMC_FMSW_SW_MASK )
/*! @} */
...
#define FMC_FMSTATCLR_SIG_DONE_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define FMC_BASE_ADDRS \
    {                  \
        FMC_BASE       \
    }
/** Array initializer of FMC peripheral base pointers */
#define FMC_BASE_PTRS \
    {                 \
        FMC           \
    }
...
typedef struct
{
    __IO uint32_t CTRL; /**< GPIO grouped interrupt control register, offset:
                           0x0 */
    uint8_t RESERVED_0[ 28 ];
    __IO uint32_t PORT_POL[ 2 ]; /**< GPIO grouped interrupt port 0 polarity
                                    register, array offset: 0x20, array step:
                                    0x4 */
    uint8_t RESERVED_1[ 24 ];
    __IO uint32_t PORT_ENA[ 2 ]; /**< GPIO grouped interrupt port 0 enable
                                    register, array offset: 0x40, array step:
                                    0x4 */
} GINT_Type;
...
/*! INT - Group interrupt status. This bit is cleared by writing a one to it.
 * Writing zero has no effect. 0b0..No request. No interrupt request is pending.
 *  0b1..Request active. Interrupt request is active.
 */
#define GINT_CTRL_INT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GINT_CTRL_INT_SHIFT ) ) & \
      GINT_CTRL_INT_MASK )
#define GINT_CTRL_COMB_MASK  ( 0x2U )
#define GINT_CTRL_COMB_SHIFT ( 1U )
/*! COMB - Combine enabled inputs for group interrupt
 *  0b0..Or. OR functionality: A grouped interrupt is generated when any one of
 * the enabled inputs is active (based on its programmed polarity). 0b1..And.
 * AND functionality: An interrupt is generated when all enabled bits are active
 * (based on their programmed polarity).
 */
#define GINT_CTRL_COMB( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GINT_CTRL_COMB_SHIFT ) ) & \
      GINT_CTRL_COMB_MASK )
 ...
 *  0b1..Level-triggered.
 */
#define GINT_CTRL_TRIG( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GINT_CTRL_TRIG_SHIFT ) ) & \
      GINT_CTRL_TRIG_MASK )
/*! @} */
...
#define GINT_PORT_POL_POL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GINT_PORT_POL_POL_SHIFT ) ) & \
...
#define GINT_PORT_ENA_ENA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GINT_PORT_ENA_ENA_SHIFT ) ) & \
...
typedef struct
{
    __IO uint8_t B[ 2 ][ 32 ]; /**< Byte pin registers for all port 0 and 1 GPIO
                                  pins, array offset: 0x0, array step:
                                  index*0x20, index2*0x1 */
    uint8_t RESERVED_0[ 4032 ];
    __IO uint32_t W[ 2 ][ 32 ]; /**< Word pin registers for all port 0 and 1
                                   GPIO pins, array offset: 0x1000, array step:
                                   index*0x80, index2*0x4 */
    uint8_t RESERVED_1[ 3840 ];
    __IO uint32_t DIR[ 2 ]; /**< Direction registers, array offset: 0x2000,
                               array step: 0x4 */
    uint8_t RESERVED_2[ 120 ];
    __IO uint32_t MASK[ 2 ]; /**< Mask register, array offset: 0x2080, array
                                step: 0x4 */
    uint8_t RESERVED_3[ 120 ];
    __IO uint32_t PIN[ 2 ]; /**< Port pin register, array offset: 0x2100, array
                               step: 0x4 */
    uint8_t RESERVED_4[ 120 ];
    __IO uint32_t MPIN[ 2 ]; /**< Masked port register, array offset: 0x2180,
                                array step: 0x4 */
    uint8_t RESERVED_5[ 120 ];
    __IO uint32_t SET[ 2 ]; /**< Write: Set register for port Read: output bits
                               for port, array offset: 0x2200, array step: 0x4
                             */
    uint8_t RESERVED_6[ 120 ];
    __O uint32_t CLR[ 2 ]; /**< Clear port, array offset: 0x2280, array step:
                              0x4 */
    uint8_t RESERVED_7[ 120 ];
    __O uint32_t NOT[ 2 ]; /**< Toggle port, array offset: 0x2300, array step:
                              0x4 */
    uint8_t RESERVED_8[ 120 ];
    __O uint32_t DIRSET[ 2 ]; /**< Set pin direction bits for port, array
                                 offset: 0x2380, array step: 0x4 */
    uint8_t RESERVED_9[ 120 ];
    __O uint32_t DIRCLR[ 2 ]; /**< Clear pin direction bits for port, array
                                 offset: 0x2400, array step: 0x4 */
    uint8_t RESERVED_10[ 120 ];
    __O uint32_t DIRNOT[ 2 ]; /**< Toggle pin direction bits for port, array
                                 offset: 0x2480, array step: 0x4 */
} GPIO_Type;
...
#define GPIO_B_PBYTE( x )                                               \
    ( ( ( uint8_t ) ( ( ( uint8_t ) ( x ) ) << GPIO_B_PBYTE_SHIFT ) ) & \
      GPIO_B_PBYTE_MASK )
/*! @} */
...
#define GPIO_W_PWORD( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_W_PWORD_SHIFT ) ) & \
      GPIO_W_PWORD_MASK )
/*! @} */
...
#define GPIO_DIR_DIRP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_DIR_DIRP_SHIFT ) ) & \
      GPIO_DIR_DIRP_MASK )
/*! @} */
...
#define GPIO_MASK_MASKP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_MASK_MASKP_SHIFT ) ) & \
...
#define GPIO_PIN_PORT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_PIN_PORT_SHIFT ) ) & \
      GPIO_PIN_PORT_MASK )
/*! @} */
...
#define GPIO_MPIN_MPORTP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_MPIN_MPORTP_SHIFT ) ) & \
...
#define GPIO_SET_SETP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_SET_SETP_SHIFT ) ) & \
      GPIO_SET_SETP_MASK )
/*! @} */
...
#define GPIO_CLR_CLRP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_CLR_CLRP_SHIFT ) ) & \
      GPIO_CLR_CLRP_MASK )
/*! @} */
...
#define GPIO_NOT_NOTP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << GPIO_NOT_NOTP_SHIFT ) ) & \
      GPIO_NOT_NOTP_MASK )
/*! @} */
...
typedef struct
{
    ...
    __IO uint32_t CFG;  /**< Configuration for shared functions., offset: 0x800
                         */
    __IO uint32_t STAT; /**< Status register for Master, Slave, and Monitor
                           functions., offset: 0x804 */
    ...
    __IO uint32_t CLKDIV;   /**< Clock pre-divider for the entire I2C interface.
                               This determines what time increments are used for
                               the MSTTIME register, and controls some timing of
                               the Slave function., offset: 0x814 */
    __I uint32_t INTSTAT; /**< Interrupt Status register for Master, Slave, and
                             Monitor functions., offset: 0x818 */
    uint8_t RESERVED_1[ 4 ];
    __IO uint32_t MSTCTL;  /**< Master control register., offset: 0x820 */
    __IO uint32_t MSTTIME; /**< Master timing configuration., offset: 0x824 */
    __IO uint32_t MSTDAT;  /**< Combined Master receiver and transmitter data
                              register., offset: 0x828 */
    uint8_t RESERVED_2[ 20 ];
    __IO uint32_t SLVCTL;      /**< Slave control register., offset: 0x840 */
    __IO uint32_t SLVDAT;      /**< Combined Slave receiver and transmitter data
                                  register., offset: 0x844 */
    __IO uint32_t SLVADR[ 4 ]; /**< Slave address register., array offset:
                                  0x848, array step: 0x4 */
    __IO uint32_t SLVQUAL0;    /**< Slave Qualification for address 0., offset:
                                  0x858 */
...
/*! MSTEN - Master Enable. When disabled, configurations settings for the Master
...
#define I2C_CFG_MSTEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_MSTEN_SHIFT ) ) & \
      I2C_CFG_MSTEN_MASK )
#define I2C_CFG_SLVEN_MASK  ( 0x2U )
#define I2C_CFG_SLVEN_SHIFT ( 1U )
/*! SLVEN - Slave Enable. When disabled, configurations settings for the Slave
...
#define I2C_CFG_SLVEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_SLVEN_SHIFT ) ) & \
      I2C_CFG_SLVEN_MASK )
#define I2C_CFG_MONEN_MASK  ( 0x4U )
#define I2C_CFG_MONEN_SHIFT ( 2U )
/*! MONEN - Monitor Enable. When disabled, configurations settings for the
 * Monitor function are not changed, but the Monitor function is internally
 * reset. 0b0..Disabled. The I2C Monitor function is disabled. 0b1..Enabled. The
 * I2C Monitor function is enabled.
 */
#define I2C_CFG_MONEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_MONEN_SHIFT ) ) & \
      I2C_CFG_MONEN_MASK )
#define I2C_CFG_TIMEOUTEN_MASK  ( 0x8U )
#define I2C_CFG_TIMEOUTEN_SHIFT ( 3U )
/*! TIMEOUTEN - I2C bus Time-out Enable. When disabled, the time-out function is
 * internally reset. 0b0..Disabled. Time-out function is disabled. 0b1..Enabled.
 * Time-out function is enabled. Both types of time-out flags will be generated
 * and will cause interrupts if they are enabled. Typically, only one time-out
 * will be used in a system.
 */
#define I2C_CFG_TIMEOUTEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_TIMEOUTEN_SHIFT ) ) & \
 ...
 *  0b0..Disabled. The Monitor function will not perform clock stretching.
 * Software or DMA may not always be able to read data provided by the Monitor
 * function before it is overwritten. This mode may be used when non-invasive
 * monitoring is critical. 0b1..Enabled. The Monitor function will perform clock
 * stretching in order to ensure that software or DMA can read all incoming data
 * supplied by the Monitor function.
 */
#define I2C_CFG_MONCLKSTR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_MONCLKSTR_SHIFT ) ) & \
      I2C_CFG_MONCLKSTR_MASK )
#define I2C_CFG_HSCAPABLE_MASK  ( 0x20U )
#define I2C_CFG_HSCAPABLE_SHIFT ( 5U )
/*! HSCAPABLE - High-speed mode Capable enable. Since High Speed mode alters the
 * way I2C pins drive and filter, as well as the timing for certain I2C
 * signalling, enabling High-speed mode applies to all functions: Master, Slave,
 * and Monitor. 0b0..Fast-mode plus. The I 2C interface will support
 * Standard-mode, Fast-mode, and Fast-mode Plus, to the extent that the pin
 * electronics support these modes. Any changes that need to be made to the pin
 * controls, such as changing the drive strength or filtering, must be made by
 * software via the IOCON register associated with each I2C pin,
 *  0b1..High-speed. In addition to Standard-mode, Fast-mode, and Fast-mode
 * Plus, the I 2C interface will support High-speed mode to the extent that the
 * pin electronics support these modes. See Section 25.7.2.2 for more
 * information.
 */
#define I2C_CFG_HSCAPABLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CFG_HSCAPABLE_SHIFT ) ) & \
...
/*! MSTPENDING - Master Pending. Indicates that the Master is waiting to
 * continue communication on the I2C-bus (pending) or is idle. When the master
 * is pending, the MSTSTATE bits indicate what type of software service if any
 * the master expects. This flag will cause an interrupt when set if, enabled
 * via the INTENSET register. The MSTPENDING flag is not set when the DMA is
 * handling an event (if the MSTDMA bit in the MSTCTL register is set). If the
 * master is in the idle state, and no communication is needed, mask this
 * interrupt. 0b0..In progress. Communication is in progress and the Master
 * function is busy and cannot currently accept a command. 0b1..Pending. The
 * Master function needs software service or is in the idle state. If the master
 * is not in the idle state, it is waiting to receive or transmit data or the
 * NACK bit.
 */
...
/*! MSTSTATE - Master State code. The master state code reflects the master
 * state when the MSTPENDING bit is set, that is the master is pending or in the
 * idle state. Each value of this field indicates a specific required service
 * for the Master function. All other values are reserved. See Table 400 for
 * details of state values and appropriate responses. 0b000..Idle. The Master
 * function is available to be used for a new transaction. 0b001..Receive ready.
 * Received data available (Master Receiver mode). Address plus Read was
 * previously sent and Acknowledged by slave. 0b010..Transmit ready. Data can be
 * transmitted (Master Transmitter mode). Address plus Write was previously sent
 * and Acknowledged by slave. 0b011..NACK Address. Slave NACKed address.
 *  0b100..NACK Data. Slave NACKed transmitted data.
 */
#define I2C_STAT_MSTSTATE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_MSTSTATE_SHIFT ) ) & \
      I2C_STAT_MSTSTATE_MASK )
#define I2C_STAT_MSTARBLOSS_MASK  ( 0x10U )
#define I2C_STAT_MSTARBLOSS_SHIFT ( 4U )
/*! MSTARBLOSS - Master Arbitration Loss flag. This flag can be cleared by
 * software writing a 1 to this bit. It is also cleared automatically a 1 is
 * written to MSTCONTINUE. 0b0..No Arbitration Loss has occurred.
 *  0b1..Arbitration loss. The Master function has experienced an Arbitration
 * Loss. At this point, the Master function has already stopped driving the bus
 * and gone to an idle state. Software can respond by doing nothing, or by
...
/*! MSTSTSTPERR - Master Start/Stop Error flag. This flag can be cleared by
 * software writing a 1 to this bit. It is also cleared automatically a 1 is
 * written to MSTCONTINUE. 0b0..No Start/Stop Error has occurred. 0b1..The
 * Master function has experienced a Start/Stop Error. A Start or Stop was
...
/*! SLVPENDING - Slave Pending. Indicates that the Slave function is waiting to
 ...
 * register is set). The SLVPENDING flag is read-only and is automatically
 ...
 * configured to be HSCAPABLE, HS master codes are detected automatically. Due
 * to the requirements of the HS I2C specification, slave addresses must also be
 * detected automatically, since the address must be acknowledged before the
 * clock can be stretched. 0b0..In progress. The Slave function does not
 * currently need service. 0b1..Pending. The Slave function needs service.
 * Information on what is needed can be found in the adjacent SLVSTATE field.
 */
...
/*! SLVSTATE - Slave State code. Each value of this field indicates a specific
 * required service for the Slave function. All other values are reserved. See
 * Table 401 for state values and actions. note that the occurrence of some
 * states and how they are handled are affected by DMA mode and Automatic
 * Operation modes. 0b00..Slave address. Address plus R/W received. At least one
 * of the four slave addresses has been matched by hardware. 0b01..Slave
 * receive. Received data is available (Slave Receiver mode). 0b10..Slave
 * transmit. Data can be transmitted (Slave Transmitter mode).
 */
#define I2C_STAT_SLVSTATE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_SLVSTATE_SHIFT ) ) & \
      I2C_STAT_SLVSTATE_MASK )
#define I2C_STAT_SLVNOTSTR_MASK  ( 0x800U )
#define I2C_STAT_SLVNOTSTR_SHIFT ( 11U )
/*! SLVNOTSTR - Slave Not Stretching. Indicates when the slave function is
 * stretching the I2C clock. This is needed in order to gracefully invoke Deep
 * Sleep or Power-down modes during slave operation. This read-only flag
 * reflects the slave function status in real time. 0b0..Stretching. The slave
 * function is currently stretching the I2C bus clock. Deep-Sleep or Power-down
 * mode cannot be entered at this time. 0b1..Not stretching. The slave function
 * is not currently stretching the I 2C bus clock. Deep-sleep or Power-down mode
...
/*! SLVIDX - Slave address match Index. This field is valid when the I2C slave
...
#define I2C_STAT_SLVIDX( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_SLVIDX_SHIFT ) ) & \
      I2C_STAT_SLVIDX_MASK )
#define I2C_STAT_SLVSEL_MASK  ( 0x4000U )
#define I2C_STAT_SLVSEL_SHIFT ( 14U )
/*! SLVSEL - Slave selected flag. SLVSEL is set after an address match when
 ...
 * address cycle presents an address that does not match an enabled address on
 * the Slave function, when slave software decides to NACK a matched address,
 ...
 * software NACKs data. 0b0..Not selected. The Slave function is not currently
 * selected. 0b1..Selected. The Slave function is currently selected.
 */
#define I2C_STAT_SLVSEL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_SLVSEL_SHIFT ) ) & \
      I2C_STAT_SLVSEL_MASK )
#define I2C_STAT_SLVDESEL_MASK  ( 0x8000U )
#define I2C_STAT_SLVDESEL_SHIFT ( 15U )
/*! SLVDESEL - Slave Deselected flag. This flag will cause an interrupt when set
 * if enabled via INTENSET. This flag can be cleared by writing a 1 to this bit.
 *  0b0..Not deselected. The Slave function has not become deselected. This does
 * not mean that it is currently selected. That information can be found in the
 * SLVSEL flag. 0b1..Deselected. The Slave function has become deselected. This
 * is specifically caused by the SLVSEL flag changing from 1 to 0. See the
 * description of SLVSEL for details on when that event occurs.
 */
#define I2C_STAT_SLVDESEL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_SLVDESEL_SHIFT ) ) & \
      I2C_STAT_SLVDESEL_MASK )
#define I2C_STAT_MONRDY_MASK  ( 0x10000U )
#define I2C_STAT_MONRDY_SHIFT ( 16U )
/*! MONRDY - Monitor Ready. This flag is cleared when the MONRXDAT register is
 * read. 0b0..No data. The Monitor function does not currently have data
 * available. 0b1..Data waiting. The Monitor function has data waiting to be
 * read.
 */
#define I2C_STAT_MONRDY( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_MONRDY_SHIFT ) ) & \
 ...
 *  0b1..Overrun. A Monitor data overrun has occurred. This can only happen when
...
#define I2C_STAT_MONOV( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_MONOV_SHIFT ) ) & \
      I2C_STAT_MONOV_MASK )
#define I2C_STAT_MONACTIVE_MASK  ( 0x40000U )
#define I2C_STAT_MONACTIVE_SHIFT ( 18U )
/*! MONACTIVE - Monitor Active flag. Indicates when the Monitor function
 * considers the I 2C bus to be active. Active is defined here as when some
 * Master is on the bus: a bus Start has occurred more recently than a bus Stop.
...
/*! MONIDLE - Monitor Idle flag. This flag is set when the Monitor function sees
 ...
 * flag can be cleared by writing a 1 to this bit. 0b0..Not idle. The I2C bus is
 * not idle, or this flag has been cleared by software. 0b1..Idle. The I2C bus
 * has gone idle at least once since the last time this flag was cleared by
 * software.
 */
#define I2C_STAT_MONIDLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_STAT_MONIDLE_SHIFT ) ) & \
      I2C_STAT_MONIDLE_MASK )
#define I2C_STAT_EVENTTIMEOUT_MASK  ( 0x1000000U )
#define I2C_STAT_EVENTTIMEOUT_SHIFT ( 24U )
/*! EVENTTIMEOUT - Event Time-out Interrupt flag. Indicates when the time
 * between events has been longer than the time specified by the TIMEOUT
 * register. Events include Start, Stop, and clock edges. The flag is cleared by
 * writing a 1 to this bit. No time-out is created when the I2C-bus is idle.
 *  0b0..No time-out. I2C bus events have not caused a time-out.
 *  0b1..Event time-out. The time between I2C bus events has been longer than
...
/*! SCLTIMEOUT - SCL Time-out Interrupt flag. Indicates when SCL has remained
 * low longer than the time specific by the TIMEOUT register. The flag is
 * cleared by writing a 1 to this bit. 0b0..No time-out. SCL low time has not
 * caused a time-out. 0b1..Time-out. SCL low time has caused a time-out.
 */
...
#define I2C_TIMEOUT_TOMIN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_TIMEOUT_TOMIN_SHIFT ) ) & \
      I2C_TIMEOUT_TOMIN_MASK )
#define I2C_TIMEOUT_TO_MASK  ( 0xFFF0U )
#define I2C_TIMEOUT_TO_SHIFT ( 4U )
#define I2C_TIMEOUT_TO( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_TIMEOUT_TO_SHIFT ) ) & \
      I2C_TIMEOUT_TO_MASK )
/*! @} */

/*! @name CLKDIV - Clock pre-divider for the entire I2C interface. This
 * determines what time increments are used for the MSTTIME register, and
 * controls some timing of the Slave function. */
/*! @{ */
#define I2C_CLKDIV_DIVVAL_MASK  ( 0xFFFFU )
#define I2C_CLKDIV_DIVVAL_SHIFT ( 0U )
#define I2C_CLKDIV_DIVVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_CLKDIV_DIVVAL_SHIFT ) ) & \
      I2C_CLKDIV_DIVVAL_MASK )
/*! @} */

/*! @name INTSTAT - Interrupt Status register for Master, Slave, and Monitor
 * functions. */
/*! @{ */
 ...
 *  0b0..No effect.
 *  0b1..Continue. Informs the Master function to continue to the next
 * operation. This must done after writing transmit data, reading received data,
 * or any other housekeeping related to the next bus operation.
 */
 ...
 *  0b0..No effect.
 *  0b1..Start. A Start will be generated on the I2C bus at the next allowed
 * time.
 */
 ...
 *  0b0..No effect.
 *  0b1..Stop. A Stop will be generated on the I2C bus at the next allowed time,
...
/*! MSTDMA - Master DMA enable. Data operations of the I2C can be performed with
 * DMA. Protocol type operations such as Start, address, Stop, and address match
 ...
 * configured to be HSCAPABLE (and address acknowledgement is handled entirely
 * by hardware) or when Automatic Operation is enabled. When a DMA data transfer
 * is complete, MSTDMA must be cleared prior to beginning the next operation,
 * typically a Start or Stop.This bit is read/write. 0b0..Disable. No DMA
 * requests are generated for master operation. 0b1..Enable. A DMA request is
 * generated for I2C master data operations. When this I2C master is generating
 * Acknowledge bits in Master Receiver mode, the acknowledge is generated
 * automatically.
 */
#define I2C_MSTCTL_MSTDMA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_MSTCTL_MSTDMA_SHIFT ) ) & \
...
/*! MSTSCLLOW - Master SCL Low time. Specifies the minimum low time that will be
 ...
 * bus specification. I2C bus specification parameters tBUF and tSU;STA have the
 * same values and are also controlled by MSTSCLLOW. 0b000..2 clocks. Minimum
 * SCL low time is 2 clocks of the I2C clock pre-divider. 0b001..3 clocks.
 * Minimum SCL low time is 3 clocks of the I2C clock pre-divider. 0b010..4
 * clocks. Minimum SCL low time is 4 clocks of the I2C clock pre-divider.
 *  0b011..5 clocks. Minimum SCL low time is 5 clocks of the I2C clock
 * pre-divider. 0b100..6 clocks. Minimum SCL low time is 6 clocks of the I2C
 * clock pre-divider. 0b101..7 clocks. Minimum SCL low time is 7 clocks of the
 * I2C clock pre-divider. 0b110..8 clocks. Minimum SCL low time is 8 clocks of
 * the I2C clock pre-divider. 0b111..9 clocks. Minimum SCL low time is 9 clocks
 * of the I2C clock pre-divider.
 */
...
/*! MSTSCLHIGH - Master SCL High time. Specifies the minimum high time that will
 ...
 * the same values and are also controlled by MSTSCLHIGH. 0b000..2 clocks.
 * Minimum SCL high time is 2 clock of the I2C clock pre-divider. 0b001..3
 * clocks. Minimum SCL high time is 3 clocks of the I2C clock pre-divider .
 *  0b010..4 clocks. Minimum SCL high time is 4 clock of the I2C clock
 * pre-divider. 0b011..5 clocks. Minimum SCL high time is 5 clock of the I2C
 * clock pre-divider. 0b100..6 clocks. Minimum SCL high time is 6 clock of the
 * I2C clock pre-divider. 0b101..7 clocks. Minimum SCL high time is 7 clock of
 * the I2C clock pre-divider. 0b110..8 clocks. Minimum SCL high time is 8 clock
 * of the I2C clock pre-divider. 0b111..9 clocks. Minimum SCL high time is 9
 * clocks of the I2C clock pre-divider.
 */
...
#define I2C_MSTDAT_DATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_MSTDAT_DATA_SHIFT ) ) & \
 ...
 *  0b0..No effect.
 *  0b1..Continue. Informs the Slave function to continue to the next operation,
 * by clearing the SLVPENDING flag in the STAT register. This must be done after
...
/*! SLVNACK - Slave NACK.
 *  0b0..No effect.
 *  0b1..NACK. Causes the Slave function to NACK the master when the slave is
 ...
 *  0b1..Enabled. DMA requests are issued for I2C slave data transmission and
 * reception.
 */
#define I2C_SLVCTL_SLVDMA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_SLVCTL_SLVDMA_SHIFT ) ) & \
      I2C_SLVCTL_SLVDMA_MASK )
#define I2C_SLVCTL_AUTOACK_MASK  ( 0x100U )
#define I2C_SLVCTL_AUTOACK_SHIFT ( 8U )
/*! AUTOACK - Automatic Acknowledge.When this bit is set, it will cause an I2C
 * header which matches SLVADR0 and the direction set by AUTOMATCHREAD to be
 * ACKed immediately; this is used with DMA to allow processing of the data
 * without intervention. If this bit is clear and a header matches SLVADR0, the
 * behavior is controlled by AUTONACK in the SLVADR0 register: allowing NACK or
 * interrupt. 0b0..Normal, non-automatic operation. If AUTONACK = 0, an
 * SlvPending interrupt is generated when a matching address is received. If
 * AUTONACK = 1, received addresses are NACKed (ignored). 0b1..A header with
 * matching SLVADR0 and matching direction as set by AUTOMATCHREAD will be ACKed
 * immediately, allowing the master to move on to the data bytes. If the address
 * matches SLVADR0, but the direction does not match AUTOMATCHREAD, the behavior
 * will depend on the AUTONACK bit in the SLVADR0 register: if AUTONACK is set,
 * then it will be Nacked; else if AUTONACK is clear, then a SlvPending
 * interrupt is generated.
 */
#define I2C_SLVCTL_AUTOACK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
...
/*! AUTOMATCHREAD - When AUTOACK is set, this bit controls whether it matches a
 * read or write request on the next header with an address matching SLVADR0.
 * Since DMA needs to be configured to match the transfer direction, the
 * direction needs to be specified. This bit allows a direction to be chosen for
 * the next operation. 0b0..The expected next operation in Automatic Mode is an
 * I2C write. 0b1..The expected next operation in Automatic Mode is an I2C read.
 */
...
#define I2C_SLVDAT_DATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_SLVDAT_DATA_SHIFT ) ) & \
...
#define I2C_SLVADR_SLVADR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2C_SLVADR_SLVADR_SHIFT ) ) & \
      I2C_SLVADR_SLVADR_MASK )
#define I2C_SLVADR_AUTONACK_MASK  ( 0x8000U )
#define I2C_SLVADR_AUTONACK_SHIFT ( 15U )
/*! AUTONACK - Automatic NACK operation. Used in conjunction with AUTOACK and
 * AUTOMATCHREAD, allows software to ignore I2C traffic while handling previous
 * I2C data or other operations. 0b0..Normal operation, matching I2C addresses
 * are not ignored. 0b1..Automatic-only mode. All incoming addresses are ignored
 * (NACKed), unless AUTOACK is set, it matches SLVADRn, and AUTOMATCHREAD
 * matches the direction.
 */
#define I2C_SLVADR_AUTONACK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
 ...
 *  0b0..Mask. The SLVQUAL0 field is used as a logical mask for matching address
 * 0. 0b1..Extend. The SLVQUAL0 field is used to extend address 0 matching in a
 * range of addresses.
 */
 ...
 *  0b0..No start detected. The Monitor function has not detected a Start event
 * on the I2C bus. 0b1..Start detected. The Monitor function has detected a
 ...
 *  0b0..No repeated start detected. The Monitor function has not detected a
 * Repeated Start event on the I2C bus. 0b1..Repeated start detected. The
 ...
 *  0b0..Acknowledged. The data currently being provided by the Monitor function
 * was acknowledged by at least one master or slave receiver. 0b1..Not
...
typedef struct
{
    ...
    __IO uint32_t CFG1; /**< Configuration register 1 for the primary channel
                           pair., offset: 0xC00 */
    __IO uint32_t CFG2; /**< Configuration register 2 for the primary channel
                           pair., offset: 0xC04 */
    __IO uint32_t STAT; /**< Status register for the primary channel pair.,
                           offset: 0xC08 */
    uint8_t RESERVED_1[ 16 ];
    __IO uint32_t DIV; /**< Clock divider, used by all channel pairs., offset:
                          0xC1C */
    uint8_t RESERVED_2[ 480 ];
    __IO uint32_t FIFOCFG; /**< FIFO configuration and enable register., offset:
                              0xE00 */
    __IO uint32_t FIFOSTAT; /**< FIFO status register., offset: 0xE04 */
    __IO uint32_t FIFOTRIG; /**< FIFO trigger settings for interrupt and DMA
                               request., offset: 0xE08 */
    uint8_t RESERVED_3[ 4 ];
    __IO uint32_t FIFOINTENSET; /**< FIFO interrupt enable set (enable) and read
                                   register., offset: 0xE10 */
    __IO uint32_t FIFOINTENCLR; /**< FIFO interrupt enable clear (disable) and
                                   read register., offset: 0xE14 */
    __I uint32_t FIFOINTSTAT;   /**< FIFO interrupt status register., offset:
                                   0xE18 */
    uint8_t RESERVED_4[ 4 ];
    __O uint32_t FIFOWR;    /**< FIFO write data., offset: 0xE20 */
    __O uint32_t FIFOWR48H; /**< FIFO write data for upper data bits. May only
                               be used if the I2S is configured for 2x 24-bit
                               data and not using DMA., offset: 0xE24 */
    uint8_t RESERVED_5[ 8 ];
    __I uint32_t FIFORD;    /**< FIFO read data., offset: 0xE30 */
    __I uint32_t FIFORD48H; /**< FIFO read data for upper data bits. May only be
                               used if the I2S is configured for 2x 24-bit data
                               and not using DMA., offset: 0xE34 */
    uint8_t RESERVED_6[ 8 ];
    __I uint32_t FIFORDNOPOP;    /**< FIFO data read with no FIFO pop., offset:
                                    0xE40 */
    __I uint32_t FIFORD48HNOPOP; /**< FIFO data read for upper data bits with no
                                    FIFO pop. May only be used if the I2S is
                                    configured for 2x 24-bit data and not using
                                    DMA., offset: 0xE44 */
 ...
 *  0b0..All I 2S channel pairs in this Flexcomm are disabled and the internal
 * state machines, counters, and flags are reset. No other channel pairs can be
 * enabled. 0b1..This I 2S channel pair is enabled. Other channel pairs in this
 * Flexcomm may be enabled in their individual PAIRENABLE bits.
 */
#define I2S_CFG1_MAINENABLE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << I2S_CFG1_MAINENABLE_SHIFT ) ) & \
      I2S_CFG1_MAINENABLE_MASK )
#define I2S_CFG1_DATAPAUSE_MASK  ( 0x2U )
#define I2S_CFG1_DATAPAUSE_SHIFT ( 1U )
/*! DATAPAUSE - Data flow Pause. Allows pausing data flow between the I2S
 * serializer/deserializer and the FIFO. This could be done in order to change
 * streams, or while restarting after a data underflow or overflow. When paused,
 * FIFO operations can be done without corrupting data that is in the process of
 * being sent or received. Once a data pause has been requested, the interface
 * may need to complete sending data that was in progress before interrupting
 * the flow of data. Software must check that the pause is actually in effect
 * before taking action. This is done by monitoring the DATAPAUSED flag in the
 * STAT register. When DATAPAUSE is cleared, data transfer will resume at the
 * beginning of the next frame. 0b0..Normal operation, or resuming normal
 * operation at the next frame if the I2S has already been paused. 0b1..A pause
 * in the data flow is being requested. It is in effect when DATAPAUSED in STAT
 * = 1.
 */
#define I2S_CFG1_DATAPAUSE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_CFG1_DATAPAUSE_SHIFT ) ) & \
      I2S_CFG1_DATAPAUSE_MASK )
#define I2S_CFG1_PAIRCOUNT_MASK  ( 0xCU )
#define I2S_CFG1_PAIRCOUNT_SHIFT ( 2U )
/*! PAIRCOUNT - Provides the number of I2S channel pairs in this Flexcomm This
 * is a read-only field whose value may be different in other Flexcomms. 00 =
 * there is 1 I2S channel pair in this Flexcomm. 01 = there are 2 I2S channel
 * pairs in this Flexcomm. 10 = there are 3 I2S channel pairs in this Flexcomm.
 * 11 = there are 4 I2S channel pairs in this Flexcomm. 0b00..1 I2S channel
 * pairs in this flexcomm 0b01..2 I2S channel pairs in this flexcomm 0b10..3 I2S
 * channel pairs in this flexcomm 0b11..4 I2S channel pairs in this flexcomm
 */
#define I2S_CFG1_PAIRCOUNT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_CFG1_PAIRCOUNT_SHIFT ) ) & \
      I2S_CFG1_PAIRCOUNT_MASK )
#define I2S_CFG1_MSTSLVCFG_MASK  ( 0x30U )
#define I2S_CFG1_MSTSLVCFG_SHIFT ( 4U )
/*! MSTSLVCFG - Master / slave configuration selection, determining how SCK and
 * WS are used by all channel pairs in this Flexcomm. 0b00..Normal slave mode,
 * the default mode. SCK and WS are received from a master and used to transmit
 * or receive data. 0b01..WS synchronized master. WS is received from another
 * master and used to synchronize the generation of SCK, when divided from the
 * Flexcomm function clock. 0b10..Master using an existing SCK. SCK is received
 * and used directly to generate WS, as well as transmitting or receiving data.
 *  0b11..Normal master mode. SCK and WS are generated so they can be sent to
 * one or more slave devices.
 */
#define I2S_CFG1_MSTSLVCFG( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_CFG1_MSTSLVCFG_SHIFT ) ) & \
      I2S_CFG1_MSTSLVCFG_MASK )
#define I2S_CFG1_MODE_MASK  ( 0xC0U )
#define I2S_CFG1_MODE_SHIFT ( 6U )
/*! MODE - Selects the basic I2S operating mode. Other configurations modify
 * this to obtain all supported cases. See Formats and modes for examples.
 *  0b00..I2S mode a.k.a. 'classic' mode. WS has a 50% duty cycle, with (for
 * each enabled channel pair) one piece of left channel data occurring during
 * the first phase, and one pieces of right channel data occurring during the
 * second phase. In this mode, the data region begins one clock after the
 * leading WS edge for the frame. For a 50% WS duty cycle, FRAMELEN must define
 * an even number of I2S clocks for the frame. If FRAMELEN defines an odd number
 * of clocks per frame, the extra clock will occur on the right. 0b01..DSP mode
 * where WS has a 50% duty cycle. See remark for mode 0. 0b10..DSP mode where WS
 * has a one clock long pulse at the beginning of each data frame. 0b11..DSP
 * mode where WS has a one data slot long pulse at the beginning of each data
 * frame.
 */
#define I2S_CFG1_MODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_MODE_SHIFT ) ) & \
      I2S_CFG1_MODE_MASK )
#define I2S_CFG1_RIGHTLOW_MASK  ( 0x100U )
#define I2S_CFG1_RIGHTLOW_SHIFT ( 8U )
/*! RIGHTLOW - Right channel data is in the Low portion of FIFO data.
 * Essentially, this swaps left and right channel data as it is transferred to
 * or from the FIFO. This bit is not used if the data width is greater than 24
 * bits or if PDMDATA = 1. Note that if the ONECHANNEL field (bit 10 of this
 * register) = 1, the one channel to be used is the nominally the left channel.
 * POSITION can still place that data in the frame where right channel data is
 * normally located. if all enabled channel pairs have ONECHANNEL = 1, then
 * RIGHTLOW = 1 is not allowed. 0b0..The right channel is taken from the high
 * part of the FIFO data. For example, when data is 16 bits, FIFO bits 31:16 are
 * used for the right channel. 0b1..The right channel is taken from the low part
 * of the FIFO data. For example, when data is 16 bits, FIFO bits 15:0 are used
 * for the right channel.
 */
#define I2S_CFG1_RIGHTLOW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_RIGHTLOW_SHIFT ) ) & \
      I2S_CFG1_RIGHTLOW_MASK )
#define I2S_CFG1_LEFTJUST_MASK  ( 0x200U )
#define I2S_CFG1_LEFTJUST_SHIFT ( 9U )
/*! LEFTJUST - Left Justify data.
 *  0b0..Data is transferred between the FIFO and the I2S
 * serializer/deserializer right justified, i.e. starting from bit 0 and
 * continuing to the position defined by DATALEN. This would correspond to right
 * justified data in the stream on the data bus. 0b1..Data is transferred
 * between the FIFO and the I2S serializer/deserializer left justified, i.e.
 * starting from the MSB of the FIFO entry and continuing for the number of bits
 * defined by DATALEN. This would correspond to left justified data in the
 * stream on the data bus.
 */
#define I2S_CFG1_LEFTJUST( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_LEFTJUST_SHIFT ) ) & \
      I2S_CFG1_LEFTJUST_MASK )
#define I2S_CFG1_ONECHANNEL_MASK  ( 0x400U )
#define I2S_CFG1_ONECHANNEL_SHIFT ( 10U )
/*! ONECHANNEL - Single channel mode. Applies to both transmit and receive. This
 * configuration bit applies only to the first I2S channel pair. Other channel
 * pairs may select this mode independently in their separate CFG1 registers.
 *  0b0..I2S data for this channel pair is treated as left and right channels.
 *  0b1..I2S data for this channel pair is treated as a single channel,
 * functionally the left channel for this pair. In mode 0 only, the right side
 * of the frame begins at POSITION = 0x100. This is because mode 0 makes a clear
 * distinction between the left and right sides of the frame. When ONECHANNEL =
 * 1, the single channel of data may be placed on the right by setting POSITION
 * to 0x100 + the data position within the right side (e.g. 0x108 would place
 * data starting at the 8th clock after the middle of the frame). In other
 * modes, data for the single channel of data is placed at the clock defined by
 * POSITION.
 */
#define I2S_CFG1_ONECHANNEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
 ...
 *  0b0..Data is launched on SCK falling edges and sampled on SCK rising edges
 * (standard for I2S). 0b1..Data is launched on SCK rising edges and sampled on
 * SCK falling edges.
 */
#define I2S_CFG1_SCK_POL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_SCK_POL_SHIFT ) ) & \
 ...
 *  0b1..WS is inverted, resulting in a data frame beginning at a rising edge of
 * WS (standard for most 'non-classic' variations of I2S).
 */
#define I2S_CFG1_WS_POL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_WS_POL_SHIFT ) ) & \
      I2S_CFG1_WS_POL_MASK )
#define I2S_CFG1_DATALEN_MASK  ( 0x1F0000U )
#define I2S_CFG1_DATALEN_SHIFT ( 16U )
#define I2S_CFG1_DATALEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG1_DATALEN_SHIFT ) ) & \
...
#define I2S_CFG2_POSITION( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_CFG2_POSITION_SHIFT ) ) & \
...
/*! BUSY - Busy status for the primary channel pair. Other BUSY flags may be
 * found in the STAT register for each channel pair. 0b0..The
 * transmitter/receiver for channel pair is currently idle. 0b1..The
 * transmitter/receiver for channel pair is currently processing data.
 */
#define I2S_STAT_BUSY( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_STAT_BUSY_SHIFT ) ) & \
      I2S_STAT_BUSY_MASK )
#define I2S_STAT_SLVFRMERR_MASK  ( 0x2U )
#define I2S_STAT_SLVFRMERR_SHIFT ( 1U )
/*! SLVFRMERR - Slave Frame Error flag. This applies when at least one channel
 * pair is operating as a slave. An error indicates that the incoming WS signal
 * did not transition as expected due to a mismatch between FRAMELEN and the
 * actual incoming I2S stream. 0b0..No error has been recorded. 0b1..An error
 * has been recorded for some channel pair that is operating in slave mode.
 * ERROR is cleared by writing a 1 to this bit position.
 */
#define I2S_STAT_SLVFRMERR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_STAT_SLVFRMERR_SHIFT ) ) & \
      I2S_STAT_SLVFRMERR_MASK )
#define I2S_STAT_LR_MASK  ( 0x4U )
#define I2S_STAT_LR_SHIFT ( 2U )
/*! LR - Left/Right indication. This flag is considered to be a debugging aid
 * and is not expected to be used by an I2S driver. Valid when one channel pair
 * is busy. Indicates left or right data being processed for the currently busy
 * channel pair. 0b0..Left channel. 0b1..Right channel.
 */
#define I2S_STAT_LR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_STAT_LR_SHIFT ) ) & \
      I2S_STAT_LR_MASK )
 ...
 *  0b0..Data is not currently paused. A data pause may have been requested but
 * is not yet in force, waiting for an allowed pause point. Refer to the
 * description of the DATAPAUSE control bit in the CFG1 register. 0b1..A data
 * pause has been requested and is now in force.
 */
#define I2S_STAT_DATAPAUSED( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
...
#define I2S_DIV_DIV( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_DIV_DIV_SHIFT ) ) & \
      I2S_DIV_DIV_MASK )
/*! @} */
...
/*! TXI2SSE0 - Transmit I2S empty 0. Determines the value sent by the I2S in
 * transmit mode if the TX FIFO becomes empty. This value is sent repeatedly
 * until the I2S is paused, the error is cleared, new data is provided, and the
 * I2S is un-paused. 0b0..If the TX FIFO becomes empty, the last value is sent.
 * This setting may be used when the data length is 24 bits or less, or when
 * MONO = 1 for this channel pair. 0b1..If the TX FIFO becomes empty, 0 is sent.
 * Use if the data length is greater than 24 bits or if zero fill is preferred.
 */
#define I2S_FIFOCFG_TXI2SSE0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )              \
                       << I2S_FIFOCFG_TXI2SSE0_SHIFT ) ) & \
      I2S_FIFOCFG_TXI2SSE0_MASK )
#define I2S_FIFOCFG_PACK48_MASK  ( 0x8U )
#define I2S_FIFOCFG_PACK48_SHIFT ( 3U )
/*! PACK48 - Packing format for 48-bit data. This relates to how data is entered
 * into or taken from the FIFO by software or DMA. 0b0..48-bit I2S FIFO entries
 * are handled as all 24-bit values. 0b1..48-bit I2S FIFO entries are handled as
 * alternating 32-bit and 16-bit values.
 */
#define I2S_FIFOCFG_PACK48( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_FIFOCFG_PACK48_SHIFT ) ) & \
      I2S_FIFOCFG_PACK48_MASK )
#define I2S_FIFOCFG_SIZE_MASK  ( 0x30U )
#define I2S_FIFOCFG_SIZE_SHIFT ( 4U )
#define I2S_FIFOCFG_SIZE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_FIFOCFG_SIZE_SHIFT ) ) & \
 ...
 *  0b1..Trigger DMA for the transmit function if the FIFO is not full.
 * Generally, data interrupts would be disabled if DMA is enabled.
 */
#define I2S_FIFOCFG_DMATX( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_FIFOCFG_DMATX_SHIFT ) ) & \
 ...
 *  0b1..Trigger DMA for the receive function if the FIFO is not empty.
 * Generally, data interrupts would be disabled if DMA is enabled.
 */
#define I2S_FIFOCFG_DMARX( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_FIFOCFG_DMARX_SHIFT ) ) & \
      I2S_FIFOCFG_DMARX_MASK )
#define I2S_FIFOCFG_WAKETX_MASK  ( 0x4000U )
#define I2S_FIFOCFG_WAKETX_SHIFT ( 14U )
/*! WAKETX - Wake-up for transmit FIFO level. This allows the device to be woken
 * from reduced power modes (up to power-down, as long as the peripheral
 * function works in that power mode) without enabling the TXLVL interrupt. Only
 * DMA wakes up, processes data, and goes back to sleep. The CPU will remain
 * stopped until woken by another cause, such as DMA completion. See Hardware
 * Wake-up control register. 0b0..Only enabled interrupts will wake up the
 * device form reduced power modes. 0b1..A device wake-up for DMA will occur if
 * the transmit FIFO level reaches the value specified by TXLVL in FIFOTRIG,
 * even when the TXLVL interrupt is not enabled.
 */
#define I2S_FIFOCFG_WAKETX( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << I2S_FIFOCFG_WAKETX_SHIFT ) ) & \
      I2S_FIFOCFG_WAKETX_MASK )
#define I2S_FIFOCFG_WAKERX_MASK  ( 0x8000U )
#define I2S_FIFOCFG_WAKERX_SHIFT ( 15U )
/*! WAKERX - Wake-up for receive FIFO level. This allows the device to be woken
 * from reduced power modes (up to power-down, as long as the peripheral
 * function works in that power mode) without enabling the TXLVL interrupt. Only
 * DMA wakes up, processes data, and goes back to sleep. The CPU will remain
 * stopped until woken by another cause, such as DMA completion. See Hardware
 * Wake-up control register. 0b0..Only enabled interrupts will wake up the
 * device form reduced power modes. 0b1..A device wake-up for DMA will occur if
 * the receive FIFO level reaches the value specified by RXLVL in FIFOTRIG, even
 * when the RXLVL interrupt is not enabled.
 */
#define I2S_FIFOCFG_WAKERX( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
...
/*! TXLVLENA - Transmit FIFO level trigger enable. This trigger will become an
 * interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMATX in FIFOCFG is
 * set. 0b0..Transmit FIFO level does not generate a FIFO level trigger. 0b1..An
 * trigger will be generated if the transmit FIFO level reaches the value
...
/*! RXLVLENA - Receive FIFO level trigger enable. This trigger will become an
 * interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMARX in FIFOCFG is
 * set. 0b0..Receive FIFO level does not generate a FIFO level trigger. 0b1..An
 * trigger will be generated if the receive FIFO level reaches the value
...
/*! TXERR - Determines whether an interrupt occurs when a transmit error occurs,
 * based on the TXERR flag in the FIFOSTAT register. 0b0..No interrupt will be
 * generated for a transmit error. 0b1..An interrupt will be generated when a
...
/*! RXERR - Determines whether an interrupt occurs when a receive error occurs,
 * based on the RXERR flag in the FIFOSTAT register. 0b0..No interrupt will be
 * generated for a receive error. 0b1..An interrupt will be generated when a
...
/*! TXLVL - Determines whether an interrupt occurs when a the transmit FIFO
 ...
 *  0b1..If TXLVLENA in the FIFOTRIG register = 1, an interrupt will be
 * generated when the TX FIFO level decreases to the level specified by TXLVL in
...
/*! RXLVL - Determines whether an interrupt occurs when a the receive FIFO
 * reaches the level specified by the TXLVL field in the FIFOTRIG register.
 *  0b0..No interrupt will be generated based on the RX FIFO level.
 *  0b1..If RXLVLENA in the FIFOTRIG register = 1, an interrupt will be
 * generated when the when the RX FIFO level increases to the level specified by
 * RXLVL in the FIFOTRIG register.
 */
...
/*! @name FIFOINTENCLR - FIFO interrupt enable clear (disable) and read
 * register. */
/*! @{ */
...
#define I2S_FIFOWR_TXDATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_FIFOWR_TXDATA_SHIFT ) ) & \
      I2S_FIFOWR_TXDATA_MASK )
/*! @} */

/*! @name FIFOWR48H - FIFO write data for upper data bits. May only be used if
...
#define I2S_FIFORD_RXDATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_FIFORD_RXDATA_SHIFT ) ) & \
      I2S_FIFORD_RXDATA_MASK )
/*! @} */

/*! @name FIFORD48H - FIFO read data for upper data bits. May only be used if
 * the I2S is configured for 2x 24-bit data and not using DMA. */
/*! @{ */
 ...
 * May only be used if the I2S is configured for 2x 24-bit data and not using
 * DMA. */
/*! @{ */
...
#define I2S_ID_Aperture( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_ID_Aperture_SHIFT ) ) & \
      I2S_ID_Aperture_MASK )
#define I2S_ID_Minor_Rev_MASK  ( 0xF00U )
#define I2S_ID_Minor_Rev_SHIFT ( 8U )
#define I2S_ID_Minor_Rev( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_ID_Minor_Rev_SHIFT ) ) & \
      I2S_ID_Minor_Rev_MASK )
#define I2S_ID_Major_Rev_MASK  ( 0xF000U )
#define I2S_ID_Major_Rev_SHIFT ( 12U )
#define I2S_ID_Major_Rev( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_ID_Major_Rev_SHIFT ) ) & \
      I2S_ID_Major_Rev_MASK )
#define I2S_ID_ID_MASK  ( 0xFFFF0000U )
#define I2S_ID_ID_SHIFT ( 16U )
#define I2S_ID_ID( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << I2S_ID_ID_SHIFT ) ) & \
      I2S_ID_ID_MASK )
/*! @} */
...
typedef struct
{
    ...
    __IO uint32_t PINTSEL[ 4 ]; /**< Pin interrupt select register, array
                                   offset: 0xC0, array step: 0x4 */
    uint8_t RESERVED_1[ 16 ];
    __IO uint32_t DMA_ITRIG_INMUX[ 22 ]; /**< Trigger select register for DMA
                                            channel, array offset: 0xE0, array
                                            step: 0x4 */
    uint8_t RESERVED_2[ 40 ];
    __IO uint32_t DMA_OTRIG_INMUX[ 4 ]; /**< DMA output trigger selection to
                                           become DMA trigger, array offset:
                                           0x160, array step: 0x4 */
    uint8_t RESERVED_3[ 16 ];
    __IO uint32_t FREQMEAS_REF;    /**< Selection for frequency measurement
                                      reference clock, offset: 0x180 */
    __IO uint32_t FREQMEAS_TARGET; /**< Selection for frequency measurement
                                      target clock, offset: 0x184 */
} INPUTMUX_Type;
...
typedef struct
{
    __IO uint32_t PIO[ 2 ][ 32 ]; /**< Digital I/O control for port 0 pins
                                     PIO0_0..Digital I/O control for port 1 pins
                                     PIO1_31, array offset: 0x0, array step:
                                     index*0x80, index2*0x4 */
} IOCON_Type;
...
/*! @name PIO - Digital I/O control for port 0 pins PIO0_0..Digital I/O control
 * for port 1 pins PIO1_31 */
/*! @{ */
 ...
 */
#define IOCON_PIO_FUNC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_FUNC_SHIFT ) ) & \
      IOCON_PIO_FUNC_MASK )
 ...
 */
#define IOCON_PIO_MODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_MODE_SHIFT ) ) & \
      IOCON_PIO_MODE_MASK )
 ...
 *  0b1..GPIO mode.
 */
#define IOCON_PIO_I2CSLEW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_I2CSLEW_SHIFT ) ) & \
 ...
 */
#define IOCON_PIO_INVERT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_INVERT_SHIFT ) ) & \
 ...
 *  0b0..Filter enabled. Noise pulses below approximately 10 ns are filtered
 * out. 0b1..Filter disabled. No input filtering is done.
 */
#define IOCON_PIO_FILTEROFF( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
 ...
 *  0b0..Low drive. Output drive sink is 4 mA. This is sufficient for standard
 * and fast mode I2C. 0b1..High drive. Output drive sink is 20 mA. This is
 * needed for Fast Mode Plus I 2C. Refer to the appropriate specific device data
 * sheet for details.
 */
#define IOCON_PIO_I2CDRIVE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
 ...
 *  0b0..Standard mode, output slew rate control is enabled. More outputs can be
 * switched simultaneously. 0b1..Fast mode, slew rate control is disabled. Refer
 * to the appropriate specific device data sheet for details.
 */
#define IOCON_PIO_SLEW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_SLEW_SHIFT ) ) & \
      IOCON_PIO_SLEW_MASK )
#define IOCON_PIO_I2CFILTER_MASK  ( 0x400U )
#define IOCON_PIO_I2CFILTER_SHIFT ( 10U )
/*! I2CFILTER - Configures I2C features for standard mode, fast mode, and Fast
 * Mode Plus operation. 0b0..Enabled. I2C 50 ns glitch filter enabled.
 *  0b1..Disabled. I2C 50 ns glitch filter disabled.
 */
#define IOCON_PIO_I2CFILTER( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
 ...
 */
#define IOCON_PIO_OD( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << IOCON_PIO_OD_SHIFT ) ) & \
      IOCON_PIO_OD_MASK )
/*! @} */
...
typedef struct
{
    ...
    {                         /* offset: 0x0, array step: 0x10 */
        __IO uint32_t INTVAL; /**< MRT Time interval value register. This value
                                 is loaded into the TIMER register., array
                                 offset: 0x0, array step: 0x10 */
        __I uint32_t TIMER;   /**< MRT Timer register. This register reads the
                                 value of the down-counter., array offset: 0x4,
                                 array step: 0x10 */
        __IO uint32_t CTRL;   /**< MRT Control register. This register controls
                                 the MRT modes., array offset: 0x8, array step:
                                 0x10 */
        __IO uint32_t STAT; /**< MRT Status register., array offset: 0xC, array
                               step: 0x10 */
    } CHANNEL[ 4 ];
    uint8_t RESERVED_0[ 176 ];
    __IO uint32_t MODCFG; /**< Module Configuration register. This register
                             provides information about this particular MRT
                             instance, and allows choosing an overall mode for
                             the idle channel feature., offset: 0xF0 */
    __I uint32_t IDLE_CH; /**< Idle channel register. This register returns the
                             number of the first idle channel., offset: 0xF4 */
...
/*! @name CHANNEL_INTVAL - MRT Time interval value register. This value is
 * loaded into the TIMER register. */
/*! @{ */
...
/*! LOAD - Determines how the timer interval value IVALUE -1 is loaded into the
 * TIMERn register. This bit is write-only. Reading this bit always returns 0.
 *  0b0..No force load. The load from the INTVALn register to the TIMERn
 * register is processed at the end of the time interval if the repeat mode is
 * selected. 0b1..Force load. The INTVALn interval value IVALUE -1 is
...
/*! @name CHANNEL_TIMER - MRT Timer register. This register reads the value of
 * the down-counter. */
/*! @{ */
...
/*! @name CHANNEL_CTRL - MRT Control register. This register controls the MRT
 * modes. */
/*! @{ */
 ...
 *  0b1..Pending interrupt. The interrupt is pending because TIMERn has reached
 * the end of the time interval. If the INTEN bit in the CONTROLn is also set to
...
/*! INUSE - Channel In Use flag. Operating details depend on the MULTITASK bit
 * in the MODCFG register, and affects the use of IDLE_CH. See Idle channel
 * register for details of the two operating modes. 0b0..This channel is not in
 * use. 0b1..This channel is in use.
 */
...
/*! @name MODCFG - Module Configuration register. This register provides
 * information about this particular MRT instance, and allows choosing an
 * overall mode for the idle channel feature. */
/*! @{ */
#define MRT_MODCFG_NOC_MASK    ( 0xFU )
#define MRT_MODCFG_NOC_SHIFT   ( 0U )
#define MRT_MODCFG_NOC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << MRT_MODCFG_NOC_SHIFT ) ) & \
      MRT_MODCFG_NOC_MASK )
#define MRT_MODCFG_NOB_MASK  ( 0x1F0U )
#define MRT_MODCFG_NOB_SHIFT ( 4U )
#define MRT_MODCFG_NOB( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << MRT_MODCFG_NOB_SHIFT ) ) & \
      MRT_MODCFG_NOB_MASK )
#define MRT_MODCFG_MULTITASK_MASK  ( 0x80000000U )
#define MRT_MODCFG_MULTITASK_SHIFT ( 31U )
/*! MULTITASK - Selects the operating mode for the INUSE flags and the IDLE_CH
 * register. 0b0..Hardware status mode. In this mode, the INUSE(n) flags for all
 * channels are reset. 0b1..Multi-task mode.
 */
...
/*! @name IDLE_CH - Idle channel register. This register returns the number of
 * the first idle channel. */
/*! @{ */
#define MRT_IDLE_CH_CHAN_MASK  ( 0xF0U )
#define MRT_IDLE_CH_CHAN_SHIFT ( 4U )
#define MRT_IDLE_CH_CHAN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << MRT_IDLE_CH_CHAN_SHIFT ) ) & \
...
typedef struct
{
    ...
    __IO uint32_t IENR; /**< Pin interrupt level or rising edge interrupt enable
                           register, offset: 0x4 */
    __O uint32_t SIENR; /**< Pin interrupt level or rising edge interrupt set
                           register, offset: 0x8 */
    __O uint32_t CIENR; /**< Pin interrupt level (rising edge interrupt) clear
                           register, offset: 0xC */
    __IO uint32_t IENF; /**< Pin interrupt active level or falling edge
                           interrupt enable register, offset: 0x10 */
    __O uint32_t SIENF; /**< Pin interrupt active level or falling edge
                           interrupt set register, offset: 0x14 */
    __O uint32_t CIENF; /**< Pin interrupt active level or falling edge
                           interrupt clear register, offset: 0x18 */
    ...
    __IO uint32_t PMCTRL; /**< Pattern match interrupt control register, offset:
                             0x28 */
    __IO uint32_t PMSRC; /**< Pattern match interrupt bit-slice source register,
                            offset: 0x2C */
    __IO uint32_t PMCFG; /**< Pattern match interrupt bit slice configuration
...
#define PINT_ISEL_PMODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_ISEL_PMODE_SHIFT ) ) & \
...
#define PINT_IENR_ENRL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_IENR_ENRL_SHIFT ) ) & \
      PINT_IENR_ENRL_MASK )
/*! @} */
...
#define PINT_CIENR_CENRL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_CIENR_CENRL_SHIFT ) ) & \
...
#define PINT_IENF_ENAF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_IENF_ENAF_SHIFT ) ) & \
      PINT_IENF_ENAF_MASK )
/*! @} */
...
#define PINT_CIENF_CENAF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_CIENF_CENAF_SHIFT ) ) & \
...
#define PINT_RISE_RDET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_RISE_RDET_SHIFT ) ) & \
      PINT_RISE_RDET_MASK )
/*! @} */
...
#define PINT_FALL_FDET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_FALL_FDET_SHIFT ) ) & \
      PINT_FALL_FDET_MASK )
/*! @} */
...
#define PINT_IST_PSTAT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_IST_PSTAT_SHIFT ) ) & \
      PINT_IST_PSTAT_MASK )
/*! @} */
...
/*! SEL_PMATCH - Specifies whether the 8 pin interrupts are controlled by the
 * pin interrupt function or by the pattern match function. 0b0..Pin interrupt.
 * Interrupts are driven in response to the standard pin interrupt function.
...
/*! ENA_RXEV - Enables the RXEV output to the CPU and/or to a GPIO output when
 * the specified boolean expression evaluates to true. 0b0..Disabled. RXEV
 * output to the CPU is disabled. 0b1..Enabled. RXEV output to the CPU is
 * enabled.
 */
...
#define PINT_PMCTRL_PMAT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCTRL_PMAT_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 0. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 0. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 0.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 0. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 0. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 0.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 0. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 0.
 */
#define PINT_PMSRC_SRC0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC0_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 1. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 1. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 1.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 1. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 1. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 1.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 1. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 1.
 */
#define PINT_PMSRC_SRC1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC1_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 2. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 2. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 2.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 2. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 2. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 2.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 2. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 2.
 */
#define PINT_PMSRC_SRC2( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC2_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 3. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 3. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 3.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 3. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 3. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 3.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 3. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 3.
 */
#define PINT_PMSRC_SRC3( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC3_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 4. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 4. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 4.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 4. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 4. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 4.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 4. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 4.
 */
#define PINT_PMSRC_SRC4( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC4_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 5. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 5. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 5.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 5. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 5. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 5.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 5. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 5.
 */
#define PINT_PMSRC_SRC5( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC5_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 6. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 6. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 6.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 6. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 6. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 6.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 6. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 6.
 */
#define PINT_PMSRC_SRC6( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC6_SHIFT ) ) & \
 ...
 *  0b000..Input 0. Selects the pin selected in the PINTSEL0 register as the
 * source to bit slice 7. 0b001..Input 1. Selects the pin selected in the
 * PINTSEL1 register as the source to bit slice 7. 0b010..Input 2. Selects the
 * pin selected in the PINTSEL2 register as the source to bit slice 7.
 *  0b011..Input 3. Selects the pin selected in the PINTSEL3 register as the
 * source to bit slice 7. 0b100..Input 4. Selects the pin selected in the
 * PINTSEL4 register as the source to bit slice 7. 0b101..Input 5. Selects the
 * pin selected in the PINTSEL5 register as the source to bit slice 7.
 *  0b110..Input 6. Selects the pin selected in the PINTSEL6 register as the
 * source to bit slice 7. 0b111..Input 7. Selects the pin selected in the
 * PINTSEL7 register as the source to bit slice 7.
 */
#define PINT_PMSRC_SRC7( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMSRC_SRC7_SHIFT ) ) & \
 ...
 *  0b1..endpoint. Slice 0 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 1 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 2 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 3 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 4 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 5 is the endpoint of a product term (minterm). Pin
 ...
 *  0b1..endpoint. Slice 6 is the endpoint of a product term (minterm). Pin
 ...
 *  0b000..Constant HIGH. This bit slice always contributes to a product term
 * match. 0b001..Sticky rising edge. Match occurs if a rising edge on the
 * specified input has occurred since the last time the edge detection for this
 * bit slice was cleared. This bit is only cleared when the PMCFG or the PMSRC
 * registers are written to. 0b010..Sticky falling edge. Match occurs if a
 * falling edge on the specified input has occurred since the last time the edge
 * detection for this bit slice was cleared. This bit is only cleared when the
 * PMCFG or the PMSRC registers are written to. 0b011..Sticky rising or falling
 * edge. Match occurs if either a rising or falling edge on the specified input
 ...
 * written to. 0b100..High level. Match (for this bit slice) occurs when there
 * is a high level on the input specified for this bit slice in the PMSRC
 * register. 0b101..Low level. Match occurs when there is a low level on the
 * specified input. 0b110..Constant 0. This bit slice never contributes to a
 * match (should be used to disable any unused bit slices). 0b111..Event.
 * Non-sticky rising or falling edge. Match occurs on an event - i.e. when
 * either a rising or falling edge is first detected on the specified input
 * (this is a non-sticky version of value 0x3) . This bit is cleared after one
 * clock cycle.
 */
#define PINT_PMCFG_CFG0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG0_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG1_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG2( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG2_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG3( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG3_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG4( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG4_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG5( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG5_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG6( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG6_SHIFT ) ) & \
 ...
 * clock cycle.
 */
#define PINT_PMCFG_CFG7( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << PINT_PMCFG_CFG7_SHIFT ) ) & \
...
typedef struct
{
    ...
    __IO uint32_t WAKE;  /**< High-resolution/wake-up timer control register,
                            offset: 0xC */
} RTC_Type;
 ...
 *  0b0..Not in reset. The RTC is not held in reset. This bit must be cleared
 * prior to configuring or initiating any operation of the RTC. 0b1..In reset.
 * The RTC is held in reset. All register bits within the RTC will be forced to
 * their reset value except the OFD bit. This bit must be cleared before writing
 * to any register in the RTC - including writes to set any of the other bits
 * within this register. Do not attempt to write to any bits of this register at
 * the same time that the reset bit is being cleared.
 */
#define RTC_CTRL_SWRESET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_CTRL_SWRESET_SHIFT ) ) & \
 ...
 *  0b0..No match. No match has occurred on the 1 Hz RTC timer. Writing a 0 has
 * no effect. 0b1..Match. A match condition has occurred on the 1 Hz RTC timer.
 * This flag generates an RTC alarm interrupt request RTC_ALARM which can also
 * wake up the part from any low power mode. Writing a 1 clears this bit.
 */
#define RTC_CTRL_ALARM1HZ( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_CTRL_ALARM1HZ_SHIFT ) ) & \
 ...
 *  0b1..Time-out. The 1 kHz high-resolution/wake-up timer has timed out. This
 * flag generates an RTC wake-up interrupt request RTC-WAKE which can also wake
 * up the part from any low power mode. Writing a 1 clears this bit.
 */
#define RTC_CTRL_WAKE1KHZ( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_CTRL_WAKE1KHZ_SHIFT ) ) & \
 ...
 *  0b0..Disable. A match on the 1 Hz RTC timer will not bring the part out of
 * Deep power-down mode. 0b1..Enable. A match on the 1 Hz RTC timer bring the
 ...
 *  0b0..Disable. A match on the 1 kHz RTC timer will not bring the part out of
 * Deep power-down mode. 0b1..Enable. A match on the 1 kHz RTC timer bring the
 * part out of Deep power-down mode.
 */
#define RTC_CTRL_WAKEDPD_EN( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
...
/*! RTC1KHZ_EN - RTC 1 kHz clock enable. This bit can be set to 0 to conserve
 * power if the 1 kHz timer is not used. This bit has no effect when the RTC is
 * disabled (bit 7 of this register is 0). 0b0..Disable. A match on the 1 kHz
 * RTC timer will not bring the part out of Deep power-down mode. 0b1..Enable.
 * The 1 kHz RTC timer is enabled.
 */
#define RTC_CTRL_RTC1KHZ_EN( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
...
/*! RTC_EN - RTC enable.
 *  0b0..Disable. The RTC 1 Hz and 1 kHz clocks are shut down and the RTC
 * operation is disabled. This bit should be 0 when writing to load a value in
 * the RTC counter register. 0b1..Enable. The 1 Hz RTC clock is running and RTC
 * operation is enabled. This bit must be set to initiate operation of the RTC.
 * The first clock to the RTC counter occurs 1 s after this bit is set. To also
 * enable the high-resolution, 1 kHz clock, set bit 6 in this register.
 */
#define RTC_CTRL_RTC_EN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_CTRL_RTC_EN_SHIFT ) ) & \
 ...
 *  0b0..RTC oscillator is powered-up and can output a clock if a crystal is
 * correctly connected externally 0b1..RTC oscillator is powered-down.
 */
#define RTC_CTRL_RTC_OSC_PD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
...
#define RTC_MATCH_MATVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_MATCH_MATVAL_SHIFT ) ) & \
...
#define RTC_COUNT_VAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_COUNT_VAL_SHIFT ) ) & \
      RTC_COUNT_VAL_MASK )
/*! @} */
...
#define RTC_WAKE_VAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << RTC_WAKE_VAL_SHIFT ) ) & \
      RTC_WAKE_VAL_MASK )
/*! @} */
...
typedef struct
{
    ...
    __IO uint32_t OUTPUTDIRCTRL; /**< SCT output counter direction control
    ...
    __IO uint32_t CONEN;  /**< SCT conflict interrupt enable register, offset:
                             0xF8 */
    __IO uint32_t CONFLAG; /**< SCT conflict flag register, offset: 0xFC */
    union
    {                                 /* offset: 0x100 */
        __IO uint32_t SCTCAP[ 10 ];   /**< SCT capture register of capture
                                         channel, array offset: 0x100, array step:
                                         0x4 */
        __IO uint32_t SCTMATCH[ 10 ]; /**< SCT match value register of match
                                         channels, array offset: 0x100, array
                                         step: 0x4 */
    };
    uint8_t RESERVED_2[ 216 ];
    union
    {                                   /* offset: 0x200 */
        __IO uint32_t SCTCAPCTRL[ 10 ]; /**< SCT capture control register, array
                                           offset: 0x200, array step: 0x4 */
        __IO uint32_t SCTMATCHREL[ 10 ]; /**< SCT match reload value register,
    ...
    {                        /* offset: 0x300, array step: 0x8 */
        __IO uint32_t STATE; /**< SCT event state register 0, array offset:
                                0x300, array step: 0x8 */
        __IO uint32_t CTRL;  /**< SCT event control register 0, array offset:
                                0x304, array step: 0x8 */
    } EVENT[ 10 ];
    uint8_t RESERVED_4[ 432 ];
    struct
    {                      /* offset: 0x500, array step: 0x8 */
        __IO uint32_t SET; /**< SCT output 0 set register, array offset: 0x500,
                              array step: 0x8 */
        __IO uint32_t CLR; /**< SCT output 0 clear register, array offset:
                              0x504, array step: 0x8 */
    } OUT[ 8 ];
} SCT_Type;
 ...
 */
#define SCT_CONFIG_UNIFY( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CONFIG_UNIFY_SHIFT ) ) & \
      SCT_CONFIG_UNIFY_MASK )
#define SCT_CONFIG_CLKMODE_MASK  ( 0x6U )
#define SCT_CONFIG_CLKMODE_SHIFT ( 1U )
/*! CLKMODE - SCT clock mode
 *  0b00..System Clock Mode. The system clock clocks the entire SCT module
 * including the counter(s) and counter prescalers. 0b01..Sampled System Clock
 * Mode. The system clock clocks the SCT module, but the counter and prescalers
 * are only enabled to count when the designated edge is detected on the input
 * selected by the CKSEL field. The minimum pulse width on the selected
 * clock-gate input is 1 bus clock period. This mode is the high-performance,
 * sampled-clock mode. 0b10..SCT Input Clock Mode. The input/edge selected by
 * the CKSEL field clocks the SCT module, including the counters and prescalers,
 * after first being synchronized to the system clock. The minimum pulse width
 * on the clock input is 1 bus clock period. This mode is the low-power,
 * sampled-clock mode. 0b11..Asynchronous Mode. The entire SCT module is clocked
 * directly by the input/edge selected by the CKSEL field. In this mode, the SCT
 * outputs are switched synchronously to the SCT input clock - not the system
 * clock. The input clock rate must be at least half the system clock rate and
 * can be the same or faster than the system clock.
 */
#define SCT_CONFIG_CLKMODE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << SCT_CONFIG_CLKMODE_SHIFT ) ) & \
      SCT_CONFIG_CLKMODE_MASK )
#define SCT_CONFIG_CKSEL_MASK  ( 0x78U )
#define SCT_CONFIG_CKSEL_SHIFT ( 3U )
/*! CKSEL - SCT clock select. The specific functionality of the designated
 ...
 */
#define SCT_CONFIG_CKSEL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CONFIG_CKSEL_SHIFT ) ) & \
...
#define SCT_CONFIG_INSYNC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CONFIG_INSYNC_SHIFT ) ) & \
...
#define SCT_CTRL_DOWN_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_DOWN_L_SHIFT ) ) & \
      SCT_CTRL_DOWN_L_MASK )
#define SCT_CTRL_STOP_L_MASK  ( 0x2U )
#define SCT_CTRL_STOP_L_SHIFT ( 1U )
#define SCT_CTRL_STOP_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_STOP_L_SHIFT ) ) & \
      SCT_CTRL_STOP_L_MASK )
#define SCT_CTRL_HALT_L_MASK  ( 0x4U )
#define SCT_CTRL_HALT_L_SHIFT ( 2U )
#define SCT_CTRL_HALT_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_HALT_L_SHIFT ) ) & \
      SCT_CTRL_HALT_L_MASK )
#define SCT_CTRL_CLRCTR_L_MASK  ( 0x8U )
#define SCT_CTRL_CLRCTR_L_SHIFT ( 3U )
#define SCT_CTRL_CLRCTR_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_CLRCTR_L_SHIFT ) ) & \
 ...
 *  0b0..Up. The counter counts up to a limit condition, then is cleared to
 * zero. 0b1..Up-down. The counter counts up to a limit, then counts down to a
 * limit condition or to 0.
 */
#define SCT_CTRL_BIDIR_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_BIDIR_L_SHIFT ) ) & \
      SCT_CTRL_BIDIR_L_MASK )
#define SCT_CTRL_PRE_L_MASK  ( 0x1FE0U )
#define SCT_CTRL_PRE_L_SHIFT ( 5U )
#define SCT_CTRL_PRE_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_PRE_L_SHIFT ) ) & \
      SCT_CTRL_PRE_L_MASK )
#define SCT_CTRL_DOWN_H_MASK  ( 0x10000U )
#define SCT_CTRL_DOWN_H_SHIFT ( 16U )
#define SCT_CTRL_DOWN_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_DOWN_H_SHIFT ) ) & \
      SCT_CTRL_DOWN_H_MASK )
#define SCT_CTRL_STOP_H_MASK  ( 0x20000U )
#define SCT_CTRL_STOP_H_SHIFT ( 17U )
#define SCT_CTRL_STOP_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_STOP_H_SHIFT ) ) & \
      SCT_CTRL_STOP_H_MASK )
#define SCT_CTRL_HALT_H_MASK  ( 0x40000U )
#define SCT_CTRL_HALT_H_SHIFT ( 18U )
#define SCT_CTRL_HALT_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_HALT_H_SHIFT ) ) & \
      SCT_CTRL_HALT_H_MASK )
#define SCT_CTRL_CLRCTR_H_MASK  ( 0x80000U )
#define SCT_CTRL_CLRCTR_H_SHIFT ( 19U )
#define SCT_CTRL_CLRCTR_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_CLRCTR_H_SHIFT ) ) & \
      SCT_CTRL_CLRCTR_H_MASK )
#define SCT_CTRL_BIDIR_H_MASK  ( 0x100000U )
#define SCT_CTRL_BIDIR_H_SHIFT ( 20U )
/*! BIDIR_H - Direction select
 *  0b0..The H counter counts up to its limit condition, then is cleared to
 * zero. 0b1..The H counter counts up to its limit, then counts down to a limit
 * condition or to 0.
 */
#define SCT_CTRL_BIDIR_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_BIDIR_H_SHIFT ) ) & \
      SCT_CTRL_BIDIR_H_MASK )
#define SCT_CTRL_PRE_H_MASK  ( 0x1FE00000U )
#define SCT_CTRL_PRE_H_SHIFT ( 21U )
#define SCT_CTRL_PRE_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CTRL_PRE_H_SHIFT ) ) & \
      SCT_CTRL_PRE_H_MASK )
/*! @} */
...
#define SCT_COUNT_CTR_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_COUNT_CTR_L_SHIFT ) ) & \
      SCT_COUNT_CTR_L_MASK )
#define SCT_COUNT_CTR_H_MASK  ( 0xFFFF0000U )
#define SCT_COUNT_CTR_H_SHIFT ( 16U )
#define SCT_COUNT_CTR_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_COUNT_CTR_H_SHIFT ) ) & \
...
#define SCT_STATE_STATE_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_STATE_STATE_L_SHIFT ) ) & \
      SCT_STATE_STATE_L_MASK )
#define SCT_STATE_STATE_H_MASK  ( 0x1F0000U )
#define SCT_STATE_STATE_H_SHIFT ( 16U )
#define SCT_STATE_STATE_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_STATE_STATE_H_SHIFT ) ) & \
...
#define SCT_OUTPUT_OUT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_OUTPUT_OUT_SHIFT ) ) & \
      SCT_OUTPUT_OUT_MASK )
/*! @} */
...
/*! SETCLR0 - Set/clear operation on output 0. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
 */
...
/*! SETCLR1 - Set/clear operation on output 1. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR2 - Set/clear operation on output 2. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR3 - Set/clear operation on output 3. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR4 - Set/clear operation on output 4. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR5 - Set/clear operation on output 5. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR6 - Set/clear operation on output 6. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR7 - Set/clear operation on output 7. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR8 - Set/clear operation on output 8. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR9 - Set/clear operation on output 9. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR10 - Set/clear operation on output 10. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR11 - Set/clear operation on output 11. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR12 - Set/clear operation on output 12. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR13 - Set/clear operation on output 13. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR14 - Set/clear operation on output 14. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
...
/*! SETCLR15 - Set/clear operation on output 15. Value 0x3 is reserved. Do not
 * program this value. 0b00..Set and clear do not depend on the direction of any
 * counter. 0b01..Set and clear are reversed when counter L or the unified
 * counter is counting down. 0b10..Set and clear are reversed when counter H is
 * counting down. Do not use if UNIFY = 1.
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR0 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR0 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O0RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O0RES_SHIFT ) ) & \
      SCT_RES_O0RES_MASK )
#define SCT_RES_O1RES_MASK  ( 0xCU )
#define SCT_RES_O1RES_SHIFT ( 2U )
/*! O1RES - Effect of simultaneous set and clear on output 1.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR1 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR1 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O1RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O1RES_SHIFT ) ) & \
      SCT_RES_O1RES_MASK )
#define SCT_RES_O2RES_MASK  ( 0x30U )
#define SCT_RES_O2RES_SHIFT ( 4U )
/*! O2RES - Effect of simultaneous set and clear on output 2.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR2 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output n (or set based on the SETCLR2 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O2RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O2RES_SHIFT ) ) & \
      SCT_RES_O2RES_MASK )
#define SCT_RES_O3RES_MASK  ( 0xC0U )
#define SCT_RES_O3RES_SHIFT ( 6U )
/*! O3RES - Effect of simultaneous set and clear on output 3.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR3 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR3 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O3RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O3RES_SHIFT ) ) & \
      SCT_RES_O3RES_MASK )
#define SCT_RES_O4RES_MASK  ( 0x300U )
#define SCT_RES_O4RES_SHIFT ( 8U )
/*! O4RES - Effect of simultaneous set and clear on output 4.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR4 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR4 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O4RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O4RES_SHIFT ) ) & \
      SCT_RES_O4RES_MASK )
#define SCT_RES_O5RES_MASK  ( 0xC00U )
#define SCT_RES_O5RES_SHIFT ( 10U )
/*! O5RES - Effect of simultaneous set and clear on output 5.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR5 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR5 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O5RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O5RES_SHIFT ) ) & \
      SCT_RES_O5RES_MASK )
#define SCT_RES_O6RES_MASK  ( 0x3000U )
#define SCT_RES_O6RES_SHIFT ( 12U )
/*! O6RES - Effect of simultaneous set and clear on output 6.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR6 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR6 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O6RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O6RES_SHIFT ) ) & \
      SCT_RES_O6RES_MASK )
#define SCT_RES_O7RES_MASK  ( 0xC000U )
#define SCT_RES_O7RES_SHIFT ( 14U )
/*! O7RES - Effect of simultaneous set and clear on output 7.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR7 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output n (or set based on the SETCLR7 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O7RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O7RES_SHIFT ) ) & \
      SCT_RES_O7RES_MASK )
#define SCT_RES_O8RES_MASK  ( 0x30000U )
#define SCT_RES_O8RES_SHIFT ( 16U )
/*! O8RES - Effect of simultaneous set and clear on output 8.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR8 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR8 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O8RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O8RES_SHIFT ) ) & \
      SCT_RES_O8RES_MASK )
#define SCT_RES_O9RES_MASK  ( 0xC0000U )
#define SCT_RES_O9RES_SHIFT ( 18U )
/*! O9RES - Effect of simultaneous set and clear on output 9.
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR9 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR9 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O9RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O9RES_SHIFT ) ) & \
      SCT_RES_O9RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR10 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR10 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O10RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O10RES_SHIFT ) ) & \
      SCT_RES_O10RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR11 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR11 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O11RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O11RES_SHIFT ) ) & \
      SCT_RES_O11RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR12 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR12 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O12RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O12RES_SHIFT ) ) & \
      SCT_RES_O12RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR13 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR13 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O13RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O13RES_SHIFT ) ) & \
      SCT_RES_O13RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR14 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR14 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O14RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O14RES_SHIFT ) ) & \
      SCT_RES_O14RES_MASK )
 ...
 *  0b00..No change.
 *  0b01..Set output (or clear based on the SETCLR15 field in the OUTPUTDIRCTRL
 * register). 0b10..Clear output (or set based on the SETCLR15 field).
 *  0b11..Toggle output.
 */
#define SCT_RES_O15RES( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_RES_O15RES_SHIFT ) ) & \
      SCT_RES_O15RES_MASK )
/*! @} */
...
#define SCT_EVEN_IEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_EVEN_IEN_SHIFT ) ) & \
      SCT_EVEN_IEN_MASK )
/*! @} */
...
#define SCT_EVFLAG_FLAG( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_EVFLAG_FLAG_SHIFT ) ) & \
...
#define SCT_CONEN_NCEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_CONEN_NCEN_SHIFT ) ) & \
      SCT_CONEN_NCEN_MASK )
/*! @} */
...
#define SCT_SCTCAP_CAPn_L( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_SCTCAP_CAPn_L_SHIFT ) ) & \
      SCT_SCTCAP_CAPn_L_MASK )
#define SCT_SCTCAP_CAPn_H_MASK  ( 0xFFFF0000U )
#define SCT_SCTCAP_CAPn_H_SHIFT ( 16U )
#define SCT_SCTCAP_CAPn_H( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_SCTCAP_CAPn_H_SHIFT ) ) & \
...
/*! IOCOND - Selects the I/O condition for event n. (The detection of edges on
 ...
 * pulse width of at least one SCT clock period . 0b00..LOW 0b01..Rise
 *  0b10..Fall
 *  0b11..HIGH
 */
...
/*! COMBMODE - Selects how the specified match and I/O condition are used and
 * combined. 0b00..OR. The event occurs when either the specified match or I/O
 * condition occurs. 0b01..MATCH. Uses the specified match only. 0b10..IO. Uses
 * the specified I/O condition only. 0b11..AND. The event occurs when the
 * specified match and I/O condition occur simultaneously.
 */
...
/*! STATELD - This bit controls how the STATEV value modifies the state selected
 * by HEVENT when this event is the highest-numbered event occurring for that
 * state. 0b0..STATEV value is added into STATE (the carry-out is ignored).
...
/*! DIRECTION - Direction qualifier for event generation. This field only
 * applies when the counters are operating in BIDIR mode. If BIDIR = 0, the SCT
 * ignores this field. Value 0x3 is reserved. 0b00..Direction independent. This
 * event is triggered regardless of the count direction. 0b01..Counting up. This
 * event is triggered only during up-counting when BIDIR = 1. 0b10..Counting
 * down. This event is triggered only during down-counting when BIDIR = 1.
 */
...
#define SCT_OUT_SET_SET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_OUT_SET_SET_SHIFT ) ) & \
...
#define SCT_OUT_CLR_CLR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SCT_OUT_CLR_CLR_SHIFT ) ) & \
...
typedef struct
{
    ...
    __IO uint32_t STAT;     /**< SPI Status. Some status flags can be cleared by
                               writing a 1 to that bit position., offset: 0x408 */
    __IO uint32_t INTENSET; /**< SPI Interrupt Enable read and Set. A complete
                               value may be read from this register. Writing a 1
                               to any implemented bit position causes that bit
                               to be set., offset: 0x40C */
    __O uint32_t INTENCLR;  /**< SPI Interrupt Enable Clear. Writing a 1 to any
                               implemented bit position causes the corresponding
                               bit in INTENSET to be cleared., offset: 0x410 */
    uint8_t RESERVED_1[ 16 ];
...
/*! ENABLE - SPI enable.
 *  0b0..Disabled. The SPI is disabled and the internal state machine and
 * counters are reset. 0b1..Enabled. The SPI is enabled for operation.
 */
#define SPI_CFG_ENABLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_ENABLE_SHIFT ) ) & \
      SPI_CFG_ENABLE_MASK )
#define SPI_CFG_MASTER_MASK  ( 0x4U )
#define SPI_CFG_MASTER_SHIFT ( 2U )
/*! MASTER - Master mode select.
 *  0b0..Slave mode. The SPI will operate in slave mode. SCK, MOSI, and the SSEL
 * signals are inputs, MISO is an output. 0b1..Master mode. The SPI will operate
 * in master mode. SCK, MOSI, and the SSEL signals are outputs, MISO is an
 * input.
 */
#define SPI_CFG_MASTER( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_MASTER_SHIFT ) ) & \
      SPI_CFG_MASTER_MASK )
...
#define SPI_CFG_LSBF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_LSBF_SHIFT ) ) & \
      SPI_CFG_LSBF_MASK )
#define SPI_CFG_CPHA_MASK  ( 0x10U )
#define SPI_CFG_CPHA_SHIFT ( 4U )
/*! CPHA - Clock Phase select.
 *  0b0..Change. The SPI captures serial data on the first clock transition of
 * the transfer (when the clock changes away from the rest state). Data is
 * changed on the following edge. 0b1..Capture. The SPI changes serial data on
 * the first clock transition of the transfer (when the clock changes away from
 * the rest state). Data is captured on the following edge.
 */
#define SPI_CFG_CPHA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_CPHA_SHIFT ) ) & \
      SPI_CFG_CPHA_MASK )
...
#define SPI_CFG_CPOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_CPOL_SHIFT ) ) & \
      SPI_CFG_CPOL_MASK )
#define SPI_CFG_LOOP_MASK  ( 0x80U )
#define SPI_CFG_LOOP_SHIFT ( 7U )
/*! LOOP - Loopback mode enable. Loopback mode applies only to Master mode, and
 * connects transmit and receive data connected together to allow simple
 * software testing. 0b0..Disabled. 0b1..Enabled.
 */
#define SPI_CFG_LOOP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_LOOP_SHIFT ) ) & \
      SPI_CFG_LOOP_MASK )
...
#define SPI_CFG_SPOL0( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_SPOL0_SHIFT ) ) & \
      SPI_CFG_SPOL0_MASK )
...
#define SPI_CFG_SPOL1( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_SPOL1_SHIFT ) ) & \
      SPI_CFG_SPOL1_MASK )
...
#define SPI_CFG_SPOL2( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_SPOL2_SHIFT ) ) & \
      SPI_CFG_SPOL2_MASK )
...
#define SPI_CFG_SPOL3( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_CFG_SPOL3_SHIFT ) ) & \
      SPI_CFG_SPOL3_MASK )
/*! @} */
...
/*! @name STAT - SPI Status. Some status flags can be cleared by writing a 1 to
 * that bit position. */
/*! @{ */
#define SPI_STAT_SSA_MASK  ( 0x10U )
#define SPI_STAT_SSA_SHIFT ( 4U )
#define SPI_STAT_SSA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_STAT_SSA_SHIFT ) ) & \
      SPI_STAT_SSA_MASK )
#define SPI_STAT_SSD_MASK  ( 0x20U )
#define SPI_STAT_SSD_SHIFT ( 5U )
#define SPI_STAT_SSD( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_STAT_SSD_SHIFT ) ) & \
      SPI_STAT_SSD_MASK )
#define SPI_STAT_STALLED_MASK  ( 0x40U )
#define SPI_STAT_STALLED_SHIFT ( 6U )
#define SPI_STAT_STALLED( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_STAT_STALLED_SHIFT ) ) & \
...
#define SPI_STAT_MSTIDLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_STAT_MSTIDLE_SHIFT ) ) & \
      SPI_STAT_MSTIDLE_MASK )
/*! @} */

/*! @name INTENSET - SPI Interrupt Enable read and Set. A complete value may be
 * read from this register. Writing a 1 to any implemented bit position causes
 * that bit to be set. */
/*! @{ */
#define SPI_INTENSET_SSAEN_MASK  ( 0x10U )
#define SPI_INTENSET_SSAEN_SHIFT ( 4U )
/*! SSAEN - Slave select assert interrupt enable. Determines whether an
 * interrupt occurs when the Slave Select is asserted. 0b0..Disabled. No
 * interrupt will be generated when any Slave Select transitions from deasserted
 * to asserted. 0b1..Enabled. An interrupt will be generated when any Slave
 * Select transitions from deasserted to asserted.
 */
...
/*! SSDEN - Slave select deassert interrupt enable. Determines whether an
 * interrupt occurs when the Slave Select is deasserted. 0b0..Disabled. No
 * interrupt will be generated when all asserted Slave Selects transition to
 * deasserted. 0b1..Enabled. An interrupt will be generated when all asserted
 * Slave Selects transition to deasserted.
 */
 ...
 *  0b1..An interrupt will be generated when the SPI master function is fully
 * idle.
 */
...
/*! @name INTENCLR - SPI Interrupt Enable Clear. Writing a 1 to any implemented
 * bit position causes the corresponding bit in INTENSET to be cleared. */
/*! @{ */
#define SPI_INTENCLR_SSAEN_MASK  ( 0x10U )
#define SPI_INTENCLR_SSAEN_SHIFT ( 4U )
#define SPI_INTENCLR_SSAEN( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << SPI_INTENCLR_SSAEN_SHIFT ) ) & \
      SPI_INTENCLR_SSAEN_MASK )
#define SPI_INTENCLR_SSDEN_MASK  ( 0x20U )
#define SPI_INTENCLR_SSDEN_SHIFT ( 5U )
#define SPI_INTENCLR_SSDEN( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
...
#define SPI_DIV_DIVVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_DIV_DIVVAL_SHIFT ) ) & \
      SPI_DIV_DIVVAL_MASK )
/*! @} */
...
#define SPI_FIFOCFG_SIZE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOCFG_SIZE_SHIFT ) ) & \
 ...
 * Generally, data interrupts would be disabled if DMA is enabled.
 */
#define SPI_FIFOCFG_DMATX( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOCFG_DMATX_SHIFT ) ) & \
 ...
 * Generally, data interrupts would be disabled if DMA is enabled.
 */
#define SPI_FIFOCFG_DMARX( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOCFG_DMARX_SHIFT ) ) & \
...
#define SPI_FIFOWR_TXDATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOWR_TXDATA_SHIFT ) ) & \
      SPI_FIFOWR_TXDATA_MASK )
#define SPI_FIFOWR_TXSSEL0_N_MASK  ( 0x10000U )
#define SPI_FIFOWR_TXSSEL0_N_SHIFT ( 16U )
/*! TXSSEL0_N - Transmit slave select. This field asserts SSEL0 in master mode.
 * The output on the pin is active LOW by default. 0b0..SSEL0 asserted.
...
/*! TXSSEL1_N - Transmit slave select. This field asserts SSEL1 in master mode.
 * The output on the pin is active LOW by default. 0b0..SSEL1 asserted.
...
/*! TXSSEL2_N - Transmit slave select. This field asserts SSEL2 in master mode.
 * The output on the pin is active LOW by default. 0b0..SSEL2 asserted.
...
/*! TXSSEL3_N - Transmit slave select. This field asserts SSEL3 in master mode.
 * The output on the pin is active LOW by default. 0b0..SSEL3 asserted.
...
/*! EOT - End of transfer. The asserted SSEL will be deasserted at the end of a
 * transfer and remain so far at least the time specified by the Transfer_delay
 * value in the DLY register. 0b0..SSEL not deasserted. This piece of data is
 * not treated as the end of a transfer. SSEL will not be deasserted at the end
 * of this data. 0b1..SSEL deasserted. This piece of data is treated as the end
 * of a transfer. SSEL will be deasserted at the end of this piece of data.
 */
#define SPI_FIFOWR_EOT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOWR_EOT_SHIFT ) ) & \
      SPI_FIFOWR_EOT_MASK )
#define SPI_FIFOWR_EOF_MASK  ( 0x200000U )
#define SPI_FIFOWR_EOF_SHIFT ( 21U )
/*! EOF - End of frame. Between frames, a delay may be inserted, as defined by
 * the Frame_delay value in the DLY register. The end of a frame may not be
 * particularly meaningful if the Frame_delay value = 0. This control can be
 * used as part of the support for frame lengths greater than 16 bits. 0b0..Data
 * not EOF. This piece of data transmitted is not treated as the end of a frame.
 *  0b1..Data EOF. This piece of data is treated as the end of a frame, causing
 * the Frame_delay time to be inserted before subsequent data is transmitted.
 */
#define SPI_FIFOWR_EOF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOWR_EOF_SHIFT ) ) & \
      SPI_FIFOWR_EOF_MASK )
#define SPI_FIFOWR_RXIGNORE_MASK  ( 0x400000U )
#define SPI_FIFOWR_RXIGNORE_SHIFT ( 22U )
/*! RXIGNORE - Receive Ignore. This allows data to be transmitted using the SPI
 * without the need to read unneeded data from the receiver. Setting this bit
 * simplifies the transmit process and can be used with the DMA. 0b0..Read
 * received data. Received data must be read in order to allow transmission to
 * progress. SPI transmit will halt when the receive data FIFO is full. In slave
 * mode, an overrun error will occur if received data is not read before new
 * data is received. 0b1..Ignore received data. Received data is ignored,
 * allowing transmission without reading unneeded received data. No receiver
 * flags are generated.
 */
#define SPI_FIFOWR_RXIGNORE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << SPI_FIFOWR_RXIGNORE_SHIFT ) ) & \
      SPI_FIFOWR_RXIGNORE_MASK )
#define SPI_FIFOWR_LEN_MASK  ( 0xF000000U )
#define SPI_FIFOWR_LEN_SHIFT ( 24U )
#define SPI_FIFOWR_LEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFOWR_LEN_SHIFT ) ) & \
      SPI_FIFOWR_LEN_MASK )
/*! @} */
...
#define SPI_FIFORD_RXDATA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFORD_RXDATA_SHIFT ) ) & \
...
#define SPI_FIFORD_SOT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SPI_FIFORD_SOT_SHIFT ) ) & \
      SPI_FIFORD_SOT_MASK )
/*! @} */
...
#define SPI_BASE_ADDRS                                                    \
    {                                                                     \
        SPI0_BASE, SPI1_BASE, SPI2_BASE, SPI3_BASE, SPI4_BASE, SPI5_BASE, \
            SPI6_BASE, SPI7_BASE                                          \
    }
...
typedef struct
{
    ...
    __IO uint32_t AHBMATPRIO; /**< AHB multilayer matrix priority control,
                                 offset: 0x10 */
    ...
    __I uint32_t PIOPORCAP[ 2 ]; /**< POR captured value of port n, array
                                    offset: 0xC0, array step: 0x4 */
    uint8_t RESERVED_4[ 8 ];
    __I uint32_t PIORESCAP[ 2 ]; /**< Reset captured value of port n, array
                                    offset: 0xD0, array step: 0x4 */
    uint8_t RESERVED_5[ 40 ];
    __IO uint32_t PRESETCTRL[ 2 ]; /**< Peripheral reset control n, array
                                      offset: 0x100, array step: 0x4 */
    uint8_t RESERVED_6[ 24 ];
    __O uint32_t PRESETCTRLSET[ 2 ]; /**< Set bits in PRESETCTRLn, array offset:
                                        0x120, array step: 0x4 */
    uint8_t RESERVED_7[ 24 ];
    __O uint32_t PRESETCTRLCLR[ 2 ]; /**< Clear bits in PRESETCTRLn, array
                                        offset: 0x140, array step: 0x4 */
    uint8_t RESERVED_8[ 168 ];
    __IO uint32_t SYSRSTSTAT; /**< System reset status register, offset: 0x1F0
                               */
    uint8_t RESERVED_9[ 12 ];
    __IO uint32_t AHBCLKCTRL[ 2 ]; /**< AHB Clock control n, array offset:
                                      0x200, array step: 0x4 */
    uint8_t RESERVED_10[ 24 ];
    __O uint32_t AHBCLKCTRLSET[ 2 ]; /**< Set bits in AHBCLKCTRLn, array offset:
                                        0x220, array step: 0x4 */
    uint8_t RESERVED_11[ 24 ];
    __O uint32_t AHBCLKCTRLCLR[ 2 ]; /**< Clear bits in AHBCLKCTRLn, array
    ...
    __IO uint32_t FXCOMCLKSEL[ 8 ]; /**< Flexcomm0 clock source
                                       select..Flexcomm7 clock source select,
                                       array offset: 0x2B0, array step: 0x4 */
    ...
    __IO uint32_t RTCOSCCTRL; /**< RTC oscillator 32 kHz output control, offset:
                                 0x50C */
    ...
    __IO uint32_t SYSPLLSSCTRL0; /**< PLL spread spectrum control 0, offset:
                                    0x590 */
    __IO uint32_t SYSPLLSSCTRL1; /**< PLL spread spectrum control 1, offset:
                                    0x594 */
    uint8_t RESERVED_30[ 104 ];
    __IO uint32_t PDSLEEPCFG[ 2 ]; /**< Sleep configuration register n, array
                                      offset: 0x600, array step: 0x4 */
    uint8_t RESERVED_31[ 8 ];
    __IO uint32_t PDRUNCFG[ 1 ]; /**< Power configuration register 0, array
                                    offset: 0x610, array step: 0x4 */
    uint8_t RESERVED_32[ 12 ];
    __O uint32_t PDRUNCFGSET[ 1 ]; /**< Set bits in PDRUNCFGn, array offset:
                                      0x620, array step: 0x4 */
    uint8_t RESERVED_33[ 12 ];
    __O uint32_t PDRUNCFGCLR[ 1 ]; /**< Clear bits in PDRUNCFGn, array offset:
                                      0x630, array step: 0x4 */
    uint8_t RESERVED_34[ 76 ];
    __IO uint32_t STARTER[ 1 ]; /**< Start logic n wake-up enable register,
                                   array offset: 0x680, array step: 0x4 */
    uint8_t RESERVED_35[ 28 ];
    __O uint32_t STARTERSET[ 1 ]; /**< Set bits in STARTERn, array offset:
                                     0x6A0, array step: 0x4 */
    uint8_t RESERVED_36[ 28 ];
    __O uint32_t STARTERCLR[ 1 ]; /**< Clear bits in STARTERn, array offset:
                                     0x6C0, array step: 0x4 */
    uint8_t RESERVED_37[ 188 ];
    __IO uint32_t HWWAKE; /**< Configures special cases of hardware wake-up,
                             offset: 0x780 */
    ...
    __I uint32_t DEVICE_ID1; /**< Boot ROM and die revision register, offset:
                                0xFFC */
...
#define SYSCON_AHBMATPRIO_PRI_ICODE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBMATPRIO_PRI_DCODE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBMATPRIO_PRI_SYS( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_AHBMATPRIO_PRI_M0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
                       << SYSCON_AHBMATPRIO_PRI_M0_SHIFT ) ) & \
      SYSCON_AHBMATPRIO_PRI_M0_MASK )
#define SYSCON_AHBMATPRIO_PRI_USB_MASK  ( 0x300U )
#define SYSCON_AHBMATPRIO_PRI_USB_SHIFT ( 8U )
#define SYSCON_AHBMATPRIO_PRI_USB( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_AHBMATPRIO_PRI_USB_SHIFT ) ) & \
      SYSCON_AHBMATPRIO_PRI_USB_MASK )
#define SYSCON_AHBMATPRIO_PRI_DMA_MASK  ( 0xC00U )
#define SYSCON_AHBMATPRIO_PRI_DMA_SHIFT ( 10U )
#define SYSCON_AHBMATPRIO_PRI_DMA( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_SYSTCKCAL_SKEW( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_SYSTCKCAL_NOREF( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_NMISRC_IRQM0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << SYSCON_NMISRC_IRQM0_SHIFT ) ) & \
      SYSCON_NMISRC_IRQM0_MASK )
#define SYSCON_NMISRC_NMIENM0_MASK  ( 0x40000000U )
#define SYSCON_NMISRC_NMIENM0_SHIFT ( 30U )
#define SYSCON_NMISRC_NMIENM0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
                       << SYSCON_NMISRC_NMIENM0_SHIFT ) ) & \
      SYSCON_NMISRC_NMIENM0_MASK )
#define SYSCON_NMISRC_NMIENM4_MASK  ( 0x80000000U )
#define SYSCON_NMISRC_NMIENM4_SHIFT ( 31U )
#define SYSCON_NMISRC_NMIENM4( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 */
#define SYSCON_ASYNCAPBCTRL_ENABLE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PIOPORCAP_PIOPORCAP( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PIORESCAP_PIORESCAP( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_MRT0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
                       << SYSCON_PRESETCTRL_MRT0_RST_SHIFT ) ) & \
      SYSCON_PRESETCTRL_MRT0_RST_MASK )
#define SYSCON_PRESETCTRL_SCT0_RST_MASK  ( 0x4U )
#define SYSCON_PRESETCTRL_SCT0_RST_SHIFT ( 2U )
#define SYSCON_PRESETCTRL_SCT0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_FLASH_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_PRESETCTRL_FMC_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_UTICK0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
                       << SYSCON_PRESETCTRL_UTICK0_RST_SHIFT ) ) & \
      SYSCON_PRESETCTRL_UTICK0_RST_MASK )
#define SYSCON_PRESETCTRL_FC0_RST_MASK  ( 0x800U )
#define SYSCON_PRESETCTRL_FC0_RST_SHIFT ( 11U )
#define SYSCON_PRESETCTRL_FC0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_MUX_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_FC1_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_FC2_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_IOCON_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_PRESETCTRL_FC3_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_GPIO0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_PRESETCTRL_FC4_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_GPIO1_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_PRESETCTRL_FC5_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_FC6_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_FC7_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_PINT_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_GINT_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_DMA0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_CRC_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PRESETCTRL_WWDT_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_USB0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
                       << SYSCON_PRESETCTRL_USB0_RST_SHIFT ) ) & \
...
#define SYSCON_PRESETCTRL_CTIMER0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                       \
...
#define SYSCON_PRESETCTRL_ADC0_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PRESETCTRL_CTIMER1_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                       \
...
#define SYSCON_PRESETCTRLSET_RST_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
...
#define SYSCON_PRESETCTRLCLR_RST_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
 ...
 */
#define SYSCON_SYSRSTSTAT_POR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 */
#define SYSCON_SYSRSTSTAT_EXTRST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 */
#define SYSCON_SYSRSTSTAT_WDT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 */
#define SYSCON_SYSRSTSTAT_BOD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 */
#define SYSCON_SYSRSTSTAT_SYSRST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_AHBCLKCTRL_MRT0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
                       << SYSCON_AHBCLKCTRL_MRT0_SHIFT ) ) & \
      SYSCON_AHBCLKCTRL_MRT0_MASK )
#define SYSCON_AHBCLKCTRL_ROM_MASK  ( 0x2U )
#define SYSCON_AHBCLKCTRL_ROM_SHIFT ( 1U )
#define SYSCON_AHBCLKCTRL_ROM( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_AHBCLKCTRL_SCT0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_AHBCLKCTRL_FLASH( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_AHBCLKCTRL_FMC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_AHBCLKCTRL_UTICK0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
                       << SYSCON_AHBCLKCTRL_UTICK0_SHIFT ) ) & \
      SYSCON_AHBCLKCTRL_UTICK0_MASK )
#define SYSCON_AHBCLKCTRL_FLEXCOMM0_MASK  ( 0x800U )
#define SYSCON_AHBCLKCTRL_FLEXCOMM0_SHIFT ( 11U )
#define SYSCON_AHBCLKCTRL_FLEXCOMM0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_INPUTMUX( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM2( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_IOCON( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM3( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_GPIO0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM4( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_GPIO1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM5( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM6( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_FLEXCOMM7( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_AHBCLKCTRL_PINT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_AHBCLKCTRL_GINT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_AHBCLKCTRL_DMA0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
                       << SYSCON_AHBCLKCTRL_DMA0_SHIFT ) ) & \
      SYSCON_AHBCLKCTRL_DMA0_MASK )
#define SYSCON_AHBCLKCTRL_CRC_MASK  ( 0x200000U )
#define SYSCON_AHBCLKCTRL_CRC_SHIFT ( 21U )
#define SYSCON_AHBCLKCTRL_CRC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_AHBCLKCTRL_WWDT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_AHBCLKCTRL_RTC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_AHBCLKCTRL_USB0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
                       << SYSCON_AHBCLKCTRL_USB0_SHIFT ) ) & \
      SYSCON_AHBCLKCTRL_USB0_MASK )
#define SYSCON_AHBCLKCTRL_CTIMER0_MASK  ( 0x4000000U )
#define SYSCON_AHBCLKCTRL_CTIMER0_SHIFT ( 26U )
#define SYSCON_AHBCLKCTRL_CTIMER0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_AHBCLKCTRL_ADC0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_AHBCLKCTRL_CTIMER1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_AHBCLKCTRLSET_CLK_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
...
#define SYSCON_AHBCLKCTRLCLR_CLK_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
 ...
 */
#define SYSCON_MAINCLKSELA_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
/*! SEL - Clock source for main clock source selector B. Selects the clock
 * source for the main clock. 0b00..MAINCLKSELA. Use the clock source selected
 * in MAINCLKSELA register. 0b01..Reserved setting 0b10..System PLL output
 * (pll_clk) 0b11..RTC oscillator 32 kHz output (32k_clk)
 */
#define SYSCON_MAINCLKSELB_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
 ...
 *  0b111..None, this may be selected in order to reduce power when no output is
 * needed.
 */
#define SYSCON_CLKOUTSELA_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 * needed.
 */
#define SYSCON_SYSPLLCLKSEL_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
 ...
 * needed.
 */
#define SYSCON_USBCLKSEL_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )              \
                       << SYSCON_USBCLKSEL_SEL_SHIFT ) ) & \
      SYSCON_USBCLKSEL_SEL_MASK )
/*! @} */

/*! @name FXCOMCLKSEL - Flexcomm0 clock source select..Flexcomm7 clock source
 * select */
/*! @{ */
 ...
 * needed.
 */
#define SYSCON_FXCOMCLKSEL_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
                       << SYSCON_FXCOMCLKSEL_SEL_SHIFT ) ) & \
      SYSCON_FXCOMCLKSEL_SEL_MASK )
/*! @} */
...
/*! SEL - MCLK source select. This may be used by Flexcomms that support I2S,
 * and/or by the digital microphone subsystem. 0b000..FRO 96 or 48 MHz (fro_hf)
 *  0b001..System PLL output (pll_clk)
 *  0b010..Main clock (main_clk)
 *  0b111..None, this may be selected in order to reduce power when no output is
 * needed.
 */
#define SYSCON_MCLKCLKSEL_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_SYSTICKCLKDIV_DIV( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_USBCLKDIV_DIV( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )              \
                       << SYSCON_USBCLKDIV_DIV_SHIFT ) ) & \
      SYSCON_USBCLKDIV_DIV_MASK )
/*! @} */
...
/*! FETCHCFG - Instruction fetch configuration. This field determines how flash
 * accelerator buffers are used for instruction fetches. 0b00..Instruction
 * fetches from flash are not buffered. Every fetch request from the CPU results
 * in a read of the flash memory. This setting may use significantly more power
 * than when buffering is enabled. 0b01..One buffer is used for all instruction
 * fetches. 0b10..All buffers may be used for instruction fetches.
 *  0b11..Reserved setting, do not use.
 */
#define SYSCON_FLASHCFG_FETCHCFG( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
/*! DATACFG - Data read configuration. This field determines how flash
 * accelerator buffers are used for data accesses. 0b00..Data accesses from
 * flash are not buffered. Every data access from the CPU results in a read of
 * the flash memory. 0b01..One buffer is used for all data accesses. 0b10..All
 * buffers may be used for data accesses. 0b11..Reserved setting, do not use.
 */
#define SYSCON_FLASHCFG_DATACFG( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
 ...
 *  0b0..Flash acceleration is disabled. Every flash read (including those
 * fulfilled from a buffer) takes FLASHTIM + 1 system clocks. This allows more
 * determinism at a cost of performance. 0b1..Flash acceleration is enabled.
 * Performance is enhanced, dependent on other FLASHCFG settings.
 */
#define SYSCON_FLASHCFG_ACCEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
 ...
 *  0b1..If the FETCHCFG field is not 0, the next flash line following the
 * current execution address is automatically prefetched if it is not already
 * buffered.
 */
#define SYSCON_FLASHCFG_PREFEN( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
/*! PREFOVR - Prefetch override. This bit only applies when PREFEN = 1 and a
 * buffered instruction is completing for which the next flash line is not
 * already buffered or being prefetched. 0b0..Any previously initiated prefetch
 * will be completed. 0b1..Any previously initiated prefetch will be aborted,
 * and the next flash line following the current execution address will be
 * prefetched if not already buffered.
 */
#define SYSCON_FLASHCFG_PREFOVR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
/*! FLASHTIM - Flash memory access time. The number of system clocks used for
 * flash accesses is equal to FLASHTIM +1. 0b0000..1 system clock flash access
 * time (for system clock rates up to 12 MHz). 0b0001..2 system clocks flash
 * access time (for system clock rates up to 30 MHz). 0b0010..3 system clocks
 * flash access time (for system clock rates up to 60 MHz). 0b0011..4 system
 * clocks flash access time (for system clock rates up to 85 MHz). 0b0100..5
 * system clocks flash access time (for system clock rates up to 100 MHz).
 */
#define SYSCON_FLASHCFG_FLASHTIM( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 */
#define SYSCON_USBCLKCTRL_POL_CLK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_USBCLKCTRL_POL_CLK_SHIFT ) ) & \
      SYSCON_USBCLKCTRL_POL_CLK_MASK )
/*! @} */
 ...
 *  0b1..High
 */
#define SYSCON_USBCLKSTAT_NEED_CLKST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
                       << SYSCON_USBCLKSTAT_NEED_CLKST_SHIFT ) ) & \
      SYSCON_USBCLKSTAT_NEED_CLKST_MASK )
/*! @} */
...
#define SYSCON_FREQMECTRL_CAPVAL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_FREQMECTRL_PROG( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
 ...
 */
#define SYSCON_MCLKIO_DIR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << SYSCON_MCLKIO_DIR_SHIFT ) ) & \
...
/*! SEL - Select the fro_hf output frequency. This bit can only be changed by
 * software when the WRTRIM bit = 1. Note that the factory trim values are for
 * the 96 MHz FRO only. 0b0..48 MHz 0b1..96 MHz
 */
#define SYSCON_FROCTRL_SEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
...
#define SYSCON_FROCTRL_FREQTRIM( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
 ...
 *  0b1..Automatic USB rate adjustment mode. If the USB FS device peripheral is
 * enabled and connected to a USB host, it provides clock adjustment information
 * to the FRO based on SOF packets. USB rate adjustment requires a number of
 * cycles to take place. the USBMODCHG bit (see below) indicates when initial
 * adjustment is complete, and when later adjustments are in progress. software
 * must not alter TRIM and FREQTRIM while USBCLKADJ = 1. see USBCLKADJ usage
 * notes below this table.
 */
#define SYSCON_FROCTRL_USBCLKADJ( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_FROCTRL_USBMODCHG( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
/*! HSPDCLK - High speed clock enable. Allows disabling the highs-speed FRO
 * output if it is not needed. 0b0..The high-speed FRO output is disabled.
 *  0b1..The selected high-speed FRO output (48 MHz or 96 MHz) is enabled.
 */
#define SYSCON_FROCTRL_HSPDCLK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_FROCTRL_WRTRIM( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_WDTOSCCTRL_DIVSEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_WDTOSCCTRL_FREQSEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_SYSPLLCTRL_SELR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLCTRL_SELI( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLCTRL_SELP( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
 ...
 *  0b1..Bypass enabled. PLL input clock is sent directly to the PLL output
 * (default).
 */
#define SYSCON_SYSPLLCTRL_BYPASS( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 *  0b0..Divide by 2. The CCO feedback clock is divided by 2 in addition to the
 * programmed M divide. 0b1..Bypass. The CCO feedback clock is divided only by
 * the programmed M divide.
 */
#define SYSCON_SYSPLLCTRL_BYPASSCCODIV2( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                         \
                       << SYSCON_SYSPLLCTRL_BYPASSCCODIV2_SHIFT ) ) & \
      SYSCON_SYSPLLCTRL_BYPASSCCODIV2_MASK )
 ...
 */
#define SYSCON_SYSPLLCTRL_UPLIMOFF( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
/*! BANDSEL - PLL filter control. Set this bit to one when the spread spectrum
 * controller is disabled or at low frequencies. For spread spectrum mode:
 * SEL_EXT = 0, BANDSEL = 0, and UPLIMOFF = 1. 0b0..SSCG control. The PLL filter
 * uses the parameters derived from the spread spectrum controller. 0b1..MDEC
 * control. The PLL filter uses the programmable fields SELP, SELR, and SELI in
 * this register to control the filter constants.
 */
#define SYSCON_SYSPLLCTRL_BANDSEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_SYSPLLCTRL_BANDSEL_SHIFT ) ) & \
 ...
 *  0b0..Disabled. The PLL input divider (N divider) output is used to drive the
 * PLL CCO. 0b1..Enabled. The PLL input divider (N divider) is bypassed. the PLL
 * input clock is used directly to drive the PLL CCO input.
 */
#define SYSCON_SYSPLLCTRL_DIRECTI( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
 ...
 *  0b0..Disabled. The PLL output divider (P divider) is used to create the PLL
 * output. 0b1..Enabled. The PLL output divider (P divider) is bypassed, the PLL
 * CCO output is used as the PLL output.
 */
#define SYSCON_SYSPLLCTRL_DIRECTO( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_SYSPLLSTAT_LOCK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLNDEC_NDEC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLNDEC_NREQ( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLPDEC_PDEC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLPDEC_PREQ( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_SYSPLLSSCTRL0_MDEC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_SYSPLLSSCTRL0_MDEC_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL0_MDEC_MASK )
#define SYSCON_SYSPLLSSCTRL0_MREQ_MASK  ( 0x20000U )
#define SYSCON_SYSPLLSSCTRL0_MREQ_SHIFT ( 17U )
#define SYSCON_SYSPLLSSCTRL0_MREQ( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_SYSPLLSSCTRL0_MREQ_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL0_MREQ_MASK )
#define SYSCON_SYSPLLSSCTRL0_SEL_EXT_MASK  ( 0x40000U )
#define SYSCON_SYSPLLSSCTRL0_SEL_EXT_SHIFT ( 18U )
#define SYSCON_SYSPLLSSCTRL0_SEL_EXT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
                       << SYSCON_SYSPLLSSCTRL0_SEL_EXT_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL0_SEL_EXT_MASK )
/*! @} */
...
#define SYSCON_SYSPLLSSCTRL1_MD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
                       << SYSCON_SYSPLLSSCTRL1_MD_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_MD_MASK )
#define SYSCON_SYSPLLSSCTRL1_MDREQ_MASK  ( 0x80000U )
#define SYSCON_SYSPLLSSCTRL1_MDREQ_SHIFT ( 19U )
#define SYSCON_SYSPLLSSCTRL1_MDREQ( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
                       << SYSCON_SYSPLLSSCTRL1_MDREQ_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_MDREQ_MASK )
#define SYSCON_SYSPLLSSCTRL1_MF_MASK  ( 0x700000U )
#define SYSCON_SYSPLLSSCTRL1_MF_SHIFT ( 20U )
#define SYSCON_SYSPLLSSCTRL1_MF( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_SYSPLLSSCTRL1_MR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
                       << SYSCON_SYSPLLSSCTRL1_MR_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_MR_MASK )
#define SYSCON_SYSPLLSSCTRL1_MC_MASK  ( 0xC000000U )
#define SYSCON_SYSPLLSSCTRL1_MC_SHIFT ( 26U )
#define SYSCON_SYSPLLSSCTRL1_MC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
                       << SYSCON_SYSPLLSSCTRL1_MC_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_MC_MASK )
 ...
 */
#define SYSCON_SYSPLLSSCTRL1_PD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
                       << SYSCON_SYSPLLSSCTRL1_PD_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_PD_MASK )
 ...
 */
#define SYSCON_SYSPLLSSCTRL1_DITHER( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
                       << SYSCON_SYSPLLSSCTRL1_DITHER_SHIFT ) ) & \
      SYSCON_SYSPLLSSCTRL1_DITHER_MASK )
/*! @} */
...
#define SYSCON_PDSLEEPCFG_PD_SLEEP( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
                       << SYSCON_PDSLEEPCFG_PD_SLEEP_SHIFT ) ) & \
      SYSCON_PDSLEEPCFG_PD_SLEEP_MASK )
/*! @} */
...
#define SYSCON_PDRUNCFG_PDEN_FRO( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_PDRUNCFG_PDEN_TS( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_PDRUNCFG_PDEN_BOD_RST( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
...
#define SYSCON_PDRUNCFG_PDEN_BOD_INTR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                       \
...
#define SYSCON_PDRUNCFG_PDEN_ADC0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PDRUNCFG_PDEN_SRAM0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PDRUNCFG_PDEN_SRAMX( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PDRUNCFG_PDEN_ROM( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_PDRUNCFG_PDEN_VDDA( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_PDRUNCFG_PDEN_WDT_OSC( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
...
#define SYSCON_PDRUNCFG_PDEN_USB_PHY( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
                       << SYSCON_PDRUNCFG_PDEN_USB_PHY_SHIFT ) ) & \
...
#define SYSCON_PDRUNCFG_PDEN_SYS_PLL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                      \
...
#define SYSCON_PDRUNCFG_PDEN_VREFP( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                    \
...
#define SYSCON_PDRUNCFGSET_PD_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_PDRUNCFGSET_PD_SET_SHIFT ) ) & \
...
#define SYSCON_PDRUNCFGCLR_PD_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
                       << SYSCON_PDRUNCFGCLR_PD_CLR_SHIFT ) ) & \
      SYSCON_PDRUNCFGCLR_PD_CLR_MASK )
/*! @} */
...
#define SYSCON_STARTER_WDT_BOD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_STARTER_DMA0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << SYSCON_STARTER_DMA0_SHIFT ) ) & \
      SYSCON_STARTER_DMA0_MASK )
#define SYSCON_STARTER_GINT0_MASK  ( 0x4U )
#define SYSCON_STARTER_GINT0_SHIFT ( 2U )
#define SYSCON_STARTER_GINT0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )              \
...
#define SYSCON_STARTER_PIN_INT0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_STARTER_PIN_INT1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_STARTER_PIN_INT2( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_STARTER_UTICK0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
                       << SYSCON_STARTER_UTICK0_SHIFT ) ) & \
      SYSCON_STARTER_UTICK0_MASK )
#define SYSCON_STARTER_MRT0_MASK  ( 0x200U )
#define SYSCON_STARTER_MRT0_SHIFT ( 9U )
#define SYSCON_STARTER_MRT0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << SYSCON_STARTER_MRT0_SHIFT ) ) & \
      SYSCON_STARTER_MRT0_MASK )
#define SYSCON_STARTER_CTIMER0_MASK  ( 0x400U )
#define SYSCON_STARTER_CTIMER0_SHIFT ( 10U )
#define SYSCON_STARTER_CTIMER0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_STARTER_CTIMER1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_STARTER_CTIMER3( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                \
...
#define SYSCON_STARTER_FLEXCOMM0( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM1( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM2( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM4( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM5( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM6( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_FLEXCOMM7( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_STARTER_USB0_NEEDCLK( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_STARTERSET_START_SET( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_STARTERCLR_START_CLR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                     \
...
#define SYSCON_HWWAKE_FORCEWAKE( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
...
#define SYSCON_HWWAKE_WAKEDMA( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )               \
...
#define SYSCON_JTAGIDCODE_JTAGID( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_DEVICE_ID0_PARTID( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_DEVICE_ID1_REVID( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                 \
 ...
 *  0b11..Level 3: 2.3 V
 */
#define SYSCON_BODCTRL_BODRSTLEV( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 */
#define SYSCON_BODCTRL_BODRSTENA( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 *  0b11..Level 3: 3.05 V
 */
#define SYSCON_BODCTRL_BODINTLEV( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
 ...
 */
#define SYSCON_BODCTRL_BODINTENA( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                  \
...
#define SYSCON_BODCTRL_BODRSTSTAT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
#define SYSCON_BODCTRL_BODINTSTAT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )                   \
...
typedef struct
{
    __IO uint32_t CFG;  /**< USART Configuration register. Basic USART
                           configuration settings that typically are not changed
                           during operation., offset: 0x0 */
    __IO uint32_t CTL;  /**< USART Control register. USART control settings that
                           are more likely to change during operation., offset:
                           0x4 */
    __IO uint32_t STAT; /**< USART Status register. The complete status value
                           can be read here. Writing ones clears some bits in
                           the register. Some bits can be cleared by writing a 1
                           to them., offset: 0x8 */
    __IO uint32_t INTENSET; /**< Interrupt Enable read and Set register for
                               USART (not FIFO) status. Contains individual
                               interrupt enable bits for each potential USART
                               interrupt. A complete value may be read from this
                               register. Writing a 1 to any implemented bit
                               position causes that bit to be set., offset: 0xC
                             */
    __O uint32_t INTENCLR; /**< Interrupt Enable Clear register. Allows clearing
                              any combination of bits in the INTENSET register.
                              Writing a 1 to any implemented bit position causes
                              the corresponding bit to be cleared., offset: 0x10
                            */
    uint8_t RESERVED_0[ 12 ];
    __IO uint32_t BRG;    /**< Baud Rate Generator register. 16-bit integer baud
                             rate divisor value., offset: 0x20 */
    __I uint32_t INTSTAT; /**< Interrupt status register. Reflects interrupts
                             that are currently enabled., offset: 0x24 */
    __IO uint32_t OSR;    /**< Oversample selection register for asynchronous
                             communication., offset: 0x28 */
...
/*! @name CFG - USART Configuration register. Basic USART configuration settings
 * that typically are not changed during operation. */
/*! @{ */
#define USART_CFG_ENABLE_MASK  ( 0x1U )
#define USART_CFG_ENABLE_SHIFT ( 0U )
/*! ENABLE - USART Enable.
 *  0b0..Disabled. The USART is disabled and the internal state machine and
 * counters are reset. While Enable = 0, all USART interrupts and DMA transfers
 * are disabled. When Enable is set again, CFG and most other control bits
 * remain unchanged. When re-enabled, the USART will immediately be ready to
 * transmit because the transmitter has been reset and is therefore available.
 *  0b1..Enabled. The USART is enabled for operation.
 */
#define USART_CFG_ENABLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_ENABLE_SHIFT ) ) & \
 ...
 *  0b10..9 bit data length. The 9th bit is commonly used for addressing in
 * multidrop mode. See the ADDRDET bit in the CTL register. 0b11..Reserved.
 */
#define USART_CFG_DATALEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_DATALEN_SHIFT ) ) & \
 ...
 *  0b00..No parity.
 *  0b01..Reserved.
 *  0b10..Even parity. Adds a bit to each character such that the number of 1s
 * in a transmitted character is even, and the number of 1s in a received
 * character is expected to be even. 0b11..Odd parity. Adds a bit to each
 * character such that the number of 1s in a transmitted character is odd, and
 * the number of 1s in a received character is expected to be odd.
 */
#define USART_CFG_PARITYSEL( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
                       << USART_CFG_PARITYSEL_SHIFT ) ) & \
      USART_CFG_PARITYSEL_MASK )
#define USART_CFG_STOPLEN_MASK  ( 0x40U )
#define USART_CFG_STOPLEN_SHIFT ( 6U )
/*! STOPLEN - Number of stop bits appended to transmitted data. Only a single
 * stop bit is required for received data. 0b0..1 stop bit. 0b1..2 stop bits.
 * This setting should only be used for asynchronous communication.
 */
#define USART_CFG_STOPLEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_STOPLEN_SHIFT ) ) & \
 ...
 *  0b1..Enabled. USART uses the 32 kHz clock from the RTC oscillator as the
 * clock source to the BRG, and uses a special bit clocking scheme.
 */
#define USART_CFG_MODE32K( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_MODE32K_SHIFT ) ) & \
 ...
 */
#define USART_CFG_LINMODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_LINMODE_SHIFT ) ) & \
      USART_CFG_LINMODE_MASK )
#define USART_CFG_CTSEN_MASK  ( 0x200U )
#define USART_CFG_CTSEN_SHIFT ( 9U )
/*! CTSEN - CTS Enable. Determines whether CTS is used for flow control. CTS can
 * be from the input pin, or from the USART's own RTS if loopback mode is
 * enabled. 0b0..No flow control. The transmitter does not receive any automatic
 * flow control signal. 0b1..Flow control enabled. The transmitter uses the CTS
 * input (or RTS output in loopback mode) for flow control purposes.
 */
#define USART_CFG_CTSEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_CTSEN_SHIFT ) ) & \
 ...
 */
#define USART_CFG_SYNCEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_SYNCEN_SHIFT ) ) & \
      USART_CFG_SYNCEN_MASK )
#define USART_CFG_CLKPOL_MASK  ( 0x1000U )
#define USART_CFG_CLKPOL_SHIFT ( 12U )
/*! CLKPOL - Selects the clock polarity and sampling edge of received data in
 * synchronous mode. 0b0..Falling edge. Un_RXD is sampled on the falling edge of
 * SCLK. 0b1..Rising edge. Un_RXD is sampled on the rising edge of SCLK.
 */
#define USART_CFG_CLKPOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_CLKPOL_SHIFT ) ) & \
 ...
 */
#define USART_CFG_SYNCMST( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_SYNCMST_SHIFT ) ) & \
      USART_CFG_SYNCMST_MASK )
#define USART_CFG_LOOP_MASK  ( 0x8000U )
#define USART_CFG_LOOP_SHIFT ( 15U )
/*! LOOP - Selects data loopback mode.
 *  0b0..Normal operation.
 *  0b1..Loopback mode. This provides a mechanism to perform diagnostic loopback
 ...
 */
#define USART_CFG_LOOP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_LOOP_SHIFT ) ) & \
      USART_CFG_LOOP_MASK )
 ...
 *  0b0..Disabled. If selected by OESEL, the Output Enable signal deasserted at
 * the end of the last stop bit of a transmission. 0b1..Enabled. If selected by
 * OESEL, the Output Enable signal remains asserted for one character time after
 * the end of the last stop bit of a transmission. OE will also remain asserted
 * if another transmit begins before it is deasserted.
 */
#define USART_CFG_OETA( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_OETA_SHIFT ) ) & \
      USART_CFG_OETA_MASK )
#define USART_CFG_AUTOADDR_MASK  ( 0x80000U )
#define USART_CFG_AUTOADDR_SHIFT ( 19U )
/*! AUTOADDR - Automatic Address matching enable.
 *  0b0..Disabled. When addressing is enabled by ADDRDET, address matching is
 * done by software. This provides the possibility of versatile addressing (e.g.
 * respond to more than one address). 0b1..Enabled. When addressing is enabled
 * by ADDRDET, address matching is done by hardware, using the value in the ADDR
 * register as the address to match.
 */
#define USART_CFG_AUTOADDR( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
 ...
 *  0b1..RS-485. The RTS signal configured to provide an output enable signal to
 * control an RS-485 transceiver.
 */
#define USART_CFG_OESEL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_OESEL_SHIFT ) ) & \
 ...
 */
#define USART_CFG_OEPOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_OEPOL_SHIFT ) ) & \
      USART_CFG_OEPOL_MASK )
#define USART_CFG_RXPOL_MASK  ( 0x400000U )
#define USART_CFG_RXPOL_SHIFT ( 22U )
/*! RXPOL - Receive data polarity.
 *  0b0..Standard. The RX signal is used as it arrives from the pin. This means
 * that the RX rest value is 1, start bit is 0, data is not inverted, and the
 * stop bit is 1. 0b1..Inverted. The RX signal is inverted before being used by
 * the USART. This means that the RX rest value is 0, start bit is 1, data is
 * inverted, and the stop bit is 0.
 */
#define USART_CFG_RXPOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_RXPOL_SHIFT ) ) & \
      USART_CFG_RXPOL_MASK )
#define USART_CFG_TXPOL_MASK  ( 0x800000U )
#define USART_CFG_TXPOL_SHIFT ( 23U )
/*! TXPOL - Transmit data polarity.
 *  0b0..Standard. The TX signal is sent out without change. This means that the
 * TX rest value is 1, start bit is 0, data is not inverted, and the stop bit
 * is 1. 0b1..Inverted. The TX signal is inverted by the USART before being sent
 * out. This means that the TX rest value is 0, start bit is 1, data is
 * inverted, and the stop bit is 0.
 */
#define USART_CFG_TXPOL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CFG_TXPOL_SHIFT ) ) & \
      USART_CFG_TXPOL_MASK )
/*! @} */

/*! @name CTL - USART Control register. USART control settings that are more
 ...
 *  0b0..Normal operation.
 *  0b1..Continuous break. Continuous break is sent immediately when this bit is
 ...
 */
#define USART_CTL_TXBRKEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CTL_TXBRKEN_SHIFT ) ) & \
 ...
 *  0b1..Enabled. The USART receiver ignores incoming data that does not have
 * the most significant bit of the data (typically the 9th bit) = 1. When the
 * data MSB bit = 1, the receiver treats the incoming data normally, generating
 * a received data interrupt. Software can then check the data to see if this is
 ...
 */
#define USART_CTL_ADDRDET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CTL_ADDRDET_SHIFT ) ) & \
 ...
 *  0b1..Disabled. USART transmitter is disabled after any character currently
 * being transmitted is complete. This feature can be used to facilitate
 * software flow control.
 */
#define USART_CTL_TXDIS( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CTL_TXDIS_SHIFT ) ) & \
      USART_CTL_TXDIS_MASK )
#define USART_CTL_CC_MASK  ( 0x100U )
#define USART_CTL_CC_SHIFT ( 8U )
/*! CC - Continuous Clock generation. By default, SCLK is only output while data
 * is being transmitted in synchronous mode. 0b0..Clock on character. In
 * synchronous mode, SCLK cycles only when characters are being sent on Un_TXD
 * or to complete a character that is being received. 0b1..Continuous clock.
 * SCLK runs continuously in synchronous mode, allowing characters to be
 * received on Un_RxD independently from transmission on Un_TXD).
 */
#define USART_CTL_CC( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_CTL_CC_SHIFT ) ) & \
      USART_CTL_CC_MASK )
 ...
 *  0b1..Auto-clear. The CC bit is automatically cleared when a complete
 * character has been received. This bit is cleared at the same time.
 */
#define USART_CTL_CLRCCONRX( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
 ...
 *  0b1..Enabled. USART is in autobaud mode. This bit should only be set when
 * the USART receiver is idle. The first start bit of RX is measured and used
 * the update the BRG register to match the received data rate. AUTOBAUD is
 * cleared once this process is complete, or if there is an AERR.
 */
#define USART_CTL_AUTOBAUD( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << USART_CTL_AUTOBAUD_SHIFT ) ) & \
      USART_CTL_AUTOBAUD_MASK )
/*! @} */

/*! @name STAT - USART Status register. The complete status value can be read
 * here. Writing ones clears some bits in the register. Some bits can be cleared
 * by writing a 1 to them. */
/*! @{ */
#define USART_STAT_RXIDLE_MASK  ( 0x2U )
#define USART_STAT_RXIDLE_SHIFT ( 1U )
#define USART_STAT_RXIDLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_RXIDLE_SHIFT ) ) & \
      USART_STAT_RXIDLE_MASK )
#define USART_STAT_TXIDLE_MASK  ( 0x8U )
#define USART_STAT_TXIDLE_SHIFT ( 3U )
#define USART_STAT_TXIDLE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_TXIDLE_SHIFT ) ) & \
      USART_STAT_TXIDLE_MASK )
#define USART_STAT_CTS_MASK  ( 0x10U )
#define USART_STAT_CTS_SHIFT ( 4U )
#define USART_STAT_CTS( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_CTS_SHIFT ) ) & \
      USART_STAT_CTS_MASK )
#define USART_STAT_DELTACTS_MASK  ( 0x20U )
#define USART_STAT_DELTACTS_SHIFT ( 5U )
#define USART_STAT_DELTACTS( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )             \
...
#define USART_STAT_RXBRK( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_RXBRK_SHIFT ) ) & \
...
#define USART_STAT_START( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_START_SHIFT ) ) & \
...
#define USART_STAT_ABERR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_STAT_ABERR_SHIFT ) ) & \
      USART_STAT_ABERR_MASK )
/*! @} */

/*! @name INTENSET - Interrupt Enable read and Set register for USART (not FIFO)
 * status. Contains individual interrupt enable bits for each potential USART
 * interrupt. A complete value may be read from this register. Writing a 1 to
...
/*! @name INTENCLR - Interrupt Enable Clear register. Allows clearing any
 * combination of bits in the INTENSET register. Writing a 1 to any implemented
...
/*! @name BRG - Baud Rate Generator register. 16-bit integer baud rate divisor
 * value. */
/*! @{ */
#define USART_BRG_BRGVAL_MASK  ( 0xFFFFU )
#define USART_BRG_BRGVAL_SHIFT ( 0U )
#define USART_BRG_BRGVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_BRG_BRGVAL_SHIFT ) ) & \
      USART_BRG_BRGVAL_MASK )
/*! @} */

/*! @name INTSTAT - Interrupt status register. Reflects interrupts that are
 * currently enabled. */
/*! @{ */
...
#define USART_OSR_OSRVAL( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USART_OSR_OSRVAL_SHIFT ) ) & \
...
#define USART_BASE_ADDRS                                                 \
    {                                                                    \
        USART0_BASE, USART1_BASE, USART2_BASE, USART3_BASE, USART4_BASE, \
            USART5_BASE, USART6_BASE, USART7_BASE                        \
    }
/** Array initializer of USART peripheral base pointers */
#define USART_BASE_PTRS                                                \
    {                                                                  \
        USART0, USART1, USART2, USART3, USART4, USART5, USART6, USART7 \
    }
...
typedef struct
{
    __IO uint32_t DEVCMDSTAT;   /**< USB Device Command/Status register, offset:
                                   0x0 */
    ...
    __IO uint32_t INTSETSTAT; /**< USB set interrupt status register, offset:
                                 0x28 */
    uint8_t RESERVED_0[ 8 ];
...
#define USB_INFO_FRAME_NR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_INFO_FRAME_NR_SHIFT ) ) & \
 ...
 */
#define USB_INFO_ERR_CODE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_INFO_ERR_CODE_SHIFT ) ) & \
...
#define USB_LPM_HIRD_HW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_LPM_HIRD_HW_SHIFT ) ) & \
      USB_LPM_HIRD_HW_MASK )
#define USB_LPM_HIRD_SW_MASK  ( 0xF0U )
#define USB_LPM_HIRD_SW_SHIFT ( 4U )
#define USB_LPM_HIRD_SW( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_LPM_HIRD_SW_SHIFT ) ) & \
...
#define USB_EPSKIP_SKIP( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_EPSKIP_SKIP_SHIFT ) ) & \
...
#define USB_EPINUSE_BUF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << USB_EPINUSE_BUF_SHIFT ) ) & \
...
typedef struct
{
    ...
    __I uint32_t CAP[ 4 ]; /**< Capture register ., array offset: 0x10, array
                              step: 0x4 */
} UTICK_Type;
...
#define UTICK_CTRL_REPEAT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << UTICK_CTRL_REPEAT_SHIFT ) ) & \
...
#define UTICK_STAT_INTR( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << UTICK_STAT_INTR_SHIFT ) ) & \
      UTICK_STAT_INTR_MASK )
#define UTICK_STAT_ACTIVE_MASK  ( 0x2U )
#define UTICK_STAT_ACTIVE_SHIFT ( 1U )
#define UTICK_STAT_ACTIVE( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << UTICK_STAT_ACTIVE_SHIFT ) ) & \
...
typedef struct
{
    __IO uint32_t MOD; /**< Watchdog mode register. This register contains the
                          basic mode and status of the Watchdog Timer., offset:
                          0x0 */
    __IO uint32_t TC;  /**< Watchdog timer constant register. This 24-bit
                          register determines the time-out value., offset: 0x4 */
    __O uint32_t FEED; /**< Watchdog feed sequence register. Writing 0xAA
                          followed by 0x55 to this register reloads the Watchdog
                          timer with the value contained in TC., offset: 0x8 */
    __I uint32_t TV;   /**< Watchdog timer value register. This 24-bit register
...
/*! @name MOD - Watchdog mode register. This register contains the basic mode
 * and status of the Watchdog Timer. */
/*! @{ */
#define WWDT_MOD_WDEN_MASK  ( 0x1U )
#define WWDT_MOD_WDEN_SHIFT ( 0U )
/*! WDEN - Watchdog enable bit. Once this bit is set to one and a watchdog feed
 * is performed, the watchdog timer will run permanently. 0b0..Stop. The
 * watchdog timer is stopped. 0b1..Run. The watchdog timer is running.
 */
#define WWDT_MOD_WDEN( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_MOD_WDEN_SHIFT ) ) & \
      WWDT_MOD_WDEN_MASK )
#define WWDT_MOD_WDRESET_MASK  ( 0x2U )
#define WWDT_MOD_WDRESET_SHIFT ( 1U )
/*! WDRESET - Watchdog reset enable bit. Once this bit has been written with a 1
 * it cannot be re-written with a 0. 0b0..Interrupt. A watchdog time-out will
 * not cause a chip reset. 0b1..Reset. A watchdog time-out will cause a chip
 * reset.
 */
#define WWDT_MOD_WDRESET( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_MOD_WDRESET_SHIFT ) ) & \
      WWDT_MOD_WDRESET_MASK )
#define WWDT_MOD_WDTOF_MASK  ( 0x4U )
#define WWDT_MOD_WDTOF_SHIFT ( 2U )
#define WWDT_MOD_WDTOF( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_MOD_WDTOF_SHIFT ) ) & \
      WWDT_MOD_WDTOF_MASK )
#define WWDT_MOD_WDINT_MASK  ( 0x8U )
#define WWDT_MOD_WDINT_SHIFT ( 3U )
#define WWDT_MOD_WDINT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_MOD_WDINT_SHIFT ) ) & \
      WWDT_MOD_WDINT_MASK )
#define WWDT_MOD_WDPROTECT_MASK  ( 0x10U )
#define WWDT_MOD_WDPROTECT_SHIFT ( 4U )
/*! WDPROTECT - Watchdog update mode. This bit can be set once by software and
 * is only cleared by a reset. 0b0..Flexible. The watchdog time-out value (TC)
 * can be changed at any time. 0b1..Threshold. The watchdog time-out value (TC)
 * can be changed only after the counter is below the value of WDWARNINT and
 * WDWINDOW.
 */
#define WWDT_MOD_WDPROTECT( x )                          \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) )            \
                       << WWDT_MOD_WDPROTECT_SHIFT ) ) & \
      WWDT_MOD_WDPROTECT_MASK )
#define WWDT_MOD_LOCK_MASK  ( 0x20U )
#define WWDT_MOD_LOCK_SHIFT ( 5U )
#define WWDT_MOD_LOCK( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_MOD_LOCK_SHIFT ) ) & \
      WWDT_MOD_LOCK_MASK )
/*! @} */

/*! @name TC - Watchdog timer constant register. This 24-bit register determines
 * the time-out value. */
/*! @{ */
#define WWDT_TC_COUNT_MASK  ( 0xFFFFFFU )
#define WWDT_TC_COUNT_SHIFT ( 0U )
#define WWDT_TC_COUNT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_TC_COUNT_SHIFT ) ) & \
      WWDT_TC_COUNT_MASK )
/*! @} */

/*! @name FEED - Watchdog feed sequence register. Writing 0xAA followed by 0x55
 * to this register reloads the Watchdog timer with the value contained in TC.
 */
/*! @{ */
#define WWDT_FEED_FEED_MASK  ( 0xFFU )
#define WWDT_FEED_FEED_SHIFT ( 0U )
#define WWDT_FEED_FEED( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_FEED_FEED_SHIFT ) ) & \
      WWDT_FEED_FEED_MASK )
/*! @} */

/*! @name TV - Watchdog timer value register. This 24-bit register reads out the
 * current value of the Watchdog timer. */
/*! @{ */
#define WWDT_TV_COUNT_MASK  ( 0xFFFFFFU )
#define WWDT_TV_COUNT_SHIFT ( 0U )
#define WWDT_TV_COUNT( x )                                                 \
    ( ( ( uint32_t ) ( ( ( uint32_t ) ( x ) ) << WWDT_TV_COUNT_SHIFT ) ) & \
      WWDT_TV_COUNT_MASK )
/*! @} */
...
#define WWDT_BASE_ADDRS \
    {                   \
        WWDT_BASE       \
    }
/** Array initializer of WWDT peripheral base pointers */
#define WWDT_BASE_PTRS \
    {                  \
        WWDT           \
    }
