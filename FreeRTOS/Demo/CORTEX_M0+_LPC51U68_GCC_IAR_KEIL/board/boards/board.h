...
#define LED_RED_TOGGLE()                                                  \
    GPIO_PortToggle( BOARD_LED_RED_GPIO,                                  \
                     BOARD_LED_RED_GPIO_PORT,                             \
                     1U << BOARD_LED_RED_GPIO_PIN ) /*!< Toggle on target \
                                                       LED_RED */
    ...
    GPIO_PinInit( BOARD_LED_GREEN_GPIO,                                      \
                  ...
                  &( gpio_pin_config_t ) { kGPIO_DigitalOutput,              \
                                           ( output ) } ) /*!< Enable target \
                                                             LED_GREEN */
#define LED_GREEN_ON()                                                   \
    GPIO_PortClear( BOARD_LED_GREEN_GPIO,                                \
                    BOARD_LED_GREEN_GPIO_PORT,                           \
                    1U << BOARD_LED_GREEN_GPIO_PIN ) /*!< Turn on target \
                                                        LED_GREEN */
#define LED_GREEN_OFF()                                                 \
    GPIO_PortSet( BOARD_LED_GREEN_GPIO,                                 \
                  BOARD_LED_GREEN_GPIO_PORT,                            \
                  1U << BOARD_LED_GREEN_GPIO_PIN ) /*!< Turn off target \
                                                      LED_GREEN */
#define LED_GREEN_TOGGLE()                                                  \
    GPIO_PortToggle( BOARD_LED_GREEN_GPIO,                                  \
                     BOARD_LED_GREEN_GPIO_PORT,                             \
                     1U << BOARD_LED_GREEN_GPIO_PIN ) /*!< Toggle on target \
                                                         LED_GREEN */
    ...
    GPIO_PinInit( BOARD_LED_BLUE_GPIO,                                       \
                  ...
                  &( gpio_pin_config_t ) { kGPIO_DigitalOutput,              \
                                           ( output ) } ) /*!< Enable target \
                                                             LED_BLUE */
#define LED_BLUE_ON()                                                   \
    GPIO_PortClear( BOARD_LED_BLUE_GPIO,                                \
                    BOARD_LED_BLUE_GPIO_PORT,                           \
                    1U << BOARD_LED_BLUE_GPIO_PIN ) /*!< Turn on target \
                                                       LED_BLUE */
#define LED_BLUE_OFF()                                                 \
    GPIO_PortSet( BOARD_LED_BLUE_GPIO,                                 \
                  BOARD_LED_BLUE_GPIO_PORT,                            \
                  1U << BOARD_LED_BLUE_GPIO_PIN ) /*!< Turn off target \
                                                     LED_BLUE */
#define LED_BLUE_TOGGLE()                                                  \
    GPIO_PortToggle( BOARD_LED_BLUE_GPIO,                                  \
                     BOARD_LED_BLUE_GPIO_PORT,                             \
                     1U << BOARD_LED_BLUE_GPIO_PIN ) /*!< Toggle on target \
                                                        LED_BLUE */
