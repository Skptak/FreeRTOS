 ...
 */
__inline__ void _metal_clock_call_all_callbacks(
    const metal_clock_callback * const list )
{
 ...
 */
__inline__ void metal_clock_register_pre_rate_change_callback(
    struct metal_clock * clk,
    metal_clock_callback * cb )
{
    clk->_pre_rate_change_callback = _metal_clock_append_to_callbacks(
...
__inline__ void metal_clock_register_post_rate_change_callback(
    ...
    metal_clock_callback * cb )
{
    clk->_post_rate_change_callback = _metal_clock_append_to_callbacks(
