...
struct metal_interrupt_vtable
{
    ...
    int ( *interrupt_vector_disable )( struct metal_interrupt * controller,
                                       int id );
    unsigned int ( *interrupt_get_threshold )(
        struct metal_interrupt * controller );
    int ( *interrupt_set_threshold )( struct metal_interrupt * controller,
                                      unsigned int threshold );
    unsigned int ( *interrupt_get_priority )(
        struct metal_interrupt * controller,
        int id );
 ...
 */
struct metal_interrupt * metal_interrupt_get_controller(
    metal_intr_cntrl_type cntrl,
    int id );
 ...
 */
__inline__ int metal_interrupt_set_vector_mode(
    struct metal_interrupt * controller,
    metal_vector_mode mode )
{
 ...
 */
__inline__ metal_vector_mode metal_interrupt_get_vector_mode(
    struct metal_interrupt * controller )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_set_privilege(
    struct metal_interrupt * controller,
 ...
 */
__inline__ metal_intr_priv_mode metal_interrupt_get_privilege(
    struct metal_interrupt * controller )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_register_handler(
    struct metal_interrupt * controller,
    int id,
    metal_interrupt_handler_t handler,
    void * priv_data )
{
    return controller->vtable->interrupt_register( controller,
                                                   id,
                                                   handler,
                                                   priv_data );
}
...
__inline__ int metal_interrupt_register_vector_handler(
    ...
    void * priv_data )
{
    return controller->vtable->interrupt_vector_register( controller,
                                                          id,
                                                          handler,
                                                          priv_data );
}
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_set_threshold(
    struct metal_interrupt * controller,
    unsigned int level )
{
 ...
 */
__inline__ unsigned int metal_interrupt_get_threshold(
    struct metal_interrupt * controller )
{
...
__inline__ int metal_interrupt_set_priority( struct metal_interrupt * controller,
                                             ...
                                             unsigned int priority )
{
    return controller->vtable->interrupt_set_priority( controller,
                                                       id,
                                                       priority );
}
 ...
 */
__inline__ unsigned int metal_interrupt_get_priority(
    struct metal_interrupt * controller,
    int id )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_set_preemptive_level(
    struct metal_interrupt * controller,
    int id,
    unsigned int level )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_vector_enable(
    struct metal_interrupt * controller,
    int id )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_interrupt_vector_disable(
    struct metal_interrupt * controller,
    int id )
{
...
metal_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc0_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc1_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc2_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc3_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc4_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc5_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc6_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc7_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc8_interrupt_vector_handler( void );
 ...
 */
void __attribute__( ( weak, interrupt ) )
metal_lc9_interrupt_vector_handler( void );
 ...
 */
__inline__ metal_affinity metal_interrupt_affinity_enable(
    struct metal_interrupt * controller,
    metal_affinity bitmask,
    int id )
{
    return controller->vtable->interrupt_affinity_enable( controller,
                                                          bitmask,
                                                          id );
}
 ...
 * @return The result of each hart context. 0 upon success at relevant bit.
 */
__inline__ metal_affinity metal_interrupt_affinity_disable(
    struct metal_interrupt * controller,
    metal_affinity bitmask,
    int id )
{
    return controller->vtable->interrupt_affinity_disable( controller,
                                                           bitmask,
                                                           id );
}
 ...
 * @return The interrupt threshold level
 */
__inline__ unsigned int metal_interrupt_affinity_get_threshold(
    struct metal_interrupt * controller,
    int context_id )
{
