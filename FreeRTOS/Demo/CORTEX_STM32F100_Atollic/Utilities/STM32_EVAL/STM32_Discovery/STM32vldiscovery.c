 ...
 *          This file should be added to the main application to use the
 *provided functions that manage the Leds LD3 and LD4 and the USER push-button.
 ******************************************************************************
 * @copy
 *
                              ...
                              ButtonMode_TypeDef Button_Mode )
{
    ...
    RCC_APB2PeriphClockCmd( BUTTON_CLK[ Button ] | RCC_APB2Periph_AFIO,
                            ENABLE );
