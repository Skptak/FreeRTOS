...
extern "C" {
    ...
    #define __CM3_CMSIS_VERSION_MAIN \
        ( 0x01 ) /*!< [31:16] CMSIS HAL main version */
    ...
    #include <stdint.h> /* Include standard types */
        ...
        #define __NVIC_PRIO_BITS \
            4 /*!< standard definition for NVIC Priority Bits */
    #endif
...
typedef struct
{
    ...
    __IO uint32_t ICPR[ 8 ]; /*!< Offset: 0x180  Interrupt Clear Pending
                                Register        */
    uint32_t RESERVED3[ 24 ];
    __IO uint32_t IABR[ 8 ]; /*!< Offset: 0x200  Interrupt Active bit Register
                              */
    uint32_t RESERVED4[ 56 ];
    __IO uint8_t IP[ 240 ]; /*!< Offset: 0x300  Interrupt Priority Register
                               (8Bit wide) */
...
typedef struct
{
    ...
    __IO uint8_t SHP[ 12 ]; /*!< Offset: 0x18  System Handlers Priority
                               Registers (4-7, 8-11, 12-15) */
    __IO uint32_t SHCSR;    /*!< Offset: 0x24  System Handler Control and State
                               Register             */
    ...
    #define SCB_AIRCR_VECTKEYSTAT_Msk                                         \
        ( 0xFFFFul << SCB_AIRCR_VECTKEYSTAT_Pos ) /*!< SCB AIRCR: VECTKEYSTAT \
                                                     Mask */
...
typedef struct
{
    ...
    #define SysTick_CALIB_TENMS_Msk                                         \
        ( 0xFFFFFFul << SysTick_VAL_CURRENT_Pos ) /*!< SysTick CALIB: TENMS \
                                                     Mask */
...
typedef struct
{
    ...
    __I uint32_t PID4; /*!< Offset:       ITM Peripheral Identification Register
                          #4 */
    __I uint32_t PID5; /*!< Offset:       ITM Peripheral Identification Register
                          #5 */
    __I uint32_t PID6; /*!< Offset:       ITM Peripheral Identification Register
                          #6 */
    __I uint32_t PID7; /*!< Offset:       ITM Peripheral Identification Register
                          #7 */
    __I uint32_t PID0; /*!< Offset:       ITM Peripheral Identification Register
                          #0 */
    __I uint32_t PID1; /*!< Offset:       ITM Peripheral Identification Register
                          #1 */
    __I uint32_t PID2; /*!< Offset:       ITM Peripheral Identification Register
                          #2 */
    __I uint32_t PID3; /*!< Offset:       ITM Peripheral Identification Register
                          #3 */
    __I uint32_t CID0; /*!< Offset:       ITM Component  Identification Register
                          #0 */
    __I uint32_t CID1; /*!< Offset:       ITM Component  Identification Register
                          #1 */
    __I uint32_t CID2; /*!< Offset:       ITM Component  Identification Register
                          #2 */
    __I uint32_t CID3; /*!< Offset:       ITM Component  Identification Register
                          #3 */
} ITM_Type;
...
typedef struct
{
    ...
    #define InterruptType_ICTR_INTLINESNUM_Msk                                \
        ( 0x1Ful << InterruptType_ICTR_INTLINESNUM_Pos ) /*!< InterruptType   \
                                                            ICTR: INTLINESNUM \
                                                            Mask */
    ...
    #define InterruptType_ACTLR_DISFOLD_Msk                                  \
        ( 1ul << InterruptType_ACTLR_DISFOLD_Pos ) /*!< InterruptType ACTLR: \
                                                      DISFOLD Mask */
    ...
    #define InterruptType_ACTLR_DISDEFWBUF_Msk                             \
        ( 1ul << InterruptType_ACTLR_DISDEFWBUF_Pos ) /*!< InterruptType   \
                                                         ACTLR: DISDEFWBUF \
                                                         Mask */
    ...
    #define InterruptType_ACTLR_DISMCYCINT_Msk                             \
        ( 1ul << InterruptType_ACTLR_DISMCYCINT_Pos ) /*!< InterruptType   \
                                                         ACTLR: DISMCYCINT \
                                                         Mask */
...
typedef struct
{
    ...
    __IO uint32_t RASR; /*!< Offset: 0x10  MPU Region Attribute and Size
                           Register         */
    __IO uint32_t RBAR_A1; /*!< Offset: 0x14  MPU Alias 1 Region Base Address
                              Register       */
    __IO uint32_t RASR_A1; /*!< Offset: 0x18  MPU Alias 1 Region Attribute and
                              Size Register */
    __IO uint32_t RBAR_A2; /*!< Offset: 0x1C  MPU Alias 2 Region Base Address
                              Register       */
    __IO uint32_t RASR_A2; /*!< Offset: 0x20  MPU Alias 2 Region Attribute and
                              Size Register */
    __IO uint32_t RBAR_A3; /*!< Offset: 0x24  MPU Alias 3 Region Base Address
                              Register       */
    __IO uint32_t RASR_A3; /*!< Offset: 0x28  MPU Alias 3 Region Attribute and
        ...
        #define MPU_RASR_ENA_Msk                                            \
            ( 0x1Ful << MPU_RASR_ENA_Pos ) /*!< MPU RASR: Region enable bit \
                                              Disable Mask */
...
typedef struct
{
    __IO uint32_t DHCSR; /*!< Offset: 0x00  Debug Halting Control and Status
                            Register    */
    ...
    #define NVIC_BASE \
        ( SCS_BASE + 0x0100 ) /*!< NVIC Base Address                 */
    #define SCB_BASE \
        ( SCS_BASE + 0x0D00 ) /*!< System Control Block Base Address */
...
static __INLINE void __disable_fault_irq()
{
    __ASM( "cpsid f" );
        ...
        #define __NOP \
            __no_operation /*!< no operation intrinsic in IAR Compiler */
