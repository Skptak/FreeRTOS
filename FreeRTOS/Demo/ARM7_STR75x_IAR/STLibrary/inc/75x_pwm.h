...
typedef struct
{
    ...
    u16 PWM_CounterMode;   /* Counter mode: Up/Down, Edge aligned or center
                              aligned */
    ...
    u16 PWM_DTRAccess;  /* Enable or disable the configuration of DTR register
                         parameters:  DeadTime, Emergency, LOCKLevel, OSSIState,
                         OCState and OCNState */
