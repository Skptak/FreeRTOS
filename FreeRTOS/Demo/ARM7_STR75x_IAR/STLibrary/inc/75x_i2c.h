...
typedef struct
{
    ...
    #define I2C_EVENT_SLAVE_ADDRESS_MATCHED \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_ADSL )
    #define I2C_EVENT_SLAVE_BYTE_RECEIVED \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_BTF )
    #define I2C_EVENT_SLAVE_BYTE_TRANSMITTED \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_BTF | I2C_FLAG_TRA )
    #define I2C_EVENT_MASTER_MODE_SELECT \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_M_SL | I2C_FLAG_SB )
    #define I2C_EVENT_MASTER_MODE_SELECTED \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_M_SL | I2C_FLAG_ENDAD )
    #define I2C_EVENT_MASTER_BYTE_RECEIVED \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_M_SL | I2C_FLAG_BTF )
    #define I2C_EVENT_MASTER_BYTE_TRANSMITTED                           \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_M_SL | I2C_FLAG_BTF | \
          I2C_FLAG_TRA )
    #define I2C_EVENT_MASTER_MODE_ADDRESS10 \
        ( I2C_FLAG_EVF | I2C_FLAG_BUSY | I2C_FLAG_M_SL | I2C_FLAG_ADD10 )
