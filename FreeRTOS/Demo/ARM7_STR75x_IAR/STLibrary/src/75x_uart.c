...
#define UART_HardwareFlowControl_Mask \
    0x3FFF                              /* UART Hardware Flow Control Mask */
 ...
 * Description    : Deinitializes the UARTx peripheral registers to their
 *default reset values. Input          : UARTx: where x can be 0,1 or 2 to
 *select the UART peripheral. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - UARTx: where x can be 0,1or 2 to select the UART
 *peripheral.
...
void UART_Init( UART_TypeDef * UARTx, UART_InitTypeDef * UART_InitStruct )
{
    ...
    IntegerDivider = ( ( 100 ) * ( APBClock ) /
                       ( 16 * ( UART_InitStruct->UART_BaudRate ) ) );
 ...
 * Input          : - UARTx: where x can be 0,1 or 2 to select the UART
 *peripheral
...
void UART_Cmd( UART_TypeDef * UARTx, FunctionalState NewState )
{
    ...
    {
        /* Disable the selected UART by clearing the UARTEN bit in the CR
         * register */
 ...
 * Input          : - UART0_DMAtransfer : specifies the configuration of DMA
 *request. This parameter can be:
 ...
 *                         - UART0_DMAOnError_Enable: DMA receive request
 *enabled when the UART error interrupt is asserted.
 *                         - UART0_DMAOnError_Disable: DMA receive request
 *disabled when the UART error interrupt is asserted. Output         : None
 * Return         : None
 *******************************************************************************/
 ...
 * Description    : Transmits a signle Byte of data through the UARTx
 *peripheral. Input          : - UARTx: where x can be 0,1 or 2 to select the
 *UART peripheral.
 ...
 * Description    : Returns the most recent received Byte by the UARTx
 *peripheral. Input          : UARTx: where x can be 0,1 or 2 to select the UART
 *peripheral. Output         : None Return         : The received data
 *******************************************************************************/
 ...
 *                     - UART_RawIT_ReceiveTimeOut: ReceiveTimeOut interrupt
 *flag
 ...
 * Description    : Checks whether the specified UART interrupt has occurred or
 *not. Input          : - UARTx: where x can be 0,1or 2 to select the UART
 *peripheral.
 ...
 *                    More than one interrupt can be cleared using the “|”
 *operator. This parameter can be:
 *                       - UART_IT_OverrunError: Overrun Error interrupt
 *                       - UART_IT_BreakError: Break Error interrupt
 *                       - UART_IT_ParityError: Parity Error interrupt
 *                       - UART_IT_FrameError: Frame Error interrupt
