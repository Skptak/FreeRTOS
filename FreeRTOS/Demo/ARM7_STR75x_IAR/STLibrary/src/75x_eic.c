 ...
 * Input          : EIC_IRQInitStruct: pointer to a EIC_IRQInitTypeDef
...
void EIC_IRQInit( EIC_IRQInitTypeDef * EIC_IRQInitStruct )
{
    ...
    if( EIC_IRQInitStruct->EIC_IRQChannelCmd == ENABLE )
    {
        ...
        /* Configure SIPL[3:0] bits according to EIC_IRQChannelPriority
         * parameter */
 ...
 * Input          : EIC_FIQInitStruct: pointer to a EIC_FIQInitTypeDef
 *structure. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Returns the priority level of the current served IRQ
 *channel. Input          : None Output         : None Return         : The
 *priority level of the current served IRQ channel.
 *******************************************************************************/
