 ...
 * Description    : Deinitializes the GPIOx peripheral registers to their
 *default reset values. The I/O remapping register 0 and 1 are not reset by this
 *function. Input          : GPIOx: where x can be 0,1 or 2 to select the GPIO
 ...
 *                  bit is set, except pins configured as input pull-up or
 *pull-down. These pins are automatically masked after each configuration. Input
 *:- GPIOx: where x can be (0..2) to select the GPIO peripheral.
 ...
 *peripheral. Output         : None Return         : GPIO data port word value.
 *******************************************************************************/
 ...
 * Input          : - GPIOx: where x can be (0..2) to select the GPIO
 *peripheral. : - GPIO_Pin:  specifies the port bit to read. This parameter can
 *be GPIO_Pin_x where x can be (0..31) for GPIO0 and x(0..19) for GPIO1 and
 *GPIO2. Output         : None Return         : The port pin value
 *******************************************************************************/
 ...
 *for GPIO0 and x(0..19) for GPIO1 and GPIO2.
 *                  - BitVal: specifies the value to be written to the selected
 *bit. This parameter must be one of the BitAction enum values:
 ...
 * Input          : GPIOx: where x can be 0,1 or 2 to select the GPIO
 *peripheral. Output         : None Return         : GPIO port mask value.
 *******************************************************************************/
