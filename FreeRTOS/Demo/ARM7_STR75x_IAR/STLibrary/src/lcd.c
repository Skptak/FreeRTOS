 ...
 * Description        : This file includes the LCD driver for GXM12232-2SL
 *liquid Crystal Display Module of STR75x-EVAL.
 ********************************************************************************
 * History:
 * 07/17/2006 : V1.0
 * 03/10/2006 : V0.1
 ...
 * Description    : Configure data lines D0~D7 (P2.10~P2.17) in Input Floating
 *mode for read from LCD or in Output Push-Pull mode for write on LCD Input : -
 *Mode: specifies the configuration mode for data lines D0~D7
 ...
 * Input          : - GPIOx: where x can be 0,1 or 2 to select the GPIO
 *peripheral.
 ...
 * Description    : Set the display page of master LCD, the page range is 0 to
 *3, make sure the input will not exceed this range ,otherwise it will reach a
 *undecided result. Input          : - Page: specifies the expected display page
 *of master LCD Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Set the display column of slave LCD. Column range is 0
 *to 61. Input          : - Address: specifies the expected display column of
 *slave LCD Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Set the display column of master LCD. Column range is 0
 *to 61. Input          : - Address: specifies the expected display column of
 *slave LCD Output         : None Return         : None
 *******************************************************************************/
...
void LCD_Clear( void )
{
    ...
    for( Page = 0; Page < 4; Page++ )
    {
        ...
        /* Send empty data to master and slave column address on the selected
         * page */
...
void LCD_DisplayString( u8 Line, u8 * ptr, TextColorMode_TypeDef CharMode )
{
    ...
    while( ( *ptr != 0 ) & ( i < 17 ) )
    {
        ...
        if( i == 17 )
        {
            LCD_DisplayChar( Line,
                             RefColumn - 1,
                             0x1f,
                             CharMode ); /* Add missed columns */
        }
    }
}
