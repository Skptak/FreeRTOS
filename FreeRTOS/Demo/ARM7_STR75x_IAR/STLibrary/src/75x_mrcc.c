 ...
 *                  reset values.
 *                   - Depending on the system clock state, some bits in
 *MRCC_CLKCTL register can’t be reset.
 *                   - The OSC32K, LPOSC and RTC clock selection configuration
 *                     bits in MRCC_PWRCTRL register are not cleared by this
 *                     function. To reset those bits, use the dedicated
 *functions available within this driver.
...
void MRCC_DeInit( void )
{
    ...
    { /* No clock detected on OSC4M */
        ...
        /* Reset LOCKIE, LOCKIF, CKUSBSEL, NCKDIE, OSC4MOFF, OSC4MBYP,
           MCOS[1:0], MCOP, HPRESC[1:0], PPRES[2:0] bits */
    ...
    /* Reset RTCM, EN33V, LP_PARAM[15:13], WFI_FLASH_EN, LPMC_DBG and LPMC[1:0]
     * bits */
 ...
 * Description    : Enables or disables the oscillator divider by 2. This
 *function must not be used when the PLL is enabled. Input          : -
 *MRCC_XTDIV2: specifies the new state of the oscillator divider by 2. This
 *parameter can be one of the following values:
 *                          - MRCC_XTDIV2_Disable: oscillator divider by 2
 *disbaled
 *                          - MRCC_XTDIV2_Enable: oscillator divider by 2
 *enbaled Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - MRCC_CKSYS: specifies the clock source used as system
 *clock. This parameter can be one of the following values:
 *                          - MRCC_CKSYS_FREEOSC
 *                          - MRCC_CKSYS_OSC4M
 *                          - MRCC_CKSYS_OSC4MPLL
 *                          - MRCC_CKSYS_RTC (RTC clock source must be
 *previously configured using MRCC_CKRTCConfig() function) : - MRCC_PLL:
 *specifies the PLL configuration. This parameter can be one of the following
 *values:
...
ErrorStatus MRCC_CKSYSConfig( u32 MRCC_CKSYS, u32 MRCC_PLL )
{
    ...
    switch( MRCC_CKSYS )
    {
        case MRCC_CKSYS_FREEOSC:
            if( ( MRCC_PLL == MRCC_PLL_Disabled ) ||
                ( MRCC_PLL == MRCC_PLL_NoChange ) )
            {
        ...
        case MRCC_CKSYS_OSC4MPLL:
            if( ( MRCC_PLL == MRCC_PLL_Mul_12 ) ||
                ( MRCC_PLL == MRCC_PLL_Mul_14 ) ||
                ( MRCC_PLL == MRCC_PLL_Mul_15 ) ||
                ( MRCC_PLL == MRCC_PLL_Mul_16 ) )
            {
 ...
 *                          - MRCC_CKRTC_OSC32K (OSC32K must be previously
 *enabled using MRCC_OSC32KConfig() function)
 ...
 * Description    : Returns the status and frequencies of different on chip
 *clocks. Don’t use this function when CK_SYS is clocked by an external clock
 *source (OSC4M bypassed). Input          : - MRCC_ClocksStatus: pointer to a
 *MRCC_ClocksTypeDef structure which will hold the clocks information. Output :
 *None Return         : None
 *******************************************************************************/
void MRCC_GetClocksStatus( MRCC_ClocksTypeDef * MRCC_ClocksStatus )
{
    ...
    MRCC_ClocksStatus->HCLK_Frequency = MRCC_ClocksStatus->CKSYS_Frequency >>
                                        Presc;

    /* Get CK_TIM prescaler */
    Presc = MRCC->CLKCTL & MRCC_PPRESC_Set_Mask;
    /* CK_TIM clock frequency */
    MRCC_ClocksStatus->CKTIM_Frequency = MRCC_ClocksStatus->HCLK_Frequency >>
                                         Presc;
    ...
    MRCC_ClocksStatus->PCLK_Frequency = MRCC_ClocksStatus->CKTIM_Frequency >>
                                        Presc;
}
 ...
 *                    This parameter can be one of the following values:
 *                          - MRCC_WFIParam_FLASHPowerDown(DMA not allowed
 *during WFI)
...
void MRCC_EnterWFIMode( u32 MRCC_WFIParam )
{
    ...
    {
        /* Set LP_PARAM[15:13] and WFI_FLASH_EN bits according to MRCC_WFIParam
         * value */
 ...
 * Input          : - MRCC_STOPParam: specifies the STOP mode control
 *parameters. This parameter can be one of the following values:
 *                          - MRCC_STOPParam_Default (OSC4M On, FLASH On, MVREG
 *On)
 ...
 *                  Make sure that WKPF flag is cleared before using this
 ...
 *                          - MRCC_MCO_OSC4M
 *                          - MRCC_MCO_CKPLL2
 *                  - MRCC_MCOPrescaler: specifies if prescaler, divide by 1 or
 *2, is applied to this clock before outputting it to MCO pin. This parameter
 ...
 * Input          : - MRCC_OSC4M: specifies the new state of the OSC4M
 *oscillator. This parameter can be one of the following values:
...
ErrorStatus MRCC_OSC4MConfig( u32 MRCC_OSC4M )
{
     ...
     * ------------------*/
    if( ( ( MRCC->CLKCTL & MRCC_CKSEL_CKOSCSEL_Mask ) ==
          MRCC_CKSEL_Set_Mask ) ||
        ( ( ( MRCC->CLKCTL & MRCC_CKSEL_CKOSCSEL_Mask ) ==
            MRCC_CKSEL_CKOSCSEL_Mask ) &&
 ...
 *                  the CK_RTC.
 * Input          : - MRCC_OSC32K: specifies the new state of the OSC32K
 *oscillator. This parameter can be one of the following values:
 ...
 *                  This function must be used when the CK_SYS is not clocked by
 *                  the CK_RTC.
 * Input          : - MRCC_LPOSC: specifies the new state of the LPOSC
 *oscillator. This parameter can be one of the following values:
...
{
    /* If CK_SYS is driven by CK_RTC or LPOSC is used as CK_RTC clock source,
     * exit*/
    if( ( ( ( MRCC->CLKCTL & MRCC_CKSEL_Set_Mask ) != RESET ) &&
          ( ( MRCC->CLKCTL & MRCC_CKOSCSEL_Set_Mask ) != RESET ) ) ||
 ...
 *                    timer IC1 or not.
 *                    This parameter can be one of the following values:
 *                          - MRCC_RTCM_Disable: CK_RTC not connected to TB
 *timer IC1
 ...
 *                          - MRCC_FLAG_LPDONE: Low Power Bit Sequence has been
 *performed
 ...
 *                          - MRCC_FLAG_STDB: STANDBY flag
 *                          - MRCC_FLAG_LPDONE: Low Power Bit Sequence has been
 *performed Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Checks whether the specified MRCC interrupt has occurred or
 *not. Input          : - MRCC_IT: specifies the MRCC interrupt source to check.
 *                    This parameter can be one of the following values:
 *                          - MRCC_IT_LOCK: PLL lock interrupt
 *                          - MRCC_IT_NCKD: No Clock detected interrupt
 * Output         : None
 ...
 * Output         : None
 * Return         : An ErrorStatus enumuration value:
 *                         - SUCCESS: OSC4M oscillator is stable and ready to
 *use
...
static ErrorStatus SetCKSYS_OSC4MPLL( u32 PLL_Mul )
{
        ...
        ( ( MRCC->CLKCTL & MRCC_OSC4MOFF_Set_Mask ) == RESET ) )
    {
        ...
        else
        {
            ...
            else if( ( PLL_Mul == MRCC_PLL_Mul_15 ) ||
                     ( PLL_Mul == MRCC_PLL_Mul_14 ) ||
