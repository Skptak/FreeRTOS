 ...
 * Input          : - SMI_InitStruct: pointer to a SMI_InitTypeDef structure
 *that contains the configuration information for the specified SMI peripheral.
 * Output         : None
 * Return         : None
 *******************************************************************************/
 ...
 * Description    : Configures the number of bytes to be transmitted and
 *received to/from external memory. This function is used in Software mode only.
 * Input          : - SMI_TxLength: specifies the number of bytes to be
 *transmitted to external memory. This parameter can be one of the following
 *values:
...
void SMI_TxRxLengthConfig( u32 SMI_TxLength, u32 SMI_RxLength )
{
    ...
    /* Set TRA_LENGTH[2:0] and REC_LENGTH[2:0] bits according to function
     * parameters */
 ...
 * Input          : - SMI_Bank: specifies the memory Bank to be enabled or
 ...
 * Input          : - Command: specifies the command to send to the external
 *memory. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - WriteAddr: external memory address from which the data
 *will be written.
 ...
 * Description    : Writes a Half Word to the selected memory Bank. This
 *function is used in Hardware mode only. Before calling this function, send a
 *Write Enable command to the selected memory Bank using SMI_SendWENCmd()
 *function. Input          : - WriteAddr: external memory address from which the
 ...
 * Description    : Reads a Half Word from the selected memory Bank. This
 *function is used in Hardware mode only. Input          : - ReadAddr: external
 *memory address to read from. Output         : None Return         : Data read
 ...
 *                          - SMI_FLAG_ERF2 : Error Flag 2: Forbidden Write
 *Request
 ...
 * Description    : Checks whether the specified SMI interrupt has occurred or
 *not. Input          : - SMI_FLAG: specifies the interrupt source to check.
 *                    This parameter can be one of the following values:
 *                          - SMI_IT_WC : Write Complete Interrupt
 *                          - SMI_IT_TF : Transfer Finished Interrupt
 * Output         : None
