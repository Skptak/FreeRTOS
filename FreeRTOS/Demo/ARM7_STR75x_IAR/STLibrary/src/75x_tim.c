 ...
 * Description    : Deinitializes TIM peripheral registers to their default
 *reset values. Input          : TIMx: where x can be 0, 1 or 2 to select the
 *TIM peripheral. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 0, 1 or 2 to select the TIM
 *peripheral.
 *                  - TIM_InitStruct: pointer to a TIM_InitTypeDef structure
...
void TIM_Init( TIM_TypeDef * TIMx, TIM_InitTypeDef * TIM_InitStruct )
{
    ...
    TIM_ClockSourceConfig( TIMx,
                           TIM_InitStruct->TIM_ClockSource,
    ...
    switch( TIM_InitStruct->TIM_Mode )
    {
        ...
        case TIM_Mode_OPM_Active:
            ...
            if( TIM_InitStruct->TIM_RepetitivePulse ==
                TIM_RepetitivePulse_Disable )
            {
                TIMx->CR |= TIM_OPM_Set;
            }
            else
...
void TIM_ITConfig( TIM_TypeDef * TIMx, u16 TIM_IT, FunctionalState Newstate )
{
    ...
    if( Newstate == ENABLE )
    {
        /* Update interrupt global source: overflow/undeflow, counter reset
        operation or slave mode controller in reset mode */
                            ...
                            u16 TIM_ExtCLKEdge )
{
    if( TIM_ClockSource == TIM_ClockSource_Internal )
    {
        ...
        TIMx->SCR &= TIM_SME_Reset & TIM_SlaveModeSelection_Mask &
                     TIM_TriggerSelection_Mask;
    }
    else
...
* Description    : Enables or disables the specified TIM peripheral Debug
control.
* Input          : - TIMx: where x can be 0, 1 or 2 to select the TIM peripheral
 ...
 *                    be used.
 *                    This parameter can be one of the following values:
 *                         - TIM_SynchroAction_Enable: The CNT_EN bit is used as
 *TRGO
 *                         - TIM_SynchroAction_Update: The Update event is used
 *as TRGO
 *                         - TIM_SynchroAction_Reset: The CNT_RST bit is used as
 *TRGO
 *                         - TIM_SynchroAction_OC: The OC1 signal is used as
 *TRGO
 *                  - TIM_SynchroMode: specifies the synchronization Mode to be
 ...
 *                           counter is controlled.
 *                         - TIM_SynchroMode_External: The rising edge of
 *selected trigger clocks the counter.
 *                         - TIM_SynchroMode_Reset: The rising edge of the
 *selected trigger signal resets the counter and generates an update of the
 *registers. Output         : None Return         : None
 *******************************************************************************/
                        ...
                        u16 TIM_SynchroMode )
{
    switch( Slave )
    {
        case PWM_Slave:
        {
            PWM->SCR &= TIM_SME_Reset & TIM_TriggerSelection_Mask &
                        TIM_SlaveModeSelection_Mask &
        ...
        case TIM0_Slave:
        {
            TIM0->SCR &= TIM_SME_Reset & TIM_TriggerSelection_Mask &
                         TIM_SlaveModeSelection_Mask &
                         TIM_InternalTriggerSelection_Mask;
        ...
        case TIM1_Slave:
        {
            TIM1->SCR &= TIM_SME_Reset & TIM_TriggerSelection_Mask &
                         TIM_SlaveModeSelection_Mask &
                         TIM_InternalTriggerSelection_Mask;
        ...
        case TIM2_Slave:
        {
            TIM2->SCR &= TIM_SME_Reset & TIM_TriggerSelection_Mask &
                         TIM_SlaveModeSelection_Mask &
                         TIM_InternalTriggerSelection_Mask;
 ...
 * Description    : Checks whether the specified TIM interrupt has occurred or
 *not. Input          : - TIMx: where x can be 0, 1 or 2 to select the TIM
 *peripheral.
                              ...
                              TIM_InitTypeDef * TIM_InitStruct )
{
    ...
    else
    {
        ...
        {
            TIMx->OMR1 &= TIM_OC1C_Mask & TIM_OC2C_Mask;
            TIMx->OMR1 |= TIM_OCControl | ( TIM_OCControl << 8 ) |
                          TIM_OC1_Enable | TIM_OC2_Enable | TIM_PLD1_Set |
                          TIM_PLD2_Set;
                               ...
                               TIM_InitTypeDef * TIM_InitStruct )
{
    ...
    else
    {
        if( TIM_InitStruct->TIM_Channel == TIM_Channel_1 )
        {
            ...
            TIMx->SCR &= TIM_TriggerSelection_Mask &
                         TIM_SlaveModeSelection_Mask;
            TIMx->SCR |= TIM_TS_IC1_Set | TIM_SMS_RESETCLK_Set | TIM_SME_Set;
