 ...
 * Description    : Deinitializes the WWDG  peripheral registers to their
 *default reset values. Input          : None Output         : None Return :
 *None
 *******************************************************************************/
 ...
 * Description    : Checks whether the Early Wakeup interrupt flag is set or
 *not. Input          : None Output         : None Return         : The new
 *state of the Early Wakeup interrupt flag (SET or RESET)
 *******************************************************************************/
