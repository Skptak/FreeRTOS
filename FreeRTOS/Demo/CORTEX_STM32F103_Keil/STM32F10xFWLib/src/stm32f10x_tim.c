...
static uc16 Tab_PolarityMask[ 4 ] = { CCER_CC1P_Mask,
                                      CCER_CC2P_Mask,
                                      CCER_CC3P_Mask,
                                      CCER_CC4P_Mask };
 ...
 *                  reset values.
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 ...
 *TIM_TimeBaseInitTypeDef structure that contains the configuration information
 *for the specified TIM peripheral. Output         : None Return         : None
 *******************************************************************************/
 ...
 *specified TIM peripheral. Output         : None Return         : None
 *******************************************************************************/
 ...
 * Description    : Fills each TIM_TimeBaseInitStruct member with its default
 *value. Input          : - TIM_TimeBaseInitStruct: pointer to a
 *TIM_TimeBaseInitTypeDef structure which will be initialized. Output         :
 *None Return         : None
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIMx
 *peripheral.
 ...
 *TIM_DMABase_CCER, TIM_DMABase_CNT, TIM_DMABase_PSC, TIM_DMABase_ARR,
 ...
 *                       - TIM_CounterMode_CenterAligned1: TIM Center Aligned
 *Mode1
 *                       - TIM_CounterMode_CenterAligned2: TIM Center Aligned
 *Mode2
 *                       - TIM_CounterMode_CenterAligned3: TIM Center Aligned
 ...
 * Description    : Forces the TIMx output 1 waveform to active or inactive
 *level. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 ...
 * Description    : Forces the TIMx output 2 waveform to active or inactive
 *level. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_ForcedAction: specifies the forced Action to be set to
 *                    the output waveform.
 ...
 * Description    : Forces the TIMx output 3 waveform to active or inactive
 *level. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_ForcedAction: specifies the forced Action to be set to
 *                    the output waveform.
 ...
 * Description    : Forces the TIMx output 4 waveform to active or inactive
 *level. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_ForcedAction: specifies the forced Action to be set to
 *                    the output waveform.
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - Newstate: new state of the TIMx peripheral Preload
 ...
 * Description    : Enables or disables the TIMx peripheral Preload register on
 *CCR1. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 ...
 * Description    : Enables or disables the TIMx peripheral Preload register on
 *CCR2. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_OCPreload: new state of the TIMx peripheral Preload
 *                    register
 *                    This parameter can be one of the following values:
 ...
 * Description    : Enables or disables the TIMx peripheral Preload register on
 *CCR3. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_OCPreload: new state of the TIMx peripheral Preload
 *                    register
 *                    This parameter can be one of the following values:
 ...
 * Description    : Enables or disables the TIMx peripheral Preload register on
 *CCR4. Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral.
 *                  - TIM_OCPreload: new state of the TIMx peripheral Preload
 *                    register
 *                    This parameter can be one of the following values:
 ...
 *                       - TIM_EncoderMode_TI12: Counter counts on both TI1FP1
 ...
 *source
 *                       - TIM_EventSource_CC2: Timer Capture Compare 2 Event
 *source
 *                       - TIM_EventSource_CC3: Timer Capture Compare 3 Event
 *source
 *                       - TIM_EventSource_CC4: Timer Capture Compare 4 Event
 *source
 ...
 *                       - TIM_MasterSlaveMode_Enable: synchronization between
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Capture Compare 1 Register
 *value.
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Capture Compare 2 Register
 *value.
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Capture Compare 3 Register
 *value.
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Capture Compare 4 Register
 *value.
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Counter Register value.
 *******************************************************************************/
 ...
 * Input          : - TIMx: where x can be 2, 3 or 4 to select the TIM
 *peripheral. Output         : None Return         : Prescaler Register value.
 *******************************************************************************/
 ...
 *                       - TIM_FLAG_CC1OF: Timer Capture Compare 1 overcapture
 *Flag
 *                       - TIM_FLAG_CC2OF: Timer Capture Compare 2 overcapture
 *Flag
 *                       - TIM_FLAG_CC3OF: Timer Capture Compare 3 overcapture
 *Flag
 *                       - TIM_FLAG_CC4OF: Timer Capture Compare 4 overcapture
 *Flag Output         : None Return         : The new state of TIM_FLAG (SET or
 *RESET).
 *******************************************************************************/
 ...
 *                         - TIM_IT_CC1: Timer Capture Compare 1 Interrupt
 *source
 *                         - TIM_IT_CC2: Timer Capture Compare 2 Interrupt
 *source
 *                         - TIM_IT_CC3: Timer Capture Compare 3 Interrupt
 *source
 *                         - TIM_IT_CC4: Timer Capture Compare 4 Interrupt
 *source
 ...
 *PWM signal. Input          : - TIM_ICInitStruct: pointer to a
 *TIM_ICInitTypeDef structure that contains the configuration information for
 *the specified TIM peripheral. Output         : None Return         : None
 *******************************************************************************/
static void PWMI_Config( TIM_TypeDef * TIMx,
                         TIM_ICInitTypeDef * TIM_ICInitStruct )
{
 ...
 *                         be connected to IC1.
 *                       - TIM_ICSelection_IndirectTI: TIM Input 1 is selected
 ...
 *                         be connected to IC2.
 *                       - TIM_ICSelection_IndirectTI: TIM Input 2 is selected
 ...
 *                         be connected to IC3.
 *                       - TIM_ICSelection_IndirectTI: TIM Input 3 is selected
 ...
 *                         be connected to IC4.
 *                       - TIM_ICSelection_IndirectTI: TIM Input 4 is selected
                        ...
                        u8 TIM_ICFilter )
{
    ...
    tmpccmr2 |= ( u16 ) ( ( u16 ) TIM_ICSelection << 8 ) |
                ( u16 ) ( ( u16 ) TIM_ICFilter << 12 );
                        ...
                        u8 ExtTRGFilter )
{
    ...
    tmpsmcr |= TIM_ExtTRGPrescaler | TIM_ExtTRGPolarity |
