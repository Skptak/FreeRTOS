 ...
 * Description    : Deinitializes the DMA Channelx registers to their default
 *reset values. Input          : - DMA_Channelx: where x can be 1, 2 to 7 to
 *select the DMA Channel. Output         : None Return         : None
 *******************************************************************************/
 ...
 *that contains the configuration information for the specified DMA Channel.
 * Output         : None
 * Return         : None
 ******************************************************************************/
 ...
 * Description    : Checks whether the specified DMA interrupt has occurred or
