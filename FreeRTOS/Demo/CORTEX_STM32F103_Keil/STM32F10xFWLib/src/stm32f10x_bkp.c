...
#define RTCCR_CCO_BB \
    ( PERIPH_BB_BASE + ( RTCCR_OFFSET * 32 ) + ( CCO_BitNumber * 4 ) )
...
#define CR_TPAL_BB \
    ( PERIPH_BB_BASE + ( CR_OFFSET * 32 ) + ( TPAL_BitNumber * 4 ) )

/* Alias word address of TPE bit */
#define TPE_BitNumber 0x00
#define CR_TPE_BB \
    ( PERIPH_BB_BASE + ( CR_OFFSET * 32 ) + ( TPE_BitNumber * 4 ) )
...
#define CSR_TPIE_BB \
    ( PERIPH_BB_BASE + ( CSR_OFFSET * 32 ) + ( TPIE_BitNumber * 4 ) )

/* Alias word address of TIF bit */
#define TIF_BitNumber 0x09
#define CSR_TIF_BB \
    ( PERIPH_BB_BASE + ( CSR_OFFSET * 32 ) + ( TIF_BitNumber * 4 ) )

/* Alias word address of TEF bit */
#define TEF_BitNumber 0x08
#define CSR_TEF_BB \
    ( PERIPH_BB_BASE + ( CSR_OFFSET * 32 ) + ( TEF_BitNumber * 4 ) )
 ...
 * Input          : - CalibrationValue: specifies the RTC Clock Calibration
 *value. This parameter must be a number between 0 and 0x7F. Output         :
 *None Return         : None
 *******************************************************************************/
