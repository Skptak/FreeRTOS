...
#include "em_rmu.h"
    ...
    /* Reset cause "don't care" definitions.
       1's mark the bits that must be zero, zeros are "don't cares". */
        ...
        #define RMU_RSTCAUSE_PORST_XMASK \
            ( 0x00000000 ) /**0b0000000000000000  < Power On Reset */
        #define RMU_RSTCAUSE_BODUNREGRST_XMASK                         \
            ( 0x00000081 ) /**0b0000000010000001  < Brown Out Detector \
                              Unregulated Domain Reset */
        #define RMU_RSTCAUSE_BODREGRST_XMASK                           \
            ( 0x00000091 ) /**0b0000000010010001  < Brown Out Detector \
                              Regulated Domain Reset */
        #define RMU_RSTCAUSE_EXTRST_XMASK \
            ( 0x00000001 ) /**0b0000000000000001  < External Pin Reset */
        #define RMU_RSTCAUSE_WDOGRST_XMASK \
            ( 0x00000003 ) /**0b0000000000000011  < Watchdog Reset */
        #define RMU_RSTCAUSE_LOCKUPRST_XMASK \
            ( 0x0000EFDF ) /**0b1110111111011111  < LOCKUP Reset */
        #define RMU_RSTCAUSE_SYSREQRST_XMASK \
            ( 0x0000EF9F ) /**0b1110111110011111  < System Request Reset */
        ...
        #define RMU_RSTCAUSE_SYSREQRST_XMASK \
            ( 0x0000EF9F ) /**0b1110111110011111  < System Request Reset */
        #define RMU_RSTCAUSE_EM4RST_XMASK \
            ( 0x00000719 ) /**0b0000011100011001  < EM4 Reset */
        #define RMU_RSTCAUSE_EM4WURST_XMASK \
            ( 0x00000619 ) /**0b0000011000011001  < EM4 Wake-up Reset */
        #define RMU_RSTCAUSE_BODAVDD0_XMASK \
            ( 0x0000041F ) /**0b0000010000011111  < AVDD0 Bod Reset. */
        #define RMU_RSTCAUSE_BODAVDD1_XMASK \
            ( 0x0000021F ) /**0b0000001000011111  < AVDD1 Bod Reset. */
        ...
        #define RMU_RSTCAUSE_BODAVDD1_XMASK \
            ( 0x0000021F ) /**0b0000001000011111  < AVDD1 Bod Reset */
        #define RMU_RSTCAUSE_BUBODVDDDREG_XMASK                                \
            ( 0x00000001 ) /**0b0000000000000001  < Backup Brown Out Detector, \
                              VDD_DREG */
        #define RMU_RSTCAUSE_BUBODBUVIN_XMASK                                  \
            ( 0x00000001 ) /**0b0000000000000001  < Backup Brown Out Detector, \
                              BU_VIN */
        #define RMU_RSTCAUSE_BUBODUNREG_XMASK                                 \
            ( 0x00000001 ) /**0b0000000000000001  < Backup Brown Out Detector \
                              Unregulated Domain */
        #define RMU_RSTCAUSE_BUBODREG_XMASK                                   \
            ( 0x00000001 ) /**0b0000000000000001  < Backup Brown Out Detector \
                              Regulated Domain */
        #define RMU_RSTCAUSE_BUMODERST_XMASK \
            ( 0x00000001 ) /**0b0000000000000001  < Backup mode reset */
        #define NUM_RSTCAUSES ( 16 )

    #elif( ( _RMU_RSTCAUSE_MASK & 0x0FFFFFFF ) == 0x00010F1DUL )
        #define RMU_RSTCAUSE_PORST_XMASK \
            ( 0x00000000 ) /**0b0000000000000000  < Power On Reset */
        #define RMU_RSTCAUSE_BODAVDD_XMASK \
            ( 0x00000001 ) /**0b0000000000000001  < AVDD Bod Reset */
        #define RMU_RSTCAUSE_BODDVDD_XMASK \
            ( 0x00000003 ) /**0b0000000000000011  < DVDD Bod Reset */
        #define RMU_RSTCAUSE_BODREGRST_XMASK                           \
            ( 0x0000000F ) /**0b0000000000001111  < Brown Out Detector \
                              Regulated Domain Reset */
        #define RMU_RSTCAUSE_EXTRST_XMASK \
            ( 0x0000000F ) /**0b0000000000001111  < External Pin Reset */
        #define RMU_RSTCAUSE_LOCKUPRST_XMASK \
            ( 0x0000001F ) /**0b0000000000011111  < LOCKUP Reset */
        #define RMU_RSTCAUSE_SYSREQRST_XMASK \
            ( 0x0000001F ) /**0b0000000000011111  < System Request Reset */
        #define RMU_RSTCAUSE_WDOGRST_XMASK \
            ( 0x0000001F ) /**0b0000000000011111  < Watchdog Reset */
        #define RMU_RSTCAUSE_EM4RST_XMASK \
            ( 0x00000003 ) /**0b0000000000000011  < EM4H/S Reset */
...
{
    /* Note that the RMU supports bit-band access, but not peripheral bit-field
     * set/clear */
...
uint32_t RMU_ResetCauseGet( void )
{
    ...
    {
        /* Checks to see if rstCause matches a RSTCAUSE and is not excluded by
         * the X-mask */
