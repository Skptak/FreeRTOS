...
#define AT91C_WD_EXTEN \
    ( ( unsigned int ) 0x1 << 3 ) // (WD) External Signal Enable
...
#define AT91C_WD_WDCLKS_MCK32 \
    ( ( unsigned int ) 0x0 ) // (WD) Master Clock divided by 32
#define AT91C_WD_WDCLKS_MCK128 \
    ( ( unsigned int ) 0x1 ) // (WD) Master Clock divided by 128
#define AT91C_WD_WDCLKS_MCK1024 \
    ( ( unsigned int ) 0x2 ) // (WD) Master Clock divided by 1024
#define AT91C_WD_WDCLKS_MCK4096 \
    ( ( unsigned int ) 0x3 ) // (WD) Master Clock divided by 4096
#define AT91C_WD_HPCV \
    ( ( unsigned int ) 0xF << 2 ) // (WD) High Pre-load Counter Value
...
#define AT91C_TC_WAVESEL_UP_AUTO \
    ( ( unsigned int ) 0x1 << 13 ) // (TC) UP mode with automatic trigger on RC
                                   // Compare
#define AT91C_TC_WAVESEL_UPDOWN \
    ( ( unsigned int ) 0x2 << 13 ) // (TC) UPDOWN mode without automatic trigger
                                   // on RC Compare
...
#define AT91C_US_RSTTX \
    ( ( unsigned int ) 0x1 << 3 ) // (USART) Reset Transmitter
...
#define AT91C_US_TXEN \
    ( ( unsigned int ) 0x1 << 6 ) // (USART) Transmitter Enable
#define AT91C_US_TXDIS \
    ( ( unsigned int ) 0x1 << 7 ) // (USART) Transmitter Disable
...
#define AT91C_US_PAR_SPACE \
    ( ( unsigned int ) 0x2 << 9 ) // (USART) Parity forced to 0 (Space)
#define AT91C_US_PAR_MARK \
    ( ( unsigned int ) 0x3 << 9 ) // (USART) Parity forced to 1 (Mark)
#define AT91C_US_PAR_NONE ( ( unsigned int ) 0x4 << 9 ) // (USART) No Parity
#define AT91C_US_PAR_MULTI_DROP \
    ( ( unsigned int ) 0x6 << 9 ) // (USART) Multi-drop mode
...
#define AT91C_US_CHMODE_NORMAL \
    ( ( unsigned int ) 0x0 << 14 ) // (USART) Normal Mode: The USART channel
                                   // operates as an RX/TX USART.
#define AT91C_US_CHMODE_AUTO \
    ( ( unsigned int ) 0x1 << 14 ) // (USART) Automatic Echo: Receiver Data
                                   // Input is connected to the TXD pin.
#define AT91C_US_CHMODE_LOCAL \
    ( ( unsigned int ) 0x2 << 14 ) // (USART) Local Loopback: Transmitter Output
                                   // Signal is connected to Receiver Input
                                   // Signal.
#define AT91C_US_CHMODE_REMOTE \
    ( ( unsigned int ) 0x3 << 14 ) // (USART) Remote Loopback: RXD pin is
...
#define AT91C_US_ENDRX \
    ( ( unsigned int ) 0x1 << 3 ) // (USART) End of Receive Transfer Interrupt
#define AT91C_US_ENDTX \
    ( ( unsigned int ) 0x1 << 4 ) // (USART) End of Transmit Interrupt
#define AT91C_US_OVRE ( ( unsigned int ) 0x1 << 5 ) // (USART) Overrun Interrupt
#define AT91C_US_FRAME \
    ( ( unsigned int ) 0x1 << 6 ) // (USART) Framing Error Interrupt
#define AT91C_US_PARE \
    ( ( unsigned int ) 0x1 << 7 ) // (USART) Parity Error Interrupt
#define AT91C_US_TIMEOUT \
    ( ( unsigned int ) 0x1 << 8 ) // (USART) Receiver Time-out
#define AT91C_US_TXEMPTY \
    ( ( unsigned int ) 0x1 << 9 ) // (USART) TXEMPTY Interrupt
...
#define AT91C_SF_VERSION \
    ( ( unsigned int ) 0x1F << 0 )                  // (SF) Version of the chip
...
#define AT91C_SF_NVPSIZ \
    ( ( unsigned int ) 0xF << 8 ) // (SF) Nonvolatile Program Memory Size
...
#define AT91C_SF_NVDSIZ \
    ( ( unsigned int ) 0xF << 12 ) // (SF) Nonvolatile Data Memory Size
#define AT91C_SF_NVDSIZ_NONE ( ( unsigned int ) 0x0 << 12 ) // (SF) None
#define AT91C_SF_VDSIZ \
    ( ( unsigned int ) 0xF << 16 ) // (SF) Volatile Data Memory Size
...
#define AT91C_SF_NVPTYP \
    ( ( unsigned int ) 0x7 << 28 ) // (SF) Nonvolatile Program Memory Type
#define AT91C_SF_NVPTYP_NVPTYP_M \
    ( ( unsigned int ) 0x1 << 28 ) // (SF) 'M' Series or 'F' Series
#define AT91C_SF_NVPTYP_NVPTYP_R \
    ( ( unsigned int ) 0x4 << 28 )                        // (SF) 'R' Series
...
#define AT91C_SF_RAMWU \
    ( ( unsigned int ) 0x1 << 0 ) // (SF) Internal Extended RAM Write Detection
// -------- SF_PMR : (SF Offset: 0x18) Protection Mode Register --------
#define AT91C_SF_AIC \
    ( ( unsigned int ) 0x1 << 5 ) // (SF) AIC Protect Mode Enable
#define AT91C_SF_PMRKEY \
    ( ( unsigned int ) 0xFFFF << 16 ) // (SF) Protect Mode Register Key
...
#define AT91C_EBI_NWS \
    ( ( unsigned int ) 0x7 << 2 ) // (EBI) Number of wait states
...
#define AT91C_EBI_TDF \
    ( ( unsigned int ) 0x7 << 9 ) // (EBI) Data Float Output Time
...
#define AT91C_EBI_CSEN \
    ( ( unsigned int ) 0x1 << 13 ) // (EBI) Chip Select Enable
#define AT91C_EBI_BA ( ( unsigned int ) 0xFFF << 20 ) // (EBI) Base Address
// -------- EBI_RCR : (EBI Offset: 0x20) Remap Control Register --------
#define AT91C_EBI_RCB \
    ( ( unsigned int ) 0x1 << 0 ) // (EBI) 0 = No effect. 1 = Cancels the
                                  // remapping (performed at reset) of the page
                                  // zero memory devices.
// -------- EBI_MCR : (EBI Offset: 0x24) Memory Control Register --------
#define AT91C_EBI_ALE ( ( unsigned int ) 0x7 << 0 ) // (EBI) Address Line Enable
#define AT91C_EBI_ALE_16M \
    ( ( unsigned int ) 0x0 ) // (EBI) Valid Address Bits = A20, A21, A22, A23
                             // Max Addressable Space = 16M Bytes Valid Chip
                             // Select=None
#define AT91C_EBI_ALE_8M \
    ( ( unsigned int ) 0x4 ) // (EBI) Valid Address Bits = A20, A21, A22  Max
                             // Addressable Space = 8M Bytes Valid Chip Select =
                             // CS4
#define AT91C_EBI_ALE_4M \
    ( ( unsigned int ) 0x5 ) // (EBI) Valid Address Bits = A20, A21  Max
                             // Addressable Space = 4M Bytes Valid Chip Select =
                             // CS4, CS5
#define AT91C_EBI_ALE_2M \
    ( ( unsigned int ) 0x6 ) // (EBI) Valid Address Bits = A20  Max Addressable
                             // Space = 2M Bytes Valid Chip Select = CS4, CS5,
                             // CS6
#define AT91C_EBI_ALE_1M \
    ( ( unsigned int ) 0x7 ) // (EBI) Valid Address Bits = None  Max Addressable
                             // Space = 1M Byte Valid Chip Select = CS4, CS5,
                             // CS6, CS7
...
#define AT91C_AIC_SVR \
    ( ( AT91_REG * ) 0xFFFFF080 ) // (AIC) Source Vector egister
...
#define AT91C_AIC_IDCR \
    ( ( AT91_REG * ) 0xFFFFF124 ) // (AIC) Interrupt Disable Command egister
...
#define AT91C_WD_OMR \
    ( ( AT91_REG * ) 0xFFFF8000 ) // (WD) Overflow Mode Register
// ========== Register definition for PS peripheral ==========
#define AT91C_PS_PCDR \
    ( ( AT91_REG * ) 0xFFFF4008 ) // (PS) Peripheral Clock Disable Register
#define AT91C_PS_CR ( ( AT91_REG * ) 0xFFFF4000 ) // (PS) Control Register
#define AT91C_PS_PCSR \
    ( ( AT91_REG * ) 0xFFFF400C ) // (PS) Peripheral Clock Status Register
#define AT91C_PS_PCER \
    ( ( AT91_REG * ) 0xFFFF4004 ) // (PS) Peripheral Clock Enable Register
// ========== Register definition for PIO peripheral ==========
#define AT91C_PIO_MDSR \
    ( ( AT91_REG * ) 0xFFFF0058 ) // (PIO) Multi-driver Status Register
#define AT91C_PIO_IFSR \
    ( ( AT91_REG * ) 0xFFFF0028 ) // (PIO) Input Filter Status Register
#define AT91C_PIO_IFER \
    ( ( AT91_REG * ) 0xFFFF0020 ) // (PIO) Input Filter Enable Register
#define AT91C_PIO_OSR \
    ( ( AT91_REG * ) 0xFFFF0018 ) // (PIO) Output Status Register
#define AT91C_PIO_OER \
    ( ( AT91_REG * ) 0xFFFF0010 ) // (PIO) Output Enable Register
#define AT91C_PIO_PSR ( ( AT91_REG * ) 0xFFFF0008 ) // (PIO) PIO Status Register
#define AT91C_PIO_PDSR \
    ( ( AT91_REG * ) 0xFFFF003C ) // (PIO) Pin Data Status Register
#define AT91C_PIO_CODR \
    ( ( AT91_REG * ) 0xFFFF0034 ) // (PIO) Clear Output Data Register
#define AT91C_PIO_IFDR \
    ( ( AT91_REG * ) 0xFFFF0024 ) // (PIO) Input Filter Disable Register
#define AT91C_PIO_MDER \
    ( ( AT91_REG * ) 0xFFFF0050 ) // (PIO) Multi-driver Enable Register
#define AT91C_PIO_IMR \
    ( ( AT91_REG * ) 0xFFFF0048 ) // (PIO) Interrupt Mask Register
#define AT91C_PIO_IER \
    ( ( AT91_REG * ) 0xFFFF0040 ) // (PIO) Interrupt Enable Register
#define AT91C_PIO_ODSR \
    ( ( AT91_REG * ) 0xFFFF0038 ) // (PIO) Output Data Status Register
#define AT91C_PIO_SODR \
    ( ( AT91_REG * ) 0xFFFF0030 ) // (PIO) Set Output Data Register
#define AT91C_PIO_PER ( ( AT91_REG * ) 0xFFFF0000 ) // (PIO) PIO Enable Register
#define AT91C_PIO_MDDR \
    ( ( AT91_REG * ) 0xFFFF0054 ) // (PIO) Multi-driver Disable Register
#define AT91C_PIO_ISR \
    ( ( AT91_REG * ) 0xFFFF004C ) // (PIO) Interrupt Status Register
#define AT91C_PIO_IDR \
    ( ( AT91_REG * ) 0xFFFF0044 ) // (PIO) Interrupt Disable Register
#define AT91C_PIO_PDR \
    ( ( AT91_REG * ) 0xFFFF0004 ) // (PIO) PIO Disable Register
#define AT91C_PIO_ODR \
    ( ( AT91_REG * ) 0xFFFF0014 ) // (PIO) Output Disable Registerr
// ========== Register definition for TC2 peripheral ==========
#define AT91C_TC2_IDR \
    ( ( AT91_REG * ) 0xFFFE00A8 ) // (TC2) Interrupt Disable Register
...
#define AT91C_TC2_CCR \
    ( ( AT91_REG * ) 0xFFFE0080 ) // (TC2) Channel Control Register
#define AT91C_TC2_IMR \
    ( ( AT91_REG * ) 0xFFFE00AC ) // (TC2) Interrupt Mask Register
#define AT91C_TC2_IER \
    ( ( AT91_REG * ) 0xFFFE00A4 ) // (TC2) Interrupt Enable Register
...
#define AT91C_TC2_CMR \
    ( ( AT91_REG * ) 0xFFFE0084 ) // (TC2) Channel Mode Register
// ========== Register definition for TC1 peripheral ==========
#define AT91C_TC1_IDR \
    ( ( AT91_REG * ) 0xFFFE0068 ) // (TC1) Interrupt Disable Register
...
#define AT91C_TC1_CCR \
    ( ( AT91_REG * ) 0xFFFE0040 ) // (TC1) Channel Control Register
#define AT91C_TC1_IMR \
    ( ( AT91_REG * ) 0xFFFE006C ) // (TC1) Interrupt Mask Register
#define AT91C_TC1_IER \
    ( ( AT91_REG * ) 0xFFFE0064 ) // (TC1) Interrupt Enable Register
...
#define AT91C_TC1_CMR \
    ( ( AT91_REG * ) 0xFFFE0044 ) // (TC1) Channel Mode Register
// ========== Register definition for TC0 peripheral ==========
#define AT91C_TC0_IDR \
    ( ( AT91_REG * ) 0xFFFE0028 ) // (TC0) Interrupt Disable Register
...
#define AT91C_TC0_CCR \
    ( ( AT91_REG * ) 0xFFFE0000 ) // (TC0) Channel Control Register
#define AT91C_TC0_IMR \
    ( ( AT91_REG * ) 0xFFFE002C ) // (TC0) Interrupt Mask Register
#define AT91C_TC0_IER \
    ( ( AT91_REG * ) 0xFFFE0024 ) // (TC0) Interrupt Enable Register
...
#define AT91C_TC0_CMR \
    ( ( AT91_REG * ) 0xFFFE0004 ) // (TC0) Channel Mode Register
// ========== Register definition for TCB0 peripheral ==========
#define AT91C_TCB0_BCR \
    ( ( AT91_REG * ) 0xFFFE00C0 ) // (TCB0) TC Block Control Register
#define AT91C_TCB0_BMR \
    ( ( AT91_REG * ) 0xFFFE00C4 ) // (TCB0) TC Block Mode Register
// ========== Register definition for PDC_US1 peripheral ==========
#define AT91C_US1_TPR \
    ( ( AT91_REG * ) 0xFFFC4038 ) // (PDC_US1) Transmit Pointer Register
#define AT91C_US1_RPR \
    ( ( AT91_REG * ) 0xFFFC4030 ) // (PDC_US1) Receive Pointer Register
#define AT91C_US1_TCR \
    ( ( AT91_REG * ) 0xFFFC403C ) // (PDC_US1) Transmit Counter Register
#define AT91C_US1_RCR \
    ( ( AT91_REG * ) 0xFFFC4034 ) // (PDC_US1) Receive Counter Register
// ========== Register definition for US1 peripheral ==========
#define AT91C_US1_RTOR \
    ( ( AT91_REG * ) 0xFFFCC024 ) // (US1) Receiver Time-out Register
#define AT91C_US1_THR \
    ( ( AT91_REG * ) 0xFFFCC01C ) // (US1) Transmitter Holding Register
#define AT91C_US1_CSR \
    ( ( AT91_REG * ) 0xFFFCC014 ) // (US1) Channel Status Register
#define AT91C_US1_IDR \
    ( ( AT91_REG * ) 0xFFFCC00C ) // (US1) Interrupt Disable Register
#define AT91C_US1_MR ( ( AT91_REG * ) 0xFFFCC004 ) // (US1) Mode Register
#define AT91C_US1_TTGR \
    ( ( AT91_REG * ) 0xFFFCC028 ) // (US1) Transmitter Time-guard Register
#define AT91C_US1_BRGR \
    ( ( AT91_REG * ) 0xFFFCC020 ) // (US1) Baud Rate Generator Register
#define AT91C_US1_RHR \
    ( ( AT91_REG * ) 0xFFFCC018 ) // (US1) Receiver Holding Register
#define AT91C_US1_IMR \
    ( ( AT91_REG * ) 0xFFFCC010 ) // (US1) Interrupt Mask Register
#define AT91C_US1_IER \
    ( ( AT91_REG * ) 0xFFFCC008 ) // (US1) Interrupt Enable Register
#define AT91C_US1_CR ( ( AT91_REG * ) 0xFFFCC000 ) // (US1) Control Register
// ========== Register definition for PDC_US0 peripheral ==========
#define AT91C_US0_TPR \
    ( ( AT91_REG * ) 0xFFFC0038 ) // (PDC_US0) Transmit Pointer Register
#define AT91C_US0_RPR \
    ( ( AT91_REG * ) 0xFFFC0030 ) // (PDC_US0) Receive Pointer Register
#define AT91C_US0_TCR \
    ( ( AT91_REG * ) 0xFFFC003C ) // (PDC_US0) Transmit Counter Register
#define AT91C_US0_RCR \
    ( ( AT91_REG * ) 0xFFFC0034 ) // (PDC_US0) Receive Counter Register
// ========== Register definition for US0 peripheral ==========
#define AT91C_US0_RTOR \
    ( ( AT91_REG * ) 0xFFFD0024 ) // (US0) Receiver Time-out Register
#define AT91C_US0_THR \
    ( ( AT91_REG * ) 0xFFFD001C ) // (US0) Transmitter Holding Register
#define AT91C_US0_CSR \
    ( ( AT91_REG * ) 0xFFFD0014 ) // (US0) Channel Status Register
#define AT91C_US0_IDR \
    ( ( AT91_REG * ) 0xFFFD000C ) // (US0) Interrupt Disable Register
#define AT91C_US0_MR ( ( AT91_REG * ) 0xFFFD0004 ) // (US0) Mode Register
#define AT91C_US0_TTGR \
    ( ( AT91_REG * ) 0xFFFD0028 ) // (US0) Transmitter Time-guard Register
#define AT91C_US0_BRGR \
    ( ( AT91_REG * ) 0xFFFD0020 ) // (US0) Baud Rate Generator Register
#define AT91C_US0_RHR \
    ( ( AT91_REG * ) 0xFFFD0018 ) // (US0) Receiver Holding Register
#define AT91C_US0_IMR \
    ( ( AT91_REG * ) 0xFFFD0010 ) // (US0) Interrupt Mask Register
#define AT91C_US0_IER \
    ( ( AT91_REG * ) 0xFFFD0008 ) // (US0) Interrupt Enable Register
...
#define AT91C_SF_EXID \
    ( ( AT91_REG * ) 0xFFF00004 ) // (SF) Chip ID Extension Register
// ========== Register definition for EBI peripheral ==========
#define AT91C_EBI_RCR \
    ( ( AT91_REG * ) 0xFFE00020 ) // (EBI) Remap Control Register
#define AT91C_EBI_CSR \
    ( ( AT91_REG * ) 0xFFE00000 ) // (EBI) Chip-select Register
#define AT91C_EBI_MCR \
    ( ( AT91_REG * ) 0xFFE00024 ) // (EBI) Memory Control Register

// *****************************************************************************
//               PIO DEFINITIONS FOR AT91R40008
// *****************************************************************************
#define AT91C_PIO_P0 ( ( unsigned int ) 1 << 0 ) // Pin Controlled by P0
#define AT91C_P0_TCLK0 \
    ( ( unsigned int ) AT91C_PIO_P0 )              //  Timer 0 Clock signal
...
#define AT91C_P10_IRQ1 \
    ( ( unsigned int ) AT91C_PIO_P10 )             //  External Interrupt 1
#define AT91C_PIO_P11 ( ( unsigned int ) 1 << 11 ) // Pin Controlled by P11
#define AT91C_P11_IRQ2 \
    ( ( unsigned int ) AT91C_PIO_P11 )             //  External Interrupt 2
#define AT91C_PIO_P12 ( ( unsigned int ) 1 << 12 ) // Pin Controlled by P12
#define AT91C_P12_FIQ \
    ( ( unsigned int ) AT91C_PIO_P12 )             //  Fast External Interrupt
#define AT91C_PIO_P13 ( ( unsigned int ) 1 << 13 ) // Pin Controlled by P13
#define AT91C_P13_SCK0 \
    ( ( unsigned int ) AT91C_PIO_P13 )             //  USART 0 Serial Clock
#define AT91C_PIO_P14 ( ( unsigned int ) 1 << 14 ) // Pin Controlled by P14
#define AT91C_P14_TXD0 \
    ( ( unsigned int ) AT91C_PIO_P14 )             //  USART 0 Transmit Data
#define AT91C_PIO_P15 ( ( unsigned int ) 1 << 15 ) // Pin Controlled by P15
#define AT91C_P15_RXD0 \
    ( ( unsigned int ) AT91C_PIO_P15 )              //  USART 0 Receive Data
...
#define AT91C_P20_SCK1 \
    ( ( unsigned int ) AT91C_PIO_P20 )             //  USART 1 Serial Clock
#define AT91C_PIO_P21 ( ( unsigned int ) 1 << 21 ) // Pin Controlled by P21
#define AT91C_P21_TXD1 \
    ( ( unsigned int ) AT91C_PIO_P21 ) //  USART 1 Transmit Data
...
#define AT91C_P22_RXD1 \
    ( ( unsigned int ) AT91C_PIO_P22 )              //  USART 1 Receive Data
...
#define AT91C_P3_TCLK1 \
    ( ( unsigned int ) AT91C_PIO_P3 )               //  Timer 1 Clock signal
...
#define AT91C_P6_TCLK2 \
    ( ( unsigned int ) AT91C_PIO_P6 )              //  Timer 2 Clock signal
...
#define AT91C_ID_IRQ0 \
    ( ( unsigned int ) 16 ) // Advanced Interrupt Controller (IRQ0)
#define AT91C_ID_IRQ1 \
    ( ( unsigned int ) 17 ) // Advanced Interrupt Controller (IRQ1)
#define AT91C_ID_IRQ2 \
    ( ( unsigned int ) 18 ) // Advanced Interrupt Controller (IRQ2)
...
// *****************************************************************************
#define AT91C_SRAM_BEFORE_REMAP \
    ( ( char * ) 0x00300000 ) // Internal SRAM before remap base address
#define AT91C_SRAM_BEFORE_REMAP_SIZE \
    ( ( unsigned int ) 0x00040000 ) // Internal SRAM before remap size in byte
                                    // (256 Kbyte)
#define AT91C_SRAM_AFTER_REMAP \
    ( ( char * ) 0x00000000 ) // Internal SRAM after remap base address
#define AT91C_SRAM_AFTER_REMAP_SIZE \
    ( ( unsigned int ) 0x00040000 ) // Internal SRAM after remap size in byte
                                    // (256 Kbyte)
